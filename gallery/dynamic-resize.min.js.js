(function(){function Z(ha,ab,b){function ca(e,k){if(!ab[e]){if(!ha[e]){var q="function"==typeof require&&require;if(!k&&q)return q(e,!0);if(K)return K(e,!0);q=Error("Cannot find module '"+e+"'");throw q.code="MODULE_NOT_FOUND",q;}q=ab[e]={exports:{}};ha[e][0].call(q.exports,function(c){return ca(ha[e][1][c]||c)},q,q.exports,Z,ha,ab,b)}return ab[e].exports}for(var K="function"==typeof require&&require,L=0;L<b.length;L++)ca(b[L]);return ca}return Z})()({1:[function(Z,ha,ab){var b=document.createElement("div");
b.style.width="100%";b.style.height="100vh";b.style.border="10px solid green";b.style.margin="10px";document.body.appendChild(b);document.body.style.margin="0";window.addEventListener("mousemove",function(L){b.style.width=L.clientX.toFixed(0)+"px";b.style.height=L.clientY.toFixed(0)+"px"});var ca=Z("../regl")({container:b}),K=ca({frag:"\n  precision mediump float;\n  uniform vec4 color;\n  void main () {\n    gl_FragColor = color;\n  }",vert:"\n  precision mediump float;\n  attribute vec2 position;\n  void main () {\n    gl_Position = vec4(position, 0, 1);\n  }",
attributes:{position:[[-1,0],[0,-1],[1,1]]},uniforms:{color:[1,0,0,1]},count:3});ca.frame(function(){ca.poll();ca.clear({color:[0,0,0,1],depth:1});K()})},{"../regl":38}],2:[function(Z,ha,ab){function b(){this.w=this.z=this.y=this.x=this.state=0;this.buffer=null;this.size=0;this.normalized=!1;this.type=5126;this.divisor=this.stride=this.offset=0}var ca=Z("./util/sorted-object-keys"),K=Z("./util/check"),L=Z("./util/values"),e=Z("./constants/dtypes.json"),k=Z("./util/is-typed-array"),q=Z("./util/is-ndarray"),
c=Z("./constants/primitives.json"),F="attributes elements offset count primitive instances".split(" ");ha.exports=function(B,G,U,n,u,x,ba){function v(f){if(f!==X.currentVAO){var w=G.oes_vertex_array_object;f?w.bindVertexArrayOES(f.vao):w.bindVertexArrayOES(null);X.currentVAO=f}}function T(f){if(f!==X.currentVAO){if(f)f.bindAttrs();else{for(var w=G.angle_instanced_arrays,l=0;l<t.length;++l){var c=t[l];c.buffer?(B.enableVertexAttribArray(l),c.buffer.bind(),B.vertexAttribPointer(l,c.size,c.type,c.normalized,
c.stride,c.offfset),w&&c.divisor&&w.vertexAttribDivisorANGLE(l,c.divisor)):(B.disableVertexAttribArray(l),B.vertexAttrib4f(l,c.x,c.y,c.z,c.w))}ba.elements?B.bindBuffer(34963,ba.elements.buffer.buffer):B.bindBuffer(34963,null)}X.currentVAO=f}}function z(){L(h).forEach(function(f){f.destroy()})}function R(){this.id=++S;this.attributes=[];this.elements=null;this.ownsElements=!1;this.offset=this.count=0;this.instances=-1;this.primitive=4;var f=G.oes_vertex_array_object;this.vao=f?f.createVertexArrayOES():
null;h[this.id]=this;this.buffers=[]}function ia(){G.oes_vertex_array_object&&L(h).forEach(function(f){f.refresh()})}var l=U.maxAttributes,t=Array(l);for(U=0;U<l;++U)t[U]=new b;var S=0,h={},X={Record:b,scope:{},state:t,currentVAO:null,targetVAO:null,restore:G.oes_vertex_array_object?ia:function(){},createVAO:function(f){function w(f){var t;if(Array.isArray(f))t=f,h.elements&&h.ownsElements&&h.elements.destroy(),h.elements=null,h.ownsElements=!1,h.offset=0,h.count=0,h.instances=-1,h.primitive=4;else{K("object"===
typeof f,"invalid arguments for create vao");K("attributes"in f,"must specify attributes for vao");if(f.elements){var d=f.elements;h.ownsElements?("function"===typeof d&&"elements"===d._reglType?h.elements.destroy():h.elements(d),h.ownsElements=!1):x.getElements(f.elements)?(h.elements=f.elements,h.ownsElements=!1):(h.elements=x.create(f.elements),h.ownsElements=!0)}else h.elements=null,h.ownsElements=!1;t=f.attributes;h.offset=0;h.count=-1;h.instances=-1;h.primitive=4;h.elements&&(h.count=h.elements._elements.vertCount,
h.primitive=h.elements._elements.primType);"offset"in f&&(h.offset=f.offset|0);"count"in f&&(h.count=f.count|0);"instances"in f&&(h.instances=f.instances|0);"primitive"in f&&(K(f.primitive in c,"bad primitive type: "+f.primitive),h.primitive=c[f.primitive]);K.optional(function(){for(var a=ca(f),d=0;d<a.length;++d)K(0<=F.indexOf(a[d]),'invalid option for vao: "'+a[d]+'" valid options are '+F)});K(Array.isArray(t),"attributes must be an array")}K(t.length<l,"too many attributes");K(0<t.length,"must specify at least one attribute");
var d={},I=h.attributes;I.length=t.length;for(var a=0;a<t.length;++a){var S=t[a],A=I[a]=new b,z=S.data||S;if(Array.isArray(z)||k(z)||q(z)){var v;h.buffers[a]&&(v=h.buffers[a],k(z)&&v._buffer.byteLength>=z.byteLength?v.subdata(z):(v.destroy(),h.buffers[a]=null));h.buffers[a]||(v=h.buffers[a]=u.create(S,34962,!1,!0));A.buffer=u.getBuffer(v);A.size=A.buffer.dimension|0;A.normalized=!1;A.type=A.buffer.dtype;A.offset=0;A.stride=0;A.divisor=0;A.state=1;d[a]=1}else u.getBuffer(S)?(A.buffer=u.getBuffer(S),
A.size=A.buffer.dimension|0,A.normalized=!1,A.type=A.buffer.dtype,A.offset=0,A.stride=0,A.divisor=0,A.state=1):u.getBuffer(S.buffer)?(A.buffer=u.getBuffer(S.buffer),A.size=(+S.size||A.buffer.dimension)|0,A.normalized=!!S.normalized||!1,"type"in S?(K.parameter(S.type,e,"invalid buffer type"),A.type=e[S.type]):A.type=A.buffer.dtype,A.offset=(S.offset||0)|0,A.stride=(S.stride||0)|0,A.divisor=(S.divisor||0)|0,A.state=1,K(1<=A.size&&4>=A.size,"size must be between 1 and 4"),K(0<=A.offset,"invalid offset"),
K(0<=A.stride&&255>=A.stride,"stride must be between 0 and 255"),K(0<=A.divisor,"divisor must be positive"),K(!A.divisor||!!G.angle_instanced_arrays,"ANGLE_instanced_arrays must be enabled to use divisor")):"x"in S?(K(0<a,"first attribute must not be a constant"),A.x=+S.x||0,A.y=+S.y||0,A.z=+S.z||0,A.w=+S.w||0,A.state=2):K(!1,"invalid attribute spec for location "+a)}for(v=0;v<h.buffers.length;++v)!d[v]&&h.buffers[v]&&(h.buffers[v].destroy(),h.buffers[v]=null);h.refresh();return w}var h=new R;n.vaoCount+=
1;w.destroy=function(){for(var f=0;f<h.buffers.length;++f)h.buffers[f]&&h.buffers[f].destroy();h.buffers.length=0;h.ownsElements&&(h.elements.destroy(),h.elements=null,h.ownsElements=!1);h.destroy()};w._vao=h;w._reglType="vao";return w(f)},getVAO:function(f){return"function"===typeof f&&f._vao?f._vao:null},destroyBuffer:function(f){for(var w=0;w<t.length;++w){var c=t[w];c.buffer===f&&(B.disableVertexAttribArray(w),c.buffer=null)}},setVAO:G.oes_vertex_array_object?v:T,clear:G.oes_vertex_array_object?
z:function(){}};R.prototype.bindAttrs=function(){for(var f=G.angle_instanced_arrays,w=this.attributes,c=0;c<w.length;++c){var k=w[c];k.buffer?(B.enableVertexAttribArray(c),B.bindBuffer(34962,k.buffer.buffer),B.vertexAttribPointer(c,k.size,k.type,k.normalized,k.stride,k.offset),f&&k.divisor&&f.vertexAttribDivisorANGLE(c,k.divisor)):(B.disableVertexAttribArray(c),B.vertexAttrib4f(c,k.x,k.y,k.z,k.w))}for(f=w.length;f<l;++f)B.disableVertexAttribArray(f);(f=x.getElements(this.elements))?B.bindBuffer(34963,
f.buffer.buffer):B.bindBuffer(34963,null)};R.prototype.refresh=function(){var f=G.oes_vertex_array_object;f&&(f.bindVertexArrayOES(this.vao),this.bindAttrs(),X.currentVAO=null,f.bindVertexArrayOES(null))};R.prototype.destroy=function(){if(this.vao){var f=G.oes_vertex_array_object;this===X.currentVAO&&(X.currentVAO=null,f.bindVertexArrayOES(null));f.deleteVertexArrayOES(this.vao);this.vao=null}this.ownsElements&&(this.elements.destroy(),this.elements=null,this.ownsElements=!1);h[this.id]&&(delete h[this.id],
--n.vaoCount)};return X}},{"./constants/dtypes.json":5,"./constants/primitives.json":6,"./util/check":21,"./util/is-ndarray":28,"./util/is-typed-array":30,"./util/sorted-object-keys":34,"./util/values":36}],3:[function(Z,ha,ab){function b(c){return U[Object.prototype.toString.call(c)]|0}function ca(c,k){for(var q=0;q<k.length;++q)c[q]=k[q]}function K(c,k,q,e,b,u,l){for(var t=0,S=0;S<q;++S)for(var h=0;h<e;++h)c[t++]=k[b*S+u*h+l]}var L=Z("./util/sorted-object-keys"),e=Z("./util/check"),k=Z("./util/is-typed-array"),
q=Z("./util/is-ndarray"),c=Z("./util/values"),F=Z("./util/pool");ab=Z("./util/flatten");var B=ab.flatten,G=ab.shape,U=Z("./constants/arraytypes.json"),n=Z("./constants/dtypes.json"),u=Z("./constants/usage.json"),x=[];x[5120]=1;x[5122]=2;x[5124]=4;x[5121]=1;x[5123]=2;x[5125]=4;x[5126]=4;ha.exports=function(U,v,T,z){function R(f){this.id=S++;this.buffer=U.createBuffer();this.type=f;this.usage=35044;this.byteLength=0;this.dimension=1;this.dtype=5121;this.persistentData=null;T.profile&&(this.stats={size:0})}
function ia(f,c,l){f.byteLength=c.byteLength;U.bufferData(f.type,c,l)}function l(f,c,l,h,t,d){f.usage=l;if(Array.isArray(c)){if(f.dtype=h||5126,0<c.length)if(Array.isArray(c[0])){t=G(c);for(var I=h=1;I<t.length;++I)h*=t[I];f.dimension=h;c=B(c,t,f.dtype);ia(f,c,l);d?f.persistentData=c:F.freeType(c)}else"number"===typeof c[0]?(f.dimension=t,t=F.allocType(f.dtype,c.length),ca(t,c),ia(f,t,l),d?f.persistentData=t:F.freeType(t)):k(c[0])?(f.dimension=c[0].length,f.dtype=h||b(c[0])||5126,c=B(c,[c.length,
c[0].length],f.dtype),ia(f,c,l),d?f.persistentData=c:F.freeType(c)):e.raise("invalid buffer data")}else if(k(c))f.dtype=h||b(c),f.dimension=t,ia(f,c,l),d&&(f.persistentData=new Uint8Array(new Uint8Array(c.buffer)));else if(q(c)){t=c.shape;var a=c.stride,I=c.offset,S=0,A=0,z=0,v=0;1===t.length?(S=t[0],A=1,z=a[0],v=0):2===t.length?(S=t[0],A=t[1],z=a[0],v=a[1]):e.raise("invalid shape");f.dtype=h||b(c.data)||5126;f.dimension=A;t=F.allocType(f.dtype,S*A);K(t,c.data,S,A,z,v,I);ia(f,t,l);d?f.persistentData=
t:F.freeType(t)}else c instanceof ArrayBuffer?(f.dtype=5121,f.dimension=t,ia(f,c,l),d&&(f.persistentData=new Uint8Array(new Uint8Array(c)))):e.raise("invalid buffer data")}function t(c){v.bufferCount--;z(c);var l=c.buffer;e(l,"buffer must not be deleted already");U.deleteBuffer(l);c.buffer=null;delete h[c.id]}var S=0,h={};R.prototype.bind=function(){U.bindBuffer(this.type,this.buffer)};R.prototype.destroy=function(){t(this)};var X=[];T.profile&&(v.getTotalBufferSize=function(){var c=0;L(h).forEach(function(l){c+=
h[l].stats.size});return c});return{create:function(c,w,S,z){function E(a){var d=35044,c=null,f=0,h=0,w=1;Array.isArray(a)||k(a)||q(a)||a instanceof ArrayBuffer?c=a:"number"===typeof a?f=a|0:a&&(e.type(a,"object","buffer arguments must be an object, a number or an array"),"data"in a&&(e(null===c||Array.isArray(c)||k(c)||q(c),"invalid data for buffer"),c=a.data),"usage"in a&&(e.parameter(a.usage,u,"invalid buffer usage"),d=u[a.usage]),"type"in a&&(e.parameter(a.type,n,"invalid buffer type"),h=n[a.type]),
...
d+" to a buffer of size "+I.byteLength);U.bufferSubData(I.type,d,a)}v.bufferCount++;var I=new R(w);h[I.id]=I;S||E(c);E._reglType="buffer";E._buffer=I;E.subdata=function(a,c){var f=(c||0)|0,l;I.bind();if(k(a)||a instanceof ArrayBuffer)d(a,f);else if(Array.isArray(a)){if(0<a.length)if("number"===typeof a[0]){var h=F.allocType(I.dtype,a.length);ca(h,a);d(h,f);F.freeType(h)}else Array.isArray(a[0])||k(a[0])?(l=G(a),h=B(a,l,I.dtype),d(h,f),F.freeType(h)):e.raise("invalid buffer data")}else if(q(a)){l=
a.shape;var w=a.stride,t=h=0,O=0,P=0;1===l.length?(h=l[0],t=1,O=w[0],P=0):2===l.length?(h=l[0],t=l[1],O=w[0],P=w[1]):e.raise("invalid shape");l=Array.isArray(a.data)?I.dtype:b(a.data);l=F.allocType(l,h*t);K(l,a.data,h,t,O,P,a.offset);d(l,f);F.freeType(l)}else e.raise("invalid data for buffer subdata");return E};T.profile&&(E.stats=I.stats);E.destroy=function(){t(I)};return E},createStream:function(c,k){var h=X.pop();h||(h=new R(c));h.bind();l(h,k,35040,0,1,!1);return h},destroyStream:function(c){X.push(c)},
clear:function(){c(h).forEach(t);X.forEach(t)},getBuffer:function(c){return c&&c._buffer instanceof R?c._buffer:null},restore:function(){c(h).forEach(function(c){c.buffer=U.createBuffer();U.bindBuffer(c.type,c.buffer);U.bufferData(c.type,c.persistentData||c.byteLength,c.usage)})},_initBuffer:l}}},{"./constants/arraytypes.json":4,"./constants/dtypes.json":5,"./constants/usage.json":7,"./util/check":21,"./util/flatten":26,"./util/is-ndarray":28,"./util/is-typed-array":30,"./util/pool":32,"./util/sorted-object-keys":34,
"./util/values":36}],4:[function(Z,ha,ab){ha.exports={"[object Int8Array]":5120,"[object Int16Array]":5122,"[object Int32Array]":5124,"[object Uint8Array]":5121,"[object Uint8ClampedArray]":5121,"[object Uint16Array]":5123,"[object Uint32Array]":5125,"[object Float32Array]":5126,"[object Float64Array]":5121,"[object ArrayBuffer]":5121}},{}],5:[function(Z,ha,ab){ha.exports={int8:5120,int16:5122,int32:5124,uint8:5121,uint16:5123,uint32:5125,"float":5126,float32:5126}},{}],6:[function(Z,ha,ab){ha.exports=
{points:0,point:0,lines:1,line:1,"line loop":2,"line strip":3,triangles:4,triangle:4,"triangle strip":5,"triangle fan":6}},{}],7:[function(Z,ha,ab){ha.exports={"static":35044,dynamic:35048,stream:35040}},{}],8:[function(Z,ha,ab){function b(c){return Array.isArray(c)||U(c)||n(c)}function ca(c){return c.sort(function(c,l){return"viewport"===c?-1:"viewport"===l?1:c<l?-1:1})}function K(c,l,k,h){this.thisDep=c;this.contextDep=l;this.propDep=k;this.append=h}function L(c){return c&&!(c.thisDep||c.contextDep||
c.propDep)}function e(c){return new K(!1,!1,!1,c)}function k(c,l){var k=c.type;if(0===k)return k=c.data.length,new K(!0,1<=k,2<=k,l);if(4===k)return k=c.data,new K(k.thisDep,k.contextDep,k.propDep,l);if(5===k)return new K(!1,!1,!1,l);if(6===k){for(var h=k=!1,q=!1,d=0;d<c.data.length;++d){var I=c.data[d];1===I.type?q=!0:2===I.type?h=!0:3===I.type?k=!0:0===I.type?(k=!0,I=I.data,1<=I&&(h=!0),2<=I&&(q=!0)):4===I.type&&(k=k||I.data.thisDep,h=h||I.data.contextDep,q=q||I.data.propDep)}return new K(k,h,q,
l)}return new K(3===k,2===k,1===k,l)}var q=Z("./util/sorted-object-keys"),c=Z("./util/check"),F=Z("./util/extend"),B=Z("./util/codegen"),G=Z("./util/loop"),U=Z("./util/is-typed-array"),n=Z("./util/is-ndarray"),u=Z("./util/is-array-like"),x=Z("./dynamic"),ba=Z("./constants/primitives.json"),v=Z("./constants/dtypes.json"),T=["x","y","z","w"],z="blend.func blend.equation stencil.func stencil.opFront stencil.opBack sample.coverage viewport scissor.box polygonOffset.offset".split(" "),R={0:0,1:1,zero:0,
...
l={never:512,less:513,"<":513,equal:514,"=":514,"==":514,"===":514,lequal:515,"<=":515,greater:516,">":516,notequal:517,"!=":517,"!==":517,gequal:518,">=":518,always:519},t={0:0,zero:0,keep:7680,replace:7681,increment:7682,decrement:7683,"increment wrap":34055,"decrement wrap":34056,invert:5386},S={frag:35632,vert:35633},h={cw:2304,ccw:2305},X=new K(!1,!1,!1,function(){});ha.exports=function(f,w,n,D,E,d,I,a,U,A,ja,Cc,V,ea,O){function P(a){return a.replace(".","_")}function C(a,d,c){var g=P(a);ua.push(a);
W[g]=la[g]=!!c;Ia[g]=d}function g(a,d,c){var g=P(a);ua.push(a);Array.isArray(c)?(la[g]=c.slice(),W[g]=c.slice()):la[g]=W[g]=c;za[g]=d}function N(){var a=B(),d=a.link,g=a.global;a.id=xd++;a.batchId="0";var m=d(mb),r=a.shared={props:"a0"};q(mb).forEach(function(a){r[a]=g.def(m,".",a)});c.optional(function(){a.CHECK=d(c);a.commandStr=c.guessCommand();a.command=d(a.commandStr);a.assert=function(a,c,g){a("if(!(",c,"))",this.CHECK,".commandRaise(",d(g),",",this.command,");")};da.invalidBlendCombinations=
ia});var l=a.next={},p=a.current={};q(za).forEach(function(a){Array.isArray(la[a])&&(l[a]=g.def(r.next,".",a),p[a]=g.def(r.current,".",a))});var k=a.constants={};q(da).forEach(function(a){k[a]=g.def(JSON.stringify(da[a]))});a.invoke=function(c,g){switch(g.type){case 0:var m=["this",r.context,r.props,a.batchId];return c.def(d(g.data),".call(",m.slice(0,Math.max(g.data.length+1,4)),")");case 1:return c.def(r.props,g.data);case 2:return c.def(r.context,g.data);case 3:return c.def("this",g.data);case 4:return g.data.append(a,
c),g.data.ref;case 5:return g.data.toString();case 6:return g.data.map(function(d){return a.invoke(c,d)})}};a.attribCache={};var h={};a.scopeAttrib=function(a){a=w.id(a);if(a in h)return h[a];var c=A.scope[a];c||(c=A.scope[a]=new sa);return h[a]=d(c)};return a}function M(a){var d=a["static"];a=a.dynamic;var c;if("profile"in d){var g=!!d.profile;c=e(function(a,d){return g});c.enable=g}else if("profile"in a){var r=a.profile;c=k(r,function(a,d){return a.invoke(d,r)})}return c}function Da(d,g){var r=
d["static"],m=d.dynamic;if("framebuffer"in r){var l=r.framebuffer;return l?(l=a.getFramebuffer(l),c.command(l,"invalid framebuffer object"),e(function(a,d){var c=a.link(l),g=a.shared;d.set(g.framebuffer,".next",c);g=g.context;d.set(g,".framebufferWidth",c+".width");d.set(g,".framebufferHeight",c+".height");return c})):e(function(a,d){var c=a.shared;d.set(c.framebuffer,".next","null");c=c.context;d.set(c,".framebufferWidth",c+".drawingBufferWidth");d.set(c,".framebufferHeight",c+".drawingBufferHeight");
return"null"})}if("framebuffer"in m){var p=m.framebuffer;return k(p,function(a,d){var g=a.invoke(d,p),r=a.shared,m=r.framebuffer,l=d.def(m,".getFramebuffer(",g,")");c.optional(function(){a.assert(d,"!"+g+"||"+l,"invalid framebuffer object")});d.set(m,".next",l);r=r.context;d.set(r,".framebufferWidth",l+"?"+l+".width:"+r+".drawingBufferWidth");d.set(r,".framebufferHeight",l+"?"+l+".height:"+r+".drawingBufferHeight");return l})}return null}function pa(a,d,g){function r(a){if(a in l){var p=l[a];c.commandType(p,
"object","invalid "+a,g.commandStr);var h=!0,f=p.x|0,H=p.y|0,y,w;"width"in p?(y=p.width|0,c.command(0<=y,"invalid "+a,g.commandStr)):h=!1;"height"in p?(w=p.height|0,c.command(0<=w,"invalid "+a,g.commandStr)):h=!1;return new K(!h&&d&&d.thisDep,!h&&d&&d.contextDep,!h&&d&&d.propDep,function(a,d){var c=a.shared.context,g=y;"width"in p||(g=d.def(c,".","framebufferWidth","-",f));var r=w;"height"in p||(r=d.def(c,".","framebufferHeight","-",H));return[f,H,g,r]})}if(a in m){var na=m[a],h=k(na,function(d,g){var r=
d.invoke(g,na);c.optional(function(){d.assert(g,r+"&&typeof "+r+'==="object"',"invalid "+a)});var l=d.shared.context,m=g.def(r,".x|0"),p=g.def(r,".y|0"),k=g.def('"width" in ',r,"?",r,".width|0:","(",l,".","framebufferWidth","-",m,")"),h=g.def('"height" in ',r,"?",r,".height|0:","(",l,".","framebufferHeight","-",p,")");c.optional(function(){d.assert(g,k+">=0&&"+h+">=0","invalid "+a)});return[m,p,k,h]});d&&(h.thisDep=h.thisDep||d.thisDep,h.contextDep=h.contextDep||d.contextDep,h.propDep=h.propDep||
d.propDep);return h}return d?new K(d.thisDep,d.contextDep,d.propDep,function(a,d){var c=a.shared.context;return[0,0,d.def(c,".","framebufferWidth"),d.def(c,".","framebufferHeight")]}):null}var l=a["static"],m=a.dynamic;if(a=r("viewport")){var p=a;a=new K(a.thisDep,a.contextDep,a.propDep,function(a,d){var c=p.append(a,d),g=a.shared.context;d.set(g,".viewportWidth",c[2]);d.set(g,".viewportHeight",c[3]);return c})}return{viewport:a,scissor_box:r("scissor.box")}}function m(a,d){var g=a["static"];if("string"===
...
return k(p,function(d,g){var r=d.invoke(g,p),l=g.def(d.shared.strings,".id(",r,")");c.optional(function(){g(d.shared.shader,".shader(",S[a],",",l,",",d.command,");")});return l})}return null}var l=a["static"],m=a.dynamic,p=r("frag"),h=r("vert"),f=null;L(p)&&L(h)?(f=ja.program(h.id,p.id,null,g),a=e(function(a,d){return a.link(f)})):a=new K(p&&p.thisDep||h&&h.thisDep,p&&p.contextDep||h&&h.contextDep,p&&p.propDep||h&&h.propDep,function(a,d){var g=a.shared.shader,r;r=p?p.append(a,d):d.def(g,".","frag");
var l;l=h?h.append(a,d):d.def(g,".","vert");var m=g+".program("+l+","+r;c.optional(function(){m+=","+a.command});return d.def(m+")")});return{frag:p,vert:h,progVar:a,program:f}}function aa(a,g){function r(a,d){if(a in l){var y=l[a]|0;d?p.offset=y:p.instances=y;c.command(!d||0<=y,"invalid "+a,g.commandStr);return e(function(a,c){d&&(a.OFFSET=y);return y})}if(a in m){var w=m[a];return k(w,function(g,r){var l=g.invoke(r,w);d&&(g.OFFSET=l,c.optional(function(){g.assert(r,l+">=0","invalid "+a)}));return l})}if(d){if(H)return e(function(a,
d){return a.OFFSET=0});if(h)return new K(f.thisDep,f.contextDep,f.propDep,function(a,d){return d.def(a.shared.vao+".currentVAO?"+a.shared.vao+".currentVAO.offset:0")})}else if(h)return new K(f.thisDep,f.contextDep,f.propDep,function(a,d){return d.def(a.shared.vao+".currentVAO?"+a.shared.vao+".currentVAO.instances:-1")});return null}var l=a["static"],m=a.dynamic,p={},h=!1,f=function(){if("vao"in l){var a=l.vao;null!==a&&null===A.getVAO(a)&&(a=A.createVAO(a));h=!0;p.vao=a;return e(function(d){var c=
A.getVAO(a);return c?d.link(c):"null"})}if("vao"in m){h=!0;var d=m.vao;return k(d,function(a,c){var g=a.invoke(c,d);return c.def(a.shared.vao+".getVAO("+g+")")})}return null}(),H=!1,y=function(){if("elements"in l){var a=l.elements;p.elements=a;if(b(a)){var r=p.elements=d.create(a,!0),a=d.getElements(r);H=!0}else a&&(a=d.getElements(a),H=!0,c.command(a,"invalid elements",g.commandStr));r=e(function(d,c){if(a){var g=d.link(a);return d.ELEMENTS=g}return d.ELEMENTS=null});r.value=a;return r}if("elements"in
m){H=!0;var y=m.elements;return k(y,function(a,d){var g=a.shared,r=g.isBufferArgs,g=g.elements,l=a.invoke(d,y),m=d.def("null"),r=d.def(r,"(",l,")"),p=a.cond(r).then(m,"=",g,".createStream(",l,");")["else"](m,"=",g,".getElements(",l,");");c.optional(function(){a.assert(p["else"],"!"+l+"||"+m,"invalid elements")});d.entry(p);d.exit(a.cond(r).then(g,".destroyStream(",m,");"));return a.ELEMENTS=m})}return h?new K(f.thisDep,f.contextDep,f.propDep,function(a,d){return d.def(a.shared.vao+".currentVAO?"+
a.shared.elements+".getElements("+a.shared.vao+".currentVAO.elements):null")}):null}(),w=r("offset",!0),na=function(){if("primitive"in l){var a=l.primitive;p.primitive=a;c.commandParameter(a,ba,"invalid primitve",g.commandStr);return e(function(d,c){return ba[a]})}if("primitive"in m){var d=m.primitive;return k(d,function(a,g){var r=a.constants.primTypes,l=a.invoke(g,d);c.optional(function(){a.assert(g,l+" in "+r,"invalid primitive, must be one of "+q(ba))});return g.def(r,"[",l,"]")})}return H?L(y)?
y.value?e(function(a,d){return d.def(a.ELEMENTS,".primType")}):e(function(){return 4}):new K(y.thisDep,y.contextDep,y.propDep,function(a,d){var c=a.ELEMENTS;return d.def(c,"?",c,".primType:",4)}):h?new K(f.thisDep,f.contextDep,f.propDep,function(a,d){return d.def(a.shared.vao+".currentVAO?"+a.shared.vao+".currentVAO.primitive:4")}):null}(),I=function(){if("count"in l){var a=l.count|0;p.count=a;c.command("number"===typeof a&&0<=a,"invalid vertex count",g.commandStr);return e(function(){return a})}if("count"in
m){var d=m.count;return k(d,function(a,g){var r=a.invoke(g,d);c.optional(function(){a.assert(g,"typeof "+r+'==="number"&&'+r+">=0&&"+r+"===("+r+"|0)","invalid vertex count")});return r})}if(H){if(L(y)){if(y)return w?new K(w.thisDep,w.contextDep,w.propDep,function(a,d){var g=d.def(a.ELEMENTS,".vertCount-",a.OFFSET);c.optional(function(){a.assert(d,g+">=0","invalid vertex offset/element buffer too small")});return g}):e(function(a,d){return d.def(a.ELEMENTS,".vertCount")});var r=e(function(){return-1});
...
count:I,instances:t,offset:w,vao:f,vaoActive:h,elementsActive:H,"static":p}}function Q(a,d){var g=a["static"],r=a.dynamic,m={};ua.forEach(function(a){function p(d,c){if(a in g){var l=d(g[a]);m[f]=e(function(){return l})}else if(a in r){var h=r[a];m[f]=k(h,function(a,d){return c(a,d,a.invoke(d,h))})}}var f=P(a);switch(a){case "cull.enable":case "blend.enable":case "dither":case "stencil.enable":case "depth.enable":case "scissor.enable":case "polygonOffset.enable":case "sample.alpha":case "sample.enable":case "depth.mask":return p(function(g){c.commandType(g,
"boolean",a,d.commandStr);return g},function(d,g,r){c.optional(function(){d.assert(g,"typeof "+r+'==="boolean"',"invalid flag "+a,d.commandStr)});return r});case "depth.func":return p(function(g){c.commandParameter(g,l,"invalid "+a,d.commandStr);return l[g]},function(d,g,r){var p=d.constants.compareFuncs;c.optional(function(){d.assert(g,r+" in "+p,"invalid "+a+", must be one of "+q(l))});return g.def(p,"[",r,"]")});case "depth.range":return p(function(a){c.command(u(a)&&2===a.length&&"number"===typeof a[0]&&
...
a.src,p="dstRGB"in a?a.dstRGB:a.dst;a="dstAlpha"in a?a.dstAlpha:a.dst;c.commandParameter(g,R,f+".srcRGB",d.commandStr);c.commandParameter(r,R,f+".srcAlpha",d.commandStr);c.commandParameter(p,R,f+".dstRGB",d.commandStr);c.commandParameter(a,R,f+".dstAlpha",d.commandStr);c.command(-1===ia.indexOf(g+", "+p),"unallowed blending combination (srcRGB, dstRGB) = ("+g+", "+p+")",d.commandStr);return[R[g],R[p],R[r],R[a]]},function(d,g,r){function p(m,h){var f=g.def('"',m,h,'" in ',r,"?",r,".",m,h,":",r,".",
m);c.optional(function(){d.assert(g,f+" in "+l,"invalid "+a+"."+m+h+", must be one of "+q(R))});return f}var l=d.constants.blendFuncs;c.optional(function(){d.assert(g,r+"&&typeof "+r+'==="object"',"invalid blend func, must be an object")});var m=p("src","RGB"),h=p("dst","RGB");c.optional(function(){d.assert(g,d.constants.invalidBlendCombinations+".indexOf("+m+'+", "+'+h+") === -1 ","unallowed blending combination for (srcRGB, dstRGB)")});var f=g.def(l,"[",m,"]"),k=g.def(l,"[",p("src","Alpha"),"]"),
H=g.def(l,"[",h,"]"),y=g.def(l,"[",p("dst","Alpha"),"]");return[f,H,k,y]});case "blend.equation":return p(function(g){if("string"===typeof g)return c.commandParameter(g,Ca,"invalid "+a,d.commandStr),[Ca[g],Ca[g]];if("object"===typeof g)return c.commandParameter(g.rgb,Ca,a+".rgb",d.commandStr),c.commandParameter(g.alpha,Ca,a+".alpha",d.commandStr),[Ca[g.rgb],Ca[g.alpha]];c.commandRaise("invalid blend.equation",d.commandStr)},function(d,g,r){var p=d.constants.blendEquations,l=g.def(),m=g.def(),h=d.cond("typeof ",
r,'==="string"');c.optional(function(){function g(a,c,r){d.assert(a,r+" in "+p,"invalid "+c+", must be one of "+q(Ca))}g(h.then,a,r);d.assert(h["else"],r+"&&typeof "+r+'==="object"',"invalid "+a);g(h["else"],a+".rgb",r+".rgb");g(h["else"],a+".alpha",r+".alpha")});h.then(l,"=",m,"=",p,"[",r,"];");h["else"](l,"=",p,"[",r,".rgb];",m,"=",p,"[",r,".alpha];");g(h);return[l,m]});case "blend.color":return p(function(a){c.command(u(a)&&4===a.length,"blend.color must be a 4d array",d.commandStr);return G(4,
...
"boolean"===typeof r)l=e(function(){return r});else if("function"===typeof r){var m=r._reglType;"texture2d"===m||"textureCube"===m?l=e(function(a){return a.link(r)}):"framebuffer"===m||"framebufferCube"===m?(c.command(0<r.color.length,'missing color attachment for framebuffer sent to uniform "'+a+'"',d.commandStr),l=e(function(a){return a.link(r.color[0])})):c.commandRaise('invalid data for uniform "'+a+'"',d.commandStr)}else u(r)?l=e(function(d){return d.global.def("[",G(r.length,function(g){c.command("number"===
typeof r[g]||"boolean"===typeof r[g],"invalid uniform "+a,d.commandStr);return r[g]}),"]")}):c.commandRaise('invalid or missing data for uniform "'+a+'"',d.commandStr);l.value=r;p[a]=l});q(r).forEach(function(a){var d=r[a];p[a]=k(d,function(a,g){return a.invoke(g,d)})});return p}function qa(a,d){var g=a["static"],r=a.dynamic,p={};q(g).forEach(function(a){var r=g[a],l=w.id(a),m=new sa;if(b(r))m.state=1,m.buffer=E.getBuffer(E.create(r,34962,!1,!0)),m.type=0;else{var h=E.getBuffer(r);if(h)m.state=1,
m.buffer=h,m.type=0;else if(c.command("object"===typeof r&&r,"invalid data for attribute "+a,d.commandStr),"constant"in r){var f=r.constant;m.buffer="null";m.state=2;"number"===typeof f?m.x=f:(c.command(u(f)&&0<f.length&&4>=f.length,"invalid constant for attribute "+a,d.commandStr),T.forEach(function(a,d){d<f.length&&(m[a]=f[d])}))}else{h=b(r.buffer)?E.getBuffer(E.create(r.buffer,34962,!1,!0)):E.getBuffer(r.buffer);c.command(!!h,'missing buffer for attribute "'+a+'"',d.commandStr);var k=r.offset|
0;c.command(0<=k,'invalid offset for attribute "'+a+'"',d.commandStr);var H=r.stride|0;c.command(0<=H&&256>H,'invalid stride for attribute "'+a+'", must be integer betweeen [0, 255]',d.commandStr);var y=r.size|0;c.command(!("size"in r)||0<y&&4>=y,'invalid size for attribute "'+a+'", must be 1,2,3,4',d.commandStr);var na=!!r.normalized,I=0;"type"in r&&(c.commandParameter(r.type,v,"invalid type for attribute "+a,d.commandStr),I=v[r.type]);var t=r.divisor|0;c.optional(function(){"divisor"in r&&(c.command(0===
t||ra,'cannot specify divisor for attribute "'+a+'", instancing not supported',d.commandStr),c.command(0<=t,'invalid divisor for attribute "'+a+'"',d.commandStr));var g=d.commandStr,p="buffer offset divisor normalized type size stride".split(" ");q(r).forEach(function(d){c.command(0<=p.indexOf(d),'unknown parameter "'+d+'" for attribute pointer "'+a+'" (valid parameters are '+p+")",g)})});m.buffer=h;m.state=1;m.size=y;m.normalized=na;m.type=I||h.dtype;m.offset=k;m.stride=H;m.divisor=t}}p[a]=e(function(a,
d){var g=a.attribCache;if(l in g)return g[l];var r={isStream:!1};q(m).forEach(function(a){r[a]=m[a]});m.buffer&&(r.buffer=a.link(m.buffer),r.type=r.type||r.buffer+".dtype");return g[l]=r})});q(r).forEach(function(a){var d=r[a];p[a]=k(d,function(g,r){function p(a){r(H[a],"=",m,".",a,"|0;")}var m=g.invoke(r,d),l=g.shared,h=g.constants,f=l.isBufferArgs,k=l.buffer;c.optional(function(){g.assert(r,m+"&&(typeof "+m+'==="object"||typeof '+m+'==="function")&&('+f+"("+m+")||"+k+".getBuffer("+m+")||"+k+".getBuffer("+
m+".buffer)||"+f+"("+m+'.buffer)||("constant" in '+m+"&&(typeof "+m+'.constant==="number"||'+l.isArrayLike+"("+m+".constant))))",'invalid dynamic attribute "'+a+'"')});var H={isStream:r.def(!1)},y=new sa;y.state=1;q(y).forEach(function(a){H[a]=r.def(""+y[a])});var w=H.buffer,na=H.type;r("if(",f,"(",m,")){",H.isStream,"=true;",w,"=",k,".createStream(",34962,",",m,");",na,"=",w,".dtype;","}else{",w,"=",k,".getBuffer(",m,");","if(",w,"){",na,"=",w,".dtype;",'}else if("constant" in ',m,"){",H.state,"=",
2,";","if(typeof "+m+'.constant === "number"){',H[T[0]],"=",m,".constant;",T.slice(1).map(function(a){return H[a]}).join("="),"=0;","}else{",T.map(function(a,d){return H[a]+"="+m+".constant.length>"+d+"?"+m+".constant["+d+"]:0;"}).join(""),"}}else{","if(",f,"(",m,".buffer)){",w,"=",k,".createStream(",34962,",",m,".buffer);","}else{",w,"=",k,".getBuffer(",m,".buffer);","}",na,'="type" in ',m,"?",h.glTypes,"[",m,".type]:",w,".dtype;",H.normalized,"=!!",m,".normalized;");p("size");p("offset");p("stride");
p("divisor");r("}}");r.exit("if(",H.isStream,"){",k,".destroyStream(",w,");","}");return H})});return p}function Aa(a){var d=a["static"],g=a.dynamic,r={};q(d).forEach(function(a){var g=d[a];r[a]=e(function(a,d){return"number"===typeof g||"boolean"===typeof g?""+g:a.link(g)})});q(g).forEach(function(a){var d=g[a];r[a]=k(d,function(a,g){return a.invoke(g,d)})});return r}function wa(a,d,g,r,p){function l(a){var d=y[a];d&&(na[a]=d)}var h=a["static"],f=a.dynamic;c.optional(function(){function a(g){q(g).forEach(function(a){c.command(0<=
d.indexOf(a),'unknown parameter "'+a+'"',p.commandStr)})}var d="framebuffer vert frag elements primitive offset count instances profile vao".split(" ").concat(ua);a(h);a(f)});var k=m(a,d),H=Da(a,p),y=pa(a,H,p),w=aa(a,p),na=Q(a,p),I=J(a,p,k);l("viewport");l(P("scissor.box"));var t=0<q(na).length,H={framebuffer:H,draw:w,shader:I,state:na,dirty:t,scopeVAO:null,drawVAO:null,useVAO:!1,attributes:{}};H.profile=M(a,p);H.uniforms=ma(g,p);H.drawVAO=H.scopeVAO=w.vao;if(!H.drawVAO&&I.program&&!k&&n.angle_instanced_arrays&&
w["static"].elements){var sa=!0;a=I.program.attributes.map(function(a){a=d["static"][a];sa=sa&&!!a;return a});if(sa&&0<a.length){var Ja=A.getVAO(A.createVAO({attributes:a,elements:w["static"].elements}));H.drawVAO=new K(null,null,null,function(a,d){return a.link(Ja)});H.useVAO=!0}}k?H.useVAO=!0:H.attributes=qa(d,p);H.context=Aa(r,p);return H}function fa(a,d,g){var r=a.shared.context,c=a.scope();q(g).forEach(function(m){d.save(r,"."+m);var p=g[m].append(a,d);Array.isArray(p)?c(r,".",m,"=[",p.join(),
"];"):c(r,".",m,"=",p,";")});d(c)}function Ba(a,d,g,r){var c=a.shared,m=c.gl,p=c.framebuffer,l;xa&&(l=d.def(c.extensions,".webgl_draw_buffers"));var h=a.constants,c=h.drawBuffer,h=h.backBuffer;a=g?g.append(a,d):d.def(p,".next");r||d("if(",a,"!==",p,".cur){");d("if(",a,"){",m,".bindFramebuffer(",36160,",",a,".framebuffer);");xa&&d(l,".drawBuffersWEBGL(",c,"[",a,".colorAttachments.length]);");d("}else{",m,".bindFramebuffer(",36160,",null);");xa&&d(l,".drawBuffersWEBGL(",h,");");d("}",p,".cur=",a,";");
r||d("}")}function ka(a,d,g){var r=a.shared,c=r.gl,m=a.current,p=a.next,l=r.current,h=r.next,f=a.cond(l,".dirty");ua.forEach(function(d){d=P(d);if(!(d in g.state)){var r,k;if(d in p){r=p[d];k=m[d];var H=G(la[d].length,function(a){return f.def(r,"[",a,"]")});f(a.cond(H.map(function(a,d){return a+"!=="+k+"["+d+"]"}).join("||")).then(c,".",za[d],"(",H,");",H.map(function(a,d){return k+"["+d+"]="+a}).join(";"),";"))}else r=f.def(h,".",d),H=a.cond(r,"!==",l,".",d),f(H),d in Ia?H(a.cond(r).then(c,".enable(",
Ia[d],");")["else"](c,".disable(",Ia[d],");"),l,".",d,"=",r,";"):H(c,".",za[d],"(",r,");",l,".",d,"=",r,";")}});0===q(g.state).length&&f(l,".dirty=false;");d(f)}function oa(a,d,g,r){var c=a.shared,m=a.current,p=c.current,l=c.gl;ca(q(g)).forEach(function(c){var h=g[c];if(!r||r(h)){var f=h.append(a,d);if(Ia[c]){var H=Ia[c];L(h)?f?d(l,".enable(",H,");"):d(l,".disable(",H,");"):d(a.cond(f).then(l,".enable(",H,");")["else"](l,".disable(",H,");"));d(p,".",c,"=",f,";")}else if(u(f)){var k=m[c];d(l,".",za[c],
"(",f,");",f.map(function(a,d){return k+"["+d+"]="+a}).join(";"),";")}else d(l,".",za[c],"(",f,");",p,".",c,"=",f,";")}})}function ya(a,d){ra&&(a.instancing=d.def(a.shared.extensions,".angle_instanced_arrays"))}function Ja(a,d,g,r,c){function m(){return"undefined"===typeof performance?"Date.now()":"performance.now()"}function p(a){w=d.def();a(w,"=",m(),";");"string"===typeof c?a(H,".count+=",c,";"):a(H,".count++;");ea&&(r?(na=d.def(),a(na,"=",y,".getNumPendingQueries();")):a(y,".beginQuery(",H,");"))}
function l(a){a(H,".cpuTime+=",m(),"-",w,";");ea&&(r?a(y,".pushScopeStats(",na,",",y,".getNumPendingQueries(),",H,");"):a(y,".endQuery();"))}function h(a){var g=d.def(k,".profile");d(k,".profile=",a,";");d.exit(k,".profile=",g,";")}var f=a.shared,H=a.stats,k=f.current,y=f.timer;g=g.profile;var w,na;if(g){if(L(g)){g.enable?(p(d),l(d.exit),h("true")):h("false");return}g=g.append(a,d);h(g)}else g=d.def(k,".profile");f=a.block();p(f);d("if(",g,"){",f,"}");a=a.block();l(a);d.exit("if(",g,"){",a,"}")}function na(a,
d,g,r,m){function p(a){switch(a){case 35664:case 35667:case 35671:return 2;case 35665:case 35668:case 35672:return 3;case 35666:case 35669:case 35673:return 4;default:return 1}}function l(g,r,c){function m(){d("if(!",k,".buffer){",f,".enableVertexAttribArray(",H,");}");var g=c.type,p;p=c.size?d.def(c.size,"||",r):r;d("if(",k,".type!==",g,"||",k,".size!==",p,"||",na.map(function(a){return k+"."+a+"!=="+c[a]}).join("||"),"){",f,".bindBuffer(",34962,",",y,".buffer);",f,".vertexAttribPointer(",[H,p,g,
c.normalized,c.stride,c.offset],");",k,".type=",g,";",k,".size=",p,";",na.map(function(a){return k+"."+a+"="+c[a]+";"}).join(""),"}");ra&&(g=c.divisor,d("if(",k,".divisor!==",g,"){",a.instancing,".vertexAttribDivisorANGLE(",[H,g],");",k,".divisor=",g,";}"))}function p(){d("if(",k,".buffer){",f,".disableVertexAttribArray(",H,");",k,".buffer=null;","}if(",T.map(function(a,d){return k+"."+a+"!=="+w[d]}).join("||"),"){",f,".vertexAttrib4f(",H,",",w,");",T.map(function(a,d){return k+"."+a+"="+w[d]+";"}).join(""),
"}")}var f=h.gl,H=d.def(g,".location"),k=d.def(h.attributes,"[",H,"]");g=c.state;var y=c.buffer,w=[c.x,c.y,c.z,c.w],na=["buffer","normalized","offset","stride"];1===g?m():2===g?p():(d("if(",g,"===",1,"){"),m(),d("}else{"),p(),d("}"))}var h=a.shared;r.forEach(function(r){var h=r.name,f=g.attributes[h],k;if(f){if(!m(f))return;k=f.append(a,d)}else{if(!m(X))return;var H=a.scopeAttrib(h);c.optional(function(){a.assert(d,H+".state","missing attribute "+h)});k={};q(new sa).forEach(function(a){k[a]=d.def(H,
".",a)})}l(a.link(r),p(r.info.type),k)})}function Xa(a,d,g,r,p,m){for(var l=a.shared,h=l.gl,f,k=0;k<r.length;++k){var H=r[k],y=H.name,na=H.info.type,I=g.uniforms[y],H=a.link(H)+".location",q;if(I){if(!p(I))continue;if(L(I)){var t=I.value;c.command(null!==t&&"undefined"!==typeof t,'missing uniform "'+y+'"',a.commandStr);if(35678===na||35680===na)c.command("function"===typeof t&&(35678===na&&("texture2d"===t._reglType||"framebuffer"===t._reglType)||35680===na&&("textureCube"===t._reglType||"framebufferCube"===
t._reglType)),"invalid texture for uniform "+y,a.commandStr),I=a.link(t._texture||t.color[0]._texture),d(h,".uniform1i(",H,",",I+".bind());"),d.exit(I,".unbind();");else if(35674===na||35675===na||35676===na){c.optional(function(){c.command(u(t),"invalid matrix for uniform "+y,a.commandStr);c.command(35674===na&&4===t.length||35675===na&&9===t.length||35676===na&&16===t.length,"invalid length for matrix uniform "+y,a.commandStr)});var I=a.global.def("new Float32Array(["+Array.prototype.slice.call(t)+
"])"),P=2;35675===na?P=3:35676===na&&(P=4);d(h,".uniformMatrix",P,"fv(",H,",false,",I,");")}else{switch(na){case 5126:c.commandType(t,"number","uniform "+y,a.commandStr);f="1f";break;case 35664:c.command(u(t)&&2===t.length,"uniform "+y,a.commandStr);f="2f";break;case 35665:c.command(u(t)&&3===t.length,"uniform "+y,a.commandStr);f="3f";break;case 35666:c.command(u(t)&&4===t.length,"uniform "+y,a.commandStr);f="4f";break;case 35670:c.commandType(t,"boolean","uniform "+y,a.commandStr);f="1i";break;case 5124:c.commandType(t,
...
a.commandStr),f="4i"}d(h,".uniform",f,"(",H,",",u(t)?Array.prototype.slice.call(t):t,");")}continue}else q=I.append(a,d)}else{if(!p(X))continue;q=d.def(l.uniforms,"[",w.id(y),"]")}35678===na?(c(!Array.isArray(q),"must specify a scalar prop for textures"),d("if(",q,"&&",q,'._reglType==="framebuffer"){',q,"=",q,".color[0];","}")):35680===na&&(c(!Array.isArray(q),"must specify a scalar prop for cube maps"),d("if(",q,"&&",q,'._reglType==="framebufferCube"){',q,"=",q,".color[0];","}"));c.optional(function(){function g(r,
...
"number");break;case 35678:p(3553);break;case 35680:p(34067)}});I=1;switch(na){case 35678:case 35680:I=d.def(q,"._texture");d(h,".uniform1i(",H,",",I,".bind());");d.exit(I,".unbind();");continue;case 5124:case 35670:f="1i";break;case 35667:case 35671:f="2i";I=2;break;case 35668:case 35672:f="3i";I=3;break;case 35669:case 35673:f="4i";I=4;break;case 5126:f="1f";break;case 35664:f="2f";I=2;break;case 35665:f="3f";I=3;break;case 35666:f="4f";I=4;break;case 35674:f="Matrix2fv";break;case 35675:f="Matrix3fv";
break;case 35676:f="Matrix4fv"}if("M"===f.charAt(0)){d(h,".uniform",f,"(",H,",");var H=Math.pow(na-35674+2,2),sa=a.global.def("new Float32Array(",H,")");Array.isArray(q)?d("false,(",G(H,function(a){return sa+"["+a+"]="+q[a]}),",",sa,")"):d("false,(Array.isArray(",q,")||",q," instanceof Float32Array)?",q,":(",G(H,function(a){return sa+"["+a+"]="+q+"["+a+"]"}),",",sa,")");d(");")}else{if(1<I){for(var P=[],Ja=[],Ca=0;Ca<I;++Ca)Array.isArray(q)?Ja.push(q[Ca]):Ja.push(d.def(q+"["+Ca+"]")),m&&P.push(d.def());
m&&d("if(!",a.batchId,"||",P.map(function(a,d){return a+"!=="+Ja[d]}).join("||"),"){",P.map(function(a,d){return a+"="+Ja[d]+";"}).join(""));d(h,".uniform",f,"(",H,",",Ja.join(","),");")}else c(!Array.isArray(q),"uniform value must not be an array"),m&&(I=d.def(),d("if(!",a.batchId,"||",I,"!==",q,"){",I,"=",q,";")),d(h,".uniform",f,"(",H,",",q,");");m&&d("}")}}}function Ta(a,d,g,r){function m(c){var p=k[c];return p?p.contextDep&&r.contextDynamic||p.propDep?p.append(a,g):p.append(a,d):d.def(H,".",
c)}function p(){function a(){g(I,".drawElementsInstancedANGLE(",[na,t,P,w+"<<(("+P+"-5121)>>1)",q],");")}function d(){g(I,".drawArraysInstancedANGLE(",[na,w,t,q],");")}y&&"null"!==y?sa?a():(g("if(",y,"){"),a(),g("}else{"),d(),g("}")):d()}function l(){function a(){g(h+".drawElements("+[na,t,P,w+"<<(("+P+"-5121)>>1)"]+");")}function d(){g(h+".drawArrays("+[na,w,t]+");")}y&&"null"!==y?sa?a():(g("if(",y,"){"),a(),g("}else{"),d(),g("}")):d()}var f=a.shared,h=f.gl,H=f.draw,k=r.draw,y=function(){var c=k.elements,
m=d;if(c){if(c.contextDep&&r.contextDynamic||c.propDep)m=g;c=c.append(a,m);k.elementsActive&&m("if("+c+")"+h+".bindBuffer(34963,"+c+".buffer.buffer);")}else c=m.def(),m(c,"=",H,".","elements",";","if(",c,"){",h,".bindBuffer(",34963,",",c,".buffer.buffer);}","else if(",f.vao,".currentVAO){",c,"=",a.shared.elements+".getElements("+f.vao,".currentVAO.elements);",Fa?"":"if("+c+")"+h+".bindBuffer(34963,"+c+".buffer.buffer);","}");return c}(),na=m("primitive"),w=m("offset"),t=function(){var m=k.count,p,
l=d;if(m){if(m.contextDep&&r.contextDynamic||m.propDep)l=g;p=m.append(a,l);c.optional(function(){m.MISSING&&a.assert(d,"false","missing vertex count");m.DYNAMIC&&a.assert(l,p+">=0","missing vertex count")})}else p=l.def(H,".","count"),c.optional(function(){a.assert(l,p+">=0","missing vertex count")});return p}();if("number"===typeof t){if(0===t)return}else g("if(",t,"){"),g.exit("}");var q,I;ra&&(q=m("instances"),I=a.instancing);var P=y+".type",sa=k.elements&&L(k.elements)&&!k.vaoActive;ra&&("number"!==
typeof q||0<=q)?"string"===typeof q?(g("if(",q,">0){"),p(),g("}else if(",q,"<0){"),l(),g("}")):p():l()}function r(a,d,g,r,m){var p=N();m=p.proc("body",m);c.optional(function(){p.commandStr=d.commandStr;p.command=p.link(d.commandStr)});ra&&(p.instancing=m.def(p.shared.extensions,".angle_instanced_arrays"));a(p,m,g,r);return p.compile().body}function p(a,d,g,r){ya(a,d);g.useVAO?g.drawVAO?d(a.shared.vao,".setVAO(",g.drawVAO.append(a,d),");"):d(a.shared.vao,".setVAO(",a.shared.vao,".targetVAO);"):(d(a.shared.vao,
".setVAO(null);"),na(a,d,g,r.attributes,function(){return!0}));Xa(a,d,g,r.uniforms,function(){return!0},!1);Ta(a,d,d,g)}function y(a,d){var g=a.proc("draw",1);ya(a,g);fa(a,g,d.context);Ba(a,g,d.framebuffer);ka(a,g,d);oa(a,g,d.state);Ja(a,g,d,!1,!0);var c=d.shader.progVar.append(a,g);g(a.shared.gl,".useProgram(",c,".program);");if(d.shader.program)p(a,g,d,d.shader.program);else{g(a.shared.vao,".setVAO(null);");var m=a.global.def("{}"),l=g.def(c,".id"),f=g.def(m,"[",l,"]");g(a.cond(f).then(f,".call(this,a0);")["else"](f,
"=",m,"[",l,"]=",a.link(function(g){return r(p,a,d,g,1)}),"(",c,");",f,".call(this,a0);"))}0<q(d.state).length&&g(a.shared.current,".dirty=true;");a.shared.vao&&g(a.shared.vao,".setVAO(null);")}function va(a,d,g,r){function c(){return!0}a.batchId="a1";ya(a,d);na(a,d,g,r.attributes,c);Xa(a,d,g,r.uniforms,c,!1);Ta(a,d,d,g)}function Ea(a,d,g,c){function m(a){return a.contextDep&&l||a.propDep}function p(a){return!m(a)}ya(a,d);var l=g.contextDep,f=d.def(),h=d.def();a.shared.props=h;a.batchId=f;var H=a.scope(),
k=a.scope();d(H.entry,"for(",f,"=0;",f,"<","a1",";++",f,"){",h,"=","a0","[",f,"];",k,"}",H.exit);g.needsContext&&fa(a,k,g.context);g.needsFramebuffer&&Ba(a,k,g.framebuffer);oa(a,k,g.state,m);g.profile&&m(g.profile)&&Ja(a,k,g,!1,!0);c?(g.useVAO?g.drawVAO?m(g.drawVAO)?k(a.shared.vao,".setVAO(",g.drawVAO.append(a,k),");"):H(a.shared.vao,".setVAO(",g.drawVAO.append(a,H),");"):H(a.shared.vao,".setVAO(",a.shared.vao,".targetVAO);"):(H(a.shared.vao,".setVAO(null);"),na(a,H,g,c.attributes,p),na(a,k,g,c.attributes,
m)),Xa(a,H,g,c.uniforms,p,!1),Xa(a,k,g,c.uniforms,m,!0),Ta(a,H,k,g)):(d=a.global.def("{}"),c=g.shader.progVar.append(a,k),h=k.def(c,".id"),H=k.def(d,"[",h,"]"),k(a.shared.gl,".useProgram(",c,".program);","if(!",H,"){",H,"=",d,"[",h,"]=",a.link(function(d){return r(va,a,g,d,2)}),"(",c,");}",H,".call(this,a0[",f,"],",f,");"))}function Bd(a,d){function g(a){return a.contextDep&&m||a.propDep}var c=a.proc("batch",2);a.batchId="0";ya(a,c);var m=!1,p=!0;q(d.context).forEach(function(a){m=m||d.context[a].propDep});
...
timer:ea,isBufferArgs:b},da={primTypes:ba,compareFuncs:l,blendFuncs:R,blendEquations:Ca,stencilOps:t,glTypes:v,orientationType:h};c.optional(function(){mb.isArrayLike=u});xa&&(da.backBuffer=[1029],da.drawBuffer=G(D.maxDrawbuffers,function(a){return 0===a?[0]:G(a,function(a){return 36064+a})}));var xd=0;return{next:W,current:la,procs:function(){var a=N(),d=a.proc("poll"),g=a.proc("refresh"),r=a.block();d(r);g(r);var c=a.shared,m=c.gl,p=c.next,l=c.current;r(l,".dirty=false;");Ba(a,d);Ba(a,g,null,!0);
var f;ra&&(f=a.link(ra));n.oes_vertex_array_object&&g(a.link(n.oes_vertex_array_object),".bindVertexArrayOES(null);");for(var h=0;h<D.maxAttributes;++h){var H=g.def(c.attributes,"[",h,"]"),k=a.cond(H,".buffer");k.then(m,".enableVertexAttribArray(",h,");",m,".bindBuffer(",34962,",",H,".buffer.buffer);",m,".vertexAttribPointer(",h,",",H,".size,",H,".type,",H,".normalized,",H,".stride,",H,".offset);")["else"](m,".disableVertexAttribArray(",h,");",m,".vertexAttrib4f(",h,",",H,".x,",H,".y,",H,".z,",H,
".w);",H,".buffer=null;");g(k);ra&&g(f,".vertexAttribDivisorANGLE(",h,",",H,".divisor);")}g(a.shared.vao,".currentVAO=null;",a.shared.vao,".setVAO(",a.shared.vao,".targetVAO);");q(Ia).forEach(function(c){var f=Ia[c],h=r.def(p,".",c),H=a.block();H("if(",h,"){",m,".enable(",f,")}else{",m,".disable(",f,")}",l,".",c,"=",h,";");g(H);d("if(",h,"!==",l,".",c,"){",H,"}")});q(za).forEach(function(c){var f=za[c],h=la[c],H,k,y=a.block();y(m,".",f,"(");u(h)?(f=h.length,H=a.global.def(p,".",c),k=a.global.def(l,
".",c),y(G(f,function(a){return H+"["+a+"]"}),");",G(f,function(a){return k+"["+a+"]="+H+"["+a+"];"}).join("")),d("if(",G(f,function(a){return H+"["+a+"]!=="+k+"["+a+"]"}).join("||"),"){",y,"}")):(H=r.def(p,".",c),k=r.def(l,".",c),y(H,");",l,".",c,"=",H,";"),d("if(",H,"!==",k,"){",y,"}"));g(y)});return a.compile()}(),compile:function(a,d,g,r,c){var m=N();m.stats=m.link(c);q(d["static"]).forEach(function(a){H(m,d,a)});z.forEach(function(d){H(m,a,d)});var p=wa(a,d,g,r,m);y(m,p);Hb(m,p);Bd(m,p);return F(m.compile(),
...
c))return['"'+k.substr(1,k.length-2).replace(/\\/g,"\\\\").replace(/"/g,'\\"')+'"'];if(c=/\[(false|true|null|\d+|'[^']*'|"[^"]*")\]/.exec(k))return ca(k.substr(0,c.index)).concat(ca(c[1])).concat(ca(k.substr(c.index+c[0].length)));c=k.split(".");if(1===c.length)return['"'+k.replace(/\\/g,"\\\\").replace(/"/g,'\\"')+'"'];k=[];for(e=0;e<c.length;++e)k=k.concat(ca(c[e]));return k}function K(k){return"["+ca(k).join("][")+"]"}function L(k,c){if("function"===typeof k)return new b(0,k);if("number"===typeof k||
"boolean"===typeof k)return new b(5,k);if(Array.isArray(k))return new b(6,k.map(function(k,q){return L(k,c+"["+q+"]")}));if(k instanceof b)return k;e(!1,"invalid option type in uniform "+c)}var e=Z("./util/check"),k=0;ha.exports={DynamicVariable:b,define:function(k,c){return new b(k,K(c+""))},isDynamic:function(k){return"function"===typeof k&&!k._reglType||k instanceof b},unbox:L,accessor:K}},{"./util/check":21}],10:[function(Z,ha,ab){var b=Z("./util/check"),ca=Z("./util/is-typed-array"),K=Z("./util/is-ndarray"),
L=Z("./util/values"),e=Z("./constants/primitives.json"),k=Z("./constants/usage.json");ha.exports=function(q,c,F,B){function G(c){this.id=x++;u[this.id]=this;this.buffer=c;this.primType=4;this.type=this.vertCount=0}function U(k,e,v,u,l,t,S){k.buffer.bind();var h;e?((h=S)||ca(e)&&(!K(e)||ca(e.data))||(h=c.oes_element_index_uint?5125:5123),F._initBuffer(k.buffer,e,v,h,3)):(q.bufferData(34963,t,v),k.buffer.dtype=h||5121,k.buffer.usage=v,k.buffer.dimension=3,k.buffer.byteLength=t);h=S;if(!S){switch(k.buffer.dtype){case 5121:case 5120:h=
5121;break;case 5123:case 5122:h=5123;break;case 5125:case 5124:h=5125;break;default:b.raise("unsupported type for element array")}k.buffer.dtype=h}k.type=h;b(5125!==h||!!c.oes_element_index_uint,"32 bit element buffers not supported, enable oes_element_index_uint first");e=l;0>e&&(e=k.buffer.byteLength,5123===h?e>>=1:5125===h&&(e>>=2));k.vertCount=e;e=u;0>u&&(e=4,u=k.buffer.dimension,1===u&&(e=0),2===u&&(e=1),3===u&&(e=4));k.primType=e}function n(c){B.elementsCount--;b(null!==c.buffer,"must not double destroy elements");
delete u[c.id];c.buffer.destroy();c.buffer=null}var u={},x=0,ba={uint8:5121,uint16:5123};c.oes_element_index_uint&&(ba.uint32=5125);G.prototype.bind=function(){this.buffer.bind()};var v=[];return{create:function(c,q){function v(c){if(c)if("number"===typeof c)u(c),l.primType=4,l.vertCount=c|0,l.type=5121;else{var q=null,h=35044,z=-1,f=-1,w=0,n=0;if(Array.isArray(c)||ca(c)||K(c))q=c;else if(b.type(c,"object","invalid arguments for elements"),"data"in c&&(q=c.data,b(Array.isArray(q)||ca(q)||K(q),"invalid data for element buffer")),
"usage"in c&&(b.parameter(c.usage,k,"invalid element buffer usage"),h=k[c.usage]),"primitive"in c&&(b.parameter(c.primitive,e,"invalid element buffer primitive"),z=e[c.primitive]),"count"in c&&(b("number"===typeof c.count&&0<=c.count,"invalid vertex count for elements"),f=c.count|0),"type"in c&&(b.parameter(c.type,ba,"invalid buffer type"),n=ba[c.type]),"length"in c)w=c.length|0;else if(w=f,5123===n||5122===n)w*=2;else if(5125===n||5124===n)w*=4;U(l,q,h,z,f,w,n)}else u(),l.primType=4,l.vertCount=
0,l.type=5121;return v}var u=F.create(null,34963,!0),l=new G(u._buffer);B.elementsCount++;v(c);v._reglType="elements";v._elements=l;v.subdata=function(c,l){u.subdata(c,l);return v};v.destroy=function(){n(l)};return v},createStream:function(c){var k=v.pop();k||(k=new G(F.create(null,34963,!0,!1)._buffer));U(k,c,35040,-1,-1,0,0);return k},destroyStream:function(c){v.push(c)},getElements:function(c){return"function"===typeof c&&c._elements instanceof G?c._elements:null},clear:function(){L(u).forEach(n)}}}},
{"./constants/primitives.json":6,"./constants/usage.json":7,"./util/check":21,"./util/is-ndarray":28,"./util/is-typed-array":30,"./util/values":36}],11:[function(Z,ha,ab){var b=Z("./util/sorted-object-keys"),ca=Z("./util/check");ha.exports=function(K,L){function e(c){ca.type(c,"string","extension name must be string");c=c.toLowerCase();var q;try{q=k[c]=K.getExtension(c)}catch(e){}return!!q}for(var k={},q=0;q<L.extensions.length;++q){var c=L.extensions[q];if(!e(c))return L.onDestroy(),L.onDone('"'+
c+'" extension is not supported by the current WebGL context, try upgrading your system or a different browser'),null}L.optionalExtensions.forEach(e);return{extensions:k,restore:function(){b(k).forEach(function(c){if(k[c]&&!e(c))throw Error("(regl): error restoring extension "+c);})}}}},{"./util/check":21,"./util/sorted-object-keys":34}],12:[function(Z,ha,ab){var b=Z("./util/check"),ca=Z("./util/values"),K=Z("./util/extend"),L=[6407,6408],e=[];e[6408]=4;e[6407]=3;var k=[];k[5121]=1;k[5126]=4;k[36193]=
...
d,c){if(a){if(a.texture){a=a.texture._texture;var l=Math.max(1,a.height);b(Math.max(1,a.width)===d&&l===c,"inconsistent width/height for supplied texture")}else a=a.renderbuffer._renderbuffer,b(a.width===d&&a.height===c,"inconsistent width/height for renderbuffer");a.refCount+=1}}function T(a,d){d&&(d.texture?F.framebufferTexture2D(36160,a,d.target,d.texture._texture.texture,0):F.framebufferRenderbuffer(36160,a,36161,d.renderbuffer._renderbuffer.renderbuffer))}function z(a){var d=3553,c=null,l=null,
k=a;"object"===typeof a&&(k=a.data,"target"in a&&(d=a.target|0));b.type(k,"function","invalid attachment data");a=k._reglType;"texture2d"===a?(c=k,b(3553===d)):"textureCube"===a?(c=k,b(34069<=d&&34075>d,"invalid cube map target")):"renderbuffer"===a?(l=k,d=36161):b.raise("invalid regl object for attachment");return new x(d,c,l)}function R(a,d,c,l,k){if(c)return a=U.create2D({width:a,height:d,format:l,type:k}),a._texture.refCount=0,new x(3553,a,null);a=n.create({width:a,height:d,format:l});a._renderbuffer.refCount=
0;return new x(36161,null,a)}function ia(a){return a&&(a.texture||a.renderbuffer)}function l(a,d,c){a&&(a.texture?a.texture.resize(d,c):a.renderbuffer&&a.renderbuffer.resize(d,c),a.width=d,a.height=c)}function t(){this.id=d++;I[this.id]=this;this.framebuffer=F.createFramebuffer();this.height=this.width=0;this.colorAttachments=[];this.depthStencilAttachment=this.stencilAttachment=this.depthAttachment=null}function S(a){a.colorAttachments.forEach(ba);ba(a.depthAttachment);ba(a.stencilAttachment);ba(a.depthStencilAttachment)}
function h(a){var d=a.framebuffer;b(d,"must not double destroy framebuffer");F.deleteFramebuffer(d);a.framebuffer=null;u.framebufferCount--;delete I[a.id]}function X(a){var d;F.bindFramebuffer(36160,a.framebuffer);var l=a.colorAttachments;for(d=0;d<l.length;++d)T(36064+d,l[d]);for(d=l.length;d<G.maxColorAttachments;++d)F.framebufferTexture2D(36160,36064+d,3553,null,0);F.framebufferTexture2D(36160,33306,3553,null,0);F.framebufferTexture2D(36160,36096,3553,null,0);F.framebufferTexture2D(36160,36128,
3553,null,0);T(36096,a.depthAttachment);T(36128,a.stencilAttachment);T(33306,a.depthStencilAttachment);a=F.checkFramebufferStatus(36160);F.isContextLost()||36053===a||b.raise("framebuffer configuration not supported, status = "+c[a]);F.bindFramebuffer(36160,w.next?w.next.framebuffer:null);w.cur=w.next;F.getError()}function f(a,d){function c(a,d){var l;b(w.next!==f,"can not update framebuffer which is currently in use");var h=0,I=0,t=!0,g=!0;l=null;var u=!0,M="rgba",n="uint8",U=1,m=null,J=null,aa=
null,Q=!1;if("number"===typeof a)h=a|0,I=d|0||h;else if(a){b.type(a,"object","invalid arguments for framebuffer");"shape"in a?(I=a.shape,b(Array.isArray(I)&&2<=I.length,"invalid shape for framebuffer"),h=I[0],I=I[1]):("radius"in a&&(h=I=a.radius),"width"in a&&(h=a.width),"height"in a&&(I=a.height));if("color"in a||"colors"in a)l=a.color||a.colors,Array.isArray(l)&&b(1===l.length||B.webgl_draw_buffers,"multiple render targets not supported");if(!l){"colorCount"in a&&(U=a.colorCount|0,b(0<U,"invalid color buffer count"));
...
a)Q=!(!a.depthTexture&&!a.depthStencilTexture),b(!Q||B.webgl_depth_texture,"webgl_depth_texture extension not supported");"depth"in a&&("boolean"===typeof a.depth?t=a.depth:(m=a.depth,g=!1));"stencil"in a&&("boolean"===typeof a.stencil?g=a.stencil:(J=a.stencil,t=!1));"depthStencil"in a&&("boolean"===typeof a.depthStencil?t=g=a.depthStencil:(aa=a.depthStencil,g=t=!1))}else h=I=1;var x=null,qa=null,T=null,wa=null;if(Array.isArray(l))x=l.map(z);else if(l)x=[z(l)];else for(x=Array(U),l=0;l<U;++l)x[l]=
R(h,I,u,M,n);b(B.webgl_draw_buffers||1>=x.length,"you must enable the WEBGL_draw_buffers extension in order to use multiple color buffers.");b(x.length<=G.maxColorAttachments,"too many color attachments, not supported");h=h||x[0].width;I=I||x[0].height;m?qa=z(m):t&&!g&&(qa=R(h,I,Q,"depth","uint32"));J?T=z(J):g&&!t&&(T=R(h,I,!1,"stencil","uint8"));aa?wa=z(aa):!m&&!J&&g&&t&&(wa=R(h,I,Q,"depth stencil","depth stencil"));b(1>=!!m+!!J+!!aa,"invalid framebuffer configuration, can specify exactly one depth/stencil attachment");
t=null;for(l=0;l<x.length;++l)v(x[l],h,I),b(!x[l]||x[l].texture&&0<=L.indexOf(x[l].texture._texture.format)||x[l].renderbuffer&&0<=q.indexOf(x[l].renderbuffer._renderbuffer.format),"framebuffer color attachment "+l+" is invalid"),x[l]&&x[l].texture&&(g=e[x[l].texture._texture.format]*k[x[l].texture._texture.type],null===t?t=g:b(t===g,"all color attachments much have the same number of bits per pixel."));v(qa,h,I);b(!qa||qa.texture&&6402===qa.texture._texture.format||qa.renderbuffer&&33189===qa.renderbuffer._renderbuffer.format,
"invalid depth attachment for framebuffer object");v(T,h,I);b(!T||T.renderbuffer&&36168===T.renderbuffer._renderbuffer.format,"invalid stencil attachment for framebuffer object");v(wa,h,I);b(!wa||wa.texture&&34041===wa.texture._texture.format||wa.renderbuffer&&34041===wa.renderbuffer._renderbuffer.format,"invalid depth-stencil attachment for framebuffer object");S(f);f.width=h;f.height=I;f.colorAttachments=x;f.depthAttachment=qa;f.stencilAttachment=T;f.depthStencilAttachment=wa;c.color=x.map(ia);
c.depth=ia(qa);c.stencil=ia(T);c.depthStencil=ia(wa);c.width=f.width;c.height=f.height;X(f);return c}var f=new t;u.framebufferCount++;c(a,d);return K(c,{resize:function(a,d){b(w.next!==f,"can not resize a framebuffer which is currently in use");var k=Math.max(a|0,1),h=Math.max(d|0||k,1);if(k===f.width&&h===f.height)return c;for(var I=f.colorAttachments,t=0;t<I.length;++t)l(I[t],k,h);l(f.depthAttachment,k,h);l(f.stencilAttachment,k,h);l(f.depthStencilAttachment,k,h);f.width=c.width=k;f.height=c.height=
h;X(f);return c},_reglType:"framebuffer",_framebuffer:f,destroy:function(){h(f);S(f)},use:function(a){w.setFBO({framebuffer:c},a)}})}var w={cur:null,next:null,dirty:!1,setFBO:null},Y=["rgba"],D=["rgba4","rgb565","rgb5 a1"];B.ext_srgb&&D.push("srgba");B.ext_color_buffer_half_float&&D.push("rgba16f","rgb16f");B.webgl_color_buffer_float&&D.push("rgba32f");var E=["uint8"];B.oes_texture_half_float&&E.push("half float","float16");B.oes_texture_float&&E.push("float","float32");var d=0,I={};return K(w,{getFramebuffer:function(a){return"function"===
typeof a&&"framebuffer"===a._reglType&&(a=a._framebuffer,a instanceof t)?a:null},create:f,createCube:function(a){function d(a){var l;b(0>c.indexOf(w.next),"can not update framebuffer which is currently in use");var k={color:null},h=0,I=null;l="rgba";var t="uint8",q=1;if("number"===typeof a)h=a|0;else if(a){b.type(a,"object","invalid arguments for framebuffer");"shape"in a?(h=a.shape,b(Array.isArray(h)&&2<=h.length,"invalid shape for framebuffer"),b(h[0]===h[1],"cube framebuffer must be square"),h=
h[0]):("radius"in a&&(h=a.radius|0),"width"in a?(h=a.width|0,"height"in a&&b(a.height===h,"must be square")):"height"in a&&(h=a.height|0));if("color"in a||"colors"in a)I=a.color||a.colors,Array.isArray(I)&&b(1===I.length||B.webgl_draw_buffers,"multiple render targets not supported");I||("colorCount"in a&&(q=a.colorCount|0,b(0<q,"invalid color buffer count")),"colorType"in a&&(b.oneOf(a.colorType,E,"invalid color type"),t=a.colorType),"colorFormat"in a&&(l=a.colorFormat,b.oneOf(a.colorFormat,Y,"invalid color format for texture")));
"depth"in a&&(k.depth=a.depth);"stencil"in a&&(k.stencil=a.stencil);"depthStencil"in a&&(k.depthStencil=a.depthStencil)}else h=1;if(I)if(Array.isArray(I))for(a=[],l=0;l<I.length;++l)a[l]=I[l];else a=[I];else for(a=Array(q),I={radius:h,format:l,type:t},l=0;l<q;++l)a[l]=U.createCube(I);k.color=Array(a.length);for(l=0;l<a.length;++l)q=a[l],b("function"===typeof q&&"textureCube"===q._reglType,"invalid cube map"),h=h||q.width,b(q.width===h&&q.height===h,"invalid cube map shape"),k.color[l]={target:34069,
data:a[l]};for(l=0;6>l;++l){for(q=0;q<a.length;++q)k.color[q].target=34069+l;0<l&&(k.depth=c[0].depth,k.stencil=c[0].stencil,k.depthStencil=c[0].depthStencil);if(c[l])c[l](k);else c[l]=f(k)}return K(d,{width:h,height:h,color:a})}var c=Array(6);d(a);return K(d,{faces:c,resize:function(a){var l=a|0;b(0<l&&l<=G.maxCubeMapSize,"invalid radius for cube fbo");if(l===d.width)return d;var k=d.color;for(a=0;a<k.length;++a)k[a].resize(l);for(a=0;6>a;++a)c[a].resize(l);d.width=d.height=l;return d},_reglType:"framebufferCube",
destroy:function(){c.forEach(function(a){a.destroy()})}})},clear:function(){ca(I).forEach(h)},restore:function(){w.cur=null;w.next=null;w.dirty=!0;ca(I).forEach(function(a){a.framebuffer=F.createFramebuffer();X(a)})}})}},{"./util/check":21,"./util/extend":25,"./util/values":36}],13:[function(Z,ha,ab){var b=Z("./util/sorted-object-keys"),ca=Z("./util/pool");ha.exports=function(K,L){var e=1;L.ext_texture_filter_anisotropic&&(e=K.getParameter(34047));var k=1,q=1;L.webgl_draw_buffers&&(k=K.getParameter(34852),
q=K.getParameter(36063));var c=!!L.oes_texture_float;if(c){c=K.createTexture();K.bindTexture(3553,c);K.texImage2D(3553,0,6408,1,1,0,6408,5126,null);var F=K.createFramebuffer();K.bindFramebuffer(36160,F);K.framebufferTexture2D(36160,36064,3553,c,0);K.bindTexture(3553,null);if(36053!==K.checkFramebufferStatus(36160))c=!1;else{K.viewport(0,0,1,1);K.clearColor(1,0,0,1);K.clear(16384);var B=ca.allocType(5126,4);K.readPixels(0,0,1,1,6408,5126,B);K.getError()?c=!1:(K.deleteFramebuffer(F),K.deleteTexture(c),
c=1===B[0]);ca.freeType(B)}}B=!0;"undefined"!==typeof navigator&&(/MSIE/.test(navigator.userAgent)||/Trident\//.test(navigator.appVersion)||/Edge/.test(navigator.userAgent))||(B=K.createTexture(),F=ca.allocType(5121,36),K.activeTexture(33984),K.bindTexture(34067,B),K.texImage2D(34069,0,6408,3,3,0,6408,5121,F),ca.freeType(F),K.bindTexture(34067,null),K.deleteTexture(B),B=!K.getError());return{colorBits:[K.getParameter(3410),K.getParameter(3411),K.getParameter(3412),K.getParameter(3413)],depthBits:K.getParameter(3414),
stencilBits:K.getParameter(3415),subpixelBits:K.getParameter(3408),extensions:b(L).filter(function(c){return!!L[c]}),maxAnisotropic:e,maxDrawbuffers:k,maxColorAttachments:q,pointSizeDims:K.getParameter(33901),lineWidthDims:K.getParameter(33902),maxViewportDims:K.getParameter(3386),maxCombinedTextureUnits:K.getParameter(35661),maxCubeMapSize:K.getParameter(34076),maxRenderbufferSize:K.getParameter(34024),maxTextureUnits:K.getParameter(34930),maxTextureSize:K.getParameter(3379),maxAttributes:K.getParameter(34921),
maxVertexUniforms:K.getParameter(36347),maxVertexTextureUnits:K.getParameter(35660),maxVaryingVectors:K.getParameter(36348),maxFragmentUniforms:K.getParameter(36349),glsl:K.getParameter(35724),renderer:K.getParameter(7937),vendor:K.getParameter(7936),version:K.getParameter(7938),readFloat:c,npotTextureCube:B}}},{"./util/pool":32,"./util/sorted-object-keys":34}],14:[function(Z,ha,ab){var b=Z("./util/check"),ca=Z("./util/is-typed-array");ha.exports=function(K,L,e,k,q,c,F){function B(U){var n;null===
...
b(5121===n,"Reading from a framebuffer is only allowed for the type 'uint8'")}));var u=0,x=0,B=k.framebufferWidth,v=k.framebufferHeight,T=null;ca(U)?T=U:U&&(b.type(U,"object","invalid arguments to regl.read()"),u=U.x|0,x=U.y|0,b(0<=u&&u<k.framebufferWidth,"invalid x offset for regl.read"),b(0<=x&&x<k.framebufferHeight,"invalid y offset for regl.read"),B=(U.width||k.framebufferWidth-u)|0,v=(U.height||k.framebufferHeight-x)|0,T=U.data||null);T&&(5121===n?b(T instanceof Uint8Array,"buffer must be 'Uint8Array' when reading from a framebuffer of type 'uint8'"):
...
v,6408,n,T);return T}function G(c){var k;L.setFBO({framebuffer:c.framebuffer},function(){k=B(c)});return k}return function(c){return c&&"framebuffer"in c?G(c):B(c)}}},{"./util/check":21,"./util/is-typed-array":30}],15:[function(Z,ha,ab){var b=Z("./util/sorted-object-keys"),ca=Z("./util/check"),K=Z("./util/values"),L=[];L[32854]=2;L[32855]=2;L[36194]=2;L[33189]=2;L[36168]=1;L[34041]=4;L[35907]=4;L[34836]=16;L[34842]=8;L[34843]=6;ha.exports=function(e,k,q,c,F){function B(c){this.id=u++;this.refCount=
1;this.renderbuffer=c;this.format=32854;this.height=this.width=0;F.profile&&(this.stats={size:0})}function G(k){var q=k.renderbuffer;ca(q,"must not double destroy renderbuffer");e.bindRenderbuffer(36161,null);e.deleteRenderbuffer(q);k.renderbuffer=null;k.refCount=0;delete x[k.id];c.renderbufferCount--}var U={rgba4:32854,rgb565:36194,"rgb5 a1":32855,depth:33189,stencil:36168,"depth stencil":34041};k.ext_srgb&&(U.srgba=35907);k.ext_color_buffer_half_float&&(U.rgba16f=34842,U.rgb16f=34843);k.webgl_color_buffer_float&&
(U.rgba32f=34836);var n=[];b(U).forEach(function(c){n[U[c]]=c});var u=0,x={};B.prototype.decRef=function(){0>=--this.refCount&&G(this)};F.profile&&(c.getTotalRenderbufferSize=function(){var c=0;b(x).forEach(function(k){c+=x[k].stats.size});return c});return{create:function(k,v){function b(c,k){var l=0,t=0,S=32854;"object"===typeof c&&c?("shape"in c?(t=c.shape,ca(Array.isArray(t)&&2<=t.length,"invalid renderbuffer shape"),l=t[0]|0,t=t[1]|0):("radius"in c&&(l=t=c.radius|0),"width"in c&&(l=c.width|0),
"height"in c&&(t=c.height|0)),"format"in c&&(ca.parameter(c.format,U,"invalid renderbuffer format"),S=U[c.format])):"number"===typeof c?(l=c|0,t="number"===typeof k?k|0:l):c?ca.raise("invalid arguments to renderbuffer constructor"):l=t=1;ca(0<l&&0<t&&l<=q.maxRenderbufferSize&&t<=q.maxRenderbufferSize,"invalid renderbuffer size");if(l!==z.width||t!==z.height||S!==z.format)return b.width=z.width=l,b.height=z.height=t,z.format=S,e.bindRenderbuffer(36161,z.renderbuffer),e.renderbufferStorage(36161,S,
l,t),ca(0===e.getError(),"invalid render buffer format"),F.profile&&(z.stats.size=L[z.format]*z.width*z.height),b.format=n[z.format],b}var z=new B(e.createRenderbuffer());x[z.id]=z;c.renderbufferCount++;b(k,v);b.resize=function(c,k){var l=c|0,t=k|0||l;if(l===z.width&&t===z.height)return b;ca(0<l&&0<t&&l<=q.maxRenderbufferSize&&t<=q.maxRenderbufferSize,"invalid renderbuffer size");b.width=z.width=l;b.height=z.height=t;e.bindRenderbuffer(36161,z.renderbuffer);e.renderbufferStorage(36161,z.format,l,
t);ca(0===e.getError(),"invalid render buffer format");F.profile&&(z.stats.size=L[z.format]*z.width*z.height);return b};b._reglType="renderbuffer";b._renderbuffer=z;F.profile&&(b.stats=z.stats);b.destroy=function(){z.decRef()};return b},clear:function(){K(x).forEach(G)},restore:function(){K(x).forEach(function(c){c.renderbuffer=e.createRenderbuffer();e.bindRenderbuffer(36161,c.renderbuffer);e.renderbufferStorage(36161,c.format,c.width,c.height)});e.bindRenderbuffer(36161,null)}}}},{"./util/check":21,
"./util/sorted-object-keys":34,"./util/values":36}],16:[function(Z,ha,ab){var b=Z("./util/sorted-object-keys"),ca=Z("./util/check"),K=Z("./util/extend"),L=Z("./util/values");ha.exports=function(e,k,q,c){function F(c,k,q,l){this.name=c;this.id=k;this.location=q;this.info=l}function B(c,k){for(var q=0;q<c.length;++q)if(c[q].id===k.id){c[q].location=k.location;return}c.push(k)}function G(c,q,v){var l=35632===c?u:x,t=l[q];if(!t){var S=k.str(q),t=e.createShader(c);e.shaderSource(t,S);e.compileShader(t);
ca.shaderError(e,t,S,c,v);l[q]=t}return t}function U(k,q){this.id=T++;this.fragId=k;this.vertId=q;this.program=null;this.uniforms=[];this.attributes=[];this.refCount=1;c.profile&&(this.stats={uniformsCount:0,attributesCount:0})}function n(q,v,b){var l;l=G(35632,q.fragId);var t=G(35633,q.vertId),S=q.program=e.createProgram();e.attachShader(S,l);e.attachShader(S,t);if(b)for(l=0;l<b.length;++l)t=b[l],e.bindAttribLocation(S,t[0],t[1]);e.linkProgram(S);ca.linkError(e,S,k.str(q.fragId),k.str(q.vertId),
v);b=e.getProgramParameter(S,35718);c.profile&&(q.stats.uniformsCount=b);t=q.uniforms;for(l=0;l<b;++l)if(v=e.getActiveUniform(S,l))if(1<v.size)for(var h=0;h<v.size;++h){var u=v.name.replace("[0]","["+h+"]");B(t,new F(u,k.id(u),e.getUniformLocation(S,u),v))}else B(t,new F(v.name,k.id(v.name),e.getUniformLocation(S,v.name),v));b=e.getProgramParameter(S,35721);c.profile&&(q.stats.attributesCount=b);q=q.attributes;for(l=0;l<b;++l)(v=e.getActiveAttrib(S,l))&&B(q,new F(v.name,k.id(v.name),e.getAttribLocation(S,
v.name),v))}var u={},x={},ba={},v=[],T=0;c.profile&&(q.getMaxUniformsCount=function(){var c=0;v.forEach(function(k){k.stats.uniformsCount>c&&(c=k.stats.uniformsCount)});return c},q.getMaxAttributesCount=function(){var c=0;v.forEach(function(k){k.stats.attributesCount>c&&(c=k.stats.attributesCount)});return c});return{clear:function(){var c=e.deleteShader.bind(e);L(u).forEach(c);u={};L(x).forEach(c);x={};v.forEach(function(c){e.deleteProgram(c.program)});v.length=0;ba={};q.shaderCount=0},program:function(c,
k,L,l){ca.command(0<=c,"missing vertex shader",L);ca.command(0<=k,"missing fragment shader",L);var t=ba[k];t||(t=ba[k]={});var S=t[c];if(S&&(S.refCount++,!l))return S;var h=new U(k,c);q.shaderCount++;n(h,L,l);S||(t[c]=h);v.push(h);return K(h,{destroy:function(){h.refCount--;if(0>=h.refCount){e.deleteProgram(h.program);var c=v.indexOf(h);v.splice(c,1);q.shaderCount--}0>=t[h.vertId].refCount&&(e.deleteShader(x[h.vertId]),delete x[h.vertId],delete ba[h.fragId][h.vertId]);b(ba[h.fragId]).length||(e.deleteShader(u[h.fragId]),
delete u[h.fragId],delete ba[h.fragId])}})},restore:function(){u={};x={};for(var c=0;c<v.length;++c)n(v[c],null,v[c].attributes.map(function(c){return[c.location,c.name]}))},shader:G,frag:-1,vert:-1}}},{"./util/check":21,"./util/extend":25,"./util/sorted-object-keys":34,"./util/values":36}],17:[function(Z,ha,ab){ha.exports=function(){return{vaoCount:0,bufferCount:0,elementsCount:0,framebufferCount:0,shaderCount:0,textureCount:0,cubeCount:0,renderbufferCount:0,maxTextureUnits:0}}},{}],18:[function(Z,
ha,ab){ha.exports=function(){var b={"":0},ca=[""];return{id:function(K){var L=b[K];if(L)return L;L=b[K]=ca.length;ca.push(K);return L},str:function(b){return ca[b]}}}},{}],19:[function(Z,ha,ab){function b(d){return"[object "+d+"]"}function ca(d){return Array.isArray(d)&&(0===d.length||"number"===typeof d[0])}function K(d){return Array.isArray(d)&&0!==d.length&&ba(d[0])?!0:!1}function L(d){return Object.prototype.toString.call(d)}function e(d){if(!d)return!1;var c=L(d);return 0<=Y.indexOf(c)?!0:ca(d)||
K(d)||n(d)}function k(d,c){36193===d.type?(d.data=x(c),u.freeType(c)):d.data=c}function q(d,c,a,k,h,f){d="undefined"!==typeof E[d]?E[d]:l[d]*D[c];f&&(d*=6);if(h){for(k=0;1<=a;)k+=d*a*a,a/=2;return k}return d*a*k}var c=Z("./util/sorted-object-keys"),F=Z("./util/check"),B=Z("./util/extend"),G=Z("./util/values"),U=Z("./util/is-typed-array"),n=Z("./util/is-ndarray"),u=Z("./util/pool"),x=Z("./util/to-half-float"),ba=Z("./util/is-array-like"),v=Z("./util/flatten"),T=Z("./util/is-pow2");ab=Z("./constants/arraytypes.json");
var z=Z("./constants/arraytypes.json"),R=[9984,9986,9985,9987],ia=[0,6409,6410,6407,6408],l={};l[6409]=l[6406]=l[6402]=1;l[34041]=l[6410]=2;l[6407]=l[35904]=3;l[6408]=l[35906]=4;var t=b("HTMLCanvasElement"),S=b("OffscreenCanvas"),h=b("CanvasRenderingContext2D"),X=b("ImageBitmap"),f=b("HTMLImageElement"),w=b("HTMLVideoElement"),Y=c(ab).concat([t,S,h,X,f,w]),D=[];D[5121]=1;D[5126]=4;D[36193]=2;D[5123]=2;D[5125]=4;var E=[];E[32854]=2;E[32855]=2;E[36194]=2;E[34041]=4;E[33776]=.5;E[33777]=.5;E[33778]=
...
x;U&&(ca.cpuTime+=performance.now()-T);Ea&&C.destroyStream(ba);Pc&&C.destroyStream(Wc);pc&&C.destroyStream(qc);Ob&&C.destroyStream(jb);rb&&C.destroyStream(Ka);Ya&&C.destroyStream(Lb);Kc.unbind()},scope:function(a,d,c){var f,l,r,m,h,b,p,H,q,y,t,na,w,A,sa,Ja,J,Ca,P,Xa,ra,fa,O,ga,D,L,I,E,va,K,Fa,Da,R,S,ka,Ta,V,X,ya,ea,ia,Hb,pa,ta,Y,ja,Aa,Bd,Cc,Z,gc,bb,bc,yb,eb,Nb,cb,ob,Ua,ha,Ib,Jb,rc,Ob,jb,Gb,Db,wb,hb,Yb,Pb,qb,Ra,Ub,zb,cc,ib,pb,Ha,rb,Ka,fb,gb,La,kb,Va,tb,sb,Oa,tc,Qa,Kb,Eb,Ma,yd,Ya,Lb,Mb,lb,Na,Zb,Pa,
...
ma=t.stencil_opBack;qa=D.stencil_opFront;Aa=t.stencil_opFront;wa=D.viewport;fa=t.viewport;Ba={int8:5120,int16:5122,int32:5124,uint8:5121,uint16:5123,uint32:5125,"float":5126,float32:5126};ka={offset:8,stride:8};oa={offset:8,stride:8};return{batch:function(a,d){var c,k,b,r,p,q;c=f.next;c!==f.cur&&(c?w.bindFramebuffer(36160,c.framebuffer):w.bindFramebuffer(36160,null),f.cur=c);if(t.dirty){var A,e,L,E,ga,H,sa,Ca,ra,xa,K,la,W,wa,pa,za,Cc,da,Z,$b,Ga,ac,Sb,ha,Dd,re,Vd,ze,zd,Qd,oe,ie;A=D.dither;A!==t.dither&&
...
y;sa=a[0];a[0]=0;Ca=a[1];a[1]=0;ra=a[2];a[2]=0;fa=a[3];a[3]=0;O=D.blend_enable;D.blend_enable=!0;L=A[0];A[0]=32774;I=A[1];A[1]=32774;u=Cc[0];Cc[0]=770;M=Cc[1];Cc[1]=771;n=Cc[2];Cc[2]=773;z=Cc[3];Cc[3]=1;aa=D.depth_enable;D.depth_enable=!1;N=g.viewport;B=N.x|0;x=N.y|0;K="width"in N?N.width|0:l.framebufferWidth-B;qa="height"in N?N.height|0:l.framebufferHeight-x;Da=pa[0];pa[0]=B;F=pa[1];pa[1]=x;R=pa[2];pa[2]=K;G=pa[3];pa[3]=qa;U=D.scissor_enable;D.scissor_enable=!0;T=D.stencil_enable;D.stencil_enable=
...
re&&p.destroyStream(Fc),cd&&p.destroyStream(Qc),ue&&p.destroyStream(jd),je&&p.destroyStream(ye),ne&&p.destroyStream(Ge),Me&&p.destroyStream(Id),Qf.unbind(),cg&&Z.destroyStream(uf)}N.unbind();va.dirty=!0;Fa.setVAO(null);f&&(ca.cpuTime+=performance.now()-l)},draw:function(a){var d,g,f,l,h,b,t,w,A,v,P,C,E,ra,O,I,D,la,M,z,N,xa,x,R,S,T,V,X,ea,ba,ia,Y,ta,ja,Cc,za,bc,yb,eb,Nb,cb,ob,Ua,hd,Ib,Jb,rc,Ob,jb,Gb,Db,wb,hb,Yb,Pb,qb,Ra,Ub,zb,cc,ib,pb,Ha,rb,Ka,fb,gb,La,kb,Va,tb,sb,Oa,tc,Qa,Kb,Eb,Ma,yd,Ya,Lb,Mb,lb,
...
wb&&p.destroyStream(hb),kb&&p.destroyStream(Va),Pa&&p.destroyStream(ub),Wb&&p.destroyStream(Qb),ec&&p.destroyStream(jc),zc&&p.destroyStream(id),kd&&p.destroyStream(vd),u.unbind(),Ge.unbind(),Re&&Z.destroyStream(se)},scope:function(c,g,k){var m,r,b,q,H,na,A,e,J,P,Q,C,O,fa,ga,Xa,M,L,Ja,u,n,N,W,aa,B,K,wa,qa,F,Da,Fa,G,da,U,ka,V,ea,Ta,oa,Ba,pa,ya,ma,ja,ta,ua,Hb,Aa,Ga,Cc,mb,Ia,Sb,ha,Ra,$b,ac,cc,ib,pb,Ha,rb,Ka,fb,gb,La,kb,Va,tb,sb,Oa,Vd,Qa,Kb,Eb,Ma,xd,Ya,Lb,Mb,lb,Na,Zb,Pa,ub,vb,Sa,nb,hc,Ac,vc,db,kc,Dd,Wa,
...
wg,xg,yg,zg,Ag,Bg,gf,df,Of,Pf,jg,kg,lg,mg,ng,Zf,Uf,$f,ag,bg,og,Cg,Dg,Eg,Fg,Gg,Hg,Ig,Jg,Kg,Lg,Mg,Ng,Og,Pg;m=c.viewport;r=m.x|0;b=m.y|0;q="width"in m?m.width|0:y.framebufferWidth-r;H="height"in m?m.height|0:y.framebufferHeight-b;na=y.viewportWidth;y.viewportWidth=q;A=y.viewportHeight;y.viewportHeight=H;e=Xd[0];Xd[0]=r;J=Xd[1];Xd[1]=b;P=Xd[2];Xd[2]=q;Q=Xd[3];Xd[3]=H;C=la[0];la[0]=0;O=la[1];la[1]=0;fa=la[2];la[2]=0;ga=la[3];la[3]=1;Xa=Ca.blend_enable;Ca.blend_enable=!0;M=za[0];za[0]=770;L=za[1];za[1]=
...
Jg=a.type;a.type=Uf;Kg=a.w;a.w=$f;Lg=a.x;a.x=ag;Mg=a.y;a.y=bg;Ng=a.z;a.z=og;Og=ra.vert;ra.vert=44;Pg=ra.frag;ra.frag=43;va.dirty=!0;g(y,c,k);y.viewportWidth=na;y.viewportHeight=A;Xd[0]=e;Xd[1]=J;Xd[2]=P;Xd[3]=Q;la[0]=C;la[1]=O;la[2]=fa;la[3]=ga;Ca.blend_enable=Xa;za[0]=M;za[1]=L;za[2]=Ja;za[3]=u;Ca.depth_enable=n;re[0]=wa;re[1]=qa;re[2]=F;re[3]=Da;Ca.scissor_enable=Fa;Ca.stencil_enable=G;da&&(ca.cpuTime+=performance.now()-U);ea&&Z.destroyStream(V);Ea.elements=Ta;Ea.offset=Ba;Ea.count=ya;Ea.primitive=
...
B&&(ca.cpuTime+=performance.now()-x),R&&P.destroyStream(G),te&&P.destroyStream(Yd),xc&&P.destroyStream(Cb),eb&&P.destroyStream(Nb),Ka.unbind()},scope:function(a,d,c){var f,l,k,b,h,m,r,p,q,H,y,t,w,e,A,na,sa,Ca,D,E,O,fa,I,M,ga,L,Xa,Ja,z,K,xa,va,wa,R,qa,S,Da,T,V,X,ea,Ta,Y,oa,ia,ta,Ba,pa,ya,ja,Ea,Hb,Z,Cc,Bd,ha,bb,bc,yb,eb,Nb,cb,ob,Ua,ab,Ib,Jb,rc,Ob,jb,Gb,Db,wb,hb,Yb,Pb,qb,Ra,Ub,zb,cc,ib,pb,Ha,rb,Ka,fb,gb,La,kb,Va,tb,sb,Oa,tc,Qa,Kb,Eb,Ma,yd,Ya,Lb,Mb,lb,Na,Zb,Pa,ub,vb,Sa,nb,hc,Ac,vc,db,kc,qd,Wa,Mc,Ab,Za,
Vb,uc,Wb,Qb,Kc,Rb,pe,Fc,sd,Nc,Yc,td,oc,wc,ic,$a,sc,Tb,Xb,ec,jc,yc,Bc,cd,Qc,Rc,Sc,Zc,od,dd,$c,lc,dc,ad,Uc,ed,zc,id;f=this.viewport;l=f.x|0;k=f.y|0;b="width"in f?f.width|0:C.framebufferWidth-l;h="height"in f?f.height|0:C.framebufferHeight-k;m=C.viewportWidth;C.viewportWidth=b;r=C.viewportHeight;C.viewportHeight=h;p=ra[0];ra[0]=l;q=ra[1];ra[1]=k;H=ra[2];ra[2]=b;y=ra[3];ra[3]=h;t=Aa[0];Aa[0]=0;w=Aa[1];Aa[1]=0;e=Aa[2];Aa[2]=0;A=Aa[3];Aa[3]=1;na=aa.blend_enable;aa.blend_enable=!0;sa=ka[0];ka[0]=770;Ca=
ka[1];ka[1]=771;D=ka[2];ka[2]=773;E=ka[3];ka[3]=1;O=aa.depth_enable;aa.depth_enable=!1;fa=aa.stencil_enable;aa.stencil_enable=!1;if(I=g.profile)M=performance.now(),ca.count++;ga=a.offset;L=N.offset;N.offset=ga;Xa=a.count;Ja=N.count;N.count=Xa;z=N.primitive;N.primitive=0;K=a.align;xa=ma[64];ma[64]=K;va=F.call(this,C,a,c);wa=ma[69];ma[69]=va;R=B.call(this,C,a,c);qa=ma[67];ma[67]=R;S=G.call(this,C,a,c);Da=ma[66];ma[66]=S;T=a.baseline;V=ma[65];ma[65]=T;X=U.call(this,C,a,c);ea=ma[62];ma[62]=X;Ta=a.color;
...
m.drawElements(cb,ob,eb.type,0<<(eb.type-5121>>1)):m.drawArrays(cb,0,ob),N.dirty=!0,Aa.setVAO(null),g.view=d,l&&(L.cpuTime+=performance.now()-h),w&&C.destroyStream(v),ta&&C.destroyStream(za),Fb&&C.destroyStream(Dc),bc.unbind(),Nb&&Da.destroyStream(eb))},scope:function(a,d,c){var f,k,b,h,m,r,p,e,q,H,y,w,A,na,u,D,E,n,I,fa,ga,Xa,Ja,B,sa,x,Ca,O,F,va,P,ra,W,wa,G,U,ka,V,X,Y,ea,Ta,xa,oa,Ba,ya,ta,ja,Ea,Fa,Aa,pa,Hb,Z,ua,ha,za,Cc,Ia,Bd,Ua,ab,Ib,Jb,rc,Ob,jb,Gb,Db,wb,hb,Yb,Pb,qb,Ra,Ub,zb,cc,ib,pb,Ha,rb,Ka,fb,
gb,La,kb,Va,tb,sb,Oa,tc,Qa,Kb,Eb,Ma,yd,Ya,Lb,Mb,lb;f=g.view;k=ba.call(this,g,a,c);g.view=k;b=Q.cull_enable;Q.cull_enable=!0;h=Q.cull_face;Q.cull_face=1029;if(m=N.profile)r=performance.now(),L.count++;p=a.elements;e=null;(q=aa(p))?e=Da.createStream(p):(e=Da.getElements(p),p&&!e&&ca.commandRaise(v,K));H=M.elements;M.elements=e;y=M.offset;M.offset=0;w=e?e.vertCount:-1;A=M.count;M.count=w;na=e?e.primType:4;u=M.primitive;M.primitive=na;D=a.atlas;E=qa[5];qa[5]=D;n=T.call(this,g,a,c);I=qa[3];qa[3]=n;fa=
g.view;ga=qa[4];qa[4]=fa;(Xa=a.normal)&&("object"===typeof Xa||"function"===typeof Xa)&&(aa(Xa)||C.getBuffer(Xa)||C.getBuffer(Xa.buffer)||aa(Xa.buffer)||"constant"in Xa&&("number"===typeof Xa.constant||J(Xa.constant)))||ca.commandRaise(z,K);Ja=!1;B=null;sa=0;x=!1;O=Ca=0;F=1;va=0;P=5126;G=wa=W=ra=0;aa(Xa)?(Ja=!0,B=C.createStream(34962,Xa),P=B.dtype):(B=C.getBuffer(Xa))?P=B.dtype:"constant"in Xa?(F=2,"number"===typeof Xa.constant?(W=Xa.constant,wa=G=ra=0):(W=0<Xa.constant.length?Xa.constant[0]:0,wa=
...
S.state=Ha;Kb=S.stride;S.stride=rb;Eb=S.type;S.type=Ka;Ma=S.w;S.w=fb;yd=S.x;S.x=gb;Ya=S.y;S.y=La;Lb=S.z;S.z=kb;Mb=ma.vert;ma.vert=2;lb=ma.frag;ma.frag=1;N.dirty=!0;d(g,a,c);g.view=f;Q.cull_enable=b;Q.cull_face=h;m&&(L.cpuTime+=performance.now()-r);q&&Da.destroyStream(e);M.elements=H;M.offset=y;M.count=A;M.primitive=u;qa[5]=E;qa[3]=I;qa[4]=ga;Ja&&C.destroyStream(B);R.buffer=U;R.divisor=ka;R.normalized=V;R.offset=X;R.size=Y;R.state=ea;R.stride=Ta;R.type=xa;R.w=oa;R.x=Ba;R.y=ya;R.z=ta;Ea&&C.destroyStream(Fa);
