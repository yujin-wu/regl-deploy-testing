...
b({frag:"\n    precision mediump float;\n    uniform vec4 color;\n    void main() {\n      gl_FragColor = color;\n    }",vert:"\n    precision mediump float;\n    attribute vec2 position;\n    uniform float angle;\n    void main() {\n      gl_Position = vec4(\n        cos(angle) * position.x + sin(angle) * position.y,\n        -sin(angle) * position.x + cos(angle) * position.y, 0, 1);\n    }",attributes:{position:[-1,0,0,-1,1,1]},uniforms:{color:b.prop("color"),angle:function(b){return.01*b.tick}},
depth:{enable:!1},count:3});b.frame(function(K){K=K.tick;b.clear({color:[0,0,0,1]});ca({color:[Math.sin(2E-5*K),Math.cos(4E-4*K),Math.sin(.006*K),1]})})},{"../regl":38}],2:[function(Z,ha,ab){function b(){this.w=this.z=this.y=this.x=this.state=0;this.buffer=null;this.size=0;this.normalized=!1;this.type=5126;this.divisor=this.stride=this.offset=0}var ca=Z("./util/sorted-object-keys"),K=Z("./util/check"),L=Z("./util/values"),e=Z("./constants/dtypes.json"),l=Z("./util/is-typed-array"),q=Z("./util/is-ndarray"),
c=Z("./constants/primitives.json"),F="attributes elements offset count primitive instances".split(" ");ha.exports=function(B,G,U,n,u,x,ba){function v(f){if(f!==X.currentVAO){var w=G.oes_vertex_array_object;f?w.bindVertexArrayOES(f.vao):w.bindVertexArrayOES(null);X.currentVAO=f}}function T(f){if(f!==X.currentVAO){if(f)f.bindAttrs();else{for(var w=G.angle_instanced_arrays,h=0;h<t.length;++h){var c=t[h];c.buffer?(B.enableVertexAttribArray(h),c.buffer.bind(),B.vertexAttribPointer(h,c.size,c.type,c.normalized,
c.stride,c.offfset),w&&c.divisor&&w.vertexAttribDivisorANGLE(h,c.divisor)):(B.disableVertexAttribArray(h),B.vertexAttrib4f(h,c.x,c.y,c.z,c.w))}ba.elements?B.bindBuffer(34963,ba.elements.buffer.buffer):B.bindBuffer(34963,null)}X.currentVAO=f}}function z(){L(k).forEach(function(f){f.destroy()})}function R(){this.id=++S;this.attributes=[];this.elements=null;this.ownsElements=!1;this.offset=this.count=0;this.instances=-1;this.primitive=4;var f=G.oes_vertex_array_object;this.vao=f?f.createVertexArrayOES():
null;k[this.id]=this;this.buffers=[]}function ia(){G.oes_vertex_array_object&&L(k).forEach(function(f){f.refresh()})}var h=U.maxAttributes,t=Array(h);for(U=0;U<h;++U)t[U]=new b;var S=0,k={},X={Record:b,scope:{},state:t,currentVAO:null,targetVAO:null,restore:G.oes_vertex_array_object?ia:function(){},createVAO:function(f){function w(f){var t;if(Array.isArray(f))t=f,k.elements&&k.ownsElements&&k.elements.destroy(),k.elements=null,k.ownsElements=!1,k.offset=0,k.count=0,k.instances=-1,k.primitive=4;else{K("object"===
typeof f,"invalid arguments for create vao");K("attributes"in f,"must specify attributes for vao");if(f.elements){var d=f.elements;k.ownsElements?("function"===typeof d&&"elements"===d._reglType?k.elements.destroy():k.elements(d),k.ownsElements=!1):x.getElements(f.elements)?(k.elements=f.elements,k.ownsElements=!1):(k.elements=x.create(f.elements),k.ownsElements=!0)}else k.elements=null,k.ownsElements=!1;t=f.attributes;k.offset=0;k.count=-1;k.instances=-1;k.primitive=4;k.elements&&(k.count=k.elements._elements.vertCount,
k.primitive=k.elements._elements.primType);"offset"in f&&(k.offset=f.offset|0);"count"in f&&(k.count=f.count|0);"instances"in f&&(k.instances=f.instances|0);"primitive"in f&&(K(f.primitive in c,"bad primitive type: "+f.primitive),k.primitive=c[f.primitive]);K.optional(function(){for(var a=ca(f),d=0;d<a.length;++d)K(0<=F.indexOf(a[d]),'invalid option for vao: "'+a[d]+'" valid options are '+F)});K(Array.isArray(t),"attributes must be an array")}K(t.length<h,"too many attributes");K(0<t.length,"must specify at least one attribute");
var d={},I=k.attributes;I.length=t.length;for(var a=0;a<t.length;++a){var S=t[a],A=I[a]=new b,z=S.data||S;if(Array.isArray(z)||l(z)||q(z)){var v;k.buffers[a]&&(v=k.buffers[a],l(z)&&v._buffer.byteLength>=z.byteLength?v.subdata(z):(v.destroy(),k.buffers[a]=null));k.buffers[a]||(v=k.buffers[a]=u.create(S,34962,!1,!0));A.buffer=u.getBuffer(v);A.size=A.buffer.dimension|0;A.normalized=!1;A.type=A.buffer.dtype;A.offset=0;A.stride=0;A.divisor=0;A.state=1;d[a]=1}else u.getBuffer(S)?(A.buffer=u.getBuffer(S),
...
{points:0,point:0,lines:1,line:1,"line loop":2,"line strip":3,triangles:4,triangle:4,"triangle strip":5,"triangle fan":6}},{}],7:[function(Z,ha,ab){ha.exports={"static":35044,dynamic:35048,stream:35040}},{}],8:[function(Z,ha,ab){function b(c){return Array.isArray(c)||U(c)||n(c)}function ca(c){return c.sort(function(c,h){return"viewport"===c?-1:"viewport"===h?1:c<h?-1:1})}function K(c,h,l,k){this.thisDep=c;this.contextDep=h;this.propDep=l;this.append=k}function L(c){return c&&!(c.thisDep||c.contextDep||
c.propDep)}function e(c){return new K(!1,!1,!1,c)}function l(c,h){var l=c.type;if(0===l)return l=c.data.length,new K(!0,1<=l,2<=l,h);if(4===l)return l=c.data,new K(l.thisDep,l.contextDep,l.propDep,h);if(5===l)return new K(!1,!1,!1,h);if(6===l){for(var k=l=!1,q=!1,d=0;d<c.data.length;++d){var I=c.data[d];1===I.type?q=!0:2===I.type?k=!0:3===I.type?l=!0:0===I.type?(l=!0,I=I.data,1<=I&&(k=!0),2<=I&&(q=!0)):4===I.type&&(l=l||I.data.thisDep,k=k||I.data.contextDep,q=q||I.data.propDep)}return new K(l,k,q,
h)}return new K(3===l,2===l,1===l,h)}var q=Z("./util/sorted-object-keys"),c=Z("./util/check"),F=Z("./util/extend"),B=Z("./util/codegen"),G=Z("./util/loop"),U=Z("./util/is-typed-array"),n=Z("./util/is-ndarray"),u=Z("./util/is-array-like"),x=Z("./dynamic"),ba=Z("./constants/primitives.json"),v=Z("./constants/dtypes.json"),T=["x","y","z","w"],z="blend.func blend.equation stencil.func stencil.opFront stencil.opBack sample.coverage viewport scissor.box polygonOffset.offset".split(" "),R={0:0,1:1,zero:0,
...
W[g]=la[g]=!!c;Ia[g]=d}function g(a,d,c){var g=P(a);ua.push(a);Array.isArray(c)?(la[g]=c.slice(),W[g]=c.slice()):la[g]=W[g]=c;Fa[g]=d}function N(){var a=B(),d=a.link,g=a.global;a.id=xd++;a.batchId="0";var m=d(mb),r=a.shared={props:"a0"};q(mb).forEach(function(a){r[a]=g.def(m,".",a)});c.optional(function(){a.CHECK=d(c);a.commandStr=c.guessCommand();a.command=d(a.commandStr);a.assert=function(a,c,g){a("if(!(",c,"))",this.CHECK,".commandRaise(",d(g),",",this.command,");")};da.invalidBlendCombinations=
ia});var h=a.next={},p=a.current={};q(Fa).forEach(function(a){Array.isArray(la[a])&&(h[a]=g.def(r.next,".",a),p[a]=g.def(r.current,".",a))});var l=a.constants={};q(da).forEach(function(a){l[a]=g.def(JSON.stringify(da[a]))});a.invoke=function(c,g){switch(g.type){case 0:var m=["this",r.context,r.props,a.batchId];return c.def(d(g.data),".call(",m.slice(0,Math.max(g.data.length+1,4)),")");case 1:return c.def(r.props,g.data);case 2:return c.def(r.context,g.data);case 3:return c.def("this",g.data);case 4:return g.data.append(a,
...
"(",f,");",f.map(function(a,d){return l+"["+d+"]="+a}).join(";"),";")}else d(h,".",Fa[c],"(",f,");",p,".",c,"=",f,";")}})}function ya(a,d){ra&&(a.instancing=d.def(a.shared.extensions,".angle_instanced_arrays"))}function Ja(a,d,g,r,c){function m(){return"undefined"===typeof performance?"Date.now()":"performance.now()"}function p(a){w=d.def();a(w,"=",m(),";");"string"===typeof c?a(H,".count+=",c,";"):a(H,".count++;");ea&&(r?(na=d.def(),a(na,"=",y,".getNumPendingQueries();")):a(y,".beginQuery(",H,");"))}
...
break;case 35676:f="Matrix4fv"}if("M"===f.charAt(0)){d(k,".uniform",f,"(",H,",");var H=Math.pow(na-35674+2,2),sa=a.global.def("new Float32Array(",H,")");Array.isArray(q)?d("false,(",G(H,function(a){return sa+"["+a+"]="+q[a]}),",",sa,")"):d("false,(Array.isArray(",q,")||",q," instanceof Float32Array)?",q,":(",G(H,function(a){return sa+"["+a+"]="+q+"["+a+"]"}),",",sa,")");d(");")}else{if(1<I){for(var P=[],Ja=[],Ba=0;Ba<I;++Ba)Array.isArray(q)?Ja.push(q[Ba]):Ja.push(d.def(q+"["+Ba+"]")),m&&P.push(d.def());
...
"=",m,"[",h,"]=",a.link(function(g){return r(p,a,d,g,1)}),"(",c,");",f,".call(this,a0);"))}0<q(d.state).length&&g(a.shared.current,".dirty=true;");a.shared.vao&&g(a.shared.vao,".setVAO(null);")}function va(a,d,g,r){function c(){return!0}a.batchId="a1";ya(a,d);na(a,d,g,r.attributes,c);Xa(a,d,g,r.uniforms,c,!1);Ta(a,d,d,g)}function Ca(a,d,g,c){function m(a){return a.contextDep&&h||a.propDep}function p(a){return!m(a)}ya(a,d);var h=g.contextDep,f=d.def(),k=d.def();a.shared.props=k;a.batchId=f;var H=a.scope(),
l=a.scope();d(H.entry,"for(",f,"=0;",f,"<","a1",";++",f,"){",k,"=","a0","[",f,"];",l,"}",H.exit);g.needsContext&&fa(a,l,g.context);g.needsFramebuffer&&Aa(a,l,g.framebuffer);oa(a,l,g.state,m);g.profile&&m(g.profile)&&Ja(a,l,g,!1,!0);c?(g.useVAO?g.drawVAO?m(g.drawVAO)?l(a.shared.vao,".setVAO(",g.drawVAO.append(a,l),");"):H(a.shared.vao,".setVAO(",g.drawVAO.append(a,H),");"):H(a.shared.vao,".setVAO(",a.shared.vao,".targetVAO);"):(H(a.shared.vao,".setVAO(null);"),na(a,H,g,c.attributes,p),na(a,l,g,c.attributes,
...
".",c),y(G(f,function(a){return H+"["+a+"]"}),");",G(f,function(a){return l+"["+a+"]="+H+"["+a+"];"}).join("")),d("if(",G(f,function(a){return H+"["+a+"]!=="+l+"["+a+"]"}).join("||"),"){",y,"}")):(H=r.def(p,".",c),l=r.def(h,".",c),y(H,");",h,".",c,"=",H,";"),d("if(",H,"!==",l,"){",y,"}"));g(y)});return a.compile()}(),compile:function(a,d,g,r,c){var m=N();m.stats=m.link(c);q(d["static"]).forEach(function(a){H(m,d,a)});z.forEach(function(d){H(m,a,d)});var p=xa(a,d,g,r,m);y(m,p);Hb(m,p);Bd(m,p);return F(m.compile(),
...
c))return['"'+l.substr(1,l.length-2).replace(/\\/g,"\\\\").replace(/"/g,'\\"')+'"'];if(c=/\[(false|true|null|\d+|'[^']*'|"[^"]*")\]/.exec(l))return ca(l.substr(0,c.index)).concat(ca(c[1])).concat(ca(l.substr(c.index+c[0].length)));c=l.split(".");if(1===c.length)return['"'+l.replace(/\\/g,"\\\\").replace(/"/g,'\\"')+'"'];l=[];for(e=0;e<c.length;++e)l=l.concat(ca(c[e]));return l}function K(l){return"["+ca(l).join("][")+"]"}function L(l,c){if("function"===typeof l)return new b(0,l);if("number"===typeof l||
"boolean"===typeof l)return new b(5,l);if(Array.isArray(l))return new b(6,l.map(function(l,q){return L(l,c+"["+q+"]")}));if(l instanceof b)return l;e(!1,"invalid option type in uniform "+c)}var e=Z("./util/check"),l=0;ha.exports={DynamicVariable:b,define:function(l,c){return new b(l,K(c+""))},isDynamic:function(l){return"function"===typeof l&&!l._reglType||l instanceof b},unbox:L,accessor:K}},{"./util/check":21}],10:[function(Z,ha,ab){var b=Z("./util/check"),ca=Z("./util/is-typed-array"),K=Z("./util/is-ndarray"),
L=Z("./util/values"),e=Z("./constants/primitives.json"),l=Z("./constants/usage.json");ha.exports=function(q,c,F,B){function G(c){this.id=x++;u[this.id]=this;this.buffer=c;this.primType=4;this.type=this.vertCount=0}function U(l,e,v,u,h,t,S){l.buffer.bind();var k;e?((k=S)||ca(e)&&(!K(e)||ca(e.data))||(k=c.oes_element_index_uint?5125:5123),F._initBuffer(l.buffer,e,v,k,3)):(q.bufferData(34963,t,v),l.buffer.dtype=k||5121,l.buffer.usage=v,l.buffer.dimension=3,l.buffer.byteLength=t);k=S;if(!S){switch(l.buffer.dtype){case 5121:case 5120:k=
...
delete u[c.id];c.buffer.destroy();c.buffer=null}var u={},x=0,ba={uint8:5121,uint16:5123};c.oes_element_index_uint&&(ba.uint32=5125);G.prototype.bind=function(){this.buffer.bind()};var v=[];return{create:function(c,q){function v(c){if(c)if("number"===typeof c)u(c),h.primType=4,h.vertCount=c|0,h.type=5121;else{var q=null,k=35044,z=-1,f=-1,w=0,n=0;if(Array.isArray(c)||ca(c)||K(c))q=c;else if(b.type(c,"object","invalid arguments for elements"),"data"in c&&(q=c.data,b(Array.isArray(q)||ca(q)||K(q),"invalid data for element buffer")),
...
v,6408,n,T);return T}function G(c){var l;L.setFBO({framebuffer:c.framebuffer},function(){l=B(c)});return l}return function(c){return c&&"framebuffer"in c?G(c):B(c)}}},{"./util/check":21,"./util/is-typed-array":30}],15:[function(Z,ha,ab){var b=Z("./util/sorted-object-keys"),ca=Z("./util/check"),K=Z("./util/values"),L=[];L[32854]=2;L[32855]=2;L[36194]=2;L[33189]=2;L[36168]=1;L[34041]=4;L[35907]=4;L[34836]=16;L[34842]=8;L[34843]=6;ha.exports=function(e,l,q,c,F){function B(c){this.id=u++;this.refCount=
...
l,L,h){ca.command(0<=c,"missing vertex shader",L);ca.command(0<=l,"missing fragment shader",L);var t=ba[l];t||(t=ba[l]={});var S=t[c];if(S&&(S.refCount++,!h))return S;var k=new U(l,c);q.shaderCount++;n(k,L,h);S||(t[c]=k);v.push(k);return K(k,{destroy:function(){k.refCount--;if(0>=k.refCount){e.deleteProgram(k.program);var c=v.indexOf(k);v.splice(c,1);q.shaderCount--}0>=t[k.vertId].refCount&&(e.deleteShader(x[k.vertId]),delete x[k.vertId],delete ba[k.fragId][k.vertId]);b(ba[k.fragId]).length||(e.deleteShader(u[k.fragId]),
...
function N(a,c,g,r,m){var h=a.element,p=a.data,l=a.internalformat,k=a.format,f=a.type,H=a.width,y=a.height;P(a);h?d.texSubImage2D(c,m,g,r,k,f,h):a.compressed?d.compressedTexSubImage2D(c,m,g,r,l,H,y,p):a.needsCopy?(b(),d.copyTexSubImage2D(c,m,g,r,a.xOffset,a.yOffset,H,y)):d.texSubImage2D(c,m,g,r,H,y,k,f,p)}function M(){return ra.pop()||new C}function Da(a){a.needsFree&&u.freeType(a.data);C.call(a);ra.push(a)}function qa(){V.call(this);this.genMipmaps=!1;this.mipmapHint=4352;this.mipmask=0;this.images=
...
1;t[5122]=t[5123]=t[36193]=t[33635]=t[32819]=t[32820]=2;t[5124]=t[5125]=t[5126]=t[34042]=4;ha.exports=Z(K,{optional:function(c){c()},raise:ca,commandRaise:v,command:function(c,h,l){c||v(h,l||G())},parameter:function(c,h,l){c in h||ca("unknown parameter ("+c+")"+L(l)+". possible values: "+R(h).join())},commandParameter:function(c,h,l,f){c in h||v("unknown parameter ("+c+")"+L(l)+". possible values: "+R(h).join(),f||G())},constructor:function(c){R(c).forEach(function(c){0>h.indexOf(c)&&ca('invalid regl constructor argument "'+
...
function(){return+new Date}},{}],23:[function(Z,ha,ab){function b(e){return Array.prototype.slice.call(e)}function ca(e){return b(e).join("")}var K=Z("./extend"),L=Z("./compiled-fns");ha.exports=function(){function e(){var l=[],q=[];return K(function(){l.push.apply(l,b(arguments))},{def:function(){var e="v"+c;c++;q.push(e);0<arguments.length&&(l.push(e,"="),l.push.apply(l,b(arguments)),l.push(";"));return e},toString:function(){return ca([0<q.length?"var "+q.join(",")+";":"",ca(l)])}})}function l(){function c(e,
...
q=q||0;for(var L=0;L<q;++L)e();var L=l(),v=L.toString;return G[c]=K(L,{arg:e,toString:function(){return ca(["function(",b.join(),"){",v(),"}"])}})},scope:l,cond:function(){var c=ca(arguments),q=l(),e=l(),L=q.toString,B=e.toString;return K(q,{then:function(){q.apply(q,b(arguments));return this},"else":function(){e.apply(e,b(arguments));return this},toString:function(){var l=B();l&&(l="else{"+l+"}");return ca(["if(",c,"){",L(),"}",l])}})},compile:function(){var c=[],l=[];Object.keys(F).sort(function(c,
...
u[3]!==x[3])e.colorMask(u[0],u[1],u[2],u[3]),x[0]=u[0],x[1]=u[1],x[2]=u[2],x[3]=u[3];P!==C&&(e.cullFace(P),K.cull_face=P);g!==N&&(e.depthFunc(g),K.depth_func=g);M!==Da&&(e.depthMask(M),K.depth_mask=M);if(ba[0]!==v[0]||ba[1]!==v[1])e.depthRange(ba[0],ba[1]),v[0]=ba[0],v[1]=ba[1];qa!==m&&(e.frontFace(qa),K.frontFace=qa);J!==aa&&(e.lineWidth(J),K.lineWidth=J);if(T[0]!==z[0]||T[1]!==z[1])e.polygonOffset(T[0],T[1]),z[0]=T[0],z[1]=T[1];if(R[0]!==ia[0]||R[1]!==ia[1])e.sampleCoverage(R[0],R[1]),ia[0]=R[0],
...
bc=new Float32Array(16);yb=new Float32Array(16);eb=new Float32Array(16);Nb=new Float32Array(16);cb=new Float32Array(16);ob=new Float32Array(16);Ua=new Float32Array(16);return{batch:function(a,d){var h,f,k,b;h=mb.next;h!==mb.cur&&(h?da.bindFramebuffer(36160,h.framebuffer):da.bindFramebuffer(36160,null),mb.cur=h);if(ua.dirty){var I,t,w,A,D,E,S,K,R,ca,X,ia,Ga,ta,ja,Y,Sb,$b,La,Fb,Pc,Bb,Cb,Oa,Xe;I=zd[0];t=zd[1];w=zd[2];A=zd[3];if(I!==Qd[0]||t!==Qd[1]||w!==Qd[2]||A!==Qd[3])da.colorMask(I,t,w,A),Qd[0]=I,
Qd[1]=t,Qd[2]=w,Qd[3]=A;D=xd.frontFace;D!==ua.frontFace&&(da.frontFace(D),ua.frontFace=D);E=xd.polygonOffset_enable;E!==ua.polygonOffset_enable&&(E?da.enable(32823):da.disable(32823),ua.polygonOffset_enable=E);S=Ed[0];K=Ed[1];if(S!==Xd[0]||K!==Xd[1])da.polygonOffset(S,K),Xd[0]=S,Xd[1]=K;R=xd.sample_alpha;R!==ua.sample_alpha&&(R?da.enable(32926):da.disable(32926),ua.sample_alpha=R);ca=xd.sample_enable;ca!==ua.sample_enable&&(ca?da.enable(32928):da.disable(32928),ua.sample_enable=ca);X=fe[0];ia=fe[1];
...
!0;h=ua.profile;ua.profile=!1;da.useProgram(K.program);ac.setVAO(null);f=ya.location;k=la[f];k.buffer||da.enableVertexAttribArray(f);if(k.type!==L.dtype||4!==k.size||k.buffer!==L||!1!==k.normalized||0!==k.offset||0!==k.stride)da.bindBuffer(34962,L.buffer),da.vertexAttribPointer(f,4,L.dtype,!1,0,0),k.type=L.dtype,k.size=4,k.buffer=L,k.normalized=!1,k.offset=0,k.stride=0;f=Ja.location;k=la[f];k.buffer||da.enableVertexAttribArray(f);if(k.type!==e.dtype||4!==k.size||k.buffer!==e||!1!==k.normalized||0!==
...
p=bd.x|0;H=bd.y|0;y="width"in bd?bd.width|0:W.framebufferWidth-p;b="height"in bd?bd.height|0:W.framebufferHeight-H;na=W.viewportWidth;W.viewportWidth=y;sa=W.viewportHeight;W.viewportHeight=b;Ja=Zd[0];Zd[0]=p;Ba=Zd[1];Zd[1]=H;P=Zd[2];Zd[2]=y;J=Zd[3];Zd[3]=b;Q=Sb[0];Sb[0]=0;Xa=Sb[1];Sb[1]=0;C=Sb[2];Sb[2]=0;O=Sb[3];Sb[3]=0;fa=xd.blend_enable;xd.blend_enable=!1;ra=Dd[0];Dd[0]=32774;ga=Dd[1];Dd[1]=32774;la=Vd[0];Vd[0]=770;M=Vd[1];Vd[1]=771;va=Vd[2];Vd[2]=1;N=Vd[3];Vd[3]=1;aa=xd.cull_enable;xd.cull_enable=
!0;wa=xd.cull_face;xd.cull_face=1029;Ea=xd.depth_enable;xd.depth_enable=!0;da=xd.depth_func;xd.depth_func=513;Da=xd.depth_mask;xd.depth_mask=!0;pa=oe[0];oe[0]=0;xa=oe[1];oe[1]=1;K=xd.dither;xd.dither=!1;R=xd.lineWidth;xd.lineWidth=2;pd.height=g.scissorHeight;pd.width=g.scissorWidth;pd.x=g.scissorX;pd.y=g.scissorY;ka=pd.x|0;ca=pd.y|0;V="width"in pd?pd.width|0:W.framebufferWidth-ka;Ta="height"in pd?pd.height|0:W.framebufferHeight-ca;ea=Xe[0];Xe[0]=ka;ya=Xe[1];Xe[1]=ca;Ca=Xe[2];Xe[2]=V;oa=Xe[3];Xe[3]=
...
rh;ja.y=sh;ja.z=th;$b.vert=uh;$b.frag=vh;ua.dirty=!0}}},$1:function(b,ca){var K,L,e,l,q,c,F,B,G,U,n,u,x,ba,v,T,z,R,ia,h,t,S,k,X,f,w,Y,D,E,d;K=b.attributes;L=b.current;e=b.framebuffer;l=b.gl;q=b.next;c=b.vao;F=q.blend_color;B=L.blend_color;G=q.blend_equation;U=L.blend_equation;n=q.blend_func;u=L.blend_func;x=q.colorMask;ba=L.colorMask;v=q.depth_range;T=L.depth_range;z=q.polygonOffset_offset;R=L.polygonOffset_offset;ia=q.sample_coverage;h=L.sample_coverage;t=q.scissor_box;S=L.scissor_box;k=q.stencil_func;
X=L.stencil_func;f=q.stencil_opBack;w=L.stencil_opBack;Y=q.stencil_opFront;D=L.stencil_opFront;E=q.viewport;d=L.viewport;return{poll:function(){var c,a,b,A,K,ca,V,ea,O,P,C,g,N,M,Da,qa,m,J,aa,Q,ma,pa;L.dirty=!1;a=q.blend_enable;b=q.cull_enable;A=q.depth_enable;K=q.dither;ca=q.polygonOffset_enable;V=q.sample_alpha;ea=q.sample_enable;O=q.scissor_enable;P=q.stencil_enable;C=q.cull_face;g=L.cull_face;N=q.depth_func;M=L.depth_func;Da=q.depth_mask;qa=L.depth_mask;m=q.frontFace;J=L.frontFace;aa=q.lineWidth;
Q=L.lineWidth;ma=q.stencil_mask;pa=L.stencil_mask;c=e.next;c!==e.cur&&(c?l.bindFramebuffer(36160,c.framebuffer):l.bindFramebuffer(36160,null),e.cur=c);a!==L.blend_enable&&(a?l.enable(3042):l.disable(3042),L.blend_enable=a);b!==L.cull_enable&&(b?l.enable(2884):l.disable(2884),L.cull_enable=b);A!==L.depth_enable&&(A?l.enable(2929):l.disable(2929),L.depth_enable=A);K!==L.dither&&(K?l.enable(3024):l.disable(3024),L.dither=K);ca!==L.polygonOffset_enable&&(ca?l.enable(32823):l.disable(32823),L.polygonOffset_enable=
...
G[0],U[1]=G[1];if(n[0]!==u[0]||n[1]!==u[1]||n[2]!==u[2]||n[3]!==u[3])l.blendFuncSeparate(n[0],n[1],n[2],n[3]),u[0]=n[0],u[1]=n[1],u[2]=n[2],u[3]=n[3];if(x[0]!==ba[0]||x[1]!==ba[1]||x[2]!==ba[2]||x[3]!==ba[3])l.colorMask(x[0],x[1],x[2],x[3]),ba[0]=x[0],ba[1]=x[1],ba[2]=x[2],ba[3]=x[3];C!==g&&(l.cullFace(C),L.cull_face=C);N!==M&&(l.depthFunc(N),L.depth_func=N);Da!==qa&&(l.depthMask(Da),L.depth_mask=Da);if(v[0]!==T[0]||v[1]!==T[1])l.depthRange(v[0],v[1]),T[0]=v[0],T[1]=v[1];m!==J&&(l.frontFace(m),L.frontFace=
...
N;l.depthRange(v[0],v[1]);T[0]=v[0];T[1]=v[1];l.frontFace(M);L.frontFace=M;l.lineWidth(Da);L.lineWidth=Da;l.polygonOffset(z[0],z[1]);R[0]=z[0];R[1]=z[1];l.sampleCoverage(ia[0],ia[1]);h[0]=ia[0];h[1]=ia[1];l.scissor(t[0],t[1],t[2],t[3]);S[0]=t[0];S[1]=t[1];S[2]=t[2];S[3]=t[3];l.stencilFunc(k[0],k[1],k[2]);X[0]=k[0];X[1]=k[1];X[2]=k[2];l.stencilMask(qa);L.stencil_mask=qa;l.stencilOpSeparate(f[0],f[1],f[2],f[3]);w[0]=f[0];w[1]=f[1];w[2]=f[2];w[3]=f[3];l.stencilOpSeparate(Y[0],Y[1],Y[2],Y[3]);D[0]=Y[0];
D[1]=Y[1];D[2]=Y[2];D[3]=Y[3];l.viewport(E[0],E[1],E[2],E[3]);d[0]=E[0];d[1]=E[1];d[2]=E[2];d[3]=E[3]}}},"$32,capOffset,capSize,color,direction,error,lineOffset,lineWidth,opacity,position,positionFract,scale,scaleFract,translate,translateFract,viewport":function(b,ca,K,L,e,l,q,c,F,B,G,U,n,u,x,ba,v,T,z,R,ia,h,t,S,k,X,f,w,Y,D,E,d,I,a,ta,A,ja,Cc,V,ea,O,P,C,g,N,M,Da,qa){var m,J,aa,Q,ma,pa,za,xa,fa,Aa,ka,oa,ya,Ja,na,Xa,Ta,r,p,y,va,Ca,Bd,Hb,ga,H,sa,Ba,ra,wa,Ea,la,W,ua,Ia,Fa,mb,da,xd,$b,Ga,ac,Sb;m=b.attributes;
...
na,e,v,ra,L,z,x,B,K,S,R,F,G,T,Ta,X,ya,oa,ba,ia,mb,Wc,Bb,Fb,Z,xb,xc,Cb,Jc,mc,Hc,Xc;t=ka.dither;t!==Q.dither&&(t?fa.enable(3024):fa.disable(3024),Q.dither=t);na=ka.depth_func;na!==Q.depth_func&&(fa.depthFunc(na),Q.depth_func=na);e=Bd[0];v=Bd[1];if(e!==Hb[0]||v!==Hb[1])fa.depthRange(e,v),Hb[0]=e,Hb[1]=v;ra=ka.depth_mask;ra!==Q.depth_mask&&(fa.depthMask(ra),Q.depth_mask=ra);L=va[0];z=va[1];x=va[2];B=va[3];if(L!==Ca[0]||z!==Ca[1]||x!==Ca[2]||B!==Ca[3])fa.colorMask(L,z,x,B),Ca[0]=L,Ca[1]=z,Ca[2]=x,Ca[3]=
B;K=ka.cull_enable;K!==Q.cull_enable&&(K?fa.enable(2884):fa.disable(2884),Q.cull_enable=K);S=ka.cull_face;S!==Q.cull_face&&(fa.cullFace(S),Q.cull_face=S);R=ka.frontFace;R!==Q.frontFace&&(fa.frontFace(R),Q.frontFace=R);F=ka.lineWidth;F!==Q.lineWidth&&(fa.lineWidth(F),Q.lineWidth=F);G=ka.polygonOffset_enable;G!==Q.polygonOffset_enable&&(G?fa.enable(32823):fa.disable(32823),Q.polygonOffset_enable=G);T=ga[0];Ta=ga[1];if(T!==H[0]||Ta!==H[1])fa.polygonOffset(T,Ta),H[0]=T,H[1]=Ta;X=ka.sample_alpha;X!==Q.sample_alpha&&
...
cb;aa.viewportHeight=ob;jb&&J.destroyStream(Gb);fb&&J.destroyStream(gb);lb&&J.destroyStream(Na);Za&&J.destroyStream(Vb)}Q.dirty=!0;Ja.setVAO(null);l&&(ca.cpuTime+=performance.now()-k)},draw:function(d){var f,h,l,k,b,p,t,na,w,e,v,ra,D,I,E,L,z,K,S,R,T,Ta,X,ya,oa,ba,ia,Y,mb,Z,Bb,Fb,Dc,xb,xc,Cb,Jc,mc,Hc,Xc,Vc,Ec,fc,Ic,pc,qc,nc,gc,bb,bc,yb,eb,Nb,cb,ob,Ua,hd,Ib,Jb,rc,Ob,jb,Gb,Db,wb,hb,Yb,Pb,qb,Ra,Ub,zb,cc,ib,pb,Ha,rb,Ka,fb,gb,La,kb,Va,tb,sb,Oa,tc,Qa,Kb,Eb,Ma,yd,Ya,Lb,Mb,lb,Na,Zb;f=xa.next;f!==xa.cur&&(f?
...
Q.depth_enable=!1;w=d.viewport;e=w.x|0;v=w.y|0;ra="width"in w?w.width|0:aa.framebufferWidth-e;D="height"in w?w.height|0:aa.framebufferHeight-v;fa.scissor(e,v,ra,D);wa[0]=e;wa[1]=v;wa[2]=ra;wa[3]=D;fa.enable(3089);Q.scissor_enable=!0;if(I=Q.profile)E=performance.now(),ca.count++;fa.useProgram(q.program);L=za.angle_instanced_arrays;Ja.setVAO(null);z=c.call(this,aa,d,0);ac.offset=z;K=!1;S=null;R=0;T=!1;X=Ta=0;ya=1;oa=0;ba=5126;Z=mb=Y=ia=0;Aa(ac)?(K=!0,S=J.createStream(34962,ac),ba=S.dtype):(S=J.getBuffer(ac))?
...
d.opacity);(lb=ma.elements)?fa.bindBuffer(34963,lb.buffer.buffer):Ja.currentVAO&&(lb=pa.getElements(Ja.currentVAO.elements))&&fa.bindBuffer(34963,lb.buffer.buffer);Na=ma.offset;Zb=d.count;0<Zb?lb?L.drawElementsInstancedANGLE(4,36,lb.type,Na<<(lb.type-5121>>1),Zb):L.drawArraysInstancedANGLE(4,Na,36,Zb):0>Zb&&(lb?fa.drawElements(4,36,lb.type,Na<<(lb.type-5121>>1)):fa.drawArrays(4,Na,36));Q.dirty=!0;Ja.setVAO(null);aa.viewportWidth=t;aa.viewportHeight=na;I&&(ca.cpuTime+=performance.now()-E);K&&J.destroyStream(S);
xc&&J.destroyStream(Cb);eb&&J.destroyStream(Nb);qb&&J.destroyStream(Ra)},scope:function(a,d,c){var g,r,m,l,b,H,q,y,w,e,A,sa,Ja,Ba,P,Xa,C,O,fa,ga,la,M,D,I,E,L,W,va,N,wa,Ea,x,B,da,Da,K,pa,xa,F,G,V,ua,ea,Ca,qa,Hb,ta,Y,ja,za,Bd,Fa,Ia,Cc,Z,Ib,Jb,rc,Ob,jb,Gb,Db,wb,hb,Yb,Pb,qb,Ra,Ub,zb,cc,ib,pb,Ha,rb,Ka,fb,gb,La,kb,Va,tb,sb,Oa,tc,Qa,Kb,Eb,Ma,yd,Ya,Lb,Mb,lb,Na,Zb,Pa,ub,vb,Sa,nb,hc,Ac,vc,db,kc,qd,Wa,Mc,Ab,Za,Vb,uc,Wb,Qb,Kc,Rb,ha,Fc,sd,Nc,Yc,td,oc,wc,ic,$a,sc,Tb,Xb,ec,jc,yc,Bc,cd,Qc,Rc,Sc,Zc,od,dd,$c,lc,dc,
...
ka.blend_enable;ka.blend_enable=!0;C=Ta[0];Ta[0]=32774;O=Ta[1];Ta[1]=32774;fa=p[0];p[0]=770;ga=p[1];p[1]=771;la=p[2];p[2]=773;M=p[3];p[3]=1;D=ka.depth_enable;ka.depth_enable=!1;I=a.viewport;E=I.x|0;L=I.y|0;W="width"in I?I.width|0:aa.framebufferWidth-E;va="height"in I?I.height|0:aa.framebufferHeight-L;N=ra[0];ra[0]=E;wa=ra[1];ra[1]=L;Ea=ra[2];ra[2]=W;x=ra[3];ra[3]=va;B=ka.scissor_enable;ka.scissor_enable=!0;if(da=Q.profile)Da=performance.now(),ca.count++;K=ma.count;ma.count=36;pa=a.count;xa=ma.instances;
ma.instances=pa;F=ma.primitive;ma.primitive=4;G=a.capSize;V=ya[5];ya[5]=G;ua=a.lineWidth;ea=ya[4];ya[4]=ua;Ca=a.opacity;qa=ya[10];ya[10]=Ca;Hb=a.range;ta=ya[18];ya[18]=Hb;Y=a.scale;ja=ya[6];ya[6]=Y;za=a.scaleFract;Bd=ya[7];ya[7]=za;Fa=a.translate;Ia=ya[8];ya[8]=Fa;Cc=a.translateFract;Z=ya[9];ya[9]=Cc;Ib=ba.call(this,aa,a,c);Jb=ya[3];ya[3]=Ib;rc=v.buffer;v.buffer=u;Ob=v.divisor;v.divisor=0;jb=v.normalized;v.normalized=!1;Gb=v.offset;v.offset=16;Db=v.size;v.size=0;wb=v.state;v.state=1;hb=v.stride;v.stride=
...
oa.vert=2;Ld=oa.frag;oa.frag=1;Q.dirty=!0;d(aa,a,c);aa.viewportWidth=H;aa.viewportHeight=q;mb[0]=y;mb[1]=w;mb[2]=e;mb[3]=A;na[0]=sa;na[1]=Ja;na[2]=Ba;na[3]=P;ka.blend_enable=Xa;Ta[0]=C;Ta[1]=O;p[0]=fa;p[1]=ga;p[2]=la;p[3]=M;ka.depth_enable=D;ra[0]=N;ra[1]=wa;ra[2]=Ea;ra[3]=x;ka.scissor_enable=B;da&&(ca.cpuTime+=performance.now()-Da);ma.count=K;ma.instances=xa;ma.primitive=F;ya[5]=V;ya[4]=ea;ya[10]=qa;ya[18]=ta;ya[6]=ja;ya[7]=Bd;ya[8]=Ia;ya[9]=Z;ya[3]=Jb;v.buffer=rc;v.divisor=Ob;v.normalized=jb;v.offset=
...
ca,K,L,e,l,q,c,F,B,G,U,n,u,x,ba,v,T,z,R,ia,h,t,S,k,X,f,w,Y,D,E,d,I,a,ta,A,ja){var Cc,V,ea,O,P,C,g,N,M,Da,qa,m,J,aa,Q,ma,pa,za,xa,fa,Aa,ka,oa,ya,Ja,na,Xa,Ta,r,p,y,va,Ca,Bd,Hb,ga,H,sa,Ba,ra,wa,Ea,la,W;Cc=b.attributes;V=b.buffer;ea=b.context;O=b.current;P=b.draw;C=b.elements;g=b.extensions;N=b.framebuffer;M=b.gl;Da=b.isBufferArgs;qa=b.next;m=b.shader;J=b.uniforms;aa=b.vao;Q=qa.blend_color;ma=O.blend_color;pa=qa.blend_equation;za=O.blend_equation;xa=qa.blend_func;fa=O.blend_func;Aa=qa.colorMask;ka=O.colorMask;
...
la={divisor:1,offset:16,stride:8};W={divisor:1,offset:0,stride:4};return{batch:function(c,r){var m,b,H,q,J,v;m=N.next;m!==N.cur&&(m?M.bindFramebuffer(36160,m.framebuffer):M.bindFramebuffer(36160,null),N.cur=m);if(O.dirty){var Q,L,u,n,x,B,K,pa,xa,F,G,U,ba,Z,Md,Xe,Ze,$e,Gd,Ae,te,Yd,Ad,Zd,ld,bd,pd,Lc,nd,Gc,fd,Pc;Q=qa.dither;Q!==O.dither&&(Q?M.enable(3024):M.disable(3024),O.dither=Q);L=qa.depth_func;L!==O.depth_func&&(M.depthFunc(L),O.depth_func=L);u=oa[0];n=oa[1];if(u!==ya[0]||n!==ya[1])M.depthRange(u,
n),ya[0]=u,ya[1]=n;x=qa.depth_mask;x!==O.depth_mask&&(M.depthMask(x),O.depth_mask=x);B=Aa[0];K=Aa[1];pa=Aa[2];xa=Aa[3];if(B!==ka[0]||K!==ka[1]||pa!==ka[2]||xa!==ka[3])M.colorMask(B,K,pa,xa),ka[0]=B,ka[1]=K,ka[2]=pa,ka[3]=xa;F=qa.cull_enable;F!==O.cull_enable&&(F?M.enable(2884):M.disable(2884),O.cull_enable=F);G=qa.cull_face;G!==O.cull_face&&(M.cullFace(G),O.cull_face=G);U=qa.frontFace;U!==O.frontFace&&(M.frontFace(U),O.frontFace=U);ba=qa.lineWidth;ba!==O.lineWidth&&(M.lineWidth(ba),O.lineWidth=ba);
Z=qa.polygonOffset_enable;Z!==O.polygonOffset_enable&&(Z?M.enable(32823):M.disable(32823),O.polygonOffset_enable=Z);Md=Ja[0];Xe=Ja[1];if(Md!==na[0]||Xe!==na[1])M.polygonOffset(Md,Xe),na[0]=Md,na[1]=Xe;Ze=qa.sample_alpha;Ze!==O.sample_alpha&&(Ze?M.enable(32926):M.disable(32926),O.sample_alpha=Ze);$e=qa.sample_enable;$e!==O.sample_enable&&($e?M.enable(32928):M.disable(32928),O.sample_enable=$e);Gd=Xa[0];Ae=Xa[1];if(Gd!==Ta[0]||Ae!==Ta[1])M.sampleCoverage(Gd,Ae),Ta[0]=Gd,Ta[1]=Ae;te=qa.stencil_mask;
te!==O.stencil_mask&&(M.stencilMask(te),O.stencil_mask=te);Yd=y[0];Ad=y[1];Zd=y[2];if(Yd!==va[0]||Ad!==va[1]||Zd!==va[2])M.stencilFunc(Yd,Ad,Zd),va[0]=Yd,va[1]=Ad,va[2]=Zd;ld=Hb[0];bd=Hb[1];pd=Hb[2];Lc=Hb[3];if(ld!==ga[0]||bd!==ga[1]||pd!==ga[2]||Lc!==ga[3])M.stencilOpSeparate(ld,bd,pd,Lc),ga[0]=ld,ga[1]=bd,ga[2]=pd,ga[3]=Lc;nd=Ca[0];Gc=Ca[1];fd=Ca[2];Pc=Ca[3];if(nd!==Bd[0]||Gc!==Bd[1]||fd!==Bd[2]||Pc!==Bd[3])M.stencilOpSeparate(nd,Gc,fd,Pc),Bd[0]=nd,Bd[1]=Gc,Bd[2]=fd,Bd[3]=Pc}M.blendColor(0,0,0,
0);ma[0]=0;ma[1]=0;ma[2]=0;ma[3]=0;M.enable(3042);O.blend_enable=!0;M.blendEquationSeparate(32774,32774);za[0]=32774;za[1]=32774;M.blendFuncSeparate(770,771,773,1);fa[0]=770;fa[1]=771;fa[2]=773;fa[3]=1;M.enable(3089);O.scissor_enable=!0;M.disable(2960);O.stencil_enable=!1;if(b=O.profile)H=performance.now(),ca.count+=r;M.useProgram(T.program);q=g.angle_instanced_arrays;var Wc,Bb,Fb,Dc,xb;aa.setVAO(null);Wc=Y.location;Bb=Cc[Wc];Bb.buffer||M.enableVertexAttribArray(Wc);if(5126!==Bb.type||1!==Bb.size||
...
wa.constant[3]:0)):(La=Da(wa.buffer)?V.createStream(34962,wa.buffer):V.getBuffer(wa.buffer),Qa="type"in wa?Ba[wa.type]:La.dtype,Va=!!wa.normalized,sb=wa.size|0,tb=wa.offset|0,tc=wa.stride|0,kb=wa.divisor|0);Ya=h.location;Lb=Cc[Ya];if(1===Oa){Lb.buffer||M.enableVertexAttribArray(Ya);Mb=sb||2;if(Lb.type!==Qa||Lb.size!==Mb||Lb.buffer!==La||Lb.normalized!==Va||Lb.offset!==tb||Lb.stride!==tc)M.bindBuffer(34962,La.buffer),M.vertexAttribPointer(Ya,Mb,Qa,Va,tc,tb),Lb.type=Qa,Lb.size=Mb,Lb.buffer=La,Lb.normalized=
...
ba,Z,Md,Xe,Ze,$e,Gd,Ae,te,Yd,Ad,Zd,ld,bd,pd,Lc,nd,Gc,fd,Pc,Wc,Bb,Fb,Dc,xb,xc,Cb,Jc,mc,Hc,Xc,Vc,Ec,fc,Ic,pc,qc,nc,gc,bb,bc,yb,eb,Nb,cb,ob,Ua,hd,Ib,Jb,rc,Ob,jb,Gb,Db,wb,hb,Yb,Pb,qb,Ra,Ub,zb,cc,ib,pb,Ha,rb,Ka,fb,gb,La,kb,Va,tb,sb,Oa,tc,Qa,Kb,Eb,Ma,ha,Ya,Lb,Mb,lb,Na,Zb,Pa,ub;r=N.next;r!==N.cur&&(r?M.bindFramebuffer(36160,r.framebuffer):M.bindFramebuffer(36160,null),N.cur=r);if(O.dirty){var vb,Sa,nb,hc,Ac,vc,db,kc,qd,Wa,Mc,Ab,Za,Vb,uc,Wb,Qb,Kc,Rb,pe,Fc,sd,Nc,Yc,td,oc,wc,ic,$a,sc,Tb,Xb;vb=qa.dither;vb!==
O.dither&&(vb?M.enable(3024):M.disable(3024),O.dither=vb);Sa=qa.depth_func;Sa!==O.depth_func&&(M.depthFunc(Sa),O.depth_func=Sa);nb=oa[0];hc=oa[1];if(nb!==ya[0]||hc!==ya[1])M.depthRange(nb,hc),ya[0]=nb,ya[1]=hc;Ac=qa.depth_mask;Ac!==O.depth_mask&&(M.depthMask(Ac),O.depth_mask=Ac);vc=Aa[0];db=Aa[1];kc=Aa[2];qd=Aa[3];if(vc!==ka[0]||db!==ka[1]||kc!==ka[2]||qd!==ka[3])M.colorMask(vc,db,kc,qd),ka[0]=vc,ka[1]=db,ka[2]=kc,ka[3]=qd;Wa=qa.cull_enable;Wa!==O.cull_enable&&(Wa?M.enable(2884):M.disable(2884),O.cull_enable=
Wa);Mc=qa.cull_face;Mc!==O.cull_face&&(M.cullFace(Mc),O.cull_face=Mc);Ab=qa.frontFace;Ab!==O.frontFace&&(M.frontFace(Ab),O.frontFace=Ab);Za=qa.lineWidth;Za!==O.lineWidth&&(M.lineWidth(Za),O.lineWidth=Za);Vb=qa.polygonOffset_enable;Vb!==O.polygonOffset_enable&&(Vb?M.enable(32823):M.disable(32823),O.polygonOffset_enable=Vb);uc=Ja[0];Wb=Ja[1];if(uc!==na[0]||Wb!==na[1])M.polygonOffset(uc,Wb),na[0]=uc,na[1]=Wb;Qb=qa.sample_alpha;Qb!==O.sample_alpha&&(Qb?M.enable(32926):M.disable(32926),O.sample_alpha=
Qb);Kc=qa.sample_enable;Kc!==O.sample_enable&&(Kc?M.enable(32928):M.disable(32928),O.sample_enable=Kc);Rb=Xa[0];pe=Xa[1];if(Rb!==Ta[0]||pe!==Ta[1])M.sampleCoverage(Rb,pe),Ta[0]=Rb,Ta[1]=pe;Fc=qa.stencil_mask;Fc!==O.stencil_mask&&(M.stencilMask(Fc),O.stencil_mask=Fc);sd=y[0];Nc=y[1];Yc=y[2];if(sd!==va[0]||Nc!==va[1]||Yc!==va[2])M.stencilFunc(sd,Nc,Yc),va[0]=sd,va[1]=Nc,va[2]=Yc;td=Hb[0];oc=Hb[1];wc=Hb[2];ic=Hb[3];if(td!==ga[0]||oc!==ga[1]||wc!==ga[2]||ic!==ga[3])M.stencilOpSeparate(td,oc,wc,ic),ga[0]=
td,ga[1]=oc,ga[2]=wc,ga[3]=ic;$a=Ca[0];sc=Ca[1];Tb=Ca[2];Xb=Ca[3];if($a!==Bd[0]||sc!==Bd[1]||Tb!==Bd[2]||Xb!==Bd[3])M.stencilOpSeparate($a,sc,Tb,Xb),Bd[0]=$a,Bd[1]=sc,Bd[2]=Tb,Bd[3]=Xb}m=c.viewport;b=m.x|0;H=m.y|0;J="width"in m?m.width|0:ea.framebufferWidth-b;v="height"in m?m.height|0:ea.framebufferHeight-H;Q=ea.viewportWidth;ea.viewportWidth=J;u=ea.viewportHeight;ea.viewportHeight=v;M.viewport(b,H,J,v);sa[0]=b;sa[1]=H;sa[2]=J;sa[3]=v;M.blendColor(0,0,0,0);ma[0]=0;ma[1]=0;ma[2]=0;ma[3]=0;M.enable(3042);
O.blend_enable=!0;M.blendEquationSeparate(32774,32774);za[0]=32774;za[1]=32774;M.blendFuncSeparate(770,771,773,1);fa[0]=770;fa[1]=771;fa[2]=773;fa[3]=1;(z=K.call(this,ea,c,0))?M.enable(2929):M.disable(2929);O.depth_enable=z;n=c.viewport;x=n.x|0;B=n.y|0;pa="width"in n?n.width|0:ea.framebufferWidth-x;xa="height"in n?n.height|0:ea.framebufferHeight-B;M.scissor(x,B,pa,xa);p[0]=x;p[1]=B;p[2]=pa;p[3]=xa;M.enable(3089);O.scissor_enable=!0;M.disable(2960);O.stencil_enable=!1;if(R=O.profile)F=performance.now(),
...
V.createStream(34962,ra.buffer):V.getBuffer(ra.buffer),Gd="type"in ra?Ba[ra.type]:U.dtype,Z=!!ra.normalized,Xe=ra.size|0,Md=ra.offset|0,$e=ra.stride|0,ba=ra.divisor|0);Zd=ia.location;ld=Cc[Zd];if(1===Ze){ld.buffer||M.enableVertexAttribArray(Zd);bd=Xe||2;if(ld.type!==Gd||ld.size!==bd||ld.buffer!==U||ld.normalized!==Z||ld.offset!==Md||ld.stride!==$e)M.bindBuffer(34962,U.buffer),M.vertexAttribPointer(Zd,bd,Gd,Z,$e,Md),ld.type=Gd,ld.size=bd,ld.buffer=U,ld.normalized=Z,ld.offset=Md,ld.stride=$e;ld.divisor!==
ba&&(G.vertexAttribDivisorANGLE(Zd,ba),ld.divisor=ba)}else if(ld.buffer&&(M.disableVertexAttribArray(Zd),ld.buffer=null),ld.x!==te||ld.y!==Yd||ld.z!==Ad||ld.w!==Ae)M.vertexAttrib4f(Zd,te,Yd,Ad,Ae),ld.x=te,ld.y=Yd,ld.z=Ad,ld.w=Ae;Ea.buffer=c.positionBuffer;pd=!1;Lc=null;nd=0;Gc=!1;Pc=fd=0;Wc=1;Bb=0;Fb=5126;Cb=xc=xb=Dc=0;Da(Ea)?(pd=!0,Lc=V.createStream(34962,Ea),Fb=Lc.dtype):(Lc=V.getBuffer(Ea))?Fb=Lc.dtype:"constant"in Ea?(Wc=2,"number"===typeof Ea.constant?(xb=Ea.constant,xc=Cb=Dc=0):(xb=0<Ea.constant.length?
...
0,4));O.dirty=!0;aa.setVAO(null);ea.viewportWidth=Q;ea.viewportHeight=u;R&&(ca.cpuTime+=performance.now()-F);T&&V.destroyStream(U);pd&&V.destroyStream(Lc);Xc&&V.destroyStream(Vc);Ua&&V.destroyStream(hd);zb&&V.destroyStream(cc);Zb.unbind()},scope:function(a,d,g){var f,h,k,b,p,q,y,t,na,w,A,sa,Ja,Xa,C,fa,ga,M,D,I,L,E,va,N,aa,z,K,S,R,T,ka,Ta,X,ya,oa,Ca,Aa,Hb,ia,ma,ta,Y,ja,za,Bd,Cc,Z,Xc,Vc,Ec,fc,Ic,pc,qc,nc,gc,bb,bc,yb,eb,Nb,cb,ob,Ua,hd,Ib,Jb,rc,Ob,jb,Gb,Db,wb,hb,Yb,Pb,qb,Ra,Ub,zb,cc,ib,pb,Ha,rb,Ka,fb,
...
v.offset=be;v.size=ee;v.state=Me;v.stride=Id;v.type=Td;v.w=De;v.x=Ne;v.y=hf;v.z=bf;m.vert=Te;m.frag=Pe;O.dirty=!0}}},"$22,aColor,aCoord,bColor,bCoord,dashLength,dashTexture,depth,lineEnd,lineTop,miterLimit,miterMode,nextCoord,opacity,prevCoord,scale,thickness,translate,viewport":function(b,ca,K,L,e,l,q,c,F,B,G,U,n,u,x,ba,v,T,z,R,ia,h,t,S,k,X,f,w,Y,D,E,d,I,a,ta,A,ja,Cc,V,ea,O){var P,C,g,N,M,Da,qa,m,J,aa,Q,ma,pa,za,xa,fa,Aa,ka,oa,ya,Ja,na,Xa,Ta,r,p,y,va,Ca,Bd,Hb,ga,H,sa,Ba,ra,wa,Ea,la,W,ua,Ia,Fa,mb,
da;P=b.attributes;C=b.buffer;g=b.context;N=b.current;M=b.draw;Da=b.elements;qa=b.extensions;m=b.framebuffer;J=b.gl;aa=b.isBufferArgs;Q=b.next;ma=b.shader;pa=b.uniforms;za=b.vao;xa=Q.blend_color;fa=N.blend_color;Aa=Q.blend_equation;ka=N.blend_equation;oa=Q.blend_func;ya=N.blend_func;Ja=Q.colorMask;na=N.colorMask;Xa=Q.depth_range;Ta=N.depth_range;r=Q.polygonOffset_offset;p=N.polygonOffset_offset;y=Q.sample_coverage;va=N.sample_coverage;Ca=Q.scissor_box;Bd=N.scissor_box;Hb=Q.stencil_func;ga=N.stencil_func;
H=Q.stencil_opBack;sa=N.stencil_opBack;Ba=Q.stencil_opFront;ra=N.stencil_opFront;wa=Q.viewport;Ea=N.viewport;la={int8:5120,int16:5122,int32:5124,uint8:5121,uint16:5123,uint32:5125,"float":5126,float32:5126};W={divisor:1,offset:0,stride:4};ua={divisor:1,offset:8,stride:8};Ia={divisor:1,offset:4,stride:4};Fa={divisor:1,offset:16,stride:8};mb={divisor:1,offset:24,stride:8};da={divisor:1,offset:0,stride:8};return{batch:function(c,b){var q,v,L,u,z,n;q=m.next;q!==m.cur&&(q?J.bindFramebuffer(36160,q.framebuffer):
J.bindFramebuffer(36160,null),m.cur=q);if(N.dirty){var wa,x,B,K,pa,xa,F,G,U,T,oa,Ca,ba,Aa,ma,Z,Yd,Ad,ha,ld,bd,pd,Lc,nd,Gc,fd,Pc,Wc,Bb,Fb;wa=Q.dither;wa!==N.dither&&(wa?J.enable(3024):J.disable(3024),N.dither=wa);x=Q.depth_func;x!==N.depth_func&&(J.depthFunc(x),N.depth_func=x);B=Xa[0];K=Xa[1];if(B!==Ta[0]||K!==Ta[1])J.depthRange(B,K),Ta[0]=B,Ta[1]=K;pa=Q.depth_mask;pa!==N.depth_mask&&(J.depthMask(pa),N.depth_mask=pa);xa=Ja[0];F=Ja[1];G=Ja[2];U=Ja[3];if(xa!==na[0]||F!==na[1]||G!==na[2]||U!==na[3])J.colorMask(xa,
F,G,U),na[0]=xa,na[1]=F,na[2]=G,na[3]=U;T=Q.frontFace;T!==N.frontFace&&(J.frontFace(T),N.frontFace=T);oa=Q.lineWidth;oa!==N.lineWidth&&(J.lineWidth(oa),N.lineWidth=oa);Ca=Q.polygonOffset_enable;Ca!==N.polygonOffset_enable&&(Ca?J.enable(32823):J.disable(32823),N.polygonOffset_enable=Ca);ba=r[0];Aa=r[1];if(ba!==p[0]||Aa!==p[1])J.polygonOffset(ba,Aa),p[0]=ba,p[1]=Aa;ma=Q.sample_alpha;ma!==N.sample_alpha&&(ma?J.enable(32926):J.disable(32926),N.sample_alpha=ma);Z=Q.sample_enable;Z!==N.sample_enable&&(Z?
J.enable(32928):J.disable(32928),N.sample_enable=Z);Yd=y[0];Ad=y[1];if(Yd!==va[0]||Ad!==va[1])J.sampleCoverage(Yd,Ad),va[0]=Yd,va[1]=Ad;ha=Q.stencil_mask;ha!==N.stencil_mask&&(J.stencilMask(ha),N.stencil_mask=ha);ld=Hb[0];bd=Hb[1];pd=Hb[2];if(ld!==ga[0]||bd!==ga[1]||pd!==ga[2])J.stencilFunc(ld,bd,pd),ga[0]=ld,ga[1]=bd,ga[2]=pd;Lc=Ba[0];nd=Ba[1];Gc=Ba[2];fd=Ba[3];if(Lc!==ra[0]||nd!==ra[1]||Gc!==ra[2]||fd!==ra[3])J.stencilOpSeparate(Lc,nd,Gc,fd),ra[0]=Lc,ra[1]=nd,ra[2]=Gc,ra[3]=fd;Pc=H[0];Wc=H[1];Bb=
...
mc?mc.width|0:g.framebufferWidth-Hc;Ec="height"in mc?mc.height|0:g.framebufferHeight-Xc;fc=g.viewportWidth;g.viewportWidth=Vc;Ic=g.viewportHeight;g.viewportHeight=Ec;J.viewport(Hc,Xc,Vc,Ec);Ea[0]=Hc;Ea[1]=Xc;Ea[2]=Vc;Ea[3]=Ec;(pc=ia.call(this,g,n,z))?J.enable(2929):J.disable(2929);N.depth_enable=pc;qc=n.viewport;nc=qc.x|0;gc=qc.y|0;bb="width"in qc?qc.width|0:g.framebufferWidth-nc;bc="height"in qc?qc.height|0:g.framebufferHeight-gc;J.scissor(nc,gc,bb,bc);Bd[0]=nc;Bd[1]=gc;Bd[2]=bb;Bd[3]=bc;ua.buffer=
...
0,4));g.viewportWidth=fc;g.viewportHeight=Ic;yb&&C.destroyStream(eb);Yb&&C.destroyStream(Pb);Va&&C.destroyStream(tb);Pa&&C.destroyStream(ub);uc&&C.destroyStream(Wb);Tb&&C.destroyStream(Xb);me.unbind()}N.dirty=!0;za.setVAO(null);v&&(ca.cpuTime+=performance.now()-L)},draw:function(h){var b,t,v,u,n,z,wa,x,B,pa,xa,R,F,G,U,T,oa,Ca,ba,Aa,ma,ia,Z,Yd,Ad,ha,ld,bd,pd,Lc,nd,Gc,fd,Pc,Wc,Bb,Fb,Dc,xb,xc,Cb,Jc,mc,Hc,Xc,Vc,Ec,fc,Ic,pc,qc,nc,gc,bb,bc,yb,eb,Nb,cb,ob,Ua,hd,Ib,Jb,rc,Ob,jb,Gb,Db,wb,hb,Yb,Pb,qb,Ra,Ub,
...
u;wa=g.viewportWidth;g.viewportWidth=n;x=g.viewportHeight;g.viewportHeight=z;J.viewport(v,u,n,z);Ea[0]=v;Ea[1]=u;Ea[2]=n;Ea[3]=z;J.blendColor(0,0,0,0);fa[0]=0;fa[1]=0;fa[2]=0;fa[3]=0;J.enable(3042);N.blend_enable=!0;J.blendEquationSeparate(32774,32774);ka[0]=32774;ka[1]=32774;J.blendFuncSeparate(770,771,773,1);ya[0]=770;ya[1]=771;ya[2]=773;ya[3]=1;J.enable(2884);N.cull_enable=!0;J.cullFace(1029);N.cull_face=1029;(B=K.call(this,g,h,0))?J.enable(2929):J.disable(2929);N.depth_enable=B;pa=h.viewport;
xa=pa.x|0;R=pa.y|0;F="width"in pa?pa.width|0:g.framebufferWidth-xa;G="height"in pa?pa.height|0:g.framebufferHeight-R;J.scissor(xa,R,F,G);Bd[0]=xa;Bd[1]=R;Bd[2]=F;Bd[3]=G;J.enable(3089);N.scissor_enable=!0;J.disable(2960);N.stencil_enable=!1;if(U=N.profile)T=performance.now(),ca.count++;J.useProgram(L.program);oa=qa.angle_instanced_arrays;za.setVAO(null);ua.buffer=h.positionBuffer;Ca=!1;ba=null;Aa=0;ma=!1;Z=ia=0;Yd=1;Ad=0;ha=5126;Lc=pd=bd=ld=0;aa(ua)?(Ca=!0,ba=C.createStream(34962,ua),ha=ba.dtype):
...
"framebuffer"===Qb._reglType&&(Qb=Qb.color[0]);Kc=Qb._texture;J.uniform1i(Y.location,Kc.bind());(Rb=M.elements)?J.bindBuffer(34963,Rb.buffer.buffer):za.currentVAO&&(Rb=Da.getElements(za.currentVAO.elements))&&J.bindBuffer(34963,Rb.buffer.buffer);pe=h.count;0<pe?Rb?oa.drawElementsInstancedANGLE(5,4,Rb.type,0<<(Rb.type-5121>>1),pe):oa.drawArraysInstancedANGLE(5,0,4,pe):0>pe&&(Rb?J.drawElements(5,4,Rb.type,0<<(Rb.type-5121>>1)):J.drawArrays(5,0,4));N.dirty=!0;za.setVAO(null);g.viewportWidth=wa;g.viewportHeight=
x;U&&(ca.cpuTime+=performance.now()-T);Ca&&C.destroyStream(ba);Pc&&C.destroyStream(Wc);pc&&C.destroyStream(qc);Ob&&C.destroyStream(jb);rb&&C.destroyStream(Ka);Ya&&C.destroyStream(Lb);Kc.unbind()},scope:function(a,d,c){var f,h,r,m,k,b,p,H,q,y,t,na,w,A,sa,Ja,J,Ba,P,Xa,ra,fa,O,ga,D,I,L,E,va,Ea,K,Da,S,R,ka,Ta,V,X,ya,ea,ia,Hb,qa,ta,Y,ja,za,Bd,Cc,Z,gc,bb,bc,yb,eb,Nb,cb,ob,Ua,ha,Ib,Jb,rc,Ob,jb,Gb,Db,wb,hb,Yb,Pb,qb,Ra,Ub,zb,cc,ib,pb,Ha,rb,Ka,fb,gb,La,kb,Va,tb,sb,Oa,tc,Qa,Kb,Eb,Ma,yd,Ya,Lb,Mb,lb,Na,Zb,Pa,
...
Q.depth_enable=D;L=a.viewport;E=L.x|0;va=L.y|0;Ea="width"in L?L.width|0:g.framebufferWidth-E;K="height"in L?L.height|0:g.framebufferHeight-va;Da=Ca[0];Ca[0]=E;S=Ca[1];Ca[1]=va;R=Ca[2];Ca[2]=Ea;ka=Ca[3];Ca[3]=K;Ta=Q.scissor_enable;Q.scissor_enable=!0;V=Q.stencil_enable;Q.stencil_enable=!1;if(X=N.profile)ya=performance.now(),ca.count++;ea=M.offset;M.offset=0;ia=M.count;M.count=4;Hb=a.count;qa=M.instances;M.instances=Hb;ta=M.primitive;M.primitive=5;Y=a.dashLength;ja=pa[23];pa[23]=Y;za=a.dashTexture;
...
z.y=Bf;vf=z.z;z.z=Cf;yf=ma.vert;ma.vert=36;zf=ma.frag;ma.frag=35;N.dirty=!0;d(g,a,c);g.viewportWidth=b;g.viewportHeight=p;wa[0]=H;wa[1]=q;wa[2]=y;wa[3]=t;xa[0]=na;xa[1]=w;xa[2]=A;xa[3]=sa;Q.blend_enable=Ja;Aa[0]=J;Aa[1]=Ba;oa[0]=P;oa[1]=Xa;oa[2]=ra;oa[3]=fa;Q.cull_enable=O;Q.cull_face=ga;Q.depth_enable=I;Ca[0]=Da;Ca[1]=S;Ca[2]=R;Ca[3]=ka;Q.scissor_enable=Ta;Q.stencil_enable=V;X&&(ca.cpuTime+=performance.now()-ya);M.offset=ea;M.count=ia;M.instances=qa;M.primitive=ta;pa[23]=ja;pa[24]=Bd;pa[22]=Z;pa[31]=
...
ma=t.stencil_opBack;pa=D.stencil_opFront;za=t.stencil_opFront;xa=D.viewport;fa=t.viewport;Aa={int8:5120,int16:5122,int32:5124,uint8:5121,uint16:5123,uint32:5125,"float":5126,float32:5126};ka={offset:8,stride:8};oa={offset:8,stride:8};return{batch:function(a,d){var c,l,b,r,p,q;c=f.next;c!==f.cur&&(c?w.bindFramebuffer(36160,c.framebuffer):w.bindFramebuffer(36160,null),f.cur=c);if(t.dirty){var A,e,L,E,ga,H,sa,Ba,ra,wa,Ea,la,W,K,xa,qa,Cc,da,Z,$b,Ga,ac,Sb,ha,Dd,re,Vd,ze,zd,Qd,oe,ie;A=D.dither;A!==t.dither&&
...
(w.cullFace(Ea),t.cull_face=Ea);la=D.frontFace;la!==t.frontFace&&(w.frontFace(la),t.frontFace=la);W=D.lineWidth;W!==t.lineWidth&&(w.lineWidth(W),t.lineWidth=W);K=D.polygonOffset_enable;K!==t.polygonOffset_enable&&(K?w.enable(32823):w.disable(32823),t.polygonOffset_enable=K);xa=g[0];qa=g[1];if(xa!==N[0]||qa!==N[1])w.polygonOffset(xa,qa),N[0]=xa,N[1]=qa;Cc=D.sample_alpha;Cc!==t.sample_alpha&&(Cc?w.enable(32926):w.disable(32926),t.sample_alpha=Cc);da=D.sample_enable;da!==t.sample_enable&&(da?w.enable(32928):
w.disable(32928),t.sample_enable=da);Z=M[0];$b=M[1];if(Z!==Da[0]||$b!==Da[1])w.sampleCoverage(Z,$b),Da[0]=Z,Da[1]=$b;Ga=D.stencil_mask;Ga!==t.stencil_mask&&(w.stencilMask(Ga),t.stencil_mask=Ga);ac=J[0];Sb=J[1];ha=J[2];if(ac!==aa[0]||Sb!==aa[1]||ha!==aa[2])w.stencilFunc(ac,Sb,ha),aa[0]=ac,aa[1]=Sb,aa[2]=ha;Dd=pa[0];re=pa[1];Vd=pa[2];ze=pa[3];if(Dd!==za[0]||re!==za[1]||Vd!==za[2]||ze!==za[3])w.stencilOpSeparate(Dd,re,Vd,ze),za[0]=Dd,za[1]=re,za[2]=Vd,za[3]=ze;zd=Q[0];Qd=Q[1];oe=Q[2];ie=Q[3];if(zd!==
...
y;sa=a[0];a[0]=0;Ba=a[1];a[1]=0;ra=a[2];a[2]=0;fa=a[3];a[3]=0;O=D.blend_enable;D.blend_enable=!0;L=A[0];A[0]=32774;u=A[1];A[1]=32774;I=Cc[0];Cc[0]=770;M=Cc[1];Cc[1]=771;n=Cc[2];Cc[2]=773;z=Cc[3];Cc[3]=1;aa=D.depth_enable;D.depth_enable=!1;N=g.viewport;B=N.x|0;x=N.y|0;K="width"in N?N.width|0:h.framebufferWidth-B;pa="height"in N?N.height|0:h.framebufferHeight-x;Da=qa[0];qa[0]=B;F=qa[1];qa[1]=x;R=qa[2];qa[2]=K;G=qa[3];qa[3]=pa;U=D.scissor_enable;D.scissor_enable=!0;T=D.stencil_enable;D.stencil_enable=
...
ha[0]=L,ha[1]=u,ha[2]=I,ha[3]=D;la=Ba.cull_enable;la!==va.cull_enable&&(la?H.enable(2884):H.disable(2884),va.cull_enable=la);n=Ba.cull_face;n!==va.cull_face&&(H.cullFace(n),va.cull_face=n);z=Ba.frontFace;z!==va.frontFace&&(H.frontFace(z),va.frontFace=z);B=Ba.lineWidth;B!==va.lineWidth&&(H.lineWidth(B),va.lineWidth=B);wa=Ba.polygonOffset_enable;wa!==va.polygonOffset_enable&&(wa?H.enable(32823):H.disable(32823),va.polygonOffset_enable=wa);x=ac[0];K=ac[1];if(x!==Sb[0]||K!==Sb[1])H.polygonOffset(x,K),
Sb[0]=x,Sb[1]=K;F=Ba.sample_alpha;F!==va.sample_alpha&&(F?H.enable(32926):H.disable(32926),va.sample_alpha=F);R=Ba.sample_enable;R!==va.sample_enable&&(R?H.enable(32928):H.disable(32928),va.sample_enable=R);S=ab[0];G=ab[1];if(S!==Dd[0]||G!==Dd[1])H.sampleCoverage(S,G),Dd[0]=S,Dd[1]=G;U=Ba.stencil_mask;U!==va.stencil_mask&&(H.stencilMask(U),va.stencil_mask=U);T=ze[0];X=ze[1];ba=ze[2];if(T!==zd[0]||X!==zd[1]||ba!==zd[2])H.stencilFunc(T,X,ba),zd[0]=T,zd[1]=X,zd[2]=ba;ia=ie[0];Y=ie[1];Fa=ie[2];bc=ie[3];
...
va.stencil_enable=!1;if(f=va.profile)h=performance.now(),ca.count+=d;H.useProgram(ta.program);l=Hb.angle_instanced_arrays;var ob;Ea.setVAO(null);H.uniform1i(J.location,!1);H.uniform1i(za.location,N.bind());ob=Ca.instances;for(k=0;k<d;++k){b=a[k];var Ua,hd,Ib,Jb,rc,Ob,jb,Gb,Db,wb,hb,Yb,Pb,qb,Ra,Ub,zb,cc,ib,pb,Ha,rb,Ka,fb,gb,La,kb,Va,tb,sb,Oa,tc,Qa,Kb,Eb,Ma,yd,Ya,Lb,Mb,lb,Na,Zb,Pa,ub,vb,Sa,nb,hc,Ac,vc,db,kc,qd,Wa,Mc,Ab,Za,Vb,uc,Wb,Qb,Kc,Rb,re,Fc,sd,Nc,Yc,td,oc,wc,ic,$a,sc,Tb,Xb,ec,jc,yc,Bc,cd,Qc,Rc,
...
Cf=of[1];k&&Bf===sf&&Qe===Cf||(Bf=sf,Qe=Cf,H.uniform2f(Aa.location,sf,Cf));Ee=b.translate;pf=Ee[0];Df=Ee[1];k&&qf===pf&&Gf===Df||(qf=pf,Gf=Df,H.uniform2f(oa.location,pf,Df));Af=b.translateFract;Ef=Af[0];wf=Af[1];k&&Ff===Ef&&xf===wf||(Ff=Ef,xf=wf,H.uniform2f(ya.location,Ef,wf));vf=M.call(this,y,b,k);yf=vf[0];If=vf[1];k&&zf===yf&&Jf===If||(zf=yf,Jf=If,H.uniform2f(pa.location,yf,If));Kf=b.opacity;k&&Lf===Kf||(Lf=Kf,H.uniform1f(ma.location,Kf));(tf=b.markerTexture)&&"framebuffer"===tf._reglType&&(tf=
...
re&&p.destroyStream(Fc),cd&&p.destroyStream(Qc),ue&&p.destroyStream(jd),je&&p.destroyStream(ye),ne&&p.destroyStream(Ge),Me&&p.destroyStream(Id),Qf.unbind(),cg&&Z.destroyStream(uf)}N.unbind();va.dirty=!0;Ea.setVAO(null);f&&(ca.cpuTime+=performance.now()-h)},draw:function(a){var d,g,f,h,k,b,t,w,A,v,P,C,E,ra,O,I,D,la,M,z,N,wa,x,R,S,T,V,X,ea,ba,ia,Y,ta,ja,Cc,Fa,bc,yb,eb,Nb,cb,ob,Ua,hd,Ib,Jb,rc,Ob,jb,Gb,Db,wb,hb,Yb,Pb,qb,Ra,Ub,zb,cc,ib,pb,Ha,rb,Ka,fb,gb,La,kb,Va,tb,sb,Oa,tc,Qa,Kb,Eb,Ma,yd,Ya,Lb,Mb,lb,
...
!1;if(ra=va.profile)O=performance.now(),ca.count++;H.useProgram(K.program);I=Hb.angle_instanced_arrays;Ea.setVAO(null);D=L.call(this,y,a,0);la=!1;M=null;z=0;N=!1;x=wa=0;R=1;S=0;T=5126;ba=ea=X=V=0;sa(D)?(la=!0,M=p.createStream(34962,D),T=M.dtype):(M=p.getBuffer(D))?T=M.dtype:"constant"in D?(R=2,"number"===typeof D.constant?(X=D.constant,ea=ba=V=0):(X=0<D.constant.length?D.constant[0]:0,ea=1<D.constant.length?D.constant[1]:0,ba=2<D.constant.length?D.constant[2]:0,V=3<D.constant.length?D.constant[3]:
0)):(M=sa(D.buffer)?p.createStream(34962,D.buffer):p.getBuffer(D.buffer),T="type"in D?Md[D.type]:M.dtype,N=!!D.normalized,x=D.size|0,wa=D.offset|0,S=D.stride|0,z=D.divisor|0);ia=Ja.location;Y=r[ia];if(1===R){Y.buffer||H.enableVertexAttribArray(ia);ta=x||1;if(Y.type!==T||Y.size!==ta||Y.buffer!==M||Y.normalized!==N||Y.offset!==wa||Y.stride!==S)H.bindBuffer(34962,M.buffer),H.vertexAttribPointer(ia,ta,T,N,S,wa),Y.type=T,Y.size=ta,Y.buffer=M,Y.normalized=N,Y.offset=wa,Y.stride=S;Y.divisor!==z&&(I.vertexAttribDivisorANGLE(ia,
...
a.elements;se=null;(se=(Re=sa(Be))?Z.createStream(Be):Z.getElements(Be))&&H.bindBuffer(34963,se.buffer.buffer);Se=a.offset;if(Oe=a.count)xe=Ca.instances,0<xe?se?I.drawElementsInstancedANGLE(0,Oe,se.type,Se<<(se.type-5121>>1),xe):I.drawArraysInstancedANGLE(0,Se,Oe,xe):0>xe&&(se?H.drawElements(0,Oe,se.type,Se<<(se.type-5121>>1)):H.drawArrays(0,Se,Oe)),va.dirty=!0,Ea.setVAO(null),y.viewportWidth=t,y.viewportHeight=w,ra&&(ca.cpuTime+=performance.now()-O),la&&p.destroyStream(M),Cc&&p.destroyStream(Fa),
wb&&p.destroyStream(hb),kb&&p.destroyStream(Va),Pa&&p.destroyStream(ub),Wb&&p.destroyStream(Qb),ec&&p.destroyStream(jc),zc&&p.destroyStream(id),kd&&p.destroyStream(vd),u.unbind(),Ge.unbind(),Re&&Z.destroyStream(se)},scope:function(c,g,l){var m,r,b,q,H,na,A,e,J,P,Q,C,O,fa,ga,Xa,L,M,Ja,u,n,N,W,aa,B,K,xa,pa,Ea,F,Da,G,da,U,ka,V,ea,Ta,oa,Aa,ya,ma,ja,qa,ta,ua,Hb,za,Ga,Cc,mb,Ia,Sb,ha,Ra,$b,ac,cc,ib,pb,Ha,rb,Ka,fb,gb,La,kb,Va,tb,sb,Oa,Vd,Qa,Kb,Eb,Ma,xd,Ya,Lb,Mb,lb,Na,Zb,Pa,ub,vb,Sa,nb,hc,Ac,vc,db,kc,Dd,Wa,
...
wg,xg,yg,zg,Ag,Bg,gf,df,Of,Pf,jg,kg,lg,mg,ng,Zf,Uf,$f,ag,bg,og,Cg,Dg,Eg,Fg,Gg,Hg,Ig,Jg,Kg,Lg,Mg,Ng,Og,Pg;m=c.viewport;r=m.x|0;b=m.y|0;q="width"in m?m.width|0:y.framebufferWidth-r;H="height"in m?m.height|0:y.framebufferHeight-b;na=y.viewportWidth;y.viewportWidth=q;A=y.viewportHeight;y.viewportHeight=H;e=Xd[0];Xd[0]=r;J=Xd[1];Xd[1]=b;P=Xd[2];Xd[2]=q;Q=Xd[3];Xd[3]=H;C=la[0];la[0]=0;O=la[1];la[1]=0;fa=la[2];la[2]=0;ga=la[3];la[3]=1;Xa=Ba.blend_enable;Ba.blend_enable=!0;L=Fa[0];Fa[0]=770;M=Fa[1];Fa[1]=
771;Ja=Fa[2];Fa[2]=773;u=Fa[3];Fa[3]=1;n=Ba.depth_enable;Ba.depth_enable=!1;N=c.viewport;W=N.x|0;aa=N.y|0;B="width"in N?N.width|0:y.framebufferWidth-W;K="height"in N?N.height|0:y.framebufferHeight-aa;xa=re[0];re[0]=W;pa=re[1];re[1]=aa;Ea=re[2];re[2]=B;F=re[3];re[3]=K;Da=Ba.scissor_enable;Ba.scissor_enable=!0;G=Ba.stencil_enable;Ba.stencil_enable=!1;if(da=va.profile)U=performance.now(),ca.count++;ka=c.elements;V=null;V=(ea=sa(ka))?Z.createStream(ka):Z.getElements(ka);Ta=Ca.elements;Ca.elements=V;oa=
...
Jg=a.type;a.type=Uf;Kg=a.w;a.w=$f;Lg=a.x;a.x=ag;Mg=a.y;a.y=bg;Ng=a.z;a.z=og;Og=ra.vert;ra.vert=44;Pg=ra.frag;ra.frag=43;va.dirty=!0;g(y,c,l);y.viewportWidth=na;y.viewportHeight=A;Xd[0]=e;Xd[1]=J;Xd[2]=P;Xd[3]=Q;la[0]=C;la[1]=O;la[2]=fa;la[3]=ga;Ba.blend_enable=Xa;Fa[0]=L;Fa[1]=M;Fa[2]=Ja;Fa[3]=u;Ba.depth_enable=n;re[0]=xa;re[1]=pa;re[2]=Ea;re[3]=F;Ba.scissor_enable=Da;Ba.stencil_enable=G;da&&(ca.cpuTime+=performance.now()-U);ea&&Z.destroyStream(V);Ca.elements=Ta;Ca.offset=Aa;Ca.count=ma;Ca.primitive=
...
B);x=sa.polygonOffset_enable;x!==y.polygonOffset_enable&&(x?ga.enable(32823):ga.disable(32823),y.polygonOffset_enable=x);K=Ga[0];S=Ga[1];if(K!==ac[0]||S!==ac[1])ga.polygonOffset(K,S),ac[0]=K,ac[1]=S;Ea=sa.sample_alpha;Ea!==y.sample_alpha&&(Ea?ga.enable(32926):ga.disable(32926),y.sample_alpha=Ea);R=sa.sample_enable;R!==y.sample_enable&&(R?ga.enable(32928):ga.disable(32928),y.sample_enable=R);F=Sb[0];G=Sb[1];if(F!==ab[0]||G!==ab[1])ga.sampleCoverage(F,G),ab[0]=F,ab[1]=G;T=sa.stencil_mask;T!==y.stencil_mask&&
...
la[3]=1;ga.enable(3042);y.blend_enable=!0;ga.blendFuncSeparate(770,771,773,1);Fa[0]=770;Fa[1]=771;Fa[2]=773;Fa[3]=1;ga.disable(2929);y.depth_enable=!1;ga.enable(3089);y.scissor_enable=!0;ga.disable(2960);y.stencil_enable=!1;if(f=y.profile)h=performance.now(),ca.count+=d;ga.useProgram(ta.program);l=Bd.angle_instanced_arrays;var cb;wa.setVAO(null);ga.uniform1i(J.location,!1);ga.uniform1i(pa.location,N.bind());cb=va.instances;for(k=0;k<d;++k){b=a[k];var ob,Ua,hd,Ib,Jb,rc,Ob,jb,Gb,Db,wb,hb,Yb,Pb,qb,Ra,
...
Ud.x=af,Ud.y=Ye,Ud.z=Ue,Ud.w=Pe;We=p.pixelRatio;k&&jf===We||(jf=We,ga.uniform1f(za.location,We));nf=M.call(this,p,b,k);ef=nf[0];lf=nf[1];k&&kf===ef&&mf===lf||(kf=ef,mf=lf,ga.uniform2f(ma.location,ef,lf));rf=b.scale;of=rf[0];Bf=rf[1];k&&sf===of&&Cf===Bf||(sf=of,Cf=Bf,ga.uniform2f(xa.location,of,Bf));Qe=b.scaleFract;Ee=Qe[0];qf=Qe[1];k&&pf===Ee&&Df===qf||(pf=Ee,Df=qf,ga.uniform2f(fa.location,Ee,qf));Gf=b.translate;Af=Gf[0];Ff=Gf[1];k&&Ef===Af&&wf===Ff||(Ef=Af,wf=Ff,ga.uniform2f(ka.location,Af,Ff));
...
Hf,uf)),p.viewportWidth=rc,p.viewportHeight=Ob,Pb&&r.destroyStream(qb),sb&&r.destroyStream(Oa),Sa&&r.destroyStream(nb),Rb&&r.destroyStream(Ed),Bc&&r.destroyStream(cd),wd&&r.destroyStream(ue),Fd&&r.destroyStream(je),Sd&&r.destroyStream(ne),ee&&r.destroyStream(Me),Qf&&Ca.destroyStream(tf)}N.unbind();y.dirty=!0;wa.setVAO(null);f&&(ca.cpuTime+=performance.now()-h)},draw:function(a){var d,g,f,h,k,b,t,w,A,v,Ba,P,C,E,ra,O,D,I,M,z,N,x,S,Ea,R,T,V,X,ea,ba,ia,Y,ja,ta,Z,Cc,Ia,bc,yb,eb,Nb,cb,ob,Ua,Dd,Ib,Jb,rc,
...
Ba,P,C);re[0]=v;re[1]=Ba;re[2]=P;re[3]=C;ga.enable(3089);y.scissor_enable=!0;ga.disable(2960);y.stencil_enable=!1;if(E=y.profile)ra=performance.now(),ca.count++;ga.useProgram(K.program);O=Bd.angle_instanced_arrays;wa.setVAO(null);D=L.call(this,p,a,0);I=!1;M=null;z=0;N=!1;S=x=0;Ea=1;R=0;T=5126;ba=ea=X=V=0;H(D)?(I=!0,M=r.createStream(34962,D),T=M.dtype):(M=r.getBuffer(D))?T=M.dtype:"constant"in D?(Ea=2,"number"===typeof D.constant?(X=D.constant,ea=ba=V=0):(X=0<D.constant.length?D.constant[0]:0,ea=1<
D.constant.length?D.constant[1]:0,ba=2<D.constant.length?D.constant[2]:0,V=3<D.constant.length?D.constant[3]:0)):(M=H(D.buffer)?r.createStream(34962,D.buffer):r.getBuffer(D.buffer),T="type"in D?fe[D.type]:M.dtype,N=!!D.normalized,S=D.size|0,x=D.offset|0,R=D.stride|0,z=D.divisor|0);ia=ya.location;Y=Ta[ia];if(1===Ea){Y.buffer||ga.enableVertexAttribArray(ia);ja=S||1;if(Y.type!==T||Y.size!==ja||Y.buffer!==M||Y.normalized!==N||Y.offset!==x||Y.stride!==R)ga.bindBuffer(34962,M.buffer),ga.vertexAttribPointer(ia,
ja,T,N,R,x),Y.type=T,Y.size=ja,Y.buffer=M,Y.normalized=N,Y.offset=x,Y.stride=R;Y.divisor!==z&&(O.vertexAttribDivisorANGLE(ia,z),Y.divisor=z)}else if(Y.buffer&&(ga.disableVertexAttribArray(ia),Y.buffer=null),Y.x!==X||Y.y!==ea||Y.z!==ba||Y.w!==V)ga.vertexAttrib4f(ia,X,ea,ba,V),Y.x=X,Y.y=ea,Y.z=ba,Y.w=V;ta=e.call(this,p,a,0);Z=!1;Cc=null;Ia=0;bc=!1;eb=yb=0;Nb=1;cb=0;ob=5126;Jb=Ib=Dd=Ua=0;H(ta)?(Z=!0,Cc=r.createStream(34962,ta),ob=Cc.dtype):(Cc=r.getBuffer(ta))?ob=Cc.dtype:"constant"in ta?(Nb=2,"number"===
...
w,E&&(ca.cpuTime+=performance.now()-ra),I&&r.destroyStream(M),Z&&r.destroyStream(Cc),Db&&r.destroyStream(wb),La&&r.destroyStream(kb),Zb&&r.destroyStream(Pa),uc&&r.destroyStream(Wb),Xb&&r.destroyStream(ec),ed&&r.destroyStream(zc),rd&&r.destroyStream(kd),u.unbind(),Ge&&Ca.destroyStream(ne)},scope:function(c,g,l){var b,m,q,A,e,na,J,P,C,Q,O,fa,M,ga,L,Xa,u,Ja,la,n,N,W,B,aa,wa,K,xa,pa,F,Da,G,U,da,ka,V,ea,Ta,oa,ta,Aa,ya,ja,ma,qa,ua,Hb,za,Cc,Z,Ga,Fa,mb,Bd,Sb,ha,Ra,$b,ac,Vd,ib,pb,Ha,rb,Ka,fb,gb,La,kb,Va,tb,
...
Hf,uf,cg,Rf,Sf,qg,ff,cf,Mf,Nf,dg,eg,fg,gg,hg,Vf,Tf,Wf,Xf,Yf,ig,rg,sg,tg,ug,vg,wg,xg,yg,zg,Ag,Bg,gf,df,Of,Pf,jg,kg,lg,mg,ng,Zf,Uf,$f,ag,bg,og,Cg,Dg,Eg,Fg,Gg,Hg,Ig,Jg,Kg,Lg,Mg,Ng,Og;b=c.viewport;m=b.x|0;q=b.y|0;A="width"in b?b.width|0:p.framebufferWidth-m;e="height"in b?b.height|0:p.framebufferHeight-q;na=p.viewportWidth;p.viewportWidth=A;J=p.viewportHeight;p.viewportHeight=e;P=Ed[0];Ed[0]=m;C=Ed[1];Ed[1]=q;Q=Ed[2];Ed[2]=A;O=Ed[3];Ed[3]=e;fa=Ea[0];Ea[0]=0;M=Ea[1];Ea[1]=0;ga=Ea[2];Ea[2]=0;L=Ea[3];Ea[3]=
1;Xa=sa.blend_enable;sa.blend_enable=!0;u=Ia[0];Ia[0]=770;Ja=Ia[1];Ia[1]=771;la=Ia[2];Ia[2]=773;n=Ia[3];Ia[3]=1;N=sa.depth_enable;sa.depth_enable=!1;W=c.viewport;B=W.x|0;aa=W.y|0;wa="width"in W?W.width|0:p.framebufferWidth-B;K="height"in W?W.height|0:p.framebufferHeight-aa;xa=Dd[0];Dd[0]=B;pa=Dd[1];Dd[1]=aa;F=Dd[2];Dd[2]=wa;Da=Dd[3];Dd[3]=K;G=sa.scissor_enable;sa.scissor_enable=!0;U=sa.stencil_enable;sa.stencil_enable=!1;if(da=y.profile)ka=performance.now(),ca.count++;V=c.elements;ea=null;ea=(Ta=
...
lg;Gg=a.state;a.state=mg;Hg=a.stride;a.stride=ng;Ig=a.type;a.type=Zf;Jg=a.w;a.w=Uf;Kg=a.x;a.x=$f;Lg=a.y;a.y=ag;Mg=a.z;a.z=bg;Ng=Ba.vert;Ba.vert=59;Og=Ba.frag;Ba.frag=58;y.dirty=!0;g(p,c,l);p.viewportWidth=na;p.viewportHeight=J;Ed[0]=P;Ed[1]=C;Ed[2]=Q;Ed[3]=O;Ea[0]=fa;Ea[1]=M;Ea[2]=ga;Ea[3]=L;sa.blend_enable=Xa;Ia[0]=u;Ia[1]=Ja;Ia[2]=la;Ia[3]=n;sa.depth_enable=N;Dd[0]=xa;Dd[1]=pa;Dd[2]=F;Dd[3]=Da;sa.scissor_enable=G;sa.stencil_enable=U;da&&(ca.cpuTime+=performance.now()-ka);Ta&&Ca.destroyStream(ea);
...
!0}}},"$22,align,atlas,atlasDim,atlasSize,baseline,char,charOffset,charStep,color,em,opacity,position,positionOffset,scale,translate,viewport,width":function(b,ca,K,L,e,l,q,c,F,B,G,U,n,u,x,ba,v,T,z,R,ia,h,t,S,k,X,f,w,Y,D,E,d,I,a,ta,A,ja,Cc,V,ea){var O,P,C,g,N,M,Da,qa,m,J,aa,Q,ma,pa,za,xa,fa,Aa,ka,oa,ya,Ja,na,Xa,Ta,r,p,y,va,Ca,Z,Hb,ga,H,sa,Ba,ra,wa,Ea,la,W;O=b.attributes;P=b.buffer;C=b.context;g=b.current;N=b.draw;M=b.elements;Da=b.extensions;qa=b.framebuffer;m=b.gl;J=b.isBufferArgs;aa=b.next;Q=b.shader;
...
uint8:5121,uint16:5123,uint32:5125,"float":5126,float32:5126};la={offset:4,stride:8};W={offset:0,stride:8};return{batch:function(c,l){var b,q,e,v,Q,ra,L,u,n,B,x,K,F;b=qa.next;b!==qa.cur&&(b?m.bindFramebuffer(36160,b.framebuffer):m.bindFramebuffer(36160,null),qa.cur=b);if(g.dirty){var G,U,ka,ba,ma,za,ha,Md,ab,Ze,$e,Gd,Ae,te,Yd,Ad,Zd,ld,bd,pd,Lc,nd,Gc,fd,Pc,Wc,Bb,Fb,Dc,xb,xc,Cb,Jc,mc,Hc,Xc,Vc,Ec,fc;G=aa.dither;G!==g.dither&&(G?m.enable(3024):m.disable(3024),g.dither=G);U=fa[0];ka=fa[1];if(U!==Aa[0]||
...
771,773,1);oa[0]=770;oa[1]=771;oa[2]=773;oa[3]=1;m.disable(2929);g.depth_enable=!1;m.disable(2960);g.stencil_enable=!1;if(B=g.profile)x=performance.now(),ca.count++;m.useProgram(K.program);F=Da.angle_instanced_arrays;pa.setVAO(null);W.buffer=this.sizeBuffer;R=!1;G=null;T=0;U=!1;ba=ka=0;ia=1;ma=0;za=5126;Ze=Xe=ab=ha=0;J(W)?(R=!0,G=P.createStream(34962,W),za=G.dtype):(G=P.getBuffer(W))?za=G.dtype:"constant"in W?(ia=2,"number"===typeof W.constant?(ab=W.constant,Xe=Ze=ha=0):(ab=0<W.constant.length?W.constant[0]:
...
Ka=rb._texture;m.uniform1i(k.location,Ka.bind());(fb=N.elements)?m.bindBuffer(34963,fb.buffer.buffer):pa.currentVAO&&(fb=M.getElements(pa.currentVAO.elements))&&m.bindBuffer(34963,fb.buffer.buffer);gb=h.offset;if(La=h.count)kb=N.instances,0<kb?fb?F.drawElementsInstancedANGLE(0,La,fb.type,gb<<(fb.type-5121>>1),kb):F.drawArraysInstancedANGLE(0,gb,La,kb):0>kb&&(fb?m.drawElements(0,La,fb.type,gb<<(fb.type-5121>>1)):m.drawArrays(0,gb,La)),g.dirty=!0,pa.setVAO(null),C.viewportWidth=n,C.viewportHeight=z,
B&&(ca.cpuTime+=performance.now()-x),R&&P.destroyStream(G),te&&P.destroyStream(Yd),xc&&P.destroyStream(Cb),eb&&P.destroyStream(Nb),Ka.unbind()},scope:function(a,d,c){var f,h,l,b,k,m,r,p,q,H,y,t,w,e,A,na,sa,Ba,D,E,O,fa,M,ga,I,L,Xa,Ja,z,K,wa,va,R,xa,pa,S,Da,T,V,X,ea,Ta,Y,oa,ia,ta,Aa,ya,ja,qa,Ca,Hb,Z,Cc,Bd,ha,bb,bc,yb,eb,Nb,cb,ob,Ua,ab,Ib,Jb,rc,Ob,jb,Gb,Db,wb,hb,Yb,Pb,qb,Ra,Ub,zb,cc,ib,pb,Ha,rb,Ka,fb,gb,La,kb,Va,tb,sb,Oa,tc,Qa,Kb,Eb,Ma,yd,Ya,Lb,Mb,lb,Na,Zb,Pa,ub,vb,Sa,nb,hc,Ac,vc,db,kc,qd,Wa,Mc,Ab,Za,
...
ka[1];ka[1]=771;D=ka[2];ka[2]=773;E=ka[3];ka[3]=1;O=aa.depth_enable;aa.depth_enable=!1;fa=aa.stencil_enable;aa.stencil_enable=!1;if(M=g.profile)ga=performance.now(),ca.count++;I=a.offset;L=N.offset;N.offset=I;Xa=a.count;Ja=N.count;N.count=Xa;z=N.primitive;N.primitive=0;K=a.align;wa=ma[64];ma[64]=K;va=F.call(this,C,a,c);R=ma[69];ma[69]=va;xa=B.call(this,C,a,c);pa=ma[67];ma[67]=xa;S=G.call(this,C,a,c);Da=ma[66];ma[66]=S;T=a.baseline;V=ma[65];ma[65]=T;X=U.call(this,C,a,c);ea=ma[62];ma[62]=X;Ta=a.color;
...
g);M!==Da&&(q.depthFunc(M),e.depth_func=M);ca!==m&&(q.depthMask(ca),e.depth_mask=ca);if(T[0]!==z[0]||T[1]!==z[1])q.depthRange(T[0],T[1]),z[0]=T[0],z[1]=T[1];J!==aa&&(q.frontFace(J),e.frontFace=J);Q!==ma&&(q.lineWidth(Q),e.lineWidth=Q);if(R[0]!==ia[0]||R[1]!==ia[1])q.polygonOffset(R[0],R[1]),ia[0]=R[0],ia[1]=R[1];if(h[0]!==t[0]||h[1]!==t[1])q.sampleCoverage(h[0],h[1]),t[0]=h[0],t[1]=h[1];if(S[0]!==k[0]||S[1]!==k[1]||S[2]!==k[2]||S[3]!==k[3])q.scissor(S[0],S[1],S[2],S[3]),k[0]=S[0],k[1]=S[1],k[2]=S[2],
...
d[2],d[3]),I[0]=d[0],I[1]=d[1],I[2]=d[2],I[3]=d[3]},refresh:function(){var a,b,A,K,ca,V,ea,O,P,C,g,N,M,Da,qa,m;e.dirty=!1;b=c.blend_enable;A=c.cull_enable;K=c.depth_enable;ca=c.dither;V=c.polygonOffset_enable;ea=c.sample_alpha;O=c.sample_enable;P=c.scissor_enable;C=c.stencil_enable;g=c.cull_face;N=c.depth_func;M=c.depth_mask;Da=c.frontFace;qa=c.lineWidth;m=c.stencil_mask;(a=l.next)?q.bindFramebuffer(36160,a.framebuffer):q.bindFramebuffer(36160,null);l.cur=a;a=L[0];a.buffer?(q.enableVertexAttribArray(0),
...
B.scissor_enable=g)}if(g=B.profile)q=performance.now(),L.count+=b;e=u.program(u.vert,u.frag,K);U.useProgram(e.program);x.setVAO(null);D=e.id;(E=O[D])||(E=O[D]=c(e));E.call(this,l,b);B.dirty=!0;x.setVAO(null);g&&(L.cpuTime+=performance.now()-q)}}},$5:function(b,ca,K,L,e,l){var q,c,F,B,G,U,n,u,x,ba,v,T,z,R,ia,h,t,S,k,X,f,w,Y,D,E,d,I,a,ta,A,ja,Z,V;q=b.context;c=b.current;F=b.framebuffer;B=b.gl;G=b.next;U=b.shader;n=b.vao;u=G.blend_color;x=c.blend_color;ba=G.blend_equation;v=c.blend_equation;T=G.blend_func;
...
(M=V[N])||(M=V[N]=l(g));M.call(this,b,q);n.setVAO(null);e&&(L.cpuTime+=performance.now()-C)}}},"$26,color,freq,phase,projection,time,view":function(b,ca,K,L,e,l,q,c,F,B,G,U,n,u,x,ba,v,T,z,R,ia,h,t,S,k,X,f,w,Y,D,E,d,I){var a,ta,A,ja,Z,V,ea,O,P,C,g,N,M,Da,qa,m,J,aa,Q,ma,pa,za,xa,fa,Aa,ka,oa,ya,Ja,na,Xa,Ta,r,p,y,va,Ca,ha,Hb,ga;a=b.attributes;ta=b.context;A=b.current;ja=b.draw;Z=b.elements;V=b.framebuffer;ea=b.gl;O=b.isArrayLike;P=b.next;C=b.shader;g=b.uniforms;N=b.vao;M=P.blend_color;Da=A.blend_color;
...
c.buffer),ea.vertexAttribPointer(h,3,5126,!1,44,32),k.type=5126,k.size=3,k.buffer=c,k.normalized=!1,k.offset=32,k.stride=44;h=F.call(this,ta,g,0);"number"!==typeof h&&ca.commandRaise(B,K);ea.uniform1f(d.location,h);h=G.call(this,ta,g,0);O(h)&&16===h.length||ca.commandRaise(U,K);ea.uniformMatrix4fv(I.location,!1,Array.isArray(h)||h instanceof Float32Array?h:(Ca[0]=h[0],Ca[1]=h[1],Ca[2]=h[2],Ca[3]=h[3],Ca[4]=h[4],Ca[5]=h[5],Ca[6]=h[6],Ca[7]=h[7],Ca[8]=h[8],Ca[9]=h[9],Ca[10]=h[10],Ca[11]=h[11],Ca[12]=
h[12],Ca[13]=h[13],Ca[14]=h[14],Ca[15]=h[15],Ca));g=n.call(this,ta,g,0);O(g)&&16===g.length||ca.commandRaise(u,K);ea.uniformMatrix4fv(E.location,!1,Array.isArray(g)||g instanceof Float32Array?g:(ha[0]=g[0],ha[1]=g[1],ha[2]=g[2],ha[3]=g[3],ha[4]=g[4],ha[5]=g[5],ha[6]=g[6],ha[7]=g[7],ha[8]=g[8],ha[9]=g[9],ha[10]=g[10],ha[11]=g[11],ha[12]=g[12],ha[13]=g[13],ha[14]=g[14],ha[15]=g[15],ha));(g=ja.elements)?ea.bindBuffer(34963,g.buffer.buffer):N.currentVAO&&(g=Z.getElements(N.currentVAO.elements))&&ea.bindBuffer(34963,
g.buffer.buffer);h=ja.offset;g?ea.drawElements(0,1E4,g.type,h<<(g.type-5121>>1)):ea.drawArrays(0,h,1E4);N.setVAO(null);f&&(L.cpuTime+=performance.now()-b)},scope:function(a,d,f){var h,b,k,m,r,p,e,y,t,w,na,D,J,E,Q,fa,I,ga,u,Xa,Ja,n,K,B,N,aa,M,O,F,va,P,S,pa,xa,G,U,ka,V,X,ca,ea,Da,Ta,Y,oa;if(h=A.profile)b=performance.now(),L.count++;k=ja.count;ja.count=1E4;m=ja.primitive;ja.primitive=0;r=x.call(this,ta,a,f);p=g[5];g[5]=r;e=ba.call(this,ta,a,f);r=g[3];g[3]=e;y=v.call(this,ta,a,f);e=g[4];g[4]=y;y=T.buffer;
T.buffer=c;t=T.divisor;T.divisor=0;w=T.normalized;T.normalized=!1;na=T.offset;T.offset=32;D=T.size;T.size=0;J=T.state;T.state=1;E=T.stride;T.stride=44;Q=T.type;T.type=5126;fa=T.w;T.w=0;I=T.x;T.x=0;ga=T.y;T.y=0;u=T.z;T.z=0;Xa=z.buffer;z.buffer=l;Ja=z.divisor;z.divisor=0;n=z.normalized;z.normalized=!1;K=z.offset;z.offset=0;B=z.size;z.size=0;N=z.state;z.state=1;aa=z.stride;z.stride=44;M=z.type;z.type=5126;O=z.w;z.w=0;F=z.x;z.x=0;va=z.y;z.y=0;P=z.z;z.z=0;S=R.buffer;R.buffer=q;pa=R.divisor;R.divisor=0;
...
N;z.stride=aa;z.type=M;z.w=O;z.x=F;z.y=va;z.z=P;R.buffer=S;R.divisor=pa;R.normalized=xa;R.offset=G;R.size=U;R.state=ka;R.stride=V;R.type=X;R.w=ca;R.x=ea;R.y=Da;R.z=Ta;C.vert=Y;C.frag=oa},batch:function(g,b){var e,v,C;e=V.next;e!==V.cur&&(e?ea.bindFramebuffer(36160,e.framebuffer):ea.bindFramebuffer(36160,null),V.cur=e);if(A.dirty){var u,n,z;e=P.dither;e!==A.dither&&(e?ea.enable(3024):ea.disable(3024),A.dither=e);e=P.blend_enable;e!==A.blend_enable&&(e?ea.enable(3042):ea.disable(3042),A.blend_enable=
e);e=M[0];u=M[1];n=M[2];z=M[3];if(e!==Da[0]||u!==Da[1]||n!==Da[2]||z!==Da[3])ea.blendColor(e,u,n,z),Da[0]=e,Da[1]=u,Da[2]=n,Da[3]=z;e=qa[0];u=qa[1];if(e!==m[0]||u!==m[1])ea.blendEquationSeparate(e,u),m[0]=e,m[1]=u;e=J[0];u=J[1];n=J[2];z=J[3];if(e!==aa[0]||u!==aa[1]||n!==aa[2]||z!==aa[3])ea.blendFuncSeparate(e,u,n,z),aa[0]=e,aa[1]=u,aa[2]=n,aa[3]=z;e=P.depth_enable;e!==A.depth_enable&&(e?ea.enable(2929):ea.disable(2929),A.depth_enable=e);e=P.depth_func;e!==A.depth_func&&(ea.depthFunc(e),A.depth_func=
...
ca,K,L,e,l,q,c,F,B,G,U,n,u,x,ba,v,T,z,R,ia,h,t,S,k,X,f,w,Y,D,E,d,I,a,ta,A,ja,Z,V,ea,O){var P,C,g,N,M,Da,qa,m,J,aa,Q,ma,pa,za,xa,fa,Aa,ka,oa,ya,Ja,na,Xa,Ta,r,p,y,va,Ca,ha,Hb,ga,H,sa,Ba,ra,wa,Ea,la,W,ua,Ia,Fa;P=b.attributes;C=b.buffer;g=b.context;N=b.current;M=b.draw;Da=b.elements;qa=b.framebuffer;m=b.gl;J=b.isArrayLike;aa=b.isBufferArgs;Q=b.next;ma=b.shader;pa=b.uniforms;za=b.vao;xa=Q.blend_color;fa=N.blend_color;Aa=Q.blend_equation;ka=N.blend_equation;oa=Q.blend_func;ya=N.blend_func;Ja=Q.colorMask;
na=N.colorMask;Xa=Q.depth_range;Ta=N.depth_range;r=Q.polygonOffset_offset;p=N.polygonOffset_offset;y=Q.sample_coverage;va=N.sample_coverage;Ca=Q.scissor_box;ha=N.scissor_box;Hb=Q.stencil_func;ga=N.stencil_func;H=Q.stencil_opBack;sa=N.stencil_opBack;Ba=Q.stencil_opFront;ra=N.stencil_opFront;wa=Q.viewport;Ea=N.viewport;la={int8:5120,int16:5122,int32:5124,uint8:5121,uint16:5123,uint32:5125,"float":5126,float32:5126};W=new Float32Array(16);ua=new Float32Array(16);Ia=new Float32Array(16);Fa=new Float32Array(16);
return{draw:function(a){var d,f,h,b,k,t,w,v,D,E,z,I,M,R,S,pa,T,X,ba,Y,ia,ma,ta,Fa,Ia,ab,Ad,Zd,ld,bd,pd,Lc,nd,Gc,fd,Pc,Wc,Bb,Fb,Dc,xb,xc,Cb,Jc,mc,Hc,Xc,Vc,Ec,fc,Ic,pc,qc,nc,gc,bb,bc,yb,eb,Nb,cb,ob;d=g.view;f=e.call(this,g,a,0);g.view=f;h=qa.next;h!==qa.cur&&(h?m.bindFramebuffer(36160,h.framebuffer):m.bindFramebuffer(36160,null),qa.cur=h);if(N.dirty){var Ua,hd,Ib,Jb,rc,Ob,jb,Gb,Db,wb,hb,Yb,Pb,qb,Ra,Ub,zb,cc,ib,pb,Ha,rb,Ka,fb,gb,La,kb,Va,tb,sb,Oa,tc,Qa,Kb,Eb,Ma,yd,Ya,Lb,Mb,lb,Na,Zb,Pa,ub,vb,Sa,nb,hc,
Ac,vc,db;Ua=Q.dither;Ua!==N.dither&&(Ua?m.enable(3024):m.disable(3024),N.dither=Ua);hd=Q.blend_enable;hd!==N.blend_enable&&(hd?m.enable(3042):m.disable(3042),N.blend_enable=hd);Ib=xa[0];Jb=xa[1];rc=xa[2];Ob=xa[3];if(Ib!==fa[0]||Jb!==fa[1]||rc!==fa[2]||Ob!==fa[3])m.blendColor(Ib,Jb,rc,Ob),fa[0]=Ib,fa[1]=Jb,fa[2]=rc,fa[3]=Ob;jb=Aa[0];Gb=Aa[1];if(jb!==ka[0]||Gb!==ka[1])m.blendEquationSeparate(jb,Gb),ka[0]=jb,ka[1]=Gb;Db=oa[0];wb=oa[1];hb=oa[2];Yb=oa[3];if(Db!==ya[0]||wb!==ya[1]||hb!==ya[2]||Yb!==ya[3])m.blendFuncSeparate(Db,
...
yd,Ya,Lb),ra[0]=Ma,ra[1]=yd,ra[2]=Ya,ra[3]=Lb;Mb=H[0];lb=H[1];Na=H[2];Zb=H[3];if(Mb!==sa[0]||lb!==sa[1]||Na!==sa[2]||Zb!==sa[3])m.stencilOpSeparate(Mb,lb,Na,Zb),sa[0]=Mb,sa[1]=lb,sa[2]=Na,sa[3]=Zb;Pa=Q.scissor_enable;Pa!==N.scissor_enable&&(Pa?m.enable(3089):m.disable(3089),N.scissor_enable=Pa);ub=Ca[0];vb=Ca[1];Sa=Ca[2];nb=Ca[3];if(ub!==ha[0]||vb!==ha[1]||Sa!==ha[2]||nb!==ha[3])m.scissor(ub,vb,Sa,nb),ha[0]=ub,ha[1]=vb,ha[2]=Sa,ha[3]=nb;hc=wa[0];Ac=wa[1];vc=wa[2];db=wa[3];if(hc!==Ea[0]||Ac!==Ea[1]||
vc!==Ea[2]||db!==Ea[3])m.viewport(hc,Ac,vc,db),Ea[0]=hc,Ea[1]=Ac,Ea[2]=vc,Ea[3]=db}m.enable(2884);N.cull_enable=!0;m.cullFace(1029);N.cull_face=1029;if(b=N.profile)k=performance.now(),L.count++;m.useProgram(l.program);za.setVAO(null);(t=a.position)&&("object"===typeof t||"function"===typeof t)&&(aa(t)||C.getBuffer(t)||C.getBuffer(t.buffer)||aa(t.buffer)||"constant"in t&&("number"===typeof t.constant||J(t.constant)))||ca.commandRaise(q,K);w=!1;v=null;D=!1;z=E=0;I=1;M=0;R=5126;X=T=pa=S=0;aa(t)?(w=!0,
...
ia=z||3,Y.type!==R||Y.size!==ia||Y.buffer!==v||Y.normalized!==D||Y.offset!==E||Y.stride!==M)m.bindBuffer(34962,v.buffer),m.vertexAttribPointer(ba,ia,R,D,M,E),Y.type=R,Y.size=ia,Y.buffer=v,Y.normalized=D,Y.offset=E,Y.stride=M}else if(Y.buffer&&(m.disableVertexAttribArray(ba),Y.buffer=null),Y.x!==pa||Y.y!==T||Y.z!==X||Y.w!==S)m.vertexAttrib4f(ba,pa,T,X,S),Y.x=pa,Y.y=T,Y.z=X,Y.w=S;(ma=a.normal)&&("object"===typeof ma||"function"===typeof ma)&&(aa(ma)||C.getBuffer(ma)||C.getBuffer(ma.buffer)||aa(ma.buffer)||
"constant"in ma&&("number"===typeof ma.constant||J(ma.constant)))||ca.commandRaise(c,K);ta=!1;Fa=null;Ia=!1;Ad=ab=0;Zd=1;ld=0;bd=5126;Gc=nd=Lc=pd=0;aa(ma)?(ta=!0,Fa=C.createStream(34962,ma),bd=Fa.dtype):(Fa=C.getBuffer(ma))?bd=Fa.dtype:"constant"in ma?(Zd=2,"number"===typeof ma.constant?(Lc=ma.constant,nd=Gc=pd=0):(Lc=0<ma.constant.length?ma.constant[0]:0,nd=1<ma.constant.length?ma.constant[1]:0,Gc=2<ma.constant.length?ma.constant[2]:0,pd=3<ma.constant.length?ma.constant[3]:0)):(Fa=aa(ma.buffer)?
...
m.drawElements(cb,ob,eb.type,0<<(eb.type-5121>>1)):m.drawArrays(cb,0,ob),N.dirty=!0,za.setVAO(null),g.view=d,b&&(L.cpuTime+=performance.now()-k),w&&C.destroyStream(v),ta&&C.destroyStream(Fa),Fb&&C.destroyStream(Dc),bc.unbind(),Nb&&Da.destroyStream(eb))},scope:function(a,d,c){var f,b,k,l,m,r,p,e,q,H,y,w,A,na,u,D,E,n,fa,I,ga,Xa,Ja,B,sa,x,Ba,O,F,va,P,ra,W,xa,G,U,ka,V,X,Y,ea,Ta,wa,oa,Aa,ya,ta,ja,Ea,Ca,za,Hb,qa,Z,ua,ha,Fa,Cc,Ia,Bd,Ua,ab,Ib,Jb,rc,Ob,jb,Gb,Db,wb,hb,Yb,Pb,qb,Ra,Ub,zb,cc,ib,pb,Ha,rb,Ka,fb,
gb,La,kb,Va,tb,sb,Oa,tc,Qa,Kb,Eb,Ma,yd,Ya,Lb,Mb,lb;f=g.view;b=ba.call(this,g,a,c);g.view=b;k=Q.cull_enable;Q.cull_enable=!0;l=Q.cull_face;Q.cull_face=1029;if(m=N.profile)r=performance.now(),L.count++;p=a.elements;e=null;(q=aa(p))?e=Da.createStream(p):(e=Da.getElements(p),p&&!e&&ca.commandRaise(v,K));H=M.elements;M.elements=e;y=M.offset;M.offset=0;w=e?e.vertCount:-1;A=M.count;M.count=w;na=e?e.primType:4;u=M.primitive;M.primitive=na;D=a.atlas;E=pa[5];pa[5]=D;n=T.call(this,g,a,c);fa=pa[3];pa[3]=n;I=
g.view;ga=pa[4];pa[4]=I;(Xa=a.normal)&&("object"===typeof Xa||"function"===typeof Xa)&&(aa(Xa)||C.getBuffer(Xa)||C.getBuffer(Xa.buffer)||aa(Xa.buffer)||"constant"in Xa&&("number"===typeof Xa.constant||J(Xa.constant)))||ca.commandRaise(z,K);Ja=!1;B=null;sa=0;x=!1;O=Ba=0;F=1;va=0;P=5126;G=xa=W=ra=0;aa(Xa)?(Ja=!0,B=C.createStream(34962,Xa),P=B.dtype):(B=C.getBuffer(Xa))?P=B.dtype:"constant"in Xa?(F=2,"number"===typeof Xa.constant?(W=Xa.constant,xa=G=ra=0):(W=0<Xa.constant.length?Xa.constant[0]:0,xa=
...
Aa=R.x;R.x=W;ya=R.y;R.y=xa;ta=R.z;R.z=G;(ja=a.position)&&("object"===typeof ja||"function"===typeof ja)&&(aa(ja)||C.getBuffer(ja)||C.getBuffer(ja.buffer)||aa(ja.buffer)||"constant"in ja&&("number"===typeof ja.constant||J(ja.constant)))||ca.commandRaise(ia,K);Ea=!1;Ca=null;za=0;Hb=!1;Z=qa=0;ua=1;ha=0;Fa=5126;Ua=Bd=Ia=Cc=0;aa(ja)?(Ea=!0,Ca=C.createStream(34962,ja),Fa=Ca.dtype):(Ca=C.getBuffer(ja))?Fa=Ca.dtype:"constant"in ja?(ua=2,"number"===typeof ja.constant?(Ia=ja.constant,Bd=Ua=Cc=0):(Ia=0<ja.constant.length?
...
S.state=Ha;Kb=S.stride;S.stride=rb;Eb=S.type;S.type=Ka;Ma=S.w;S.w=fb;yd=S.x;S.x=gb;Ya=S.y;S.y=La;Lb=S.z;S.z=kb;Mb=ma.vert;ma.vert=2;lb=ma.frag;ma.frag=1;N.dirty=!0;d(g,a,c);g.view=f;Q.cull_enable=k;Q.cull_face=l;m&&(L.cpuTime+=performance.now()-r);q&&Da.destroyStream(e);M.elements=H;M.offset=y;M.count=A;M.primitive=u;pa[5]=E;pa[3]=fa;pa[4]=ga;Ja&&C.destroyStream(B);R.buffer=U;R.divisor=ka;R.normalized=V;R.offset=X;R.size=Y;R.state=ea;R.stride=Ta;R.type=wa;R.w=oa;R.x=Aa;R.y=ya;R.z=ta;Ea&&C.destroyStream(Ca);
h.buffer=ab;h.divisor=Ib;h.normalized=Jb;h.offset=rc;h.size=Ob;h.state=jb;h.stride=Gb;h.type=Db;h.w=wb;h.x=hb;h.y=Yb;h.z=Pb;Ra&&C.destroyStream(Ub);S.buffer=Va;S.divisor=tb;S.normalized=sb;S.offset=Oa;S.size=tc;S.state=Qa;S.stride=Kb;S.type=Eb;S.w=Ma;S.x=yd;S.y=Ya;S.z=Lb;ma.vert=Mb;ma.frag=lb;N.dirty=!0},batch:function(c,h){var b,l,e,q,t,v,u;b=g.view;l=k.call(this,g,c,0);g.view=l;e=qa.next;e!==qa.cur&&(e?m.bindFramebuffer(36160,e.framebuffer):m.bindFramebuffer(36160,null),qa.cur=e);if(N.dirty){var n,
z,B,x,M,F,R,W,S,pa,G,T,U,ba,ma,ia,ua,ab,Ad,Zd,ld,bd,pd,Lc,nd,Gc,fd,Pc,Wc,Bb,Fb,Dc,xb,xc,Cb,Jc,mc,Hc,Xc,Vc,Ec,fc,Ic,pc,qc,nc,gc,bb,bc,yb,eb,Nb;n=Q.dither;n!==N.dither&&(n?m.enable(3024):m.disable(3024),N.dither=n);z=Q.blend_enable;z!==N.blend_enable&&(z?m.enable(3042):m.disable(3042),N.blend_enable=z);B=xa[0];x=xa[1];M=xa[2];F=xa[3];if(B!==fa[0]||x!==fa[1]||M!==fa[2]||F!==fa[3])m.blendColor(B,x,M,F),fa[0]=B,fa[1]=x,fa[2]=M,fa[3]=F;R=Aa[0];W=Aa[1];if(R!==ka[0]||W!==ka[1])m.blendEquationSeparate(R,W),
...
mc=Ba[1];Hc=Ba[2];Xc=Ba[3];if(Jc!==ra[0]||mc!==ra[1]||Hc!==ra[2]||Xc!==ra[3])m.stencilOpSeparate(Jc,mc,Hc,Xc),ra[0]=Jc,ra[1]=mc,ra[2]=Hc,ra[3]=Xc;Vc=H[0];Ec=H[1];fc=H[2];Ic=H[3];if(Vc!==sa[0]||Ec!==sa[1]||fc!==sa[2]||Ic!==sa[3])m.stencilOpSeparate(Vc,Ec,fc,Ic),sa[0]=Vc,sa[1]=Ec,sa[2]=fc,sa[3]=Ic;pc=Q.scissor_enable;pc!==N.scissor_enable&&(pc?m.enable(3089):m.disable(3089),N.scissor_enable=pc);qc=Ca[0];nc=Ca[1];gc=Ca[2];bb=Ca[3];if(qc!==ha[0]||nc!==ha[1]||gc!==ha[2]||bb!==ha[3])m.scissor(qc,nc,gc,
bb),ha[0]=qc,ha[1]=nc,ha[2]=gc,ha[3]=bb;bc=wa[0];yb=wa[1];eb=wa[2];Nb=wa[3];if(bc!==Ea[0]||yb!==Ea[1]||eb!==Ea[2]||Nb!==Ea[3])m.viewport(bc,yb,eb,Nb),Ea[0]=bc,Ea[1]=yb,Ea[2]=eb,Ea[3]=Nb}m.enable(2884);N.cull_enable=!0;m.cullFace(1029);N.cull_face=1029;if(q=N.profile)t=performance.now(),L.count+=h;m.useProgram(X.program);var cb,ob;za.setVAO(null);cb=D.call(this,g,u,v);J(cb)&&16===cb.length||ca.commandRaise(E,K);m.uniformMatrix4fv(V.location,!1,Array.isArray(cb)||cb instanceof Float32Array?cb:(Ia[0]=
cb[0],Ia[1]=cb[1],Ia[2]=cb[2],Ia[3]=cb[3],Ia[4]=cb[4],Ia[5]=cb[5],Ia[6]=cb[6],Ia[7]=cb[7],Ia[8]=cb[8],Ia[9]=cb[9],Ia[10]=cb[10],Ia[11]=cb[11],Ia[12]=cb[12],Ia[13]=cb[13],Ia[14]=cb[14],Ia[15]=cb[15],Ia));ob=g.view;J(ob)&&16===ob.length||ca.commandRaise(d,K);m.uniformMatrix4fv(O.location,!1,Array.isArray(ob)||ob instanceof Float32Array?ob:(Fa[0]=ob[0],Fa[1]=ob[1],Fa[2]=ob[2],Fa[3]=ob[3],Fa[4]=ob[4],Fa[5]=ob[5],Fa[6]=ob[6],Fa[7]=ob[7],Fa[8]=ob[8],Fa[9]=ob[9],Fa[10]=ob[10],Fa[11]=ob[11],Fa[12]=ob[12],
Fa[13]=ob[13],Fa[14]=ob[14],Fa[15]=ob[15],Fa));for(v=0;v<h;++v){u=c[v];var Ua,hd,Ib,Jb,rc,Ob,jb,Gb,Db,wb,hb,Yb,Pb,qb,Ra,Ub,zb,cc,ib,pb,Ha,rb,Ka,fb,gb,La,kb,Va,tb,sb,Oa,tc,Qa,Kb,Eb,Ma,yd,Ya,Lb,Mb,lb,Na,Zb,Pa,ub,vb,Sa,nb,hc,Ac,vc,db,kc,qd,Wa;(Ua=u.position)&&("object"===typeof Ua||"function"===typeof Ua)&&(aa(Ua)||C.getBuffer(Ua)||C.getBuffer(Ua.buffer)||aa(Ua.buffer)||"constant"in Ua&&("number"===typeof Ua.constant||J(Ua.constant)))||ca.commandRaise(f,K);hd=!1;Ib=null;Jb=!1;Ob=rc=0;jb=1;Gb=0;Db=5126;
...
db.type,0<<(db.type-5121>>1)):m.drawArrays(qd,0,Wa),hd&&C.destroyStream(Ib),cc&&C.destroyStream(ib),Kb&&C.destroyStream(Eb),Ac.unbind(),kc&&Da.destroyStream(db))}N.dirty=!0;za.setVAO(null);g.view=b;q&&(L.cpuTime+=performance.now()-t)}}},"$7,color,position":function(b,ca,K,L,e,l,q,c,F,B){var G,U,n,u,x,ba,v,T,z,R,ia,h,t,S,k,X,f,w,Y,D,E,d,I,a,ta,A,ja,Z,V,ea,O,P,C,g,N,M;G=b.attributes;U=b.context;n=b.current;u=b.draw;x=b.elements;ba=b.framebuffer;v=b.gl;T=b.next;z=b.shader;R=b.uniforms;ia=b.vao;h=T.blend_color;
...
v=S.location;z=k[v];z.buffer||E.enableVertexAttribArray(v);if(z.type!==l.dtype||2!==z.size||z.buffer!==l||!1!==z.normalized||0!==z.offset||0!==z.stride)E.bindBuffer(34962,l.buffer),E.vertexAttribPointer(v,2,l.dtype,!1,0,0),z.type=l.dtype,z.size=2,z.buffer=l,z.normalized=!1,z.offset=0,z.stride=0;v=q.call(this,X,a,0);"number"!==typeof v&&ca.commandRaise(c,K);E.uniform1f(ia.location,v);v=a.offset;d(v)&&2===v.length||ca.commandRaise(F,K);E.uniform2f(t.location,v[0],v[1]);a=B.call(this,X,a,0);d(a)&&4===
a.length||ca.commandRaise(G,K);E.uniform4f(h.location,a[0],a[1],a[2],a[3]);(a=w.elements)?E.bindBuffer(34963,a.buffer.buffer):A.currentVAO&&(a=Y.getElements(A.currentVAO.elements))&&E.bindBuffer(34963,a.buffer.buffer);v=w.primitive;z=w.offset;a?E.drawElements(v,3,a.type,z<<(a.type-5121>>1)):E.drawArrays(v,z,3);f.dirty=!0;A.setVAO(null);b&&(L.cpuTime+=performance.now()-na)},scope:function(c,d,g){var b,h,k,m,e,q,t,v,z,A,H,D,E,C,Q,fa,J,K,B,x,M;b=I.depth_enable;I.depth_enable=!1;if(h=f.profile)k=performance.now(),
...
l.buffer),E.vertexAttribPointer(p,2,l.dtype,!1,0,0),y.type=l.dtype,y.size=2,y.buffer=l,y.normalized=!1,y.offset=0,y.stride=0;q=ba.call(this,X,r,q);"number"!==typeof q&&ca.commandRaise(v,K);E.uniform1f(ia.location,q);(p=w.elements)?E.bindBuffer(34963,p.buffer.buffer):A.currentVAO&&(p=Y.getElements(A.currentVAO.elements))&&E.bindBuffer(34963,p.buffer.buffer);y=w.primitive;u=w.offset;for(q=0;q<c;++q){r=a[q];var n,B,F,ga,H,sa,Ba,ra,G;n=r.offset;d(n)&&2===n.length||ca.commandRaise(T,K);B=n[0];n=n[1];q&&
F===B&&ga===n||(F=B,ga=n,E.uniform2f(t.location,B,n));H=z.call(this,X,r,q);d(H)&&4===H.length||ca.commandRaise(R,K);r=H[0];B=H[1];n=H[2];H=H[3];q&&sa===r&&Ba===B&&ra===n&&G===H||(sa=r,Ba=B,ra=n,G=H,E.uniform4f(h.location,r,B,n,H));p?E.drawElements(y,3,p.type,u<<(p.type-5121>>1)):E.drawArrays(y,u,3)}f.dirty=!0;A.setVAO(null);b&&(L.cpuTime+=performance.now()-e)}}},"$23,model,position,projection,view":function(b,ca,K,L,e,l,q,c,F,B,G,U,n,u,x,ba,v,T,z,R,ia,h,t,S,k,X,f,w){var Y,D,E,d,I,a,ta,A,ja,Z,V,ea,
O,P,C,g,N,M,ha,qa,m,J,aa,Q,ma,pa,za,xa,fa,Aa,ka,oa,ya,Ja,na,Xa,Ta,r,p,y,va,Ca;Y=b.attributes;D=b.context;E=b.current;d=b.draw;I=b.framebuffer;a=b.gl;ta=b.isArrayLike;A=b.next;ja=b.shader;Z=b.uniforms;V=b.vao;ea=A.blend_color;O=E.blend_color;P=A.blend_equation;C=E.blend_equation;g=A.blend_func;N=E.blend_func;M=A.colorMask;ha=E.colorMask;qa=A.depth_range;m=E.depth_range;J=A.polygonOffset_offset;aa=E.polygonOffset_offset;Q=A.sample_coverage;ma=E.sample_coverage;pa=A.scissor_box;za=E.scissor_box;xa=A.stencil_func;
...
t,N[3]=y;b=A.depth_enable;b!==E.depth_enable&&(b?a.enable(2929):a.disable(2929),E.depth_enable=b);b=A.depth_func;b!==E.depth_func&&(a.depthFunc(b),E.depth_func=b);b=qa[0];p=qa[1];if(b!==m[0]||p!==m[1])a.depthRange(b,p),m[0]=b,m[1]=p;b=A.depth_mask;b!==E.depth_mask&&(a.depthMask(b),E.depth_mask=b);b=M[0];p=M[1];t=M[2];y=M[3];if(b!==ha[0]||p!==ha[1]||t!==ha[2]||y!==ha[3])a.colorMask(b,p,t,y),ha[0]=b,ha[1]=p,ha[2]=t,ha[3]=y;b=A.cull_enable;b!==E.cull_enable&&(b?a.enable(2884):a.disable(2884),E.cull_enable=
...
d[8],r[9]=d[9],r[10]=d[10],r[11]=d[11],r[12]=d[12],r[13]=d[13],r[14]=d[14],r[15]=d[15],r));G&&a.bindBuffer(34963,G.buffer.buffer);d=G.primType;p=G.vertCount-0;0<=p||ca.commandRaise(U,K);p&&(a.drawElements(d,p,G.type,0<<(G.type-5121>>1)),V.setVAO(null),b&&(L.cpuTime+=performance.now()-h))},scope:function(a,c,b){var f,g,h,k,m,r,e,q,t,y,w,z,A,C,Q,I,fa,J,na,B,M,Xa,N;if(f=E.profile)g=performance.now(),L.count++;h=d.elements;d.elements=n;k=d.offset;d.offset=0;m=n.vertCount-0;0<=m||ca.commandRaise(u,K);
...
if(b!==O[0]||e!==O[1]||q!==O[2]||v!==O[3])a.blendColor(b,e,q,v),O[0]=b,O[1]=e,O[2]=q,O[3]=v;b=P[0];e=P[1];if(b!==C[0]||e!==C[1])a.blendEquationSeparate(b,e),C[0]=b,C[1]=e;b=g[0];e=g[1];q=g[2];v=g[3];if(b!==N[0]||e!==N[1]||q!==N[2]||v!==N[3])a.blendFuncSeparate(b,e,q,v),N[0]=b,N[1]=e,N[2]=q,N[3]=v;b=A.depth_enable;b!==E.depth_enable&&(b?a.enable(2929):a.disable(2929),E.depth_enable=b);b=A.depth_func;b!==E.depth_func&&(a.depthFunc(b),E.depth_func=b);b=qa[0];e=qa[1];if(b!==m[0]||e!==m[1])a.depthRange(b,
...
q.buffer!==l||!1!==q.normalized||0!==q.offset||0!==q.stride)a.bindBuffer(34962,l.buffer),a.vertexAttribPointer(e,3,l.dtype,!1,0,0),q.type=l.dtype,q.size=3,q.buffer=l,q.normalized=!1,q.offset=0,q.stride=0;a.uniformMatrix4fv(k.location,!1,y);e=z.call(this,D,void 0,p);ta(e)&&16===e.length||ca.commandRaise(R,K);a.uniformMatrix4fv(w.location,!1,Array.isArray(e)||e instanceof Float32Array?e:(va[0]=e[0],va[1]=e[1],va[2]=e[2],va[3]=e[3],va[4]=e[4],va[5]=e[5],va[6]=e[6],va[7]=e[7],va[8]=e[8],va[9]=e[9],va[10]=
e[10],va[11]=e[11],va[12]=e[12],va[13]=e[13],va[14]=e[14],va[15]=e[15],va));p=ia.call(this,D,void 0,p);ta(p)&&16===p.length||ca.commandRaise(h,K);a.uniformMatrix4fv(f.location,!1,Array.isArray(p)||p instanceof Float32Array?p:(Ca[0]=p[0],Ca[1]=p[1],Ca[2]=p[2],Ca[3]=p[3],Ca[4]=p[4],Ca[5]=p[5],Ca[6]=p[6],Ca[7]=p[7],Ca[8]=p[8],Ca[9]=p[9],Ca[10]=p[10],Ca[11]=p[11],Ca[12]=p[12],Ca[13]=p[13],Ca[14]=p[14],Ca[15]=p[15],Ca));t&&a.bindBuffer(34963,t.buffer.buffer);e=t.primType;q=t.vertCount-0;0<=q||ca.commandRaise(S,
K);for(p=0;p<c;++p)q&&a.drawElements(e,q,t.type,0<<(t.type-5121>>1));V.setVAO(null);b&&(L.cpuTime+=performance.now()-r)}}},$20:function(b,ca,K,L,e,l,q,c,F,B,G,U,n,u,x,ba,v,T,z,R,ia){var h,t,S,k,X,f,w,Y,D,E,d,I,a,ta,A,ja,Z,V,ea,O,P,C,g,N,M,ha,qa,m,J,aa,Q,ma,pa,za;h=b.context;t=b.current;S=b.framebuffer;k=b.gl;X=b.next;f=b.shader;w=b.uniforms;Y=b.vao;D=X.blend_color;E=t.blend_color;d=X.blend_equation;I=t.blend_equation;a=X.blend_func;ta=t.blend_func;A=X.colorMask;ja=t.colorMask;Z=X.depth_range;V=t.depth_range;
ea=X.polygonOffset_offset;O=t.polygonOffset_offset;P=X.sample_coverage;C=t.sample_coverage;g=X.scissor_box;N=t.scissor_box;M=X.stencil_func;ha=t.stencil_func;qa=X.stencil_opBack;m=t.stencil_opBack;J=X.stencil_opFront;aa=t.stencil_opFront;Q=X.viewport;ma=t.viewport;pa={};za={};return{draw:function(b){var v,w,z,u,n,x,na,Xa,R,r,p,y,G;v=h.center;w=h.distance;z=h.eye;u=h.phi;n=h.projection;x=q.call(this,h,b,0);na=h.theta;Xa=h.up;R=h.view;h.center=e;h.distance=2.302585092994046;h.eye=l;h.phi=0;h.projection=
...
ha[2]=y;x=J[0];p=J[1];y=J[2];G=J[3];if(x!==aa[0]||p!==aa[1]||y!==aa[2]||G!==aa[3])k.stencilOpSeparate(x,p,y,G),aa[0]=x,aa[1]=p,aa[2]=y,aa[3]=G;x=qa[0];p=qa[1];y=qa[2];G=qa[3];if(x!==m[0]||p!==m[1]||y!==m[2]||G!==m[3])k.stencilOpSeparate(x,p,y,G),m[0]=x,m[1]=p,m[2]=y,m[3]=G;x=X.scissor_enable;x!==t.scissor_enable&&(x?k.enable(3089):k.disable(3089),t.scissor_enable=x);x=g[0];p=g[1];y=g[2];G=g[3];if(x!==N[0]||p!==N[1]||y!==N[2]||G!==N[3])k.scissor(x,p,y,G),N[0]=x,N[1]=p,N[2]=y,N[3]=G;x=Q[0];p=Q[1];y=
Q[2];G=Q[3];if(x!==ma[0]||p!==ma[1]||y!==ma[2]||G!==ma[3])k.viewport(x,p,y,G),ma[0]=x,ma[1]=p,ma[2]=y,ma[3]=G;t.dirty=!1}if(x=t.profile)r=performance.now(),L.count++;p=f.program(f.vert,f.frag,K);k.useProgram(p.program);Y.setVAO(null);y=p.id;(G=pa[y])||(G=pa[y]=B(p));G.call(this,b);Y.setVAO(null);h.center=v;h.distance=w;h.eye=z;h.phi=u;h.projection=n;h.theta=na;h.up=Xa;h.view=R;x&&(L.cpuTime+=performance.now()-r)},scope:function(a,d,c){var b,f,g,k,l,m,e,r,p,q,v,z,A,D,E,H,C,Q,I;b=h.center;f=h.distance;
...
f.frag,K);k.useProgram(y.program);Y.setVAO(null);G=y.id;(F=za[G])||(F=za[G]=ia(y));F.call(this,c,b);Y.setVAO(null);h.center=l;h.distance=e;h.eye=q;h.phi=w;h.projection=u;h.theta=x;h.up=B;h.view=r;n&&(L.cpuTime+=performance.now()-p)}}},"$27,position,projection,tex,uv,view":function(b,ca,K,L,e,l,q,c,F,B,G,U,n,u,x,ba,v,T,z,R,ia,h,t,S,k,X,f,w,Y,D,E,d,I){var a,Z,A,ja,ha,V,ea,O,P,C,g,N,M,Da,qa,m,J,aa,Q,ma,pa,za,xa,fa,Aa,ka,oa,ya,Ja,na,Xa,Ta,r,p,y,va,Ca,ab,Hb;a=b.attributes;Z=b.context;A=b.current;ja=b.draw;
ha=b.framebuffer;V=b.gl;ea=b.isArrayLike;O=b.next;P=b.shader;C=b.uniforms;g=b.vao;N=O.blend_color;M=A.blend_color;Da=O.blend_equation;qa=A.blend_equation;m=O.blend_func;J=A.blend_func;aa=O.colorMask;Q=A.colorMask;ma=O.depth_range;pa=A.depth_range;za=O.polygonOffset_offset;xa=A.polygonOffset_offset;fa=O.sample_coverage;Aa=A.sample_coverage;ka=O.scissor_box;oa=A.scissor_box;ya=O.stencil_func;Ja=A.stencil_func;na=O.stencil_opBack;Xa=A.stencil_opBack;Ta=O.stencil_opFront;r=A.stencil_opFront;p=O.viewport;
...
V.vertexAttribPointer(k,3,l.dtype,!1,0,0),t.type=l.dtype,t.size=3,t.buffer=l,t.normalized=!1,t.offset=0,t.stride=0;k=d.location;t=a[k];t.buffer||V.enableVertexAttribArray(k);if(t.type!==q.dtype||2!==t.size||t.buffer!==q||!1!==t.normalized||0!==t.offset||0!==t.stride)V.bindBuffer(34962,q.buffer),V.vertexAttribPointer(k,2,q.dtype,!1,0,0),t.type=q.dtype,t.size=2,t.buffer=q,t.normalized=!1,t.offset=0,t.stride=0;k=c.call(this,Z,b,0);ea(k)&&16===k.length||ca.commandRaise(F,K);V.uniformMatrix4fv(D.location,
!1,Array.isArray(k)||k instanceof Float32Array?k:(va[0]=k[0],va[1]=k[1],va[2]=k[2],va[3]=k[3],va[4]=k[4],va[5]=k[5],va[6]=k[6],va[7]=k[7],va[8]=k[8],va[9]=k[9],va[10]=k[10],va[11]=k[11],va[12]=k[12],va[13]=k[13],va[14]=k[14],va[15]=k[15],va));k=B.call(this,Z,b,0);ea(k)&&16===k.length||ca.commandRaise(G,K);V.uniformMatrix4fv(I.location,!1,Array.isArray(k)||k instanceof Float32Array?k:(Ca[0]=k[0],Ca[1]=k[1],Ca[2]=k[2],Ca[3]=k[3],Ca[4]=k[4],Ca[5]=k[5],Ca[6]=k[6],Ca[7]=k[7],Ca[8]=k[8],Ca[9]=k[9],Ca[10]=
k[10],Ca[11]=k[11],Ca[12]=k[12],Ca[13]=k[13],Ca[14]=k[14],Ca[15]=k[15],Ca));(b=b.texture)&&"framebuffer"===b._reglType&&(b=b.color[0]);"function"===typeof b&&"texture2d"===b._reglType||ca.commandRaise(U,K);b=b._texture;V.uniform1i(E.location,b.bind());n&&V.bindBuffer(34963,n.buffer.buffer);k=n.primType;t=n.vertCount-0;0<=t||ca.commandRaise(u,K);t&&(V.drawElements(k,t,n.type,0<<(n.type-5121>>1)),g.setVAO(null),f&&(L.cpuTime+=performance.now()-h),b.unbind())},scope:function(a,d,c){var b,f,g,h,k,m,p,
r,e,t,y,n,w,u,D,E,Q,I,J,fa,G,B,F,M,N,Xa,O,S,pa,xa,U,na,V,ka,X;if(b=A.profile)f=performance.now(),L.count++;g=ja.elements;ja.elements=x;h=ja.offset;ja.offset=0;k=x.vertCount-0;0<=k||ca.commandRaise(ba,K);m=ja.count;ja.count=k;p=x.primType;k=ja.primitive;ja.primitive=p;r=v.call(this,Z,a,c);p=C[3];C[3]=r;e=a.texture;r=C[5];C[5]=e;t=T.call(this,Z,a,c);e=C[4];C[4]=t;t=z.buffer;z.buffer=l;y=z.divisor;z.divisor=0;n=z.normalized;z.normalized=!1;w=z.offset;z.offset=0;u=z.size;z.size=0;D=z.state;z.state=1;
E=z.stride;z.stride=0;Q=z.type;z.type=l.dtype;I=z.w;z.w=0;J=z.x;z.x=0;fa=z.y;z.y=0;G=z.z;z.z=0;B=R.buffer;R.buffer=q;F=R.divisor;R.divisor=0;M=R.normalized;R.normalized=!1;N=R.offset;R.offset=0;Xa=R.size;R.size=0;O=R.state;R.state=1;S=R.stride;R.stride=0;pa=R.type;R.type=q.dtype;xa=R.w;R.w=0;U=R.x;R.x=0;na=R.y;R.y=0;V=R.z;R.z=0;ka=P.vert;P.vert=2;X=P.frag;P.frag=1;d(Z,a,c);b&&(L.cpuTime+=performance.now()-f);ja.elements=g;ja.offset=h;ja.count=m;ja.primitive=k;C[3]=p;C[5]=r;C[4]=e;z.buffer=t;z.divisor=
...
x.size=2,x.buffer=q,x.normalized=!1,x.offset=0,x.stride=0;u=h.call(this,Z,z,n);ea(u)&&16===u.length||ca.commandRaise(t,K);V.uniformMatrix4fv(D.location,!1,Array.isArray(u)||u instanceof Float32Array?u:(ab[0]=u[0],ab[1]=u[1],ab[2]=u[2],ab[3]=u[3],ab[4]=u[4],ab[5]=u[5],ab[6]=u[6],ab[7]=u[7],ab[8]=u[8],ab[9]=u[9],ab[10]=u[10],ab[11]=u[11],ab[12]=u[12],ab[13]=u[13],ab[14]=u[14],ab[15]=u[15],ab));n=S.call(this,Z,z,n);ea(n)&&16===n.length||ca.commandRaise(k,K);V.uniformMatrix4fv(I.location,!1,Array.isArray(n)||
...
B.primType;p=B.vertCount-0;0<=p||ca.commandRaise(G,K);p&&(D.drawElements(r,p,B.type,0<<(B.type-5121>>1)),Z.setVAO(null),b&&(L.cpuTime+=performance.now()-v))},scope:function(a,b,d){var c,g,h,k,e,m,t,v,z,A,C,D,E,Q,J,fa,G,B,F,M,N,O,P,R,S,pa,T,xa,na,V,ka,aa;if(c=f.profile)g=performance.now(),L.count++;h=w.elements;w.elements=U;k=w.offset;w.offset=0;e=U.vertCount-0;0<=e||ca.commandRaise(n,K);m=w.count;w.count=e;t=U.primType;e=w.primitive;w.primitive=t;t=u.buffer;u.buffer=q;v=u.divisor;u.divisor=0;z=u.normalized;
u.normalized=!1;A=u.offset;u.offset=0;C=u.size;u.size=0;D=u.state;u.state=1;E=u.stride;u.stride=0;Q=u.type;u.type=q.dtype;J=u.w;u.w=0;fa=u.x;u.x=0;G=u.y;u.y=0;B=u.z;u.z=0;F=x.buffer;x.buffer=l;M=x.divisor;x.divisor=0;N=x.normalized;x.normalized=!1;O=x.offset;x.offset=0;P=x.size;x.size=0;R=x.state;x.state=1;S=x.stride;x.stride=0;pa=x.type;x.type=l.dtype;T=x.w;x.w=0;xa=x.x;x.x=0;na=x.y;x.y=0;V=x.z;x.z=0;ka=I.vert;I.vert=10;aa=I.frag;I.frag=9;b(X,a,d);c&&(L.cpuTime+=performance.now()-g);w.elements=h;
w.offset=k;w.count=m;w.primitive=e;u.buffer=t;u.divisor=v;u.normalized=z;u.offset=A;u.size=C;u.state=D;u.stride=E;u.type=Q;u.w=J;u.x=fa;u.y=G;u.z=B;x.buffer=F;x.divisor=M;x.normalized=N;x.offset=O;x.size=P;x.state=R;x.stride=S;x.type=pa;x.w=T;x.x=xa;x.y=na;x.z=V;I.vert=ka;I.frag=aa},batch:function(b,c){var e,p,y;e=Y.next;e!==Y.cur&&(e?D.bindFramebuffer(36160,e.framebuffer):D.bindFramebuffer(36160,null),Y.cur=e);if(f.dirty){var n,u;e=d.dither;e!==f.dither&&(e?D.enable(3024):D.disable(3024),f.dither=
...
F!==J[2]||na!==J[3])k.stencilOpSeparate(e,B,F,na),J[0]=e,J[1]=B,J[2]=F,J[3]=na;e=f.scissor_enable;e!==ia.scissor_enable&&(e?k.enable(3089):k.disable(3089),ia.scissor_enable=e);e=N[0];B=N[1];F=N[2];na=N[3];if(e!==M[0]||B!==M[1]||F!==M[2]||na!==M[3])k.scissor(e,B,F,na),M[0]=e,M[1]=B,M[2]=F,M[3]=na;e=ma[0];B=ma[1];F=ma[2];na=ma[3];if(e!==pa[0]||B!==pa[1]||F!==pa[2]||na!==pa[3])k.viewport(e,B,F,na),pa[0]=e,pa[1]=B,pa[2]=F,pa[3]=na}k.disable(2929);ia.depth_enable=!1;if(e=ia.profile)q=performance.now(),
L.count+=c;k.useProgram(U.program);D.setVAO(null);B=T.location;F=z[B];F.buffer||k.enableVertexAttribArray(B);if(F.type!==l.dtype||2!==F.size||F.buffer!==l||!1!==F.normalized||0!==F.offset||0!==F.stride)k.bindBuffer(34962,l.buffer),k.vertexAttribPointer(B,2,l.dtype,!1,0,0),F.type=l.dtype,F.size=2,F.buffer=l,F.normalized=!1,F.offset=0,F.stride=0;w=n.call(this,R,G,w);"number"!==typeof w&&ca.commandRaise(u,K);k.uniform1f(ba.location,w);(B=h.elements)?k.bindBuffer(34963,B.buffer.buffer):D.currentVAO&&
(B=t.getElements(D.currentVAO.elements))&&k.bindBuffer(34963,B.buffer.buffer);F=h.primitive;na=h.offset;for(w=0;w<c;++w){G=b[w];var Y,Ta,r,p,y,va,Ca;Y=G.color;X(Y)&&4===Y.length||ca.commandRaise(x,K);G=Y[0];r=Y[1];y=Y[2];Y=Y[3];w&&Ta===G&&p===r&&va===y&&Ca===Y||(Ta=G,p=r,va=y,Ca=Y,k.uniform4f(v.location,G,r,y,Y));B?k.drawElements(F,3,B.type,na<<(B.type-5121>>1)):k.drawArrays(F,na,3)}ia.dirty=!0;D.setVAO(null);e&&(L.cpuTime+=performance.now()-q)}}},"$13,color,position":function(b,ca,K,L,e,l,q,c,F,
B,G,U,n,u,x,ba){var v,T,z,R,ia,h,t,S,k,X,f,w,Y,D,E,d,I,a,Z,A,ja,ha,V,ea,O,P,C,g,N,M,Da,qa,m,J,aa;v=b.attributes;T=b.context;z=b.current;R=b.draw;ia=b.framebuffer;h=b.gl;t=b.next;S=b.shader;k=b.uniforms;X=b.vao;f=t.blend_color;w=z.blend_color;Y=t.blend_equation;D=z.blend_equation;E=t.blend_func;d=z.blend_func;I=t.colorMask;a=z.colorMask;Z=t.depth_range;A=z.depth_range;ja=t.polygonOffset_offset;ha=z.polygonOffset_offset;V=t.sample_coverage;ea=z.sample_coverage;O=t.scissor_box;P=z.scissor_box;C=t.stencil_func;
g=z.stencil_func;N=t.stencil_opBack;M=z.stencil_opBack;Da=t.stencil_opFront;qa=z.stencil_opFront;m=t.viewport;J=z.viewport;aa=[1,0,0,1];return{draw:function(b){var k,n,u;b=ia.next;b!==ia.cur&&(b?h.bindFramebuffer(36160,b.framebuffer):h.bindFramebuffer(36160,null),ia.cur=b);if(z.dirty){var B;b=t.dither;b!==z.dither&&(b?h.enable(3024):h.disable(3024),z.dither=b);b=t.blend_enable;b!==z.blend_enable&&(b?h.enable(3042):h.disable(3042),z.blend_enable=b);b=f[0];n=f[1];u=f[2];B=f[3];if(b!==w[0]||n!==w[1]||
...
2,l.dtype,!1,0,0),B.type=l.dtype,B.size=2,B.buffer=l,B.normalized=!1,B.offset=0,B.stride=0;h.uniform4f(x.location,1,0,0,1);n&&h.bindBuffer(34963,n.buffer.buffer);B=n.primType;F=n.vertCount-0;0<=F||ca.commandRaise(u,K);for(q=0;q<c;++q)F&&h.drawElements(B,F,n.type,0<<(n.type-5121>>1));z.dirty=!0;X.setVAO(null);e&&(L.cpuTime+=performance.now()-k)}}},"$20,mouse,position,t,texture":function(b,ca,K,L,e,l,q,c,F,B,G,U,n,u,x,ba,v,T,z,R,Z,h,t,S,k){var X,f,w,Y,D,E,d,I,a,ha,A,ja,ab,V,ea,O,P,C,g,N,M,Da,qa,m,J,
aa,Q,ma,pa,za,xa,fa,Aa,ka,oa,ya;X=b.attributes;f=b.context;w=b.current;Y=b.draw;D=b.elements;E=b.framebuffer;d=b.gl;I=b.isArrayLike;a=b.next;ha=b.shader;A=b.uniforms;ja=b.vao;ab=a.blend_color;V=w.blend_color;ea=a.blend_equation;O=w.blend_equation;P=a.blend_func;C=w.blend_func;g=a.colorMask;N=w.colorMask;M=a.depth_range;Da=w.depth_range;qa=a.polygonOffset_offset;m=w.polygonOffset_offset;J=a.sample_coverage;aa=w.sample_coverage;Q=a.scissor_box;ma=w.scissor_box;pa=a.stencil_func;za=w.stencil_func;xa=
...
performance.now(),L.count+=c;d.useProgram(ba.program);ja.setVAO(null);p=t.location;u=X[p];u.buffer||d.enableVertexAttribArray(p);if(u.type!==l.dtype||2!==u.size||u.buffer!==l||!1!==u.normalized||0!==u.offset||0!==u.stride)d.bindBuffer(34962,l.buffer),d.vertexAttribPointer(p,2,l.dtype,!1,0,0),u.type=l.dtype,u.size=2,u.buffer=l,u.normalized=!1,u.offset=0,u.stride=0;p=v.call(this,f,void 0,q);I(p)&&2===p.length||ca.commandRaise(T,K);d.uniform2f(h.location,p[0],p[1]);q=z.call(this,f,void 0,q);"number"!==
...
b(K),e=0;e<L.length;++e)ca[L[e]]=K[L[e]];return ca}},{"./sorted-object-keys":34}],26:[function(Z,ha,ab){function b(b,e,l,q,c,F){for(var B=0;B<e;++B)for(var G=b[B],K=0;K<l;++K)for(var n=G[K],u=0;u<q;++u)c[F++]=n[u]}function ca(K,e,l,q,c){for(var F=1,B=l+1;B<e.length;++B)F*=e[B];var G=e[l];if(4===e.length-l){var U=e[l+1],n=e[l+2];e=e[l+3];for(B=0;B<G;++B)b(K[B],U,n,e,q,c),c+=F}else for(B=0;B<G;++B)ca(K[B],e,l+1,q,c),c+=F}var K=Z("./pool");ha.exports={shape:function(b){for(var e=[];b.length;b=b[0])e.push(b.length);
...
(K=new ResizeObserver(function(){setTimeout(B)}),K.observe(b)):window.addEventListener("resize",B,!1);B();return{canvas:G,onDestroy:function(){K?K.disconnect():window.removeEventListener("resize",B);b.removeChild(G)}}}function ca(b,c){function e(l){try{return b.getContext(l,c)}catch(F){return null}}return e("webgl")||e("experimental-webgl")||e("webgl-experimental")}function K(b){if("string"===typeof b)return b.split();e(Array.isArray(b),"invalid extension array");return b}function L(b){return"string"===
