(function(){function z(aa,jc,d){function ba(g,b){if(!jc[g]){if(!aa[g]){var x="function"==typeof require&&require;if(!b&&x)return x(g,!0);if(r)return r(g,!0);x=Error("Cannot find module '"+g+"'");throw x.code="MODULE_NOT_FOUND",x;}x=jc[g]={exports:{}};aa[g][0].call(x.exports,function(b){return ba(aa[g][1][b]||b)},x,x.exports,z,aa,jc,d)}return jc[g].exports}for(var r="function"==typeof require&&require,N=0;N<d.length;N++)ba(d[N]);return ba}return z})()({1:[function(z,aa,jc){var d=z("../regl")(),ba=
Array(1048576).fill(0).map(function(){return.9<Math.random()?255:0}),r=Array(2).fill().map(function(){return d.framebuffer({color:d.texture({radius:512,data:ba,wrap:"repeat"}),depthStencil:!1})}),N=d({frag:"\n  precision mediump float;\n  uniform sampler2D prevState;\n  varying vec2 uv;\n  void main() {\n    float n = 0.0;\n    for(int dx=-1; dx<=1; ++dx)\n    for(int dy=-1; dy<=1; ++dy) {\n      n += texture2D(prevState, uv+vec2(dx,dy)/float(512)).r;\n    }\n    float s = texture2D(prevState, uv).r;\n    if(n > 3.0+s || n < 3.0) {\n      gl_FragColor = vec4(0,0,0,1);\n    } else {\n      gl_FragColor = vec4(1,1,1,1);\n    }\n  }",
framebuffer:function(b){return r[(b.tick+1)%2]}}),g=d({frag:"\n  precision mediump float;\n  uniform sampler2D prevState;\n  varying vec2 uv;\n  void main() {\n    float state = texture2D(prevState, uv).r;\n    gl_FragColor = vec4(vec3(state), 1);\n  }",vert:"\n  precision mediump float;\n  attribute vec2 position;\n  varying vec2 uv;\n  void main() {\n    uv = 0.5 * (position + 1.0);\n    gl_Position = vec4(position, 0, 1);\n  }",attributes:{position:[-4,-4,4,-4,0,4]},uniforms:{prevState:function(b){return r[b.tick%
2]}},depth:{enable:!1},count:3});d.frame(function(){g(function(){d.draw();N()})})},{"../regl":38}],2:[function(z,aa,jc){function d(){this.w=this.z=this.y=this.x=this.state=0;this.buffer=null;this.size=0;this.normalized=!1;this.type=5126;this.divisor=this.stride=this.offset=0}var ba=z("./util/sorted-object-keys"),r=z("./util/check"),N=z("./util/values"),g=z("./constants/dtypes.json"),b=z("./util/is-typed-array"),x=z("./util/is-ndarray"),c=z("./constants/primitives.json"),v="attributes elements offset count primitive instances".split(" ");
aa.exports=function(na,da,K,E,u,A,H){function n(b){if(b!==T.currentVAO){var c=da.oes_vertex_array_object;b?c.bindVertexArrayOES(b.vao):c.bindVertexArrayOES(null);T.currentVAO=b}}function F(b){if(b!==T.currentVAO){if(b)b.bindAttrs();else{for(var c=da.angle_instanced_arrays,g=0;g<h.length;++g){var f=h[g];f.buffer?(na.enableVertexAttribArray(g),f.buffer.bind(),na.vertexAttribPointer(g,f.size,f.type,f.normalized,f.stride,f.offfset),c&&f.divisor&&c.vertexAttribDivisorANGLE(g,f.divisor)):(na.disableVertexAttribArray(g),
na.vertexAttrib4f(g,f.x,f.y,f.z,f.w))}H.elements?na.bindBuffer(34963,H.elements.buffer.buffer):na.bindBuffer(34963,null)}T.currentVAO=b}}function ca(){N(D).forEach(function(b){b.destroy()})}function I(){this.id=++f;this.attributes=[];this.elements=null;this.ownsElements=!1;this.offset=this.count=0;this.instances=-1;this.primitive=4;var b=da.oes_vertex_array_object;this.vao=b?b.createVertexArrayOES():null;D[this.id]=this;this.buffers=[]}function z(){da.oes_vertex_array_object&&N(D).forEach(function(b){b.refresh()})}
var e=K.maxAttributes,h=Array(e);for(K=0;K<e;++K)h[K]=new d;var f=0,D={},T={Record:d,scope:{},state:h,currentVAO:null,targetVAO:null,restore:da.oes_vertex_array_object?z:function(){},createVAO:function(f){function q(f){var V;if(Array.isArray(f))V=f,h.elements&&h.ownsElements&&h.elements.destroy(),h.elements=null,h.ownsElements=!1,h.offset=0,h.count=0,h.instances=-1,h.primitive=4;else{r("object"===typeof f,"invalid arguments for create vao");r("attributes"in f,"must specify attributes for vao");if(f.elements){var a=
f.elements;h.ownsElements?("function"===typeof a&&"elements"===a._reglType?h.elements.destroy():h.elements(a),h.ownsElements=!1):A.getElements(f.elements)?(h.elements=f.elements,h.ownsElements=!1):(h.elements=A.create(f.elements),h.ownsElements=!0)}else h.elements=null,h.ownsElements=!1;V=f.attributes;h.offset=0;h.count=-1;h.instances=-1;h.primitive=4;h.elements&&(h.count=h.elements._elements.vertCount,h.primitive=h.elements._elements.primType);"offset"in f&&(h.offset=f.offset|0);"count"in f&&(h.count=
f.count|0);"instances"in f&&(h.instances=f.instances|0);"primitive"in f&&(r(f.primitive in c,"bad primitive type: "+f.primitive),h.primitive=c[f.primitive]);r.optional(function(){for(var a=ba(f),b=0;b<a.length;++b)r(0<=v.indexOf(a[b]),'invalid option for vao: "'+a[b]+'" valid options are '+v)});r(Array.isArray(V),"attributes must be an array")}r(V.length<e,"too many attributes");r(0<V.length,"must specify at least one attribute");var a={},l=h.attributes;l.length=V.length;for(var X=0;X<V.length;++X){var D=
V[X],n=l[X]=new d,I=D.data||D;if(Array.isArray(I)||b(I)||x(I)){var F;h.buffers[X]&&(F=h.buffers[X],b(I)&&F._buffer.byteLength>=I.byteLength?F.subdata(I):(F.destroy(),h.buffers[X]=null));h.buffers[X]||(F=h.buffers[X]=u.create(D,34962,!1,!0));n.buffer=u.getBuffer(F);n.size=n.buffer.dimension|0;n.normalized=!1;n.type=n.buffer.dtype;n.offset=0;n.stride=0;n.divisor=0;n.state=1;a[X]=1}else u.getBuffer(D)?(n.buffer=u.getBuffer(D),n.size=n.buffer.dimension|0,n.normalized=!1,n.type=n.buffer.dtype,n.offset=
0,n.stride=0,n.divisor=0,n.state=1):u.getBuffer(D.buffer)?(n.buffer=u.getBuffer(D.buffer),n.size=(+D.size||n.buffer.dimension)|0,n.normalized=!!D.normalized||!1,"type"in D?(r.parameter(D.type,g,"invalid buffer type"),n.type=g[D.type]):n.type=n.buffer.dtype,n.offset=(D.offset||0)|0,n.stride=(D.stride||0)|0,n.divisor=(D.divisor||0)|0,n.state=1,r(1<=n.size&&4>=n.size,"size must be between 1 and 4"),r(0<=n.offset,"invalid offset"),r(0<=n.stride&&255>=n.stride,"stride must be between 0 and 255"),r(0<=
n.divisor,"divisor must be positive"),r(!n.divisor||!!da.angle_instanced_arrays,"ANGLE_instanced_arrays must be enabled to use divisor")):"x"in D?(r(0<X,"first attribute must not be a constant"),n.x=+D.x||0,n.y=+D.y||0,n.z=+D.z||0,n.w=+D.w||0,n.state=2):r(!1,"invalid attribute spec for location "+X)}for(F=0;F<h.buffers.length;++F)!a[F]&&h.buffers[F]&&(h.buffers[F].destroy(),h.buffers[F]=null);h.refresh();return q}var h=new I;E.vaoCount+=1;q.destroy=function(){for(var b=0;b<h.buffers.length;++b)h.buffers[b]&&
h.buffers[b].destroy();h.buffers.length=0;h.ownsElements&&(h.elements.destroy(),h.elements=null,h.ownsElements=!1);h.destroy()};q._vao=h;q._reglType="vao";return q(f)},getVAO:function(b){return"function"===typeof b&&b._vao?b._vao:null},destroyBuffer:function(b){for(var c=0;c<h.length;++c){var f=h[c];f.buffer===b&&(na.disableVertexAttribArray(c),f.buffer=null)}},setVAO:da.oes_vertex_array_object?n:F,clear:da.oes_vertex_array_object?ca:function(){}};I.prototype.bindAttrs=function(){for(var b=da.angle_instanced_arrays,
c=this.attributes,f=0;f<c.length;++f){var g=c[f];g.buffer?(na.enableVertexAttribArray(f),na.bindBuffer(34962,g.buffer.buffer),na.vertexAttribPointer(f,g.size,g.type,g.normalized,g.stride,g.offset),b&&g.divisor&&b.vertexAttribDivisorANGLE(f,g.divisor)):(na.disableVertexAttribArray(f),na.vertexAttrib4f(f,g.x,g.y,g.z,g.w))}for(b=c.length;b<e;++b)na.disableVertexAttribArray(b);(b=A.getElements(this.elements))?na.bindBuffer(34963,b.buffer.buffer):na.bindBuffer(34963,null)};I.prototype.refresh=function(){var b=
...
"./util/check":21,"./util/is-ndarray":28,"./util/is-typed-array":30,"./util/sorted-object-keys":34,"./util/values":36}],3:[function(z,aa,jc){function d(b){return K[Object.prototype.toString.call(b)]|0}function ba(b,c){for(var g=0;g<c.length;++g)b[g]=c[g]}function r(b,c,g,d,x,v,e){for(var h=0,f=0;f<g;++f)for(var D=0;D<d;++D)b[h++]=c[x*f+v*D+e]}var N=z("./util/sorted-object-keys"),g=z("./util/check"),b=z("./util/is-typed-array"),x=z("./util/is-ndarray"),c=z("./util/values"),v=z("./util/pool");jc=z("./util/flatten");
var na=jc.flatten,da=jc.shape,K=z("./constants/arraytypes.json"),E=z("./constants/dtypes.json"),u=z("./constants/usage.json"),A=[];A[5120]=1;A[5122]=2;A[5124]=4;A[5121]=1;A[5123]=2;A[5125]=4;A[5126]=4;aa.exports=function(K,n,F,ca){function I(b){this.id=f++;this.buffer=K.createBuffer();this.type=b;this.usage=35044;this.byteLength=0;this.dimension=1;this.dtype=5121;this.persistentData=null;F.profile&&(this.stats={size:0})}function z(b,c,g){b.byteLength=c.byteLength;K.bufferData(b.type,c,g)}function e(c,
f,h,e,n,a){c.usage=h;if(Array.isArray(f)){if(c.dtype=e||5126,0<f.length)if(Array.isArray(f[0])){n=da(f);for(var l=e=1;l<n.length;++l)e*=n[l];c.dimension=e;f=na(f,n,c.dtype);z(c,f,h);a?c.persistentData=f:v.freeType(f)}else"number"===typeof f[0]?(c.dimension=n,n=v.allocType(c.dtype,f.length),ba(n,f),z(c,n,h),a?c.persistentData=n:v.freeType(n)):b(f[0])?(c.dimension=f[0].length,c.dtype=e||d(f[0])||5126,f=na(f,[f.length,f[0].length],c.dtype),z(c,f,h),a?c.persistentData=f:v.freeType(f)):g.raise("invalid buffer data")}else if(b(f))c.dtype=
e||d(f),c.dimension=n,z(c,f,h),a&&(c.persistentData=new Uint8Array(new Uint8Array(f.buffer)));else if(x(f)){n=f.shape;var X=f.stride,l=f.offset,D=0,u=0,F=0,I=0;1===n.length?(D=n[0],u=1,F=X[0],I=0):2===n.length?(D=n[0],u=n[1],F=X[0],I=X[1]):g.raise("invalid shape");c.dtype=e||d(f.data)||5126;c.dimension=u;n=v.allocType(c.dtype,D*u);r(n,f.data,D,u,F,I,l);z(c,n,h);a?c.persistentData=n:v.freeType(n)}else f instanceof ArrayBuffer?(c.dtype=5121,c.dimension=n,z(c,f,h),a&&(c.persistentData=new Uint8Array(new Uint8Array(f)))):
g.raise("invalid buffer data")}function h(b){n.bufferCount--;ca(b);var c=b.buffer;g(c,"buffer must not be deleted already");K.deleteBuffer(c);b.buffer=null;delete D[b.id]}var f=0,D={};I.prototype.bind=function(){K.bindBuffer(this.type,this.buffer)};I.prototype.destroy=function(){h(this)};var T=[];F.profile&&(n.getTotalBufferSize=function(){var b=0;N(D).forEach(function(c){b+=D[c].stats.size});return b});return{create:function(c,f,T,L){function ca(a){var c=35044,f=null,h=0,q=0,n=1;Array.isArray(a)||
b(a)||x(a)||a instanceof ArrayBuffer?f=a:"number"===typeof a?h=a|0:a&&(g.type(a,"object","buffer arguments must be an object, a number or an array"),"data"in a&&(g(null===f||Array.isArray(f)||b(f)||x(f),"invalid data for buffer"),f=a.data),"usage"in a&&(g.parameter(a.usage,u,"invalid buffer usage"),c=u[a.usage]),"type"in a&&(g.parameter(a.type,E,"invalid buffer type"),q=E[a.type]),"dimension"in a&&(g.type(a.dimension,"number","invalid dimension"),n=a.dimension|0),"length"in a&&(g.nni(h,"buffer length must be a nonnegative integer"),
h=a.length|0));l.bind();f?e(l,f,c,q,n,L):(h&&K.bufferData(l.type,h,c),l.dtype=q||5121,l.usage=c,l.dimension=n,l.byteLength=h);F.profile&&(l.stats.size=l.byteLength*A[l.dtype]);return ca}function a(a,b){g(b+a.byteLength<=l.byteLength,"invalid buffer subdata call, buffer is too small.  Can't write data of size "+a.byteLength+" starting from offset "+b+" to a buffer of size "+l.byteLength);K.bufferSubData(l.type,b,a)}n.bufferCount++;var l=new I(f);D[l.id]=l;T||ca(c);ca._reglType="buffer";ca._buffer=
l;ca.subdata=function(c,f){var h=(f||0)|0,q;l.bind();if(b(c)||c instanceof ArrayBuffer)a(c,h);else if(Array.isArray(c)){if(0<c.length)if("number"===typeof c[0]){var e=v.allocType(l.dtype,c.length);ba(e,c);a(e,h);v.freeType(e)}else Array.isArray(c[0])||b(c[0])?(q=da(c),e=na(c,q,l.dtype),a(e,h),v.freeType(e)):g.raise("invalid buffer data")}else if(x(c)){q=c.shape;var n=c.stride,D=e=0,u=0,F=0;1===q.length?(e=q[0],D=1,u=n[0],F=0):2===q.length?(e=q[0],D=q[1],u=n[0],F=n[1]):g.raise("invalid shape");q=Array.isArray(c.data)?
l.dtype:d(c.data);q=v.allocType(q,e*D);r(q,c.data,e,D,u,F,c.offset);a(q,h);v.freeType(q)}else g.raise("invalid data for buffer subdata");return ca};F.profile&&(ca.stats=l.stats);ca.destroy=function(){h(l)};return ca},createStream:function(c,b){var f=T.pop();f||(f=new I(c));f.bind();e(f,b,35040,0,1,!1);return f},destroyStream:function(c){T.push(c)},clear:function(){c(D).forEach(h);T.forEach(h)},getBuffer:function(c){return c&&c._buffer instanceof I?c._buffer:null},restore:function(){c(D).forEach(function(c){c.buffer=
K.createBuffer();K.bindBuffer(c.type,c.buffer);K.bufferData(c.type,c.persistentData||c.byteLength,c.usage)})},_initBuffer:e}}},{"./constants/arraytypes.json":4,"./constants/dtypes.json":5,"./constants/usage.json":7,"./util/check":21,"./util/flatten":26,"./util/is-ndarray":28,"./util/is-typed-array":30,"./util/pool":32,"./util/sorted-object-keys":34,"./util/values":36}],4:[function(z,aa,jc){aa.exports={"[object Int8Array]":5120,"[object Int16Array]":5122,"[object Int32Array]":5124,"[object Uint8Array]":5121,
...
{"static":35044,dynamic:35048,stream:35040}},{}],8:[function(z,aa,jc){function d(c){return Array.isArray(c)||K(c)||E(c)}function ba(c){return c.sort(function(c,b){return"viewport"===c?-1:"viewport"===b?1:c<b?-1:1})}function r(c,b,f,g){this.thisDep=c;this.contextDep=b;this.propDep=f;this.append=g}function N(c){return c&&!(c.thisDep||c.contextDep||c.propDep)}function g(c){return new r(!1,!1,!1,c)}function b(c,b){var f=c.type;if(0===f)return f=c.data.length,new r(!0,1<=f,2<=f,b);if(4===f)return f=c.data,
new r(f.thisDep,f.contextDep,f.propDep,b);if(5===f)return new r(!1,!1,!1,b);if(6===f){for(var g=f=!1,h=!1,a=0;a<c.data.length;++a){var l=c.data[a];1===l.type?h=!0:2===l.type?g=!0:3===l.type?f=!0:0===l.type?(f=!0,l=l.data,1<=l&&(g=!0),2<=l&&(h=!0)):4===l.type&&(f=f||l.data.thisDep,g=g||l.data.contextDep,h=h||l.data.propDep)}return new r(f,g,h,b)}return new r(3===f,2===f,1===f,b)}var x=z("./util/sorted-object-keys"),c=z("./util/check"),v=z("./util/extend"),na=z("./util/codegen"),da=z("./util/loop"),
K=z("./util/is-typed-array"),E=z("./util/is-ndarray"),u=z("./util/is-array-like"),A=z("./dynamic"),H=z("./constants/primitives.json"),n=z("./constants/dtypes.json"),F=["x","y","z","w"],ca="blend.func blend.equation stencil.func stencil.opFront stencil.opBack sample.coverage viewport scissor.box polygonOffset.offset".split(" "),I={0:0,1:1,zero:0,one:1,"src color":768,"one minus src color":769,"src alpha":770,"one minus src alpha":771,"dst color":774,"one minus dst color":775,"dst alpha":772,"one minus dst alpha":773,
...
"<":513,equal:514,"=":514,"==":514,"===":514,lequal:515,"<=":515,greater:516,">":516,notequal:517,"!=":517,"!==":517,gequal:518,">=":518,always:519},h={0:0,zero:0,keep:7680,replace:7681,increment:7682,decrement:7683,"increment wrap":34055,"decrement wrap":34056,invert:5386},f={frag:35632,vert:35633},D={cw:2304,ccw:2305},T=new r(!1,!1,!1,function(){});aa.exports=function(K,q,E,L,ga,a,l,X,ma,Ka,cb,kc,oa,Qa,Y){function O(c){return c.replace(".","_")}function M(c,p,a){var b=O(c);Z.push(c);m[b]=G[b]=!!a;
y[b]=p}function R(c,p,b){var a=O(c);Z.push(c);Array.isArray(b)?(G[a]=b.slice(),m[a]=b.slice()):G[a]=m[a]=b;ja[a]=p}function z(){var b=na(),p=b.link,a=b.global;b.id=tc++;b.batchId="0";var f=p(pa),y=b.shared={props:"a0"};x(pa).forEach(function(c){y[c]=a.def(f,".",c)});c.optional(function(){b.CHECK=p(c);b.commandStr=c.guessCommand();b.command=p(b.commandStr);b.assert=function(c,b,a){c("if(!(",b,"))",this.CHECK,".commandRaise(",p(a),",",this.command,");")};k.invalidBlendCombinations=Id});var g=b.next=
{},l=b.current={};x(ja).forEach(function(c){Array.isArray(G[c])&&(g[c]=a.def(y.next,".",c),l[c]=a.def(y.current,".",c))});var h=b.constants={};x(k).forEach(function(c){h[c]=a.def(JSON.stringify(k[c]))});b.invoke=function(c,a){switch(a.type){case 0:var f=["this",y.context,y.props,b.batchId];return c.def(p(a.data),".call(",f.slice(0,Math.max(a.data.length+1,4)),")");case 1:return c.def(y.props,a.data);case 2:return c.def(y.context,a.data);case 3:return c.def("this",a.data);case 4:return a.data.append(b,
c),a.data.ref;case 5:return a.data.toString();case 6:return a.data.map(function(a){return b.invoke(c,a)})}};b.attribCache={};var Ed={};b.scopeAttrib=function(c){c=q.id(c);if(c in Ed)return Ed[c];var b=Ka.scope[c];b||(b=Ka.scope[c]=new ia);return Ed[c]=p(b)};return b}function J(c){var a=c["static"];c=c.dynamic;var f;if("profile"in a){var k=!!a.profile;f=g(function(c,b){return k});f.enable=k}else if("profile"in c){var y=c.profile;f=b(y,function(c,b){return c.invoke(b,y)})}return f}function Ob(a,p){var f=
a["static"],k=a.dynamic;if("framebuffer"in f){var y=f.framebuffer;return y?(y=X.getFramebuffer(y),c.command(y,"invalid framebuffer object"),g(function(c,b){var a=c.link(y),p=c.shared;b.set(p.framebuffer,".next",a);p=p.context;b.set(p,".framebufferWidth",a+".width");b.set(p,".framebufferHeight",a+".height");return a})):g(function(c,b){var a=c.shared;b.set(a.framebuffer,".next","null");a=a.context;b.set(a,".framebufferWidth",a+".drawingBufferWidth");b.set(a,".framebufferHeight",a+".drawingBufferHeight");
return"null"})}if("framebuffer"in k){var l=k.framebuffer;return b(l,function(a,b){var p=a.invoke(b,l),f=a.shared,k=f.framebuffer,S=b.def(k,".getFramebuffer(",p,")");c.optional(function(){a.assert(b,"!"+p+"||"+S,"invalid framebuffer object")});b.set(k,".next",S);f=f.context;b.set(f,".framebufferWidth",S+"?"+S+".width:"+f+".drawingBufferWidth");b.set(f,".framebufferHeight",S+"?"+S+".height:"+f+".drawingBufferHeight");return S})}return null}function $a(a,p,f){function k(a){if(a in y){var S=y[a];c.commandType(S,
"object","invalid "+a,f.commandStr);var l=!0,qd=S.x|0,h=S.y|0,q,e;"width"in S?(q=S.width|0,c.command(0<=q,"invalid "+a,f.commandStr)):l=!1;"height"in S?(e=S.height|0,c.command(0<=e,"invalid "+a,f.commandStr)):l=!1;return new r(!l&&p&&p.thisDep,!l&&p&&p.contextDep,!l&&p&&p.propDep,function(c,a){var b=c.shared.context,p=q;"width"in S||(p=a.def(b,".","framebufferWidth","-",qd));var f=e;"height"in S||(f=a.def(b,".","framebufferHeight","-",h));return[qd,h,p,f]})}if(a in g){var m=g[a],l=b(m,function(b,
p){var f=b.invoke(p,m);c.optional(function(){b.assert(p,f+"&&typeof "+f+'==="object"',"invalid "+a)});var k=b.shared.context,S=p.def(f,".x|0"),y=p.def(f,".y|0"),g=p.def('"width" in ',f,"?",f,".width|0:","(",k,".","framebufferWidth","-",S,")"),l=p.def('"height" in ',f,"?",f,".height|0:","(",k,".","framebufferHeight","-",y,")");c.optional(function(){b.assert(p,g+">=0&&"+l+">=0","invalid "+a)});return[S,y,g,l]});p&&(l.thisDep=l.thisDep||p.thisDep,l.contextDep=l.contextDep||p.contextDep,l.propDep=l.propDep||
p.propDep);return l}return p?new r(p.thisDep,p.contextDep,p.propDep,function(c,a){var b=c.shared.context;return[0,0,a.def(b,".","framebufferWidth"),a.def(b,".","framebufferHeight")]}):null}var y=a["static"],g=a.dynamic;if(a=k("viewport")){var l=a;a=new r(a.thisDep,a.contextDep,a.propDep,function(c,a){var b=l.append(c,a),p=c.shared.context;a.set(p,".viewportWidth",b[2]);a.set(p,".viewportHeight",b[3]);return b})}return{viewport:a,scissor_box:k("scissor.box")}}function P(a,b){var f=a["static"];if("string"===
typeof f.frag&&"string"===typeof f.vert){if(0<x(b.dynamic).length)return null;var f=b["static"],k=x(f);if(0<k.length&&"number"===typeof f[k[0]]){for(var y=[],g=0;g<k.length;++g)c("number"===typeof f[k[g]],"must specify all vertex attribute locations when using vaos"),y.push([f[k[g]]|0,k[g]]);return y}}return null}function t(a,p,k){function y(a){if(a in l){var p=q.id(l[a]);c.optional(function(){cb.shader(f[a],p,c.guessCommand())});var k=g(function(){return p});k.id=p;return k}if(a in h){var S=h[a];
return b(S,function(b,p){var k=b.invoke(p,S),y=p.def(b.shared.strings,".id(",k,")");c.optional(function(){p(b.shared.shader,".shader(",f[a],",",y,",",b.command,");")});return y})}return null}var l=a["static"],h=a.dynamic,e=y("frag"),m=y("vert"),Ed=null;N(e)&&N(m)?(Ed=cb.program(m.id,e.id,null,k),a=g(function(a,c){return a.link(Ed)})):a=new r(e&&e.thisDep||m&&m.thisDep,e&&e.contextDep||m&&m.contextDep,e&&e.propDep||m&&m.propDep,function(a,b){var p=a.shared.shader,f;f=e?e.append(a,b):b.def(p,".","frag");
var k;k=m?m.append(a,b):b.def(p,".","vert");var y=p+".program("+k+","+f;c.optional(function(){y+=","+a.command});return b.def(y+")")});return{frag:e,vert:m,progVar:a,program:Ed}}function la(f,p){function k(a,f){if(a in y){var S=y[a]|0;f?h.offset=S:h.instances=S;c.command(!f||0<=S,"invalid "+a,p.commandStr);return g(function(a,c){f&&(a.OFFSET=S);return S})}if(a in l){var qd=l[a];return b(qd,function(b,p){var k=b.invoke(p,qd);f&&(b.OFFSET=k,c.optional(function(){b.assert(p,k+">=0","invalid "+a)}));
return k})}if(f){if(Ed)return g(function(a,c){return a.OFFSET=0});if(q)return new r(e.thisDep,e.contextDep,e.propDep,function(a,c){return c.def(a.shared.vao+".currentVAO?"+a.shared.vao+".currentVAO.offset:0")})}else if(q)return new r(e.thisDep,e.contextDep,e.propDep,function(a,c){return c.def(a.shared.vao+".currentVAO?"+a.shared.vao+".currentVAO.instances:-1")});return null}var y=f["static"],l=f.dynamic,h={},q=!1,e=function(){if("vao"in y){var a=y.vao;null!==a&&null===Ka.getVAO(a)&&(a=Ka.createVAO(a));
q=!0;h.vao=a;return g(function(c){var b=Ka.getVAO(a);return b?c.link(b):"null"})}if("vao"in l){q=!0;var c=l.vao;return b(c,function(a,b){var p=a.invoke(b,c);return b.def(a.shared.vao+".getVAO("+p+")")})}return null}(),Ed=!1,m=function(){if("elements"in y){var f=y.elements;h.elements=f;if(d(f)){var k=h.elements=a.create(f,!0),f=a.getElements(k);Ed=!0}else f&&(f=a.getElements(f),Ed=!0,c.command(f,"invalid elements",p.commandStr));k=g(function(a,c){if(f){var b=a.link(f);return a.ELEMENTS=b}return a.ELEMENTS=
null});k.value=f;return k}if("elements"in l){Ed=!0;var S=l.elements;return b(S,function(a,b){var p=a.shared,f=p.isBufferArgs,p=p.elements,k=a.invoke(b,S),y=b.def("null"),f=b.def(f,"(",k,")"),g=a.cond(f).then(y,"=",p,".createStream(",k,");")["else"](y,"=",p,".getElements(",k,");");c.optional(function(){a.assert(g["else"],"!"+k+"||"+y,"invalid elements")});b.entry(g);b.exit(a.cond(f).then(p,".destroyStream(",y,");"));return a.ELEMENTS=y})}return q?new r(e.thisDep,e.contextDep,e.propDep,function(a,b){return b.def(a.shared.vao+
".currentVAO?"+a.shared.elements+".getElements("+a.shared.vao+".currentVAO.elements):null")}):null}(),qd=k("offset",!0),t=function(){if("primitive"in y){var a=y.primitive;h.primitive=a;c.commandParameter(a,H,"invalid primitve",p.commandStr);return g(function(b,c){return H[a]})}if("primitive"in l){var f=l.primitive;return b(f,function(a,b){var p=a.constants.primTypes,k=a.invoke(b,f);c.optional(function(){a.assert(b,k+" in "+p,"invalid primitive, must be one of "+x(H))});return b.def(p,"[",k,"]")})}return Ed?
N(m)?m.value?g(function(a,b){return b.def(a.ELEMENTS,".primType")}):g(function(){return 4}):new r(m.thisDep,m.contextDep,m.propDep,function(a,b){var c=a.ELEMENTS;return b.def(c,"?",c,".primType:",4)}):q?new r(e.thisDep,e.contextDep,e.propDep,function(a,b){return b.def(a.shared.vao+".currentVAO?"+a.shared.vao+".currentVAO.primitive:4")}):null}(),n=function(){if("count"in y){var a=y.count|0;h.count=a;c.command("number"===typeof a&&0<=a,"invalid vertex count",p.commandStr);return g(function(){return a})}if("count"in
l){var f=l.count;return b(f,function(a,b){var p=a.invoke(b,f);c.optional(function(){a.assert(b,"typeof "+p+'==="number"&&'+p+">=0&&"+p+"===("+p+"|0)","invalid vertex count")});return p})}if(Ed){if(N(m)){if(m)return qd?new r(qd.thisDep,qd.contextDep,qd.propDep,function(a,b){var p=b.def(a.ELEMENTS,".vertCount-",a.OFFSET);c.optional(function(){a.assert(b,p+">=0","invalid vertex offset/element buffer too small")});return p}):g(function(a,b){return b.def(a.ELEMENTS,".vertCount")});var k=g(function(){return-1});
c.optional(function(){k.MISSING=!0});return k}var S=new r(m.thisDep||qd.thisDep,m.contextDep||qd.contextDep,m.propDep||qd.propDep,function(a,b){var c=a.ELEMENTS;return a.OFFSET?b.def(c,"?",c,".vertCount-",a.OFFSET,":-1"):b.def(c,"?",c,".vertCount:-1")});c.optional(function(){S.DYNAMIC=!0});return S}return q?new r(e.thisDep,e.contextDep,e.propDep,function(a,b){return b.def(a.shared.vao,".currentVAO?",a.shared.vao,".currentVAO.count:-1")}):null}(),pa=k("instances",!1);return{elements:m,primitive:t,
count:n,instances:pa,offset:qd,vao:e,vaoActive:q,elementsActive:Ed,"static":h}}function fa(a,p){var f=a["static"],k=a.dynamic,y={};Z.forEach(function(a){function S(c,p){if(a in f){var h=c(f[a]);y[l]=g(function(){return h})}else if(a in k){var e=k[a];y[l]=b(e,function(a,b){return p(a,b,a.invoke(b,e))})}}var l=O(a);switch(a){case "cull.enable":case "blend.enable":case "dither":case "stencil.enable":case "depth.enable":case "scissor.enable":case "polygonOffset.enable":case "sample.alpha":case "sample.enable":case "depth.mask":return S(function(b){c.commandType(b,
"boolean",a,p.commandStr);return b},function(b,p,f){c.optional(function(){b.assert(p,"typeof "+f+'==="boolean"',"invalid flag "+a,b.commandStr)});return f});case "depth.func":return S(function(b){c.commandParameter(b,e,"invalid "+a,p.commandStr);return e[b]},function(b,p,f){var k=b.constants.compareFuncs;c.optional(function(){b.assert(p,f+" in "+k,"invalid "+a+", must be one of "+x(e))});return p.def(k,"[",f,"]")});case "depth.range":return S(function(a){c.command(u(a)&&2===a.length&&"number"===typeof a[0]&&
"number"===typeof a[1]&&a[0]<=a[1],"depth range is 2d array",p.commandStr);return a},function(a,b,p){c.optional(function(){a.assert(b,a.shared.isArrayLike+"("+p+")&&"+p+".length===2&&typeof "+p+'[0]==="number"&&typeof '+p+'[1]==="number"&&'+p+"[0]<="+p+"[1]","depth range must be a 2d array")});var f=b.def("+",p,"[0]"),k=b.def("+",p,"[1]");return[f,k]});case "blend.func":return S(function(a){c.commandType(a,"object","blend.func",p.commandStr);var b="srcRGB"in a?a.srcRGB:a.src,f="srcAlpha"in a?a.srcAlpha:
a.src,k="dstRGB"in a?a.dstRGB:a.dst;a="dstAlpha"in a?a.dstAlpha:a.dst;c.commandParameter(b,I,l+".srcRGB",p.commandStr);c.commandParameter(f,I,l+".srcAlpha",p.commandStr);c.commandParameter(k,I,l+".dstRGB",p.commandStr);c.commandParameter(a,I,l+".dstAlpha",p.commandStr);c.command(-1===Id.indexOf(b+", "+k),"unallowed blending combination (srcRGB, dstRGB) = ("+b+", "+k+")",p.commandStr);return[I[b],I[k],I[f],I[a]]},function(b,p,f){function k(S,l){var g=p.def('"',S,l,'" in ',f,"?",f,".",S,l,":",f,".",
S);c.optional(function(){b.assert(p,g+" in "+y,"invalid "+a+"."+S+l+", must be one of "+x(I))});return g}var y=b.constants.blendFuncs;c.optional(function(){b.assert(p,f+"&&typeof "+f+'==="object"',"invalid blend func, must be an object")});var S=k("src","RGB"),l=k("dst","RGB");c.optional(function(){b.assert(p,b.constants.invalidBlendCombinations+".indexOf("+S+'+", "+'+l+") === -1 ","unallowed blending combination for (srcRGB, dstRGB)")});var g=p.def(y,"[",S,"]"),h=p.def(y,"[",k("src","Alpha"),"]"),
e=p.def(y,"[",l,"]"),q=p.def(y,"[",k("dst","Alpha"),"]");return[g,e,h,q]});case "blend.equation":return S(function(b){if("string"===typeof b)return c.commandParameter(b,ua,"invalid "+a,p.commandStr),[ua[b],ua[b]];if("object"===typeof b)return c.commandParameter(b.rgb,ua,a+".rgb",p.commandStr),c.commandParameter(b.alpha,ua,a+".alpha",p.commandStr),[ua[b.rgb],ua[b.alpha]];c.commandRaise("invalid blend.equation",p.commandStr)},function(b,p,f){var k=b.constants.blendEquations,y=p.def(),S=p.def(),l=b.cond("typeof ",
f,'==="string"');c.optional(function(){function c(a,p,f){b.assert(a,f+" in "+k,"invalid "+p+", must be one of "+x(ua))}c(l.then,a,f);b.assert(l["else"],f+"&&typeof "+f+'==="object"',"invalid "+a);c(l["else"],a+".rgb",f+".rgb");c(l["else"],a+".alpha",f+".alpha")});l.then(y,"=",S,"=",k,"[",f,"];");l["else"](y,"=",k,"[",f,".rgb];",S,"=",k,"[",f,".alpha];");p(l);return[y,S]});case "blend.color":return S(function(a){c.command(u(a)&&4===a.length,"blend.color must be a 4d array",p.commandStr);return da(4,
function(b){return+a[b]})},function(a,b,p){c.optional(function(){a.assert(b,a.shared.isArrayLike+"("+p+")&&"+p+".length===4","blend.color must be a 4d array")});return da(4,function(a){return b.def("+",p,"[",a,"]")})});case "stencil.mask":return S(function(a){c.commandType(a,"number",l,p.commandStr);return a|0},function(a,b,p){c.optional(function(){a.assert(b,"typeof "+p+'==="number"',"invalid stencil.mask")});return b.def(p,"|0")});case "stencil.func":return S(function(b){c.commandType(b,"object",
l,p.commandStr);var f=b.cmp||"keep",k=b.ref||0;b="mask"in b?b.mask:-1;c.commandParameter(f,e,a+".cmp",p.commandStr);c.commandType(k,"number",a+".ref",p.commandStr);c.commandType(b,"number",a+".mask",p.commandStr);return[e[f],k,b]},function(a,b,p){var f=a.constants.compareFuncs;c.optional(function(){function c(){a.assert(b,Array.prototype.join.call(arguments,""),"invalid stencil.func")}c(p+"&&typeof ",p,'==="object"');c('!("cmp" in ',p,")||(",p,".cmp in ",f,")")});var k=b.def('"cmp" in ',p,"?",f,"[",
p,".cmp]",":",7680),y=b.def(p,".ref|0"),S=b.def('"mask" in ',p,"?",p,".mask|0:-1");return[k,y,S]});case "stencil.opFront":case "stencil.opBack":return S(function(b){c.commandType(b,"object",l,p.commandStr);var f=b.fail||"keep",k=b.zfail||"keep";b=b.zpass||"keep";c.commandParameter(f,h,a+".fail",p.commandStr);c.commandParameter(k,h,a+".zfail",p.commandStr);c.commandParameter(b,h,a+".zpass",p.commandStr);return["stencil.opBack"===a?1029:1028,h[f],h[k],h[b]]},function(b,p,f){function k(S){c.optional(function(){b.assert(p,
'!("'+S+'" in '+f+")||("+f+"."+S+" in "+y+")","invalid "+a+"."+S+", must be one of "+x(h))});return p.def('"',S,'" in ',f,"?",y,"[",f,".",S,"]:",7680)}var y=b.constants.stencilOps;c.optional(function(){b.assert(p,f+"&&typeof "+f+'==="object"',"invalid "+a)});return["stencil.opBack"===a?1029:1028,k("fail"),k("zfail"),k("zpass")]});case "polygonOffset.offset":return S(function(a){c.commandType(a,"object",l,p.commandStr);var b=a.factor|0;a=a.units|0;c.commandType(b,"number",l+".factor",p.commandStr);
c.commandType(a,"number",l+".units",p.commandStr);return[b,a]},function(b,p,f){c.optional(function(){b.assert(p,f+"&&typeof "+f+'==="object"',"invalid "+a)});var k=p.def(f,".factor|0"),y=p.def(f,".units|0");return[k,y]});case "cull.face":return S(function(a){var b=0;"front"===a?b=1028:"back"===a&&(b=1029);c.command(!!b,l,p.commandStr);return b},function(a,b,p){c.optional(function(){a.assert(b,p+'==="front"||'+p+'==="back"',"invalid cull.face")});return b.def(p,'==="front"?',1028,":",1029)});case "lineWidth":return S(function(a){c.command("number"===
typeof a&&a>=L.lineWidthDims[0]&&a<=L.lineWidthDims[1],"invalid line width, must be a positive number between "+L.lineWidthDims[0]+" and "+L.lineWidthDims[1],p.commandStr);return a},function(a,b,p){c.optional(function(){a.assert(b,"typeof "+p+'==="number"&&'+p+">="+L.lineWidthDims[0]+"&&"+p+"<="+L.lineWidthDims[1],"invalid line width")});return p});case "frontFace":return S(function(a){c.commandParameter(a,D,l,p.commandStr);return D[a]},function(a,b,p){c.optional(function(){a.assert(b,p+'==="cw"||'+
p+'==="ccw"',"invalid frontFace, must be one of cw,ccw")});return b.def(p+'==="cw"?2304:2305')});case "colorMask":return S(function(a){c.command(u(a)&&4===a.length,"color.mask must be length 4 array",p.commandStr);return a.map(function(a){return!!a})},function(a,b,p){c.optional(function(){a.assert(b,a.shared.isArrayLike+"("+p+")&&"+p+".length===4","invalid color.mask")});return da(4,function(a){return"!!"+p+"["+a+"]"})});case "sample.coverage":return S(function(a){c.command("object"===typeof a&&a,
l,p.commandStr);var b="value"in a?a.value:1;a=!!a.invert;c.command("number"===typeof b&&0<=b&&1>=b,"sample.coverage.value must be a number between 0 and 1",p.commandStr);return[b,a]},function(a,b,p){c.optional(function(){a.assert(b,p+"&&typeof "+p+'==="object"',"invalid sample.coverage")});var f=b.def('"value" in ',p,"?+",p,".value:1"),k=b.def("!!",p,".invert");return[f,k]})}});return y}function Ea(a,p){var f=a["static"],k=a.dynamic,y={};x(f).forEach(function(a){var b=f[a],k;if("number"===typeof b||
"boolean"===typeof b)k=g(function(){return b});else if("function"===typeof b){var S=b._reglType;"texture2d"===S||"textureCube"===S?k=g(function(a){return a.link(b)}):"framebuffer"===S||"framebufferCube"===S?(c.command(0<b.color.length,'missing color attachment for framebuffer sent to uniform "'+a+'"',p.commandStr),k=g(function(a){return a.link(b.color[0])})):c.commandRaise('invalid data for uniform "'+a+'"',p.commandStr)}else u(b)?k=g(function(p){return p.global.def("[",da(b.length,function(f){c.command("number"===
typeof b[f]||"boolean"===typeof b[f],"invalid uniform "+a,p.commandStr);return b[f]}),"]")}):c.commandRaise('invalid or missing data for uniform "'+a+'"',p.commandStr);k.value=b;y[a]=k});x(k).forEach(function(a){var p=k[a];y[a]=b(p,function(a,b){return a.invoke(b,p)})});return y}function Na(a,p){var f=a["static"],k=a.dynamic,y={};x(f).forEach(function(a){var b=f[a],k=q.id(a),S=new ia;if(d(b))S.state=1,S.buffer=ga.getBuffer(ga.create(b,34962,!1,!0)),S.type=0;else{var l=ga.getBuffer(b);if(l)S.state=
1,S.buffer=l,S.type=0;else if(c.command("object"===typeof b&&b,"invalid data for attribute "+a,p.commandStr),"constant"in b){var h=b.constant;S.buffer="null";S.state=2;"number"===typeof h?S.x=h:(c.command(u(h)&&0<h.length&&4>=h.length,"invalid constant for attribute "+a,p.commandStr),F.forEach(function(a,b){b<h.length&&(S[a]=h[b])}))}else{l=d(b.buffer)?ga.getBuffer(ga.create(b.buffer,34962,!1,!0)):ga.getBuffer(b.buffer);c.command(!!l,'missing buffer for attribute "'+a+'"',p.commandStr);var e=b.offset|
0;c.command(0<=e,'invalid offset for attribute "'+a+'"',p.commandStr);var m=b.stride|0;c.command(0<=m&&256>m,'invalid stride for attribute "'+a+'", must be integer betweeen [0, 255]',p.commandStr);var t=b.size|0;c.command(!("size"in b)||0<t&&4>=t,'invalid size for attribute "'+a+'", must be 1,2,3,4',p.commandStr);var pa=!!b.normalized,w=0;"type"in b&&(c.commandParameter(b.type,n,"invalid type for attribute "+a,p.commandStr),w=n[b.type]);var ja=b.divisor|0;c.optional(function(){"divisor"in b&&(c.command(0===
ja||Q,'cannot specify divisor for attribute "'+a+'", instancing not supported',p.commandStr),c.command(0<=ja,'invalid divisor for attribute "'+a+'"',p.commandStr));var f=p.commandStr,k="buffer offset divisor normalized type size stride".split(" ");x(b).forEach(function(b){c.command(0<=k.indexOf(b),'unknown parameter "'+b+'" for attribute pointer "'+a+'" (valid parameters are '+k+")",f)})});S.buffer=l;S.state=1;S.size=t;S.normalized=pa;S.type=w||l.dtype;S.offset=e;S.stride=m;S.divisor=ja}}y[a]=g(function(a,
b){var p=a.attribCache;if(k in p)return p[k];var c={isStream:!1};x(S).forEach(function(a){c[a]=S[a]});S.buffer&&(c.buffer=a.link(S.buffer),c.type=c.type||c.buffer+".dtype");return p[k]=c})});x(k).forEach(function(a){var p=k[a];y[a]=b(p,function(b,f){function k(a){f(e[a],"=",S,".",a,"|0;")}var S=b.invoke(f,p),y=b.shared,l=b.constants,g=y.isBufferArgs,h=y.buffer;c.optional(function(){b.assert(f,S+"&&(typeof "+S+'==="object"||typeof '+S+'==="function")&&('+g+"("+S+")||"+h+".getBuffer("+S+")||"+h+".getBuffer("+
S+".buffer)||"+g+"("+S+'.buffer)||("constant" in '+S+"&&(typeof "+S+'.constant==="number"||'+y.isArrayLike+"("+S+".constant))))",'invalid dynamic attribute "'+a+'"')});var e={isStream:f.def(!1)},q=new ia;q.state=1;x(q).forEach(function(a){e[a]=f.def(""+q[a])});var m=e.buffer,Bb=e.type;f("if(",g,"(",S,")){",e.isStream,"=true;",m,"=",h,".createStream(",34962,",",S,");",Bb,"=",m,".dtype;","}else{",m,"=",h,".getBuffer(",S,");","if(",m,"){",Bb,"=",m,".dtype;",'}else if("constant" in ',S,"){",e.state,"=",
2,";","if(typeof "+S+'.constant === "number"){',e[F[0]],"=",S,".constant;",F.slice(1).map(function(a){return e[a]}).join("="),"=0;","}else{",F.map(function(a,b){return e[a]+"="+S+".constant.length>"+b+"?"+S+".constant["+b+"]:0;"}).join(""),"}}else{","if(",g,"(",S,".buffer)){",m,"=",h,".createStream(",34962,",",S,".buffer);","}else{",m,"=",h,".getBuffer(",S,".buffer);","}",Bb,'="type" in ',S,"?",l.glTypes,"[",S,".type]:",m,".dtype;",e.normalized,"=!!",S,".normalized;");k("size");k("offset");k("stride");
k("divisor");f("}}");f.exit("if(",e.isStream,"){",h,".destroyStream(",m,");","}");return e})});return y}function Hb(a){var p=a["static"],c=a.dynamic,f={};x(p).forEach(function(a){var b=p[a];f[a]=g(function(a,p){return"number"===typeof b||"boolean"===typeof b?""+b:a.link(b)})});x(c).forEach(function(a){var p=c[a];f[a]=b(p,function(a,b){return a.invoke(b,p)})});return f}function Ha(a,b,f,k,y){function l(a){var b=q[a];b&&(n[a]=b)}var g=a["static"],h=a.dynamic;c.optional(function(){function a(p){x(p).forEach(function(a){c.command(0<=
b.indexOf(a),'unknown parameter "'+a+'"',y.commandStr)})}var b="framebuffer vert frag elements primitive offset count instances profile vao".split(" ").concat(Z);a(g);a(h)});var e=P(a,b),m=Ob(a,y),q=$a(a,m,y),pa=la(a,y),n=fa(a,y),w=t(a,y,e);l("viewport");l(O("scissor.box"));var ja=0<x(n).length,m={framebuffer:m,draw:pa,shader:w,state:n,dirty:ja,scopeVAO:null,drawVAO:null,useVAO:!1,attributes:{}};m.profile=J(a,y);m.uniforms=Ea(f,y);m.drawVAO=m.scopeVAO=pa.vao;if(!m.drawVAO&&w.program&&!e&&E.angle_instanced_arrays&&
pa["static"].elements){var d=!0;a=w.program.attributes.map(function(a){a=b["static"][a];d=d&&!!a;return a});if(d&&0<a.length){var D=Ka.getVAO(Ka.createVAO({attributes:a,elements:pa["static"].elements}));m.drawVAO=new r(null,null,null,function(a,b){return a.link(D)});m.useVAO=!0}}e?m.useVAO=!0:m.attributes=Na(b,y);m.context=Hb(k,y);return m}function U(a,b,c){var f=a.shared.context,k=a.scope();x(c).forEach(function(y){b.save(f,"."+y);var l=c[y].append(a,b);Array.isArray(l)?k(f,".",y,"=[",l.join(),"];"):
k(f,".",y,"=",l,";")});b(k)}function ob(a,b,c,f){var k=a.shared,y=k.gl,l=k.framebuffer,g;ha&&(g=b.def(k.extensions,".webgl_draw_buffers"));var h=a.constants,k=h.drawBuffer,h=h.backBuffer;a=c?c.append(a,b):b.def(l,".next");f||b("if(",a,"!==",l,".cur){");b("if(",a,"){",y,".bindFramebuffer(",36160,",",a,".framebuffer);");ha&&b(g,".drawBuffersWEBGL(",k,"[",a,".colorAttachments.length]);");b("}else{",y,".bindFramebuffer(",36160,",null);");ha&&b(g,".drawBuffersWEBGL(",h,");");b("}",l,".cur=",a,";");f||
b("}")}function ea(a,b,c){var f=a.shared,k=f.gl,l=a.current,g=a.next,h=f.current,e=f.next,m=a.cond(h,".dirty");Z.forEach(function(b){b=O(b);if(!(b in c.state)){var p,f;if(b in g){p=g[b];f=l[b];var q=da(G[b].length,function(a){return m.def(p,"[",a,"]")});m(a.cond(q.map(function(a,b){return a+"!=="+f+"["+b+"]"}).join("||")).then(k,".",ja[b],"(",q,");",q.map(function(a,b){return f+"["+b+"]="+a}).join(";"),";"))}else p=m.def(e,".",b),q=a.cond(p,"!==",h,".",b),m(q),b in y?q(a.cond(p).then(k,".enable(",
y[b],");")["else"](k,".disable(",y[b],");"),h,".",b,"=",p,";"):q(k,".",ja[b],"(",p,");",h,".",b,"=",p,";")}});0===x(c.state).length&&m(h,".dirty=false;");b(m)}function va(a,b,c,f){var k=a.shared,l=a.current,g=k.current,h=k.gl;ba(x(c)).forEach(function(k){var e=c[k];if(!f||f(e)){var m=e.append(a,b);if(y[k]){var q=y[k];N(e)?m?b(h,".enable(",q,");"):b(h,".disable(",q,");"):b(a.cond(m).then(h,".enable(",q,");")["else"](h,".disable(",q,");"));b(g,".",k,"=",m,";")}else if(u(m)){var t=l[k];b(h,".",ja[k],
"(",m,");",m.map(function(a,b){return t+"["+b+"]="+a}).join(";"),";")}else b(h,".",ja[k],"(",m,");",g,".",k,"=",m,";")}})}function bc(a,b){Q&&(a.instancing=b.def(a.shared.extensions,".angle_instanced_arrays"))}function cc(a,b,c,f,k){function y(){return"undefined"===typeof performance?"Date.now()":"performance.now()"}function l(a){pa=b.def();a(pa,"=",y(),";");"string"===typeof k?a(e,".count+=",k,";"):a(e,".count++;");Qa&&(f?(n=b.def(),a(n,"=",t,".getNumPendingQueries();")):a(t,".beginQuery(",e,");"))}
function g(a){a(e,".cpuTime+=",y(),"-",pa,";");Qa&&(f?a(t,".pushScopeStats(",n,",",t,".getNumPendingQueries(),",e,");"):a(t,".endQuery();"))}function h(a){var c=b.def(q,".profile");b(q,".profile=",a,";");b.exit(q,".profile=",c,";")}var m=a.shared,e=a.stats,q=m.current,t=m.timer;c=c.profile;var pa,n;if(c){if(N(c)){c.enable?(l(b),g(b.exit),h("true")):h("false");return}c=c.append(a,b);h(c)}else c=b.def(q,".profile");m=a.block();l(m);b("if(",c,"){",m,"}");a=a.block();g(a);b.exit("if(",c,"){",a,"}")}function Qc(a,
b,f,k,y){function l(a){switch(a){case 35664:case 35667:case 35671:return 2;case 35665:case 35668:case 35672:return 3;case 35666:case 35669:case 35673:return 4;default:return 1}}function g(c,f,k){function y(){b("if(!",q,".buffer){",m,".enableVertexAttribArray(",e,");}");var c=k.type,l;l=k.size?b.def(k.size,"||",f):f;b("if(",q,".type!==",c,"||",q,".size!==",l,"||",n.map(function(a){return q+"."+a+"!=="+k[a]}).join("||"),"){",m,".bindBuffer(",34962,",",t,".buffer);",m,".vertexAttribPointer(",[e,l,c,
k.normalized,k.stride,k.offset],");",q,".type=",c,";",q,".size=",l,";",n.map(function(a){return q+"."+a+"="+k[a]+";"}).join(""),"}");Q&&(c=k.divisor,b("if(",q,".divisor!==",c,"){",a.instancing,".vertexAttribDivisorANGLE(",[e,c],");",q,".divisor=",c,";}"))}function l(){b("if(",q,".buffer){",m,".disableVertexAttribArray(",e,");",q,".buffer=null;","}if(",F.map(function(a,b){return q+"."+a+"!=="+pa[b]}).join("||"),"){",m,".vertexAttrib4f(",e,",",pa,");",F.map(function(a,b){return q+"."+a+"="+pa[b]+";"}).join(""),
"}")}var m=h.gl,e=b.def(c,".location"),q=b.def(h.attributes,"[",e,"]");c=k.state;var t=k.buffer,pa=[k.x,k.y,k.z,k.w],n=["buffer","normalized","offset","stride"];1===c?y():2===c?l():(b("if(",c,"===",1,"){"),y(),b("}else{"),l(),b("}"))}var h=a.shared;k.forEach(function(k){var h=k.name,m=f.attributes[h],e;if(m){if(!y(m))return;e=m.append(a,b)}else{if(!y(T))return;var q=a.scopeAttrib(h);c.optional(function(){a.assert(b,q+".state","missing attribute "+h)});e={};x(new ia).forEach(function(a){e[a]=b.def(q,
".",a)})}g(a.link(k),l(k.info.type),e)})}function td(a,b,f,k,y,l){for(var g=a.shared,h=g.gl,m,e=0;e<k.length;++e){var t=k[e],pa=t.name,n=t.info.type,w=f.uniforms[pa],t=a.link(t)+".location",ja;if(w){if(!y(w))continue;if(N(w)){var d=w.value;c.command(null!==d&&"undefined"!==typeof d,'missing uniform "'+pa+'"',a.commandStr);if(35678===n||35680===n)c.command("function"===typeof d&&(35678===n&&("texture2d"===d._reglType||"framebuffer"===d._reglType)||35680===n&&("textureCube"===d._reglType||"framebufferCube"===
d._reglType)),"invalid texture for uniform "+pa,a.commandStr),w=a.link(d._texture||d.color[0]._texture),b(h,".uniform1i(",t,",",w+".bind());"),b.exit(w,".unbind();");else if(35674===n||35675===n||35676===n){c.optional(function(){c.command(u(d),"invalid matrix for uniform "+pa,a.commandStr);c.command(35674===n&&4===d.length||35675===n&&9===d.length||35676===n&&16===d.length,"invalid length for matrix uniform "+pa,a.commandStr)});var w=a.global.def("new Float32Array(["+Array.prototype.slice.call(d)+
"])"),D=2;35675===n?D=3:35676===n&&(D=4);b(h,".uniformMatrix",D,"fv(",t,",false,",w,");")}else{switch(n){case 5126:c.commandType(d,"number","uniform "+pa,a.commandStr);m="1f";break;case 35664:c.command(u(d)&&2===d.length,"uniform "+pa,a.commandStr);m="2f";break;case 35665:c.command(u(d)&&3===d.length,"uniform "+pa,a.commandStr);m="3f";break;case 35666:c.command(u(d)&&4===d.length,"uniform "+pa,a.commandStr);m="4f";break;case 35670:c.commandType(d,"boolean","uniform "+pa,a.commandStr);m="1i";break;
case 5124:c.commandType(d,"number","uniform "+pa,a.commandStr);m="1i";break;case 35671:c.command(u(d)&&2===d.length,"uniform "+pa,a.commandStr);m="2i";break;case 35667:c.command(u(d)&&2===d.length,"uniform "+pa,a.commandStr);m="2i";break;case 35672:c.command(u(d)&&3===d.length,"uniform "+pa,a.commandStr);m="3i";break;case 35668:c.command(u(d)&&3===d.length,"uniform "+pa,a.commandStr);m="3i";break;case 35673:c.command(u(d)&&4===d.length,"uniform "+pa,a.commandStr);m="4i";break;case 35669:c.command(u(d)&&
4===d.length,"uniform "+pa,a.commandStr),m="4i"}b(h,".uniform",m,"(",t,",",u(d)?Array.prototype.slice.call(d):d,");")}continue}else ja=w.append(a,b)}else{if(!y(T))continue;ja=b.def(g.uniforms,"[",q.id(pa),"]")}35678===n?(c(!Array.isArray(ja),"must specify a scalar prop for textures"),b("if(",ja,"&&",ja,'._reglType==="framebuffer"){',ja,"=",ja,".color[0];","}")):35680===n&&(c(!Array.isArray(ja),"must specify a scalar prop for cube maps"),b("if(",ja,"&&",ja,'._reglType==="framebufferCube"){',ja,"=",
ja,".color[0];","}"));c.optional(function(){function f(c,k){a.assert(b,c,'bad data or missing for uniform "'+pa+'".  '+k)}function k(a){c(!Array.isArray(ja),"must not specify an array type for uniform");f("typeof "+ja+'==="'+a+'"',"invalid type, expected "+a)}function y(b,k){Array.isArray(ja)?c(ja.length===b,"must have length "+b):f(g.isArrayLike+"("+ja+")&&"+ja+".length==="+b,"invalid vector, should have length "+b,a.commandStr)}function l(b){c(!Array.isArray(ja),"must not specify a value type");
f("typeof "+ja+'==="function"&&'+ja+'._reglType==="texture'+(3553===b?"2d":"Cube")+'"',"invalid texture type",a.commandStr)}switch(n){case 5124:k("number");break;case 35667:y(2,"number");break;case 35668:y(3,"number");break;case 35669:y(4,"number");break;case 5126:k("number");break;case 35664:y(2,"number");break;case 35665:y(3,"number");break;case 35666:y(4,"number");break;case 35670:k("boolean");break;case 35671:y(2,"boolean");break;case 35672:y(3,"boolean");break;case 35673:y(4,"boolean");break;
case 35674:y(4,"number");break;case 35675:y(9,"number");break;case 35676:y(16,"number");break;case 35678:l(3553);break;case 35680:l(34067)}});w=1;switch(n){case 35678:case 35680:w=b.def(ja,"._texture");b(h,".uniform1i(",t,",",w,".bind());");b.exit(w,".unbind();");continue;case 5124:case 35670:m="1i";break;case 35667:case 35671:m="2i";w=2;break;case 35668:case 35672:m="3i";w=3;break;case 35669:case 35673:m="4i";w=4;break;case 5126:m="1f";break;case 35664:m="2f";w=2;break;case 35665:m="3f";w=3;break;
case 35666:m="4f";w=4;break;case 35674:m="Matrix2fv";break;case 35675:m="Matrix3fv";break;case 35676:m="Matrix4fv"}if("M"===m.charAt(0)){b(h,".uniform",m,"(",t,",");var t=Math.pow(n-35674+2,2),B=a.global.def("new Float32Array(",t,")");Array.isArray(ja)?b("false,(",da(t,function(a){return B+"["+a+"]="+ja[a]}),",",B,")"):b("false,(Array.isArray(",ja,")||",ja," instanceof Float32Array)?",ja,":(",da(t,function(a){return B+"["+a+"]="+ja+"["+a+"]"}),",",B,")");b(");")}else{if(1<w){for(var D=[],X=[],x=0;x<
w;++x)Array.isArray(ja)?X.push(ja[x]):X.push(b.def(ja+"["+x+"]")),l&&D.push(b.def());l&&b("if(!",a.batchId,"||",D.map(function(a,b){return a+"!=="+X[b]}).join("||"),"){",D.map(function(a,b){return a+"="+X[b]+";"}).join(""));b(h,".uniform",m,"(",t,",",X.join(","),");")}else c(!Array.isArray(ja),"uniform value must not be an array"),l&&(w=b.def(),b("if(!",a.batchId,"||",w,"!==",ja,"){",w,"=",ja,";")),b(h,".uniform",m,"(",t,",",ja,");");l&&b("}")}}}function wc(a,b,f,k){function y(c){var l=q[c];return l?
l.contextDep&&k.contextDynamic||l.propDep?l.append(a,f):l.append(a,b):b.def(e,".",c)}function l(){function a(){f(ja,".drawElementsInstancedANGLE(",[pa,w,D,n+"<<(("+D+"-5121)>>1)",d],");")}function b(){f(ja,".drawArraysInstancedANGLE(",[pa,n,w,d],");")}t&&"null"!==t?B?a():(f("if(",t,"){"),a(),f("}else{"),b(),f("}")):b()}function g(){function a(){f(m+".drawElements("+[pa,w,D,n+"<<(("+D+"-5121)>>1)"]+");")}function b(){f(m+".drawArrays("+[pa,n,w]+");")}t&&"null"!==t?B?a():(f("if(",t,"){"),a(),f("}else{"),
b(),f("}")):b()}var h=a.shared,m=h.gl,e=h.draw,q=k.draw,t=function(){var c=q.elements,y=b;if(c){if(c.contextDep&&k.contextDynamic||c.propDep)y=f;c=c.append(a,y);q.elementsActive&&y("if("+c+")"+m+".bindBuffer(34963,"+c+".buffer.buffer);")}else c=y.def(),y(c,"=",e,".","elements",";","if(",c,"){",m,".bindBuffer(",34963,",",c,".buffer.buffer);}","else if(",h.vao,".currentVAO){",c,"=",a.shared.elements+".getElements("+h.vao,".currentVAO.elements);",ra?"":"if("+c+")"+m+".bindBuffer(34963,"+c+".buffer.buffer);",
"}");return c}(),pa=y("primitive"),n=y("offset"),w=function(){var y=q.count,l,g=b;if(y){if(y.contextDep&&k.contextDynamic||y.propDep)g=f;l=y.append(a,g);c.optional(function(){y.MISSING&&a.assert(b,"false","missing vertex count");y.DYNAMIC&&a.assert(g,l+">=0","missing vertex count")})}else l=g.def(e,".","count"),c.optional(function(){a.assert(g,l+">=0","missing vertex count")});return l}();if("number"===typeof w){if(0===w)return}else f("if(",w,"){"),f.exit("}");var d,ja;Q&&(d=y("instances"),ja=a.instancing);
var D=t+".type",B=q.elements&&N(q.elements)&&!q.vaoActive;Q&&("number"!==typeof d||0<=d)?"string"===typeof d?(f("if(",d,">0){"),l(),f("}else if(",d,"<0){"),g(),f("}")):l():g()}function W(a,b,f,k,y){var l=z();y=l.proc("body",y);c.optional(function(){l.commandStr=b.commandStr;l.command=l.link(b.commandStr)});Q&&(l.instancing=y.def(l.shared.extensions,".angle_instanced_arrays"));a(l,y,f,k);return l.compile().body}function B(a,b,c,f){bc(a,b);c.useVAO?c.drawVAO?b(a.shared.vao,".setVAO(",c.drawVAO.append(a,
b),");"):b(a.shared.vao,".setVAO(",a.shared.vao,".targetVAO);"):(b(a.shared.vao,".setVAO(null);"),Qc(a,b,c,f.attributes,function(){return!0}));td(a,b,c,f.uniforms,function(){return!0},!1);wc(a,b,b,c)}function ka(a,b){var c=a.proc("draw",1);bc(a,c);U(a,c,b.context);ob(a,c,b.framebuffer);ea(a,c,b);va(a,c,b.state);cc(a,c,b,!1,!0);var f=b.shader.progVar.append(a,c);c(a.shared.gl,".useProgram(",f,".program);");if(b.shader.program)B(a,c,b,b.shader.program);else{c(a.shared.vao,".setVAO(null);");var k=a.global.def("{}"),
y=c.def(f,".id"),l=c.def(k,"[",y,"]");c(a.cond(l).then(l,".call(this,a0);")["else"](l,"=",k,"[",y,"]=",a.link(function(c){return W(B,a,b,c,1)}),"(",f,");",l,".call(this,a0);"))}0<x(b.state).length&&c(a.shared.current,".dirty=true;");a.shared.vao&&c(a.shared.vao,".setVAO(null);")}function Ca(a,b,c,f){function k(){return!0}a.batchId="a1";bc(a,b);Qc(a,b,c,f.attributes,k);td(a,b,c,f.uniforms,k,!1);wc(a,b,b,c)}function Lb(a,b,c,f){function k(a){return a.contextDep&&l||a.propDep}function y(a){return!k(a)}
bc(a,b);var l=c.contextDep,g=b.def(),h=b.def();a.shared.props=h;a.batchId=g;var m=a.scope(),e=a.scope();b(m.entry,"for(",g,"=0;",g,"<","a1",";++",g,"){",h,"=","a0","[",g,"];",e,"}",m.exit);c.needsContext&&U(a,e,c.context);c.needsFramebuffer&&ob(a,e,c.framebuffer);va(a,e,c.state,k);c.profile&&k(c.profile)&&cc(a,e,c,!1,!0);f?(c.useVAO?c.drawVAO?k(c.drawVAO)?e(a.shared.vao,".setVAO(",c.drawVAO.append(a,e),");"):m(a.shared.vao,".setVAO(",c.drawVAO.append(a,m),");"):m(a.shared.vao,".setVAO(",a.shared.vao,
".targetVAO);"):(m(a.shared.vao,".setVAO(null);"),Qc(a,m,c,f.attributes,y),Qc(a,e,c,f.attributes,k)),td(a,m,c,f.uniforms,y,!1),td(a,e,c,f.uniforms,k,!0),wc(a,m,e,c)):(b=a.global.def("{}"),f=c.shader.progVar.append(a,e),h=e.def(f,".id"),m=e.def(b,"[",h,"]"),e(a.shared.gl,".useProgram(",f,".program);","if(!",m,"){",m,"=",b,"[",h,"]=",a.link(function(b){return W(Ca,a,c,b,2)}),"(",f,");}",m,".call(this,a0[",g,"],",g,");"))}function nc(a,b){function c(a){return a.contextDep&&k||a.propDep}var f=a.proc("batch",
2);a.batchId="0";bc(a,f);var k=!1,y=!0;x(b.context).forEach(function(a){k=k||b.context[a].propDep});k||(U(a,f,b.context),y=!1);var l=b.framebuffer,g=!1;l?(l.propDep?k=g=!0:l.contextDep&&k&&(g=!0),g||ob(a,f,l)):ob(a,f,null);b.state.viewport&&b.state.viewport.propDep&&(k=!0);ea(a,f,b);va(a,f,b.state,function(a){return!c(a)});b.profile&&c(b.profile)||cc(a,f,b,!1,"a1");b.contextDep=k;b.needsContext=y;b.needsFramebuffer=g;y=b.shader.progVar;if(y.contextDep&&k||y.propDep)Lb(a,f,b,null);else if(y=y.append(a,
f),f(a.shared.gl,".useProgram(",y,".program);"),b.shader.program)Lb(a,f,b,b.shader.program);else{f(a.shared.vao,".setVAO(null);");var l=a.global.def("{}"),g=f.def(y,".id"),h=f.def(l,"[",g,"]");f(a.cond(h).then(h,".call(this,a0,a1);")["else"](h,"=",l,"[",g,"]=",a.link(function(c){return W(Lb,a,b,c,2)}),"(",y,");",h,".call(this,a0,a1);"))}0<x(b.state).length&&f(a.shared.current,".dirty=true;");a.shared.vao&&f(a.shared.vao,".setVAO(null);")}function Zc(a,b){function c(y){var l=b.shader[y];l&&f.set(k.shader,
"."+y,l.append(a,f))}var f=a.proc("scope",3);a.batchId="a2";var k=a.shared,y=k.current;U(a,f,b.context);b.framebuffer&&b.framebuffer.append(a,f);ba(x(b.state)).forEach(function(c){var y=b.state[c].append(a,f);u(y)?y.forEach(function(b,k){f.set(a.next[c],"["+k+"]",b)}):f.set(k.next,"."+c,y)});cc(a,f,b,!0,!0);["elements","offset","count","instances","primitive"].forEach(function(c){var y=b.draw[c];y&&f.set(k.draw,"."+c,""+y.append(a,f))});x(b.uniforms).forEach(function(c){var y=b.uniforms[c].append(a,
f);Array.isArray(y)&&(y="["+y.join()+"]");f.set(k.uniforms,"["+q.id(c)+"]",y)});x(b.attributes).forEach(function(c){var k=b.attributes[c].append(a,f),y=a.scopeAttrib(c);x(new ia).forEach(function(a){f.set(y,"."+a,k[a])})});b.scopeVAO&&f.set(k.vao,".targetVAO",b.scopeVAO.append(a,f));c("vert");c("frag");0<x(b.state).length&&(f(y,".dirty=true;"),f.exit(y,".dirty=true;"));f("a1(",a.shared.context,",a0,",a.batchId,");")}function C(a){if("object"===typeof a&&!u(a)){for(var b=x(a),c=0;c<b.length;++c)if(A.isDynamic(a[b[c]]))return!0;
return!1}}function w(a,c,f){function k(a,b){g.forEach(function(c){var f=y[c];A.isDynamic(f)&&(f=a.invoke(b,f),b(q,".",c,"=",f,";"))})}var y=c["static"][f];if(y&&C(y)){var l=a.global,g=x(y),h=!1,m=!1,e=!1,q=a.global.def("{}");g.forEach(function(c){var f=y[c];if(A.isDynamic(f))"function"===typeof f&&(f=y[c]=A.unbox(f)),c=b(f,null),h=h||c.thisDep,e=e||c.propDep,m=m||c.contextDep;else{l(q,".",c,"=");switch(typeof f){case "number":l(f);break;case "string":l('"',f,'"');break;case "object":Array.isArray(f)&&
l("[",f.join(),"]");break;default:l(a.link(f))}l(";")}});c.dynamic[f]=new A.DynamicVariable(4,{thisDep:h,contextDep:m,propDep:e,ref:q,append:k});delete c["static"][f]}}var ia=Ka.Record,ua={add:32774,subtract:32778,"reverse subtract":32779};E.ext_blend_minmax&&(ua.min=32775,ua.max=32776);var Q=E.angle_instanced_arrays,ha=E.webgl_draw_buffers,ra=E.oes_vertex_array_object,G={dirty:!0,profile:Y.profile},m={},Z=[],y={},ja={};M("dither",3024);M("blend.enable",3042);R("blend.color","blendColor",[0,0,0,0]);
...
32928);R("sample.coverage","sampleCoverage",[1,!1]);M("stencil.enable",2960);R("stencil.mask","stencilMask",-1);R("stencil.func","stencilFunc",[519,0,-1]);R("stencil.opFront","stencilOpSeparate",[1028,7680,7680,7680]);R("stencil.opBack","stencilOpSeparate",[1029,7680,7680,7680]);M("scissor.enable",3089);R("scissor.box","scissor",[0,0,K.drawingBufferWidth,K.drawingBufferHeight]);R("viewport","viewport",[0,0,K.drawingBufferWidth,K.drawingBufferHeight]);var pa={gl:K,context:oa,strings:q,next:m,current:G,
draw:kc,elements:a,buffer:ga,shader:cb,attributes:Ka.state,vao:Ka,uniforms:ma,framebuffer:X,extensions:E,timer:Qa,isBufferArgs:d},k={primTypes:H,compareFuncs:e,blendFuncs:I,blendEquations:ua,stencilOps:h,glTypes:n,orientationType:D};c.optional(function(){pa.isArrayLike=u});ha&&(k.backBuffer=[1029],k.drawBuffer=da(L.maxDrawbuffers,function(a){return 0===a?[0]:da(a,function(a){return 36064+a})}));var tc=0;return{next:m,current:G,procs:function(){var a=z(),b=a.proc("poll"),c=a.proc("refresh"),f=a.block();
b(f);c(f);var k=a.shared,l=k.gl,g=k.next,h=k.current;f(h,".dirty=false;");ob(a,b);ob(a,c,null,!0);var m;Q&&(m=a.link(Q));E.oes_vertex_array_object&&c(a.link(E.oes_vertex_array_object),".bindVertexArrayOES(null);");for(var e=0;e<L.maxAttributes;++e){var q=c.def(k.attributes,"[",e,"]"),t=a.cond(q,".buffer");t.then(l,".enableVertexAttribArray(",e,");",l,".bindBuffer(",34962,",",q,".buffer.buffer);",l,".vertexAttribPointer(",e,",",q,".size,",q,".type,",q,".normalized,",q,".stride,",q,".offset);")["else"](l,
".disableVertexAttribArray(",e,");",l,".vertexAttrib4f(",e,",",q,".x,",q,".y,",q,".z,",q,".w);",q,".buffer=null;");c(t);Q&&c(m,".vertexAttribDivisorANGLE(",e,",",q,".divisor);")}c(a.shared.vao,".currentVAO=null;",a.shared.vao,".setVAO(",a.shared.vao,".targetVAO);");x(y).forEach(function(k){var m=y[k],e=f.def(g,".",k),q=a.block();q("if(",e,"){",l,".enable(",m,")}else{",l,".disable(",m,")}",h,".",k,"=",e,";");c(q);b("if(",e,"!==",h,".",k,"){",q,"}")});x(ja).forEach(function(k){var y=ja[k],m=G[k],e,
q,t=a.block();t(l,".",y,"(");u(m)?(y=m.length,e=a.global.def(g,".",k),q=a.global.def(h,".",k),t(da(y,function(a){return e+"["+a+"]"}),");",da(y,function(a){return q+"["+a+"]="+e+"["+a+"];"}).join("")),b("if(",da(y,function(a){return e+"["+a+"]!=="+q+"["+a+"]"}).join("||"),"){",t,"}")):(e=f.def(g,".",k),q=f.def(h,".",k),t(e,");",h,".",k,"=",e,";"),b("if(",e,"!==",q,"){",t,"}"));c(t)});return a.compile()}(),compile:function(a,b,c,f,k){var y=z();y.stats=y.link(k);x(b["static"]).forEach(function(a){w(y,
b,a)});ca.forEach(function(b){w(y,a,b)});var l=Ha(a,b,c,f,y);ka(y,l);Zc(y,l);nc(y,l);return v(y.compile(),{destroy:function(){l.shader.program.destroy()}})}}}},{"./constants/dtypes.json":5,"./constants/primitives.json":6,"./dynamic":9,"./util/check":21,"./util/codegen":23,"./util/extend":25,"./util/is-array-like":27,"./util/is-ndarray":28,"./util/is-typed-array":30,"./util/loop":31,"./util/sorted-object-keys":34}],9:[function(z,aa,jc){function d(g,c){this.id=b++;this.type=g;this.data=c}function ba(b){if(0===
b.length)return[];var c=b.charAt(0),g=b.charAt(b.length-1);if(1<b.length&&c===g&&('"'===c||"'"===c))return['"'+b.substr(1,b.length-2).replace(/\\/g,"\\\\").replace(/"/g,'\\"')+'"'];if(c=/\[(false|true|null|\d+|'[^']*'|"[^"]*")\]/.exec(b))return ba(b.substr(0,c.index)).concat(ba(c[1])).concat(ba(b.substr(c.index+c[0].length)));c=b.split(".");if(1===c.length)return['"'+b.replace(/\\/g,"\\\\").replace(/"/g,'\\"')+'"'];b=[];for(g=0;g<c.length;++g)b=b.concat(ba(c[g]));return b}function r(b){return"["+
ba(b).join("][")+"]"}function N(b,c){if("function"===typeof b)return new d(0,b);if("number"===typeof b||"boolean"===typeof b)return new d(5,b);if(Array.isArray(b))return new d(6,b.map(function(b,g){return N(b,c+"["+g+"]")}));if(b instanceof d)return b;g(!1,"invalid option type in uniform "+c)}var g=z("./util/check"),b=0;aa.exports={DynamicVariable:d,define:function(b,c){return new d(b,r(c+""))},isDynamic:function(b){return"function"===typeof b&&!b._reglType||b instanceof d},unbox:N,accessor:r}},{"./util/check":21}],
10:[function(z,aa,jc){var d=z("./util/check"),ba=z("./util/is-typed-array"),r=z("./util/is-ndarray"),N=z("./util/values"),g=z("./constants/primitives.json"),b=z("./constants/usage.json");aa.exports=function(x,c,v,na){function da(b){this.id=A++;u[this.id]=this;this.buffer=b;this.primType=4;this.type=this.vertCount=0}function K(b,g,n,u,e,h,f){b.buffer.bind();var D;g?((D=f)||ba(g)&&(!r(g)||ba(g.data))||(D=c.oes_element_index_uint?5125:5123),v._initBuffer(b.buffer,g,n,D,3)):(x.bufferData(34963,h,n),b.buffer.dtype=
D||5121,b.buffer.usage=n,b.buffer.dimension=3,b.buffer.byteLength=h);D=f;if(!f){switch(b.buffer.dtype){case 5121:case 5120:D=5121;break;case 5123:case 5122:D=5123;break;case 5125:case 5124:D=5125;break;default:d.raise("unsupported type for element array")}b.buffer.dtype=D}b.type=D;d(5125!==D||!!c.oes_element_index_uint,"32 bit element buffers not supported, enable oes_element_index_uint first");g=e;0>g&&(g=b.buffer.byteLength,5123===D?g>>=1:5125===D&&(g>>=2));b.vertCount=g;g=u;0>u&&(g=4,u=b.buffer.dimension,
1===u&&(g=0),2===u&&(g=1),3===u&&(g=4));b.primType=g}function E(b){na.elementsCount--;d(null!==b.buffer,"must not double destroy elements");delete u[b.id];b.buffer.destroy();b.buffer=null}var u={},A=0,H={uint8:5121,uint16:5123};c.oes_element_index_uint&&(H.uint32=5125);da.prototype.bind=function(){this.buffer.bind()};var n=[];return{create:function(c,n){function u(c){if(c)if("number"===typeof c)x(c),e.primType=4,e.vertCount=c|0,e.type=5121;else{var f=null,n=35044,v=-1,A=-1,q=0,F=0;if(Array.isArray(c)||
ba(c)||r(c))f=c;else if(d.type(c,"object","invalid arguments for elements"),"data"in c&&(f=c.data,d(Array.isArray(f)||ba(f)||r(f),"invalid data for element buffer")),"usage"in c&&(d.parameter(c.usage,b,"invalid element buffer usage"),n=b[c.usage]),"primitive"in c&&(d.parameter(c.primitive,g,"invalid element buffer primitive"),v=g[c.primitive]),"count"in c&&(d("number"===typeof c.count&&0<=c.count,"invalid vertex count for elements"),A=c.count|0),"type"in c&&(d.parameter(c.type,H,"invalid buffer type"),
F=H[c.type]),"length"in c)q=c.length|0;else if(q=A,5123===F||5122===F)q*=2;else if(5125===F||5124===F)q*=4;K(e,f,n,v,A,q,F)}else x(),e.primType=4,e.vertCount=0,e.type=5121;return u}var x=v.create(null,34963,!0),e=new da(x._buffer);na.elementsCount++;u(c);u._reglType="elements";u._elements=e;u.subdata=function(b,c){x.subdata(b,c);return u};u.destroy=function(){E(e)};return u},createStream:function(b){var c=n.pop();c||(c=new da(v.create(null,34963,!0,!1)._buffer));K(c,b,35040,-1,-1,0,0);return c},destroyStream:function(b){n.push(b)},
getElements:function(b){return"function"===typeof b&&b._elements instanceof da?b._elements:null},clear:function(){N(u).forEach(E)}}}},{"./constants/primitives.json":6,"./constants/usage.json":7,"./util/check":21,"./util/is-ndarray":28,"./util/is-typed-array":30,"./util/values":36}],11:[function(z,aa,jc){var d=z("./util/sorted-object-keys"),ba=z("./util/check");aa.exports=function(r,N){function g(c){ba.type(c,"string","extension name must be string");c=c.toLowerCase();var g;try{g=b[c]=r.getExtension(c)}catch(d){}return!!g}
for(var b={},x=0;x<N.extensions.length;++x){var c=N.extensions[x];if(!g(c))return N.onDestroy(),N.onDone('"'+c+'" extension is not supported by the current WebGL context, try upgrading your system or a different browser'),null}N.optionalExtensions.forEach(g);return{extensions:b,restore:function(){d(b).forEach(function(c){if(b[c]&&!g(c))throw Error("(regl): error restoring extension "+c);})}}}},{"./util/check":21,"./util/sorted-object-keys":34}],12:[function(z,aa,jc){var d=z("./util/check"),ba=z("./util/values"),
r=z("./util/extend"),N=[6407,6408],g=[];g[6408]=4;g[6407]=3;var b=[];b[5121]=1;b[5126]=4;b[36193]=2;var x=[32854,32855,36194,35907,34842,34843,34836],c={36053:"complete",36054:"incomplete attachment",36057:"incomplete dimensions",36055:"incomplete, missing attachment",36061:"unsupported"};aa.exports=function(v,na,da,K,E,u){function A(a,b,c){this.target=a;this.texture=b;this.renderbuffer=c;var f=a=0;b?(a=b.width,f=b.height):c&&(a=c.width,f=c.height);this.width=a;this.height=f}function H(a){a&&(a.texture&&
a.texture._texture.decRef(),a.renderbuffer&&a.renderbuffer._renderbuffer.decRef())}function n(a,b,c){if(a){if(a.texture){a=a.texture._texture;var f=Math.max(1,a.height);d(Math.max(1,a.width)===b&&f===c,"inconsistent width/height for supplied texture")}else a=a.renderbuffer._renderbuffer,d(a.width===b&&a.height===c,"inconsistent width/height for renderbuffer");a.refCount+=1}}function F(a,b){b&&(b.texture?v.framebufferTexture2D(36160,a,b.target,b.texture._texture.texture,0):v.framebufferRenderbuffer(36160,
a,36161,b.renderbuffer._renderbuffer.renderbuffer))}function ca(a){var b=3553,c=null,f=null,l=a;"object"===typeof a&&(l=a.data,"target"in a&&(b=a.target|0));d.type(l,"function","invalid attachment data");a=l._reglType;"texture2d"===a?(c=l,d(3553===b)):"textureCube"===a?(c=l,d(34069<=b&&34075>b,"invalid cube map target")):"renderbuffer"===a?(f=l,b=36161):d.raise("invalid regl object for attachment");return new A(b,c,f)}function I(a,b,c,f,l){if(c)return a=K.create2D({width:a,height:b,format:f,type:l}),
a._texture.refCount=0,new A(3553,a,null);a=E.create({width:a,height:b,format:f});a._renderbuffer.refCount=0;return new A(36161,null,a)}function z(a){return a&&(a.texture||a.renderbuffer)}function e(a,b,c){a&&(a.texture?a.texture.resize(b,c):a.renderbuffer&&a.renderbuffer.resize(b,c),a.width=b,a.height=c)}function h(){this.id=a++;l[this.id]=this;this.framebuffer=v.createFramebuffer();this.height=this.width=0;this.colorAttachments=[];this.depthStencilAttachment=this.stencilAttachment=this.depthAttachment=
null}function f(a){a.colorAttachments.forEach(H);H(a.depthAttachment);H(a.stencilAttachment);H(a.depthStencilAttachment)}function D(a){var b=a.framebuffer;d(b,"must not double destroy framebuffer");v.deleteFramebuffer(b);a.framebuffer=null;u.framebufferCount--;delete l[a.id]}function T(a){var b;v.bindFramebuffer(36160,a.framebuffer);var f=a.colorAttachments;for(b=0;b<f.length;++b)F(36064+b,f[b]);for(b=f.length;b<da.maxColorAttachments;++b)v.framebufferTexture2D(36160,36064+b,3553,null,0);v.framebufferTexture2D(36160,
33306,3553,null,0);v.framebufferTexture2D(36160,36096,3553,null,0);v.framebufferTexture2D(36160,36128,3553,null,0);F(36096,a.depthAttachment);F(36128,a.stencilAttachment);F(33306,a.depthStencilAttachment);a=v.checkFramebufferStatus(36160);v.isContextLost()||36053===a||d.raise("framebuffer configuration not supported, status = "+c[a]);v.bindFramebuffer(36160,q.next?q.next.framebuffer:null);q.cur=q.next;v.getError()}function V(a,c){function l(a,c){var e;d(q.next!==v,"can not update framebuffer which is currently in use");
var h=0,D=0,u=!0,r=!0;e=null;var K=!0,A="rgba",E="uint8",F=1,ba=null,t=null,H=null,X=!1;if("number"===typeof a)h=a|0,D=c|0||h;else if(a){d.type(a,"object","invalid arguments for framebuffer");"shape"in a?(D=a.shape,d(Array.isArray(D)&&2<=D.length,"invalid shape for framebuffer"),h=D[0],D=D[1]):("radius"in a&&(h=D=a.radius),"width"in a&&(h=a.width),"height"in a&&(D=a.height));if("color"in a||"colors"in a)e=a.color||a.colors,Array.isArray(e)&&d(1===e.length||na.webgl_draw_buffers,"multiple render targets not supported");
if(!e){"colorCount"in a&&(F=a.colorCount|0,d(0<F,"invalid color buffer count"));"colorTexture"in a&&(K=!!a.colorTexture,A="rgba4");if("colorType"in a){E=a.colorType;if(K)d(na.oes_texture_float||!("float"===E||"float32"===E),"you must enable OES_texture_float in order to use floating point framebuffer objects"),d(na.oes_texture_half_float||!("half float"===E||"float16"===E),"you must enable OES_texture_half_float in order to use 16-bit floating point framebuffer objects");else if("half float"===E||
"float16"===E)d(na.ext_color_buffer_half_float,"you must enable EXT_color_buffer_half_float to use 16-bit render buffers"),A="rgba16f";else if("float"===E||"float32"===E)d(na.webgl_color_buffer_float,"you must enable WEBGL_color_buffer_float in order to use 32-bit floating point renderbuffers"),A="rgba32f";d.oneOf(E,ga,"invalid color type")}"colorFormat"in a&&(A=a.colorFormat,0<=qa.indexOf(A)?K=!0:0<=L.indexOf(A)?K=!1:d.optional(function(){if(K)d.oneOf(a.colorFormat,qa,"invalid color format for texture");
else d.oneOf(a.colorFormat,L,"invalid color format for renderbuffer")}))}if("depthTexture"in a||"depthStencilTexture"in a)X=!(!a.depthTexture&&!a.depthStencilTexture),d(!X||na.webgl_depth_texture,"webgl_depth_texture extension not supported");"depth"in a&&("boolean"===typeof a.depth?u=a.depth:(ba=a.depth,r=!1));"stencil"in a&&("boolean"===typeof a.stencil?r=a.stencil:(t=a.stencil,u=!1));"depthStencil"in a&&("boolean"===typeof a.depthStencil?u=r=a.depthStencil:(H=a.depthStencil,r=u=!1))}else h=D=1;
var V=null,ma=null,Hb=null,Ha=null;if(Array.isArray(e))V=e.map(ca);else if(e)V=[ca(e)];else for(V=Array(F),e=0;e<F;++e)V[e]=I(h,D,K,A,E);d(na.webgl_draw_buffers||1>=V.length,"you must enable the WEBGL_draw_buffers extension in order to use multiple color buffers.");d(V.length<=da.maxColorAttachments,"too many color attachments, not supported");h=h||V[0].width;D=D||V[0].height;ba?ma=ca(ba):u&&!r&&(ma=I(h,D,X,"depth","uint32"));t?Hb=ca(t):r&&!u&&(Hb=I(h,D,!1,"stencil","uint8"));H?Ha=ca(H):!ba&&!t&&
r&&u&&(Ha=I(h,D,X,"depth stencil","depth stencil"));d(1>=!!ba+!!t+!!H,"invalid framebuffer configuration, can specify exactly one depth/stencil attachment");u=null;for(e=0;e<V.length;++e)n(V[e],h,D),d(!V[e]||V[e].texture&&0<=N.indexOf(V[e].texture._texture.format)||V[e].renderbuffer&&0<=x.indexOf(V[e].renderbuffer._renderbuffer.format),"framebuffer color attachment "+e+" is invalid"),V[e]&&V[e].texture&&(r=g[V[e].texture._texture.format]*b[V[e].texture._texture.type],null===u?u=r:d(u===r,"all color attachments much have the same number of bits per pixel."));
n(ma,h,D);d(!ma||ma.texture&&6402===ma.texture._texture.format||ma.renderbuffer&&33189===ma.renderbuffer._renderbuffer.format,"invalid depth attachment for framebuffer object");n(Hb,h,D);d(!Hb||Hb.renderbuffer&&36168===Hb.renderbuffer._renderbuffer.format,"invalid stencil attachment for framebuffer object");n(Ha,h,D);d(!Ha||Ha.texture&&34041===Ha.texture._texture.format||Ha.renderbuffer&&34041===Ha.renderbuffer._renderbuffer.format,"invalid depth-stencil attachment for framebuffer object");f(v);v.width=
h;v.height=D;v.colorAttachments=V;v.depthAttachment=ma;v.stencilAttachment=Hb;v.depthStencilAttachment=Ha;l.color=V.map(z);l.depth=z(ma);l.stencil=z(Hb);l.depthStencil=z(Ha);l.width=v.width;l.height=v.height;T(v);return l}var v=new h;u.framebufferCount++;l(a,c);return r(l,{resize:function(a,b){d(q.next!==v,"can not resize a framebuffer which is currently in use");var c=Math.max(a|0,1),f=Math.max(b|0||c,1);if(c===v.width&&f===v.height)return l;for(var g=v.colorAttachments,h=0;h<g.length;++h)e(g[h],
c,f);e(v.depthAttachment,c,f);e(v.stencilAttachment,c,f);e(v.depthStencilAttachment,c,f);v.width=l.width=c;v.height=l.height=f;T(v);return l},_reglType:"framebuffer",_framebuffer:v,destroy:function(){D(v);f(v)},use:function(a){q.setFBO({framebuffer:l},a)}})}var q={cur:null,next:null,dirty:!1,setFBO:null},qa=["rgba"],L=["rgba4","rgb565","rgb5 a1"];na.ext_srgb&&L.push("srgba");na.ext_color_buffer_half_float&&L.push("rgba16f","rgb16f");na.webgl_color_buffer_float&&L.push("rgba32f");var ga=["uint8"];
na.oes_texture_half_float&&ga.push("half float","float16");na.oes_texture_float&&ga.push("float","float32");var a=0,l={};return r(q,{getFramebuffer:function(a){return"function"===typeof a&&"framebuffer"===a._reglType&&(a=a._framebuffer,a instanceof h)?a:null},create:V,createCube:function(a){function b(a){var f;d(0>c.indexOf(q.next),"can not update framebuffer which is currently in use");var l={color:null},g=0,e=null;f="rgba";var h="uint8",n=1;if("number"===typeof a)g=a|0;else if(a){d.type(a,"object",
"invalid arguments for framebuffer");"shape"in a?(g=a.shape,d(Array.isArray(g)&&2<=g.length,"invalid shape for framebuffer"),d(g[0]===g[1],"cube framebuffer must be square"),g=g[0]):("radius"in a&&(g=a.radius|0),"width"in a?(g=a.width|0,"height"in a&&d(a.height===g,"must be square")):"height"in a&&(g=a.height|0));if("color"in a||"colors"in a)e=a.color||a.colors,Array.isArray(e)&&d(1===e.length||na.webgl_draw_buffers,"multiple render targets not supported");e||("colorCount"in a&&(n=a.colorCount|0,
d(0<n,"invalid color buffer count")),"colorType"in a&&(d.oneOf(a.colorType,ga,"invalid color type"),h=a.colorType),"colorFormat"in a&&(f=a.colorFormat,d.oneOf(a.colorFormat,qa,"invalid color format for texture")));"depth"in a&&(l.depth=a.depth);"stencil"in a&&(l.stencil=a.stencil);"depthStencil"in a&&(l.depthStencil=a.depthStencil)}else g=1;if(e)if(Array.isArray(e))for(a=[],f=0;f<e.length;++f)a[f]=e[f];else a=[e];else for(a=Array(n),e={radius:g,format:f,type:h},f=0;f<n;++f)a[f]=K.createCube(e);l.color=
Array(a.length);for(f=0;f<a.length;++f)n=a[f],d("function"===typeof n&&"textureCube"===n._reglType,"invalid cube map"),g=g||n.width,d(n.width===g&&n.height===g,"invalid cube map shape"),l.color[f]={target:34069,data:a[f]};for(f=0;6>f;++f){for(n=0;n<a.length;++n)l.color[n].target=34069+f;0<f&&(l.depth=c[0].depth,l.stencil=c[0].stencil,l.depthStencil=c[0].depthStencil);if(c[f])c[f](l);else c[f]=V(l)}return r(b,{width:g,height:g,color:a})}var c=Array(6);b(a);return r(b,{faces:c,resize:function(a){var f=
a|0;d(0<f&&f<=da.maxCubeMapSize,"invalid radius for cube fbo");if(f===b.width)return b;var l=b.color;for(a=0;a<l.length;++a)l[a].resize(f);for(a=0;6>a;++a)c[a].resize(f);b.width=b.height=f;return b},_reglType:"framebufferCube",destroy:function(){c.forEach(function(a){a.destroy()})}})},clear:function(){ba(l).forEach(D)},restore:function(){q.cur=null;q.next=null;q.dirty=!0;ba(l).forEach(function(a){a.framebuffer=v.createFramebuffer();T(a)})}})}},{"./util/check":21,"./util/extend":25,"./util/values":36}],
13:[function(z,aa,jc){var d=z("./util/sorted-object-keys"),ba=z("./util/pool");aa.exports=function(r,N){var g=1;N.ext_texture_filter_anisotropic&&(g=r.getParameter(34047));var b=1,x=1;N.webgl_draw_buffers&&(b=r.getParameter(34852),x=r.getParameter(36063));var c=!!N.oes_texture_float;if(c){c=r.createTexture();r.bindTexture(3553,c);r.texImage2D(3553,0,6408,1,1,0,6408,5126,null);var v=r.createFramebuffer();r.bindFramebuffer(36160,v);r.framebufferTexture2D(36160,36064,3553,c,0);r.bindTexture(3553,null);
if(36053!==r.checkFramebufferStatus(36160))c=!1;else{r.viewport(0,0,1,1);r.clearColor(1,0,0,1);r.clear(16384);var na=ba.allocType(5126,4);r.readPixels(0,0,1,1,6408,5126,na);r.getError()?c=!1:(r.deleteFramebuffer(v),r.deleteTexture(c),c=1===na[0]);ba.freeType(na)}}na=!0;"undefined"!==typeof navigator&&(/MSIE/.test(navigator.userAgent)||/Trident\//.test(navigator.appVersion)||/Edge/.test(navigator.userAgent))||(na=r.createTexture(),v=ba.allocType(5121,36),r.activeTexture(33984),r.bindTexture(34067,
na),r.texImage2D(34069,0,6408,3,3,0,6408,5121,v),ba.freeType(v),r.bindTexture(34067,null),r.deleteTexture(na),na=!r.getError());return{colorBits:[r.getParameter(3410),r.getParameter(3411),r.getParameter(3412),r.getParameter(3413)],depthBits:r.getParameter(3414),stencilBits:r.getParameter(3415),subpixelBits:r.getParameter(3408),extensions:d(N).filter(function(b){return!!N[b]}),maxAnisotropic:g,maxDrawbuffers:b,maxColorAttachments:x,pointSizeDims:r.getParameter(33901),lineWidthDims:r.getParameter(33902),
...
version:r.getParameter(7938),readFloat:c,npotTextureCube:na}}},{"./util/pool":32,"./util/sorted-object-keys":34}],14:[function(z,aa,jc){var d=z("./util/check"),ba=z("./util/is-typed-array");aa.exports=function(r,N,g,b,x,c,v){function na(K){var E;null===N.next?(d(x.preserveDrawingBuffer,'you must create a webgl context with "preserveDrawingBuffer":true in order to read pixels from the drawing buffer'),E=5121):(d(null!==N.next.colorAttachments[0].texture,"You cannot read from a renderbuffer"),E=N.next.colorAttachments[0].texture._texture.type,
d.optional(function(){c.oes_texture_float?(d(5121===E||5126===E,"Reading from a framebuffer is only allowed for the types 'uint8' and 'float'"),5126===E&&d(v.readFloat,"Reading 'float' values is not permitted in your browser. For a fallback, please see: https://www.npmjs.com/package/glsl-read-float")):d(5121===E,"Reading from a framebuffer is only allowed for the type 'uint8'")}));var u=0,A=0,H=b.framebufferWidth,n=b.framebufferHeight,F=null;ba(K)?F=K:K&&(d.type(K,"object","invalid arguments to regl.read()"),
u=K.x|0,A=K.y|0,d(0<=u&&u<b.framebufferWidth,"invalid x offset for regl.read"),d(0<=A&&A<b.framebufferHeight,"invalid y offset for regl.read"),H=(K.width||b.framebufferWidth-u)|0,n=(K.height||b.framebufferHeight-A)|0,F=K.data||null);F&&(5121===E?d(F instanceof Uint8Array,"buffer must be 'Uint8Array' when reading from a framebuffer of type 'uint8'"):5126===E&&d(F instanceof Float32Array,"buffer must be 'Float32Array' when reading from a framebuffer of type 'float'"));d(0<H&&H+u<=b.framebufferWidth,
"invalid width for read pixels");d(0<n&&n+A<=b.framebufferHeight,"invalid height for read pixels");g();K=H*n*4;F||(5121===E?F=new Uint8Array(K):5126===E&&(F=F||new Float32Array(K)));d.isTypedArray(F,"data buffer for regl.read() must be a typedarray");d(F.byteLength>=K,"data buffer for regl.read() too small");r.pixelStorei(3333,4);r.readPixels(u,A,H,n,6408,E,F);return F}function da(b){var c;N.setFBO({framebuffer:b.framebuffer},function(){c=na(b)});return c}return function(b){return b&&"framebuffer"in
b?da(b):na(b)}}},{"./util/check":21,"./util/is-typed-array":30}],15:[function(z,aa,jc){var d=z("./util/sorted-object-keys"),ba=z("./util/check"),r=z("./util/values"),N=[];N[32854]=2;N[32855]=2;N[36194]=2;N[33189]=2;N[36168]=1;N[34041]=4;N[35907]=4;N[34836]=16;N[34842]=8;N[34843]=6;aa.exports=function(g,b,x,c,v){function na(b){this.id=u++;this.refCount=1;this.renderbuffer=b;this.format=32854;this.height=this.width=0;v.profile&&(this.stats={size:0})}function da(b){var n=b.renderbuffer;ba(n,"must not double destroy renderbuffer");
g.bindRenderbuffer(36161,null);g.deleteRenderbuffer(n);b.renderbuffer=null;b.refCount=0;delete A[b.id];c.renderbufferCount--}var K={rgba4:32854,rgb565:36194,"rgb5 a1":32855,depth:33189,stencil:36168,"depth stencil":34041};b.ext_srgb&&(K.srgba=35907);b.ext_color_buffer_half_float&&(K.rgba16f=34842,K.rgb16f=34843);b.webgl_color_buffer_float&&(K.rgba32f=34836);var E=[];d(K).forEach(function(b){E[K[b]]=b});var u=0,A={};na.prototype.decRef=function(){0>=--this.refCount&&da(this)};v.profile&&(c.getTotalRenderbufferSize=
function(){var b=0;d(A).forEach(function(c){b+=A[c].stats.size});return b});return{create:function(b,n){function d(b,c){var e=0,h=0,f=32854;"object"===typeof b&&b?("shape"in b?(h=b.shape,ba(Array.isArray(h)&&2<=h.length,"invalid renderbuffer shape"),e=h[0]|0,h=h[1]|0):("radius"in b&&(e=h=b.radius|0),"width"in b&&(e=b.width|0),"height"in b&&(h=b.height|0)),"format"in b&&(ba.parameter(b.format,K,"invalid renderbuffer format"),f=K[b.format])):"number"===typeof b?(e=b|0,h="number"===typeof c?c|0:e):b?
ba.raise("invalid arguments to renderbuffer constructor"):e=h=1;ba(0<e&&0<h&&e<=x.maxRenderbufferSize&&h<=x.maxRenderbufferSize,"invalid renderbuffer size");if(e!==u.width||h!==u.height||f!==u.format)return d.width=u.width=e,d.height=u.height=h,u.format=f,g.bindRenderbuffer(36161,u.renderbuffer),g.renderbufferStorage(36161,f,e,h),ba(0===g.getError(),"invalid render buffer format"),v.profile&&(u.stats.size=N[u.format]*u.width*u.height),d.format=E[u.format],d}var u=new na(g.createRenderbuffer());A[u.id]=
u;c.renderbufferCount++;d(b,n);d.resize=function(b,c){var e=b|0,h=c|0||e;if(e===u.width&&h===u.height)return d;ba(0<e&&0<h&&e<=x.maxRenderbufferSize&&h<=x.maxRenderbufferSize,"invalid renderbuffer size");d.width=u.width=e;d.height=u.height=h;g.bindRenderbuffer(36161,u.renderbuffer);g.renderbufferStorage(36161,u.format,e,h);ba(0===g.getError(),"invalid render buffer format");v.profile&&(u.stats.size=N[u.format]*u.width*u.height);return d};d._reglType="renderbuffer";d._renderbuffer=u;v.profile&&(d.stats=
u.stats);d.destroy=function(){u.decRef()};return d},clear:function(){r(A).forEach(da)},restore:function(){r(A).forEach(function(b){b.renderbuffer=g.createRenderbuffer();g.bindRenderbuffer(36161,b.renderbuffer);g.renderbufferStorage(36161,b.format,b.width,b.height)});g.bindRenderbuffer(36161,null)}}}},{"./util/check":21,"./util/sorted-object-keys":34,"./util/values":36}],16:[function(z,aa,jc){var d=z("./util/sorted-object-keys"),ba=z("./util/check"),r=z("./util/extend"),N=z("./util/values");aa.exports=
function(g,b,x,c){function v(b,c,g,e){this.name=b;this.id=c;this.location=g;this.info=e}function na(b,c){for(var g=0;g<b.length;++g)if(b[g].id===c.id){b[g].location=c.location;return}b.push(c)}function da(c,n,d){var e=35632===c?u:A,h=e[n];if(!h){var f=b.str(n),h=g.createShader(c);g.shaderSource(h,f);g.compileShader(h);ba.shaderError(g,h,f,c,d);e[n]=h}return h}function K(b,g){this.id=F++;this.fragId=b;this.vertId=g;this.program=null;this.uniforms=[];this.attributes=[];this.refCount=1;c.profile&&(this.stats=
{uniformsCount:0,attributesCount:0})}function E(n,d,u){var e;e=da(35632,n.fragId);var h=da(35633,n.vertId),f=n.program=g.createProgram();g.attachShader(f,e);g.attachShader(f,h);if(u)for(e=0;e<u.length;++e)h=u[e],g.bindAttribLocation(f,h[0],h[1]);g.linkProgram(f);ba.linkError(g,f,b.str(n.fragId),b.str(n.vertId),d);u=g.getProgramParameter(f,35718);c.profile&&(n.stats.uniformsCount=u);h=n.uniforms;for(e=0;e<u;++e)if(d=g.getActiveUniform(f,e))if(1<d.size)for(var D=0;D<d.size;++D){var x=d.name.replace("[0]",
"["+D+"]");na(h,new v(x,b.id(x),g.getUniformLocation(f,x),d))}else na(h,new v(d.name,b.id(d.name),g.getUniformLocation(f,d.name),d));u=g.getProgramParameter(f,35721);c.profile&&(n.stats.attributesCount=u);n=n.attributes;for(e=0;e<u;++e)(d=g.getActiveAttrib(f,e))&&na(n,new v(d.name,b.id(d.name),g.getAttribLocation(f,d.name),d))}var u={},A={},H={},n=[],F=0;c.profile&&(x.getMaxUniformsCount=function(){var b=0;n.forEach(function(c){c.stats.uniformsCount>b&&(b=c.stats.uniformsCount)});return b},x.getMaxAttributesCount=
function(){var b=0;n.forEach(function(c){c.stats.attributesCount>b&&(b=c.stats.attributesCount)});return b});return{clear:function(){var b=g.deleteShader.bind(g);N(u).forEach(b);u={};N(A).forEach(b);A={};n.forEach(function(b){g.deleteProgram(b.program)});n.length=0;H={};x.shaderCount=0},program:function(b,c,v,e){ba.command(0<=b,"missing vertex shader",v);ba.command(0<=c,"missing fragment shader",v);var h=H[c];h||(h=H[c]={});var f=h[b];if(f&&(f.refCount++,!e))return f;var D=new K(c,b);x.shaderCount++;
E(D,v,e);f||(h[b]=D);n.push(D);return r(D,{destroy:function(){D.refCount--;if(0>=D.refCount){g.deleteProgram(D.program);var b=n.indexOf(D);n.splice(b,1);x.shaderCount--}0>=h[D.vertId].refCount&&(g.deleteShader(A[D.vertId]),delete A[D.vertId],delete H[D.fragId][D.vertId]);d(H[D.fragId]).length||(g.deleteShader(u[D.fragId]),delete u[D.fragId],delete H[D.fragId])}})},restore:function(){u={};A={};for(var b=0;b<n.length;++b)E(n[b],null,n[b].attributes.map(function(b){return[b.location,b.name]}))},shader:da,
frag:-1,vert:-1}}},{"./util/check":21,"./util/extend":25,"./util/sorted-object-keys":34,"./util/values":36}],17:[function(z,aa,jc){aa.exports=function(){return{vaoCount:0,bufferCount:0,elementsCount:0,framebufferCount:0,shaderCount:0,textureCount:0,cubeCount:0,renderbufferCount:0,maxTextureUnits:0}}},{}],18:[function(z,aa,jc){aa.exports=function(){var d={"":0},ba=[""];return{id:function(r){var N=d[r];if(N)return N;N=d[r]=ba.length;ba.push(r);return N},str:function(d){return ba[d]}}}},{}],19:[function(z,
aa,jc){function d(a){return"[object "+a+"]"}function ba(a){return Array.isArray(a)&&(0===a.length||"number"===typeof a[0])}function r(a){return Array.isArray(a)&&0!==a.length&&H(a[0])?!0:!1}function N(a){return Object.prototype.toString.call(a)}function g(a){if(!a)return!1;var b=N(a);return 0<=qa.indexOf(b)?!0:ba(a)||r(a)||E(a)}function b(a,b){36193===a.type?(a.data=A(b),u.freeType(b)):a.data=b}function x(a,b,c,f,g,h){a="undefined"!==typeof ga[a]?ga[a]:e[a]*L[b];h&&(a*=6);if(g){for(f=0;1<=c;)f+=a*
c*c,c/=2;return f}return a*c*f}var c=z("./util/sorted-object-keys"),v=z("./util/check"),na=z("./util/extend"),da=z("./util/values"),K=z("./util/is-typed-array"),E=z("./util/is-ndarray"),u=z("./util/pool"),A=z("./util/to-half-float"),H=z("./util/is-array-like"),n=z("./util/flatten"),F=z("./util/is-pow2");jc=z("./constants/arraytypes.json");var ca=z("./constants/arraytypes.json"),I=[9984,9986,9985,9987],Id=[0,6409,6410,6407,6408],e={};e[6409]=e[6406]=e[6402]=1;e[34041]=e[6410]=2;e[6407]=e[35904]=3;
e[6408]=e[35906]=4;var h=d("HTMLCanvasElement"),f=d("OffscreenCanvas"),D=d("CanvasRenderingContext2D"),T=d("ImageBitmap"),V=d("HTMLImageElement"),q=d("HTMLVideoElement"),qa=c(jc).concat([h,f,D,T,V,q]),L=[];L[5121]=1;L[5126]=4;L[36193]=2;L[5123]=2;L[5125]=4;var ga=[];ga[32854]=2;ga[32855]=2;ga[36194]=2;ga[34041]=4;ga[33776]=.5;ga[33777]=.5;ga[33778]=1;ga[33779]=1;ga[35986]=.5;ga[35987]=1;ga[34798]=1;ga[35840]=.5;ga[35841]=.25;ga[35842]=.5;ga[35843]=.25;ga[36196]=.5;aa.exports=function(a,l,d,L,ga,z,
...
typeof b&&b){"premultiplyAlpha"in b&&(v.type(b.premultiplyAlpha,"boolean","invalid premultiplyAlpha"),a.premultiplyAlpha=b.premultiplyAlpha);"flipY"in b&&(v.type(b.flipY,"boolean","invalid texture flip"),a.flipY=b.flipY);"alignment"in b&&(v.oneOf(b.alignment,[1,2,4,8],"invalid texture unpack alignment"),a.unpackAlignment=b.alignment);"colorSpace"in b&&(v.parameter(b.colorSpace,wc,"invalid colorSpace"),a.colorSpace=wc[b.colorSpace]);if("type"in b){var c=b.type;v(l.oes_texture_float||!("float"===c||
"float32"===c),"you must enable the OES_texture_float extension in order to use floating point textures.");v(l.oes_texture_half_float||!("half float"===c||"float16"===c),"you must enable the OES_texture_half_float extension in order to use 16-bit floating point textures.");v(l.webgl_depth_texture||!("uint16"===c||"uint32"===c||"depth stencil"===c),"you must enable the WEBGL_depth_texture extension in order to use depth/stencil textures.");v.parameter(c,W,"invalid texture type");a.type=W[c]}var f=
a.width,g=a.height,h=a.channels,c=!1;"shape"in b?(v(Array.isArray(b.shape)&&2<=b.shape.length,"shape must be an array"),f=b.shape[0],g=b.shape[1],3===b.shape.length&&(h=b.shape[2],v(0<h&&4>=h,"invalid number of channels"),c=!0),v(0<=f&&f<=d.maxTextureSize,"invalid width"),v(0<=g&&g<=d.maxTextureSize,"invalid height")):("radius"in b&&(f=g=b.radius,v(0<=f&&f<=d.maxTextureSize,"invalid radius")),"width"in b&&(f=b.width,v(0<=f&&f<=d.maxTextureSize,"invalid width")),"height"in b&&(g=b.height,v(0<=g&&g<=
d.maxTextureSize,"invalid height")),"channels"in b&&(h=b.channels,v(0<h&&4>=h,"invalid number of channels"),c=!0));a.width=f|0;a.height=g|0;a.channels=h|0;f=!1;"format"in b&&(f=b.format,v(l.webgl_depth_texture||!("depth"===f||"depth stencil"===f),"you must enable the WEBGL_depth_texture extension in order to use depth/stencil textures."),v.parameter(f,B,"invalid texture format"),g=a.internalformat=B[f],a.format=ua[g],f in W&&!("type"in b)&&(a.type=W[f]),f in ka&&(a.compressed=!0),f=!0);!c&&f?a.channels=
e[a.format]:c&&!f?a.channels!==Id[a.format]&&(a.format=a.internalformat=Id[a.channels]):f&&c&&v(a.channels===e[a.format],"number of channels inconsistent with specified format")}}function O(b){a.pixelStorei(37440,b.flipY);a.pixelStorei(37441,b.premultiplyAlpha);a.pixelStorei(37443,b.colorSpace);a.pixelStorei(3317,b.unpackAlignment)}function M(){oa.call(this);this.yOffset=this.xOffset=0;this.data=null;this.needsFree=!1;this.element=null;this.needsCopy=!1}function R(a,c){var l=null;g(c)?l=c:c&&(v.type(c,
"object","invalid pixel data type"),Y(a,c),"x"in c&&(a.xOffset=c.x|0),"y"in c&&(a.yOffset=c.y|0),g(c.data)&&(l=c.data));v(!a.compressed||l instanceof Uint8Array,"compressed texture data must be stored in a uint8array");if(c.copy){v(!l,"can not specify copy and data field for the same texture");var k=ga.viewportWidth,e=ga.viewportHeight;a.width=a.width||k-a.xOffset;a.height=a.height||e-a.yOffset;a.needsCopy=!0;v(0<=a.xOffset&&a.xOffset<k&&0<=a.yOffset&&a.yOffset<e&&0<a.width&&a.width<=k&&0<a.height&&
a.height<=e,"copy texture read out of bounds")}else if(!l)a.width=a.width||1,a.height=a.height||1,a.channels=a.channels||4;else if(K(l))a.channels=a.channels||4,a.data=l,"type"in c||5121!==a.type||(a.type=ca[Object.prototype.toString.call(l)]|0);else if(ba(l)){a.channels=a.channels||4;k=l;e=k.length;switch(a.type){case 5121:case 5123:case 5125:case 5126:e=u.allocType(a.type,e);e.set(k);a.data=e;break;case 36193:a.data=A(k);break;default:v.raise("unsupported texture type, must specify a typed array")}a.alignment=
1;a.needsFree=!0}else if(E(l)){k=l.data;Array.isArray(k)||5121!==a.type||(a.type=ca[Object.prototype.toString.call(k)]|0);var e=l.shape,m=l.stride,p,t,w,B;3===e.length?(w=e[2],B=m[2]):(v(2===e.length,"invalid ndarray pixel data, must be 2 or 3D"),B=w=1);p=e[0];t=e[1];e=m[0];m=m[1];a.alignment=1;a.width=p;a.height=t;a.channels=w;a.format=a.internalformat=Id[w];a.needsFree=!0;p=B;l=l.offset;w=a.width;B=a.height;t=a.channels;for(var x=u.allocType(36193===a.type?5126:a.type,w*B*t),G=0,Z=0;Z<B;++Z)for(var C=
0;C<w;++C)for(var W=0;W<t;++W)x[G++]=k[e*C+m*Z+p*W+l];b(a,x)}else if(N(l)===h||N(l)===f||N(l)===D)N(l)===h||N(l)===f?a.element=l:a.element=l.canvas,a.width=a.element.width,a.height=a.element.height,a.channels=4;else if(N(l)===T)a.element=l,a.width=l.width,a.height=l.height,a.channels=4;else if(N(l)===V)a.element=l,a.width=l.naturalWidth,a.height=l.naturalHeight,a.channels=4;else if(N(l)===q)a.element=l,a.width=l.videoWidth,a.height=l.videoHeight,a.channels=4;else if(r(l)){k=a.width||l[0].length;e=
a.height||l.length;m=a.channels;m=H(l[0][0])?m||l[0][0].length:m||1;p=n.shape(l);w=1;for(B=0;B<p.length;++B)w*=p[B];w=u.allocType(36193===a.type?5126:a.type,w);n.flatten(l,p,"",w);b(a,w);a.alignment=1;a.width=k;a.height=e;a.channels=m;a.format=a.internalformat=Id[m];a.needsFree=!0}5126===a.type?v(0<=d.extensions.indexOf("oes_texture_float"),"oes_texture_float extension not enabled"):36193===a.type&&v(0<=d.extensions.indexOf("oes_texture_half_float"),"oes_texture_half_float extension not enabled")}
function sa(b,c,f,k,l){var g=b.element,p=b.data,e=b.internalformat,h=b.format,m=b.type,q=b.width,d=b.height;O(b);g?a.texSubImage2D(c,l,f,k,h,m,g):b.compressed?a.compressedTexSubImage2D(c,l,f,k,e,q,d,p):b.needsCopy?(L(),a.copyTexSubImage2D(c,l,f,k,b.xOffset,b.yOffset,q,d)):a.texSubImage2D(c,l,f,k,q,d,h,m,p)}function J(){return Q.pop()||new M}function Ob(a){a.needsFree&&u.freeType(a.data);M.call(a);Q.push(a)}function $a(){oa.call(this);this.genMipmaps=!1;this.mipmapHint=4352;this.mipmask=0;this.images=
Array(16)}function P(a,b,c){var f=a.images[0]=J();a.mipmask=1;f.width=a.width=b;f.height=a.height=c;f.channels=a.channels=4}function t(a,b){var c=null;if(g(b))c=a.images[0]=J(),Qa(c,a),R(c,b),a.mipmask=1;else if(Y(a,b),Array.isArray(b.mipmap))for(var f=b.mipmap,l=0;l<f.length;++l)c=a.images[l]=J(),Qa(c,a),c.width>>=l,c.height>>=l,R(c,f[l]),a.mipmask|=1<<l;else c=a.images[0]=J(),Qa(c,a),R(c,b),a.mipmask=1;Qa(a,a.images[0]);!a.compressed||33776!==a.internalformat&&33777!==a.internalformat&&33778!==
a.internalformat&&33779!==a.internalformat||v(0===a.width%4&&0===a.height%4,"for compressed texture formats, mipmap level 0 must have width and height that are a multiple of 4")}function la(b,c){for(var f=b.images,k=0;k<f.length&&f[k];++k){var l=f[k],g=c,p=k,e=l.element,h=l.data,m=l.internalformat,q=l.format,d=l.type,n=l.width,t=l.height;O(l);e?a.texImage2D(g,p,q,q,d,e):l.compressed?a.compressedTexImage2D(g,p,m,n,t,0,h):l.needsCopy?(L(),a.copyTexImage2D(g,p,q,l.xOffset,l.yOffset,n,t,0)):a.texImage2D(g,
p,q,n,t,0,q,d,h||null)}}function fa(){var a=ha.pop()||new $a;oa.call(a);for(var b=a.mipmask=0;16>b;++b)a.images[b]=null;return a}function Ea(a){for(var b=a.images,c=0;c<b.length;++c)b[c]&&Ob(b[c]),b[c]=null;ha.push(a)}function Na(){this.magFilter=this.minFilter=9728;this.wrapT=this.wrapS=33071;this.anisotropic=1;this.genMipmaps=!1;this.mipmapHint=4352}function Hb(a,b){if("min"in b){var c=b.min;v.parameter(c,td);a.minFilter=td[c];0<=I.indexOf(a.minFilter)&&!("faces"in b)&&(a.genMipmaps=!0)}"mag"in
b&&(c=b.mag,v.parameter(c,Qc),a.magFilter=Qc[c]);var c=a.wrapS,f=a.wrapT;if("wrap"in b){var l=b.wrap;"string"===typeof l?(v.parameter(l,cc),c=f=cc[l]):Array.isArray(l)&&(v.parameter(l[0],cc),v.parameter(l[1],cc),c=cc[l[0]],f=cc[l[1]])}else"wrapS"in b&&(c=b.wrapS,v.parameter(c,cc),c=cc[c]),"wrapT"in b&&(f=b.wrapT,v.parameter(f,cc),f=cc[f]);a.wrapS=c;a.wrapT=f;"anisotropic"in b&&(c=b.anisotropic,v("number"===typeof c&&1<=c&&c<=d.maxAnisotropic,"aniso samples must be between 1 and "),a.anisotropic=b.anisotropic);
if("mipmap"in b){c=!1;switch(typeof b.mipmap){case "string":v.parameter(b.mipmap,bc,"invalid mipmap hint");a.mipmapHint=bc[b.mipmap];c=a.genMipmaps=!0;break;case "boolean":c=a.genMipmaps=b.mipmap;break;case "object":v(Array.isArray(b.mipmap),"invalid mipmap type");a.genMipmaps=!1;c=!0;break;default:v.raise("invalid mipmap type")}!c||"min"in b||(a.minFilter=9984)}}function Ha(b,c){a.texParameteri(c,10241,b.minFilter);a.texParameteri(c,10240,b.magFilter);a.texParameteri(c,10242,b.wrapS);a.texParameteri(c,
10243,b.wrapT);l.ext_texture_filter_anisotropic&&a.texParameteri(c,34046,b.anisotropic);b.genMipmaps&&(a.hint(33170,b.mipmapHint),a.generateMipmap(c))}function U(b){oa.call(this);this.mipmask=0;this.internalformat=6408;this.id=ra++;this.refCount=1;this.target=b;this.texture=a.createTexture();this.unit=-1;this.bindCount=0;this.texInfo=new Na;qa.profile&&(this.stats={size:0})}function ob(b){a.activeTexture(33984);a.bindTexture(b.target,b.texture)}function ea(){var b=Z[0];b?a.bindTexture(b.target,b.texture):
a.bindTexture(3553,null)}function va(b){var c=b.texture;v(c,"must not double destroy texture");var f=b.unit,l=b.target;0<=f&&(a.activeTexture(33984+f),a.bindTexture(l,null),Z[f]=null);a.deleteTexture(c);b.texture=null;b.params=null;b.pixels=null;b.refCount=0;delete G[b.id];z.textureCount--}var bc={"don't care":4352,"dont care":4352,nice:4354,fast:4353},cc={repeat:10497,clamp:33071,mirror:33648},Qc={nearest:9728,linear:9729},td=na({mipmap:9987,"nearest mipmap nearest":9984,"linear mipmap nearest":9985,
...
c(ka).forEach(function(a){var b=ka[a];0<=Ca.indexOf(b)&&(B[a]=b)});var Lb=c(B);d.textureFormats=Lb;var nc=[];c(B).forEach(function(a){nc[B[a]]=a});var Zc=[];c(W).forEach(function(a){Zc[W[a]]=a});var C=[];c(Qc).forEach(function(a){C[Qc[a]]=a});var w=[];c(td).forEach(function(a){w[td[a]]=a});var ia=[];c(cc).forEach(function(a){ia[cc[a]]=a});var ua=Lb.reduce(function(a,b){var c=B[b];6409===c||6406===c||6409===c||6410===c||6402===c||34041===c||l.ext_srgb&&(35904===c||35906===c)?a[c]=c:32855===c||0<=b.indexOf("rgba")?
a[c]=6408:a[c]=6407;return a},{}),Q=[],ha=[],ra=0,G={},m=d.maxTextureUnits,Z=Array(m).map(function(){return null});na(U.prototype,{bind:function(){this.bindCount+=1;var b=this.unit;if(0>b){for(var c=0;c<m;++c){var f=Z[c];if(f){if(0<f.bindCount)continue;f.unit=-1}Z[c]=this;b=c;break}b>=m&&v.raise("insufficient number of texture units");qa.profile&&z.maxTextureUnits<b+1&&(z.maxTextureUnits=b+1);this.unit=b;a.activeTexture(33984+b);a.bindTexture(this.target,this.texture)}return b},unbind:function(){--this.bindCount},
decRef:function(){0>=--this.refCount&&va(this)}});qa.profile&&(z.getTotalTextureSize=function(){var a=0;c(G).forEach(function(b){a+=G[b].stats.size});return a});return{create2D:function(b,c){function f(a,b){var c=l.texInfo;Na.call(c);var g=fa();"number"===typeof a?"number"===typeof b?P(g,a|0,b|0):P(g,a|0,a|0):a?(v.type(a,"object","invalid arguments to regl.texture"),Hb(c,a),t(g,a)):P(g,1,1);c.genMipmaps&&(g.mipmask=(g.width<<1)-1);l.mipmask=g.mipmask;Qa(l,g);v.texture2D(c,g,d);l.internalformat=g.internalformat;
f.width=g.width;f.height=g.height;ob(l);la(g,3553);Ha(c,3553);ea();Ea(g);qa.profile&&(l.stats.size=x(l.internalformat,l.type,g.width,g.height,c.genMipmaps,!1));f.format=nc[l.internalformat];f.type=Zc[l.type];f.mag=C[c.magFilter];f.min=w[c.minFilter];f.wrapS=ia[c.wrapS];f.wrapT=ia[c.wrapT];return f}var l=new U(3553);G[l.id]=l;z.textureCount++;f(b,c);f.subimage=function(a,b,c,g){v(!!a,"must specify image data");b|=0;c|=0;g|=0;var e=J();Qa(e,l);e.width=0;e.height=0;R(e,a);e.width=e.width||(l.width>>
g)-b;e.height=e.height||(l.height>>g)-c;v(l.type===e.type&&l.format===e.format&&l.internalformat===e.internalformat,"incompatible format for texture.subimage");v(0<=b&&0<=c&&b+e.width<=l.width&&c+e.height<=l.height,"texture.subimage write out of bounds");v(l.mipmask&1<<g,"missing mipmap data");v(e.data||e.element||e.needsCopy,"missing image data");ob(l);sa(e,3553,b,c,g);ea();Ob(e);return f};f.resize=function(b,c){var g=b|0,e=c|0||g;if(g===l.width&&e===l.height)return f;f.width=l.width=g;f.height=
l.height=e;ob(l);for(var h=0;l.mipmask>>h;++h){var m=g>>h,q=e>>h;if(!m||!q)break;a.texImage2D(3553,h,l.format,m,q,0,l.format,l.type,null)}ea();qa.profile&&(l.stats.size=x(l.internalformat,l.type,g,e,!1,!1));return f};f._reglType="texture2d";f._texture=l;qa.profile&&(f.stats=l.stats);f.destroy=function(){l.decRef()};return f},createCube:function(b,c,f,l,g,e){function h(a,b,c,f,l,k){var g,e=m.texInfo;Na.call(e);for(g=0;6>g;++g)q[g]=fa();if("number"!==typeof a&&a)if("object"===typeof a)if(b)t(q[0],a),
t(q[1],b),t(q[2],c),t(q[3],f),t(q[4],l),t(q[5],k);else if(Hb(e,a),Y(m,a),"faces"in a)for(a=a.faces,v(Array.isArray(a)&&6===a.length,"cube faces must be a length 6 array"),g=0;6>g;++g)v("object"===typeof a[g]&&!!a[g],"invalid input for cube map face"),Qa(q[g],m),t(q[g],a[g]);else for(g=0;6>g;++g)t(q[g],a);else v.raise("invalid arguments to cube map");else for(a=a|0||1,g=0;6>g;++g)P(q[g],a,a);Qa(m,q[0]);v.optional(function(){d.npotTextureCube||v(F(m.width)&&F(m.height),"your browser does not support non power or two texture dimensions")});
m.mipmask=e.genMipmaps?(q[0].width<<1)-1:q[0].mipmask;v.textureCube(m,e,q,d);m.internalformat=q[0].internalformat;h.width=q[0].width;h.height=q[0].height;ob(m);for(g=0;6>g;++g)la(q[g],34069+g);Ha(e,34067);ea();qa.profile&&(m.stats.size=x(m.internalformat,m.type,h.width,h.height,e.genMipmaps,!0));h.format=nc[m.internalformat];h.type=Zc[m.type];h.mag=C[e.magFilter];h.min=w[e.minFilter];h.wrapS=ia[e.wrapS];h.wrapT=ia[e.wrapT];for(g=0;6>g;++g)Ea(q[g]);return h}var m=new U(34067);G[m.id]=m;z.cubeCount++;
var q=Array(6);h(b,c,f,l,g,e);h.subimage=function(a,b,c,f,l){v(!!b,"must specify image data");v("number"===typeof a&&a===(a|0)&&0<=a&&6>a,"invalid face");c|=0;f|=0;l|=0;var g=J();Qa(g,m);g.width=0;g.height=0;R(g,b);g.width=g.width||(m.width>>l)-c;g.height=g.height||(m.height>>l)-f;v(m.type===g.type&&m.format===g.format&&m.internalformat===g.internalformat,"incompatible format for texture.subimage");v(0<=c&&0<=f&&c+g.width<=m.width&&f+g.height<=m.height,"texture.subimage write out of bounds");v(m.mipmask&
1<<l,"missing mipmap data");v(g.data||g.element||g.needsCopy,"missing image data");ob(m);sa(g,34069+a,c,f,l);ea();Ob(g);return h};h.resize=function(b){b|=0;if(b!==m.width){h.width=m.width=b;h.height=m.height=b;ob(m);for(var c=0;6>c;++c)for(var f=0;m.mipmask>>f;++f)a.texImage2D(34069+c,f,m.format,b>>f,b>>f,0,m.format,m.type,null);ea();qa.profile&&(m.stats.size=x(m.internalformat,m.type,h.width,h.height,!1,!0));return h}};h._reglType="textureCube";h._texture=m;qa.profile&&(h.stats=m.stats);h.destroy=
function(){m.decRef()};return h},clear:function(){for(var b=0;b<m;++b)a.activeTexture(33984+b),a.bindTexture(3553,null),Z[b]=null;da(G).forEach(va);z.cubeCount=0;z.textureCount=0},getTexture:function(a){return null},restore:function(){for(var b=0;b<m;++b){var c=Z[b];c&&(c.bindCount=0,c.unit=-1,Z[b]=null)}da(G).forEach(function(b){b.texture=a.createTexture();a.bindTexture(b.target,b.texture);for(var c=0;32>c;++c)if(0!==(b.mipmask&1<<c))if(3553===b.target)a.texImage2D(3553,c,b.internalformat,b.width>>
c,b.height>>c,0,b.internalformat,b.type,null);else for(var f=0;6>f;++f)a.texImage2D(34069+f,c,b.internalformat,b.width>>c,b.height>>c,0,b.internalformat,b.type,null);Ha(b.texInfo,b.target)})},refresh:function(){for(var b=0;b<m;++b){var c=Z[b];c&&(c.bindCount=0,c.unit=-1,Z[b]=null);a.activeTexture(33984+b);a.bindTexture(3553,null);a.bindTexture(34067,null)}}}}},{"./constants/arraytypes.json":4,"./util/check":21,"./util/extend":25,"./util/flatten":26,"./util/is-array-like":27,"./util/is-ndarray":28,
"./util/is-pow2":29,"./util/is-typed-array":30,"./util/pool":32,"./util/sorted-object-keys":34,"./util/to-half-float":35,"./util/values":36}],20:[function(z,aa,jc){aa.exports=function(d,ba){function r(){this.endQueryIndex=this.startQueryIndex=-1;this.sum=0;this.stats=null}function N(b,g,d){var u=x.pop()||new r;u.startQueryIndex=b;u.endQueryIndex=g;u.sum=0;u.stats=d;c.push(u)}if(!ba.ext_disjoint_timer_query)return null;var g=[],b=[],x=[],c=[],v=[],na=[];return{beginQuery:function(c){var d=g.pop()||
ba.ext_disjoint_timer_query.createQueryEXT();ba.ext_disjoint_timer_query.beginQueryEXT(35007,d);b.push(d);N(b.length-1,b.length,c)},endQuery:function(){ba.ext_disjoint_timer_query.endQueryEXT(35007)},pushScopeStats:N,update:function(){var d,r;d=b.length;if(0!==d){na.length=Math.max(na.length,d+1);v.length=Math.max(v.length,d+1);v[0]=0;var E=na[0]=0;for(r=d=0;r<b.length;++r){var u=b[r];ba.ext_disjoint_timer_query.getQueryObjectEXT(u,34919)?(E+=ba.ext_disjoint_timer_query.getQueryObjectEXT(u,34918),
g.push(u)):b[d++]=u;v[r+1]=E;na[r+1]=d}b.length=d;for(r=d=0;r<c.length;++r){var E=c[r],A=E.startQueryIndex,u=E.endQueryIndex;E.sum+=v[u]-v[A];A=na[A];u=na[u];u===A?(E.stats.gpuTime+=E.sum/1E6,x.push(E)):(E.startQueryIndex=A,E.endQueryIndex=u,c[d++]=E)}c.length=d}},getNumPendingQueries:function(){return b.length},clear:function(){g.push.apply(g,b);for(var c=0;c<g.length;c++)ba.ext_disjoint_timer_query.deleteQueryEXT(g[c]);b.length=0;g.length=0},restore:function(){b.length=0;g.length=0}}}},{}],21:[function(z,
aa,jc){function d(b){return"undefined"!==typeof atob?atob(b):"base64:"+b}function ba(b){b=Error("(regl) "+b);console.error(b);throw b;}function r(b,c){b||ba(c)}function N(b){return b?": "+b:""}function g(b,c){switch(c){case "number":return"number"===typeof b;case "object":return"object"===typeof b;case "string":return"string"===typeof b;case "boolean":return"boolean"===typeof b;case "function":return"function"===typeof b;case "undefined":return"undefined"===typeof b;case "symbol":return"symbol"===
typeof b}}function b(b,c,g){0>c.indexOf(b)&&ba("invalid value"+N(g)+". must be one of: "+c)}function x(b,c){for(b+="";b.length<c;)b=" "+b;return b}function c(){this.name="unknown";this.lines=[];this.index={};this.hasErrors=!1}function v(b,c){this.number=b;this.line=c;this.errors=[]}function na(b,c,g){this.file=b;this.line=c;this.message=g}function da(){var b=Error(),b=(b.stack||b).toString(),c=/compileProcedure.*\n\s*at.*\((.*)\)/.exec(b);return c?c[1]:(b=/compileProcedure.*\n\s*at\s+(.*)(\n|$)/.exec(b))?
b[1]:"unknown"}function K(){var b=Error(),b=(b.stack||b).toString(),c=/at REGLCommand.*\n\s+at.*\((.*)\)/.exec(b);return c?c[1]:(b=/at REGLCommand.*\n\s+at\s+(.*)\n/.exec(b))?b[1]:"unknown"}function E(b,g){var e=b.split("\n"),h=1,q=0,n={unknown:new c,0:new c};n.unknown.name=n[0].name=g||da();n.unknown.lines.push(new v(0,""));for(var u=0;u<e.length;++u){var x=e[u],a=/^\s*#\s*(\w+)\s+(.+)\s*$/.exec(x);if(a)switch(a[1]){case "line":if(a=/(\d+)(\s+\d+)?/.exec(a[2]))h=a[1]|0,a[2]&&(q=a[2]|0,q in n||(n[q]=
new c));break;case "define":if(a=/SHADER_NAME(_B64)?\s+(.*)$/.exec(a[2]))n[q].name=a[1]?d(a[2]):a[2]}n[q].lines.push(new v(h++,x))}I(n).forEach(function(a){var b=n[a];b.lines.forEach(function(a){b.index[a.number]=a})});return n}function u(b){var c=[];b.split("\n").forEach(function(b){if(!(5>b.length)){var f=/^ERROR:\s+(\d+):(\d+):\s*(.*)$/.exec(b);f?c.push(new na(f[1]|0,f[2]|0,f[3].trim())):0<b.length&&c.push(new na("unknown",0,b))}});return c}function A(b,c){c.forEach(function(c){var g=b[c.file];
if(g){var e=g.index[c.line];if(e){e.errors.push(c);g.hasErrors=!0;return}}b.unknown.hasErrors=!0;b.unknown.lines[0].errors.push(c)})}function H(b){b._commandRef=da()}function n(b,c){var g=K();ba(b+" in command "+(c||da())+("unknown"===g?"":" called from "+g))}function F(b,c,e,h){g(b,c)||n("invalid parameter type"+N(e)+". expected "+c+", got "+typeof b,h||da())}function ca(b,c){return 32820===b||32819===b||33635===b?2:34042===b?4:h[b]*c}var I=z("./sorted-object-keys"),Id=z("./is-typed-array");z=z("./extend");
var e="gl canvas container attributes pixelRatio extensions optionalExtensions profile onDone".split(" "),h={};h[5120]=h[5121]=1;h[5122]=h[5123]=h[36193]=h[33635]=h[32819]=h[32820]=2;h[5124]=h[5125]=h[5126]=h[34042]=4;aa.exports=z(r,{optional:function(b){b()},raise:ba,commandRaise:n,command:function(b,c,g){b||n(c,g||da())},parameter:function(b,c,g){b in c||ba("unknown parameter ("+b+")"+N(g)+". possible values: "+I(c).join())},commandParameter:function(b,c,g,e){b in c||n("unknown parameter ("+b+")"+
N(g)+". possible values: "+I(c).join(),e||da())},constructor:function(b){I(b).forEach(function(b){0>e.indexOf(b)&&ba('invalid regl constructor argument "'+b+'". must be one of '+e)})},type:function(b,c,e){g(b,c)||ba("invalid parameter type"+N(e)+". expected "+c+", got "+typeof b)},commandType:F,isTypedArray:function(b,c){Id(b)||ba("invalid parameter type"+N(c)+". must be a typed array")},nni:function(b,c){0<=b&&(b|0)===b||ba("invalid parameter type, ("+b+")"+N(c)+". must be a nonnegative integer")},
oneOf:b,shaderError:function(b,c,g,e,h){if(!b.getShaderParameter(c,b.COMPILE_STATUS)){c=b.getShaderInfoLog(c);b=e===b.FRAGMENT_SHADER?"fragment":"vertex";F(g,"string",b+" shader source must be a string",h);var d=E(g,h);g=u(c);A(d,g);I(d).forEach(function(b){function c(a,b){f.push(a);g.push(b||"")}var a=d[b];if(a.hasErrors){var f=[""],g=[""];c("file number "+b+": "+a.name+"\n","color:red;text-decoration:underline;font-weight:bold");a.lines.forEach(function(a){if(0<a.errors.length){c(x(a.number,4)+
"|  ","background-color:yellow; font-weight:bold");c(a.line+"\n","color:red; background-color:yellow; font-weight:bold");var b=0;a.errors.forEach(function(f){f=f.message;var l=/^\s*'(.*)'\s*:\s*(.*)$/.exec(f);if(l){var g=l[1];f=l[2];switch(g){case "assign":g="="}b=Math.max(a.line.indexOf(g,b),0)}else b=0;c(x("| ",6));c(x("^^^",b+3)+"\n","font-weight:bold");c(x("| ",6));c(f+"\n","font-weight:bold")});c(x("| ",6)+"\n")}else c(x(a.number,4)+"|  "),c(a.line+"\n","color:red")});"undefined"===typeof document||
window.chrome?console.log(f.join("")):(g[0]=f.join("%c"),console.log.apply(console,g))}});r.raise("Error compiling "+b+" shader, "+d[0].name)}},linkError:function(b,c,g,e,h){b.getProgramParameter(c,b.LINK_STATUS)||(b=b.getProgramInfoLog(c),g=E(g,h),e='Error linking program with vertex shader, "'+E(e,h)[0].name+'", and fragment shader "'+g[0].name+'"',"undefined"!==typeof document?console.log("%c"+e+"\n%c"+b,"color:red;text-decoration:underline;font-weight:bold","color:red"):console.log(e+"\n"+b),
r.raise(e))},callSite:K,saveCommandRef:H,saveDrawInfo:function(b,c,g,e){function h(b){return b?e.id(b):0}function d(b,a){I(a).forEach(function(a){b[e.id(a)]=!0})}H(b);b._fragId=h(b["static"].frag);b._vertId=h(b["static"].vert);var n=b._uniformSet={};d(n,c["static"]);d(n,c.dynamic);c=b._attributeSet={};d(c,g["static"]);d(c,g.dynamic);b._hasCount="count"in b["static"]||"count"in b.dynamic||"elements"in b["static"]||"elements"in b.dynamic},framebufferFormat:function(c,g,e){c.texture?b(c.texture._texture.internalformat,
g,"unsupported texture format for attachment"):b(c.renderbuffer._renderbuffer.format,e,"unsupported renderbuffer format for attachment")},guessCommand:da,texture2D:function(b,c,g){var e=c.width,h=c.height,d=c.channels;r(0<e&&e<=g.maxTextureSize&&0<h&&h<=g.maxTextureSize,"invalid texture shape");33071===b.wrapS&&33071===b.wrapT||r(!(e&e-1)&&!!e&&!(h&h-1)&&!!h,"incompatible wrap mode for texture, both width and height must be power of 2");1===c.mipmask?1!==e&&1!==h&&r(9984!==b.minFilter&&9986!==b.minFilter&&
9985!==b.minFilter&&9987!==b.minFilter,"min filter requires mipmap"):(r(!(e&e-1)&&!!e&&!(h&h-1)&&!!h,"texture must be a square power of 2 to support mipmapping"),r(c.mipmask===(e<<1)-1,"missing or incomplete mipmap data"));5126===c.type&&(0>g.extensions.indexOf("oes_texture_float_linear")&&r(9728===b.minFilter&&9728===b.magFilter,"filter not supported, must enable oes_texture_float_linear"),r(!b.genMipmaps,"mipmap generation not supported with float textures"));var n=c.images;for(g=0;16>g;++g)if(n[g]){var u=
e>>g,a=h>>g;r(c.mipmask&1<<g,"missing mipmap data");var l=n[g];r(l.width===u&&l.height===a,"invalid shape for mip images");r(l.format===c.format&&l.internalformat===c.internalformat&&l.type===c.type,"incompatible type for mip image");!l.compressed&&l.data&&(u=Math.ceil(ca(l.type,d)*u/l.unpackAlignment)*l.unpackAlignment,r(l.data.byteLength===u*a,"invalid data for image, buffer size is inconsistent with image format"))}else b.genMipmaps||r(0===(c.mipmask&1<<g),"extra mipmap data");c.compressed&&r(!b.genMipmaps,
"mipmap generation for compressed images not supported")},textureCube:function(b,c,g,e){var h=b.width,d=b.height,n=b.channels;r(0<h&&h<=e.maxTextureSize&&0<d&&d<=e.maxTextureSize,"invalid texture shape");r(h===d,"cube map must be square");r(33071===c.wrapS&&33071===c.wrapT,"wrap mode not supported by cube map");for(e=0;e<g.length;++e){var u=g[e];r(u.width===h&&u.height===d,"inconsistent cube map face shape");c.genMipmaps&&(r(!u.compressed,"can not generate mipmap for compressed textures"),r(1===u.mipmask,
"can not specify mipmaps and generate mipmaps"));for(var a=u.images,l=0;16>l;++l){var v=a[l];if(v){var x=h>>l,A=d>>l;r(u.mipmask&1<<l,"missing mipmap data");r(v.width===x&&v.height===A,"invalid shape for mip images");r(v.format===b.format&&v.internalformat===b.internalformat&&v.type===b.type,"incompatible type for mip image");v.compressed||v.data&&r(v.data.byteLength===x*A*Math.max(ca(v.type,n),v.unpackAlignment),"invalid data for image, buffer size is inconsistent with image format")}}}}})},{"./extend":25,
"./is-typed-array":30,"./sorted-object-keys":34}],22:[function(z,aa,jc){aa.exports="undefined"!==typeof performance&&performance.now?function(){return performance.now()}:function(){return+new Date}},{}],23:[function(z,aa,jc){function d(d){return Array.prototype.slice.call(d)}var ba=z("./extend"),r=z("./compiled-fns");aa.exports=function(){function N(){var b=[],c=[];return ba(function(){b.push.apply(b,d(arguments))},{def:function(){var g="v"+x;x++;c.push(g);0<arguments.length&&(b.push(g,"="),b.push.apply(b,
d(arguments)),b.push(";"));return g},toString:function(){return d([0<c.length?"var "+c.join(",")+";":"",d(b).join("")]).join("")}})}function g(){function b(d,u){g(d,u,"=",c.def(d,u),";")}var c=N(),g=N(),v=c.toString,u=g.toString;return ba(function(){c.apply(c,d(arguments))},{def:c.def,entry:c,exit:g,save:b,set:function(g,d,n){b(g,d);c(g,d,"=",n,";")},toString:function(){return v()+u()}})}var b=0,x=0,c={},v={};return{global:N(),link:function(g){var d="$"+b,v=!1;"object"===typeof g&&g.name&&(d=g.name.replace(/ /g,
"_"),v=!0);if(d in c)return d;c[d]=g;v||b++;return d},block:N,proc:function(b,c){function x(){var b="a"+r.length;r.push(b);return b}var r=[];c=c||0;for(var u=0;u<c;++u)x();var u=g(),A=u.toString;return v[b]=ba(u,{arg:x,toString:function(){return d(["function(",r.join(),"){",A(),"}"]).join("")}})},scope:g,cond:function(){var b=d(arguments).join(""),c=g(),v=g(),x=c.toString,u=v.toString;return ba(c,{then:function(){c.apply(c,d(arguments));return this},"else":function(){v.apply(v,d(arguments));return this},
toString:function(){var c=u();c&&(c="else{"+c+"}");return d(["if(",b,"){",x(),"}",c]).join("")}})},compile:function(){var b=[],g=[];Object.keys(c).sort(function(b,c){var g="$"===b.charAt(0),d="$"===c.charAt(0);return g||d?g&&d?+b.slice(1)<+c.slice(1)?-1:1:g&&!d?-1:1:b.localeCompare(c)}).forEach(function(d){var v=c[d];b.push(d);g.push(v)});for(var d=0,v=b.length-1;-1<v;v--)if("$"===b[v].charAt(0)){d=v;break}d=b.slice(d).join();v=r[d];if(!v)throw Error("missing precompiled function with key: "+d);return v.apply(null,
g)}}}},{"./compiled-fns":24,"./extend":25}],24:[function(z,aa,jc){aa.exports={$0:function(d){var ba,r,N,g,b,x,c,v,z,da,K,E,u,A,H,n,F,ca,I,Id,e,h,f,D,T,V,q,qa,L,ga;ba=d.attributes;r=d.current;N=d.framebuffer;g=d.gl;b=d.next;x=d.vao;c=b.blend_color;v=r.blend_color;z=b.blend_equation;da=r.blend_equation;K=b.blend_func;E=r.blend_func;u=b.colorMask;A=r.colorMask;H=b.depth_range;n=r.depth_range;F=b.polygonOffset_offset;ca=r.polygonOffset_offset;I=b.sample_coverage;Id=r.sample_coverage;e=b.scissor_box;h=
r.scissor_box;f=b.stencil_func;D=r.stencil_func;T=b.stencil_opBack;V=r.stencil_opBack;q=b.stencil_opFront;qa=r.stencil_opFront;L=b.viewport;ga=r.viewport;return{poll:function(){var a,l,d,x,ba,cb,aa,oa,Qa,Y,O,M,R,sa,J,Ob,$a,P,t,la,fa,Ea;r.dirty=!1;l=b.blend_enable;d=b.cull_enable;x=b.depth_enable;ba=b.dither;cb=b.polygonOffset_enable;aa=b.sample_alpha;oa=b.sample_enable;Qa=b.scissor_enable;Y=b.stencil_enable;O=b.cull_face;M=r.cull_face;R=b.depth_func;sa=r.depth_func;J=b.depth_mask;Ob=r.depth_mask;
$a=b.frontFace;P=r.frontFace;t=b.lineWidth;la=r.lineWidth;fa=b.stencil_mask;Ea=r.stencil_mask;a=N.next;a!==N.cur&&(a?g.bindFramebuffer(36160,a.framebuffer):g.bindFramebuffer(36160,null),N.cur=a);l!==r.blend_enable&&(l?g.enable(3042):g.disable(3042),r.blend_enable=l);d!==r.cull_enable&&(d?g.enable(2884):g.disable(2884),r.cull_enable=d);x!==r.depth_enable&&(x?g.enable(2929):g.disable(2929),r.depth_enable=x);ba!==r.dither&&(ba?g.enable(3024):g.disable(3024),r.dither=ba);cb!==r.polygonOffset_enable&&
(cb?g.enable(32823):g.disable(32823),r.polygonOffset_enable=cb);aa!==r.sample_alpha&&(aa?g.enable(32926):g.disable(32926),r.sample_alpha=aa);oa!==r.sample_enable&&(oa?g.enable(32928):g.disable(32928),r.sample_enable=oa);Qa!==r.scissor_enable&&(Qa?g.enable(3089):g.disable(3089),r.scissor_enable=Qa);Y!==r.stencil_enable&&(Y?g.enable(2960):g.disable(2960),r.stencil_enable=Y);if(c[0]!==v[0]||c[1]!==v[1]||c[2]!==v[2]||c[3]!==v[3])g.blendColor(c[0],c[1],c[2],c[3]),v[0]=c[0],v[1]=c[1],v[2]=c[2],v[3]=c[3];
if(z[0]!==da[0]||z[1]!==da[1])g.blendEquationSeparate(z[0],z[1]),da[0]=z[0],da[1]=z[1];if(K[0]!==E[0]||K[1]!==E[1]||K[2]!==E[2]||K[3]!==E[3])g.blendFuncSeparate(K[0],K[1],K[2],K[3]),E[0]=K[0],E[1]=K[1],E[2]=K[2],E[3]=K[3];if(u[0]!==A[0]||u[1]!==A[1]||u[2]!==A[2]||u[3]!==A[3])g.colorMask(u[0],u[1],u[2],u[3]),A[0]=u[0],A[1]=u[1],A[2]=u[2],A[3]=u[3];O!==M&&(g.cullFace(O),r.cull_face=O);R!==sa&&(g.depthFunc(R),r.depth_func=R);J!==Ob&&(g.depthMask(J),r.depth_mask=J);if(H[0]!==n[0]||H[1]!==n[1])g.depthRange(H[0],
H[1]),n[0]=H[0],n[1]=H[1];$a!==P&&(g.frontFace($a),r.frontFace=$a);t!==la&&(g.lineWidth(t),r.lineWidth=t);if(F[0]!==ca[0]||F[1]!==ca[1])g.polygonOffset(F[0],F[1]),ca[0]=F[0],ca[1]=F[1];if(I[0]!==Id[0]||I[1]!==Id[1])g.sampleCoverage(I[0],I[1]),Id[0]=I[0],Id[1]=I[1];if(e[0]!==h[0]||e[1]!==h[1]||e[2]!==h[2]||e[3]!==h[3])g.scissor(e[0],e[1],e[2],e[3]),h[0]=e[0],h[1]=e[1],h[2]=e[2],h[3]=e[3];if(f[0]!==D[0]||f[1]!==D[1]||f[2]!==D[2])g.stencilFunc(f[0],f[1],f[2]),D[0]=f[0],D[1]=f[1],D[2]=f[2];fa!==Ea&&(g.stencilMask(fa),
r.stencil_mask=fa);if(T[0]!==V[0]||T[1]!==V[1]||T[2]!==V[2]||T[3]!==V[3])g.stencilOpSeparate(T[0],T[1],T[2],T[3]),V[0]=T[0],V[1]=T[1],V[2]=T[2],V[3]=T[3];if(q[0]!==qa[0]||q[1]!==qa[1]||q[2]!==qa[2]||q[3]!==qa[3])g.stencilOpSeparate(q[0],q[1],q[2],q[3]),qa[0]=q[0],qa[1]=q[1],qa[2]=q[2],qa[3]=q[3];if(L[0]!==ga[0]||L[1]!==ga[1]||L[2]!==ga[2]||L[3]!==ga[3])g.viewport(L[0],L[1],L[2],L[3]),ga[0]=L[0],ga[1]=L[1],ga[2]=L[2],ga[3]=L[3]},refresh:function(){var a,l,d,ma,Ka,cb,aa,oa,Qa,Y,O,M,R,sa,J,Ob;r.dirty=
!1;l=b.blend_enable;d=b.cull_enable;ma=b.depth_enable;Ka=b.dither;cb=b.polygonOffset_enable;aa=b.sample_alpha;oa=b.sample_enable;Qa=b.scissor_enable;Y=b.stencil_enable;O=b.cull_face;M=b.depth_func;R=b.depth_mask;sa=b.frontFace;J=b.lineWidth;Ob=b.stencil_mask;(a=N.next)?g.bindFramebuffer(36160,a.framebuffer):g.bindFramebuffer(36160,null);N.cur=a;a=ba[0];a.buffer?(g.enableVertexAttribArray(0),g.bindBuffer(34962,a.buffer.buffer),g.vertexAttribPointer(0,a.size,a.type,a.normalized,a.stride,a.offset)):
...
a.stride,a.offset)):(g.disableVertexAttribArray(15),g.vertexAttrib4f(15,a.x,a.y,a.z,a.w),a.buffer=null);x.currentVAO=null;x.setVAO(x.targetVAO);l?g.enable(3042):g.disable(3042);r.blend_enable=l;d?g.enable(2884):g.disable(2884);r.cull_enable=d;ma?g.enable(2929):g.disable(2929);r.depth_enable=ma;Ka?g.enable(3024):g.disable(3024);r.dither=Ka;cb?g.enable(32823):g.disable(32823);r.polygonOffset_enable=cb;aa?g.enable(32926):g.disable(32926);r.sample_alpha=aa;oa?g.enable(32928):g.disable(32928);r.sample_enable=
oa;Qa?g.enable(3089):g.disable(3089);r.scissor_enable=Qa;Y?g.enable(2960):g.disable(2960);r.stencil_enable=Y;g.blendColor(c[0],c[1],c[2],c[3]);v[0]=c[0];v[1]=c[1];v[2]=c[2];v[3]=c[3];g.blendEquationSeparate(z[0],z[1]);da[0]=z[0];da[1]=z[1];g.blendFuncSeparate(K[0],K[1],K[2],K[3]);E[0]=K[0];E[1]=K[1];E[2]=K[2];E[3]=K[3];g.colorMask(u[0],u[1],u[2],u[3]);A[0]=u[0];A[1]=u[1];A[2]=u[2];A[3]=u[3];g.cullFace(O);r.cull_face=O;g.depthFunc(M);r.depth_func=M;g.depthMask(R);r.depth_mask=R;g.depthRange(H[0],H[1]);
n[0]=H[0];n[1]=H[1];g.frontFace(sa);r.frontFace=sa;g.lineWidth(J);r.lineWidth=J;g.polygonOffset(F[0],F[1]);ca[0]=F[0];ca[1]=F[1];g.sampleCoverage(I[0],I[1]);Id[0]=I[0];Id[1]=I[1];g.scissor(e[0],e[1],e[2],e[3]);h[0]=e[0];h[1]=e[1];h[2]=e[2];h[3]=e[3];g.stencilFunc(f[0],f[1],f[2]);D[0]=f[0];D[1]=f[1];D[2]=f[2];g.stencilMask(Ob);r.stencil_mask=Ob;g.stencilOpSeparate(T[0],T[1],T[2],T[3]);V[0]=T[0];V[1]=T[1];V[2]=T[2];V[3]=T[3];g.stencilOpSeparate(q[0],q[1],q[2],q[3]);qa[0]=q[0];qa[1]=q[1];qa[2]=q[2];
qa[3]=q[3];g.viewport(L[0],L[1],L[2],L[3]);ga[0]=L[0];ga[1]=L[1];ga[2]=L[2];ga[3]=L[3]}}},$3:function(d,ba,r,N){var g,b,x,c,v,z,da,K,E,u,A,H,n,F,ca,I,aa,e,h,f,D,T,V,q,qa,L,ga,a,l,X,ma,Ka,cb;g=d.context;b=d.current;x=d.framebuffer;c=d.gl;v=d.next;z=d.shader;da=d.vao;K=v.blend_color;E=b.blend_color;u=v.blend_equation;A=b.blend_equation;H=v.blend_func;n=b.blend_func;F=v.colorMask;ca=b.colorMask;I=v.depth_range;aa=b.depth_range;e=v.polygonOffset_offset;h=b.polygonOffset_offset;f=v.sample_coverage;D=b.sample_coverage;
T=v.scissor_box;V=b.scissor_box;q=v.stencil_func;qa=b.stencil_func;L=v.stencil_opBack;ga=b.stencil_opBack;a=v.stencil_opFront;l=b.stencil_opFront;X=v.viewport;ma=b.viewport;Ka={};cb={};return{batch:function(g,d){var r,Y,O,M,R;r=x.next;r!==x.cur&&(r?c.bindFramebuffer(36160,r.framebuffer):c.bindFramebuffer(36160,null),x.cur=r);if(b.dirty){r=v.dither;r!==b.dither&&(r?c.enable(3024):c.disable(3024),b.dither=r);r=v.blend_enable;r!==b.blend_enable&&(r?c.enable(3042):c.disable(3042),b.blend_enable=r);r=
K[0];O=K[1];M=K[2];R=K[3];if(r!==E[0]||O!==E[1]||M!==E[2]||R!==E[3])c.blendColor(r,O,M,R),E[0]=r,E[1]=O,E[2]=M,E[3]=R;r=u[0];O=u[1];if(r!==A[0]||O!==A[1])c.blendEquationSeparate(r,O),A[0]=r,A[1]=O;r=H[0];O=H[1];M=H[2];R=H[3];if(r!==n[0]||O!==n[1]||M!==n[2]||R!==n[3])c.blendFuncSeparate(r,O,M,R),n[0]=r,n[1]=O,n[2]=M,n[3]=R;r=v.depth_enable;r!==b.depth_enable&&(r?c.enable(2929):c.disable(2929),b.depth_enable=r);r=v.depth_func;r!==b.depth_func&&(c.depthFunc(r),b.depth_func=r);r=I[0];O=I[1];if(r!==aa[0]||
O!==aa[1])c.depthRange(r,O),aa[0]=r,aa[1]=O;r=v.depth_mask;r!==b.depth_mask&&(c.depthMask(r),b.depth_mask=r);r=F[0];O=F[1];M=F[2];R=F[3];if(r!==ca[0]||O!==ca[1]||M!==ca[2]||R!==ca[3])c.colorMask(r,O,M,R),ca[0]=r,ca[1]=O,ca[2]=M,ca[3]=R;r=v.cull_enable;r!==b.cull_enable&&(r?c.enable(2884):c.disable(2884),b.cull_enable=r);r=v.cull_face;r!==b.cull_face&&(c.cullFace(r),b.cull_face=r);r=v.frontFace;r!==b.frontFace&&(c.frontFace(r),b.frontFace=r);r=v.lineWidth;r!==b.lineWidth&&(c.lineWidth(r),b.lineWidth=
r);r=v.polygonOffset_enable;r!==b.polygonOffset_enable&&(r?c.enable(32823):c.disable(32823),b.polygonOffset_enable=r);r=e[0];O=e[1];if(r!==h[0]||O!==h[1])c.polygonOffset(r,O),h[0]=r,h[1]=O;r=v.sample_alpha;r!==b.sample_alpha&&(r?c.enable(32926):c.disable(32926),b.sample_alpha=r);r=v.sample_enable;r!==b.sample_enable&&(r?c.enable(32928):c.disable(32928),b.sample_enable=r);r=f[0];O=f[1];if(r!==D[0]||O!==D[1])c.sampleCoverage(r,O),D[0]=r,D[1]=O;r=v.stencil_enable;r!==b.stencil_enable&&(r?c.enable(2960):
c.disable(2960),b.stencil_enable=r);r=v.stencil_mask;r!==b.stencil_mask&&(c.stencilMask(r),b.stencil_mask=r);r=q[0];O=q[1];M=q[2];if(r!==qa[0]||O!==qa[1]||M!==qa[2])c.stencilFunc(r,O,M),qa[0]=r,qa[1]=O,qa[2]=M;r=a[0];O=a[1];M=a[2];R=a[3];if(r!==l[0]||O!==l[1]||M!==l[2]||R!==l[3])c.stencilOpSeparate(r,O,M,R),l[0]=r,l[1]=O,l[2]=M,l[3]=R;r=L[0];O=L[1];M=L[2];R=L[3];if(r!==ga[0]||O!==ga[1]||M!==ga[2]||R!==ga[3])c.stencilOpSeparate(r,O,M,R),ga[0]=r,ga[1]=O,ga[2]=M,ga[3]=R;r=v.scissor_enable;r!==b.scissor_enable&&
(r?c.enable(3089):c.disable(3089),b.scissor_enable=r);r=T[0];O=T[1];M=T[2];R=T[3];if(r!==V[0]||O!==V[1]||M!==V[2]||R!==V[3])c.scissor(r,O,M,R),V[0]=r,V[1]=O,V[2]=M,V[3]=R;r=X[0];O=X[1];M=X[2];R=X[3];if(r!==ma[0]||O!==ma[1]||M!==ma[2]||R!==ma[3])c.viewport(r,O,M,R),ma[0]=r,ma[1]=O,ma[2]=M,ma[3]=R;b.dirty=!1}if(r=b.profile)Y=performance.now(),ba.count+=d;O=z.program(z.vert,z.frag);c.useProgram(O.program);da.setVAO(null);M=O.id;(R=cb[M])||(R=cb[M]=N(O));R.call(this,g,d);da.setVAO(null);r&&(ba.cpuTime+=
performance.now()-Y)},draw:function(g){var d,N,Y,O,M;d=x.next;d!==x.cur&&(d?c.bindFramebuffer(36160,d.framebuffer):c.bindFramebuffer(36160,null),x.cur=d);if(b.dirty){d=v.dither;d!==b.dither&&(d?c.enable(3024):c.disable(3024),b.dither=d);d=v.blend_enable;d!==b.blend_enable&&(d?c.enable(3042):c.disable(3042),b.blend_enable=d);d=K[0];Y=K[1];O=K[2];M=K[3];if(d!==E[0]||Y!==E[1]||O!==E[2]||M!==E[3])c.blendColor(d,Y,O,M),E[0]=d,E[1]=Y,E[2]=O,E[3]=M;d=u[0];Y=u[1];if(d!==A[0]||Y!==A[1])c.blendEquationSeparate(d,
Y),A[0]=d,A[1]=Y;d=H[0];Y=H[1];O=H[2];M=H[3];if(d!==n[0]||Y!==n[1]||O!==n[2]||M!==n[3])c.blendFuncSeparate(d,Y,O,M),n[0]=d,n[1]=Y,n[2]=O,n[3]=M;d=v.depth_enable;d!==b.depth_enable&&(d?c.enable(2929):c.disable(2929),b.depth_enable=d);d=v.depth_func;d!==b.depth_func&&(c.depthFunc(d),b.depth_func=d);d=I[0];Y=I[1];if(d!==aa[0]||Y!==aa[1])c.depthRange(d,Y),aa[0]=d,aa[1]=Y;d=v.depth_mask;d!==b.depth_mask&&(c.depthMask(d),b.depth_mask=d);d=F[0];Y=F[1];O=F[2];M=F[3];if(d!==ca[0]||Y!==ca[1]||O!==ca[2]||M!==
ca[3])c.colorMask(d,Y,O,M),ca[0]=d,ca[1]=Y,ca[2]=O,ca[3]=M;d=v.cull_enable;d!==b.cull_enable&&(d?c.enable(2884):c.disable(2884),b.cull_enable=d);d=v.cull_face;d!==b.cull_face&&(c.cullFace(d),b.cull_face=d);d=v.frontFace;d!==b.frontFace&&(c.frontFace(d),b.frontFace=d);d=v.lineWidth;d!==b.lineWidth&&(c.lineWidth(d),b.lineWidth=d);d=v.polygonOffset_enable;d!==b.polygonOffset_enable&&(d?c.enable(32823):c.disable(32823),b.polygonOffset_enable=d);d=e[0];Y=e[1];if(d!==h[0]||Y!==h[1])c.polygonOffset(d,Y),
h[0]=d,h[1]=Y;d=v.sample_alpha;d!==b.sample_alpha&&(d?c.enable(32926):c.disable(32926),b.sample_alpha=d);d=v.sample_enable;d!==b.sample_enable&&(d?c.enable(32928):c.disable(32928),b.sample_enable=d);d=f[0];Y=f[1];if(d!==D[0]||Y!==D[1])c.sampleCoverage(d,Y),D[0]=d,D[1]=Y;d=v.stencil_enable;d!==b.stencil_enable&&(d?c.enable(2960):c.disable(2960),b.stencil_enable=d);d=v.stencil_mask;d!==b.stencil_mask&&(c.stencilMask(d),b.stencil_mask=d);d=q[0];Y=q[1];O=q[2];if(d!==qa[0]||Y!==qa[1]||O!==qa[2])c.stencilFunc(d,
Y,O),qa[0]=d,qa[1]=Y,qa[2]=O;d=a[0];Y=a[1];O=a[2];M=a[3];if(d!==l[0]||Y!==l[1]||O!==l[2]||M!==l[3])c.stencilOpSeparate(d,Y,O,M),l[0]=d,l[1]=Y,l[2]=O,l[3]=M;d=L[0];Y=L[1];O=L[2];M=L[3];if(d!==ga[0]||Y!==ga[1]||O!==ga[2]||M!==ga[3])c.stencilOpSeparate(d,Y,O,M),ga[0]=d,ga[1]=Y,ga[2]=O,ga[3]=M;d=v.scissor_enable;d!==b.scissor_enable&&(d?c.enable(3089):c.disable(3089),b.scissor_enable=d);d=T[0];Y=T[1];O=T[2];M=T[3];if(d!==V[0]||Y!==V[1]||O!==V[2]||M!==V[3])c.scissor(d,Y,O,M),V[0]=d,V[1]=Y,V[2]=O,V[3]=
M;d=X[0];Y=X[1];O=X[2];M=X[3];if(d!==ma[0]||Y!==ma[1]||O!==ma[2]||M!==ma[3])c.viewport(d,Y,O,M),ma[0]=d,ma[1]=Y,ma[2]=O,ma[3]=M;b.dirty=!1}if(d=b.profile)N=performance.now(),ba.count++;Y=z.program(z.vert,z.frag);c.useProgram(Y.program);da.setVAO(null);O=Y.id;(M=Ka[O])||(M=Ka[O]=r(Y));M.call(this,g);da.setVAO(null);d&&(ba.cpuTime+=performance.now()-N)},scope:function(a,c,f){var l,e;if(l=b.profile)e=performance.now(),ba.count++;c(g,a,f);l&&(ba.cpuTime+=performance.now()-e)}}},"$38,colors,contextColor,dim0A,dim0B,dim0C,dim0D,dim1A,dim1B,dim1C,dim1D,drwLayer,hiA,hiB,hiC,hiD,loA,loB,loC,loD,maskHeight,maskTexture,p01_04,p05_08,p09_12,p13_16,p17_20,p21_24,p25_28,p29_32,p33_36,p37_40,p41_44,p45_48,p49_52,p53_56,p57_60,palette,resolution,viewBoxPos,viewBoxSize":function(d,
ba,r,N,g,b,x,c,v,z,da,K,E,u,A,H,n,F,ca,I,aa,e,h,f,D,T,V,q,qa,L,ga,a,l,X,ma,Ka,cb,kc,oa,Qa,Y,O,M,R,sa,J,Ob,$a,P,t,la,fa,Ea,Na,Hb,Ha,U,ob,ea,va,bc,cc,Qc,td,wc,W,B,ka,Ca,Lb,nc,Zc,C,w,ia,ua,Q,ha,ra){var G,m,Z,y,ja,pa,k,tc,S,p,Bb,yb,jf,ne,ve,je,Ed,re,qd,fe,se,xd,Dd,Zd,Wd,Ve,kf,af,Ad,Fe,Sd,Td,le,Xd,rd,jd,vd,$c,kd,oc,id,ed,Lc,qc,ab,Ic,Db,pc,Ta,Jc,$b,rc,Fd,Bd,Ac,Xb,Gc,Rc,La,Eb,Wa,wa,md,hb,Sa,Gb,db,ec,Sb;G=d.attributes;m=d.context;Z=d.current;y=d.draw;ja=d.elements;pa=d.framebuffer;k=d.gl;tc=d.next;S=d.shader;
p=d.uniforms;Bb=d.vao;yb=tc.blend_color;jf=Z.blend_color;ne=tc.blend_equation;ve=Z.blend_equation;je=tc.blend_func;Ed=Z.blend_func;re=tc.colorMask;qd=Z.colorMask;fe=tc.depth_range;se=Z.depth_range;xd=tc.polygonOffset_offset;Dd=Z.polygonOffset_offset;Zd=tc.sample_coverage;Wd=Z.sample_coverage;Ve=tc.scissor_box;kf=Z.scissor_box;af=tc.stencil_func;Ad=Z.stencil_func;Fe=tc.stencil_opBack;Sd=Z.stencil_opBack;Td=tc.stencil_opFront;le=Z.stencil_opFront;Xd=tc.viewport;rd=Z.viewport;jd={};vd={};$c=new Float32Array(16);
...
Eb=new Float32Array(16);Wa=new Float32Array(16);wa=new Float32Array(16);md=new Float32Array(16);hb=new Float32Array(16);Sa=new Float32Array(16);Gb=new Float32Array(16);db=new Float32Array(16);ec=new Float32Array(16);Sb=new Float32Array(16);return{batch:function(a,f){var l,e,d,h;l=pa.next;l!==pa.cur&&(l?k.bindFramebuffer(36160,l.framebuffer):k.bindFramebuffer(36160,null),pa.cur=l);if(Z.dirty){var p,q,r,S,D,ba,L,I,T,X,V,ab,Ta,ta,ga,xa,yb,Db,Aa,$b,Ia,qa,Lc,Ra,ed;p=re[0];q=re[1];r=re[2];S=re[3];if(p!==
qd[0]||q!==qd[1]||r!==qd[2]||S!==qd[3])k.colorMask(p,q,r,S),qd[0]=p,qd[1]=q,qd[2]=r,qd[3]=S;D=tc.frontFace;D!==Z.frontFace&&(k.frontFace(D),Z.frontFace=D);ba=tc.polygonOffset_enable;ba!==Z.polygonOffset_enable&&(ba?k.enable(32823):k.disable(32823),Z.polygonOffset_enable=ba);L=xd[0];I=xd[1];if(L!==Dd[0]||I!==Dd[1])k.polygonOffset(L,I),Dd[0]=L,Dd[1]=I;T=tc.sample_alpha;T!==Z.sample_alpha&&(T?k.enable(32926):k.disable(32926),Z.sample_alpha=T);X=tc.sample_enable;X!==Z.sample_enable&&(X?k.enable(32928):
...
je.buffer.buffer);for(d=0;d<f;++d){h=a[d];var fe,Xd,Fd,ne,aa,Wb,ac,Qb,Ga,Yb,nb,xb,Nb,Rb,gc,ic,Ka,Bc,Cc,Ec,Nc,Yc,Sc,Oc,Kb,Fb,Pc,Hc,Tc,hc,Vc,cb,gd,oe,Wc,Id,Ld,we,xe,Ud,Jd,Gd,bd,Fc,od,hd,ad,pd,yd,zd,ye,te,uf,ee,de,be,ue,$d;jd.height=h.viewportHeight;jd.width=h.viewportWidth;jd.x=h.viewportX;jd.y=h.viewportY;fe=jd.x|0;Xd=jd.y|0;Fd="width"in jd?jd.width|0:m.framebufferWidth-fe;ne="height"in jd?jd.height|0:m.framebufferHeight-Xd;aa=m.viewportWidth;m.viewportWidth=Fd;Wb=m.viewportHeight;m.viewportHeight=
...
Sb[7]=Fb[7],Sb[8]=Fb[8],Sb[9]=Fb[9],Sb[10]=Fb[10],Sb[11]=Fb[11],Sb[12]=Fb[12],Sb[13]=Fb[13],Sb[14]=Fb[14],Sb[15]=Fb[15],Sb));Pc=h.resolution;Hc=Pc[0];hc=Pc[1];d&&Tc===Hc&&Vc===hc||(Tc=Hc,Vc=hc,k.uniform2f(Q.location,Hc,hc));cb=h.viewBoxPos;gd=cb[0];Wc=cb[1];d&&oe===gd&&Id===Wc||(oe=gd,Id=Wc,k.uniform2f(ha.location,gd,Wc));Ld=h.viewBoxSize;we=Ld[0];Ud=Ld[1];d&&xe===we&&Jd===Ud||(xe=we,Jd=Ud,k.uniform2f(ra.location,we,Ud));Gd=h.maskHeight;d&&bd===Gd||(bd=Gd,k.uniform1f(ea.location,Gd));Fc=h.drwLayer;
d&&od===Fc||(od=Fc,k.uniform1f(t.location,Fc));hd=h.contextColor;ad=hd[0];yd=hd[1];ye=hd[2];uf=hd[3];d&&pd===ad&&zd===yd&&te===ye&&ee===uf||(pd=ad,zd=yd,te=ye,ee=uf,k.uniform4f(Y.location,ad,yd,ye,uf));(de=h.maskTexture)&&"framebuffer"===de._reglType&&(de=de.color[0]);be=de._texture;k.uniform1i(va.location,be.bind());ue=h.offset;if($d=h.count)je?k.drawElements(1,$d,je.type,ue<<(je.type-5121>>1)):k.drawArrays(1,ue,$d),m.viewportWidth=aa,m.viewportHeight=Wb,be.unbind()}oa.unbind();Z.dirty=!0;Bb.setVAO(null);
Z.profile=e},draw:function(a){var f,l,e,d,h,p;f=pa.next;f!==pa.cur&&(f?k.bindFramebuffer(36160,f.framebuffer):k.bindFramebuffer(36160,null),pa.cur=f);if(Z.dirty){f=re[0];p=re[1];l=re[2];e=re[3];if(f!==qd[0]||p!==qd[1]||l!==qd[2]||e!==qd[3])k.colorMask(f,p,l,e),qd[0]=f,qd[1]=p,qd[2]=l,qd[3]=e;f=tc.frontFace;f!==Z.frontFace&&(k.frontFace(f),Z.frontFace=f);f=tc.polygonOffset_enable;f!==Z.polygonOffset_enable&&(f?k.enable(32823):k.disable(32823),Z.polygonOffset_enable=f);f=xd[0];p=xd[1];if(f!==Dd[0]||
p!==Dd[1])k.polygonOffset(f,p),Dd[0]=f,Dd[1]=p;f=tc.sample_alpha;f!==Z.sample_alpha&&(f?k.enable(32926):k.disable(32926),Z.sample_alpha=f);f=tc.sample_enable;f!==Z.sample_enable&&(f?k.enable(32928):k.disable(32928),Z.sample_enable=f);f=Zd[0];p=Zd[1];if(f!==Wd[0]||p!==Wd[1])k.sampleCoverage(f,p),Wd[0]=f,Wd[1]=p;f=tc.stencil_enable;f!==Z.stencil_enable&&(f?k.enable(2960):k.disable(2960),Z.stencil_enable=f);f=tc.stencil_mask;f!==Z.stencil_mask&&(k.stencilMask(f),Z.stencil_mask=f);f=af[0];p=af[1];l=af[2];
if(f!==Ad[0]||p!==Ad[1]||l!==Ad[2])k.stencilFunc(f,p,l),Ad[0]=f,Ad[1]=p,Ad[2]=l;f=Td[0];p=Td[1];l=Td[2];e=Td[3];if(f!==le[0]||p!==le[1]||l!==le[2]||e!==le[3])k.stencilOpSeparate(f,p,l,e),le[0]=f,le[1]=p,le[2]=l,le[3]=e;f=Fe[0];p=Fe[1];l=Fe[2];e=Fe[3];if(f!==Sd[0]||p!==Sd[1]||l!==Sd[2]||e!==Sd[3])k.stencilOpSeparate(f,p,l,e),Sd[0]=f,Sd[1]=p,Sd[2]=l,Sd[3]=e}jd.height=a.viewportHeight;jd.width=a.viewportWidth;jd.x=a.viewportX;jd.y=a.viewportY;l=jd.x|0;e=jd.y|0;d="width"in jd?jd.width|0:m.framebufferWidth-
l;h="height"in jd?jd.height|0:m.framebufferHeight-e;f=m.viewportWidth;m.viewportWidth=d;p=m.viewportHeight;m.viewportHeight=h;k.viewport(l,e,d,h);rd[0]=l;rd[1]=e;rd[2]=d;rd[3]=h;k.blendColor(0,0,0,0);jf[0]=0;jf[1]=0;jf[2]=0;jf[3]=0;k.disable(3042);Z.blend_enable=!1;k.blendEquationSeparate(32774,32774);ve[0]=32774;ve[1]=32774;k.blendFuncSeparate(770,771,1,1);Ed[0]=770;Ed[1]=771;Ed[2]=1;Ed[3]=1;k.enable(2884);Z.cull_enable=!0;k.cullFace(1029);Z.cull_face=1029;k.enable(2929);Z.depth_enable=!0;k.depthFunc(513);
Z.depth_func=513;k.depthMask(!0);Z.depth_mask=!0;k.depthRange(0,1);se[0]=0;se[1]=1;k.disable(3024);Z.dither=!1;k.lineWidth(2);Z.lineWidth=2;vd.height=a.scissorHeight;vd.width=a.scissorWidth;vd.x=a.scissorX;vd.y=a.scissorY;l=vd.x|0;e=vd.y|0;d="width"in vd?vd.width|0:m.framebufferWidth-l;h="height"in vd?vd.height|0:m.framebufferHeight-e;k.scissor(l,e,d,h);kf[0]=l;kf[1]=e;kf[2]=d;kf[3]=h;k.enable(3089);Z.scissor_enable=!0;l=Z.profile;Z.profile=!1;k.useProgram(r.program);Bb.setVAO(null);e=bc.location;
d=G[e];d.buffer||k.enableVertexAttribArray(e);if(d.type!==N.dtype||4!==d.size||d.buffer!==N||!1!==d.normalized||0!==d.offset||0!==d.stride)k.bindBuffer(34962,N.buffer),k.vertexAttribPointer(e,4,N.dtype,!1,0,0),d.type=N.dtype,d.size=4,d.buffer=N,d.normalized=!1,d.offset=0,d.stride=0;e=cc.location;d=G[e];d.buffer||k.enableVertexAttribArray(e);if(d.type!==g.dtype||4!==d.size||d.buffer!==g||!1!==d.normalized||0!==d.offset||0!==d.stride)k.bindBuffer(34962,g.buffer),k.vertexAttribPointer(e,4,g.dtype,!1,
0,0),d.type=g.dtype,d.size=4,d.buffer=g,d.normalized=!1,d.offset=0,d.stride=0;e=Qc.location;d=G[e];d.buffer||k.enableVertexAttribArray(e);if(d.type!==b.dtype||4!==d.size||d.buffer!==b||!1!==d.normalized||0!==d.offset||0!==d.stride)k.bindBuffer(34962,b.buffer),k.vertexAttribPointer(e,4,b.dtype,!1,0,0),d.type=b.dtype,d.size=4,d.buffer=b,d.normalized=!1,d.offset=0,d.stride=0;e=td.location;d=G[e];d.buffer||k.enableVertexAttribArray(e);if(d.type!==x.dtype||4!==d.size||d.buffer!==x||!1!==d.normalized||
0!==d.offset||0!==d.stride)k.bindBuffer(34962,x.buffer),k.vertexAttribPointer(e,4,x.dtype,!1,0,0),d.type=x.dtype,d.size=4,d.buffer=x,d.normalized=!1,d.offset=0,d.stride=0;e=wc.location;d=G[e];d.buffer||k.enableVertexAttribArray(e);if(d.type!==c.dtype||4!==d.size||d.buffer!==c||!1!==d.normalized||0!==d.offset||0!==d.stride)k.bindBuffer(34962,c.buffer),k.vertexAttribPointer(e,4,c.dtype,!1,0,0),d.type=c.dtype,d.size=4,d.buffer=c,d.normalized=!1,d.offset=0,d.stride=0;e=W.location;d=G[e];d.buffer||k.enableVertexAttribArray(e);
if(d.type!==v.dtype||4!==d.size||d.buffer!==v||!1!==d.normalized||0!==d.offset||0!==d.stride)k.bindBuffer(34962,v.buffer),k.vertexAttribPointer(e,4,v.dtype,!1,0,0),d.type=v.dtype,d.size=4,d.buffer=v,d.normalized=!1,d.offset=0,d.stride=0;e=B.location;d=G[e];d.buffer||k.enableVertexAttribArray(e);if(d.type!==z.dtype||4!==d.size||d.buffer!==z||!1!==d.normalized||0!==d.offset||0!==d.stride)k.bindBuffer(34962,z.buffer),k.vertexAttribPointer(e,4,z.dtype,!1,0,0),d.type=z.dtype,d.size=4,d.buffer=z,d.normalized=
!1,d.offset=0,d.stride=0;e=ka.location;d=G[e];d.buffer||k.enableVertexAttribArray(e);if(d.type!==da.dtype||4!==d.size||d.buffer!==da||!1!==d.normalized||0!==d.offset||0!==d.stride)k.bindBuffer(34962,da.buffer),k.vertexAttribPointer(e,4,da.dtype,!1,0,0),d.type=da.dtype,d.size=4,d.buffer=da,d.normalized=!1,d.offset=0,d.stride=0;e=Ca.location;d=G[e];d.buffer||k.enableVertexAttribArray(e);if(d.type!==K.dtype||4!==d.size||d.buffer!==K||!1!==d.normalized||0!==d.offset||0!==d.stride)k.bindBuffer(34962,K.buffer),
k.vertexAttribPointer(e,4,K.dtype,!1,0,0),d.type=K.dtype,d.size=4,d.buffer=K,d.normalized=!1,d.offset=0,d.stride=0;e=Lb.location;d=G[e];d.buffer||k.enableVertexAttribArray(e);if(d.type!==E.dtype||4!==d.size||d.buffer!==E||!1!==d.normalized||0!==d.offset||0!==d.stride)k.bindBuffer(34962,E.buffer),k.vertexAttribPointer(e,4,E.dtype,!1,0,0),d.type=E.dtype,d.size=4,d.buffer=E,d.normalized=!1,d.offset=0,d.stride=0;e=nc.location;d=G[e];d.buffer||k.enableVertexAttribArray(e);if(d.type!==u.dtype||4!==d.size||
d.buffer!==u||!1!==d.normalized||0!==d.offset||0!==d.stride)k.bindBuffer(34962,u.buffer),k.vertexAttribPointer(e,4,u.dtype,!1,0,0),d.type=u.dtype,d.size=4,d.buffer=u,d.normalized=!1,d.offset=0,d.stride=0;e=Zc.location;d=G[e];d.buffer||k.enableVertexAttribArray(e);if(d.type!==A.dtype||4!==d.size||d.buffer!==A||!1!==d.normalized||0!==d.offset||0!==d.stride)k.bindBuffer(34962,A.buffer),k.vertexAttribPointer(e,4,A.dtype,!1,0,0),d.type=A.dtype,d.size=4,d.buffer=A,d.normalized=!1,d.offset=0,d.stride=0;
e=C.location;d=G[e];d.buffer||k.enableVertexAttribArray(e);if(d.type!==H.dtype||4!==d.size||d.buffer!==H||!1!==d.normalized||0!==d.offset||0!==d.stride)k.bindBuffer(34962,H.buffer),k.vertexAttribPointer(e,4,H.dtype,!1,0,0),d.type=H.dtype,d.size=4,d.buffer=H,d.normalized=!1,d.offset=0,d.stride=0;e=w.location;d=G[e];d.buffer||k.enableVertexAttribArray(e);if(d.type!==n.dtype||4!==d.size||d.buffer!==n||!1!==d.normalized||0!==d.offset||0!==d.stride)k.bindBuffer(34962,n.buffer),k.vertexAttribPointer(e,
4,n.dtype,!1,0,0),d.type=n.dtype,d.size=4,d.buffer=n,d.normalized=!1,d.offset=0,d.stride=0;e=ia.location;d=G[e];d.buffer||k.enableVertexAttribArray(e);if(d.type!==F.dtype||4!==d.size||d.buffer!==F||!1!==d.normalized||0!==d.offset||0!==d.stride)k.bindBuffer(34962,F.buffer),k.vertexAttribPointer(e,4,F.dtype,!1,0,0),d.type=F.dtype,d.size=4,d.buffer=F,d.normalized=!1,d.offset=0,d.stride=0;e=Qa.location;d=G[e];d.buffer||k.enableVertexAttribArray(e);if(d.type!==ca.dtype||4!==d.size||d.buffer!==ca||!1!==
d.normalized||0!==d.offset||0!==d.stride)k.bindBuffer(34962,ca.buffer),k.vertexAttribPointer(e,4,ca.dtype,!1,0,0),d.type=ca.dtype,d.size=4,d.buffer=ca,d.normalized=!1,d.offset=0,d.stride=0;e=a.dim0A;k.uniformMatrix4fv(O.location,!1,Array.isArray(e)||e instanceof Float32Array?e:($c[0]=e[0],$c[1]=e[1],$c[2]=e[2],$c[3]=e[3],$c[4]=e[4],$c[5]=e[5],$c[6]=e[6],$c[7]=e[7],$c[8]=e[8],$c[9]=e[9],$c[10]=e[10],$c[11]=e[11],$c[12]=e[12],$c[13]=e[13],$c[14]=e[14],$c[15]=e[15],$c));e=a.dim1A;k.uniformMatrix4fv(J.location,
!1,Array.isArray(e)||e instanceof Float32Array?e:(kd[0]=e[0],kd[1]=e[1],kd[2]=e[2],kd[3]=e[3],kd[4]=e[4],kd[5]=e[5],kd[6]=e[6],kd[7]=e[7],kd[8]=e[8],kd[9]=e[9],kd[10]=e[10],kd[11]=e[11],kd[12]=e[12],kd[13]=e[13],kd[14]=e[14],kd[15]=e[15],kd));e=a.dim0B;k.uniformMatrix4fv(M.location,!1,Array.isArray(e)||e instanceof Float32Array?e:(oc[0]=e[0],oc[1]=e[1],oc[2]=e[2],oc[3]=e[3],oc[4]=e[4],oc[5]=e[5],oc[6]=e[6],oc[7]=e[7],oc[8]=e[8],oc[9]=e[9],oc[10]=e[10],oc[11]=e[11],oc[12]=e[12],oc[13]=e[13],oc[14]=
e[14],oc[15]=e[15],oc));e=a.dim1B;k.uniformMatrix4fv(Ob.location,!1,Array.isArray(e)||e instanceof Float32Array?e:(id[0]=e[0],id[1]=e[1],id[2]=e[2],id[3]=e[3],id[4]=e[4],id[5]=e[5],id[6]=e[6],id[7]=e[7],id[8]=e[8],id[9]=e[9],id[10]=e[10],id[11]=e[11],id[12]=e[12],id[13]=e[13],id[14]=e[14],id[15]=e[15],id));e=a.dim0C;k.uniformMatrix4fv(R.location,!1,Array.isArray(e)||e instanceof Float32Array?e:(ed[0]=e[0],ed[1]=e[1],ed[2]=e[2],ed[3]=e[3],ed[4]=e[4],ed[5]=e[5],ed[6]=e[6],ed[7]=e[7],ed[8]=e[8],ed[9]=
e[9],ed[10]=e[10],ed[11]=e[11],ed[12]=e[12],ed[13]=e[13],ed[14]=e[14],ed[15]=e[15],ed));e=a.dim1C;k.uniformMatrix4fv($a.location,!1,Array.isArray(e)||e instanceof Float32Array?e:(Lc[0]=e[0],Lc[1]=e[1],Lc[2]=e[2],Lc[3]=e[3],Lc[4]=e[4],Lc[5]=e[5],Lc[6]=e[6],Lc[7]=e[7],Lc[8]=e[8],Lc[9]=e[9],Lc[10]=e[10],Lc[11]=e[11],Lc[12]=e[12],Lc[13]=e[13],Lc[14]=e[14],Lc[15]=e[15],Lc));e=a.dim0D;k.uniformMatrix4fv(sa.location,!1,Array.isArray(e)||e instanceof Float32Array?e:(qc[0]=e[0],qc[1]=e[1],qc[2]=e[2],qc[3]=
e[3],qc[4]=e[4],qc[5]=e[5],qc[6]=e[6],qc[7]=e[7],qc[8]=e[8],qc[9]=e[9],qc[10]=e[10],qc[11]=e[11],qc[12]=e[12],qc[13]=e[13],qc[14]=e[14],qc[15]=e[15],qc));e=a.dim1D;k.uniformMatrix4fv(P.location,!1,Array.isArray(e)||e instanceof Float32Array?e:(ab[0]=e[0],ab[1]=e[1],ab[2]=e[2],ab[3]=e[3],ab[4]=e[4],ab[5]=e[5],ab[6]=e[6],ab[7]=e[7],ab[8]=e[8],ab[9]=e[9],ab[10]=e[10],ab[11]=e[11],ab[12]=e[12],ab[13]=e[13],ab[14]=e[14],ab[15]=e[15],ab));e=a.loA;k.uniformMatrix4fv(Hb.location,!1,Array.isArray(e)||e instanceof
Float32Array?e:(Ic[0]=e[0],Ic[1]=e[1],Ic[2]=e[2],Ic[3]=e[3],Ic[4]=e[4],Ic[5]=e[5],Ic[6]=e[6],Ic[7]=e[7],Ic[8]=e[8],Ic[9]=e[9],Ic[10]=e[10],Ic[11]=e[11],Ic[12]=e[12],Ic[13]=e[13],Ic[14]=e[14],Ic[15]=e[15],Ic));e=a.hiA;k.uniformMatrix4fv(la.location,!1,Array.isArray(e)||e instanceof Float32Array?e:(Db[0]=e[0],Db[1]=e[1],Db[2]=e[2],Db[3]=e[3],Db[4]=e[4],Db[5]=e[5],Db[6]=e[6],Db[7]=e[7],Db[8]=e[8],Db[9]=e[9],Db[10]=e[10],Db[11]=e[11],Db[12]=e[12],Db[13]=e[13],Db[14]=e[14],Db[15]=e[15],Db));e=a.loB;k.uniformMatrix4fv(Ha.location,
!1,Array.isArray(e)||e instanceof Float32Array?e:(pc[0]=e[0],pc[1]=e[1],pc[2]=e[2],pc[3]=e[3],pc[4]=e[4],pc[5]=e[5],pc[6]=e[6],pc[7]=e[7],pc[8]=e[8],pc[9]=e[9],pc[10]=e[10],pc[11]=e[11],pc[12]=e[12],pc[13]=e[13],pc[14]=e[14],pc[15]=e[15],pc));e=a.hiB;k.uniformMatrix4fv(fa.location,!1,Array.isArray(e)||e instanceof Float32Array?e:(Ta[0]=e[0],Ta[1]=e[1],Ta[2]=e[2],Ta[3]=e[3],Ta[4]=e[4],Ta[5]=e[5],Ta[6]=e[6],Ta[7]=e[7],Ta[8]=e[8],Ta[9]=e[9],Ta[10]=e[10],Ta[11]=e[11],Ta[12]=e[12],Ta[13]=e[13],Ta[14]=
e[14],Ta[15]=e[15],Ta));e=a.loC;k.uniformMatrix4fv(U.location,!1,Array.isArray(e)||e instanceof Float32Array?e:(Jc[0]=e[0],Jc[1]=e[1],Jc[2]=e[2],Jc[3]=e[3],Jc[4]=e[4],Jc[5]=e[5],Jc[6]=e[6],Jc[7]=e[7],Jc[8]=e[8],Jc[9]=e[9],Jc[10]=e[10],Jc[11]=e[11],Jc[12]=e[12],Jc[13]=e[13],Jc[14]=e[14],Jc[15]=e[15],Jc));e=a.hiC;k.uniformMatrix4fv(Ea.location,!1,Array.isArray(e)||e instanceof Float32Array?e:($b[0]=e[0],$b[1]=e[1],$b[2]=e[2],$b[3]=e[3],$b[4]=e[4],$b[5]=e[5],$b[6]=e[6],$b[7]=e[7],$b[8]=e[8],$b[9]=e[9],
$b[10]=e[10],$b[11]=e[11],$b[12]=e[12],$b[13]=e[13],$b[14]=e[14],$b[15]=e[15],$b));e=a.loD;k.uniformMatrix4fv(ob.location,!1,Array.isArray(e)||e instanceof Float32Array?e:(rc[0]=e[0],rc[1]=e[1],rc[2]=e[2],rc[3]=e[3],rc[4]=e[4],rc[5]=e[5],rc[6]=e[6],rc[7]=e[7],rc[8]=e[8],rc[9]=e[9],rc[10]=e[10],rc[11]=e[11],rc[12]=e[12],rc[13]=e[13],rc[14]=e[14],rc[15]=e[15],rc));e=a.hiD;k.uniformMatrix4fv(Na.location,!1,Array.isArray(e)||e instanceof Float32Array?e:(Fd[0]=e[0],Fd[1]=e[1],Fd[2]=e[2],Fd[3]=e[3],Fd[4]=
e[4],Fd[5]=e[5],Fd[6]=e[6],Fd[7]=e[7],Fd[8]=e[8],Fd[9]=e[9],Fd[10]=e[10],Fd[11]=e[11],Fd[12]=e[12],Fd[13]=e[13],Fd[14]=e[14],Fd[15]=e[15],Fd));e=a.resolution;k.uniform2f(Q.location,e[0],e[1]);e=a.viewBoxPos;k.uniform2f(ha.location,e[0],e[1]);e=a.viewBoxSize;k.uniform2f(ra.location,e[0],e[1]);k.uniform1f(ea.location,a.maskHeight);k.uniform1f(t.location,a.drwLayer);e=a.contextColor;k.uniform4f(Y.location,e[0],e[1],e[2],e[3]);(e=a.maskTexture)&&"framebuffer"===e._reglType&&(e=e.color[0]);e=e._texture;
k.uniform1i(va.location,e.bind());k.uniform1i(ua.location,I.bind());(d=y.elements)?k.bindBuffer(34963,d.buffer.buffer):Bb.currentVAO&&(d=ja.getElements(Bb.currentVAO.elements))&&k.bindBuffer(34963,d.buffer.buffer);h=a.offset;if(a=a.count)d?k.drawElements(1,a,d.type,h<<(d.type-5121>>1)):k.drawArrays(1,h,a),Z.dirty=!0,Bb.setVAO(null),m.viewportWidth=f,m.viewportHeight=p,Z.profile=l,e.unbind(),I.unbind()},scope:function(d,k,r){var t,w,B,G,C,W,ba,M,O,J,ja,R,P,U,Q,ha,ka,pa,I,Y,ia,fa,ea,la,ua,wa,cc,ab,
...
Rf,Sf,pg,cf,Ze,Mf,Nf,dg,eg,fg,gg,hg,Vf,Tf,Wf,Xf,Yf,ig,qg,rg,sg,tg,ug,vg,wg,xg,yg,zg,Ag,df,$e,Of,Pf,jg,kg,lg,mg,ng,Zf,Uf,$f,ag,bg,og,Bg,Cg,Dg,Eg,Fg,Gg,Hg,Ig,Jg,Kg,Lg,Mg,Ng,Og,Pg,Qg,Rg,Sg,Tg,Ug,Vg,Wg,Xg,Yg,Zg,$g,ah,bh,ch,dh,eh,fh,gh,hh,ih,jh,kh,lh,mh,nh,oh,ph,qh,rh,sh,th,uh;jd.height=d.viewportHeight;jd.width=d.viewportWidth;jd.x=d.viewportX;jd.y=d.viewportY;t=jd.x|0;w=jd.y|0;B="width"in jd?jd.width|0:m.framebufferWidth-t;G="height"in jd?jd.height|0:m.framebufferHeight-w;C=m.viewportWidth;m.viewportWidth=
...
fe[0]=0;ab=fe[1];fe[1]=1;ra=tc.dither;tc.dither=!1;Ta=tc.lineWidth;tc.lineWidth=2;vd.height=d.scissorHeight;vd.width=d.scissorWidth;vd.x=d.scissorX;vd.y=d.scissorY;Ca=vd.x|0;ya=vd.y|0;La="width"in vd?vd.width|0:m.framebufferWidth-Ca;Wd="height"in vd?vd.height|0:m.framebufferHeight-ya;Bb=Ve[0];Ve[0]=Ca;Db=Ve[1];Ve[1]=ya;Wa=Ve[2];Ve[2]=La;za=Ve[3];Ve[3]=Wd;Td=tc.scissor_enable;tc.scissor_enable=!0;Da=Z.profile;Z.profile=!1;$b=d.offset;Gc=y.offset;y.offset=$b;Lc=d.count;ed=y.count;y.count=Lc;Xb=y.primitive;
y.primitive=1;Sa=d.contextColor;sa=p[24];p[24]=Sa;Eb=d.dim0A;qc=p[3];p[3]=Eb;rc=d.dim0B;Fa=p[5];p[5]=rc;Rc=d.dim0C;Pa=p[7];p[7]=Rc;Ba=d.dim0D;td=p[9];p[9]=Ba;qd=d.dim1A;va=p[4];p[4]=qd;hb=d.dim1B;db=p[6];p[6]=hb;oa=d.dim1C;oc=p[8];p[8]=oa;pc=d.dim1D;Ad=p[10];p[10]=pc;Sd=d.drwLayer;$c=p[23];p[23]=Sd;Jc=d.hiA;Ic=p[12];p[12]=Jc;Ac=d.hiB;Gb=p[14];p[14]=Ac;Ga=d.hiC;Lb=p[16];p[16]=Ga;nb=d.hiD;xb=p[18];p[18]=nb;rd=d.loA;kd=p[11];p[11]=rd;le=d.loB;nc=p[13];p[13]=le;Sb=d.loC;id=p[15];p[15]=Sb;wc=d.loD;md=
p[17];p[17]=wc;ec=d.maskHeight;Ea=p[22];p[22]=ec;Bd=d.maskTexture;jf=p[25];p[25]=Bd;Kb=p[26];p[26]=aa;Fb=d.resolution;ve=p[19];p[19]=Fb;Ed=d.viewBoxPos;xd=p[20];p[20]=Ed;kf=d.viewBoxSize;Fe=p[21];p[21]=kf;Fd=e.buffer;e.buffer=ca;bc=e.divisor;e.divisor=0;af=e.normalized;e.normalized=!1;$a=e.offset;e.offset=0;Qa=e.size;e.size=0;Qc=e.state;e.state=1;Zd=e.stride;e.stride=0;re=e.type;e.type=ca.dtype;Na=e.w;e.w=0;ob=e.x;e.x=0;Dd=e.y;e.y=0;Ob=e.z;e.z=0;Fc=h.buffer;h.buffer=N;se=h.divisor;h.divisor=0;Ha=
h.normalized;h.normalized=!1;Zc=h.offset;h.offset=0;Hb=h.size;h.size=0;yd=h.state;h.state=1;zd=h.stride;h.stride=0;kc=h.type;h.type=N.dtype;te=h.w;h.w=0;uf=h.x;h.x=0;ee=h.y;h.y=0;de=h.z;h.z=0;be=f.buffer;f.buffer=g;ue=f.divisor;f.divisor=0;$d=f.normalized;f.normalized=!1;he=f.offset;f.offset=0;zc=f.size;f.size=0;Uc=f.state;f.state=1;pe=f.stride;f.stride=0;ke=f.type;f.type=g.dtype;Hd=f.w;f.w=0;Md=f.x;f.x=0;Nd=f.y;f.y=0;Od=f.z;f.z=0;ie=D.buffer;D.buffer=b;jc=D.divisor;D.divisor=0;ze=D.normalized;D.normalized=
!1;me=D.offset;D.offset=0;Oe=D.size;D.size=0;Pe=D.state;D.state=1;Le=D.stride;D.stride=0;qe=D.type;D.type=b.dtype;De=D.w;D.w=0;Ge=D.x;D.x=0;He=D.y;D.y=0;Ie=D.z;D.z=0;Ee=T.buffer;T.buffer=x;Kd=T.divisor;T.divisor=0;Rd=T.normalized;T.normalized=!1;Yd=T.offset;T.offset=0;ae=T.size;T.size=0;Je=T.state;T.state=1;Cd=T.stride;T.stride=0;Pd=T.type;T.type=x.dtype;Ae=T.w;T.w=0;Ke=T.x;T.x=0;pf=T.y;T.y=0;Xe=T.z;T.z=0;Qe=V.buffer;V.buffer=c;Me=V.divisor;V.divisor=0;We=V.normalized;V.normalized=!1;Ue=V.offset;
V.offset=0;Re=V.size;V.size=0;Se=V.state;V.state=1;Qd=V.stride;V.stride=0;Vd=V.type;V.type=c.dtype;Te=V.w;V.w=0;ef=V.x;V.x=0;lf=V.y;V.y=0;bf=V.z;V.z=0;ff=q.buffer;q.buffer=v;gf=q.divisor;q.divisor=0;hf=q.normalized;q.normalized=!1;qf=q.offset;q.offset=0;mf=q.size;q.size=0;rf=q.state;q.state=1;Bf=q.stride;q.stride=0;Cf=q.type;q.type=v.dtype;Ne=q.w;q.w=0;Be=q.x;q.x=0;nf=q.y;q.y=0;of=q.z;q.z=0;Df=qa.buffer;qa.buffer=z;Gf=qa.divisor;qa.divisor=0;Af=qa.normalized;qa.normalized=!1;Ef=qa.offset;qa.offset=
...
Mg;ma.offset=Ng;ma.size=Og;ma.state=Pg;ma.stride=Qg;ma.type=Rg;ma.w=Sg;ma.x=Tg;ma.y=Ug;ma.z=Vg;Ka.buffer=Wg;Ka.divisor=Xg;Ka.normalized=Yg;Ka.offset=Zg;Ka.size=$g;Ka.state=ah;Ka.stride=bh;Ka.type=ch;Ka.w=dh;Ka.x=eh;Ka.y=fh;Ka.z=gh;cb.buffer=hh;cb.divisor=ih;cb.normalized=jh;cb.offset=kh;cb.size=lh;cb.state=mh;cb.stride=nh;cb.type=oh;cb.w=ph;cb.x=qh;cb.y=rh;cb.z=sh;S.vert=th;S.frag=uh;Z.dirty=!0}}},$1:function(d,ba){var r,N,g,b,x,c,v,z,da,K,E,u,A,H,n,F,ca,I,aa,e,h,f,D,T,V,q,qa,L,ga,a;r=d.attributes;
N=d.current;g=d.framebuffer;b=d.gl;x=d.next;c=d.vao;v=x.blend_color;z=N.blend_color;da=x.blend_equation;K=N.blend_equation;E=x.blend_func;u=N.blend_func;A=x.colorMask;H=N.colorMask;n=x.depth_range;F=N.depth_range;ca=x.polygonOffset_offset;I=N.polygonOffset_offset;aa=x.sample_coverage;e=N.sample_coverage;h=x.scissor_box;f=N.scissor_box;D=x.stencil_func;T=N.stencil_func;V=x.stencil_opBack;q=N.stencil_opBack;qa=x.stencil_opFront;L=N.stencil_opFront;ga=x.viewport;a=N.viewport;return{poll:function(){var c,
d,r,ba,cb,kc,oa,Qa,Y,O,M,R,sa,J,Ob,$a,P,t,la,fa,Ea,Na;N.dirty=!1;d=x.blend_enable;r=x.cull_enable;ba=x.depth_enable;cb=x.dither;kc=x.polygonOffset_enable;oa=x.sample_alpha;Qa=x.sample_enable;Y=x.scissor_enable;O=x.stencil_enable;M=x.cull_face;R=N.cull_face;sa=x.depth_func;J=N.depth_func;Ob=x.depth_mask;$a=N.depth_mask;P=x.frontFace;t=N.frontFace;la=x.lineWidth;fa=N.lineWidth;Ea=x.stencil_mask;Na=N.stencil_mask;c=g.next;c!==g.cur&&(c?b.bindFramebuffer(36160,c.framebuffer):b.bindFramebuffer(36160,null),
g.cur=c);d!==N.blend_enable&&(d?b.enable(3042):b.disable(3042),N.blend_enable=d);r!==N.cull_enable&&(r?b.enable(2884):b.disable(2884),N.cull_enable=r);ba!==N.depth_enable&&(ba?b.enable(2929):b.disable(2929),N.depth_enable=ba);cb!==N.dither&&(cb?b.enable(3024):b.disable(3024),N.dither=cb);kc!==N.polygonOffset_enable&&(kc?b.enable(32823):b.disable(32823),N.polygonOffset_enable=kc);oa!==N.sample_alpha&&(oa?b.enable(32926):b.disable(32926),N.sample_alpha=oa);Qa!==N.sample_enable&&(Qa?b.enable(32928):
...
u[0]=E[0],u[1]=E[1],u[2]=E[2],u[3]=E[3];if(A[0]!==H[0]||A[1]!==H[1]||A[2]!==H[2]||A[3]!==H[3])b.colorMask(A[0],A[1],A[2],A[3]),H[0]=A[0],H[1]=A[1],H[2]=A[2],H[3]=A[3];M!==R&&(b.cullFace(M),N.cull_face=M);sa!==J&&(b.depthFunc(sa),N.depth_func=sa);Ob!==$a&&(b.depthMask(Ob),N.depth_mask=Ob);if(n[0]!==F[0]||n[1]!==F[1])b.depthRange(n[0],n[1]),F[0]=n[0],F[1]=n[1];P!==t&&(b.frontFace(P),N.frontFace=P);la!==fa&&(b.lineWidth(la),N.lineWidth=la);if(ca[0]!==I[0]||ca[1]!==I[1])b.polygonOffset(ca[0],ca[1]),I[0]=
ca[0],I[1]=ca[1];if(aa[0]!==e[0]||aa[1]!==e[1])b.sampleCoverage(aa[0],aa[1]),e[0]=aa[0],e[1]=aa[1];if(h[0]!==f[0]||h[1]!==f[1]||h[2]!==f[2]||h[3]!==f[3])b.scissor(h[0],h[1],h[2],h[3]),f[0]=h[0],f[1]=h[1],f[2]=h[2],f[3]=h[3];if(D[0]!==T[0]||D[1]!==T[1]||D[2]!==T[2])b.stencilFunc(D[0],D[1],D[2]),T[0]=D[0],T[1]=D[1],T[2]=D[2];Ea!==Na&&(b.stencilMask(Ea),N.stencil_mask=Ea);if(V[0]!==q[0]||V[1]!==q[1]||V[2]!==q[2]||V[3]!==q[3])b.stencilOpSeparate(V[0],V[1],V[2],V[3]),q[0]=V[0],q[1]=V[1],q[2]=V[2],q[3]=
V[3];if(qa[0]!==L[0]||qa[1]!==L[1]||qa[2]!==L[2]||qa[3]!==L[3])b.stencilOpSeparate(qa[0],qa[1],qa[2],qa[3]),L[0]=qa[0],L[1]=qa[1],L[2]=qa[2],L[3]=qa[3];if(ga[0]!==a[0]||ga[1]!==a[1]||ga[2]!==a[2]||ga[3]!==a[3])b.viewport(ga[0],ga[1],ga[2],ga[3]),a[0]=ga[0],a[1]=ga[1],a[2]=ga[2],a[3]=ga[3]},refresh:function(){var d,X,ma,Ka,cb,kc,oa,Qa,Y,O,M,R,sa,J,Ob,$a;N.dirty=!1;X=x.blend_enable;ma=x.cull_enable;Ka=x.depth_enable;cb=x.dither;kc=x.polygonOffset_enable;oa=x.sample_alpha;Qa=x.sample_enable;Y=x.scissor_enable;
O=x.stencil_enable;M=x.cull_face;R=x.depth_func;sa=x.depth_mask;J=x.frontFace;Ob=x.lineWidth;$a=x.stencil_mask;(d=g.next)?b.bindFramebuffer(36160,d.framebuffer):b.bindFramebuffer(36160,null);g.cur=d;d=r[0];d.buffer?(b.enableVertexAttribArray(0),b.bindBuffer(34962,d.buffer.buffer),b.vertexAttribPointer(0,d.size,d.type,d.normalized,d.stride,d.offset)):(b.disableVertexAttribArray(0),b.vertexAttrib4f(0,d.x,d.y,d.z,d.w),d.buffer=null);ba.vertexAttribDivisorANGLE(0,d.divisor);d=r[1];d.buffer?(b.enableVertexAttribArray(1),
b.bindBuffer(34962,d.buffer.buffer),b.vertexAttribPointer(1,d.size,d.type,d.normalized,d.stride,d.offset)):(b.disableVertexAttribArray(1),b.vertexAttrib4f(1,d.x,d.y,d.z,d.w),d.buffer=null);ba.vertexAttribDivisorANGLE(1,d.divisor);d=r[2];d.buffer?(b.enableVertexAttribArray(2),b.bindBuffer(34962,d.buffer.buffer),b.vertexAttribPointer(2,d.size,d.type,d.normalized,d.stride,d.offset)):(b.disableVertexAttribArray(2),b.vertexAttrib4f(2,d.x,d.y,d.z,d.w),d.buffer=null);ba.vertexAttribDivisorANGLE(2,d.divisor);
d=r[3];d.buffer?(b.enableVertexAttribArray(3),b.bindBuffer(34962,d.buffer.buffer),b.vertexAttribPointer(3,d.size,d.type,d.normalized,d.stride,d.offset)):(b.disableVertexAttribArray(3),b.vertexAttrib4f(3,d.x,d.y,d.z,d.w),d.buffer=null);ba.vertexAttribDivisorANGLE(3,d.divisor);d=r[4];d.buffer?(b.enableVertexAttribArray(4),b.bindBuffer(34962,d.buffer.buffer),b.vertexAttribPointer(4,d.size,d.type,d.normalized,d.stride,d.offset)):(b.disableVertexAttribArray(4),b.vertexAttrib4f(4,d.x,d.y,d.z,d.w),d.buffer=
null);ba.vertexAttribDivisorANGLE(4,d.divisor);d=r[5];d.buffer?(b.enableVertexAttribArray(5),b.bindBuffer(34962,d.buffer.buffer),b.vertexAttribPointer(5,d.size,d.type,d.normalized,d.stride,d.offset)):(b.disableVertexAttribArray(5),b.vertexAttrib4f(5,d.x,d.y,d.z,d.w),d.buffer=null);ba.vertexAttribDivisorANGLE(5,d.divisor);d=r[6];d.buffer?(b.enableVertexAttribArray(6),b.bindBuffer(34962,d.buffer.buffer),b.vertexAttribPointer(6,d.size,d.type,d.normalized,d.stride,d.offset)):(b.disableVertexAttribArray(6),
b.vertexAttrib4f(6,d.x,d.y,d.z,d.w),d.buffer=null);ba.vertexAttribDivisorANGLE(6,d.divisor);d=r[7];d.buffer?(b.enableVertexAttribArray(7),b.bindBuffer(34962,d.buffer.buffer),b.vertexAttribPointer(7,d.size,d.type,d.normalized,d.stride,d.offset)):(b.disableVertexAttribArray(7),b.vertexAttrib4f(7,d.x,d.y,d.z,d.w),d.buffer=null);ba.vertexAttribDivisorANGLE(7,d.divisor);d=r[8];d.buffer?(b.enableVertexAttribArray(8),b.bindBuffer(34962,d.buffer.buffer),b.vertexAttribPointer(8,d.size,d.type,d.normalized,
d.stride,d.offset)):(b.disableVertexAttribArray(8),b.vertexAttrib4f(8,d.x,d.y,d.z,d.w),d.buffer=null);ba.vertexAttribDivisorANGLE(8,d.divisor);d=r[9];d.buffer?(b.enableVertexAttribArray(9),b.bindBuffer(34962,d.buffer.buffer),b.vertexAttribPointer(9,d.size,d.type,d.normalized,d.stride,d.offset)):(b.disableVertexAttribArray(9),b.vertexAttrib4f(9,d.x,d.y,d.z,d.w),d.buffer=null);ba.vertexAttribDivisorANGLE(9,d.divisor);d=r[10];d.buffer?(b.enableVertexAttribArray(10),b.bindBuffer(34962,d.buffer.buffer),
b.vertexAttribPointer(10,d.size,d.type,d.normalized,d.stride,d.offset)):(b.disableVertexAttribArray(10),b.vertexAttrib4f(10,d.x,d.y,d.z,d.w),d.buffer=null);ba.vertexAttribDivisorANGLE(10,d.divisor);d=r[11];d.buffer?(b.enableVertexAttribArray(11),b.bindBuffer(34962,d.buffer.buffer),b.vertexAttribPointer(11,d.size,d.type,d.normalized,d.stride,d.offset)):(b.disableVertexAttribArray(11),b.vertexAttrib4f(11,d.x,d.y,d.z,d.w),d.buffer=null);ba.vertexAttribDivisorANGLE(11,d.divisor);d=r[12];d.buffer?(b.enableVertexAttribArray(12),
b.bindBuffer(34962,d.buffer.buffer),b.vertexAttribPointer(12,d.size,d.type,d.normalized,d.stride,d.offset)):(b.disableVertexAttribArray(12),b.vertexAttrib4f(12,d.x,d.y,d.z,d.w),d.buffer=null);ba.vertexAttribDivisorANGLE(12,d.divisor);d=r[13];d.buffer?(b.enableVertexAttribArray(13),b.bindBuffer(34962,d.buffer.buffer),b.vertexAttribPointer(13,d.size,d.type,d.normalized,d.stride,d.offset)):(b.disableVertexAttribArray(13),b.vertexAttrib4f(13,d.x,d.y,d.z,d.w),d.buffer=null);ba.vertexAttribDivisorANGLE(13,
d.divisor);d=r[14];d.buffer?(b.enableVertexAttribArray(14),b.bindBuffer(34962,d.buffer.buffer),b.vertexAttribPointer(14,d.size,d.type,d.normalized,d.stride,d.offset)):(b.disableVertexAttribArray(14),b.vertexAttrib4f(14,d.x,d.y,d.z,d.w),d.buffer=null);ba.vertexAttribDivisorANGLE(14,d.divisor);d=r[15];d.buffer?(b.enableVertexAttribArray(15),b.bindBuffer(34962,d.buffer.buffer),b.vertexAttribPointer(15,d.size,d.type,d.normalized,d.stride,d.offset)):(b.disableVertexAttribArray(15),b.vertexAttrib4f(15,
d.x,d.y,d.z,d.w),d.buffer=null);ba.vertexAttribDivisorANGLE(15,d.divisor);c.currentVAO=null;c.setVAO(c.targetVAO);X?b.enable(3042):b.disable(3042);N.blend_enable=X;ma?b.enable(2884):b.disable(2884);N.cull_enable=ma;Ka?b.enable(2929):b.disable(2929);N.depth_enable=Ka;cb?b.enable(3024):b.disable(3024);N.dither=cb;kc?b.enable(32823):b.disable(32823);N.polygonOffset_enable=kc;oa?b.enable(32926):b.disable(32926);N.sample_alpha=oa;Qa?b.enable(32928):b.disable(32928);N.sample_enable=Qa;Y?b.enable(3089):
b.disable(3089);N.scissor_enable=Y;O?b.enable(2960):b.disable(2960);N.stencil_enable=O;b.blendColor(v[0],v[1],v[2],v[3]);z[0]=v[0];z[1]=v[1];z[2]=v[2];z[3]=v[3];b.blendEquationSeparate(da[0],da[1]);K[0]=da[0];K[1]=da[1];b.blendFuncSeparate(E[0],E[1],E[2],E[3]);u[0]=E[0];u[1]=E[1];u[2]=E[2];u[3]=E[3];b.colorMask(A[0],A[1],A[2],A[3]);H[0]=A[0];H[1]=A[1];H[2]=A[2];H[3]=A[3];b.cullFace(M);N.cull_face=M;b.depthFunc(R);N.depth_func=R;b.depthMask(sa);N.depth_mask=sa;b.depthRange(n[0],n[1]);F[0]=n[0];F[1]=
n[1];b.frontFace(J);N.frontFace=J;b.lineWidth(Ob);N.lineWidth=Ob;b.polygonOffset(ca[0],ca[1]);I[0]=ca[0];I[1]=ca[1];b.sampleCoverage(aa[0],aa[1]);e[0]=aa[0];e[1]=aa[1];b.scissor(h[0],h[1],h[2],h[3]);f[0]=h[0];f[1]=h[1];f[2]=h[2];f[3]=h[3];b.stencilFunc(D[0],D[1],D[2]);T[0]=D[0];T[1]=D[1];T[2]=D[2];b.stencilMask($a);N.stencil_mask=$a;b.stencilOpSeparate(V[0],V[1],V[2],V[3]);q[0]=V[0];q[1]=V[1];q[2]=V[2];q[3]=V[3];b.stencilOpSeparate(qa[0],qa[1],qa[2],qa[3]);L[0]=qa[0];L[1]=qa[1];L[2]=qa[2];L[3]=qa[3];
b.viewport(ga[0],ga[1],ga[2],ga[3]);a[0]=ga[0];a[1]=ga[1];a[2]=ga[2];a[3]=ga[3]}}},"$32,capOffset,capSize,color,direction,error,lineOffset,lineWidth,opacity,position,positionFract,scale,scaleFract,translate,translateFract,viewport":function(d,ba,r,N,g,b,x,c,v,z,da,K,E,u,A,H,n,F,ca,I,aa,e,h,f,D,T,V,q,qa,L,ga,a,l,X,ma,Ka,cb,kc,oa,Qa,Y,O,M,R,sa,J,Ob,$a){var P,t,la,fa,Ea,Na,Hb,Ha,U,ob,ea,va,bc,cc,Qc,td,wc,W,B,ka,Ca,Lb,nc,Zc,C,w,ia,ua,Q,ha,ra,G,m,Z,y,ja,pa,k,tc,S,p,Bb,yb;P=d.attributes;t=d.buffer;la=d.context;
fa=d.current;Ea=d.draw;Na=d.elements;Hb=d.extensions;Ha=d.framebuffer;U=d.gl;ob=d.isBufferArgs;ea=d.next;va=d.shader;bc=d.uniforms;cc=d.vao;Qc=ea.blend_color;td=fa.blend_color;wc=ea.blend_equation;W=fa.blend_equation;B=ea.blend_func;ka=fa.blend_func;Ca=ea.colorMask;Lb=fa.colorMask;nc=ea.depth_range;Zc=fa.depth_range;C=ea.polygonOffset_offset;w=fa.polygonOffset_offset;ia=ea.sample_coverage;ua=fa.sample_coverage;Q=ea.scissor_box;ha=fa.scissor_box;ra=ea.stencil_func;G=fa.stencil_func;m=ea.stencil_opBack;
Z=fa.stencil_opBack;y=ea.stencil_opFront;ja=fa.stencil_opFront;pa=ea.viewport;k=fa.viewport;tc={int8:5120,int16:5122,int32:5124,uint8:5121,uint16:5123,uint32:5125,"float":5126,float32:5126};S={};S.buffer=r;S.divisor=1;p={};p.buffer=N;p.divisor=1;Bb={};Bb.buffer=g;Bb.divisor=1;yb={};yb.buffer=b;yb.divisor=1;return{batch:function(b,c){var d,e,f,g,h,n;d=Ha.next;d!==Ha.cur&&(d?U.bindFramebuffer(36160,d.framebuffer):U.bindFramebuffer(36160,null),Ha.cur=d);if(fa.dirty){var r,v,B,x,D,A,N,F,z,H,Q,pa,I,T,
...
Wa=Ea.offset;for(h=0;h<c;++h){n=b[h];var wa,md,hb,Sa,Gb,db,ec,Sb,aa,Zb,Tb,bc,Ub,Ma,pb,ub,ib,Oa,Qc,Ib,cd,eb,lc,dd,dc,kb,lb,ta,qb,xa,Ua,bb,Aa,fb,Ia,Ab,zb,Ra,Kc,Jb,Za,Vb,ya,ce,Ja,Pb,gb,jb,za,fc,Da,rb,sb,Xa,Ya,mc,xc,uc,Va,Mb,Xc,Fa,yc,Pa,Ba,mb,vb,Cb,tb,vc,wb,wd,sc,ud,Mc,ld,sd,Wb,ac,Qb,Ga,Yb,nb,xb,Nb,Rb,gc,ic,Ye,Bc,Cc,Ec,Nc,Yc,Sc,Oc,Kb,Fb,Pc,Hc,Tc,hc,Vc,nd,gd,oe,Wc,Id,Ld,we,xe,Ud,Jd,Gd,bd,Fc;wa=n.viewport;md=wa.x|0;hb=wa.y|0;Sa="width"in wa?wa.width|0:la.framebufferWidth-md;Gb="height"in wa?wa.height|0:
la.framebufferHeight-hb;db=la.viewportWidth;la.viewportWidth=Sa;ec=la.viewportHeight;la.viewportHeight=Gb;U.viewport(md,hb,Sa,Gb);k[0]=md;k[1]=hb;k[2]=Sa;k[3]=Gb;Sb=n.viewport;aa=Sb.x|0;Zb=Sb.y|0;Tb="width"in Sb?Sb.width|0:la.framebufferWidth-aa;bc="height"in Sb?Sb.height|0:la.framebufferHeight-Zb;U.scissor(aa,Zb,Tb,bc);ha[0]=aa;ha[1]=Zb;ha[2]=Tb;ha[3]=bc;Ub=qa.call(this,la,n,h);Bb.offset=Ub;Ma=!1;pb=null;ub=0;ib=!1;Qc=Oa=0;Ib=1;cd=0;eb=5126;kb=dc=dd=lc=0;ob(Bb)?(Ma=!0,pb=t.createStream(34962,Bb),
...
dd,dc,kb,lc),ta.x=dd,ta.y=dc,ta.z=kb,ta.w=lc;xa=L.call(this,la,n,h);yb.offset=xa;Ua=!1;bb=null;Aa=0;fb=!1;Ab=Ia=0;zb=1;Ra=0;Kc=5126;ya=Vb=Za=Jb=0;ob(yb)?(Ua=!0,bb=t.createStream(34962,yb),Kc=bb.dtype):(bb=t.getBuffer(yb))?Kc=bb.dtype:"constant"in yb?(zb=2,"number"===typeof yb.constant?(Za=yb.constant,Vb=ya=Jb=0):(Za=0<yb.constant.length?yb.constant[0]:0,Vb=1<yb.constant.length?yb.constant[1]:0,ya=2<yb.constant.length?yb.constant[2]:0,Jb=3<yb.constant.length?yb.constant[3]:0)):(bb=ob(yb.buffer)?t.createStream(34962,
...
Mc,ac.y=ld,ac.z=sd,ac.w=ud;Ga=l.call(this,la,n,h);Yb=Ga[0];xb=Ga[1];Rb=Ga[2];ic=Ga[3];h&&nb===Yb&&Nb===xb&&gc===Rb&&Ye===ic||(nb=Yb,Nb=xb,gc=Rb,Ye=ic,U.uniform4f($a.location,Yb,xb,Rb,ic));Bc=n.lineWidth;h&&Cc===Bc||(Cc=Bc,U.uniform1f(Qa.location,Bc));Ec=n.capSize;h&&Nc===Ec||(Nc=Ec,U.uniform1f(ma.location,Ec));Yc=n.scale;Sc=Yc[0];Kb=Yc[1];h&&Oc===Sc&&Fb===Kb||(Oc=Sc,Fb=Kb,U.uniform2f(R.location,Sc,Kb));Pc=n.scaleFract;Hc=Pc[0];hc=Pc[1];h&&Tc===Hc&&Vc===hc||(Tc=Hc,Vc=hc,U.uniform2f(sa.location,Hc,
hc));nd=n.translate;gd=nd[0];Wc=nd[1];h&&oe===gd&&Id===Wc||(oe=gd,Id=Wc,U.uniform2f(J.location,gd,Wc));Ld=n.translateFract;we=Ld[0];Ud=Ld[1];h&&xe===we&&Jd===Ud||(xe=we,Jd=Ud,U.uniform2f(Ob.location,we,Ud));Gd=n.opacity;h&&bd===Gd||(bd=Gd,U.uniform1f(Y.location,Gd));Fc=n.count;0<Fc?Eb?g.drawElementsInstancedANGLE(4,36,Eb.type,Wa<<(Eb.type-5121>>1),Fc):g.drawArraysInstancedANGLE(4,Wa,36,Fc):0>Fc&&(Eb?U.drawElements(4,36,Eb.type,Wa<<(Eb.type-5121>>1)):U.drawArrays(4,Wa,36));la.viewportWidth=db;la.viewportHeight=
ec;Ma&&t.destroyStream(pb);Ua&&t.destroyStream(bb);jb&&t.destroyStream(za);Ba&&t.destroyStream(mb)}fa.dirty=!0;cc.setVAO(null);e&&(ba.cpuTime+=performance.now()-f)},draw:function(a){var b,d,e,f,g,h,l,q,n,r,B,D,N,F,L,H,Q,pa,I,T,V,ca,ga,qa,va,wc,oc,id,ed,Lc,qc,ab,Ic,Db,pc,Ta,Jc,$b,rc,aa,bc,Ac,Xb,Gc,Rc,La,Eb,Wa,wa,md,hb,Sa,Gb,db,ec,Sb,Qc,Zb,Tb,fd,Ub,Ma,pb,ub,ib,Oa,Dc,Ib,cd,eb,lc,dd,dc,kb,lb,ta,qb,xa,Ua,bb,Aa,fb,Ia,Ab,zb,Ra,Kc,Jb,Za,Vb,ya,ce,Ja,Pb,gb,jb,za,fc;b=Ha.next;b!==Ha.cur&&(b?U.bindFramebuffer(36160,
...
wd!==fa.stencil_mask&&(U.stencilMask(wd),fa.stencil_mask=wd);sc=ra[0];ud=ra[1];Mc=ra[2];if(sc!==G[0]||ud!==G[1]||Mc!==G[2])U.stencilFunc(sc,ud,Mc),G[0]=sc,G[1]=ud,G[2]=Mc;ld=y[0];sd=y[1];Wb=y[2];ac=y[3];if(ld!==ja[0]||sd!==ja[1]||Wb!==ja[2]||ac!==ja[3])U.stencilOpSeparate(ld,sd,Wb,ac),ja[0]=ld,ja[1]=sd,ja[2]=Wb,ja[3]=ac;Qb=m[0];Ga=m[1];Yb=m[2];nb=m[3];if(Qb!==Z[0]||Ga!==Z[1]||Yb!==Z[2]||nb!==Z[3])U.stencilOpSeparate(Qb,Ga,Yb,nb),Z[0]=Qb,Z[1]=Ga,Z[2]=Yb,Z[3]=nb}d=a.viewport;e=d.x|0;f=d.y|0;g="width"in
d?d.width|0:la.framebufferWidth-e;h="height"in d?d.height|0:la.framebufferHeight-f;l=la.viewportWidth;la.viewportWidth=g;q=la.viewportHeight;la.viewportHeight=h;U.viewport(e,f,g,h);k[0]=e;k[1]=f;k[2]=g;k[3]=h;U.blendColor(0,0,0,0);td[0]=0;td[1]=0;td[2]=0;td[3]=0;U.enable(3042);fa.blend_enable=!0;U.blendEquationSeparate(32774,32774);W[0]=32774;W[1]=32774;U.blendFuncSeparate(770,771,773,1);ka[0]=770;ka[1]=771;ka[2]=773;ka[3]=1;U.disable(2929);fa.depth_enable=!1;n=a.viewport;r=n.x|0;B=n.y|0;D="width"in
n?n.width|0:la.framebufferWidth-r;N="height"in n?n.height|0:la.framebufferHeight-B;U.scissor(r,B,D,N);ha[0]=r;ha[1]=B;ha[2]=D;ha[3]=N;U.enable(3089);fa.scissor_enable=!0;if(F=fa.profile)L=performance.now(),ba.count++;U.useProgram(x.program);H=Hb.angle_instanced_arrays;cc.setVAO(null);Q=c.call(this,la,a,0);Bb.offset=Q;pa=!1;I=null;T=0;V=!1;ga=ca=0;qa=1;va=0;wc=5126;Lc=ed=id=oc=0;ob(Bb)?(pa=!0,I=t.createStream(34962,Bb),wc=I.dtype):(I=t.getBuffer(Bb))?wc=I.dtype:"constant"in Bb?(qa=2,"number"===typeof Bb.constant?
...
Md,Nd,Od,ie,Ce,ze,me,Oe,Pe,Le,qe,De,Ge,He,Ie,Ee,Kd;d=a.viewport;g=d.x|0;k=d.y|0;m="width"in d?d.width|0:la.framebufferWidth-g;l="height"in d?d.height|0:la.framebufferHeight-k;q=la.viewportWidth;la.viewportWidth=m;r=la.viewportHeight;la.viewportHeight=l;w=pa[0];pa[0]=g;y=pa[1];pa[1]=k;v=pa[2];pa[2]=m;x=pa[3];pa[3]=l;G=Qc[0];Qc[0]=0;C=Qc[1];Qc[1]=0;Z=Qc[2];Qc[2]=0;W=Qc[3];Qc[3]=0;A=ea.blend_enable;ea.blend_enable=!0;N=wc[0];wc[0]=32774;M=wc[1];wc[1]=32774;L=B[0];B[0]=770;O=B[1];B[1]=771;J=B[2];B[2]=
...
Eb=bc[10];bc[10]=La;Wa=a.range;wa=bc[18];bc[18]=Wa;oa=a.scale;hb=bc[6];bc[6]=oa;Sa=a.scaleFract;ma=bc[7];bc[7]=Sa;db=a.translate;na=bc[8];bc[8]=db;Lb=a.translateFract;nc=bc[9];bc[9]=Lb;Zb=H.call(this,la,a,c);Tb=bc[3];bc[3]=Zb;$a=n.buffer;n.buffer=u;Ub=n.divisor;n.divisor=0;Ma=n.normalized;n.normalized=!1;pb=n.offset;n.offset=16;ub=n.size;n.size=0;ib=n.state;n.state=1;Oa=n.stride;n.stride=24;Qa=n.type;n.type=5126;Ib=n.w;n.w=0;Ka=n.x;n.x=0;eb=n.y;n.y=0;lc=n.z;n.z=0;Na=F.call(this,la,a,c);S.offset=Na;
...
t.createStream(34962,p.buffer):t.getBuffer(p.buffer),wb="type"in p?tc[p.type]:Pa.dtype,mb=!!p.normalized,Cb=p.size|0,vb=p.offset|0,vc=p.stride|0,Ba=p.divisor|0);Zc=e.buffer;e.buffer=Pa;Hb=e.divisor;e.divisor=Ba;Wb=e.normalized;e.normalized=mb;ac=e.offset;e.offset=vb;Qb=e.size;e.size=Cb;Ga=e.state;e.state=tb;Yb=e.stride;e.stride=vc;nb=e.type;e.type=wb;xb=e.w;e.w=cb;Nb=e.x;e.x=sc;Rb=e.y;e.y=Ha;gc=e.z;e.z=Mc;ic=h.buffer;h.buffer=E;Ye=h.divisor;h.divisor=0;Bc=h.normalized;h.normalized=!1;Cc=h.offset;
h.offset=8;Ec=h.size;h.size=0;Nc=h.state;h.state=1;Yc=h.stride;h.stride=24;Sc=h.type;h.type=5126;Oc=h.w;h.w=0;Kb=h.x;h.x=0;Fb=h.y;h.y=0;Pc=h.z;h.z=0;Hc=f.call(this,la,a,c);Bb.offset=Hc;Tc=!1;hc=null;Vc=0;nd=!1;oe=gd=0;Wc=1;kc=0;Ld=5126;Jd=Ud=xe=we=0;ob(Bb)?(Tc=!0,hc=t.createStream(34962,Bb),Ld=hc.dtype):(hc=t.getBuffer(Bb))?Ld=hc.dtype:"constant"in Bb?(Wc=2,"number"===typeof Bb.constant?(xe=Bb.constant,Ud=Jd=we=0):(xe=0<Bb.constant.length?Bb.constant[0]:0,Ud=1<Bb.constant.length?Bb.constant[1]:0,
...
y;pa[2]=v;pa[3]=x;Qc[0]=G;Qc[1]=C;Qc[2]=Z;Qc[3]=W;ea.blend_enable=A;wc[0]=N;wc[1]=M;B[0]=L;B[1]=O;B[2]=J;B[3]=ja;ea.depth_enable=z;Q[0]=Y;Q[1]=ia;Q[2]=X;Q[3]=da;ea.scissor_enable=ua;cc&&(ba.cpuTime+=performance.now()-ra);Ea.count=Ca;Ea.instances=qa;Ea.primitive=sa;bc[5]=Xb;bc[4]=Rc;bc[10]=Eb;bc[18]=wa;bc[6]=hb;bc[7]=ma;bc[8]=na;bc[9]=nc;bc[3]=Tb;n.buffer=$a;n.divisor=Ub;n.normalized=Ma;n.offset=pb;n.size=ub;n.state=ib;n.stride=Oa;n.type=Qa;n.w=Ib;n.x=Ka;n.y=eb;n.z=lc;dc&&t.destroyStream(kb);ca.buffer=
Ra;ca.divisor=Kc;ca.normalized=Jb;ca.offset=Za;ca.size=Vb;ca.state=ya;ca.stride=Ob;ca.type=Ja;ca.w=Pb;ca.x=gb;ca.y=jb;ca.z=za;I.buffer=fc;I.divisor=Da;I.normalized=rb;I.offset=sb;I.size=Xa;I.state=Ya;I.stride=mc;I.type=xc;I.w=uc;I.x=Va;I.y=Mb;I.z=Xc;yc&&t.destroyStream(Pa);e.buffer=Zc;e.divisor=Hb;e.normalized=Wb;e.offset=ac;e.size=Qb;e.state=Ga;e.stride=Yb;e.type=nb;e.w=xb;e.x=Nb;e.y=Rb;e.z=gc;h.buffer=ic;h.divisor=Ye;h.normalized=Bc;h.offset=Cc;h.size=Ec;h.state=Nc;h.stride=Yc;h.type=Sc;h.w=Oc;
h.x=Kb;h.y=Fb;h.z=Pc;Tc&&t.destroyStream(hc);D.buffer=Gd;D.divisor=bd;D.normalized=Fc;D.offset=od;D.size=hd;D.state=ad;D.stride=pd;D.type=yd;D.w=zd;D.x=ye;D.y=te;D.z=jc;de&&t.destroyStream(be);V.buffer=ie;V.divisor=Ce;V.normalized=ze;V.offset=me;V.size=Oe;V.state=Pe;V.stride=Le;V.type=qe;V.w=De;V.x=Ge;V.y=He;V.z=Ie;va.vert=Ee;va.frag=Kd;fa.dirty=!0}}},"$19,aCoord,aCoordFract,bCoord,bCoordFract,color,dashLength,dashTexture,depth,lineEnd,lineTop,opacity,scale,scaleFract,thickness,translate,translateFract,viewport":function(d,
ba,r,N,g,b,x,c,v,z,da,K,E,u,A,H,n,F,ca,I,aa,e,h,f,D,T,V,q,qa,L,ga,a,l,X,ma,Ka,cb){var kc,oa,Qa,Y,O,M,R,sa,J,Ob,$a,P,t,la,fa,Ea,Na,Hb,Ha,U,ob,ea,va,bc,cc,Qc,td,wc,W,B,ka,Ca,Lb,nc,Zc,C,w,ia,ua,Q,ha,ra,G,m;kc=d.attributes;oa=d.buffer;Qa=d.context;Y=d.current;O=d.draw;M=d.elements;R=d.extensions;sa=d.framebuffer;J=d.gl;Ob=d.isBufferArgs;$a=d.next;P=d.shader;t=d.uniforms;la=d.vao;fa=$a.blend_color;Ea=Y.blend_color;Na=$a.blend_equation;Hb=Y.blend_equation;Ha=$a.blend_func;U=Y.blend_func;ob=$a.colorMask;
...
sd,C[1]=Wb,C[2]=ac,C[3]=Qb;Ga=Lb[0];Yb=Lb[1];nb=Lb[2];xb=Lb[3];if(Ga!==nc[0]||Yb!==nc[1]||nb!==nc[2]||xb!==nc[3])J.stencilOpSeparate(Ga,Yb,nb,xb),nc[0]=Ga,nc[1]=Yb,nc[2]=nb,nc[3]=xb}n=c.viewport;t=n.x|0;k=n.y|0;w="width"in n?n.width|0:Qa.framebufferWidth-t;u="height"in n?n.height|0:Qa.framebufferHeight-k;p=Qa.viewportWidth;Qa.viewportWidth=w;v=Qa.viewportHeight;Qa.viewportHeight=u;J.viewport(t,k,w,u);ia[0]=t;ia[1]=k;ia[2]=w;ia[3]=u;J.blendColor(0,0,0,0);Ea[0]=0;Ea[1]=0;Ea[2]=0;Ea[3]=0;J.enable(3042);
...
(I.vertexAttribDivisorANGLE(Vb,0),ya.divisor=0);ce=c.scale;J.uniform2f(a.location,ce[0],ce[1]);Ja=c.scaleFract;J.uniform2f(l.location,Ja[0],Ja[1]);Pb=c.translate;J.uniform2f(ma.location,Pb[0],Pb[1]);gb=c.translateFract;J.uniform2f(Ka.location,gb[0],gb[1]);J.uniform1f(X.location,c.thickness);J.uniform1f(q.location,c.depth);jb=x.call(this,Qa,c,0);J.uniform4f(cb.location,jb[0],jb[1],jb[2],jb[3]);J.uniform1f(T.location,c.dashLength);J.uniform1f(ga.location,c.opacity);(za=c.dashTexture)&&"framebuffer"===
...
performance.now()-P);fa&&oa.destroyStream(da);vd&&oa.destroyStream($c);Fd&&oa.destroyStream(Bd);Sb&&oa.destroyStream(ge);dd&&oa.destroyStream(dc);fc.unbind()},scope:function(a,d,e){var f,h,l,q,p,r,B,x,C,D,N,M,F,L,J,I,R,U,ka,T,V,ia,X,ca,ea,la,cc,Ca,ga,qa,va,sa,td,ma,wc,aa,ed,Lc,qc,ab,Lb,Db,pc,Ta,Jc,$b,rc,nc,bc,Ac,Xb,Gc,Rc,La,Eb,Wa,wa,Ea,hb,Sa,Gb,db,ec,Sb,Qc,Zb,Tb,Ka,Ub,Ma,pb,ub,ib,Oa,Dc,Ib,ob,eb,lc,cb,dc,kb,lb,ta,qb,xa,Ua,bb,Aa,fb,Ia,Ab,zb,Ra,Kc,Jb,Za,Vb,ya,Zc,Ja,Pb,gb,jb,za,fc,Da,rb,sb,Xa,Ya,mc,xc,
uc,Va,Mb,Xc,Fa,yc,Pa,Ba,mb,vb,Cb,tb,vc,wb,Hb,sc,ud,Mc,ld,sd,Wb,ac,Qb,Ga,Yb,nb,xb,Nb,Rb,gc,ic,Ye,Bc,Cc,Ec,Nc,Yc,Sc,Oc,Kb,Fb,Pc,Hc,Tc,hc,Vc,nd,gd,oe,Wc,kc,Ld,Id,jc,Ud,Jd,Gd,bd,Fc,od,hd,ad,pd,yd,zd,ye,te,uf,ee,de,be,ue,$d,he,zc,Uc,pe,ke,Hd,Md,Nd,Od,ie,Ce,ze,me,Oe,Pe,Le,qe,De,Ge,He,Ie,Ee,Kd,Rd,Yd,ae,Je,Cd,Pd,Ae,Ke,pf,Xe,Qe,Me;f=a.viewport;h=f.x|0;l=f.y|0;q="width"in f?f.width|0:Qa.framebufferWidth-h;p="height"in f?f.height|0:Qa.framebufferHeight-l;r=Qa.viewportWidth;Qa.viewportWidth=q;B=Qa.viewportHeight;
Qa.viewportHeight=p;x=w[0];w[0]=h;C=w[1];w[1]=l;D=w[2];w[2]=q;N=w[3];w[3]=p;M=fa[0];fa[0]=0;F=fa[1];fa[1]=0;L=fa[2];fa[2]=0;J=fa[3];fa[3]=0;I=$a.blend_enable;$a.blend_enable=!0;R=Na[0];Na[0]=32774;U=Na[1];Na[1]=32774;ka=Ha[0];Ha[0]=770;T=Ha[1];Ha[1]=771;V=Ha[2];Ha[2]=773;ia=Ha[3];Ha[3]=1;X=c.call(this,Qa,a,e);ca=$a.depth_enable;$a.depth_enable=X;ea=a.viewport;la=ea.x|0;cc=ea.y|0;Ca="width"in ea?ea.width|0:Qa.framebufferWidth-la;ga="height"in ea?ea.height|0:Qa.framebufferHeight-cc;qa=W[0];W[0]=la;
...
Vc;u.divisor=nd;u.normalized=gd;u.offset=oe;u.size=Wc;u.state=kc;u.stride=Ld;u.type=Id;u.w=jc;u.x=Ud;u.y=Jd;u.z=Gd;bd&&oa.destroyStream(Fc);A.buffer=be;A.divisor=ue;A.normalized=$d;A.offset=he;A.size=zc;A.state=Uc;A.stride=pe;A.type=ke;A.w=Hd;A.x=Md;A.y=Nd;A.z=Od;H.buffer=ie;H.divisor=Ce;H.normalized=ze;H.offset=me;H.size=Oe;H.state=Pe;H.stride=Le;H.type=qe;H.w=De;H.x=Ge;H.y=He;H.z=Ie;n.buffer=Ee;n.divisor=Kd;n.normalized=Rd;n.offset=Yd;n.size=ae;n.state=Je;n.stride=Cd;n.type=Pd;n.w=Ae;n.x=Ke;n.y=
pf;n.z=Xe;P.vert=Qe;P.frag=Me;Y.dirty=!0}}},"$22,aColor,aCoord,bColor,bCoord,dashLength,dashTexture,depth,lineEnd,lineTop,miterLimit,miterMode,nextCoord,opacity,prevCoord,scale,thickness,translate,viewport":function(d,ba,r,N,g,b,x,c,v,z,da,K,E,u,A,H,n,F,ca,I,aa,e,h,f,D,T,V,q,qa,L,ga,a,l,X,ma,Ka,cb,kc,oa,Qa,Y){var O,M,R,sa,J,Ob,$a,P,t,la,fa,Ea,Na,Hb,Ha,U,ob,ea,va,bc,cc,Qc,td,wc,W,B,ka,Ca,Lb,nc,Zc,C,w,ia,ua,Q,ha,ra,G,m,Z,y,ja,pa,k;O=d.attributes;M=d.buffer;R=d.context;sa=d.current;J=d.draw;Ob=d.elements;
$a=d.extensions;P=d.framebuffer;t=d.gl;la=d.isBufferArgs;fa=d.next;Ea=d.shader;Na=d.uniforms;Hb=d.vao;Ha=fa.blend_color;U=sa.blend_color;ob=fa.blend_equation;ea=sa.blend_equation;va=fa.blend_func;bc=sa.blend_func;cc=fa.colorMask;Qc=sa.colorMask;td=fa.depth_range;wc=sa.depth_range;W=fa.polygonOffset_offset;B=sa.polygonOffset_offset;ka=fa.sample_coverage;Ca=sa.sample_coverage;Lb=fa.scissor_box;nc=sa.scissor_box;Zc=fa.stencil_func;C=sa.stencil_func;w=fa.stencil_opBack;ia=sa.stencil_opBack;ua=fa.stencil_opFront;
Q=sa.stencil_opFront;ha=fa.viewport;ra=sa.viewport;G={int8:5120,int16:5122,int32:5124,uint8:5121,uint16:5123,uint32:5125,"float":5126,float32:5126};m={divisor:1,offset:0,stride:4};Z={divisor:1,offset:8,stride:8};y={divisor:1,offset:4,stride:4};ja={divisor:1,offset:16,stride:8};pa={divisor:1,offset:24,stride:8};k={divisor:1,offset:0,stride:8};return{batch:function(c,d){var p,n,r,u,v,x;p=P.next;p!==P.cur&&(p?t.bindFramebuffer(36160,p.framebuffer):t.bindFramebuffer(36160,null),P.cur=p);if(sa.dirty){var A,
...
ia[0]||Lc!==ia[1]||qc!==ia[2]||ab!==ia[3])t.stencilOpSeparate(ed,Lc,qc,ab),ia[0]=ed,ia[1]=Lc,ia[2]=qc,ia[3]=ab}t.blendColor(0,0,0,0);U[0]=0;U[1]=0;U[2]=0;U[3]=0;t.enable(3042);sa.blend_enable=!0;t.blendEquationSeparate(32774,32774);ea[0]=32774;ea[1]=32774;t.blendFuncSeparate(770,771,773,1);bc[0]=770;bc[1]=771;bc[2]=773;bc[3]=1;t.enable(2884);sa.cull_enable=!0;t.cullFace(1029);sa.cull_face=1029;t.enable(3089);sa.scissor_enable=!0;t.disable(2960);sa.stencil_enable=!1;if(n=sa.profile)r=performance.now(),
...
nd=x.translate;gd=nd[0];Wc=nd[1];v&&oe===gd&&jc===Wc||(oe=gd,jc=Wc,t.uniform2f(Qa.location,gd,Wc));Ld=x.thickness;v&&we===Ld||(we=Ld,t.uniform1f(oa.location,Ld));xe=x.depth;v&&Ud===xe||(Ud=xe,t.uniform1f(L.location,xe));Jd=e.call(this,R,x,v);Gd=Jd[0];Fc=Jd[1];hd=Jd[2];pd=Jd[3];v&&bd===Gd&&od===Fc&&ad===hd&&yd===pd||(bd=Gd,od=Fc,ad=hd,yd=pd,t.uniform4f(Y.location,Gd,Fc,hd,pd));zd=x.miterLimit;v&&ye===zd||(ye=zd,t.uniform1f(l.location,zd));te=h.call(this,R,x,v);v&&uf===te||(uf=te,t.uniform1f(X.location,
te));ee=x.dashLength;v&&de===ee||(de=ee,t.uniform1f(q.location,ee));be=x.opacity;v&&ue===be||(ue=be,t.uniform1f(Ka.location,be));($d=x.dashTexture)&&"framebuffer"===$d._reglType&&($d=$d.color[0]);he=$d._texture;t.uniform1i(qa.location,he.bind());zc=x.count;0<zc?Jc?u.drawElementsInstancedANGLE(5,4,Jc.type,0<<(Jc.type-5121>>1),zc):u.drawArraysInstancedANGLE(5,0,4,zc):0>zc&&(Jc?t.drawElements(5,4,Jc.type,0<<(Jc.type-5121>>1)):t.drawArrays(5,0,4));R.viewportWidth=Xb;R.viewportHeight=Gc;hb&&M.destroyStream(Sa);
Dc&&M.destroyStream(Ib);Ia&&M.destroyStream(Ab);Da&&M.destroyStream(rb);vb&&M.destroyStream(Cb);nb&&M.destroyStream(xb);he.unbind()}sa.dirty=!0;Hb.setVAO(null);n&&(ba.cpuTime+=performance.now()-r)},draw:function(d){var e,h,n,u,v,A,F,E,K,z,H,I,ha,da,ca,va,na,Lb,aa,Ea,Na,Ha,Sd,Td,ob,Xd,rd,jd,vd,$c,kd,oc,id,ed,Lc,qc,ab,Ic,Db,pc,Ta,Jc,$b,rc,Fd,Bd,Ac,Xb,Gc,Rc,La,Eb,Wa,wa,md,hb,Sa,Gb,db,ec,Sb,ge,Zb,Tb,fd,Ub,Ma,pb,ub,ib,Oa,Dc,Ib,cd,eb,lc,dd,dc,kb,lb,ta,qb,xa,Ua,bb,Aa,fb,Ia,Ab,zb,Ra,Kc,Jb,Za,Vb,ya,ce,Ja,
Pb,gb,jb,za,fc,Da,rb,sb,Xa,Ya,mc,xc,uc,Va,Mb,Xc,Fa,yc,Pa,Ba,mb,vb,Cb,tb,vc,wb,wd;e=P.next;e!==P.cur&&(e?t.bindFramebuffer(36160,e.framebuffer):t.bindFramebuffer(36160,null),P.cur=e);if(sa.dirty){var sc,ud,Mc,ld,sd,Wb,ac,Qb,Ga,Yb,nb,xb,Nb,Rb,gc,ic,Ye,Bc,Cc,Ec,Nc,Yc,Sc,Oc,Kb,Fb,Pc,Hc,Tc,hc;sc=fa.dither;sc!==sa.dither&&(sc?t.enable(3024):t.disable(3024),sa.dither=sc);ud=fa.depth_func;ud!==sa.depth_func&&(t.depthFunc(ud),sa.depth_func=ud);Mc=td[0];ld=td[1];if(Mc!==wc[0]||ld!==wc[1])t.depthRange(Mc,ld),
...
Nc,Yc),C[0]=Ec,C[1]=Nc,C[2]=Yc;Sc=ua[0];Oc=ua[1];Kb=ua[2];Fb=ua[3];if(Sc!==Q[0]||Oc!==Q[1]||Kb!==Q[2]||Fb!==Q[3])t.stencilOpSeparate(Sc,Oc,Kb,Fb),Q[0]=Sc,Q[1]=Oc,Q[2]=Kb,Q[3]=Fb;Pc=w[0];Hc=w[1];Tc=w[2];hc=w[3];if(Pc!==ia[0]||Hc!==ia[1]||Tc!==ia[2]||hc!==ia[3])t.stencilOpSeparate(Pc,Hc,Tc,hc),ia[0]=Pc,ia[1]=Hc,ia[2]=Tc,ia[3]=hc}h=d.viewport;n=h.x|0;u=h.y|0;v="width"in h?h.width|0:R.framebufferWidth-n;A="height"in h?h.height|0:R.framebufferHeight-u;F=R.viewportWidth;R.viewportWidth=v;E=R.viewportHeight;
R.viewportHeight=A;t.viewport(n,u,v,A);ra[0]=n;ra[1]=u;ra[2]=v;ra[3]=A;t.blendColor(0,0,0,0);U[0]=0;U[1]=0;U[2]=0;U[3]=0;t.enable(3042);sa.blend_enable=!0;t.blendEquationSeparate(32774,32774);ea[0]=32774;ea[1]=32774;t.blendFuncSeparate(770,771,773,1);bc[0]=770;bc[1]=771;bc[2]=773;bc[3]=1;t.enable(2884);sa.cull_enable=!0;t.cullFace(1029);sa.cull_face=1029;(K=r.call(this,R,d,0))?t.enable(2929):t.disable(2929);sa.depth_enable=K;z=d.viewport;H=z.x|0;I=z.y|0;ha="width"in z?z.width|0:R.framebufferWidth-
H;da="height"in z?z.height|0:R.framebufferHeight-I;t.scissor(H,I,ha,da);nc[0]=H;nc[1]=I;nc[2]=ha;nc[3]=da;t.enable(3089);sa.scissor_enable=!0;t.disable(2960);sa.stencil_enable=!1;if(ca=sa.profile)va=performance.now(),ba.count++;t.useProgram(N.program);na=$a.angle_instanced_arrays;Hb.setVAO(null);Z.buffer=d.positionBuffer;Lb=!1;aa=null;Ea=0;Na=!1;Sd=Ha=0;Td=1;ob=0;Xd=5126;$c=vd=jd=rd=0;la(Z)?(Lb=!0,aa=M.createStream(34962,Z),Xd=aa.dtype):(aa=M.getBuffer(Z))?Xd=aa.dtype:"constant"in Z?(Td=2,"number"===
...
aa||oc.normalized!==Na||oc.offset!==Ha||oc.stride!==ob)t.bindBuffer(34962,aa.buffer),t.vertexAttribPointer(kd,id,Xd,Na,ob,Ha),oc.type=Xd,oc.size=id,oc.buffer=aa,oc.normalized=Na,oc.offset=Ha,oc.stride=ob;oc.divisor!==Ea&&(na.vertexAttribDivisorANGLE(kd,Ea),oc.divisor=Ea)}else if(oc.buffer&&(t.disableVertexAttribArray(kd),oc.buffer=null),oc.x!==jd||oc.y!==vd||oc.z!==$c||oc.w!==rd)t.vertexAttrib4f(kd,jd,vd,$c,rd),oc.x=jd,oc.y=vd,oc.z=$c,oc.w=rd;ja.buffer=d.positionBuffer;ed=!1;Lc=null;qc=0;ab=!1;Db=
...
Xb.buffer=null),Xb.x!==rc||Xb.y!==Fd||Xb.z!==Bd||Xb.w!==$b)t.vertexAttrib4f(Ac,rc,Fd,Bd,$b),Xb.x=rc,Xb.y=Fd,Xb.z=Bd,Xb.w=$b;pa.buffer=d.positionBuffer;Rc=!1;La=null;Eb=0;Wa=!1;md=wa=0;hb=1;Sa=0;Gb=5126;ge=Sb=ec=db=0;la(pa)?(Rc=!0,La=M.createStream(34962,pa),Gb=La.dtype):(La=M.getBuffer(pa))?Gb=La.dtype:"constant"in pa?(hb=2,"number"===typeof pa.constant?(ec=pa.constant,Sb=ge=db=0):(ec=0<pa.constant.length?pa.constant[0]:0,Sb=1<pa.constant.length?pa.constant[1]:0,ge=2<pa.constant.length?pa.constant[2]:
...
fd,Tb.buffer=La,Tb.normalized=Wa,Tb.offset=wa,Tb.stride=Sa;Tb.divisor!==Eb&&(na.vertexAttribDivisorANGLE(Zb,Eb),Tb.divisor=Eb)}else if(Tb.buffer&&(t.disableVertexAttribArray(Zb),Tb.buffer=null),Tb.x!==ec||Tb.y!==Sb||Tb.z!==ge||Tb.w!==db)t.vertexAttrib4f(Zb,ec,Sb,ge,db),Tb.x=ec,Tb.y=Sb,Tb.z=ge,Tb.w=db;k.buffer=d.positionBuffer;Ub=!1;Ma=null;pb=0;ub=!1;Oa=ib=0;Dc=1;Ib=0;cd=5126;dc=dd=lc=eb=0;la(k)?(Ub=!0,Ma=M.createStream(34962,k),cd=Ma.dtype):(Ma=M.getBuffer(k))?cd=Ma.dtype:"constant"in k?(Dc=2,"number"===
...
Fc;A.type=od;A.w=hd;A.x=ad;A.y=pd;A.z=yd;H.buffer=zd;H.divisor=ye;H.normalized=te;H.offset=uf;H.size=ee;H.state=de;H.stride=be;H.type=ue;H.w=$d;H.x=he;H.y=zc;H.z=Uc;n.buffer=pe;n.divisor=ke;n.normalized=Hd;n.offset=Md;n.size=Nd;n.state=Od;n.stride=ie;n.type=Ce;n.w=ze;n.x=me;n.y=Oe;n.z=Pe;Le&&M.destroyStream(qe);F.buffer=Pd;F.divisor=Ae;F.normalized=Ke;F.offset=pf;F.size=Xe;F.state=Qe;F.stride=Me;F.type=We;F.w=Ue;F.x=Re;F.y=Se;F.z=Qd;Vd&&M.destroyStream(Te);ca.buffer=Ne;ca.divisor=Be;ca.normalized=
nf;ca.offset=of;ca.size=Df;ca.state=Gf;ca.stride=Af;ca.type=Ef;ca.w=Ff;ca.x=wf;ca.y=xf;ca.z=vf;Ea.vert=yf;Ea.frag=zf;sa.dirty=!0}}},"$9,color,id,opacity,position,positionFract,scale,scaleFract,translate,translateFract":function(d,ba,r,N,g,b,x,c,v,z,da,K,E,u,A,H,n,F,ca){var I,aa,e,h,f,D,T,V,q,qa,L,ga,a,l,X,ma,Ka,cb,kc,oa,Qa,Y,O,M,R,sa,J,Ob,$a,P,t,la,fa,Ea,Na,Hb,Ha,U,ob,ea,va;I=d.attributes;aa=d.buffer;e=d.context;h=d.current;f=d.draw;D=d.elements;T=d.extensions;V=d.framebuffer;q=d.gl;qa=d.isBufferArgs;
L=d.next;ga=d.shader;a=d.uniforms;l=d.vao;X=L.blend_color;ma=h.blend_color;Ka=L.blend_equation;cb=h.blend_equation;kc=L.blend_func;oa=h.blend_func;Qa=L.colorMask;Y=h.colorMask;O=L.depth_range;M=h.depth_range;R=L.polygonOffset_offset;sa=h.polygonOffset_offset;J=L.sample_coverage;Ob=h.sample_coverage;$a=L.scissor_box;P=h.scissor_box;t=L.stencil_func;la=h.stencil_func;fa=L.stencil_opBack;Ea=h.stencil_opBack;Na=L.stencil_opFront;Hb=h.stencil_opFront;Ha=L.viewport;U=h.viewport;ob={int8:5120,int16:5122,
int32:5124,uint8:5121,uint16:5123,uint32:5125,"float":5126,float32:5126};ea={offset:8,stride:8};va={offset:8,stride:8};return{batch:function(a,b){var c,d,g,r,B,x;c=V.next;c!==V.cur&&(c?q.bindFramebuffer(36160,c.framebuffer):q.bindFramebuffer(36160,null),V.cur=c);if(h.dirty){var N,X,ga,Ha,C,w,ia,ua,Q,ha,ra,G,m,Z,y,ja,pa,k,Ka,S,p,Bb,yb,$a,kc,jc,je,Ed,re,qd,fe,se;N=L.dither;N!==h.dither&&(N?q.enable(3024):q.disable(3024),h.dither=N);X=L.depth_func;X!==h.depth_func&&(q.depthFunc(X),h.depth_func=X);ga=
O[0];Ha=O[1];if(ga!==M[0]||Ha!==M[1])q.depthRange(ga,Ha),M[0]=ga,M[1]=Ha;C=L.depth_mask;C!==h.depth_mask&&(q.depthMask(C),h.depth_mask=C);w=Qa[0];ia=Qa[1];ua=Qa[2];Q=Qa[3];if(w!==Y[0]||ia!==Y[1]||ua!==Y[2]||Q!==Y[3])q.colorMask(w,ia,ua,Q),Y[0]=w,Y[1]=ia,Y[2]=ua,Y[3]=Q;ha=L.cull_enable;ha!==h.cull_enable&&(ha?q.enable(2884):q.disable(2884),h.cull_enable=ha);ra=L.cull_face;ra!==h.cull_face&&(q.cullFace(ra),h.cull_face=ra);G=L.frontFace;G!==h.frontFace&&(q.frontFace(G),h.frontFace=G);m=L.lineWidth;m!==
h.lineWidth&&(q.lineWidth(m),h.lineWidth=m);Z=L.polygonOffset_enable;Z!==h.polygonOffset_enable&&(Z?q.enable(32823):q.disable(32823),h.polygonOffset_enable=Z);y=R[0];ja=R[1];if(y!==sa[0]||ja!==sa[1])q.polygonOffset(y,ja),sa[0]=y,sa[1]=ja;pa=L.sample_alpha;pa!==h.sample_alpha&&(pa?q.enable(32926):q.disable(32926),h.sample_alpha=pa);k=L.sample_enable;k!==h.sample_enable&&(k?q.enable(32928):q.disable(32928),h.sample_enable=k);Ka=J[0];S=J[1];if(Ka!==Ob[0]||S!==Ob[1])q.sampleCoverage(Ka,S),Ob[0]=Ka,Ob[1]=
S;p=L.stencil_mask;p!==h.stencil_mask&&(q.stencilMask(p),h.stencil_mask=p);Bb=t[0];yb=t[1];$a=t[2];if(Bb!==la[0]||yb!==la[1]||$a!==la[2])q.stencilFunc(Bb,yb,$a),la[0]=Bb,la[1]=yb,la[2]=$a;kc=Na[0];jc=Na[1];je=Na[2];Ed=Na[3];if(kc!==Hb[0]||jc!==Hb[1]||je!==Hb[2]||Ed!==Hb[3])q.stencilOpSeparate(kc,jc,je,Ed),Hb[0]=kc,Hb[1]=jc,Hb[2]=je,Hb[3]=Ed;re=fa[0];qd=fa[1];fe=fa[2];se=fa[3];if(re!==Ea[0]||qd!==Ea[1]||fe!==Ea[2]||se!==Ea[3])q.stencilOpSeparate(re,qd,fe,se),Ea[0]=re,Ea[1]=qd,Ea[2]=fe,Ea[3]=se}q.blendColor(0,
0,0,0);ma[0]=0;ma[1]=0;ma[2]=0;ma[3]=0;q.enable(3042);h.blend_enable=!0;q.blendEquationSeparate(32774,32774);cb[0]=32774;cb[1]=32774;q.blendFuncSeparate(770,771,773,1);oa[0]=770;oa[1]=771;oa[2]=773;oa[3]=1;q.disable(2929);h.depth_enable=!1;q.enable(3089);h.scissor_enable=!0;q.disable(2960);h.stencil_enable=!1;if(d=h.profile)g=performance.now(),ba.count+=b;q.useProgram(v.program);r=T.angle_instanced_arrays;var xd;l.setVAO(null);xd=f.instances;for(B=0;B<b;++B){x=a[B];var Dd,Zd,Wd,Ve,kf,af,Ad,Fe,Sd,
Td,le,Xd,rd,jd,vd,$c,kd,oc,id,ed,Lc,qc,ab,Ic,Db,pc,Ta,Jc,$b,rc,Fd,Bd,Ac,Xb,Gc,Rc,La,Eb,Wa,wa,md,hb,Sa,Gb,db,ec,Sb,ge,Zb,Tb,fd,Ub,Ma,pb,ub,ib,Oa,Dc,Ib,cd,eb,lc,dd,dc,kb,lb,ta,qb,xa,Ua,bb,Aa,fb,Ia,Ab,zb,Ra,Kc,Jb,Za,Vb;Dd=x.viewport;Zd=Dd.x|0;Wd=Dd.y|0;Ve="width"in Dd?Dd.width|0:e.framebufferWidth-Zd;kf="height"in Dd?Dd.height|0:e.framebufferHeight-Wd;af=e.viewportWidth;e.viewportWidth=Ve;Ad=e.viewportHeight;e.viewportHeight=kf;q.viewport(Zd,Wd,Ve,kf);U[0]=Zd;U[1]=Wd;U[2]=Ve;U[3]=kf;Fe=x.viewport;Sd=
Fe.x|0;Td=Fe.y|0;le="width"in Fe?Fe.width|0:e.framebufferWidth-Sd;Xd="height"in Fe?Fe.height|0:e.framebufferHeight-Td;q.scissor(Sd,Td,le,Xd);P[0]=Sd;P[1]=Td;P[2]=le;P[3]=Xd;ea.buffer=x.positionBuffer;rd=!1;jd=null;vd=0;$c=!1;oc=kd=0;id=1;ed=0;Lc=5126;Db=Ic=ab=qc=0;qa(ea)?(rd=!0,jd=aa.createStream(34962,ea),Lc=jd.dtype):(jd=aa.getBuffer(ea))?Lc=jd.dtype:"constant"in ea?(id=2,"number"===typeof ea.constant?(ab=ea.constant,Ic=Db=qc=0):(ab=0<ea.constant.length?ea.constant[0]:0,Ic=1<ea.constant.length?
ea.constant[1]:0,Db=2<ea.constant.length?ea.constant[2]:0,qc=3<ea.constant.length?ea.constant[3]:0)):(jd=qa(ea.buffer)?aa.createStream(34962,ea.buffer):aa.getBuffer(ea.buffer),Lc="type"in ea?ob[ea.type]:jd.dtype,$c=!!ea.normalized,oc=ea.size|0,kd=ea.offset|0,ed=ea.stride|0,vd=ea.divisor|0);pc=u.location;Ta=I[pc];if(1===id){Ta.buffer||q.enableVertexAttribArray(pc);Jc=oc||2;if(Ta.type!==Lc||Ta.size!==Jc||Ta.buffer!==jd||Ta.normalized!==$c||Ta.offset!==kd||Ta.stride!==ed)q.bindBuffer(34962,jd.buffer),
q.vertexAttribPointer(pc,Jc,Lc,$c,ed,kd),Ta.type=Lc,Ta.size=Jc,Ta.buffer=jd,Ta.normalized=$c,Ta.offset=kd,Ta.stride=ed;Ta.divisor!==vd&&(r.vertexAttribDivisorANGLE(pc,vd),Ta.divisor=vd)}else if(Ta.buffer&&(q.disableVertexAttribArray(pc),Ta.buffer=null),Ta.x!==ab||Ta.y!==Ic||Ta.z!==Db||Ta.w!==qc)q.vertexAttrib4f(pc,ab,Ic,Db,qc),Ta.x=ab,Ta.y=Ic,Ta.z=Db,Ta.w=qc;va.buffer=x.positionFractBuffer;$b=!1;rc=null;Fd=0;Bd=!1;Xb=Ac=0;Gc=1;Rc=0;La=5126;md=wa=Wa=Eb=0;qa(va)?($b=!0,rc=aa.createStream(34962,va),
...
I[hb];if(1===Gc){Sa.buffer||q.enableVertexAttribArray(hb);Gb=Xb||2;if(Sa.type!==La||Sa.size!==Gb||Sa.buffer!==rc||Sa.normalized!==Bd||Sa.offset!==Ac||Sa.stride!==Rc)q.bindBuffer(34962,rc.buffer),q.vertexAttribPointer(hb,Gb,La,Bd,Rc,Ac),Sa.type=La,Sa.size=Gb,Sa.buffer=rc,Sa.normalized=Bd,Sa.offset=Ac,Sa.stride=Rc;Sa.divisor!==Fd&&(r.vertexAttribDivisorANGLE(hb,Fd),Sa.divisor=Fd)}else if(Sa.buffer&&(q.disableVertexAttribArray(hb),Sa.buffer=null),Sa.x!==Wa||Sa.y!==wa||Sa.z!==md||Sa.w!==Eb)q.vertexAttrib4f(hb,
Wa,wa,md,Eb),Sa.x=Wa,Sa.y=wa,Sa.z=md,Sa.w=Eb;db=x.fill;ec=db[0];ge=db[1];Tb=db[2];Ub=db[3];B&&Sb===ec&&Zb===ge&&fd===Tb&&Ma===Ub||(Sb=ec,Zb=ge,fd=Tb,Ma=Ub,q.uniform4f(da.location,ec,ge,Tb,Ub));pb=x.scale;ub=pb[0];Oa=pb[1];B&&ib===ub&&Dc===Oa||(ib=ub,Dc=Oa,q.uniform2f(H.location,ub,Oa));Ib=x.scaleFract;cd=Ib[0];lc=Ib[1];B&&eb===cd&&dd===lc||(eb=cd,dd=lc,q.uniform2f(n.location,cd,lc));dc=x.translate;kb=dc[0];ta=dc[1];B&&lb===kb&&qb===ta||(lb=kb,qb=ta,q.uniform2f(F.location,kb,ta));xa=x.translateFract;
Ua=xa[0];Aa=xa[1];B&&bb===Ua&&fb===Aa||(bb=Ua,fb=Aa,q.uniform2f(ca.location,Ua,Aa));Ia=x.id;B&&Ab===Ia||(Ab=Ia,q.uniform1f(K.location,Ia));zb=x.opacity;B&&Ra===zb||(Ra=zb,q.uniform1f(E.location,zb));Kc=z.call(this,e,x,B);Jb=null;(Jb=(Za=qa(Kc))?D.createStream(Kc):D.getElements(Kc))&&q.bindBuffer(34963,Jb.buffer.buffer);if(Vb=Jb?Jb.vertCount:-1)0<xd?Jb?r.drawElementsInstancedANGLE(4,Vb,Jb.type,0<<(Jb.type-5121>>1),xd):r.drawArraysInstancedANGLE(4,0,Vb,xd):0>xd&&(Jb?q.drawElements(4,Vb,Jb.type,0<<(Jb.type-
5121>>1)):q.drawArrays(4,0,Vb)),e.viewportWidth=af,e.viewportHeight=Ad,rd&&aa.destroyStream(jd),$b&&aa.destroyStream(rc),Za&&D.destroyStream(Jb)}h.dirty=!0;l.setVAO(null);d&&(ba.cpuTime+=performance.now()-g)},draw:function(a){var b,c,d,g,v,x,z,X,ga,na,Ha,C,w,ia,ua,Q,ha,ra,G,m,Z,y;b=V.next;b!==V.cur&&(b?q.bindFramebuffer(36160,b.framebuffer):q.bindFramebuffer(36160,null),V.cur=b);if(h.dirty){b=L.dither;b!==h.dither&&(b?q.enable(3024):q.disable(3024),h.dither=b);b=L.depth_func;b!==h.depth_func&&(q.depthFunc(b),
h.depth_func=b);b=O[0];x=O[1];if(b!==M[0]||x!==M[1])q.depthRange(b,x),M[0]=b,M[1]=x;b=L.depth_mask;b!==h.depth_mask&&(q.depthMask(b),h.depth_mask=b);b=Qa[0];x=Qa[1];c=Qa[2];d=Qa[3];if(b!==Y[0]||x!==Y[1]||c!==Y[2]||d!==Y[3])q.colorMask(b,x,c,d),Y[0]=b,Y[1]=x,Y[2]=c,Y[3]=d;b=L.cull_enable;b!==h.cull_enable&&(b?q.enable(2884):q.disable(2884),h.cull_enable=b);b=L.cull_face;b!==h.cull_face&&(q.cullFace(b),h.cull_face=b);b=L.frontFace;b!==h.frontFace&&(q.frontFace(b),h.frontFace=b);b=L.lineWidth;b!==h.lineWidth&&
(q.lineWidth(b),h.lineWidth=b);b=L.polygonOffset_enable;b!==h.polygonOffset_enable&&(b?q.enable(32823):q.disable(32823),h.polygonOffset_enable=b);b=R[0];x=R[1];if(b!==sa[0]||x!==sa[1])q.polygonOffset(b,x),sa[0]=b,sa[1]=x;b=L.sample_alpha;b!==h.sample_alpha&&(b?q.enable(32926):q.disable(32926),h.sample_alpha=b);b=L.sample_enable;b!==h.sample_enable&&(b?q.enable(32928):q.disable(32928),h.sample_enable=b);b=J[0];x=J[1];if(b!==Ob[0]||x!==Ob[1])q.sampleCoverage(b,x),Ob[0]=b,Ob[1]=x;b=L.stencil_mask;b!==
h.stencil_mask&&(q.stencilMask(b),h.stencil_mask=b);b=t[0];x=t[1];c=t[2];if(b!==la[0]||x!==la[1]||c!==la[2])q.stencilFunc(b,x,c),la[0]=b,la[1]=x,la[2]=c;b=Na[0];x=Na[1];c=Na[2];d=Na[3];if(b!==Hb[0]||x!==Hb[1]||c!==Hb[2]||d!==Hb[3])q.stencilOpSeparate(b,x,c,d),Hb[0]=b,Hb[1]=x,Hb[2]=c,Hb[3]=d;b=fa[0];x=fa[1];c=fa[2];d=fa[3];if(b!==Ea[0]||x!==Ea[1]||c!==Ea[2]||d!==Ea[3])q.stencilOpSeparate(b,x,c,d),Ea[0]=b,Ea[1]=x,Ea[2]=c,Ea[3]=d}b=a.viewport;c=b.x|0;d=b.y|0;g="width"in b?b.width|0:e.framebufferWidth-
c;v="height"in b?b.height|0:e.framebufferHeight-d;b=e.viewportWidth;e.viewportWidth=g;x=e.viewportHeight;e.viewportHeight=v;q.viewport(c,d,g,v);U[0]=c;U[1]=d;U[2]=g;U[3]=v;q.blendColor(0,0,0,0);ma[0]=0;ma[1]=0;ma[2]=0;ma[3]=0;q.enable(3042);h.blend_enable=!0;q.blendEquationSeparate(32774,32774);cb[0]=32774;cb[1]=32774;q.blendFuncSeparate(770,771,773,1);oa[0]=770;oa[1]=771;oa[2]=773;oa[3]=1;q.disable(2929);h.depth_enable=!1;v=a.viewport;c=v.x|0;d=v.y|0;g="width"in v?v.width|0:e.framebufferWidth-c;
v="height"in v?v.height|0:e.framebufferHeight-d;q.scissor(c,d,g,v);P[0]=c;P[1]=d;P[2]=g;P[3]=v;q.enable(3089);h.scissor_enable=!0;q.disable(2960);h.stencil_enable=!1;if(c=h.profile)z=performance.now(),ba.count++;q.useProgram(r.program);d=T.angle_instanced_arrays;l.setVAO(null);ea.buffer=a.positionBuffer;g=!1;X=0;ga=!1;Ha=na=0;C=1;w=0;ia=5126;ra=ha=Q=ua=0;qa(ea)?(g=!0,v=aa.createStream(34962,ea),ia=v.dtype):(v=aa.getBuffer(ea))?ia=v.dtype:"constant"in ea?(C=2,"number"===typeof ea.constant?(Q=ea.constant,
ha=ra=ua=0):(Q=0<ea.constant.length?ea.constant[0]:0,ha=1<ea.constant.length?ea.constant[1]:0,ra=2<ea.constant.length?ea.constant[2]:0,ua=3<ea.constant.length?ea.constant[3]:0)):(v=qa(ea.buffer)?aa.createStream(34962,ea.buffer):aa.getBuffer(ea.buffer),ia="type"in ea?ob[ea.type]:v.dtype,ga=!!ea.normalized,Ha=ea.size|0,na=ea.offset|0,w=ea.stride|0,X=ea.divisor|0);G=u.location;m=I[G];if(1===C){m.buffer||q.enableVertexAttribArray(G);Ha=Ha||2;if(m.type!==ia||m.size!==Ha||m.buffer!==v||m.normalized!==ga||
m.offset!==na||m.stride!==w)q.bindBuffer(34962,v.buffer),q.vertexAttribPointer(G,Ha,ia,ga,w,na),m.type=ia,m.size=Ha,m.buffer=v,m.normalized=ga,m.offset=na,m.stride=w;m.divisor!==X&&(d.vertexAttribDivisorANGLE(G,X),m.divisor=X)}else if(m.buffer&&(q.disableVertexAttribArray(G),m.buffer=null),m.x!==Q||m.y!==ha||m.z!==ra||m.w!==ua)q.vertexAttrib4f(G,Q,ha,ra,ua),m.x=Q,m.y=ha,m.z=ra,m.w=ua;va.buffer=a.positionFractBuffer;X=!1;na=0;w=!1;ua=ia=0;Q=1;G=0;m=5126;y=Z=ra=ha=0;qa(va)?(X=!0,ga=aa.createStream(34962,
...
Q){C.buffer||q.enableVertexAttribArray(Ha);ua=ua||2;if(C.type!==m||C.size!==ua||C.buffer!==ga||C.normalized!==w||C.offset!==ia||C.stride!==G)q.bindBuffer(34962,ga.buffer),q.vertexAttribPointer(Ha,ua,m,w,G,ia),C.type=m,C.size=ua,C.buffer=ga,C.normalized=w,C.offset=ia,C.stride=G;C.divisor!==na&&(d.vertexAttribDivisorANGLE(Ha,na),C.divisor=na)}else if(C.buffer&&(q.disableVertexAttribArray(Ha),C.buffer=null),C.x!==ra||C.y!==Z||C.z!==y||C.w!==ha)q.vertexAttrib4f(Ha,ra,Z,y,ha),C.x=ra,C.y=Z,C.z=y,C.w=ha;
na=a.fill;q.uniform4f(da.location,na[0],na[1],na[2],na[3]);na=a.scale;q.uniform2f(H.location,na[0],na[1]);na=a.scaleFract;q.uniform2f(n.location,na[0],na[1]);na=a.translate;q.uniform2f(F.location,na[0],na[1]);na=a.translateFract;q.uniform2f(ca.location,na[0],na[1]);q.uniform1f(K.location,a.id);q.uniform1f(E.location,a.opacity);na=N.call(this,e,a,0);(na=(a=qa(na))?D.createStream(na):D.getElements(na))&&q.bindBuffer(34963,na.buffer.buffer);if(w=na?na.vertCount:-1)ia=f.instances,0<ia?na?d.drawElementsInstancedANGLE(4,
w,na.type,0<<(na.type-5121>>1),ia):d.drawArraysInstancedANGLE(4,0,w,ia):0>ia&&(na?q.drawElements(4,w,na.type,0<<(na.type-5121>>1)):q.drawArrays(4,0,w)),h.dirty=!0,l.setVAO(null),e.viewportWidth=b,e.viewportHeight=x,c&&(ba.cpuTime+=performance.now()-z),g&&aa.destroyStream(v),X&&aa.destroyStream(ga),a&&D.destroyStream(na)},scope:function(d,l,q){var n,r,t,v,u,A,N,F,E,C,w,M,z,K,H,O,G,m,Z,y,I,J,k,P,S,p,R,U,T,Y,da,V,fa,ca,na,la,sa,ma,oa,Ea,Na,Qa,cb,Ob,Ad,Hb,Sd,Td,le,Xd,rd,jd,vd,$c,kd,oc,id,ed,Lc,qc,ab,
Ic,Db,pc,Ta,Jc,$b,rc,Fd,Bd,Ac,Xb,Gc,Rc,La,Eb,Wa,wa,md,hb,Sa,Gb,db,ec,Sb,ge,Zb,Tb,fd,Ub,Ma,pb,ub,ib,Oa,Dc,Ib,cd,eb,lc,dd,dc,kb,lb,ta,qb,xa,Ua,bb,Aa,fb,Ia,Ab,zb;n=d.viewport;r=n.x|0;t=n.y|0;v="width"in n?n.width|0:e.framebufferWidth-r;u="height"in n?n.height|0:e.framebufferHeight-t;A=e.viewportWidth;e.viewportWidth=v;N=e.viewportHeight;e.viewportHeight=u;F=Ha[0];Ha[0]=r;E=Ha[1];Ha[1]=t;C=Ha[2];Ha[2]=v;w=Ha[3];Ha[3]=u;M=X[0];X[0]=0;z=X[1];X[1]=0;K=X[2];X[2]=0;H=X[3];X[3]=0;O=L.blend_enable;L.blend_enable=
!0;G=Ka[0];Ka[0]=32774;m=Ka[1];Ka[1]=32774;Z=kc[0];kc[0]=770;y=kc[1];kc[1]=771;I=kc[2];kc[2]=773;J=kc[3];kc[3]=1;k=L.depth_enable;L.depth_enable=!1;P=d.viewport;S=P.x|0;p=P.y|0;R="width"in P?P.width|0:e.framebufferWidth-S;U="height"in P?P.height|0:e.framebufferHeight-p;T=$a[0];$a[0]=S;Y=$a[1];$a[1]=p;da=$a[2];$a[2]=R;V=$a[3];$a[3]=U;fa=L.scissor_enable;L.scissor_enable=!0;ca=L.stencil_enable;L.stencil_enable=!1;if(na=h.profile)la=performance.now(),ba.count++;sa=g.call(this,e,d,q);ma=null;ma=(oa=qa(sa))?
D.createStream(sa):D.getElements(sa);Ea=f.elements;f.elements=ma;Na=f.offset;f.offset=0;Qa=ma?ma.vertCount:-1;cb=f.count;f.count=Qa;Ob=f.primitive;f.primitive=4;Ad=d.fill;Hb=a[14];a[14]=Ad;Sd=d.id;Td=a[31];a[31]=Sd;le=d.opacity;Xd=a[10];a[10]=le;rd=e.pixelRatio;jd=a[34];a[34]=rd;vd=d.scale;$c=a[6];a[6]=vd;kd=d.scaleFract;oc=a[7];a[7]=kd;id=d.translate;ed=a[8];a[8]=id;Lc=d.translateFract;qc=a[9];a[9]=Lc;ab=b.call(this,e,d,q);Ic=a[3];a[3]=ab;ea.buffer=d.positionBuffer;Db=!1;pc=null;Ta=0;Jc=!1;rc=$b=
...
rc=ea.size|0,$b=ea.offset|0,Bd=ea.stride|0,Ta=ea.divisor|0);Eb=x.buffer;x.buffer=pc;Wa=x.divisor;x.divisor=Ta;wa=x.normalized;x.normalized=Jc;md=x.offset;x.offset=$b;hb=x.size;x.size=rc;Sa=x.state;x.state=Fd;Gb=x.stride;x.stride=Bd;db=x.type;x.type=Ac;ec=x.w;x.w=Xb;Sb=x.x;x.x=Gc;ge=x.y;x.y=Rc;Zb=x.z;x.z=La;va.buffer=d.positionFractBuffer;Tb=!1;fd=null;Ub=0;Ma=!1;ub=pb=0;ib=1;Oa=0;Dc=5126;lc=eb=cd=Ib=0;qa(va)?(Tb=!0,fd=aa.createStream(34962,va),Dc=fd.dtype):(fd=aa.getBuffer(va))?Dc=fd.dtype:"constant"in
va?(ib=2,"number"===typeof va.constant?(cd=va.constant,eb=lc=Ib=0):(cd=0<va.constant.length?va.constant[0]:0,eb=1<va.constant.length?va.constant[1]:0,lc=2<va.constant.length?va.constant[2]:0,Ib=3<va.constant.length?va.constant[3]:0)):(fd=qa(va.buffer)?aa.createStream(34962,va.buffer):aa.getBuffer(va.buffer),Dc="type"in va?ob[va.type]:fd.dtype,Ma=!!va.normalized,ub=va.size|0,pb=va.offset|0,Oa=va.stride|0,Ub=va.divisor|0);dd=c.buffer;c.buffer=fd;dc=c.divisor;c.divisor=Ub;kb=c.normalized;c.normalized=
Ma;lb=c.offset;c.offset=pb;ta=c.size;c.size=ub;qb=c.state;c.state=ib;xa=c.stride;c.stride=Oa;Ua=c.type;c.type=Dc;bb=c.w;c.w=Ib;Aa=c.x;c.x=cd;fb=c.y;c.y=eb;Ia=c.z;c.z=lc;Ab=ga.vert;ga.vert=42;zb=ga.frag;ga.frag=41;h.dirty=!0;l(e,d,q);e.viewportWidth=A;e.viewportHeight=N;Ha[0]=F;Ha[1]=E;Ha[2]=C;Ha[3]=w;X[0]=M;X[1]=z;X[2]=K;X[3]=H;L.blend_enable=O;Ka[0]=G;Ka[1]=m;kc[0]=Z;kc[1]=y;kc[2]=I;kc[3]=J;L.depth_enable=k;$a[0]=T;$a[1]=Y;$a[2]=da;$a[3]=V;L.scissor_enable=fa;L.stencil_enable=ca;na&&(ba.cpuTime+=
performance.now()-la);oa&&D.destroyStream(ma);f.elements=Ea;f.offset=Na;f.count=cb;f.primitive=Ob;a[14]=Hb;a[31]=Td;a[10]=Xd;a[34]=jd;a[6]=$c;a[7]=oc;a[8]=ed;a[9]=qc;a[3]=Ic;Db&&aa.destroyStream(pc);x.buffer=Eb;x.divisor=Wa;x.normalized=wa;x.offset=md;x.size=hb;x.state=Sa;x.stride=Gb;x.type=db;x.w=ec;x.x=Sb;x.y=ge;x.z=Zb;Tb&&aa.destroyStream(fd);c.buffer=dd;c.divisor=dc;c.normalized=kb;c.offset=lb;c.size=ta;c.state=qb;c.stride=xa;c.type=Ua;c.w=bb;c.x=Aa;c.y=fb;c.z=Ia;ga.vert=Ab;ga.frag=zb;h.dirty=
!0}}},"$45,borderColorId,borderSize,colorId,constPointSize,isActive,markerTexture,opacity,paletteSize,paletteTexture,pixelRatio,scale,scaleFract,size,translate,translateFract,x,xFract,y,yFract":function(d,ba,r,N,g,b,x,c,v,z,da,K,E,u,A,H,n,F,ca,I,aa,e,h,f,D,T,V,q,qa,L,ga,a,l,X,ma,Ka,cb,kc,oa,Qa,Y,O,M,R,sa,J,Ob,$a,P,t,la,fa,Ea,Na,Hb,Ha,U,ob,ea,va,bc,cc,Qc,td,wc){var W,B,ka,Ca,Lb,nc,Zc,C,w,ia,ua,Q,ha,ra,G,m,Z,y,ja,pa,k,tc,S,p,Bb,yb,jc,ne,ve,je,Ed,re,qd,fe,se,xd,Dd,Zd,Wd;W=d.attributes;B=d.buffer;ka=
d.context;Ca=d.current;Lb=d.draw;nc=d.elements;Zc=d.extensions;C=d.framebuffer;w=d.gl;ia=d.isBufferArgs;ua=d.next;Q=d.shader;ha=d.uniforms;ra=d.vao;G=ua.blend_color;m=Ca.blend_color;Z=ua.blend_equation;y=Ca.blend_equation;ja=ua.blend_func;pa=Ca.blend_func;k=ua.colorMask;tc=Ca.colorMask;S=ua.depth_range;p=Ca.depth_range;Bb=ua.polygonOffset_offset;yb=Ca.polygonOffset_offset;jc=ua.sample_coverage;ne=Ca.sample_coverage;ve=ua.scissor_box;je=Ca.scissor_box;Ed=ua.stencil_func;re=Ca.stencil_func;qd=ua.stencil_opBack;
...
null),jb.x!==kc||jb.y!==Ja||jb.z!==Pb||jb.w!==ya)w.vertexAttrib4f(gb,kc,Ja,Pb,ya),jb.x=kc,jb.y=Ja,jb.z=Pb,jb.w=ya;fc=c.call(this,ka,a,0);Da=!1;rb=null;sb=0;Xa=!1;mc=Ya=0;xc=1;uc=0;Va=5126;yc=Fa=Xc=Mb=0;ia(fc)?(Da=!0,rb=B.createStream(34962,fc),Va=rb.dtype):(rb=B.getBuffer(fc))?Va=rb.dtype:"constant"in fc?(xc=2,"number"===typeof fc.constant?(Xc=fc.constant,Fa=yc=Mb=0):(Xc=0<fc.constant.length?fc.constant[0]:0,Fa=1<fc.constant.length?fc.constant[1]:0,yc=2<fc.constant.length?fc.constant[2]:0,Mb=3<fc.constant.length?
...
0,bd=Wc.stride|0,Zd=Wc.divisor|0);yd=f.buffer;f.buffer=jc;zd=f.divisor;f.divisor=Zd;fe=f.normalized;f.normalized=xd;re=f.offset;f.offset=Ud;se=f.size;f.size=Jd;ee=f.state;f.state=Gd;de=f.stride;f.stride=bd;be=f.type;f.type=Fc;ne=f.w;f.w=od;$d=f.x;f.x=hd;he=f.y;f.y=ad;zc=f.z;f.z=pd;Uc=D.call(this,ka,b,d);pe=!1;ke=null;Hd=0;Md=!1;Od=Nd=0;ie=1;Ce=0;ze=5126;Le=Pe=Oe=me=0;ia(Uc)?(pe=!0,ke=B.createStream(34962,Uc),ze=ke.dtype):(ke=B.getBuffer(Uc))?ze=ke.dtype:"constant"in Uc?(ie=2,"number"===typeof Uc.constant?
...
0,Se=3<Pd.constant.length?Pd.constant[3]:0)):(Ke=ia(Pd.buffer)?B.createStream(34962,Pd.buffer):B.getBuffer(Pd.buffer),Re="type"in Pd?Wd[Pd.type]:Ke.dtype,Xe=!!Pd.normalized,Me=Pd.size|0,Qe=Pd.offset|0,Ue=Pd.stride|0,jf=Pd.divisor|0);ef=q.buffer;q.buffer=Ke;lf=q.divisor;q.divisor=jf;bf=q.normalized;q.normalized=Xe;ff=q.offset;q.offset=Qe;gf=q.size;q.size=Me;hf=q.state;q.state=We;qf=q.stride;q.stride=Ue;mf=q.type;q.type=Re;rf=q.w;q.w=Se;Bf=q.x;q.x=Qd;Cf=q.y;q.y=Vd;Ne=q.z;q.z=Te;Be=qa.call(this,ka,b,
...
ha[47]=Oa;ha[34]=Ib;ha[6]=eb;ha[7]=tc;ha[8]=kb;ha[9]=ta;xa&&B.destroyStream(Ua);F.buffer=ya;F.divisor=Hb;F.normalized=Ja;F.offset=Pb;F.size=gb;F.state=jb;F.stride=za;F.type=fc;F.w=Da;F.x=rb;F.y=sb;F.z=Xa;mc&&B.destroyStream(xc);I.buffer=tb;I.divisor=vc;I.normalized=wb;I.offset=cc;I.size=sc;I.state=Qc;I.stride=Mc;I.type=kc;I.w=qd;I.x=Wb;I.y=ac;I.z=Qb;Yb&&B.destroyStream(nb);e.buffer=Sc;e.divisor=Oc;e.normalized=Kb;e.offset=Fb;e.size=Pc;e.state=Hc;e.stride=Tc;e.type=hc;e.w=Vc;e.x=nd;e.y=gd;e.z=Ed;Zc&&
B.destroyStream(jc);f.buffer=yd;f.divisor=zd;f.normalized=fe;f.offset=re;f.size=se;f.state=ee;f.stride=de;f.type=be;f.w=ne;f.x=$d;f.y=he;f.z=zc;pe&&B.destroyStream(ke);T.buffer=qe;T.divisor=De;T.normalized=Ge;T.offset=He;T.size=Ie;T.state=Ee;T.stride=Kd;T.type=Rd;T.w=Yd;T.x=ae;T.y=Je;T.z=Cd;Ae&&B.destroyStream(Ke);q.buffer=ef;q.divisor=lf;q.normalized=bf;q.offset=ff;q.size=gf;q.state=hf;q.stride=qf;q.type=mf;q.w=rf;q.x=Bf;q.y=Cf;q.z=Ne;nf&&B.destroyStream(of);L.buffer=Jf;L.divisor=Kf;L.normalized=
Lf;L.offset=sf;L.size=Qf;L.state=Hf;L.stride=tf;L.type=cg;L.w=Rf;L.x=Sf;L.y=pg;L.z=cf;Mf&&B.destroyStream(Nf);a.buffer=qg;a.divisor=rg;a.normalized=sg;a.offset=tg;a.size=ug;a.state=vg;a.stride=wg;a.type=xg;a.w=yg;a.x=zg;a.y=Ag;a.z=df;Of&&B.destroyStream(Pf);X.buffer=Bg;X.divisor=Cg;X.normalized=Dg;X.offset=Eg;X.size=Fg;X.state=Gg;X.stride=Hg;X.type=Ig;X.w=Jg;X.x=Kg;X.y=Lg;X.z=Mg;Q.vert=Ng;Q.frag=Og;Ca.dirty=!0}}},"$45,borderColorId,borderSize,colorId,constPointSize,isActive,opacity,paletteSize,paletteTexture,pixelRatio,scale,scaleFract,size,translate,translateFract,x,xFract,y,yFract":function(d,
z,r,N,g,b,x,c,v,na,da,K,E,u,A,H,n,F,ca,I,aa,e,h,f,D,T,V,q,qa,L,ga,a,l,X,ma,Ka,cb,kc,oa,Qa,Y,O,M,R,sa,J,Ob,$a,P,t,la,fa,Ea,Na,Hb,Ha,U,ob,ea,va,bc,cc,Qc,td){var wc,W,B,ka,Ca,Lb,jc,Zc,C,w,ia,ua,Q,ha,ra,G,m,Z,y,ja,pa,k,tc,S,p,Bb,yb,jf,ne,ve,je,Ed,re,qd,fe,se,xd,Dd,Zd;wc=d.attributes;W=d.buffer;B=d.context;ka=d.current;Ca=d.draw;Lb=d.elements;jc=d.extensions;Zc=d.framebuffer;C=d.gl;w=d.isBufferArgs;ia=d.next;ua=d.shader;Q=d.uniforms;ha=d.vao;ra=ia.blend_color;G=ka.blend_color;m=ia.blend_equation;Z=ka.blend_equation;
...
Xa&&W.destroyStream(Ya),wb&&W.destroyStream(wd),ic&&W.destroyStream(xd),gd&&W.destroyStream(oe),zd&&W.destroyStream(ye),Od&&W.destroyStream(ie),ae&&W.destroyStream(Je),Qf&&Lb.destroyStream(sf)}sa.unbind();ka.dirty=!0;ha.setVAO(null);d&&(z.cpuTime+=performance.now()-e)},draw:function(a){var d,e,f,h,l,n,q,y,A,D,F,J,L,M,O,H,I,R,Q,T,V,X,Y,ca,ga,aa,ua,ra,oa,qa,sa,ma,Ka,La,Qa,Wa,wa,cb,hb,Sa,Gb,db,ec,Sb,kc,Zb,Tb,fd,Ub,Ma,pb,ub,ib,Oa,Dc,Ib,cd,eb,lc,dd,dc,kb,lb,ta,qb,xa,Ua,bb,Aa,fb,Ia,Ab,zb,Ra,Kc,Jb,Za,Vb,
ya,xd,Ja,Pb,gb,jb,za,fc,Da,rb,sb,Xa,Ya,mc,xc,uc,Va,Mb,Xc,Fa,yc,Pa,Ba,mb,vb,Cb,tb,vc,wb,wd,sc,ud,Mc,ld,sd,Wb,ac,Qb,Ga,Yb,nb,xb,Nb,Rb,gc,ic,ne,Bc,Cc,Ec,Nc,Yc,Sc,Oc,Kb,Fb,Pc,Hc,Tc,hc,Vc,nd,gd,oe,Wc,Id,Ld,we,xe,Ud,Jd,Gd,bd,Fc,od,hd,ad,pd,yd,zd,ye,te,uf,ee,de,be,ue,$d,he,zc,Uc,pe,ke,Hd,Md,Nd,Od,ie,Ce,ze,me,Oe;d=Zc.next;d!==Zc.cur&&(d?C.bindFramebuffer(36160,d.framebuffer):C.bindFramebuffer(36160,null),Zc.cur=d);if(ka.dirty){var Pe,Le,qe,De,Ge,He,Ie,Ee,Kd,Rd,Yd,ae,Je,Cd,Pd,Ae,Ke,pf,Xe,Qe,Me,We,Ue,Re,Se,
...
Ia)}else if(gb.buffer&&(C.disableVertexAttribArray(Pb),gb.buffer=null),gb.x!==ya||gb.y!==xd||gb.z!==Ja||gb.w!==Vb)C.vertexAttrib4f(Pb,ya,xd,Ja,Vb),gb.x=ya,gb.y=xd,gb.z=Ja,gb.w=Vb;za=c.call(this,B,a,0);fc=!1;Da=null;rb=0;sb=!1;Ya=Xa=0;mc=1;xc=0;uc=5126;Fa=Xc=Mb=Va=0;w(za)?(fc=!0,Da=W.createStream(34962,za),uc=Da.dtype):(Da=W.getBuffer(za))?uc=Da.dtype:"constant"in za?(mc=2,"number"===typeof za.constant?(Mb=za.constant,Xc=Fa=Va=0):(Mb=0<za.constant.length?za.constant[0]:0,Xc=1<za.constant.length?za.constant[1]:
...
Qb.offset|0,ic=Qb.stride|0,nb=Qb.divisor|0);Yc=e.buffer;e.buffer=Yb;Sc=e.divisor;e.divisor=nb;Oc=e.normalized;e.normalized=xb;Kb=e.offset;e.offset=Nb;Fb=e.size;e.size=Rb;Pc=e.state;e.state=gc;Hc=e.stride;e.stride=ic;Tc=e.type;e.type=Ed;hc=e.w;e.w=Bc;Vc=e.x;e.x=Cc;Zc=e.y;e.y=Ec;gd=e.z;e.z=Nc;nc=h.call(this,B,b,d);Wc=!1;Dd=null;Ld=0;fe=!1;Ud=re=0;Jd=1;Gd=0;bd=5126;ad=hd=od=Fc=0;w(nc)?(Wc=!0,Dd=W.createStream(34962,nc),bd=Dd.dtype):(Dd=W.getBuffer(nc))?bd=Dd.dtype:"constant"in nc?(Jd=2,"number"===typeof nc.constant?
(od=nc.constant,hd=ad=Fc=0):(od=0<nc.constant.length?nc.constant[0]:0,hd=1<nc.constant.length?nc.constant[1]:0,ad=2<nc.constant.length?nc.constant[2]:0,Fc=3<nc.constant.length?nc.constant[3]:0)):(Dd=w(nc.buffer)?W.createStream(34962,nc.buffer):W.getBuffer(nc.buffer),bd="type"in nc?Zd[nc.type]:Dd.dtype,fe=!!nc.normalized,Ud=nc.size|0,re=nc.offset|0,Gd=nc.stride|0,Ld=nc.divisor|0);pd=f.buffer;f.buffer=Dd;yd=f.divisor;f.divisor=Ld;zd=f.normalized;f.normalized=fe;ve=f.offset;f.offset=re;se=f.size;f.size=
Ud;jf=f.state;f.state=Jd;ee=f.stride;f.stride=Gd;de=f.type;f.type=bd;be=f.w;f.w=Fc;ue=f.x;f.x=od;$d=f.y;f.y=hd;he=f.z;f.z=ad;zc=D.call(this,B,b,d);Uc=!1;pe=null;ke=0;Hd=!1;Nd=Md=0;Od=1;ie=0;Ce=5126;Pe=Oe=me=ze=0;w(zc)?(Uc=!0,pe=W.createStream(34962,zc),Ce=pe.dtype):(pe=W.getBuffer(zc))?Ce=pe.dtype:"constant"in zc?(Od=2,"number"===typeof zc.constant?(me=zc.constant,Oe=Pe=ze=0):(me=0<zc.constant.length?zc.constant[0]:0,Oe=1<zc.constant.length?zc.constant[1]:0,Pe=2<zc.constant.length?zc.constant[2]:
...
pf=!!Cd.normalized,Qe=Cd.size|0,Xe=Cd.offset|0,We=Cd.stride|0,Ke=Cd.divisor|0);Te=q.buffer;q.buffer=Ae;ef=q.divisor;q.divisor=Ke;lf=q.normalized;q.normalized=pf;bf=q.offset;q.offset=Xe;ff=q.size;q.size=Qe;gf=q.state;q.state=Me;hf=q.stride;q.stride=We;qf=q.type;q.type=Ue;mf=q.w;q.w=Re;rf=q.x;q.x=Se;Bf=q.y;q.y=Qd;Cf=q.z;q.z=Vd;Ne=qa.call(this,B,b,d);Be=!1;nf=null;of=0;Df=!1;Af=Gf=0;Ef=1;Ff=0;wf=5126;zf=yf=vf=xf=0;w(Ne)?(Be=!0,nf=W.createStream(34962,Ne),wf=nf.dtype):(nf=W.getBuffer(Ne))?wf=nf.dtype:
...
Rb,gc,ic,Ye,Bc,Cc,Ec,Nc,Yc,Sc,Oc,Kb,Fb,Pc,Hc,Tc,hc,Vc,nd;vb=ca.call(this,M,H,E);E&&Cb===vb||(Cb=vb,P.uniform1f(ga.location,vb));tb=I.call(this,M,H,E);E&&vc===tb||(vc=tb,P.uniform1f(l.location,tb));wb=H.align;E&&wd===wb||(wd=wb,P.uniform1f(f.location,wb));sc=H.baseline;E&&ud===sc||(ud=sc,P.uniform1f(q.location,sc));Mc=H.color;ld=Mc[0];Wb=Mc[1];Qb=Mc[2];Yb=Mc[3];E&&sd===ld&&ac===Wb&&Ga===Qb&&nb===Yb||(sd=ld,ac=Wb,Ga=Qb,nb=Yb,P.uniform4f(a.location,ld,Wb,Qb,Yb));xb=aa.call(this,M,H,E);Nb=xb[0];gc=xb[1];
E&&Rb===Nb&&ic===gc||(Rb=Nb,ic=gc,P.uniform2f(V.location,Nb,gc));Ye=e.call(this,M,H,E);Bc=Ye[0];Ec=Ye[1];E&&Cc===Bc&&Nc===Ec||(Cc=Bc,Nc=Ec,P.uniform2f(T.location,Bc,Ec));Yc=H.positionOffset;Sc=Yc[0];Kb=Yc[1];E&&Oc===Sc&&Fb===Kb||(Oc=Sc,Fb=Kb,P.uniform2f(Ka.location,Sc,Kb));Pc=H.opacity;E&&Hc===Pc||(Hc=Pc,P.uniform1f(X.location,Pc));(Tc=h.call(this,M,H,E))&&"framebuffer"===Tc._reglType&&(Tc=Tc.color[0]);hc=Tc._texture;P.uniform1i(D.location,hc.bind());Vc=H.offset;if(nd=H.count)0<mb?Ba?N.drawElementsInstancedANGLE(0,
nd,Ba.type,Vc<<(Ba.type-5121>>1),mb):N.drawArraysInstancedANGLE(0,Vc,nd,mb):0>mb&&(Ba?P.drawElements(0,nd,Ba.type,Vc<<(Ba.type-5121>>1)):P.drawArrays(0,Vc,nd)),hc.unbind()}Gc&&O.destroyStream(Rc);fd&&O.destroyStream(Ub);qb&&O.destroyStream(xa);Pb&&O.destroyStream(gb);R.dirty=!0;Na.setVAO(null);M.viewportWidth=v;M.viewportHeight=u;x&&(z.cpuTime+=performance.now()-A)},draw:function(d){var e,h,n,k,v,u,p,A,E,H,F,I,K,Q,da,ca,na,fa,ea,aa,Ea,Hb,Id,kf,af,Ad,Fe,Sd,Td,le,Xd,rd,jd,vd,$c,kd,oc,id,ed,Lc,qc,ab,
Ic,Db,pc,Ta,Jc,$b,rc,Fd,Bd,Ac,Xb,Gc,Rc,La,Eb,Wa,wa,md,hb,Sa,Gb,db,ec,Sb,ge,Zb,Tb,fd,Ub,Ma,pb,ub,ib,Oa,Dc,Ib,cd,eb,lc,dd,dc,kb,lb,ta,qb,xa,Ua,bb,Aa,fb;e=$a.next;e!==$a.cur&&(e?P.bindFramebuffer(36160,e.framebuffer):P.bindFramebuffer(36160,null),$a.cur=e);if(R.dirty){var Ia,Ab,zb,Ra,Kc,Jb,Za,Vb,ya,ce,Ja,Pb,gb,jb,za,fc,Da,rb,sb,Xa,Ya,mc,xc,uc,Va,Mb,Xc,Fa,yc,Pa,Ba,mb,vb,Cb,tb,vc,wb,wd,sc;Ia=la.dither;Ia!==R.dither&&(Ia?P.enable(3024):P.disable(3024),R.dither=Ia);Ab=U[0];zb=U[1];if(Ab!==ob[0]||zb!==ob[1])P.blendEquationSeparate(Ab,
...
Oa.w!==Ub)P.vertexAttrib4f(ib,Ma,pb,ub,Ub),Oa.x=Ma,Oa.y=pb,Oa.z=ub,Oa.w=Ub;Ib=N.call(this,M,d,0);P.uniform1f(ga.location,Ib);cd=g.call(this,M,d,0);P.uniform1f(l.location,cd);P.uniform1f(f.location,d.align);P.uniform1f(q.location,d.baseline);eb=this.viewportArray;P.uniform4f(oa.location,eb[0],eb[1],eb[2],eb[3]);lc=d.color;P.uniform4f(a.location,lc[0],lc[1],lc[2],lc[3]);dd=b.call(this,M,d,0);P.uniform2f(V.location,dd[0],dd[1]);dc=x.call(this,M,d,0);P.uniform2f(T.location,dc[0],dc[1]);kb=this.scale;
P.uniform2f(cb.location,kb[0],kb[1]);lb=this.translate;P.uniform2f(kc.location,lb[0],lb[1]);ta=d.positionOffset;P.uniform2f(Ka.location,ta[0],ta[1]);P.uniform1f(X.location,d.opacity);(qb=c.call(this,M,d,0))&&"framebuffer"===qb._reglType&&(qb=qb.color[0]);xa=qb._texture;P.uniform1i(D.location,xa.bind());(Ua=sa.elements)?P.bindBuffer(34963,Ua.buffer.buffer):Na.currentVAO&&(Ua=J.getElements(Na.currentVAO.elements))&&P.bindBuffer(34963,Ua.buffer.buffer);bb=d.offset;if(Aa=d.count)fb=sa.instances,0<fb?
Ua?F.drawElementsInstancedANGLE(0,Aa,Ua.type,bb<<(Ua.type-5121>>1),fb):F.drawArraysInstancedANGLE(0,bb,Aa,fb):0>fb&&(Ua?P.drawElements(0,Aa,Ua.type,bb<<(Ua.type-5121>>1)):P.drawArrays(0,bb,Aa)),R.dirty=!0,Na.setVAO(null),M.viewportWidth=p,M.viewportHeight=A,E&&(z.cpuTime+=performance.now()-H),I&&O.destroyStream(K),Sd&&O.destroyStream(Td),pc&&O.destroyStream(Ta),Sa&&O.destroyStream(Gb),xa.unbind()},scope:function(a,b,c){var d,e,f,g,h,l,q,r,w,x,B,N,C,D,F,I,J,L,W,P,T,U,ha,V,X,Y,ca,aa,ga,ia,ka,ua,ma,
...
Za;A.offset=Vb;A.size=ya;A.state=Id;A.stride=Ja;A.type=Pb;A.w=gb;A.x=jb;A.y=za;A.z=fc;rb&&O.destroyStream(sb);H.buffer=Ba;H.divisor=mb;H.normalized=vb;H.offset=Cb;H.size=tb;H.state=vc;H.stride=wb;H.type=wd;H.w=sc;H.x=ud;H.y=Mc;H.z=ld;sd&&O.destroyStream(Wb);n.buffer=Bc;n.divisor=Cc;n.normalized=Ec;n.offset=Nc;n.size=Yc;n.state=Sc;n.stride=Oc;n.type=Kb;n.w=Fb;n.x=Pc;n.y=Hc;n.z=Tc;fa.vert=hc;fa.frag=Vc;R.dirty=!0}}}}},{}],25:[function(z,aa,jc){var d=z("./sorted-object-keys");aa.exports=function(z,r){for(var N=
d(r),g=0;g<N.length;++g)z[N[g]]=r[N[g]];return z}},{"./sorted-object-keys":34}],26:[function(z,aa,jc){function d(d,g,b,r,c,v){for(var z=0;z<g;++z)for(var ba=d[z],K=0;K<b;++K)for(var E=ba[K],u=0;u<r;++u)c[v++]=E[u]}function ba(r,g,b,x,c){for(var v=1,z=b+1;z<g.length;++z)v*=g[z];var da=g[b];if(4===g.length-b){var K=g[b+1],E=g[b+2];g=g[b+3];for(z=0;z<da;++z)d(r[z],K,E,g,x,c),c+=v}else for(z=0;z<da;++z)ba(r[z],g,b+1,x,c),c+=v}var r=z("./pool");aa.exports={shape:function(d){for(var g=[];d.length;d=d[0])g.push(d.length);
return g},flatten:function(z,g,b,x){var c=1;if(g.length)for(var v=0;v<g.length;++v)c*=g[v];else c=0;b=x||r.allocType(b,c);switch(g.length){case 0:break;case 1:x=g[0];for(g=0;g<x;++g)b[g]=z[g];break;case 2:x=g[0];g=g[1];for(v=c=0;v<x;++v)for(var aa=z[v],da=0;da<g;++da)b[c++]=aa[da];break;case 3:d(z,g[0],g[1],g[2],b,0);break;default:ba(z,g,0,b,0)}return b}}},{"./pool":32}],27:[function(z,aa,jc){var d=z("./is-typed-array");aa.exports=function(z){return Array.isArray(z)||d(z)}},{"./is-typed-array":30}],
28:[function(z,aa,jc){var d=z("./is-typed-array");aa.exports=function(z){return!!z&&"object"===typeof z&&Array.isArray(z.shape)&&Array.isArray(z.stride)&&"number"===typeof z.offset&&z.shape.length===z.stride.length&&(Array.isArray(z.data)||d(z.data))}},{"./is-typed-array":30}],29:[function(z,aa,jc){aa.exports=function(d){return!(d&d-1)&&!!d}},{}],30:[function(z,aa,jc){aa.exports=function(d){return d instanceof Uint8Array||d instanceof Uint16Array||d instanceof Uint32Array||d instanceof Int8Array||
d instanceof Int16Array||d instanceof Int32Array||d instanceof Float32Array||d instanceof Float64Array||d instanceof Uint8ClampedArray}},{}],31:[function(z,aa,jc){aa.exports=function(d,z){for(var r=Array(d),N=0;N<d;++N)r[N]=z(N);return r}},{}],32:[function(z,aa,jc){function d(d){var g,b;g=(65535<d)<<4;d>>>=g;b=(255<d)<<3;d>>>=b;g|=b;b=(15<d)<<2;d>>>=b;g|=b;b=(3<d)<<1;return g|b|d>>>b>>1}function ba(){function z(g){a:{for(var c=16;268435456>=c;c*=16)if(g<=c){g=c;break a}g=0}c=b[d(g)>>2];return 0<c.length?
c.pop():new ArrayBuffer(g)}function g(g){b[d(g.byteLength)>>2].push(g)}var b=r(8,function(){return[]});return{alloc:z,free:g,allocType:function(b,c){var d=null;switch(b){case 5120:d=new Int8Array(z(c),0,c);break;case 5121:d=new Uint8Array(z(c),0,c);break;case 5122:d=new Int16Array(z(2*c),0,c);break;case 5123:d=new Uint16Array(z(2*c),0,c);break;case 5124:d=new Int32Array(z(4*c),0,c);break;case 5125:d=new Uint32Array(z(4*c),0,c);break;case 5126:d=new Float32Array(z(4*c),0,c);break;default:return null}return d.length!==
c?d.subarray(0,c):d},freeType:function(b){g(b.buffer)}}}var r=z("./loop");z=ba();z.zero=ba();aa.exports=z},{"./loop":31}],33:[function(z,aa,jc){aa.exports={next:"function"===typeof requestAnimationFrame?function(d){return requestAnimationFrame(d)}:function(d){return setTimeout(d,16)},cancel:"function"===typeof cancelAnimationFrame?function(d){return cancelAnimationFrame(d)}:clearTimeout}},{}],34:[function(z,aa,jc){aa.exports=function(d){return Object.keys(d).sort()}},{}],35:[function(z,aa,jc){var d=
z("./pool"),ba=new Float32Array(1),r=new Uint32Array(ba.buffer);aa.exports=function(z){for(var g=d.allocType(5123,z.length),b=0;b<z.length;++b)if(isNaN(z[b]))g[b]=65535;else if(Infinity===z[b])g[b]=31744;else if(-Infinity===z[b])g[b]=64512;else{ba[0]=z[b];var x=r[0],c=x>>>31<<15,v=(x<<1>>>24)-127,x=x>>13&1023;g[b]=-24>v?c:-14>v?c+(x+1024>>-14-v):15<v?c+31744:c+(v+15<<10)+x}return g}},{"./pool":32}],36:[function(z,aa,jc){var d=z("./sorted-object-keys");aa.exports=function(z){return d(z).map(function(d){return z[d]})}},
{"./sorted-object-keys":34}],37:[function(z,aa,jc){function d(d,c,g){function r(){var b=window.innerWidth,c=window.innerHeight;d!==document.body&&(c=z.getBoundingClientRect(),b=c.right-c.left,c=c.bottom-c.top);z.width=g*b;z.height=g*c}var z=document.createElement("canvas");b(z.style,{border:0,margin:0,padding:0,top:0,left:0,width:"100%",height:"100%"});d.appendChild(z);d===document.body&&(z.style.position="absolute",b(d.style,{margin:0,padding:0}));var K;d!==document.body&&"function"===typeof ResizeObserver?
(K=new ResizeObserver(function(){setTimeout(r)}),K.observe(d)):window.addEventListener("resize",r,!1);r();return{canvas:z,onDestroy:function(){K?K.disconnect():window.removeEventListener("resize",r);d.removeChild(z)}}}function ba(b,c){function d(g){try{return b.getContext(g,c)}catch(r){return null}}return d("webgl")||d("experimental-webgl")||d("webgl-experimental")}function r(b){if("string"===typeof b)return b.split();g(Array.isArray(b),"invalid extension array");return b}function N(b){return"string"===
typeof b?(g("undefined"!==typeof document,"not supported outside of DOM"),document.querySelector(b)):b}var g=z("./util/check"),b=z("./util/extend");aa.exports=function(b){var c=b||{},v,z,da,K;b={};var E=[],u=[],A="undefined"===typeof window?1:window.devicePixelRatio,H=!1,n=function(b){b&&g.raise(b)},F=function(){};"string"===typeof c?(g("undefined"!==typeof document,"selector queries only supported in DOM environments"),v=document.querySelector(c),g(v,"invalid query string for element")):"object"===
typeof c?"string"===typeof c.nodeName&&"function"===typeof c.appendChild&&"function"===typeof c.getBoundingClientRect?v=c:"function"===typeof c.drawArrays||"function"===typeof c.drawElements?(K=c,da=K.canvas):(g.constructor(c),"gl"in c?K=c.gl:"canvas"in c?da=N(c.canvas):"container"in c&&(z=N(c.container)),"attributes"in c&&(b=c.attributes,g.type(b,"object","invalid context attributes")),"extensions"in c&&(E=r(c.extensions)),"optionalExtensions"in c&&(u=r(c.optionalExtensions)),"onDone"in c&&(g.type(c.onDone,
"function","invalid or missing onDone callback"),n=c.onDone),"profile"in c&&(H=!!c.profile),"pixelRatio"in c&&(A=+c.pixelRatio,g(0<A,"invalid pixel ratio"))):g.raise("invalid arguments to regl");v&&("canvas"===v.nodeName.toLowerCase()?da=v:z=v);if(!K){if(!da){g("undefined"!==typeof document,"must manually specify webgl context outside of DOM environments");v=d(z||document.body,n,A);if(!v)return null;da=v.canvas;F=v.onDestroy}void 0===b.premultipliedAlpha&&(b.premultipliedAlpha=!0);K=ba(da,b)}return K?
{gl:K,canvas:da,container:z,extensions:E,optionalExtensions:u,pixelRatio:A,profile:H,onDone:n,onDestroy:F}:(F(),n("webgl not supported, try upgrading your browser or graphics drivers http://get.webgl.org"),null)}},{"./util/check":21,"./util/extend":25}],38:[function(z,aa,jc){function d(b,c){for(var d=0;d<b.length;++d)if(b[d]===c)return d;return-1}var ba=z("./lib/util/check"),r=z("./lib/util/extend"),N=z("./lib/dynamic"),g=z("./lib/util/raf"),b=z("./lib/util/clock"),x=z("./lib/strings"),c=z("./lib/webgl"),
v=z("./lib/extension"),na=z("./lib/limits"),da=z("./lib/buffer"),K=z("./lib/elements"),E=z("./lib/texture"),u=z("./lib/renderbuffer"),A=z("./lib/framebuffer"),H=z("./lib/attribute"),n=z("./lib/shader"),F=z("./lib/read"),ca=z("./lib/core"),I=z("./lib/stats"),Id=z("./lib/timer");aa.exports=function(e){function h(){if(0===ob.length)O&&O.update(),cc=null;else{cc=g.next(h);a();for(var b=ob.length-1;0<=b;--b){var c=ob[b];c&&c(J,null,0)}ma.flush();O&&O.update()}}function f(){!cc&&0<ob.length&&(cc=g.next(h))}
function z(){cc&&(g.cancel(h),cc=null)}function T(a){a.preventDefault();cb=!0;z();ea.forEach(function(a){a()})}function V(a){ma.getError();cb=!1;kc.restore();la.restore();$a.restore();fa.restore();Ea.restore();Na.restore();t.restore();O&&O.restore();Hb.procs.refresh();f();va.forEach(function(a){a()})}function q(a){function b(a,c){var d={},e={};Object.keys(a).forEach(function(b){var f=a[b];if(N.isDynamic(f))e[b]=N.unbox(f,b);else{if(c&&Array.isArray(f))for(var g=0;g<f.length;++g)if(N.isDynamic(f[g])){e[b]=
...
"called regl.clear with no buffer specified");ma.clear(c)}function L(a){ba.type(a,"function","regl.frame() callback must be a function");ob.push(a);f();return{cancel:function(){function b(){var a=d(ob,b);ob[a]=ob[ob.length-1];--ob.length;0>=ob.length&&z()}var c=d(ob,a);ba(0<=c,"cannot cancel a frame twice");ob[c]=b}}}function ga(){var a=Ha.viewport,b=Ha.scissor_box;a[0]=a[1]=b[0]=b[1]=0;J.viewportWidth=J.framebufferWidth=J.drawingBufferWidth=a[2]=b[2]=ma.drawingBufferWidth;J.viewportHeight=J.framebufferHeight=
J.drawingBufferHeight=a[3]=b[3]=ma.drawingBufferHeight}function a(){J.tick+=1;J.time=X();ga();Hb.procs.poll()}function l(){fa.refresh();ga();Hb.procs.refresh();O&&O.update()}function X(){return(b()-M)/1E3}console.log("REGL args are:",e);e=c(e);if(!e)return null;var ma=e.gl,Ka=ma.getContextAttributes(),cb=ma.isContextLost(),kc=v(ma,e);if(!kc)return null;var oa=x(),Qa=I(),Y=kc.extensions,O=Id(ma,Y),M=b(),R=ma.drawingBufferWidth,sa=ma.drawingBufferHeight,J={tick:0,time:0,viewportWidth:R,viewportHeight:sa,
framebufferWidth:R,framebufferHeight:sa,drawingBufferWidth:R,drawingBufferHeight:sa,pixelRatio:e.pixelRatio},R={elements:null,primitive:4,count:-1,offset:0,instances:-1},Ob=na(ma,Y),$a=da(ma,Qa,e,function(a){return t.destroyBuffer(a)}),P=K(ma,Y,$a,Qa),t=H(ma,Y,Ob,Qa,$a,P,R),la=n(ma,oa,Qa,e),fa=E(ma,Y,Ob,function(){Hb.procs.poll()},J,Qa,e),Ea=u(ma,Y,Ob,Qa,e),Na=A(ma,Y,Ob,fa,Ea,Qa),Hb=ca(ma,oa,Y,Ob,$a,P,fa,Na,{},t,la,R,J,O,e),oa=F(ma,Na,Hb.procs.poll,J,Ka,Y,Ob),Ha=Hb.next,U=ma.canvas,ob=[],ea=[],va=
[],bc=[e.onDestroy],cc=null;U&&(U.addEventListener("webglcontextlost",T,!1),U.addEventListener("webglcontextrestored",V,!1));var jc=Na.setFBO=q({framebuffer:N.define.call(null,1,"framebuffer")});l();Ka=r(q,{clear:function(a){ba("object"===typeof a&&a,"regl.clear() takes an object as input");if("framebuffer"in a)if(a.framebuffer&&"framebufferCube"===a.framebuffer_reglType)for(var b=0;6>b;++b)jc(r({framebuffer:a.framebuffer.faces[b]},a),aa);else jc(a,aa);else aa(null,a)},prop:N.define.bind(null,1),
context:N.define.bind(null,2),"this":N.define.bind(null,3),draw:q({}),buffer:function(a){return $a.create(a,34962,!1,!1)},elements:function(a){return P.create(a,!1)},texture:fa.create2D,cube:fa.createCube,renderbuffer:Ea.create,framebuffer:Na.create,framebufferCube:Na.createCube,vao:t.createVAO,attributes:Ka,frame:L,on:function(a,b){ba.type(b,"function","listener callback must be a function");var c;switch(a){case "frame":return L(b);case "lost":c=ea;break;case "restore":c=va;break;case "destroy":c=
bc;break;default:ba.raise("invalid event, must be one of frame,lost,restore,destroy")}c.push(b);return{cancel:function(){for(var a=0;a<c.length;++a)if(c[a]===b){c[a]=c[c.length-1];c.pop();break}}}},limits:Ob,hasExtension:function(a){return 0<=Ob.extensions.indexOf(a.toLowerCase())},read:oa,destroy:function(){ob.length=0;z();U&&(U.removeEventListener("webglcontextlost",T),U.removeEventListener("webglcontextrestored",V));la.clear();Na.clear();Ea.clear();t.clear();fa.clear();P.clear();$a.clear();O&&
O.clear();bc.forEach(function(a){a()})},_gl:ma,_refresh:l,poll:function(){a();O&&O.update()},now:X,stats:Qa});e.onDone(null,Ka);return Ka}},{"./lib/attribute":2,"./lib/buffer":3,"./lib/core":8,"./lib/dynamic":9,"./lib/elements":10,"./lib/extension":11,"./lib/framebuffer":12,"./lib/limits":13,"./lib/read":14,"./lib/renderbuffer":15,"./lib/shader":16,"./lib/stats":17,"./lib/strings":18,"./lib/texture":19,"./lib/timer":20,"./lib/util/check":21,"./lib/util/clock":22,"./lib/util/extend":25,"./lib/util/raf":33,
"./lib/webgl":37}]},{},[1]);
