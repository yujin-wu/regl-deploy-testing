...
var e=G.maxAttributes,g=Array(e);for(G=0;G<e;++G)g[G]=new k;var d=0,z={},U={Record:k,scope:{},state:g,currentVAO:null,targetVAO:null,restore:ea.oes_vertex_array_object?A:function(){},createVAO:function(d){function m(d){var W;if(Array.isArray(d))W=d,g.elements&&g.ownsElements&&g.elements.destroy(),g.elements=null,g.ownsElements=!1,g.offset=0,g.count=0,g.instances=-1,g.primitive=4;else{q("object"===typeof d,"invalid arguments for create vao");q("attributes"in d,"must specify attributes for vao");if(d.elements){var a=
...
d.count|0);"instances"in d&&(g.instances=d.instances|0);"primitive"in d&&(q(d.primitive in b,"bad primitive type: "+d.primitive),g.primitive=b[d.primitive]);q.optional(function(){for(var a=Z(d),b=0;b<a.length;++b)q(0<=v.indexOf(a[b]),'invalid option for vao: "'+a[b]+'" valid options are '+v)});q(Array.isArray(W),"attributes must be an array")}q(W.length<e,"too many attributes");q(0<W.length,"must specify at least one attribute");var a={},h=g.attributes;h.length=W.length;for(var X=0;X<W.length;++X){var z=
...
0,n.stride=0,n.divisor=0,n.state=1):w.getBuffer(z.buffer)?(n.buffer=w.getBuffer(z.buffer),n.size=(+z.size||n.buffer.dimension)|0,n.normalized=!!z.normalized||!1,"type"in z?(q.parameter(z.type,f,"invalid buffer type"),n.type=f[z.type]):n.type=n.buffer.dtype,n.offset=(z.offset||0)|0,n.stride=(z.stride||0)|0,n.divisor=(z.divisor||0)|0,n.state=1,q(1<=n.size&&4>=n.size,"size must be between 1 and 4"),q(0<=n.offset,"invalid offset"),q(0<=n.stride&&255>=n.stride,"stride must be between 0 and 255"),q(0<=
n.divisor,"divisor must be positive"),q(!n.divisor||!!ea.angle_instanced_arrays,"ANGLE_instanced_arrays must be enabled to use divisor")):"x"in z?(q(0<X,"first attribute must not be a constant"),n.x=+z.x||0,n.y=+z.y||0,n.z=+z.z||0,n.w=+z.w||0,n.state=2):q(!1,"invalid attribute spec for location "+X)}for(H=0;H<g.buffers.length;++H)!a[H]&&g.buffers[H]&&(g.buffers[H].destroy(),g.buffers[H]=null);g.refresh();return m}var g=new I;F.vaoCount+=1;m.destroy=function(){for(var b=0;b<g.buffers.length;++b)g.buffers[b]&&
...
"./util/check":21,"./util/is-ndarray":28,"./util/is-typed-array":30,"./util/sorted-object-keys":34,"./util/values":36}],3:[function(A,R,Ib){function k(b){return G[Object.prototype.toString.call(b)]|0}function Z(b,c){for(var f=0;f<c.length;++f)b[f]=c[f]}function q(b,c,f,y,k,v,e){for(var g=0,d=0;d<f;++d)for(var z=0;z<y;++z)b[g++]=c[k*d+v*z+e]}var O=A("./util/sorted-object-keys"),f=A("./util/check"),c=A("./util/is-typed-array"),y=A("./util/is-ndarray"),b=A("./util/values"),v=A("./util/pool");Ib=A("./util/flatten");
...
dynamic:35048,stream:35040}},{}],8:[function(A,R,Ib){function k(b){return Array.isArray(b)||G(b)||F(b)}function Z(b){return b.sort(function(b,c){return"viewport"===b?-1:"viewport"===c?1:b<c?-1:1})}function q(b,c,d,f){this.thisDep=b;this.contextDep=c;this.propDep=d;this.append=f}function O(b){return b&&!(b.thisDep||b.contextDep||b.propDep)}function f(b){return new q(!1,!1,!1,b)}function c(b,c){var d=b.type;if(0===d)return d=b.data.length,new q(!0,1<=d,2<=d,c);if(4===d)return d=b.data,new q(d.thisDep,
d.contextDep,d.propDep,c);if(5===d)return new q(!1,!1,!1,c);if(6===d){for(var f=d=!1,g=!1,a=0;a<b.data.length;++a){var h=b.data[a];1===h.type?g=!0:2===h.type?f=!0:3===h.type?d=!0:0===h.type?(d=!0,h=h.data,1<=h&&(f=!0),2<=h&&(g=!0)):4===h.type&&(d=d||h.data.thisDep,f=f||h.data.contextDep,g=g||h.data.propDep)}return new q(d,f,g,c)}return new q(3===d,2===d,1===d,c)}var y=A("./util/sorted-object-keys"),b=A("./util/check"),v=A("./util/extend"),pa=A("./util/codegen"),ea=A("./util/loop"),G=A("./util/is-typed-array"),
...
"==":514,"===":514,lequal:515,"<=":515,greater:516,">":516,notequal:517,"!=":517,"!==":517,gequal:518,">=":518,always:519},g={0:0,zero:0,keep:7680,replace:7681,increment:7682,decrement:7683,"increment wrap":34055,"decrement wrap":34056,invert:5386},d={frag:35632,vert:35633},z={cw:2304,ccw:2305},U=new q(!1,!1,!1,function(){});R.exports=function(G,m,F,L,fa,a,h,X,ra,xa,jb,ec,na,Na,Y){function K(b){return b.replace(".","_")}function M(b,r,a){var d=K(b);ba.push(b);p[d]=E[d]=!!a;x[d]=r}function P(b,r,a){var d=
K(b);ba.push(b);Array.isArray(a)?(E[d]=a.slice(),p[d]=a.slice()):E[d]=p[d]=a;ja[d]=r}function A(){var a=pa(),r=a.link,d=a.global;a.id=tc++;a.batchId="0";var c=r(ia),x=a.shared={props:"a0"};y(ia).forEach(function(b){x[b]=d.def(c,".",b)});b.optional(function(){a.CHECK=r(b);a.commandStr=b.guessCommand();a.command=r(a.commandStr);a.assert=function(b,a,d){b("if(!(",a,"))",this.CHECK,".commandRaise(",r(d),",",this.command,");")};l.invalidBlendCombinations=be});var f=a.next={},h=a.current={};y(ja).forEach(function(b){Array.isArray(E[b])&&
...
r)})}};a.attribCache={};var Kd={};a.scopeAttrib=function(b){b=m.id(b);if(b in Kd)return Kd[b];var a=xa.scope[b];a||(a=xa.scope[b]=new ka);return Kd[b]=r(a)};return a}function J(b){var r=b["static"];b=b.dynamic;var a;if("profile"in r){var d=!!r.profile;a=f(function(b,r){return d});a.enable=d}else if("profile"in b){var l=b.profile;a=c(l,function(b,r){return b.invoke(r,l)})}return a}function Wb(a,r){var d=a["static"],l=a.dynamic;if("framebuffer"in d){var x=d.framebuffer;return x?(x=X.getFramebuffer(x),
b.command(x,"invalid framebuffer object"),f(function(b,r){var a=b.link(x),d=b.shared;r.set(d.framebuffer,".next",a);d=d.context;r.set(d,".framebufferWidth",a+".width");r.set(d,".framebufferHeight",a+".height");return a})):f(function(b,r){var a=b.shared;r.set(a.framebuffer,".next","null");a=a.context;r.set(a,".framebufferWidth",a+".drawingBufferWidth");r.set(a,".framebufferHeight",a+".drawingBufferHeight");return"null"})}if("framebuffer"in l){var h=l.framebuffer;return c(h,function(a,r){var d=a.invoke(r,
h),c=a.shared,l=c.framebuffer,aa=r.def(l,".getFramebuffer(",d,")");b.optional(function(){a.assert(r,"!"+d+"||"+aa,"invalid framebuffer object")});r.set(l,".next",aa);c=c.context;r.set(c,".framebufferWidth",aa+"?"+aa+".width:"+c+".drawingBufferWidth");r.set(c,".framebufferHeight",aa+"?"+aa+".height:"+c+".drawingBufferHeight");return aa})}return null}function $a(a,r,d){function l(a){if(a in x){var aa=x[a];b.commandType(aa,"object","invalid "+a,d.commandStr);var h=!0,od=aa.x|0,g=aa.y|0,m,e;"width"in
aa?(m=aa.width|0,b.command(0<=m,"invalid "+a,d.commandStr)):h=!1;"height"in aa?(e=aa.height|0,b.command(0<=e,"invalid "+a,d.commandStr)):h=!1;return new q(!h&&r&&r.thisDep,!h&&r&&r.contextDep,!h&&r&&r.propDep,function(b,a){var r=b.shared.context,d=m;"width"in aa||(d=a.def(r,".","framebufferWidth","-",od));var c=e;"height"in aa||(c=a.def(r,".","framebufferHeight","-",g));return[od,g,d,c]})}if(a in f){var p=f[a],h=c(p,function(r,d){var c=r.invoke(d,p);b.optional(function(){r.assert(d,c+"&&typeof "+
c+'==="object"',"invalid "+a)});var l=r.shared.context,aa=d.def(c,".x|0"),x=d.def(c,".y|0"),f=d.def('"width" in ',c,"?",c,".width|0:","(",l,".","framebufferWidth","-",aa,")"),h=d.def('"height" in ',c,"?",c,".height|0:","(",l,".","framebufferHeight","-",x,")");b.optional(function(){r.assert(d,f+">=0&&"+h+">=0","invalid "+a)});return[aa,x,f,h]});r&&(h.thisDep=h.thisDep||r.thisDep,h.contextDep=h.contextDep||r.contextDep,h.propDep=h.propDep||r.propDep);return h}return r?new q(r.thisDep,r.contextDep,r.propDep,
...
var d=r["static"],c=y(d);if(0<c.length&&"number"===typeof d[c[0]]){for(var l=[],x=0;x<c.length;++x)b("number"===typeof d[c[x]],"must specify all vertex attribute locations when using vaos"),l.push([d[c[x]]|0,c[x]]);return l}}return null}function t(a,r,l){function x(a){if(a in h){var r=m.id(h[a]);b.optional(function(){jb.shader(d[a],r,b.guessCommand())});var l=f(function(){return r});l.id=r;return l}if(a in g){var aa=g[a];return c(aa,function(r,c){var l=r.invoke(c,aa),x=c.def(r.shared.strings,".id(",
l,")");b.optional(function(){c(r.shared.shader,".shader(",d[a],",",x,",",r.command,");")});return x})}return null}var h=a["static"],g=a.dynamic,e=x("frag"),p=x("vert"),Kd=null;O(e)&&O(p)?(Kd=jb.program(p.id,e.id,null,l),a=f(function(b,a){return b.link(Kd)})):a=new q(e&&e.thisDep||p&&p.thisDep,e&&e.contextDep||p&&p.contextDep,e&&e.propDep||p&&p.propDep,function(a,r){var d=a.shared.shader,c;c=e?e.append(a,r):r.def(d,".","frag");var l;l=p?p.append(a,r):r.def(d,".","vert");var x=d+".program("+l+","+c;
b.optional(function(){x+=","+a.command});return r.def(x+")")});return{frag:e,vert:p,progVar:a,program:Kd}}function ma(d,r){function l(a,d){if(a in x){var aa=x[a]|0;d?g.offset=aa:g.instances=aa;b.command(!d||0<=aa,"invalid "+a,r.commandStr);return f(function(b,a){d&&(b.OFFSET=aa);return aa})}if(a in h){var od=h[a];return c(od,function(r,c){var l=r.invoke(c,od);d&&(r.OFFSET=l,b.optional(function(){r.assert(c,l+">=0","invalid "+a)}));return l})}if(d){if(Kd)return f(function(b,a){return b.OFFSET=0});
if(e)return new q(m.thisDep,m.contextDep,m.propDep,function(b,a){return a.def(b.shared.vao+".currentVAO?"+b.shared.vao+".currentVAO.offset:0")})}else if(e)return new q(m.thisDep,m.contextDep,m.propDep,function(b,a){return a.def(b.shared.vao+".currentVAO?"+b.shared.vao+".currentVAO.instances:-1")});return null}var x=d["static"],h=d.dynamic,g={},e=!1,m=function(){if("vao"in x){var b=x.vao;null!==b&&null===xa.getVAO(b)&&(b=xa.createVAO(b));e=!0;g.vao=b;return f(function(a){var r=xa.getVAO(b);return r?
a.link(r):"null"})}if("vao"in h){e=!0;var a=h.vao;return c(a,function(b,r){var d=b.invoke(r,a);return r.def(b.shared.vao+".getVAO("+d+")")})}return null}(),Kd=!1,p=function(){if("elements"in x){var d=x.elements;g.elements=d;if(k(d)){var l=g.elements=a.create(d,!0),d=a.getElements(l);Kd=!0}else d&&(d=a.getElements(d),Kd=!0,b.command(d,"invalid elements",r.commandStr));l=f(function(b,a){if(d){var r=b.link(d);return b.ELEMENTS=r}return b.ELEMENTS=null});l.value=d;return l}if("elements"in h){Kd=!0;var aa=
h.elements;return c(aa,function(a,r){var d=a.shared,c=d.isBufferArgs,d=d.elements,l=a.invoke(r,aa),x=r.def("null"),c=r.def(c,"(",l,")"),h=a.cond(c).then(x,"=",d,".createStream(",l,");")["else"](x,"=",d,".getElements(",l,");");b.optional(function(){a.assert(h["else"],"!"+l+"||"+x,"invalid elements")});r.entry(h);r.exit(a.cond(c).then(d,".destroyStream(",x,");"));return a.ELEMENTS=x})}return e?new q(m.thisDep,m.contextDep,m.propDep,function(b,a){return a.def(b.shared.vao+".currentVAO?"+b.shared.elements+
".getElements("+b.shared.vao+".currentVAO.elements):null")}):null}(),od=l("offset",!0),t=function(){if("primitive"in x){var a=x.primitive;g.primitive=a;b.commandParameter(a,N,"invalid primitve",r.commandStr);return f(function(b,r){return N[a]})}if("primitive"in h){var d=h.primitive;return c(d,function(a,r){var c=a.constants.primTypes,l=a.invoke(r,d);b.optional(function(){a.assert(r,l+" in "+c,"invalid primitive, must be one of "+y(N))});return r.def(c,"[",l,"]")})}return Kd?O(p)?p.value?f(function(b,
a){return a.def(b.ELEMENTS,".primType")}):f(function(){return 4}):new q(p.thisDep,p.contextDep,p.propDep,function(b,a){var r=b.ELEMENTS;return a.def(r,"?",r,".primType:",4)}):e?new q(m.thisDep,m.contextDep,m.propDep,function(b,a){return a.def(b.shared.vao+".currentVAO?"+b.shared.vao+".currentVAO.primitive:4")}):null}(),n=function(){if("count"in x){var a=x.count|0;g.count=a;b.command("number"===typeof a&&0<=a,"invalid vertex count",r.commandStr);return f(function(){return a})}if("count"in h){var d=
h.count;return c(d,function(a,r){var c=a.invoke(r,d);b.optional(function(){a.assert(r,"typeof "+c+'==="number"&&'+c+">=0&&"+c+"===("+c+"|0)","invalid vertex count")});return c})}if(Kd){if(O(p)){if(p)return od?new q(od.thisDep,od.contextDep,od.propDep,function(a,r){var d=r.def(a.ELEMENTS,".vertCount-",a.OFFSET);b.optional(function(){a.assert(r,d+">=0","invalid vertex offset/element buffer too small")});return d}):f(function(b,a){return a.def(b.ELEMENTS,".vertCount")});var l=f(function(){return-1});
b.optional(function(){l.MISSING=!0});return l}var aa=new q(p.thisDep||od.thisDep,p.contextDep||od.contextDep,p.propDep||od.propDep,function(b,a){var r=b.ELEMENTS;return b.OFFSET?a.def(r,"?",r,".vertCount-",b.OFFSET,":-1"):a.def(r,"?",r,".vertCount:-1")});b.optional(function(){aa.DYNAMIC=!0});return aa}return e?new q(m.thisDep,m.contextDep,m.propDep,function(b,a){return a.def(b.shared.vao,".currentVAO?",b.shared.vao,".currentVAO.count:-1")}):null}(),ia=l("instances",!1);return{elements:p,primitive:t,
count:n,instances:ia,offset:od,vao:m,vaoActive:e,elementsActive:Kd,"static":g}}function da(a,r){var d=a["static"],l=a.dynamic,x={};ba.forEach(function(a){function aa(b,r){if(a in d){var g=b(d[a]);x[h]=f(function(){return g})}else if(a in l){var m=l[a];x[h]=c(m,function(b,a){return r(b,a,b.invoke(a,m))})}}var h=K(a);switch(a){case "cull.enable":case "blend.enable":case "dither":case "stencil.enable":case "depth.enable":case "scissor.enable":case "polygonOffset.enable":case "sample.alpha":case "sample.enable":case "depth.mask":return aa(function(d){b.commandType(d,
"boolean",a,r.commandStr);return d},function(r,d,c){b.optional(function(){r.assert(d,"typeof "+c+'==="boolean"',"invalid flag "+a,r.commandStr)});return c});case "depth.func":return aa(function(d){b.commandParameter(d,e,"invalid "+a,r.commandStr);return e[d]},function(r,d,c){var l=r.constants.compareFuncs;b.optional(function(){r.assert(d,c+" in "+l,"invalid "+a+", must be one of "+y(e))});return d.def(l,"[",c,"]")});case "depth.range":return aa(function(a){b.command(w(a)&&2===a.length&&"number"===
typeof a[0]&&"number"===typeof a[1]&&a[0]<=a[1],"depth range is 2d array",r.commandStr);return a},function(a,r,d){b.optional(function(){a.assert(r,a.shared.isArrayLike+"("+d+")&&"+d+".length===2&&typeof "+d+'[0]==="number"&&typeof '+d+'[1]==="number"&&'+d+"[0]<="+d+"[1]","depth range must be a 2d array")});var c=r.def("+",d,"[0]"),l=r.def("+",d,"[1]");return[c,l]});case "blend.func":return aa(function(a){b.commandType(a,"object","blend.func",r.commandStr);var d="srcRGB"in a?a.srcRGB:a.src,c="srcAlpha"in
a?a.srcAlpha:a.src,l="dstRGB"in a?a.dstRGB:a.dst;a="dstAlpha"in a?a.dstAlpha:a.dst;b.commandParameter(d,I,h+".srcRGB",r.commandStr);b.commandParameter(c,I,h+".srcAlpha",r.commandStr);b.commandParameter(l,I,h+".dstRGB",r.commandStr);b.commandParameter(a,I,h+".dstAlpha",r.commandStr);b.command(-1===be.indexOf(d+", "+l),"unallowed blending combination (srcRGB, dstRGB) = ("+d+", "+l+")",r.commandStr);return[I[d],I[l],I[c],I[a]]},function(r,d,c){function l(aa,h){var f=d.def('"',aa,h,'" in ',c,"?",c,".",
aa,h,":",c,".",aa);b.optional(function(){r.assert(d,f+" in "+x,"invalid "+a+"."+aa+h+", must be one of "+y(I))});return f}var x=r.constants.blendFuncs;b.optional(function(){r.assert(d,c+"&&typeof "+c+'==="object"',"invalid blend func, must be an object")});var aa=l("src","RGB"),h=l("dst","RGB");b.optional(function(){r.assert(d,r.constants.invalidBlendCombinations+".indexOf("+aa+'+", "+'+h+") === -1 ","unallowed blending combination for (srcRGB, dstRGB)")});var f=d.def(x,"[",aa,"]"),g=d.def(x,"[",
l("src","Alpha"),"]"),m=d.def(x,"[",h,"]"),e=d.def(x,"[",l("dst","Alpha"),"]");return[f,m,g,e]});case "blend.equation":return aa(function(d){if("string"===typeof d)return b.commandParameter(d,ua,"invalid "+a,r.commandStr),[ua[d],ua[d]];if("object"===typeof d)return b.commandParameter(d.rgb,ua,a+".rgb",r.commandStr),b.commandParameter(d.alpha,ua,a+".alpha",r.commandStr),[ua[d.rgb],ua[d.alpha]];b.commandRaise("invalid blend.equation",r.commandStr)},function(r,d,c){var l=r.constants.blendEquations,x=
d.def(),aa=d.def(),h=r.cond("typeof ",c,'==="string"');b.optional(function(){function b(a,d,c){r.assert(a,c+" in "+l,"invalid "+d+", must be one of "+y(ua))}b(h.then,a,c);r.assert(h["else"],c+"&&typeof "+c+'==="object"',"invalid "+a);b(h["else"],a+".rgb",c+".rgb");b(h["else"],a+".alpha",c+".alpha")});h.then(x,"=",aa,"=",l,"[",c,"];");h["else"](x,"=",l,"[",c,".rgb];",aa,"=",l,"[",c,".alpha];");d(h);return[x,aa]});case "blend.color":return aa(function(a){b.command(w(a)&&4===a.length,"blend.color must be a 4d array",
r.commandStr);return ea(4,function(b){return+a[b]})},function(a,r,d){b.optional(function(){a.assert(r,a.shared.isArrayLike+"("+d+")&&"+d+".length===4","blend.color must be a 4d array")});return ea(4,function(a){return r.def("+",d,"[",a,"]")})});case "stencil.mask":return aa(function(a){b.commandType(a,"number",h,r.commandStr);return a|0},function(a,r,d){b.optional(function(){a.assert(r,"typeof "+d+'==="number"',"invalid stencil.mask")});return r.def(d,"|0")});case "stencil.func":return aa(function(d){b.commandType(d,
...
d,"?",c,"[",d,".cmp]",":",7680),x=r.def(d,".ref|0"),aa=r.def('"mask" in ',d,"?",d,".mask|0:-1");return[l,x,aa]});case "stencil.opFront":case "stencil.opBack":return aa(function(d){b.commandType(d,"object",h,r.commandStr);var c=d.fail||"keep",l=d.zfail||"keep";d=d.zpass||"keep";b.commandParameter(c,g,a+".fail",r.commandStr);b.commandParameter(l,g,a+".zfail",r.commandStr);b.commandParameter(d,g,a+".zpass",r.commandStr);return["stencil.opBack"===a?1029:1028,g[c],g[l],g[d]]},function(d,r,c){function l(aa){b.optional(function(){d.assert(r,
'!("'+aa+'" in '+c+")||("+c+"."+aa+" in "+x+")","invalid "+a+"."+aa+", must be one of "+y(g))});return r.def('"',aa,'" in ',c,"?",x,"[",c,".",aa,"]:",7680)}var x=d.constants.stencilOps;b.optional(function(){d.assert(r,c+"&&typeof "+c+'==="object"',"invalid "+a)});return["stencil.opBack"===a?1029:1028,l("fail"),l("zfail"),l("zpass")]});case "polygonOffset.offset":return aa(function(a){b.commandType(a,"object",h,r.commandStr);var d=a.factor|0;a=a.units|0;b.commandType(d,"number",h+".factor",r.commandStr);
b.commandType(a,"number",h+".units",r.commandStr);return[d,a]},function(d,r,c){b.optional(function(){d.assert(r,c+"&&typeof "+c+'==="object"',"invalid "+a)});var l=r.def(c,".factor|0"),x=r.def(c,".units|0");return[l,x]});case "cull.face":return aa(function(a){var d=0;"front"===a?d=1028:"back"===a&&(d=1029);b.command(!!d,h,r.commandStr);return d},function(a,d,r){b.optional(function(){a.assert(d,r+'==="front"||'+r+'==="back"',"invalid cull.face")});return d.def(r,'==="front"?',1028,":",1029)});case "lineWidth":return aa(function(a){b.command("number"===
typeof a&&a>=L.lineWidthDims[0]&&a<=L.lineWidthDims[1],"invalid line width, must be a positive number between "+L.lineWidthDims[0]+" and "+L.lineWidthDims[1],r.commandStr);return a},function(a,d,r){b.optional(function(){a.assert(d,"typeof "+r+'==="number"&&'+r+">="+L.lineWidthDims[0]+"&&"+r+"<="+L.lineWidthDims[1],"invalid line width")});return r});case "frontFace":return aa(function(a){b.commandParameter(a,z,h,r.commandStr);return z[a]},function(a,d,r){b.optional(function(){a.assert(d,r+'==="cw"||'+
r+'==="ccw"',"invalid frontFace, must be one of cw,ccw")});return d.def(r+'==="cw"?2304:2305')});case "colorMask":return aa(function(a){b.command(w(a)&&4===a.length,"color.mask must be length 4 array",r.commandStr);return a.map(function(a){return!!a})},function(a,d,r){b.optional(function(){a.assert(d,a.shared.isArrayLike+"("+r+")&&"+r+".length===4","invalid color.mask")});return ea(4,function(a){return"!!"+r+"["+a+"]"})});case "sample.coverage":return aa(function(a){b.command("object"===typeof a&&
a,h,r.commandStr);var d="value"in a?a.value:1;a=!!a.invert;b.command("number"===typeof d&&0<=d&&1>=d,"sample.coverage.value must be a number between 0 and 1",r.commandStr);return[d,a]},function(a,d,r){b.optional(function(){a.assert(d,r+"&&typeof "+r+'==="object"',"invalid sample.coverage")});var c=d.def('"value" in ',r,"?+",r,".value:1"),l=d.def("!!",r,".invert");return[c,l]})}});return x}function Fa(a,d){var l=a["static"],x=a.dynamic,h={};y(l).forEach(function(a){var c=l[a],x;if("number"===typeof c||
"boolean"===typeof c)x=f(function(){return c});else if("function"===typeof c){var aa=c._reglType;"texture2d"===aa||"textureCube"===aa?x=f(function(a){return a.link(c)}):"framebuffer"===aa||"framebufferCube"===aa?(b.command(0<c.color.length,'missing color attachment for framebuffer sent to uniform "'+a+'"',d.commandStr),x=f(function(a){return a.link(c.color[0])})):b.commandRaise('invalid data for uniform "'+a+'"',d.commandStr)}else w(c)?x=f(function(d){return d.global.def("[",ea(c.length,function(r){b.command("number"===
typeof c[r]||"boolean"===typeof c[r],"invalid uniform "+a,d.commandStr);return c[r]}),"]")}):b.commandRaise('invalid or missing data for uniform "'+a+'"',d.commandStr);x.value=c;h[a]=x});y(x).forEach(function(a){var b=x[a];h[a]=c(b,function(a,d){return a.invoke(d,b)})});return h}function Oa(a,d){var l=a["static"],x=a.dynamic,h={};y(l).forEach(function(a){var c=l[a],x=m.id(a),aa=new ka;if(k(c))aa.state=1,aa.buffer=fa.getBuffer(fa.create(c,34962,!1,!0)),aa.type=0;else{var g=fa.getBuffer(c);if(g)aa.state=
...
c&&(b.command(0===z||T,'cannot specify divisor for attribute "'+a+'", instancing not supported',d.commandStr),b.command(0<=z,'invalid divisor for attribute "'+a+'"',d.commandStr));var l=d.commandStr,x="buffer offset divisor normalized type size stride".split(" ");y(c).forEach(function(d){b.command(0<=x.indexOf(d),'unknown parameter "'+d+'" for attribute pointer "'+a+'" (valid parameters are '+x+")",l)})});aa.buffer=g;aa.state=1;aa.size=ia;aa.normalized=u;aa.type=ja||g.dtype;aa.offset=p;aa.stride=
t;aa.divisor=z}}h[a]=f(function(a,b){var d=a.attribCache;if(x in d)return d[x];var r={isStream:!1};y(aa).forEach(function(a){r[a]=aa[a]});aa.buffer&&(r.buffer=a.link(aa.buffer),r.type=r.type||r.buffer+".dtype");return d[x]=r})});y(x).forEach(function(a){var d=x[a];h[a]=c(d,function(r,c){function l(a){c(m[a],"=",x,".",a,"|0;")}var x=r.invoke(c,d),aa=r.shared,h=r.constants,f=aa.isBufferArgs,g=aa.buffer;b.optional(function(){r.assert(c,x+"&&(typeof "+x+'==="object"||typeof '+x+'==="function")&&('+f+
"("+x+")||"+g+".getBuffer("+x+")||"+g+".getBuffer("+x+".buffer)||"+f+"("+x+'.buffer)||("constant" in '+x+"&&(typeof "+x+'.constant==="number"||'+aa.isArrayLike+"("+x+".constant))))",'invalid dynamic attribute "'+a+'"')});var m={isStream:c.def(!1)},e=new ka;e.state=1;y(e).forEach(function(a){m[a]=c.def(""+e[a])});var p=m.buffer,Db=m.type;c("if(",f,"(",x,")){",m.isStream,"=true;",p,"=",g,".createStream(",34962,",",x,");",Db,"=",p,".dtype;","}else{",p,"=",g,".getBuffer(",x,");","if(",p,"){",Db,"=",p,
".dtype;",'}else if("constant" in ',x,"){",m.state,"=",2,";","if(typeof "+x+'.constant === "number"){',m[H[0]],"=",x,".constant;",H.slice(1).map(function(a){return m[a]}).join("="),"=0;","}else{",H.map(function(a,b){return m[a]+"="+x+".constant.length>"+b+"?"+x+".constant["+b+"]:0;"}).join(""),"}}else{","if(",f,"(",x,".buffer)){",p,"=",g,".createStream(",34962,",",x,".buffer);","}else{",p,"=",g,".getBuffer(",x,".buffer);","}",Db,'="type" in ',x,"?",h.glTypes,"[",x,".type]:",p,".dtype;",m.normalized,
"=!!",x,".normalized;");l("size");l("offset");l("stride");l("divisor");c("}}");c.exit("if(",m.isStream,"){",g,".destroyStream(",p,");","}");return m})});return h}function R(a){var b=a["static"],d=a.dynamic,l={};y(b).forEach(function(a){var d=b[a];l[a]=f(function(a,b){return"number"===typeof d||"boolean"===typeof d?""+d:a.link(d)})});y(d).forEach(function(a){var b=d[a];l[a]=c(b,function(a,d){return a.invoke(d,b)})});return l}function Ia(a,d,c,l,x){function h(a){var d=p[a];d&&(n[a]=d)}var f=a["static"],
g=a.dynamic;b.optional(function(){function a(r){y(r).forEach(function(a){b.command(0<=d.indexOf(a),'unknown parameter "'+a+'"',x.commandStr)})}var d="framebuffer vert frag elements primitive offset count instances profile vao".split(" ").concat(ba);a(f);a(g)});var m=Q(a,d),e=Wb(a,x),p=$a(a,e,x),ia=ma(a,x),n=da(a,x),u=t(a,x,m);h("viewport");h(K("scissor.box"));var z=0<y(n).length,e={framebuffer:e,draw:ia,shader:u,state:n,dirty:z,scopeVAO:null,drawVAO:null,useVAO:!1,attributes:{}};e.profile=J(a,x);
e.uniforms=Fa(c,x);e.drawVAO=e.scopeVAO=ia.vao;if(!e.drawVAO&&u.program&&!m&&F.angle_instanced_arrays&&ia["static"].elements){var ja=!0;a=u.program.attributes.map(function(a){a=d["static"][a];ja=ja&&!!a;return a});if(ja&&0<a.length){var C=xa.getVAO(xa.createVAO({attributes:a,elements:ia["static"].elements}));e.drawVAO=new q(null,null,null,function(a,d){return a.link(C)});e.useVAO=!0}}m?e.useVAO=!0:e.attributes=Oa(d,x);e.context=R(l,x);return e}function S(a,d,b){var c=a.shared.context,l=a.scope();
...
x,".bindFramebuffer(",36160,",null);");ha&&d(f,".drawBuffersWEBGL(",g,");");d("}",h,".cur=",a,";");c||d("}")}function ga(a,d,b){var c=a.shared,l=c.gl,h=a.current,f=a.next,g=c.current,m=c.next,e=a.cond(g,".dirty");ba.forEach(function(d){d=K(d);if(!(d in b.state)){var r,c;if(d in f){r=f[d];c=h[d];var p=ea(E[d].length,function(a){return e.def(r,"[",a,"]")});e(a.cond(p.map(function(a,d){return a+"!=="+c+"["+d+"]"}).join("||")).then(l,".",ja[d],"(",p,");",p.map(function(a,d){return c+"["+d+"]="+a}).join(";"),
";"))}else r=e.def(m,".",d),p=a.cond(r,"!==",g,".",d),e(p),d in x?p(a.cond(r).then(l,".enable(",x[d],");")["else"](l,".disable(",x[d],");"),g,".",d,"=",r,";"):p(l,".",ja[d],"(",r,");",g,".",d,"=",r,";")}});0===y(b.state).length&&e(g,".dirty=false;");d(e)}function ta(a,d,b,c){var l=a.shared,h=a.current,f=l.current,g=l.gl;Z(y(b)).forEach(function(l){var e=b[l];if(!c||c(e)){var m=e.append(a,d);if(x[l]){var p=x[l];O(e)?m?d(g,".enable(",p,");"):d(g,".disable(",p,");"):d(a.cond(m).then(g,".enable(",p,");")["else"](g,
".disable(",p,");"));d(f,".",l,"=",m,";")}else if(w(m)){var t=h[l];d(g,".",ja[l],"(",m,");",m.map(function(a,d){return t+"["+d+"]="+a}).join(";"),";")}else d(g,".",ja[l],"(",m,");",f,".",l,"=",m,";")}})}function cc(a,d){T&&(a.instancing=d.def(a.shared.extensions,".angle_instanced_arrays"))}function nc(a,d,b,c,l){function x(){return"undefined"===typeof performance?"Date.now()":"performance.now()"}function h(a){ia=d.def();a(ia,"=",x(),";");"string"===typeof l?a(e,".count+=",l,";"):a(e,".count++;");
Na&&(c?(n=d.def(),a(n,"=",t,".getNumPendingQueries();")):a(t,".beginQuery(",e,");"))}function f(a){a(e,".cpuTime+=",x(),"-",ia,";");Na&&(c?a(t,".pushScopeStats(",n,",",t,".getNumPendingQueries(),",e,");"):a(t,".endQuery();"))}function g(a){var b=d.def(p,".profile");d(p,".profile=",a,";");d.exit(p,".profile=",b,";")}var m=a.shared,e=a.stats,p=m.current,t=m.timer;b=b.profile;var ia,n;if(b){if(O(b)){b.enable?(h(d),f(d.exit),g("true")):g("false");return}b=b.append(a,d);g(b)}else b=d.def(p,".profile");
m=a.block();h(m);d("if(",b,"){",m,"}");a=a.block();f(a);d.exit("if(",b,"){",a,"}")}function kc(a,d,c,l,x){function h(a){switch(a){case 35664:case 35667:case 35671:return 2;case 35665:case 35668:case 35672:return 3;case 35666:case 35669:case 35673:return 4;default:return 1}}function f(b,c,l){function x(){d("if(!",p,".buffer){",m,".enableVertexAttribArray(",e,");}");var b=l.type,h;h=l.size?d.def(l.size,"||",c):c;d("if(",p,".type!==",b,"||",p,".size!==",h,"||",n.map(function(a){return p+"."+a+"!=="+
l[a]}).join("||"),"){",m,".bindBuffer(",34962,",",t,".buffer);",m,".vertexAttribPointer(",[e,h,b,l.normalized,l.stride,l.offset],");",p,".type=",b,";",p,".size=",h,";",n.map(function(a){return p+"."+a+"="+l[a]+";"}).join(""),"}");T&&(b=l.divisor,d("if(",p,".divisor!==",b,"){",a.instancing,".vertexAttribDivisorANGLE(",[e,b],");",p,".divisor=",b,";}"))}function h(){d("if(",p,".buffer){",m,".disableVertexAttribArray(",e,");",p,".buffer=null;","}if(",H.map(function(a,d){return p+"."+a+"!=="+ia[d]}).join("||"),
"){",m,".vertexAttrib4f(",e,",",ia,");",H.map(function(a,d){return p+"."+a+"="+ia[d]+";"}).join(""),"}")}var m=g.gl,e=d.def(b,".location"),p=d.def(g.attributes,"[",e,"]");b=l.state;var t=l.buffer,ia=[l.x,l.y,l.z,l.w],n=["buffer","normalized","offset","stride"];1===b?x():2===b?h():(d("if(",b,"===",1,"){"),x(),d("}else{"),h(),d("}"))}var g=a.shared;l.forEach(function(l){var g=l.name,e=c.attributes[g],m;if(e){if(!x(e))return;m=e.append(a,d)}else{if(!x(U))return;var p=a.scopeAttrib(g);b.optional(function(){a.assert(d,
p+".state","missing attribute "+g)});m={};y(new ka).forEach(function(a){m[a]=d.def(p,".",a)})}f(a.link(l),h(l.info.type),m)})}function ud(a,d,c,l,x,h){for(var f=a.shared,g=f.gl,e,p=0;p<l.length;++p){var t=l[p],ia=t.name,n=t.info.type,u=c.uniforms[ia],t=a.link(t)+".location",ja;if(u){if(!x(u))continue;if(O(u)){var z=u.value;b.command(null!==z&&"undefined"!==typeof z,'missing uniform "'+ia+'"',a.commandStr);if(35678===n||35680===n)b.command("function"===typeof z&&(35678===n&&("texture2d"===z._reglType||
...
4===z.length,"uniform "+ia,a.commandStr);e="4i";break;case 35669:b.command(w(z)&&4===z.length,"uniform "+ia,a.commandStr),e="4i"}d(g,".uniform",e,"(",t,",",w(z)?Array.prototype.slice.call(z):z,");")}continue}else ja=u.append(a,d)}else{if(!x(U))continue;ja=d.def(f.uniforms,"[",m.id(ia),"]")}35678===n?(b(!Array.isArray(ja),"must specify a scalar prop for textures"),d("if(",ja,"&&",ja,'._reglType==="framebuffer"){',ja,"=",ja,".color[0];","}")):35680===n&&(b(!Array.isArray(ja),"must specify a scalar prop for cube maps"),
...
b,'"');break;case "object":Array.isArray(b)&&h("[",b.join(),"]");break;default:h(a.link(b))}h(";")}});d.dynamic[b]=new B.DynamicVariable(4,{thisDep:g,contextDep:e,propDep:m,ref:p,append:l});delete d["static"][b]}}var ka=xa.Record,ua={add:32774,subtract:32778,"reverse subtract":32779};F.ext_blend_minmax&&(ua.min=32775,ua.max=32776);var T=F.angle_instanced_arrays,ha=F.webgl_draw_buffers,qa=F.oes_vertex_array_object,E={dirty:!0,profile:Y.profile},p={},ba=[],x={},ja={};M("dither",3024);M("blend.enable",
...
p,".normalized,",p,".stride,",p,".offset);")["else"](h,".disableVertexAttribArray(",m,");",h,".vertexAttrib4f(",m,",",p,".x,",p,".y,",p,".z,",p,".w);",p,".buffer=null;");b(ia);T&&b(e,".vertexAttribDivisorANGLE(",m,",",p,".divisor);")}b(a.shared.vao,".currentVAO=null;",a.shared.vao,".setVAO(",a.shared.vao,".targetVAO);");y(x).forEach(function(l){var e=x[l],m=c.def(f,".",l),p=a.block();p("if(",m,"){",h,".enable(",e,")}else{",h,".disable(",e,")}",g,".",l,"=",m,";");b(p);d("if(",m,"!==",g,".",l,"){",
p,"}")});y(ja).forEach(function(l){var x=ja[l],e=E[l],m,p,ia=a.block();ia(h,".",x,"(");w(e)?(x=e.length,m=a.global.def(f,".",l),p=a.global.def(g,".",l),ia(ea(x,function(a){return m+"["+a+"]"}),");",ea(x,function(a){return p+"["+a+"]="+m+"["+a+"];"}).join("")),d("if(",ea(x,function(a){return m+"["+a+"]!=="+p+"["+a+"]"}).join("||"),"){",ia,"}")):(m=c.def(f,".",l),p=c.def(g,".",l),ia(m,");",g,".",l,"=",m,";"),d("if(",m,"!==",p,"){",ia,"}"));b(ia)});return a.compile()}(),compile:function(a,d,b,c,l){var x=
...
c.concat(Z(b[f]));return c}function q(c){return"["+Z(c).join("][")+"]"}function O(c,b){if("function"===typeof c)return new k(0,c);if("number"===typeof c||"boolean"===typeof c)return new k(5,c);if(Array.isArray(c))return new k(6,c.map(function(c,f){return O(c,b+"["+f+"]")}));if(c instanceof k)return c;f(!1,"invalid option type in uniform "+b)}var f=A("./util/check"),c=0;R.exports={DynamicVariable:k,define:function(c,b){return new k(c,q(b+""))},isDynamic:function(c){return"function"===typeof c&&!c._reglType||
c instanceof k},unbox:O,accessor:q}},{"./util/check":21}],10:[function(A,R,Ib){var k=A("./util/check"),Z=A("./util/is-typed-array"),q=A("./util/is-ndarray"),O=A("./util/values"),f=A("./constants/primitives.json"),c=A("./constants/usage.json");R.exports=function(y,b,v,pa){function ea(b){this.id=B++;w[this.id]=this;this.buffer=b;this.primType=4;this.type=this.vertCount=0}function G(c,f,n,w,e,g,d){c.buffer.bind();var z;f?((z=d)||Z(f)&&(!q(f)||Z(f.data))||(z=b.oes_element_index_uint?5125:5123),v._initBuffer(c.buffer,
...
else{var d=null,n=35044,v=-1,B=-1,m=0,H=0;if(Array.isArray(b)||Z(b)||q(b))d=b;else if(k.type(b,"object","invalid arguments for elements"),"data"in b&&(d=b.data,k(Array.isArray(d)||Z(d)||q(d),"invalid data for element buffer")),"usage"in b&&(k.parameter(b.usage,c,"invalid element buffer usage"),n=c[b.usage]),"primitive"in b&&(k.parameter(b.primitive,f,"invalid element buffer primitive"),v=f[b.primitive]),"count"in b&&(k("number"===typeof b.count&&0<=b.count,"invalid vertex count for elements"),B=b.count|
0),"type"in b&&(k.parameter(b.type,N,"invalid buffer type"),H=N[b.type]),"length"in b)m=b.length|0;else if(m=B,5123===H||5122===H)m*=2;else if(5125===H||5124===H)m*=4;G(e,d,n,v,B,m,H)}else y(),e.primType=4,e.vertCount=0,e.type=5121;return w}var y=v.create(null,34963,!0),e=new ea(y._buffer);pa.elementsCount++;w(b);w._reglType="elements";w._elements=e;w.subdata=function(b,d){y.subdata(b,d);return w};w.destroy=function(){F(e)};return w},createStream:function(b){var c=n.pop();c||(c=new ea(v.create(null,
34963,!0,!1)._buffer));G(c,b,35040,-1,-1,0,0);return c},destroyStream:function(b){n.push(b)},getElements:function(b){return"function"===typeof b&&b._elements instanceof ea?b._elements:null},clear:function(){O(w).forEach(F)}}}},{"./constants/primitives.json":6,"./constants/usage.json":7,"./util/check":21,"./util/is-ndarray":28,"./util/is-typed-array":30,"./util/values":36}],11:[function(A,R,Ib){var k=A("./util/sorted-object-keys"),Z=A("./util/check");R.exports=function(q,O){function f(b){Z.type(b,
...
b);})}}}},{"./util/check":21,"./util/sorted-object-keys":34}],12:[function(A,R,Ib){var k=A("./util/check"),Z=A("./util/values"),q=A("./util/extend"),O=[6407,6408],f=[];f[6408]=4;f[6407]=3;var c=[];c[5121]=1;c[5126]=4;c[36193]=2;var y=[32854,32855,36194,35907,34842,34843,34836],b={36053:"complete",36054:"incomplete attachment",36057:"incomplete dimensions",36055:"incomplete, missing attachment",36061:"unsupported"};R.exports=function(v,pa,ea,G,F,w){function B(a,d,b){this.target=a;this.texture=d;this.renderbuffer=
...
d,c[d]);for(d=c.length;d<ea.maxColorAttachments;++d)v.framebufferTexture2D(36160,36064+d,3553,null,0);v.framebufferTexture2D(36160,33306,3553,null,0);v.framebufferTexture2D(36160,36096,3553,null,0);v.framebufferTexture2D(36160,36128,3553,null,0);H(36096,a.depthAttachment);H(36128,a.stencilAttachment);H(33306,a.depthStencilAttachment);a=v.checkFramebufferStatus(36160);v.isContextLost()||36053===a||k.raise("framebuffer configuration not supported, status = "+b[a]);v.bindFramebuffer(36160,m.next?m.next.framebuffer:
null);m.cur=m.next;v.getError()}function W(a,b){function h(a,b){var e;k(m.next!==v,"can not update framebuffer which is currently in use");var g=0,z=0,w=!0,q=!0;e=null;var G=!0,B="rgba",F="uint8",H=1,Z=null,t=null,N=null,X=!1;if("number"===typeof a)g=a|0,z=b|0||g;else if(a){k.type(a,"object","invalid arguments for framebuffer");"shape"in a?(z=a.shape,k(Array.isArray(z)&&2<=z.length,"invalid shape for framebuffer"),g=z[0],z=z[1]):("radius"in a&&(g=z=a.radius),"width"in a&&(g=a.width),"height"in a&&
...
a&&(B=a.colorFormat,0<=oa.indexOf(B)?G=!0:0<=L.indexOf(B)?G=!1:k.optional(function(){if(G)k.oneOf(a.colorFormat,oa,"invalid color format for texture");else k.oneOf(a.colorFormat,L,"invalid color format for renderbuffer")}))}if("depthTexture"in a||"depthStencilTexture"in a)X=!(!a.depthTexture&&!a.depthStencilTexture),k(!X||pa.webgl_depth_texture,"webgl_depth_texture extension not supported");"depth"in a&&("boolean"===typeof a.depth?w=a.depth:(Z=a.depth,q=!1));"stencil"in a&&("boolean"===typeof a.stencil?
q=a.stencil:(t=a.stencil,w=!1));"depthStencil"in a&&("boolean"===typeof a.depthStencil?w=q=a.depthStencil:(N=a.depthStencil,q=w=!1))}else g=z=1;var W=null,ra=null,R=null,Ia=null;if(Array.isArray(e))W=e.map(ca);else if(e)W=[ca(e)];else for(W=Array(H),e=0;e<H;++e)W[e]=I(g,z,G,B,F);k(pa.webgl_draw_buffers||1>=W.length,"you must enable the WEBGL_draw_buffers extension in order to use multiple color buffers.");k(W.length<=ea.maxColorAttachments,"too many color attachments, not supported");g=g||W[0].width;
z=z||W[0].height;Z?ra=ca(Z):w&&!q&&(ra=I(g,z,X,"depth","uint32"));t?R=ca(t):q&&!w&&(R=I(g,z,!1,"stencil","uint8"));N?Ia=ca(N):!Z&&!t&&q&&w&&(Ia=I(g,z,X,"depth stencil","depth stencil"));k(1>=!!Z+!!t+!!N,"invalid framebuffer configuration, can specify exactly one depth/stencil attachment");w=null;for(e=0;e<W.length;++e)n(W[e],g,z),k(!W[e]||W[e].texture&&0<=O.indexOf(W[e].texture._texture.format)||W[e].renderbuffer&&0<=y.indexOf(W[e].renderbuffer._renderbuffer.format),"framebuffer color attachment "+
e+" is invalid"),W[e]&&W[e].texture&&(q=f[W[e].texture._texture.format]*c[W[e].texture._texture.type],null===w?w=q:k(w===q,"all color attachments much have the same number of bits per pixel."));n(ra,g,z);k(!ra||ra.texture&&6402===ra.texture._texture.format||ra.renderbuffer&&33189===ra.renderbuffer._renderbuffer.format,"invalid depth attachment for framebuffer object");n(R,g,z);k(!R||R.renderbuffer&&36168===R.renderbuffer._renderbuffer.format,"invalid stencil attachment for framebuffer object");n(Ia,
g,z);k(!Ia||Ia.texture&&34041===Ia.texture._texture.format||Ia.renderbuffer&&34041===Ia.renderbuffer._renderbuffer.format,"invalid depth-stencil attachment for framebuffer object");d(v);v.width=g;v.height=z;v.colorAttachments=W;v.depthAttachment=ra;v.stencilAttachment=R;v.depthStencilAttachment=Ia;h.color=W.map(A);h.depth=A(ra);h.stencil=A(R);h.depthStencil=A(Ia);h.width=v.width;h.height=v.height;U(v);return h}var v=new g;w.framebufferCount++;h(a,b);return q(h,{resize:function(a,d){k(m.next!==v,"can not resize a framebuffer which is currently in use");
var b=Math.max(a|0,1),c=Math.max(d|0||b,1);if(b===v.width&&c===v.height)return h;for(var f=v.colorAttachments,g=0;g<f.length;++g)e(f[g],b,c);e(v.depthAttachment,b,c);e(v.stencilAttachment,b,c);e(v.depthStencilAttachment,b,c);v.width=h.width=b;v.height=h.height=c;U(v);return h},_reglType:"framebuffer",_framebuffer:v,destroy:function(){z(v);d(v)},use:function(a){m.setFBO({framebuffer:h},a)}})}var m={cur:null,next:null,dirty:!1,setFBO:null},oa=["rgba"],L=["rgba4","rgb565","rgb5 a1"];pa.ext_srgb&&L.push("srgba");
pa.ext_color_buffer_half_float&&L.push("rgba16f","rgb16f");pa.webgl_color_buffer_float&&L.push("rgba32f");var fa=["uint8"];pa.oes_texture_half_float&&fa.push("half float","float16");pa.oes_texture_float&&fa.push("float","float32");var a=0,h={};return q(m,{getFramebuffer:function(a){return"function"===typeof a&&"framebuffer"===a._reglType&&(a=a._framebuffer,a instanceof g)?a:null},create:W,createCube:function(a){function d(a){var c;k(0>b.indexOf(m.next),"can not update framebuffer which is currently in use");
...
W(h)}return q(d,{width:f,height:f,color:a})}var b=Array(6);d(a);return q(d,{faces:b,resize:function(a){var c=a|0;k(0<c&&c<=ea.maxCubeMapSize,"invalid radius for cube fbo");if(c===d.width)return d;var h=d.color;for(a=0;a<h.length;++a)h[a].resize(c);for(a=0;6>a;++a)b[a].resize(c);d.width=d.height=c;return d},_reglType:"framebufferCube",destroy:function(){b.forEach(function(a){a.destroy()})}})},clear:function(){Z(h).forEach(z)},restore:function(){m.cur=null;m.next=null;m.dirty=!0;Z(h).forEach(function(a){a.framebuffer=
v.createFramebuffer();U(a)})}})}},{"./util/check":21,"./util/extend":25,"./util/values":36}],13:[function(A,R,Ib){var k=A("./util/sorted-object-keys"),Z=A("./util/pool");R.exports=function(q,O){var f=1;O.ext_texture_filter_anisotropic&&(f=q.getParameter(34047));var c=1,y=1;O.webgl_draw_buffers&&(c=q.getParameter(34852),y=q.getParameter(36063));var b=!!O.oes_texture_float;if(b){b=q.createTexture();q.bindTexture(3553,b);q.texImage2D(3553,0,6408,1,1,0,6408,5126,null);var v=q.createFramebuffer();q.bindFramebuffer(36160,
v);q.framebufferTexture2D(36160,36064,3553,b,0);q.bindTexture(3553,null);if(36053!==q.checkFramebufferStatus(36160))b=!1;else{q.viewport(0,0,1,1);q.clearColor(1,0,0,1);q.clear(16384);var pa=Z.allocType(5126,4);q.readPixels(0,0,1,1,6408,5126,pa);q.getError()?b=!1:(q.deleteFramebuffer(v),q.deleteTexture(b),b=1===pa[0]);Z.freeType(pa)}}pa=!0;"undefined"!==typeof navigator&&(/MSIE/.test(navigator.userAgent)||/Trident\//.test(navigator.appVersion)||/Edge/.test(navigator.userAgent))||(pa=q.createTexture(),
v=Z.allocType(5121,36),q.activeTexture(33984),q.bindTexture(34067,pa),q.texImage2D(34069,0,6408,3,3,0,6408,5121,v),Z.freeType(v),q.bindTexture(34067,null),q.deleteTexture(pa),pa=!q.getError());return{colorBits:[q.getParameter(3410),q.getParameter(3411),q.getParameter(3412),q.getParameter(3413)],depthBits:q.getParameter(3414),stencilBits:q.getParameter(3415),subpixelBits:q.getParameter(3408),extensions:k(O).filter(function(b){return!!O[b]}),maxAnisotropic:f,maxDrawbuffers:c,maxColorAttachments:y,pointSizeDims:q.getParameter(33901),
lineWidthDims:q.getParameter(33902),maxViewportDims:q.getParameter(3386),maxCombinedTextureUnits:q.getParameter(35661),maxCubeMapSize:q.getParameter(34076),maxRenderbufferSize:q.getParameter(34024),maxTextureUnits:q.getParameter(34930),maxTextureSize:q.getParameter(3379),maxAttributes:q.getParameter(34921),maxVertexUniforms:q.getParameter(36347),maxVertexTextureUnits:q.getParameter(35660),maxVaryingVectors:q.getParameter(36348),maxFragmentUniforms:q.getParameter(36349),glsl:q.getParameter(35724),
renderer:q.getParameter(7937),vendor:q.getParameter(7936),version:q.getParameter(7938),readFloat:b,npotTextureCube:pa}}},{"./util/pool":32,"./util/sorted-object-keys":34}],14:[function(A,R,Ib){var k=A("./util/check"),Z=A("./util/is-typed-array");R.exports=function(q,O,f,c,y,b,v){function pa(G){var F;null===O.next?(k(y.preserveDrawingBuffer,'you must create a webgl context with "preserveDrawingBuffer":true in order to read pixels from the drawing buffer'),F=5121):(k(null!==O.next.colorAttachments[0].texture,
...
w._renderbuffer=k;v.profile&&(w.stats=k.stats);w.destroy=function(){k.decRef()};return w},clear:function(){q(B).forEach(ea)},restore:function(){q(B).forEach(function(b){b.renderbuffer=f.createRenderbuffer();f.bindRenderbuffer(36161,b.renderbuffer);f.renderbufferStorage(36161,b.format,b.width,b.height)});f.bindRenderbuffer(36161,null)}}}},{"./util/check":21,"./util/sorted-object-keys":34,"./util/values":36}],16:[function(A,R,Ib){var k=A("./util/sorted-object-keys"),Z=A("./util/check"),q=A("./util/extend"),
...
(d.refCount++,!e))return d;var z=new G(c,b);y.shaderCount++;F(z,v,e);d||(g[b]=z);n.push(z);return q(z,{destroy:function(){z.refCount--;if(0>=z.refCount){f.deleteProgram(z.program);var b=n.indexOf(z);n.splice(b,1);y.shaderCount--}0>=g[z.vertId].refCount&&(f.deleteShader(B[z.vertId]),delete B[z.vertId],delete N[z.fragId][z.vertId]);k(N[z.fragId]).length||(f.deleteShader(w[z.fragId]),delete w[z.fragId],delete N[z.fragId])}})},restore:function(){w={};B={};for(var b=0;b<n.length;++b)F(n[b],null,n[b].attributes.map(function(b){return[b.location,
b.name]}))},shader:ea,frag:-1,vert:-1}}},{"./util/check":21,"./util/extend":25,"./util/sorted-object-keys":34,"./util/values":36}],17:[function(A,R,Ib){R.exports=function(){return{vaoCount:0,bufferCount:0,elementsCount:0,framebufferCount:0,shaderCount:0,textureCount:0,cubeCount:0,renderbufferCount:0,maxTextureUnits:0}}},{}],18:[function(A,R,Ib){R.exports=function(){var k={"":0},Z=[""];return{id:function(q){var O=k[q];if(O)return O;O=k[q]=Z.length;Z.push(q);return O},str:function(k){return Z[k]}}}},
{}],19:[function(A,R,Ib){function k(a){return"[object "+a+"]"}function Z(a){return Array.isArray(a)&&(0===a.length||"number"===typeof a[0])}function q(a){return Array.isArray(a)&&0!==a.length&&N(a[0])?!0:!1}function O(a){return Object.prototype.toString.call(a)}function f(a){if(!a)return!1;var b=O(a);return 0<=oa.indexOf(b)?!0:Z(a)||q(a)||F(a)}function c(a,b){36193===a.type?(a.data=B(b),w.freeType(b)):a.data=b}function y(a,b,d,c,f,g){a="undefined"!==typeof fa[a]?fa[a]:e[a]*L[b];g&&(a*=6);if(f){for(c=
...
e[35904]=3;e[6408]=e[35906]=4;var g=k("HTMLCanvasElement"),d=k("OffscreenCanvas"),z=k("CanvasRenderingContext2D"),U=k("ImageBitmap"),W=k("HTMLImageElement"),m=k("HTMLVideoElement"),oa=b(Ib).concat([g,d,z,U,W,m]),L=[];L[5121]=1;L[5126]=4;L[36193]=2;L[5123]=2;L[5125]=4;var fa=[];fa[32854]=2;fa[32855]=2;fa[36194]=2;fa[34041]=4;fa[33776]=.5;fa[33777]=.5;fa[33778]=1;fa[33779]=1;fa[35986]=.5;fa[35987]=1;fa[34798]=1;fa[35840]=.5;fa[35841]=.25;fa[35842]=.5;fa[35843]=.25;fa[36196]=.5;R.exports=function(a,
...
1;a.needsFree=!0}else if(F(h)){l=h.data;Array.isArray(l)||5121!==a.type||(a.type=ca[Object.prototype.toString.call(l)]|0);var e=h.shape,p=h.stride,r,t,u,C;3===e.length?(u=e[2],C=p[2]):(v(2===e.length,"invalid ndarray pixel data, must be 2 or 3D"),C=u=1);r=e[0];t=e[1];e=p[0];p=p[1];a.alignment=1;a.width=r;a.height=t;a.channels=u;a.format=a.internalformat=be[u];a.needsFree=!0;r=C;h=h.offset;u=a.width;C=a.height;t=a.channels;for(var y=w.allocType(36193===a.type?5126:a.type,u*C*t),E=0,ba=0;ba<C;++ba)for(var D=
0;D<u;++D)for(var V=0;V<t;++V)y[E++]=l[e*D+p*ba+r*V+h];c(a,y)}else if(O(h)===g||O(h)===d||O(h)===z)O(h)===g||O(h)===d?a.element=h:a.element=h.canvas,a.width=a.element.width,a.height=a.element.height,a.channels=4;else if(O(h)===U)a.element=h,a.width=h.width,a.height=h.height,a.channels=4;else if(O(h)===W)a.element=h,a.width=h.naturalWidth,a.height=h.naturalHeight,a.channels=4;else if(O(h)===m)a.element=h,a.width=h.videoWidth,a.height=h.videoHeight,a.channels=4;else if(q(h)){l=a.width||h[0].length;
e=a.height||h.length;p=a.channels;p=N(h[0][0])?p||h[0][0].length:p||1;r=n.shape(h);u=1;for(C=0;C<r.length;++C)u*=r[C];u=w.allocType(36193===a.type?5126:a.type,u);n.flatten(h,r,"",u);c(a,u);a.alignment=1;a.width=l;a.height=e;a.channels=p;a.format=a.internalformat=be[p];a.needsFree=!0}5126===a.type?v(0<=k.extensions.indexOf("oes_texture_float"),"oes_texture_float extension not enabled"):36193===a.type&&v(0<=k.extensions.indexOf("oes_texture_half_float"),"oes_texture_half_float extension not enabled")}
function sa(b,d,c,l,h){var f=b.element,e=b.data,g=b.internalformat,m=b.format,p=b.type,z=b.width,n=b.height;K(b);f?a.texSubImage2D(d,h,c,l,m,p,f):b.compressed?a.compressedTexSubImage2D(d,h,c,l,g,z,n,e):b.needsCopy?(L(),a.copyTexSubImage2D(d,h,c,l,b.xOffset,b.yOffset,z,n)):a.texSubImage2D(d,h,c,l,z,n,m,p,e)}function J(){return T.pop()||new M}function R(a){a.needsFree&&w.freeType(a.data);M.call(a);T.push(a)}function $a(){na.call(this);this.genMipmaps=!1;this.mipmapHint=4352;this.mipmask=0;this.images=
...
a[d]=6408:a[d]=6407;return a},{}),T=[],ha=[],qa=0,E={},p=k.maxTextureUnits,ba=Array(p).map(function(){return null});pa(S.prototype,{bind:function(){this.bindCount+=1;var b=this.unit;if(0>b){for(var d=0;d<p;++d){var c=ba[d];if(c){if(0<c.bindCount)continue;c.unit=-1}ba[d]=this;b=d;break}b>=p&&v.raise("insufficient number of texture units");oa.profile&&A.maxTextureUnits<b+1&&(A.maxTextureUnits=b+1);this.unit=b;a.activeTexture(33984+b);a.bindTexture(this.target,this.texture)}return b},unbind:function(){--this.bindCount},
...
e;ob(h);for(var g=0;h.mipmask>>g;++g){var m=f>>g,p=e>>g;if(!m||!p)break;a.texImage2D(3553,g,h.format,m,p,0,h.format,h.type,null)}ga();oa.profile&&(h.stats.size=y(h.internalformat,h.type,f,e,!1,!1));return c};c._reglType="texture2d";c._texture=h;oa.profile&&(c.stats=h.stats);c.destroy=function(){h.decRef()};return c},createCube:function(b,d,c,h,f,e){function g(a,b,d,c,h,l){var f,e=m.texInfo;Oa.call(e);for(f=0;6>f;++f)p[f]=da();if("number"!==typeof a&&a)if("object"===typeof a)if(b)t(p[0],a),t(p[1],
b),t(p[2],d),t(p[3],c),t(p[4],h),t(p[5],l);else if($b(e,a),Y(m,a),"faces"in a)for(a=a.faces,v(Array.isArray(a)&&6===a.length,"cube faces must be a length 6 array"),f=0;6>f;++f)v("object"===typeof a[f]&&!!a[f],"invalid input for cube map face"),Na(p[f],m),t(p[f],a[f]);else for(f=0;6>f;++f)t(p[f],a);else v.raise("invalid arguments to cube map");else for(a=a|0||1,f=0;6>f;++f)Q(p[f],a,a);Na(m,p[0]);v.optional(function(){k.npotTextureCube||v(H(m.width)&&H(m.height),"your browser does not support non power or two texture dimensions")});
m.mipmask=e.genMipmaps?(p[0].width<<1)-1:p[0].mipmask;v.textureCube(m,e,p,k);m.internalformat=p[0].internalformat;g.width=p[0].width;g.height=p[0].height;ob(m);for(f=0;6>f;++f)ma(p[f],34069+f);Ia(e,34067);ga();oa.profile&&(m.stats.size=y(m.internalformat,m.type,g.width,g.height,e.genMipmaps,!0));g.format=Qc[m.internalformat];g.type=Uc[m.type];g.mag=D[e.magFilter];g.min=u[e.minFilter];g.wrapS=ka[e.wrapS];g.wrapT=ka[e.wrapT];for(f=0;6>f;++f)Fa(p[f]);return g}var m=new S(34067);E[m.id]=m;A.cubeCount++;
var p=Array(6);g(b,d,c,h,f,e);g.subimage=function(a,b,d,c,h){v(!!b,"must specify image data");v("number"===typeof a&&a===(a|0)&&0<=a&&6>a,"invalid face");d|=0;c|=0;h|=0;var f=J();Na(f,m);f.width=0;f.height=0;P(f,b);f.width=f.width||(m.width>>h)-d;f.height=f.height||(m.height>>h)-c;v(m.type===f.type&&m.format===f.format&&m.internalformat===f.internalformat,"incompatible format for texture.subimage");v(0<=d&&0<=c&&d+f.width<=m.width&&c+f.height<=m.height,"texture.subimage write out of bounds");v(m.mipmask&
...
function(){m.decRef()};return g},clear:function(){for(var b=0;b<p;++b)a.activeTexture(33984+b),a.bindTexture(3553,null),ba[b]=null;ea(E).forEach(ta);A.cubeCount=0;A.textureCount=0},getTexture:function(a){return null},restore:function(){for(var b=0;b<p;++b){var d=ba[b];d&&(d.bindCount=0,d.unit=-1,ba[b]=null)}ea(E).forEach(function(b){b.texture=a.createTexture();a.bindTexture(b.target,b.texture);for(var d=0;32>d;++d)if(0!==(b.mipmask&1<<d))if(3553===b.target)a.texImage2D(3553,d,b.internalformat,b.width>>
d,b.height>>d,0,b.internalformat,b.type,null);else for(var c=0;6>c;++c)a.texImage2D(34069+c,d,b.internalformat,b.width>>d,b.height>>d,0,b.internalformat,b.type,null);Ia(b.texInfo,b.target)})},refresh:function(){for(var b=0;b<p;++b){var d=ba[b];d&&(d.bindCount=0,d.unit=-1,ba[b]=null);a.activeTexture(33984+b);a.bindTexture(3553,null);a.bindTexture(34067,null)}}}}},{"./constants/arraytypes.json":4,"./util/check":21,"./util/extend":25,"./util/flatten":26,"./util/is-array-like":27,"./util/is-ndarray":28,
"./util/is-pow2":29,"./util/is-typed-array":30,"./util/pool":32,"./util/sorted-object-keys":34,"./util/to-half-float":35,"./util/values":36}],20:[function(A,R,Ib){R.exports=function(k,Z){function q(){this.endQueryIndex=this.startQueryIndex=-1;this.sum=0;this.stats=null}function O(c,f,k){var w=y.pop()||new q;w.startQueryIndex=c;w.endQueryIndex=f;w.sum=0;w.stats=k;b.push(w)}if(!Z.ext_disjoint_timer_query)return null;var f=[],c=[],y=[],b=[],v=[],pa=[];return{beginQuery:function(b){var k=f.pop()||Z.ext_disjoint_timer_query.createQueryEXT();
Z.ext_disjoint_timer_query.beginQueryEXT(35007,k);c.push(k);O(c.length-1,c.length,b)},endQuery:function(){Z.ext_disjoint_timer_query.endQueryEXT(35007)},pushScopeStats:O,update:function(){var k,q;k=c.length;if(0!==k){pa.length=Math.max(pa.length,k+1);v.length=Math.max(v.length,k+1);v[0]=0;var F=pa[0]=0;for(q=k=0;q<c.length;++q){var w=c[q];Z.ext_disjoint_timer_query.getQueryObjectEXT(w,34919)?(F+=Z.ext_disjoint_timer_query.getQueryObjectEXT(w,34918),f.push(w)):c[k++]=w;v[q+1]=F;pa[q+1]=k}c.length=
...
g={};g[5120]=g[5121]=1;g[5122]=g[5123]=g[36193]=g[33635]=g[32819]=g[32820]=2;g[5124]=g[5125]=g[5126]=g[34042]=4;R.exports=A(q,{optional:function(b){b()},raise:Z,commandRaise:n,command:function(b,c,f){b||n(c,f||ea())},parameter:function(b,c,f){b in c||Z("unknown parameter ("+b+")"+O(f)+". possible values: "+I(c).join())},commandParameter:function(b,c,f,e){b in c||n("unknown parameter ("+b+")"+O(f)+". possible values: "+I(c).join(),e||ea())},constructor:function(b){I(b).forEach(function(b){0>e.indexOf(b)&&
...
guessCommand:ea,texture2D:function(b,c,f){var e=c.width,g=c.height,n=c.channels;q(0<e&&e<=f.maxTextureSize&&0<g&&g<=f.maxTextureSize,"invalid texture shape");33071===b.wrapS&&33071===b.wrapT||q(!(e&e-1)&&!!e&&!(g&g-1)&&!!g,"incompatible wrap mode for texture, both width and height must be power of 2");1===c.mipmask?1!==e&&1!==g&&q(9984!==b.minFilter&&9986!==b.minFilter&&9985!==b.minFilter&&9987!==b.minFilter,"min filter requires mipmap"):(q(!(e&e-1)&&!!e&&!(g&g-1)&&!!g,"texture must be a square power of 2 to support mipmapping"),
q(c.mipmask===(e<<1)-1,"missing or incomplete mipmap data"));5126===c.type&&(0>f.extensions.indexOf("oes_texture_float_linear")&&q(9728===b.minFilter&&9728===b.magFilter,"filter not supported, must enable oes_texture_float_linear"),q(!b.genMipmaps,"mipmap generation not supported with float textures"));var k=c.images;for(f=0;16>f;++f)if(k[f]){var w=e>>f,a=g>>f;q(c.mipmask&1<<f,"missing mipmap data");var h=k[f];q(h.width===w&&h.height===a,"invalid shape for mip images");q(h.format===c.format&&h.internalformat===
c.internalformat&&h.type===c.type,"incompatible type for mip image");!h.compressed&&h.data&&(w=Math.ceil(ca(h.type,n)*w/h.unpackAlignment)*h.unpackAlignment,q(h.data.byteLength===w*a,"invalid data for image, buffer size is inconsistent with image format"))}else b.genMipmaps||q(0===(c.mipmask&1<<f),"extra mipmap data");c.compressed&&q(!b.genMipmaps,"mipmap generation for compressed images not supported")},textureCube:function(b,c,f,e){var g=b.width,n=b.height,k=b.channels;q(0<g&&g<=e.maxTextureSize&&
0<n&&n<=e.maxTextureSize,"invalid texture shape");q(g===n,"cube map must be square");q(33071===c.wrapS&&33071===c.wrapT,"wrap mode not supported by cube map");for(e=0;e<f.length;++e){var w=f[e];q(w.width===g&&w.height===n,"inconsistent cube map face shape");c.genMipmaps&&(q(!w.compressed,"can not generate mipmap for compressed textures"),q(1===w.mipmask,"can not specify mipmaps and generate mipmaps"));for(var a=w.images,h=0;16>h;++h){var v=a[h];if(v){var y=g>>h,B=n>>h;q(w.mipmask&1<<h,"missing mipmap data");
q(v.width===y&&v.height===B,"invalid shape for mip images");q(v.format===b.format&&v.internalformat===b.internalformat&&v.type===b.type,"incompatible type for mip image");v.compressed||v.data&&q(v.data.byteLength===y*B*Math.max(ca(v.type,k),v.unpackAlignment),"invalid data for image, buffer size is inconsistent with image format")}}}}})},{"./extend":25,"./is-typed-array":30,"./sorted-object-keys":34}],22:[function(A,R,Ib){R.exports="undefined"!==typeof performance&&performance.now?function(){return performance.now()}:
function(){return+new Date}},{}],23:[function(A,R,Ib){function k(k){return Array.prototype.slice.call(k)}var Z=A("./extend"),q=A("./compiled-fns");R.exports=function(){function O(){var b=[],c=[];return Z(function(){b.push.apply(b,k(arguments))},{def:function(){var f="v"+y;y++;c.push(f);0<arguments.length&&(b.push(f,"="),b.push.apply(b,k(arguments)),b.push(";"));return f},toString:function(){return k([0<c.length?"var "+c.join(",")+";":"",k(b).join("")]).join("")}})}function f(){function b(k,w){f(k,
w,"=",c.def(k,w),";")}var c=O(),f=O(),v=c.toString,w=f.toString;return Z(function(){c.apply(c,k(arguments))},{def:c.def,entry:c,exit:f,save:b,set:function(f,k,n){b(f,k);c(f,k,"=",n,";")},toString:function(){return v()+w()}})}var c=0,y=0,b={},v={};return{global:O(),link:function(f){var k="$"+c,v=!1;"object"===typeof f&&f.name&&(k=f.name.replace(/ /g,"_"),v=!0);if(k in b)return k;b[k]=f;v||c++;return k},block:O,proc:function(b,c){function y(){var b="a"+q.length;q.push(b);return b}var q=[];c=c||0;for(var w=
0;w<c;++w)y();var w=f(),B=w.toString;return v[b]=Z(w,{arg:y,toString:function(){return k(["function(",q.join(),"){",B(),"}"]).join("")}})},scope:f,cond:function(){var b=k(arguments).join(""),c=f(),v=f(),y=c.toString,w=v.toString;return Z(c,{then:function(){c.apply(c,k(arguments));return this},"else":function(){v.apply(v,k(arguments));return this},toString:function(){var c=w();c&&(c="else{"+c+"}");return k(["if(",b,"){",y(),"}",c]).join("")}})},compile:function(){var c=[],f=[];Object.keys(b).sort(function(b,
c){var f="$"===b.charAt(0),n="$"===c.charAt(0);return f||n?f&&n?+b.slice(1)<+c.slice(1)?-1:1:f&&!n?-1:1:b.localeCompare(c)}).forEach(function(k){var v=b[k];c.push(k);f.push(v)});for(var k=0,v=c.length-1;-1<v;v--)if("$"===c[v].charAt(0)){k=v;break}k=c.slice(k).join();v=q[k];if(!v)throw Error("missing precompiled function with key: "+k);return v.apply(null,f)}}}},{"./compiled-fns":24,"./extend":25}],24:[function(A,R,Ib){R.exports={$0:function(k){var Z,q,O,f,c,y,b,v,A,ea,G,F,w,B,N,n,H,ca,I,R,e,g,d,z,
U,W,m,oa,L,fa;Z=k.attributes;q=k.current;O=k.framebuffer;f=k.gl;c=k.next;y=k.vao;b=c.blend_color;v=q.blend_color;A=c.blend_equation;ea=q.blend_equation;G=c.blend_func;F=q.blend_func;w=c.colorMask;B=q.colorMask;N=c.depth_range;n=q.depth_range;H=c.polygonOffset_offset;ca=q.polygonOffset_offset;I=c.sample_coverage;R=q.sample_coverage;e=c.scissor_box;g=q.scissor_box;d=c.stencil_func;z=q.stencil_func;U=c.stencil_opBack;W=q.stencil_opBack;m=c.stencil_opFront;oa=q.stencil_opFront;L=c.viewport;fa=q.viewport;
return{poll:function(){var a,h,k,y,Z,jb,ec,na,Na,Y,K,M,P,sa,J,Wb,$a,Q,t,ma,da,Fa;q.dirty=!1;h=c.blend_enable;k=c.cull_enable;y=c.depth_enable;Z=c.dither;jb=c.polygonOffset_enable;ec=c.sample_alpha;na=c.sample_enable;Na=c.scissor_enable;Y=c.stencil_enable;K=c.cull_face;M=q.cull_face;P=c.depth_func;sa=q.depth_func;J=c.depth_mask;Wb=q.depth_mask;$a=c.frontFace;Q=q.frontFace;t=c.lineWidth;ma=q.lineWidth;da=c.stencil_mask;Fa=q.stencil_mask;a=O.next;a!==O.cur&&(a?f.bindFramebuffer(36160,a.framebuffer):
f.bindFramebuffer(36160,null),O.cur=a);h!==q.blend_enable&&(h?f.enable(3042):f.disable(3042),q.blend_enable=h);k!==q.cull_enable&&(k?f.enable(2884):f.disable(2884),q.cull_enable=k);y!==q.depth_enable&&(y?f.enable(2929):f.disable(2929),q.depth_enable=y);Z!==q.dither&&(Z?f.enable(3024):f.disable(3024),q.dither=Z);jb!==q.polygonOffset_enable&&(jb?f.enable(32823):f.disable(32823),q.polygonOffset_enable=jb);ec!==q.sample_alpha&&(ec?f.enable(32926):f.disable(32926),q.sample_alpha=ec);na!==q.sample_enable&&
(na?f.enable(32928):f.disable(32928),q.sample_enable=na);Na!==q.scissor_enable&&(Na?f.enable(3089):f.disable(3089),q.scissor_enable=Na);Y!==q.stencil_enable&&(Y?f.enable(2960):f.disable(2960),q.stencil_enable=Y);if(b[0]!==v[0]||b[1]!==v[1]||b[2]!==v[2]||b[3]!==v[3])f.blendColor(b[0],b[1],b[2],b[3]),v[0]=b[0],v[1]=b[1],v[2]=b[2],v[3]=b[3];if(A[0]!==ea[0]||A[1]!==ea[1])f.blendEquationSeparate(A[0],A[1]),ea[0]=A[0],ea[1]=A[1];if(G[0]!==F[0]||G[1]!==F[1]||G[2]!==F[2]||G[3]!==F[3])f.blendFuncSeparate(G[0],
G[1],G[2],G[3]),F[0]=G[0],F[1]=G[1],F[2]=G[2],F[3]=G[3];if(w[0]!==B[0]||w[1]!==B[1]||w[2]!==B[2]||w[3]!==B[3])f.colorMask(w[0],w[1],w[2],w[3]),B[0]=w[0],B[1]=w[1],B[2]=w[2],B[3]=w[3];K!==M&&(f.cullFace(K),q.cull_face=K);P!==sa&&(f.depthFunc(P),q.depth_func=P);J!==Wb&&(f.depthMask(J),q.depth_mask=J);if(N[0]!==n[0]||N[1]!==n[1])f.depthRange(N[0],N[1]),n[0]=N[0],n[1]=N[1];$a!==Q&&(f.frontFace($a),q.frontFace=$a);t!==ma&&(f.lineWidth(t),q.lineWidth=t);if(H[0]!==ca[0]||H[1]!==ca[1])f.polygonOffset(H[0],
H[1]),ca[0]=H[0],ca[1]=H[1];if(I[0]!==R[0]||I[1]!==R[1])f.sampleCoverage(I[0],I[1]),R[0]=I[0],R[1]=I[1];if(e[0]!==g[0]||e[1]!==g[1]||e[2]!==g[2]||e[3]!==g[3])f.scissor(e[0],e[1],e[2],e[3]),g[0]=e[0],g[1]=e[1],g[2]=e[2],g[3]=e[3];if(d[0]!==z[0]||d[1]!==z[1]||d[2]!==z[2])f.stencilFunc(d[0],d[1],d[2]),z[0]=d[0],z[1]=d[1],z[2]=d[2];da!==Fa&&(f.stencilMask(da),q.stencil_mask=da);if(U[0]!==W[0]||U[1]!==W[1]||U[2]!==W[2]||U[3]!==W[3])f.stencilOpSeparate(U[0],U[1],U[2],U[3]),W[0]=U[0],W[1]=U[1],W[2]=U[2],
W[3]=U[3];if(m[0]!==oa[0]||m[1]!==oa[1]||m[2]!==oa[2]||m[3]!==oa[3])f.stencilOpSeparate(m[0],m[1],m[2],m[3]),oa[0]=m[0],oa[1]=m[1],oa[2]=m[2],oa[3]=m[3];if(L[0]!==fa[0]||L[1]!==fa[1]||L[2]!==fa[2]||L[3]!==fa[3])f.viewport(L[0],L[1],L[2],L[3]),fa[0]=L[0],fa[1]=L[1],fa[2]=L[2],fa[3]=L[3]},refresh:function(){var a,h,k,ra,xa,jb,ec,na,Na,Y,K,M,P,sa,J,Wb;q.dirty=!1;h=c.blend_enable;k=c.cull_enable;ra=c.depth_enable;xa=c.dither;jb=c.polygonOffset_enable;ec=c.sample_alpha;na=c.sample_enable;Na=c.scissor_enable;
...
q.blend_enable=h;k?f.enable(2884):f.disable(2884);q.cull_enable=k;ra?f.enable(2929):f.disable(2929);q.depth_enable=ra;xa?f.enable(3024):f.disable(3024);q.dither=xa;jb?f.enable(32823):f.disable(32823);q.polygonOffset_enable=jb;ec?f.enable(32926):f.disable(32926);q.sample_alpha=ec;na?f.enable(32928):f.disable(32928);q.sample_enable=na;Na?f.enable(3089):f.disable(3089);q.scissor_enable=Na;Y?f.enable(2960):f.disable(2960);q.stencil_enable=Y;f.blendColor(b[0],b[1],b[2],b[3]);v[0]=b[0];v[1]=b[1];v[2]=b[2];
v[3]=b[3];f.blendEquationSeparate(A[0],A[1]);ea[0]=A[0];ea[1]=A[1];f.blendFuncSeparate(G[0],G[1],G[2],G[3]);F[0]=G[0];F[1]=G[1];F[2]=G[2];F[3]=G[3];f.colorMask(w[0],w[1],w[2],w[3]);B[0]=w[0];B[1]=w[1];B[2]=w[2];B[3]=w[3];f.cullFace(K);q.cull_face=K;f.depthFunc(M);q.depth_func=M;f.depthMask(P);q.depth_mask=P;f.depthRange(N[0],N[1]);n[0]=N[0];n[1]=N[1];f.frontFace(sa);q.frontFace=sa;f.lineWidth(J);q.lineWidth=J;f.polygonOffset(H[0],H[1]);ca[0]=H[0];ca[1]=H[1];f.sampleCoverage(I[0],I[1]);R[0]=I[0];R[1]=
I[1];f.scissor(e[0],e[1],e[2],e[3]);g[0]=e[0];g[1]=e[1];g[2]=e[2];g[3]=e[3];f.stencilFunc(d[0],d[1],d[2]);z[0]=d[0];z[1]=d[1];z[2]=d[2];f.stencilMask(Wb);q.stencil_mask=Wb;f.stencilOpSeparate(U[0],U[1],U[2],U[3]);W[0]=U[0];W[1]=U[1];W[2]=U[2];W[3]=U[3];f.stencilOpSeparate(m[0],m[1],m[2],m[3]);oa[0]=m[0];oa[1]=m[1];oa[2]=m[2];oa[3]=m[3];f.viewport(L[0],L[1],L[2],L[3]);fa[0]=L[0];fa[1]=L[1];fa[2]=L[2];fa[3]=L[3]}}},$3:function(k,Z,q,O){var f,c,y,b,v,A,ea,G,F,w,B,N,n,H,ca,I,R,e,g,d,z,U,W,m,oa,L,fa,a,
h,X,ra,xa,jb;f=k.context;c=k.current;y=k.framebuffer;b=k.gl;v=k.next;A=k.shader;ea=k.vao;G=v.blend_color;F=c.blend_color;w=v.blend_equation;B=c.blend_equation;N=v.blend_func;n=c.blend_func;H=v.colorMask;ca=c.colorMask;I=v.depth_range;R=c.depth_range;e=v.polygonOffset_offset;g=c.polygonOffset_offset;d=v.sample_coverage;z=c.sample_coverage;U=v.scissor_box;W=c.scissor_box;m=v.stencil_func;oa=c.stencil_func;L=v.stencil_opBack;fa=c.stencil_opBack;a=v.stencil_opFront;h=c.stencil_opFront;X=v.viewport;ra=
c.viewport;xa={};jb={};return{batch:function(f,k){var q,Y,K,M,P;q=y.next;q!==y.cur&&(q?b.bindFramebuffer(36160,q.framebuffer):b.bindFramebuffer(36160,null),y.cur=q);if(c.dirty){q=v.dither;q!==c.dither&&(q?b.enable(3024):b.disable(3024),c.dither=q);q=v.blend_enable;q!==c.blend_enable&&(q?b.enable(3042):b.disable(3042),c.blend_enable=q);q=G[0];K=G[1];M=G[2];P=G[3];if(q!==F[0]||K!==F[1]||M!==F[2]||P!==F[3])b.blendColor(q,K,M,P),F[0]=q,F[1]=K,F[2]=M,F[3]=P;q=w[0];K=w[1];if(q!==B[0]||K!==B[1])b.blendEquationSeparate(q,
K),B[0]=q,B[1]=K;q=N[0];K=N[1];M=N[2];P=N[3];if(q!==n[0]||K!==n[1]||M!==n[2]||P!==n[3])b.blendFuncSeparate(q,K,M,P),n[0]=q,n[1]=K,n[2]=M,n[3]=P;q=v.depth_enable;q!==c.depth_enable&&(q?b.enable(2929):b.disable(2929),c.depth_enable=q);q=v.depth_func;q!==c.depth_func&&(b.depthFunc(q),c.depth_func=q);q=I[0];K=I[1];if(q!==R[0]||K!==R[1])b.depthRange(q,K),R[0]=q,R[1]=K;q=v.depth_mask;q!==c.depth_mask&&(b.depthMask(q),c.depth_mask=q);q=H[0];K=H[1];M=H[2];P=H[3];if(q!==ca[0]||K!==ca[1]||M!==ca[2]||P!==ca[3])b.colorMask(q,
K,M,P),ca[0]=q,ca[1]=K,ca[2]=M,ca[3]=P;q=v.cull_enable;q!==c.cull_enable&&(q?b.enable(2884):b.disable(2884),c.cull_enable=q);q=v.cull_face;q!==c.cull_face&&(b.cullFace(q),c.cull_face=q);q=v.frontFace;q!==c.frontFace&&(b.frontFace(q),c.frontFace=q);q=v.lineWidth;q!==c.lineWidth&&(b.lineWidth(q),c.lineWidth=q);q=v.polygonOffset_enable;q!==c.polygonOffset_enable&&(q?b.enable(32823):b.disable(32823),c.polygonOffset_enable=q);q=e[0];K=e[1];if(q!==g[0]||K!==g[1])b.polygonOffset(q,K),g[0]=q,g[1]=K;q=v.sample_alpha;
q!==c.sample_alpha&&(q?b.enable(32926):b.disable(32926),c.sample_alpha=q);q=v.sample_enable;q!==c.sample_enable&&(q?b.enable(32928):b.disable(32928),c.sample_enable=q);q=d[0];K=d[1];if(q!==z[0]||K!==z[1])b.sampleCoverage(q,K),z[0]=q,z[1]=K;q=v.stencil_enable;q!==c.stencil_enable&&(q?b.enable(2960):b.disable(2960),c.stencil_enable=q);q=v.stencil_mask;q!==c.stencil_mask&&(b.stencilMask(q),c.stencil_mask=q);q=m[0];K=m[1];M=m[2];if(q!==oa[0]||K!==oa[1]||M!==oa[2])b.stencilFunc(q,K,M),oa[0]=q,oa[1]=K,
oa[2]=M;q=a[0];K=a[1];M=a[2];P=a[3];if(q!==h[0]||K!==h[1]||M!==h[2]||P!==h[3])b.stencilOpSeparate(q,K,M,P),h[0]=q,h[1]=K,h[2]=M,h[3]=P;q=L[0];K=L[1];M=L[2];P=L[3];if(q!==fa[0]||K!==fa[1]||M!==fa[2]||P!==fa[3])b.stencilOpSeparate(q,K,M,P),fa[0]=q,fa[1]=K,fa[2]=M,fa[3]=P;q=v.scissor_enable;q!==c.scissor_enable&&(q?b.enable(3089):b.disable(3089),c.scissor_enable=q);q=U[0];K=U[1];M=U[2];P=U[3];if(q!==W[0]||K!==W[1]||M!==W[2]||P!==W[3])b.scissor(q,K,M,P),W[0]=q,W[1]=K,W[2]=M,W[3]=P;q=X[0];K=X[1];M=X[2];
P=X[3];if(q!==ra[0]||K!==ra[1]||M!==ra[2]||P!==ra[3])b.viewport(q,K,M,P),ra[0]=q,ra[1]=K,ra[2]=M,ra[3]=P;c.dirty=!1}if(q=c.profile)Y=performance.now(),Z.count+=k;K=A.program(A.vert,A.frag);b.useProgram(K.program);ea.setVAO(null);M=K.id;(P=jb[M])||(P=jb[M]=O(K));P.call(this,f,k);ea.setVAO(null);q&&(Z.cpuTime+=performance.now()-Y)},draw:function(f){var k,O,Y,K,M;k=y.next;k!==y.cur&&(k?b.bindFramebuffer(36160,k.framebuffer):b.bindFramebuffer(36160,null),y.cur=k);if(c.dirty){k=v.dither;k!==c.dither&&
...
k);k=d[0];Y=d[1];if(k!==z[0]||Y!==z[1])b.sampleCoverage(k,Y),z[0]=k,z[1]=Y;k=v.stencil_enable;k!==c.stencil_enable&&(k?b.enable(2960):b.disable(2960),c.stencil_enable=k);k=v.stencil_mask;k!==c.stencil_mask&&(b.stencilMask(k),c.stencil_mask=k);k=m[0];Y=m[1];K=m[2];if(k!==oa[0]||Y!==oa[1]||K!==oa[2])b.stencilFunc(k,Y,K),oa[0]=k,oa[1]=Y,oa[2]=K;k=a[0];Y=a[1];K=a[2];M=a[3];if(k!==h[0]||Y!==h[1]||K!==h[2]||M!==h[3])b.stencilOpSeparate(k,Y,K,M),h[0]=k,h[1]=Y,h[2]=K,h[3]=M;k=L[0];Y=L[1];K=L[2];M=L[3];if(k!==
...
A.frag);b.useProgram(Y.program);ea.setVAO(null);K=Y.id;(M=xa[K])||(M=xa[K]=q(Y));M.call(this,f);ea.setVAO(null);k&&(Z.cpuTime+=performance.now()-O)},scope:function(a,b,d){var h,e;if(h=c.profile)e=performance.now(),Z.count++;b(f,a,d);h&&(Z.cpuTime+=performance.now()-e)}}},"$38,colors,contextColor,dim0A,dim0B,dim0C,dim0D,dim1A,dim1B,dim1C,dim1D,drwLayer,hiA,hiB,hiC,hiD,loA,loB,loC,loD,maskHeight,maskTexture,p01_04,p05_08,p09_12,p13_16,p17_20,p21_24,p25_28,p29_32,p33_36,p37_40,p41_44,p45_48,p49_52,p53_56,p57_60,palette,resolution,viewBoxPos,viewBoxSize":function(k,
Z,q,O,f,c,y,b,v,A,ea,G,F,w,B,N,n,H,ca,I,R,e,g,d,z,U,W,m,oa,L,fa,a,h,X,ra,xa,jb,ec,na,Na,Y,K,M,P,sa,J,Wb,$a,Q,t,ma,da,Fa,Oa,$b,Ia,S,ob,ga,ta,cc,nc,kc,ud,yc,V,C,la,Da,ub,Qc,Uc,D,u,ka,ua,T,ha,qa){var E,p,ba,x,ja,ia,l,tc,aa,r,Db,Ab,Ve,de,we,ee,Kd,se,od,he,ue,Gd,Bd,Zd,Wd,Ze,yf,bf,wd,Fe,Sd,Td,ne,Xd,rd,id,vd,pd,dd,oc,sd,fd,Lc,qc,ab,Ic,Fb,pc,Ta,Jc,ac,rc,Cd,xd,Bc,Xb,Gc,Rc,La,vb,Wa,Aa,ld,gb,Sa,Hb,cb,fc,Rb;E=k.attributes;p=k.context;ba=k.current;x=k.draw;ja=k.elements;ia=k.framebuffer;l=k.gl;tc=k.next;aa=k.shader;
r=k.uniforms;Db=k.vao;Ab=tc.blend_color;Ve=ba.blend_color;de=tc.blend_equation;we=ba.blend_equation;ee=tc.blend_func;Kd=ba.blend_func;se=tc.colorMask;od=ba.colorMask;he=tc.depth_range;ue=ba.depth_range;Gd=tc.polygonOffset_offset;Bd=ba.polygonOffset_offset;Zd=tc.sample_coverage;Wd=ba.sample_coverage;Ze=tc.scissor_box;yf=ba.scissor_box;bf=tc.stencil_func;wd=ba.stencil_func;Fe=tc.stencil_opBack;Sd=ba.stencil_opBack;Td=tc.stencil_opFront;ne=ba.stencil_opFront;Xd=tc.viewport;rd=ba.viewport;id={};vd={};
...
l.bindBuffer(34963,sd.buffer.buffer);for(g=0;g<d;++g){k=a[g];var ee,he,Xd,Cd,de,Vb,bc,Pb,Ha,Yb,nb,zb,Nb,Qb,hc,jc,xa,Cc,Dc,Ec,Nc,$c,Sc,Oc,Lb,Gb,Pc,Hc,Tc,ic,Wc,jb,kd,qd,Xc,be,Ld,le,xe,Ud,Hd,Ed,ed,Fc,nd,gd,bd,hd,zd,Ad,te,ve,Ce,ge,fe,ce,pe,$d;id.height=k.viewportHeight;id.width=k.viewportWidth;id.x=k.viewportX;id.y=k.viewportY;ee=id.x|0;he=id.y|0;Xd="width"in id?id.width|0:p.framebufferWidth-ee;Cd="height"in id?id.height|0:p.framebufferHeight-he;de=p.viewportWidth;p.viewportWidth=Xd;Vb=p.viewportHeight;
p.viewportHeight=Cd;l.viewport(ee,he,Xd,Cd);rd[0]=ee;rd[1]=he;rd[2]=Xd;rd[3]=Cd;vd.height=k.scissorHeight;vd.width=k.scissorWidth;vd.x=k.scissorX;vd.y=k.scissorY;bc=vd.x|0;Pb=vd.y|0;Ha="width"in vd?vd.width|0:p.framebufferWidth-bc;Yb="height"in vd?vd.height|0:p.framebufferHeight-Pb;l.scissor(bc,Pb,Ha,Yb);yf[0]=bc;yf[1]=Pb;yf[2]=Ha;yf[3]=Yb;nb=k.dim0A;l.uniformMatrix4fv(K.location,!1,Array.isArray(nb)||nb instanceof Float32Array?nb:(xd[0]=nb[0],xd[1]=nb[1],xd[2]=nb[2],xd[3]=nb[3],xd[4]=nb[4],xd[5]=
...
Ed));Fc=k.drwLayer;g&&nd===Fc||(nd=Fc,l.uniform1f(t.location,Fc));gd=k.contextColor;bd=gd[0];zd=gd[1];te=gd[2];Ce=gd[3];g&&hd===bd&&Ad===zd&&ve===te&&ge===Ce||(hd=bd,Ad=zd,ve=te,ge=Ce,l.uniform4f(Y.location,bd,zd,te,Ce));(fe=k.maskTexture)&&"framebuffer"===fe._reglType&&(fe=fe.color[0]);ce=fe._texture;l.uniform1i(ta.location,ce.bind());pe=k.offset;if($d=k.count)sd?l.drawElements(1,$d,sd.type,pe<<(sd.type-5121>>1)):l.drawArrays(1,pe,$d),p.viewportWidth=de,p.viewportHeight=Vb,ce.unbind()}na.unbind();
ba.dirty=!0;Db.setVAO(null);ba.profile=e},draw:function(a){var d,h,e,g,k,m;d=ia.next;d!==ia.cur&&(d?l.bindFramebuffer(36160,d.framebuffer):l.bindFramebuffer(36160,null),ia.cur=d);if(ba.dirty){d=se[0];m=se[1];h=se[2];e=se[3];if(d!==od[0]||m!==od[1]||h!==od[2]||e!==od[3])l.colorMask(d,m,h,e),od[0]=d,od[1]=m,od[2]=h,od[3]=e;d=tc.frontFace;d!==ba.frontFace&&(l.frontFace(d),ba.frontFace=d);d=tc.polygonOffset_enable;d!==ba.polygonOffset_enable&&(d?l.enable(32823):l.disable(32823),ba.polygonOffset_enable=
d);d=Gd[0];m=Gd[1];if(d!==Bd[0]||m!==Bd[1])l.polygonOffset(d,m),Bd[0]=d,Bd[1]=m;d=tc.sample_alpha;d!==ba.sample_alpha&&(d?l.enable(32926):l.disable(32926),ba.sample_alpha=d);d=tc.sample_enable;d!==ba.sample_enable&&(d?l.enable(32928):l.disable(32928),ba.sample_enable=d);d=Zd[0];m=Zd[1];if(d!==Wd[0]||m!==Wd[1])l.sampleCoverage(d,m),Wd[0]=d,Wd[1]=m;d=tc.stencil_enable;d!==ba.stencil_enable&&(d?l.enable(2960):l.disable(2960),ba.stencil_enable=d);d=tc.stencil_mask;d!==ba.stencil_mask&&(l.stencilMask(d),
ba.stencil_mask=d);d=bf[0];m=bf[1];h=bf[2];if(d!==wd[0]||m!==wd[1]||h!==wd[2])l.stencilFunc(d,m,h),wd[0]=d,wd[1]=m,wd[2]=h;d=Td[0];m=Td[1];h=Td[2];e=Td[3];if(d!==ne[0]||m!==ne[1]||h!==ne[2]||e!==ne[3])l.stencilOpSeparate(d,m,h,e),ne[0]=d,ne[1]=m,ne[2]=h,ne[3]=e;d=Fe[0];m=Fe[1];h=Fe[2];e=Fe[3];if(d!==Sd[0]||m!==Sd[1]||h!==Sd[2]||e!==Sd[3])l.stencilOpSeparate(d,m,h,e),Sd[0]=d,Sd[1]=m,Sd[2]=h,Sd[3]=e}id.height=a.viewportHeight;id.width=a.viewportWidth;id.x=a.viewportX;id.y=a.viewportY;h=id.x|0;e=id.y|
0;g="width"in id?id.width|0:p.framebufferWidth-h;k="height"in id?id.height|0:p.framebufferHeight-e;d=p.viewportWidth;p.viewportWidth=g;m=p.viewportHeight;p.viewportHeight=k;l.viewport(h,e,g,k);rd[0]=h;rd[1]=e;rd[2]=g;rd[3]=k;l.blendColor(0,0,0,0);Ve[0]=0;Ve[1]=0;Ve[2]=0;Ve[3]=0;l.disable(3042);ba.blend_enable=!1;l.blendEquationSeparate(32774,32774);we[0]=32774;we[1]=32774;l.blendFuncSeparate(770,771,1,1);Kd[0]=770;Kd[1]=771;Kd[2]=1;Kd[3]=1;l.enable(2884);ba.cull_enable=!0;l.cullFace(1029);ba.cull_face=
1029;l.enable(2929);ba.depth_enable=!0;l.depthFunc(513);ba.depth_func=513;l.depthMask(!0);ba.depth_mask=!0;l.depthRange(0,1);ue[0]=0;ue[1]=1;l.disable(3024);ba.dither=!1;l.lineWidth(2);ba.lineWidth=2;vd.height=a.scissorHeight;vd.width=a.scissorWidth;vd.x=a.scissorX;vd.y=a.scissorY;h=vd.x|0;e=vd.y|0;g="width"in vd?vd.width|0:p.framebufferWidth-h;k="height"in vd?vd.height|0:p.framebufferHeight-e;l.scissor(h,e,g,k);yf[0]=h;yf[1]=e;yf[2]=g;yf[3]=k;l.enable(3089);ba.scissor_enable=!0;h=ba.profile;ba.profile=
!1;l.useProgram(q.program);Db.setVAO(null);e=cc.location;g=E[e];g.buffer||l.enableVertexAttribArray(e);if(g.type!==O.dtype||4!==g.size||g.buffer!==O||!1!==g.normalized||0!==g.offset||0!==g.stride)l.bindBuffer(34962,O.buffer),l.vertexAttribPointer(e,4,O.dtype,!1,0,0),g.type=O.dtype,g.size=4,g.buffer=O,g.normalized=!1,g.offset=0,g.stride=0;e=nc.location;g=E[e];g.buffer||l.enableVertexAttribArray(e);if(g.type!==f.dtype||4!==g.size||g.buffer!==f||!1!==g.normalized||0!==g.offset||0!==g.stride)l.bindBuffer(34962,
...
uf,vf,tf,wf,xf,If,Jf,Kf,Lf,rf,Qf,Gf,sf,cg,Rf,Sf,pg,df,$e,Mf,Nf,dg,eg,fg,gg,hg,Vf,Tf,Wf,Xf,Yf,ig,qg,rg,sg,tg,ug,vg,wg,xg,yg,zg,Ag,ef,af,Of,Pf,jg,kg,lg,mg,ng,Zf,Uf,$f,ag,bg,og,Bg,Cg,Dg,Eg,Fg,Gg,Hg,Ig,Jg,Kg,Lg,Mg,Ng,Og,Pg,Qg,Rg,Sg,Tg,Ug,Vg,Wg,Xg,Yg,Zg,$g,ah,bh,ch,dh,eh,fh,gh,hh,ih,jh,kh,lh,mh,nh,oh,ph,qh,rh,sh,th,uh;id.height=l.viewportHeight;id.width=l.viewportWidth;id.x=l.viewportX;id.y=l.viewportY;t=id.x|0;u=id.y|0;C="width"in id?id.width|0:p.framebufferWidth-t;E="height"in id?id.height|0:p.framebufferHeight-
u;D=p.viewportWidth;p.viewportWidth=C;V=p.viewportHeight;p.viewportHeight=E;Z=Xd[0];Xd[0]=t;M=Xd[1];Xd[1]=u;K=Xd[2];Xd[2]=C;J=Xd[3];Xd[3]=E;ja=Ab[0];Ab[0]=0;ia=Ab[1];Ab[1]=0;P=Ab[2];Ab[2]=0;Q=Ab[3];Ab[3]=0;S=tc.blend_enable;tc.blend_enable=!1;T=de[0];de[0]=32774;ha=de[1];de[1]=32774;la=ee[0];ee[0]=770;I=ee[1];ee[1]=771;Y=ee[2];ee[2]=1;ka=ee[3];ee[3]=1;da=tc.cull_enable;tc.cull_enable=!0;ga=tc.cull_face;tc.cull_face=1029;ma=tc.depth_enable;tc.depth_enable=!0;ua=tc.depth_func;tc.depth_func=513;Aa=tc.depth_mask;
tc.depth_mask=!0;nc=he[0];he[0]=0;ab=he[1];he[1]=1;qa=tc.dither;tc.dither=!1;Ta=tc.lineWidth;tc.lineWidth=2;vd.height=l.scissorHeight;vd.width=l.scissorWidth;vd.x=l.scissorX;vd.y=l.scissorY;Da=vd.x|0;ya=vd.y|0;La="width"in vd?vd.width|0:p.framebufferWidth-Da;Wd="height"in vd?vd.height|0:p.framebufferHeight-ya;Db=Ze[0];Ze[0]=Da;Fb=Ze[1];Ze[1]=ya;Wa=Ze[2];Ze[2]=La;za=Ze[3];Ze[3]=Wd;Td=tc.scissor_enable;tc.scissor_enable=!0;Ea=ba.profile;ba.profile=!1;ac=l.offset;Gc=x.offset;x.offset=ac;Lc=l.count;fd=
x.count;x.count=Lc;Xb=x.primitive;x.primitive=1;Sa=l.contextColor;sa=r[24];r[24]=Sa;vb=l.dim0A;qc=r[3];r[3]=vb;rc=l.dim0B;Ga=r[5];r[5]=rc;Rc=l.dim0C;Qa=r[7];r[7]=Rc;Ca=l.dim0D;ud=r[9];r[9]=Ca;od=l.dim1A;ta=r[4];r[4]=od;dd=l.dim1B;gb=r[6];r[6]=dd;cb=l.dim1C;na=r[8];r[8]=cb;oc=l.dim1D;pc=r[10];r[10]=oc;wd=l.drwLayer;Sd=r[23];r[23]=wd;Jc=l.hiA;Ic=r[12];r[12]=Jc;Bc=l.hiB;Hb=r[14];r[14]=Bc;Ha=l.hiC;ub=r[16];r[16]=Ha;nb=l.hiD;zb=r[18];r[18]=nb;rd=l.loA;sd=r[11];r[11]=rd;ne=l.loB;Qc=r[13];r[13]=ne;Rb=l.loC;
pd=r[15];r[15]=Rb;yc=l.loD;ld=r[17];r[17]=yc;fc=l.maskHeight;Fa=r[22];r[22]=fc;xd=l.maskTexture;Ve=r[25];r[25]=xd;Lb=r[26];r[26]=R;Gb=l.resolution;we=r[19];r[19]=Gb;Kd=l.viewBoxPos;Gd=r[20];r[20]=Kd;yf=l.viewBoxSize;Fe=r[21];r[21]=yf;Cd=e.buffer;e.buffer=ca;cc=e.divisor;e.divisor=0;bf=e.normalized;e.normalized=!1;$a=e.offset;e.offset=0;Na=e.size;e.size=0;kc=e.state;e.state=1;Zd=e.stride;e.stride=0;se=e.type;e.type=ca.dtype;Oa=e.w;e.w=0;ob=e.x;e.x=0;Bd=e.y;e.y=0;ue=e.z;e.z=0;Fc=g.buffer;g.buffer=O;
...
W.normalized=!1;Ue=W.offset;W.offset=0;Re=W.size;W.size=0;Se=W.state;W.state=1;Qd=W.stride;W.stride=0;Vd=W.type;W.type=b.dtype;Te=W.w;W.w=0;qf=W.x;W.x=0;nf=W.y;W.y=0;cf=W.z;W.z=0;gf=m.buffer;m.buffer=v;hf=m.divisor;m.divisor=0;jf=m.normalized;m.normalized=!1;of=m.offset;m.offset=0;kf=m.size;m.size=0;pf=m.state;m.state=1;Af=m.stride;m.stride=0;Bf=m.type;m.type=v.dtype;Ne=m.w;m.w=0;Be=m.x;m.x=0;lf=m.y;m.y=0;mf=m.z;m.z=0;Cf=oa.buffer;oa.buffer=A;Ff=oa.divisor;oa.divisor=0;zf=oa.normalized;oa.normalized=
...
Qe;W.divisor=Me;W.normalized=We;W.offset=Ue;W.size=Re;W.state=Se;W.stride=Qd;W.type=Vd;W.w=Te;W.x=qf;W.y=nf;W.z=cf;m.buffer=gf;m.divisor=hf;m.normalized=jf;m.offset=of;m.size=kf;m.state=pf;m.stride=Af;m.type=Bf;m.w=Ne;m.x=Be;m.y=lf;m.z=mf;oa.buffer=Cf;oa.divisor=Ff;oa.normalized=zf;oa.offset=Df;oa.size=Ef;oa.state=uf;oa.stride=vf;oa.type=tf;oa.w=wf;oa.x=xf;oa.y=If;oa.z=Jf;L.buffer=Kf;L.divisor=Lf;L.normalized=rf;L.offset=Qf;L.size=Gf;L.state=sf;L.stride=cg;L.type=Rf;L.w=Sf;L.x=pg;L.y=df;L.z=$e;fa.buffer=
...
Kg;ra.divisor=Lg;ra.normalized=Mg;ra.offset=Ng;ra.size=Og;ra.state=Pg;ra.stride=Qg;ra.type=Rg;ra.w=Sg;ra.x=Tg;ra.y=Ug;ra.z=Vg;xa.buffer=Wg;xa.divisor=Xg;xa.normalized=Yg;xa.offset=Zg;xa.size=$g;xa.state=ah;xa.stride=bh;xa.type=ch;xa.w=dh;xa.x=eh;xa.y=fh;xa.z=gh;jb.buffer=hh;jb.divisor=ih;jb.normalized=jh;jb.offset=kh;jb.size=lh;jb.state=mh;jb.stride=nh;jb.type=oh;jb.w=ph;jb.x=qh;jb.y=rh;jb.z=sh;aa.vert=th;aa.frag=uh;ba.dirty=!0}}},$1:function(k,Z){var q,O,f,c,y,b,v,A,ea,G,F,w,B,N,n,H,ca,I,R,e,g,d,
z,U,W,m,oa,L,fa,a;q=k.attributes;O=k.current;f=k.framebuffer;c=k.gl;y=k.next;b=k.vao;v=y.blend_color;A=O.blend_color;ea=y.blend_equation;G=O.blend_equation;F=y.blend_func;w=O.blend_func;B=y.colorMask;N=O.colorMask;n=y.depth_range;H=O.depth_range;ca=y.polygonOffset_offset;I=O.polygonOffset_offset;R=y.sample_coverage;e=O.sample_coverage;g=y.scissor_box;d=O.scissor_box;z=y.stencil_func;U=O.stencil_func;W=y.stencil_opBack;m=O.stencil_opBack;oa=y.stencil_opFront;L=O.stencil_opFront;fa=y.viewport;a=O.viewport;
return{poll:function(){var b,k,q,Z,jb,ec,na,Na,Y,K,M,P,sa,J,Wb,$a,Q,t,ma,da,Fa,Oa;O.dirty=!1;k=y.blend_enable;q=y.cull_enable;Z=y.depth_enable;jb=y.dither;ec=y.polygonOffset_enable;na=y.sample_alpha;Na=y.sample_enable;Y=y.scissor_enable;K=y.stencil_enable;M=y.cull_face;P=O.cull_face;sa=y.depth_func;J=O.depth_func;Wb=y.depth_mask;$a=O.depth_mask;Q=y.frontFace;t=O.frontFace;ma=y.lineWidth;da=O.lineWidth;Fa=y.stencil_mask;Oa=O.stencil_mask;b=f.next;b!==f.cur&&(b?c.bindFramebuffer(36160,b.framebuffer):
c.bindFramebuffer(36160,null),f.cur=b);k!==O.blend_enable&&(k?c.enable(3042):c.disable(3042),O.blend_enable=k);q!==O.cull_enable&&(q?c.enable(2884):c.disable(2884),O.cull_enable=q);Z!==O.depth_enable&&(Z?c.enable(2929):c.disable(2929),O.depth_enable=Z);jb!==O.dither&&(jb?c.enable(3024):c.disable(3024),O.dither=jb);ec!==O.polygonOffset_enable&&(ec?c.enable(32823):c.disable(32823),O.polygonOffset_enable=ec);na!==O.sample_alpha&&(na?c.enable(32926):c.disable(32926),O.sample_alpha=na);Na!==O.sample_enable&&
...
Ta=x[3];if(Ic!==ja[0]||Fb!==ja[1]||pc!==ja[2]||Ta!==ja[3])S.stencilOpSeparate(Ic,Fb,pc,Ta),ja[0]=Ic,ja[1]=Fb,ja[2]=pc,ja[3]=Ta;Jc=p[0];ac=p[1];rc=p[2];yc=p[3];if(Jc!==ba[0]||ac!==ba[1]||rc!==ba[2]||yc!==ba[3])S.stencilOpSeparate(Jc,ac,rc,yc),ba[0]=Jc,ba[1]=ac,ba[2]=rc,ba[3]=yc}S.blendColor(0,0,0,0);ud[0]=0;ud[1]=0;ud[2]=0;ud[3]=0;S.enable(3042);da.blend_enable=!0;S.blendEquationSeparate(32774,32774);V[0]=32774;V[1]=32774;S.blendFuncSeparate(770,771,773,1);la[0]=770;la[1]=771;la[2]=773;la[3]=1;S.disable(2929);
da.depth_enable=!1;S.enable(3089);da.scissor_enable=!0;if(e=da.profile)g=performance.now(),Z.count+=d;S.useProgram(m.program);f=$b.angle_instanced_arrays;var pa,Bc,Xb,Gc,Rc,La,vb,Wa;nc.setVAO(null);pa=jb.location;Bc=Q[pa];Bc.buffer||S.enableVertexAttribArray(pa);if(5126!==Bc.type||2!==Bc.size||Bc.buffer!==G||!1!==Bc.normalized||0!==Bc.offset||24!==Bc.stride)S.bindBuffer(34962,G.buffer),S.vertexAttribPointer(pa,2,5126,!1,24,0),Bc.type=5126,Bc.size=2,Bc.buffer=G,Bc.normalized=!1,Bc.offset=0,Bc.stride=
...
Ba)}else if(Ka.buffer&&(S.disableVertexAttribArray(ze),Ka.buffer=null),Ka.x!==Za||Ka.y!==Ub||Ka.z!==ya||Ka.w!==Kb)S.vertexAttrib4f(ze,Za,Ub,ya,Kb),Ka.x=Za,Ka.y=Ub,Ka.z=ya,Ka.w=Kb;fb=fa.call(this,ma,n,k);r.offset=fb;ib=!1;za=null;gc=0;Ea=!1;sb=rb=0;Xa=1;Ya=0;mc=5126;Mb=Va=vc=xc=0;ob(r)?(ib=!0,za=t.createStream(34962,r),mc=za.dtype):(za=t.getBuffer(r))?mc=za.dtype:"constant"in r?(Xa=2,"number"===typeof r.constant?(vc=r.constant,Va=Mb=xc=0):(vc=0<r.constant.length?r.constant[0]:0,Va=1<r.constant.length?
r.constant[1]:0,Mb=2<r.constant.length?r.constant[2]:0,xc=3<r.constant.length?r.constant[3]:0)):(za=ob(r.buffer)?t.createStream(34962,r.buffer):t.getBuffer(r.buffer),mc="type"in r?tc[r.type]:za.dtype,Ea=!!r.normalized,sb=r.size|0,rb=r.offset|0,Ya=r.stride|0,gc=r.divisor|0);Zc=ec.location;Ga=Q[Zc];if(1===Xa){Ga.buffer||S.enableVertexAttribArray(Zc);zc=sb||4;if(Ga.type!==mc||Ga.size!==zc||Ga.buffer!==za||Ga.normalized!==Ea||Ga.offset!==rb||Ga.stride!==Ya)S.bindBuffer(34962,za.buffer),S.vertexAttribPointer(Zc,
...
(S.stencilMask(Dd),da.stencil_mask=Dd);sc=qa[0];Jd=qa[1];Mc=qa[2];if(sc!==E[0]||Jd!==E[1]||Mc!==E[2])S.stencilFunc(sc,Jd,Mc),E[0]=sc,E[1]=Jd,E[2]=Mc;jd=x[0];cd=x[1];Vb=x[2];bc=x[3];if(jd!==ja[0]||cd!==ja[1]||Vb!==ja[2]||bc!==ja[3])S.stencilOpSeparate(jd,cd,Vb,bc),ja[0]=jd,ja[1]=cd,ja[2]=Vb,ja[3]=bc;Pb=p[0];Ha=p[1];Yb=p[2];nb=p[3];if(Pb!==ba[0]||Ha!==ba[1]||Yb!==ba[2]||nb!==ba[3])S.stencilOpSeparate(Pb,Ha,Yb,nb),ba[0]=Pb,ba[1]=Ha,ba[2]=Yb,ba[3]=nb}c=a.viewport;e=c.x|0;g=c.y|0;h="width"in c?c.width|
0:ma.framebufferWidth-e;f="height"in c?c.height|0:ma.framebufferHeight-g;k=ma.viewportWidth;ma.viewportWidth=h;m=ma.viewportHeight;ma.viewportHeight=f;S.viewport(e,g,h,f);l[0]=e;l[1]=g;l[2]=h;l[3]=f;S.blendColor(0,0,0,0);ud[0]=0;ud[1]=0;ud[2]=0;ud[3]=0;S.enable(3042);da.blend_enable=!0;S.blendEquationSeparate(32774,32774);V[0]=32774;V[1]=32774;S.blendFuncSeparate(770,771,773,1);la[0]=770;la[1]=771;la[2]=773;la[3]=1;S.disable(2929);da.depth_enable=!1;n=a.viewport;q=n.x|0;C=n.y|0;z="width"in n?n.width|
0:ma.framebufferWidth-q;O="height"in n?n.height|0:ma.framebufferHeight-C;S.scissor(q,C,z,O);ha[0]=q;ha[1]=C;ha[2]=z;ha[3]=O;S.enable(3089);da.scissor_enable=!0;if(H=da.profile)L=performance.now(),Z.count++;S.useProgram(y.program);ia=$b.angle_instanced_arrays;nc.setVAO(null);N=b.call(this,ma,a,0);Db.offset=N;T=!1;I=null;U=0;W=!1;fa=ca=0;oa=1;R=0;ta=5126;Lc=fd=yc=oc=0;ob(Db)?(T=!0,I=t.createStream(34962,Db),ta=I.dtype):(I=t.getBuffer(Db))?ta=I.dtype:"constant"in Db?(oa=2,"number"===typeof Db.constant?
...
null),Aa.x!==Rc||Aa.y!==La||Aa.z!==vb||Aa.w!==Gc)S.vertexAttrib4f(Wa,Rc,La,vb,Gc),Aa.x=Rc,Aa.y=La,Aa.z=vb,Aa.w=Gc;gb=A.call(this,ma,a,0);r.offset=gb;Sa=!1;Hb=null;cb=0;fc=!1;ke=Rb=0;Zb=1;Sb=0;td=5126;wb=pb=Ma=Tb=0;ob(r)?(Sa=!0,Hb=t.createStream(34962,r),td=Hb.dtype):(Hb=t.getBuffer(r))?td=Hb.dtype:"constant"in r?(Zb=2,"number"===typeof r.constant?(Ma=r.constant,pb=wb=Tb=0):(Ma=0<r.constant.length?r.constant[0]:0,pb=1<r.constant.length?r.constant[1]:0,wb=2<r.constant.length?r.constant[2]:0,Tb=3<r.constant.length?
r.constant[3]:0)):(Hb=ob(r.buffer)?t.createStream(34962,r.buffer):t.getBuffer(r.buffer),td="type"in r?tc[r.type]:Hb.dtype,fc=!!r.normalized,ke=r.size|0,Rb=r.offset|0,Sb=r.stride|0,cb=r.divisor|0);hb=ec.location;Pa=Q[hb];if(1===Zb){Pa.buffer||S.enableVertexAttribArray(hb);uc=ke||4;if(Pa.type!==td||Pa.size!==uc||Pa.buffer!==Hb||Pa.normalized!==fc||Pa.offset!==Rb||Pa.stride!==Sb)S.bindBuffer(34962,Hb.buffer),S.vertexAttribPointer(hb,uc,td,fc,Sb,Rb),Pa.type=td,Pa.size=uc,Pa.buffer=Hb,Pa.normalized=fc,
...
S.bindBuffer(34963,ib.buffer.buffer);za=Fa.offset;gc=a.count;0<gc?ib?ia.drawElementsInstancedANGLE(4,36,ib.type,za<<(ib.type-5121>>1),gc):ia.drawArraysInstancedANGLE(4,za,36,gc):0>gc&&(ib?S.drawElements(4,36,ib.type,za<<(ib.type-5121>>1)):S.drawArrays(4,za,36));da.dirty=!0;nc.setVAO(null);ma.viewportWidth=k;ma.viewportHeight=m;H&&(Z.cpuTime+=performance.now()-L);T&&t.destroyStream(I);pc&&t.destroyStream(Ta);Sa&&t.destroyStream(Hb);ad&&t.destroyStream(db)},scope:function(a,b,c){var h,f,l,k,m,p,q,x,
...
Fd,Md,Nd,Od,je,Ye,ye,oe,Oe,Pe,Le,re,De,Ge,He,Ie,Ee,Id;h=a.viewport;f=h.x|0;l=h.y|0;k="width"in h?h.width|0:ma.framebufferWidth-f;m="height"in h?h.height|0:ma.framebufferHeight-l;p=ma.viewportWidth;ma.viewportWidth=k;q=ma.viewportHeight;ma.viewportHeight=m;x=ia[0];ia[0]=f;u=ia[1];ia[1]=l;v=ia[2];ia[2]=k;y=ia[3];ia[3]=m;E=kc[0];kc[0]=0;D=kc[1];kc[1]=0;ba=kc[2];kc[2]=0;V=kc[3];kc[3]=0;B=ga.blend_enable;ga.blend_enable=!0;O=yc[0];yc[0]=32774;M=yc[1];yc[1]=32774;L=C[0];C[0]=770;K=C[1];C[1]=771;J=C[2];
...
I.state=1;mc=I.stride;I.stride=24;xc=I.type;I.type=5126;vc=I.w;I.w=0;Va=I.x;I.x=0;Mb=I.y;I.y=0;Zc=I.z;I.z=0;Ga=R.call(this,ma,a,c);r.offset=Ga;zc=!1;Qa=null;Ca=0;mb=!1;Eb=xb=0;tb=1;wc=0;yb=5126;Mc=Ia=sc=Wb=0;ob(r)?(zc=!0,Qa=t.createStream(34962,r),yb=Qa.dtype):(Qa=t.getBuffer(r))?yb=Qa.dtype:"constant"in r?(tb=2,"number"===typeof r.constant?(sc=r.constant,Ia=Mc=Wb=0):(sc=0<r.constant.length?r.constant[0]:0,Ia=1<r.constant.length?r.constant[1]:0,Mc=2<r.constant.length?r.constant[2]:0,Wb=3<r.constant.length?
r.constant[3]:0)):(Qa=ob(r.buffer)?t.createStream(34962,r.buffer):t.getBuffer(r.buffer),yb="type"in r?tc[r.type]:Qa.dtype,mb=!!r.normalized,Eb=r.size|0,xb=r.offset|0,wc=r.stride|0,Ca=r.divisor|0);Uc=e.buffer;e.buffer=Qa;cd=e.divisor;e.divisor=Ca;Vb=e.normalized;e.normalized=mb;bc=e.offset;e.offset=xb;Pb=e.size;e.size=Eb;Ha=e.state;e.state=tb;Yb=e.stride;e.stride=wc;nb=e.type;e.type=yb;zb=e.w;e.w=Wb;Nb=e.x;e.x=sc;Qb=e.y;e.y=Ia;hc=e.z;e.z=Mc;jc=g.buffer;g.buffer=F;$b=g.divisor;g.divisor=0;Cc=g.normalized;
...
Z,q,O,f,c,y,b,v,A,ea,G,F,w,B,N,n,H,ca,I,R,e,g,d,z,U,W,m,oa,L,fa,a,h,X,ra,xa,jb){var ec,na,Na,Y,K,M,P,sa,J,Wb,$a,Q,t,ma,da,Fa,Oa,$b,Ia,S,ob,ga,ta,cc,nc,kc,ud,yc,V,C,la,Da,ub,Qc,Uc,D,u,ka,ua,T,ha,qa,E,p;ec=k.attributes;na=k.buffer;Na=k.context;Y=k.current;K=k.draw;M=k.elements;P=k.extensions;sa=k.framebuffer;J=k.gl;Wb=k.isBufferArgs;$a=k.next;Q=k.shader;t=k.uniforms;ma=k.vao;da=$a.blend_color;Fa=Y.blend_color;Oa=$a.blend_equation;$b=Y.blend_equation;Ia=$a.blend_func;S=Y.blend_func;ob=$a.colorMask;ga=
...
0,0,0);Fa[0]=0;Fa[1]=0;Fa[2]=0;Fa[3]=0;J.enable(3042);Y.blend_enable=!0;J.blendEquationSeparate(32774,32774);$b[0]=32774;$b[1]=32774;J.blendFuncSeparate(770,771,773,1);S[0]=770;S[1]=771;S[2]=773;S[3]=1;J.enable(3089);Y.scissor_enable=!0;J.disable(2960);Y.stencil_enable=!1;if(q=Y.profile)l=performance.now(),Z.count+=k;J.useProgram(H.program);t=P.angle_instanced_arrays;var Lc,qc,ab,Ic,Fb;ma.setVAO(null);Lc=oa.location;qc=ec[Lc];qc.buffer||J.enableVertexAttribArray(Lc);if(5126!==qc.type||1!==qc.size||
...
Ic.type=5126,Ic.size=1,Ic.buffer=c,Ic.normalized=!1,Ic.offset=4,Ic.stride=8;0!==Ic.divisor&&(t.vertexAttribDivisorANGLE(ab,0),Ic.divisor=0);(Fb=K.elements)?J.bindBuffer(34963,Fb.buffer.buffer):ma.currentVAO&&(Fb=M.getElements(ma.currentVAO.elements))&&J.bindBuffer(34963,Fb.buffer.buffer);for(u=0;u<k;++u){r=b[u];var pc,Ta,Jc,ac,rc,Cd,xd,Bc,Xb,Gc,Rc,La,vb,Wa,Aa,ld,gb,Sa,Hb,cb,fc,Rb,Ia,Zb,Sb,td,Tb,Ma,pb,wb,hb,Pa,uc,Jb,ad,db,lc,Yc,dc,kb,lb,va,qb,wa,Ua,bb,Ba,eb,Ja,Cb,Bb,Ra,Kc,Kb,Za,Ub,ya,ze,Ka,Ob,fb,ib,
za,gc,Ea,rb,sb,Xa,Ya,mc,xc,vc,Va,Mb,Zc,Ga,zc,Qa,Ca,mb,xb,Eb,tb,wc,yb,Dd,sc,Jd,Mc,jd,cd,Vb,bc,Pb,Ha,Yb,nb,zb,Nb,Qb,hc,jc,Hf,Cc,Dc,Ec,Nc,$c,Sc,Oc,Lb,Gb,Pc,Hc,Tc,ic,Wc,md,kd,qd,Xc,Ib,Ld,le,xe,Ud,Hd,Ed,ed,Fc,nd,gd,bd;pc=r.viewport;Ta=pc.x|0;Jc=pc.y|0;ac="width"in pc?pc.width|0:Na.framebufferWidth-Ta;rc="height"in pc?pc.height|0:Na.framebufferHeight-Jc;Cd=Na.viewportWidth;Na.viewportWidth=ac;xd=Na.viewportHeight;Na.viewportHeight=rc;J.viewport(Ta,Jc,ac,rc);ka[0]=Ta;ka[1]=Jc;ka[2]=ac;ka[3]=rc;(Bc=ca.call(this,
Na,r,u))?J.enable(2929):J.disable(2929);Y.depth_enable=Bc;Xb=r.viewport;Gc=Xb.x|0;Rc=Xb.y|0;La="width"in Xb?Xb.width|0:Na.framebufferWidth-Gc;vb="height"in Xb?Xb.height|0:Na.framebufferHeight-Rc;J.scissor(Gc,Rc,La,vb);C[0]=Gc;C[1]=Rc;C[2]=La;C[3]=vb;T.buffer=r.positionBuffer;Wa=!1;Aa=null;ld=0;gb=!1;Hb=Sa=0;cb=1;fc=0;Rb=5126;td=Sb=Zb=Ia=0;Wb(T)?(Wa=!0,Aa=na.createStream(34962,T),Rb=Aa.dtype):(Aa=na.getBuffer(T))?Rb=Aa.dtype:"constant"in T?(cb=2,"number"===typeof T.constant?(Zb=T.constant,Sb=td=Ia=
...
lb||wa.z!==va||wa.w!==dc)J.vertexAttrib4f(qb,kb,lb,va,dc),wa.x=kb,wa.y=lb,wa.z=va,wa.w=dc;ha.buffer=r.positionFractBuffer;bb=!1;Ba=null;eb=0;Ja=!1;Bb=Cb=0;Ra=1;Kc=0;Kb=5126;ze=ya=Ub=Za=0;Wb(ha)?(bb=!0,Ba=na.createStream(34962,ha),Kb=Ba.dtype):(Ba=na.getBuffer(ha))?Kb=Ba.dtype:"constant"in ha?(Ra=2,"number"===typeof ha.constant?(Ub=ha.constant,ya=ze=Za=0):(Ub=0<ha.constant.length?ha.constant[0]:0,ya=1<ha.constant.length?ha.constant[1]:0,ze=2<ha.constant.length?ha.constant[2]:0,Za=3<ha.constant.length?
...
Ea||Ga.offset!==rb||Ga.stride!==Ya)J.bindBuffer(34962,za.buffer),J.vertexAttribPointer(Zc,zc,mc,Ea,Ya,rb),Ga.type=mc,Ga.size=zc,Ga.buffer=za,Ga.normalized=Ea,Ga.offset=rb,Ga.stride=Ya;Ga.divisor!==gc&&(t.vertexAttribDivisorANGLE(Zc,gc),Ga.divisor=gc)}else if(Ga.buffer&&(J.disableVertexAttribArray(Zc),Ga.buffer=null),Ga.x!==vc||Ga.y!==Va||Ga.z!==Mb||Ga.w!==xc)J.vertexAttrib4f(Zc,vc,Va,Mb,xc),Ga.x=vc,Ga.y=Va,Ga.z=Mb,Ga.w=xc;p.buffer=r.colorBuffer;Qa=!1;Ca=null;mb=0;xb=!1;tb=Eb=0;wc=1;yb=0;Dd=5126;jd=
Mc=Jd=sc=0;Wb(p)?(Qa=!0,Ca=na.createStream(34962,p),Dd=Ca.dtype):(Ca=na.getBuffer(p))?Dd=Ca.dtype:"constant"in p?(wc=2,"number"===typeof p.constant?(Jd=p.constant,Mc=jd=sc=0):(Jd=0<p.constant.length?p.constant[0]:0,Mc=1<p.constant.length?p.constant[1]:0,jd=2<p.constant.length?p.constant[2]:0,sc=3<p.constant.length?p.constant[3]:0)):(Ca=Wb(p.buffer)?na.createStream(34962,p.buffer):na.getBuffer(p.buffer),Dd="type"in p?ua[p.type]:Ca.dtype,xb=!!p.normalized,tb=p.size|0,Eb=p.offset|0,yb=p.stride|0,mb=
p.divisor|0);cd=z.location;Vb=ec[cd];if(1===wc){Vb.buffer||J.enableVertexAttribArray(cd);bc=tb||4;if(Vb.type!==Dd||Vb.size!==bc||Vb.buffer!==Ca||Vb.normalized!==xb||Vb.offset!==Eb||Vb.stride!==yb)J.bindBuffer(34962,Ca.buffer),J.vertexAttribPointer(cd,bc,Dd,xb,yb,Eb),Vb.type=Dd,Vb.size=bc,Vb.buffer=Ca,Vb.normalized=xb,Vb.offset=Eb,Vb.stride=yb;Vb.divisor!==mb&&(t.vertexAttribDivisorANGLE(cd,mb),Vb.divisor=mb)}else if(Vb.buffer&&(J.disableVertexAttribArray(cd),Vb.buffer=null),Vb.x!==Jd||Vb.y!==Mc||
Vb.z!==jd||Vb.w!==sc)J.vertexAttrib4f(cd,Jd,Mc,jd,sc),Vb.x=Jd,Vb.y=Mc,Vb.z=jd,Vb.w=sc;Pb=r.scale;Ha=Pb[0];nb=Pb[1];u&&Yb===Ha&&zb===nb||(Yb=Ha,zb=nb,J.uniform2f(a.location,Ha,nb));Nb=r.scaleFract;Qb=Nb[0];jc=Nb[1];u&&hc===Qb&&Hf===jc||(hc=Qb,Hf=jc,J.uniform2f(h.location,Qb,jc));Cc=r.translate;Dc=Cc[0];Nc=Cc[1];u&&Ec===Dc&&$c===Nc||(Ec=Dc,$c=Nc,J.uniform2f(ra.location,Dc,Nc));Sc=r.translateFract;Oc=Sc[0];Gb=Sc[1];u&&Lb===Oc&&Pc===Gb||(Lb=Oc,Pc=Gb,J.uniform2f(xa.location,Oc,Gb));Hc=r.thickness;u&&Tc===
Hc||(Tc=Hc,J.uniform1f(X.location,Hc));ic=r.depth;u&&Wc===ic||(Wc=ic,J.uniform1f(m.location,ic));md=I.call(this,Na,r,u);kd=md[0];Xc=md[1];Ld=md[2];xe=md[3];u&&qd===kd&&Ib===Xc&&le===Ld&&Ud===xe||(qd=kd,Ib=Xc,le=Ld,Ud=xe,J.uniform4f(jb.location,kd,Xc,Ld,xe));Hd=r.dashLength;u&&Ed===Hd||(Ed=Hd,J.uniform1f(U.location,Hd));ed=r.opacity;u&&Fc===ed||(Fc=ed,J.uniform1f(fa.location,ed));(nd=r.dashTexture)&&"framebuffer"===nd._reglType&&(nd=nd.color[0]);gd=nd._texture;J.uniform1i(W.location,gd.bind());bd=
r.count;0<bd?Fb?t.drawElementsInstancedANGLE(5,4,Fb.type,0<<(Fb.type-5121>>1),bd):t.drawArraysInstancedANGLE(5,0,4,bd):0>bd&&(Fb?J.drawElements(5,4,Fb.type,0<<(Fb.type-5121>>1)):J.drawArrays(5,0,4));Na.viewportWidth=Cd;Na.viewportHeight=xd;Wa&&na.destroyStream(Aa);wb&&na.destroyStream(hb);bb&&na.destroyStream(Ba);ib&&na.destroyStream(za);Qa&&na.destroyStream(Ca);gd.unbind()}Y.dirty=!0;ma.setVAO(null);q&&(Z.cpuTime+=performance.now()-l)},draw:function(b){var k,n,u,l,t,w,r,v,V,B,H,F,A,G,Q,N,I,da,ea,
...
cd,D[1]=Vb,D[2]=bc,D[3]=Pb;Ha=ub[0];Yb=ub[1];nb=ub[2];zb=ub[3];if(Ha!==Qc[0]||Yb!==Qc[1]||nb!==Qc[2]||zb!==Qc[3])J.stencilOpSeparate(Ha,Yb,nb,zb),Qc[0]=Ha,Qc[1]=Yb,Qc[2]=nb,Qc[3]=zb}n=b.viewport;u=n.x|0;l=n.y|0;t="width"in n?n.width|0:Na.framebufferWidth-u;w="height"in n?n.height|0:Na.framebufferHeight-l;r=Na.viewportWidth;Na.viewportWidth=t;v=Na.viewportHeight;Na.viewportHeight=w;J.viewport(u,l,t,w);ka[0]=u;ka[1]=l;ka[2]=t;ka[3]=w;J.blendColor(0,0,0,0);Fa[0]=0;Fa[1]=0;Fa[2]=0;Fa[3]=0;J.enable(3042);
Y.blend_enable=!0;J.blendEquationSeparate(32774,32774);$b[0]=32774;$b[1]=32774;J.blendFuncSeparate(770,771,773,1);S[0]=770;S[1]=771;S[2]=773;S[3]=1;(V=q.call(this,Na,b,0))?J.enable(2929):J.disable(2929);Y.depth_enable=V;B=b.viewport;H=B.x|0;F=B.y|0;A="width"in B?B.width|0:Na.framebufferWidth-H;G="height"in B?B.height|0:Na.framebufferHeight-F;J.scissor(H,F,A,G);C[0]=H;C[1]=F;C[2]=A;C[3]=G;J.enable(3089);Y.scissor_enable=!0;J.disable(2960);Y.stencil_enable=!1;if(Q=Y.profile)N=performance.now(),Z.count++;
...
Zb),db.divisor=Zb)}else if(db.buffer&&(J.disableVertexAttribArray(ad),db.buffer=null),db.x!==Pa||db.y!==uc||db.z!==Jb||db.w!==hb)J.vertexAttrib4f(ad,Pa,uc,Jb,hb),db.x=Pa,db.y=uc,db.z=Jb,db.w=hb;p.buffer=b.colorBuffer;Yc=!1;dc=null;kb=0;lb=!1;qb=va=0;wa=1;Ua=0;bb=5126;Cb=Ja=eb=Ba=0;Wb(p)?(Yc=!0,dc=na.createStream(34962,p),bb=dc.dtype):(dc=na.getBuffer(p))?bb=dc.dtype:"constant"in p?(wa=2,"number"===typeof p.constant?(eb=p.constant,Ja=Cb=Ba=0):(eb=0<p.constant.length?p.constant[0]:0,Ja=1<p.constant.length?
p.constant[1]:0,Cb=2<p.constant.length?p.constant[2]:0,Ba=3<p.constant.length?p.constant[3]:0)):(dc=Wb(p.buffer)?na.createStream(34962,p.buffer):na.getBuffer(p.buffer),bb="type"in p?ua[p.type]:dc.dtype,lb=!!p.normalized,qb=p.size|0,va=p.offset|0,Ua=p.stride|0,kb=p.divisor|0);Bb=z.location;Ra=ec[Bb];if(1===wa){Ra.buffer||J.enableVertexAttribArray(Bb);Kc=qb||4;if(Ra.type!==bb||Ra.size!==Kc||Ra.buffer!==dc||Ra.normalized!==lb||Ra.offset!==va||Ra.stride!==Ua)J.bindBuffer(34962,dc.buffer),J.vertexAttribPointer(Bb,
...
Nc;qd=w.offset;w.offset=$c;Xc=w.size;w.size=Sc;be=w.state;w.state=Oc;Ld=w.stride;w.stride=Lb;le=w.type;w.type=Gb;Ib=w.w;w.w=Pc;Ud=w.x;w.x=Hc;Hd=w.y;w.y=Tc;Ed=w.z;w.z=ic;p.buffer=a.colorBuffer;ed=!1;Fc=null;nd=0;gd=!1;hd=bd=0;zd=1;Ad=0;te=5126;fe=ge=Ce=ve=0;Wb(p)?(ed=!0,Fc=na.createStream(34962,p),te=Fc.dtype):(Fc=na.getBuffer(p))?te=Fc.dtype:"constant"in p?(zd=2,"number"===typeof p.constant?(Ce=p.constant,ge=fe=ve=0):(Ce=0<p.constant.length?p.constant[0]:0,ge=1<p.constant.length?p.constant[1]:0,fe=
2<p.constant.length?p.constant[2]:0,ve=3<p.constant.length?p.constant[3]:0)):(Fc=Wb(p.buffer)?na.createStream(34962,p.buffer):na.getBuffer(p.buffer),te="type"in p?ua[p.type]:Fc.dtype,gd=!!p.normalized,hd=p.size|0,bd=p.offset|0,Ad=p.stride|0,nd=p.divisor|0);ce=B.buffer;B.buffer=Fc;pe=B.divisor;B.divisor=nd;$d=B.normalized;B.normalized=gd;ie=B.offset;B.offset=bd;Ac=B.size;B.size=hd;Vc=B.state;B.state=zd;qe=B.stride;B.stride=Ad;me=B.type;B.type=te;Fd=B.w;B.w=ve;Md=B.x;B.x=Ce;Nd=B.y;B.y=ge;Od=B.z;B.z=
...
ff;n.z=Xe;Q.vert=Qe;Q.frag=Me;Y.dirty=!0}}},"$22,aColor,aCoord,bColor,bCoord,dashLength,dashTexture,depth,lineEnd,lineTop,miterLimit,miterMode,nextCoord,opacity,prevCoord,scale,thickness,translate,viewport":function(k,Z,q,O,f,c,y,b,v,A,ea,G,F,w,B,N,n,H,ca,I,R,e,g,d,z,U,W,m,oa,L,fa,a,h,X,ra,xa,jb,ec,na,Na,Y){var K,M,P,sa,J,Wb,$a,Q,t,ma,da,Fa,Oa,$b,Ia,S,ob,ga,ta,cc,nc,kc,ud,yc,V,C,la,Da,ub,Qc,Uc,D,u,ka,ua,T,ha,qa,E,p,ba,x,ja,ia,l;K=k.attributes;M=k.buffer;P=k.context;sa=k.current;J=k.draw;Wb=k.elements;
...
T=sa.stencil_opFront;ha=da.viewport;qa=sa.viewport;E={int8:5120,int16:5122,int32:5124,uint8:5121,uint16:5123,uint32:5125,"float":5126,float32:5126};p={divisor:1,offset:0,stride:4};ba={divisor:1,offset:8,stride:8};x={divisor:1,offset:4,stride:4};ja={divisor:1,offset:16,stride:8};ia={divisor:1,offset:24,stride:8};l={divisor:1,offset:0,stride:8};return{batch:function(b,k){var r,n,q,w,v,y;r=Q.next;r!==Q.cur&&(r?t.bindFramebuffer(36160,r.framebuffer):t.bindFramebuffer(36160,null),Q.cur=r);if(sa.dirty){var B,
...
Ca.buffer=null),Ca.x!==Zc||Ca.y!==Ga||Ca.z!==zc||Ca.w!==Mb)t.vertexAttrib4f(Qa,Zc,Ga,zc,Mb),Ca.x=Zc,Ca.y=Ga,Ca.z=zc,Ca.w=Mb;p.buffer=y.colorBuffer;xb=!1;Eb=null;tb=0;wc=!1;Dd=yb=0;sc=1;Jd=0;Mc=5126;bc=Vb=cd=jd=0;ma(p)?(xb=!0,Eb=M.createStream(34962,p),Mc=Eb.dtype):(Eb=M.getBuffer(p))?Mc=Eb.dtype:"constant"in p?(sc=2,"number"===typeof p.constant?(cd=p.constant,Vb=bc=jd=0):(cd=0<p.constant.length?p.constant[0]:0,Vb=1<p.constant.length?p.constant[1]:0,bc=2<p.constant.length?p.constant[2]:0,jd=3<p.constant.length?
p.constant[3]:0)):(Eb=ma(p.buffer)?M.createStream(34962,p.buffer):M.getBuffer(p.buffer),Mc="type"in p?E[p.type]:Eb.dtype,wc=!!p.normalized,Dd=p.size|0,yb=p.offset|0,Jd=p.stride|0,tb=p.divisor|0);Pb=d.location;Ha=K[Pb];if(1===sc){Ha.buffer||t.enableVertexAttribArray(Pb);Yb=Dd||4;if(Ha.type!==Mc||Ha.size!==Yb||Ha.buffer!==Eb||Ha.normalized!==wc||Ha.offset!==yb||Ha.stride!==Jd)t.bindBuffer(34962,Eb.buffer),t.vertexAttribPointer(Pb,Yb,Mc,wc,Jd,yb),Ha.type=Mc,Ha.size=Yb,Ha.buffer=Eb,Ha.normalized=wc,Ha.offset=
...
qb&&M.destroyStream(wa);Ka&&M.destroyStream(Ob);wc.unbind()},scope:function(a,b,d){var e,g,h,k,m,q,u,t,C,y,z,D,V,O,L,K,I,Q,S,T,la,U,Y,W,ka,ga,X,ua,nc,qa,Da,R,fa,oa,ab,ud,Fb,ra,Ta,na,ac,yc,Qc,cc,Bc,Xb,Gc,Rc,La,vb,Wa,Aa,kc,gb,Sa,Hb,cb,fc,Rb,xa,Zb,Sb,$a,Tb,Ma,pb,wb,hb,Pa,Na,Jb,jb,db,lc,Uc,dc,kb,lb,va,qb,wa,Ua,bb,Ba,eb,Ja,Cb,Bb,Ra,Kc,Kb,Za,Ub,ya,Wb,Ka,Ob,fb,ib,za,gc,Ea,rb,sb,Xa,Ya,mc,xc,vc,Va,Mb,Zc,Ga,zc,Qa,Ca,mb,xb,Eb,tb,wc,yb,$b,sc,ec,Mc,jd,cd,Vb,bc,Pb,Ha,Yb,nb,zb,Nb,Qb,hc,jc,Ib,Cc,Dc,Ec,Nc,$c,Sc,Oc,
Lb,Gb,Pc,Hc,Tc,ic,Wc,md,kd,qd,Xc,be,Ld,le,xe,Ud,Hd,Ed,ed,Fc,nd,gd,bd,hd,zd,Ad,te,ve,Ce,ge,fe,ce,pe,$d,ie,Ac,Vc,qe,me,Fd,Md,Nd,Od,je,Ye,ye,oe,Oe,Pe,Le,re,De,Ge,He,Ie,Ee,Id,Rd,Yd,ae,Je,yd,Pd,Ae,Ke,ff,Xe,Qe,Me,We,Ue,Re,Se,Qd,Vd,Te,qf,nf,cf,gf,hf,jf,of,kf,pf,Af,Bf,Ne,Be,lf,mf,Cf,Ff,zf,Df,Ef,uf,vf,tf,wf,xf;e=a.viewport;g=e.x|0;h=e.y|0;k="width"in e?e.width|0:P.framebufferWidth-g;m="height"in e?e.height|0:P.framebufferHeight-h;q=P.viewportWidth;P.viewportWidth=k;u=P.viewportHeight;P.viewportHeight=m;t=
ha[0];ha[0]=g;C=ha[1];ha[1]=h;y=ha[2];ha[2]=k;z=ha[3];ha[3]=m;D=Ia[0];Ia[0]=0;V=Ia[1];Ia[1]=0;O=Ia[2];Ia[2]=0;L=Ia[3];Ia[3]=0;K=da.blend_enable;da.blend_enable=!0;I=ob[0];ob[0]=32774;Q=ob[1];ob[1]=32774;S=ta[0];ta[0]=770;T=ta[1];ta[1]=771;la=ta[2];ta[2]=773;U=ta[3];ta[3]=1;Y=da.cull_enable;da.cull_enable=!0;W=da.cull_face;da.cull_face=1029;ka=v.call(this,P,a,d);ga=da.depth_enable;da.depth_enable=ka;X=a.viewport;ua=X.x|0;nc=X.y|0;qa="width"in X?X.width|0:P.framebufferWidth-ua;Da="height"in X?X.height|
...
kc;Sa=A.call(this,P,a,d);Hb=Oa[33];Oa[33]=Sa;cb=a.opacity;fc=Oa[10];Oa[10]=cb;Rb=P.pixelRatio;xa=Oa[34];Oa[34]=Rb;Zb=a.scale;Sb=Oa[6];Oa[6]=Zb;$a=a.scaleFract;Tb=Oa[7];Oa[7]=$a;Ma=a.thickness;pb=Oa[21];Oa[21]=Ma;wb=a.translate;hb=Oa[8];Oa[8]=wb;Pa=a.translateFract;Na=Oa[9];Oa[9]=Pa;Jb=ea.call(this,P,a,d);jb=Oa[3];Oa[3]=Jb;p.buffer=a.colorBuffer;db=!1;lc=null;Uc=0;dc=!1;lb=kb=0;va=1;qb=0;wa=5126;eb=Ba=bb=Ua=0;ma(p)?(db=!0,lc=M.createStream(34962,p),wa=lc.dtype):(lc=M.getBuffer(p))?wa=lc.dtype:"constant"in
p?(va=2,"number"===typeof p.constant?(bb=p.constant,Ba=eb=Ua=0):(bb=0<p.constant.length?p.constant[0]:0,Ba=1<p.constant.length?p.constant[1]:0,eb=2<p.constant.length?p.constant[2]:0,Ua=3<p.constant.length?p.constant[3]:0)):(lc=ma(p.buffer)?M.createStream(34962,p.buffer):M.getBuffer(p.buffer),wa="type"in p?E[p.type]:lc.dtype,dc=!!p.normalized,lb=p.size|0,kb=p.offset|0,qb=p.stride|0,Uc=p.divisor|0);Ja=G.buffer;G.buffer=lc;Cb=G.divisor;G.divisor=Uc;Bb=G.normalized;G.normalized=dc;Ra=G.offset;G.offset=
...
nf=!!l.normalized,gf=l.size|0,cf=l.offset|0,jf=l.stride|0,qf=l.divisor|0);Ne=ca.buffer;ca.buffer=Te;Be=ca.divisor;ca.divisor=qf;lf=ca.normalized;ca.normalized=nf;mf=ca.offset;ca.offset=cf;Cf=ca.size;ca.size=gf;Ff=ca.state;ca.state=hf;zf=ca.stride;ca.stride=jf;Df=ca.type;ca.type=of;Ef=ca.w;ca.w=kf;uf=ca.x;ca.x=pf;vf=ca.y;ca.y=Af;tf=ca.z;ca.z=Bf;wf=Fa.vert;Fa.vert=36;xf=Fa.frag;Fa.frag=35;sa.dirty=!0;b(P,a,d);P.viewportWidth=q;P.viewportHeight=u;ha[0]=t;ha[1]=C;ha[2]=y;ha[3]=z;Ia[0]=D;Ia[1]=V;Ia[2]=
...
Cf;ca.state=Ff;ca.stride=zf;ca.type=Df;ca.w=Ef;ca.x=uf;ca.y=vf;ca.z=tf;Fa.vert=wf;Fa.frag=xf;sa.dirty=!0}}},"$9,color,id,opacity,position,positionFract,scale,scaleFract,translate,translateFract":function(k,Z,q,O,f,c,y,b,v,A,ea,G,F,w,B,N,n,H,ca){var I,R,e,g,d,z,U,W,m,oa,L,fa,a,h,X,ra,xa,jb,ec,na,Na,Y,K,M,P,sa,J,Wb,$a,Q,t,ma,da,Fa,Oa,$b,Ia,S,ob,ga,ta;I=k.attributes;R=k.buffer;e=k.context;g=k.current;d=k.draw;z=k.elements;U=k.extensions;W=k.framebuffer;m=k.gl;oa=k.isBufferArgs;L=k.next;fa=k.shader;a=
...
uint16:5123,uint32:5125,"float":5126,float32:5126};ga={offset:8,stride:8};ta={offset:8,stride:8};return{batch:function(a,b){var c,f,k,q,C,y;c=W.next;c!==W.cur&&(c?m.bindFramebuffer(36160,c.framebuffer):m.bindFramebuffer(36160,null),W.cur=c);if(g.dirty){var O,X,fa,Ia,D,u,ka,ua,T,ha,qa,E,p,ba,x,ja,ia,l,xa,aa,r,Db,Ab,$a,ec,Ib,ee,Kd,se,od,he,ue;O=L.dither;O!==g.dither&&(O?m.enable(3024):m.disable(3024),g.dither=O);X=L.depth_func;X!==g.depth_func&&(m.depthFunc(X),g.depth_func=X);fa=K[0];Ia=K[1];if(fa!==
M[0]||Ia!==M[1])m.depthRange(fa,Ia),M[0]=fa,M[1]=Ia;D=L.depth_mask;D!==g.depth_mask&&(m.depthMask(D),g.depth_mask=D);u=Na[0];ka=Na[1];ua=Na[2];T=Na[3];if(u!==Y[0]||ka!==Y[1]||ua!==Y[2]||T!==Y[3])m.colorMask(u,ka,ua,T),Y[0]=u,Y[1]=ka,Y[2]=ua,Y[3]=T;ha=L.cull_enable;ha!==g.cull_enable&&(ha?m.enable(2884):m.disable(2884),g.cull_enable=ha);qa=L.cull_face;qa!==g.cull_face&&(m.cullFace(qa),g.cull_face=qa);E=L.frontFace;E!==g.frontFace&&(m.frontFace(E),g.frontFace=E);p=L.lineWidth;p!==g.lineWidth&&(m.lineWidth(p),
g.lineWidth=p);ba=L.polygonOffset_enable;ba!==g.polygonOffset_enable&&(ba?m.enable(32823):m.disable(32823),g.polygonOffset_enable=ba);x=P[0];ja=P[1];if(x!==sa[0]||ja!==sa[1])m.polygonOffset(x,ja),sa[0]=x,sa[1]=ja;ia=L.sample_alpha;ia!==g.sample_alpha&&(ia?m.enable(32926):m.disable(32926),g.sample_alpha=ia);l=L.sample_enable;l!==g.sample_enable&&(l?m.enable(32928):m.disable(32928),g.sample_enable=l);xa=J[0];aa=J[1];if(xa!==Wb[0]||aa!==Wb[1])m.sampleCoverage(xa,aa),Wb[0]=xa,Wb[1]=aa;r=L.stencil_mask;
r!==g.stencil_mask&&(m.stencilMask(r),g.stencil_mask=r);Db=t[0];Ab=t[1];$a=t[2];if(Db!==ma[0]||Ab!==ma[1]||$a!==ma[2])m.stencilFunc(Db,Ab,$a),ma[0]=Db,ma[1]=Ab,ma[2]=$a;ec=Oa[0];Ib=Oa[1];ee=Oa[2];Kd=Oa[3];if(ec!==$b[0]||Ib!==$b[1]||ee!==$b[2]||Kd!==$b[3])m.stencilOpSeparate(ec,Ib,ee,Kd),$b[0]=ec,$b[1]=Ib,$b[2]=ee,$b[3]=Kd;se=da[0];od=da[1];he=da[2];ue=da[3];if(se!==Fa[0]||od!==Fa[1]||he!==Fa[2]||ue!==Fa[3])m.stencilOpSeparate(se,od,he,ue),Fa[0]=se,Fa[1]=od,Fa[2]=he,Fa[3]=ue}m.blendColor(0,0,0,0);
ra[0]=0;ra[1]=0;ra[2]=0;ra[3]=0;m.enable(3042);g.blend_enable=!0;m.blendEquationSeparate(32774,32774);jb[0]=32774;jb[1]=32774;m.blendFuncSeparate(770,771,773,1);na[0]=770;na[1]=771;na[2]=773;na[3]=1;m.disable(2929);g.depth_enable=!1;m.enable(3089);g.scissor_enable=!0;m.disable(2960);g.stencil_enable=!1;if(f=g.profile)k=performance.now(),Z.count+=b;m.useProgram(v.program);q=U.angle_instanced_arrays;var Gd;h.setVAO(null);Gd=d.instances;for(C=0;C<b;++C){y=a[C];var Bd,Zd,Wd,Ze,yf,bf,wd,Fe,Sd,Td,ne,Xd,
rd,id,vd,pd,dd,oc,sd,fd,Lc,qc,ab,Ic,Fb,pc,Ta,Jc,ac,rc,Cd,xd,Bc,Xb,Gc,Rc,La,vb,Wa,Aa,ld,gb,Sa,Hb,cb,fc,Rb,ke,Zb,Sb,td,Tb,Ma,pb,wb,hb,Pa,uc,Jb,ad,db,lc,Yc,dc,kb,lb,va,qb,wa,Ua,bb,Ba,eb,Ja,Cb,Bb,Ra,Kc,Kb,Za,Ub;Bd=y.viewport;Zd=Bd.x|0;Wd=Bd.y|0;Ze="width"in Bd?Bd.width|0:e.framebufferWidth-Zd;yf="height"in Bd?Bd.height|0:e.framebufferHeight-Wd;bf=e.viewportWidth;e.viewportWidth=Ze;wd=e.viewportHeight;e.viewportHeight=yf;m.viewport(Zd,Wd,Ze,yf);S[0]=Zd;S[1]=Wd;S[2]=Ze;S[3]=yf;Fe=y.viewport;Sd=Fe.x|0;Td=
Fe.y|0;ne="width"in Fe?Fe.width|0:e.framebufferWidth-Sd;Xd="height"in Fe?Fe.height|0:e.framebufferHeight-Td;m.scissor(Sd,Td,ne,Xd);Q[0]=Sd;Q[1]=Td;Q[2]=ne;Q[3]=Xd;ga.buffer=y.positionBuffer;rd=!1;id=null;vd=0;pd=!1;oc=dd=0;sd=1;fd=0;Lc=5126;Fb=Ic=ab=qc=0;oa(ga)?(rd=!0,id=R.createStream(34962,ga),Lc=id.dtype):(id=R.getBuffer(ga))?Lc=id.dtype:"constant"in ga?(sd=2,"number"===typeof ga.constant?(ab=ga.constant,Ic=Fb=qc=0):(ab=0<ga.constant.length?ga.constant[0]:0,Ic=1<ga.constant.length?ga.constant[1]:
0,Fb=2<ga.constant.length?ga.constant[2]:0,qc=3<ga.constant.length?ga.constant[3]:0)):(id=oa(ga.buffer)?R.createStream(34962,ga.buffer):R.getBuffer(ga.buffer),Lc="type"in ga?ob[ga.type]:id.dtype,pd=!!ga.normalized,oc=ga.size|0,dd=ga.offset|0,fd=ga.stride|0,vd=ga.divisor|0);pc=w.location;Ta=I[pc];if(1===sd){Ta.buffer||m.enableVertexAttribArray(pc);Jc=oc||2;if(Ta.type!==Lc||Ta.size!==Jc||Ta.buffer!==id||Ta.normalized!==pd||Ta.offset!==dd||Ta.stride!==fd)m.bindBuffer(34962,id.buffer),m.vertexAttribPointer(pc,
Jc,Lc,pd,fd,dd),Ta.type=Lc,Ta.size=Jc,Ta.buffer=id,Ta.normalized=pd,Ta.offset=dd,Ta.stride=fd;Ta.divisor!==vd&&(q.vertexAttribDivisorANGLE(pc,vd),Ta.divisor=vd)}else if(Ta.buffer&&(m.disableVertexAttribArray(pc),Ta.buffer=null),Ta.x!==ab||Ta.y!==Ic||Ta.z!==Fb||Ta.w!==qc)m.vertexAttrib4f(pc,ab,Ic,Fb,qc),Ta.x=ab,Ta.y=Ic,Ta.z=Fb,Ta.w=qc;ta.buffer=y.positionFractBuffer;ac=!1;rc=null;Cd=0;xd=!1;Xb=Bc=0;Gc=1;Rc=0;La=5126;ld=Aa=Wa=vb=0;oa(ta)?(ac=!0,rc=R.createStream(34962,ta),La=rc.dtype):(rc=R.getBuffer(ta))?
La=rc.dtype:"constant"in ta?(Gc=2,"number"===typeof ta.constant?(Wa=ta.constant,Aa=ld=vb=0):(Wa=0<ta.constant.length?ta.constant[0]:0,Aa=1<ta.constant.length?ta.constant[1]:0,ld=2<ta.constant.length?ta.constant[2]:0,vb=3<ta.constant.length?ta.constant[3]:0)):(rc=oa(ta.buffer)?R.createStream(34962,ta.buffer):R.getBuffer(ta.buffer),La="type"in ta?ob[ta.type]:rc.dtype,xd=!!ta.normalized,Xb=ta.size|0,Bc=ta.offset|0,Rc=ta.stride|0,Cd=ta.divisor|0);gb=B.location;Sa=I[gb];if(1===Gc){Sa.buffer||m.enableVertexAttribArray(gb);
Hb=Xb||2;if(Sa.type!==La||Sa.size!==Hb||Sa.buffer!==rc||Sa.normalized!==xd||Sa.offset!==Bc||Sa.stride!==Rc)m.bindBuffer(34962,rc.buffer),m.vertexAttribPointer(gb,Hb,La,xd,Rc,Bc),Sa.type=La,Sa.size=Hb,Sa.buffer=rc,Sa.normalized=xd,Sa.offset=Bc,Sa.stride=Rc;Sa.divisor!==Cd&&(q.vertexAttribDivisorANGLE(gb,Cd),Sa.divisor=Cd)}else if(Sa.buffer&&(m.disableVertexAttribArray(gb),Sa.buffer=null),Sa.x!==Wa||Sa.y!==Aa||Sa.z!==ld||Sa.w!==vb)m.vertexAttrib4f(gb,Wa,Aa,ld,vb),Sa.x=Wa,Sa.y=Aa,Sa.z=ld,Sa.w=vb;cb=
y.fill;fc=cb[0];ke=cb[1];Sb=cb[2];Tb=cb[3];C&&Rb===fc&&Zb===ke&&td===Sb&&Ma===Tb||(Rb=fc,Zb=ke,td=Sb,Ma=Tb,m.uniform4f(ea.location,fc,ke,Sb,Tb));pb=y.scale;wb=pb[0];Pa=pb[1];C&&hb===wb&&uc===Pa||(hb=wb,uc=Pa,m.uniform2f(N.location,wb,Pa));Jb=y.scaleFract;ad=Jb[0];lc=Jb[1];C&&db===ad&&Yc===lc||(db=ad,Yc=lc,m.uniform2f(n.location,ad,lc));dc=y.translate;kb=dc[0];va=dc[1];C&&lb===kb&&qb===va||(lb=kb,qb=va,m.uniform2f(H.location,kb,va));wa=y.translateFract;Ua=wa[0];Ba=wa[1];C&&bb===Ua&&eb===Ba||(bb=Ua,
eb=Ba,m.uniform2f(ca.location,Ua,Ba));Ja=y.id;C&&Cb===Ja||(Cb=Ja,m.uniform1f(G.location,Ja));Bb=y.opacity;C&&Ra===Bb||(Ra=Bb,m.uniform1f(F.location,Bb));Kc=A.call(this,e,y,C);Kb=null;(Kb=(Za=oa(Kc))?z.createStream(Kc):z.getElements(Kc))&&m.bindBuffer(34963,Kb.buffer.buffer);if(Ub=Kb?Kb.vertCount:-1)0<Gd?Kb?q.drawElementsInstancedANGLE(4,Ub,Kb.type,0<<(Kb.type-5121>>1),Gd):q.drawArraysInstancedANGLE(4,0,Ub,Gd):0>Gd&&(Kb?m.drawElements(4,Ub,Kb.type,0<<(Kb.type-5121>>1)):m.drawArrays(4,0,Ub)),e.viewportWidth=
bf,e.viewportHeight=wd,rd&&R.destroyStream(id),ac&&R.destroyStream(rc),Za&&z.destroyStream(Kb)}g.dirty=!0;h.setVAO(null);f&&(Z.cpuTime+=performance.now()-k)},draw:function(a){var b,c,f,k,v,y,A,X,fa,pa,Ia,D,u,ka,ua,T,ha,qa,E,p,ba,x;b=W.next;b!==W.cur&&(b?m.bindFramebuffer(36160,b.framebuffer):m.bindFramebuffer(36160,null),W.cur=b);if(g.dirty){b=L.dither;b!==g.dither&&(b?m.enable(3024):m.disable(3024),g.dither=b);b=L.depth_func;b!==g.depth_func&&(m.depthFunc(b),g.depth_func=b);b=K[0];y=K[1];if(b!==
M[0]||y!==M[1])m.depthRange(b,y),M[0]=b,M[1]=y;b=L.depth_mask;b!==g.depth_mask&&(m.depthMask(b),g.depth_mask=b);b=Na[0];y=Na[1];c=Na[2];f=Na[3];if(b!==Y[0]||y!==Y[1]||c!==Y[2]||f!==Y[3])m.colorMask(b,y,c,f),Y[0]=b,Y[1]=y,Y[2]=c,Y[3]=f;b=L.cull_enable;b!==g.cull_enable&&(b?m.enable(2884):m.disable(2884),g.cull_enable=b);b=L.cull_face;b!==g.cull_face&&(m.cullFace(b),g.cull_face=b);b=L.frontFace;b!==g.frontFace&&(m.frontFace(b),g.frontFace=b);b=L.lineWidth;b!==g.lineWidth&&(m.lineWidth(b),g.lineWidth=
b);b=L.polygonOffset_enable;b!==g.polygonOffset_enable&&(b?m.enable(32823):m.disable(32823),g.polygonOffset_enable=b);b=P[0];y=P[1];if(b!==sa[0]||y!==sa[1])m.polygonOffset(b,y),sa[0]=b,sa[1]=y;b=L.sample_alpha;b!==g.sample_alpha&&(b?m.enable(32926):m.disable(32926),g.sample_alpha=b);b=L.sample_enable;b!==g.sample_enable&&(b?m.enable(32928):m.disable(32928),g.sample_enable=b);b=J[0];y=J[1];if(b!==Wb[0]||y!==Wb[1])m.sampleCoverage(b,y),Wb[0]=b,Wb[1]=y;b=L.stencil_mask;b!==g.stencil_mask&&(m.stencilMask(b),
g.stencil_mask=b);b=t[0];y=t[1];c=t[2];if(b!==ma[0]||y!==ma[1]||c!==ma[2])m.stencilFunc(b,y,c),ma[0]=b,ma[1]=y,ma[2]=c;b=Oa[0];y=Oa[1];c=Oa[2];f=Oa[3];if(b!==$b[0]||y!==$b[1]||c!==$b[2]||f!==$b[3])m.stencilOpSeparate(b,y,c,f),$b[0]=b,$b[1]=y,$b[2]=c,$b[3]=f;b=da[0];y=da[1];c=da[2];f=da[3];if(b!==Fa[0]||y!==Fa[1]||c!==Fa[2]||f!==Fa[3])m.stencilOpSeparate(b,y,c,f),Fa[0]=b,Fa[1]=y,Fa[2]=c,Fa[3]=f}b=a.viewport;c=b.x|0;f=b.y|0;k="width"in b?b.width|0:e.framebufferWidth-c;v="height"in b?b.height|0:e.framebufferHeight-
f;b=e.viewportWidth;e.viewportWidth=k;y=e.viewportHeight;e.viewportHeight=v;m.viewport(c,f,k,v);S[0]=c;S[1]=f;S[2]=k;S[3]=v;m.blendColor(0,0,0,0);ra[0]=0;ra[1]=0;ra[2]=0;ra[3]=0;m.enable(3042);g.blend_enable=!0;m.blendEquationSeparate(32774,32774);jb[0]=32774;jb[1]=32774;m.blendFuncSeparate(770,771,773,1);na[0]=770;na[1]=771;na[2]=773;na[3]=1;m.disable(2929);g.depth_enable=!1;v=a.viewport;c=v.x|0;f=v.y|0;k="width"in v?v.width|0:e.framebufferWidth-c;v="height"in v?v.height|0:e.framebufferHeight-f;
m.scissor(c,f,k,v);Q[0]=c;Q[1]=f;Q[2]=k;Q[3]=v;m.enable(3089);g.scissor_enable=!0;m.disable(2960);g.stencil_enable=!1;if(c=g.profile)A=performance.now(),Z.count++;m.useProgram(q.program);f=U.angle_instanced_arrays;h.setVAO(null);ga.buffer=a.positionBuffer;k=!1;X=0;fa=!1;Ia=pa=0;D=1;u=0;ka=5126;qa=ha=T=ua=0;oa(ga)?(k=!0,v=R.createStream(34962,ga),ka=v.dtype):(v=R.getBuffer(ga))?ka=v.dtype:"constant"in ga?(D=2,"number"===typeof ga.constant?(T=ga.constant,ha=qa=ua=0):(T=0<ga.constant.length?ga.constant[0]:
0,ha=1<ga.constant.length?ga.constant[1]:0,qa=2<ga.constant.length?ga.constant[2]:0,ua=3<ga.constant.length?ga.constant[3]:0)):(v=oa(ga.buffer)?R.createStream(34962,ga.buffer):R.getBuffer(ga.buffer),ka="type"in ga?ob[ga.type]:v.dtype,fa=!!ga.normalized,Ia=ga.size|0,pa=ga.offset|0,u=ga.stride|0,X=ga.divisor|0);E=w.location;p=I[E];if(1===D){p.buffer||m.enableVertexAttribArray(E);Ia=Ia||2;if(p.type!==ka||p.size!==Ia||p.buffer!==v||p.normalized!==fa||p.offset!==pa||p.stride!==u)m.bindBuffer(34962,v.buffer),
m.vertexAttribPointer(E,Ia,ka,fa,u,pa),p.type=ka,p.size=Ia,p.buffer=v,p.normalized=fa,p.offset=pa,p.stride=u;p.divisor!==X&&(f.vertexAttribDivisorANGLE(E,X),p.divisor=X)}else if(p.buffer&&(m.disableVertexAttribArray(E),p.buffer=null),p.x!==T||p.y!==ha||p.z!==qa||p.w!==ua)m.vertexAttrib4f(E,T,ha,qa,ua),p.x=T,p.y=ha,p.z=qa,p.w=ua;ta.buffer=a.positionFractBuffer;X=!1;pa=0;u=!1;ua=ka=0;T=1;E=0;p=5126;x=ba=qa=ha=0;oa(ta)?(X=!0,fa=R.createStream(34962,ta),p=fa.dtype):(fa=R.getBuffer(ta))?p=fa.dtype:"constant"in
ta?(T=2,"number"===typeof ta.constant?(qa=ta.constant,ba=x=ha=0):(qa=0<ta.constant.length?ta.constant[0]:0,ba=1<ta.constant.length?ta.constant[1]:0,x=2<ta.constant.length?ta.constant[2]:0,ha=3<ta.constant.length?ta.constant[3]:0)):(fa=oa(ta.buffer)?R.createStream(34962,ta.buffer):R.getBuffer(ta.buffer),p="type"in ta?ob[ta.type]:fa.dtype,u=!!ta.normalized,ua=ta.size|0,ka=ta.offset|0,E=ta.stride|0,pa=ta.divisor|0);Ia=B.location;D=I[Ia];if(1===T){D.buffer||m.enableVertexAttribArray(Ia);ua=ua||2;if(D.type!==
p||D.size!==ua||D.buffer!==fa||D.normalized!==u||D.offset!==ka||D.stride!==E)m.bindBuffer(34962,fa.buffer),m.vertexAttribPointer(Ia,ua,p,u,E,ka),D.type=p,D.size=ua,D.buffer=fa,D.normalized=u,D.offset=ka,D.stride=E;D.divisor!==pa&&(f.vertexAttribDivisorANGLE(Ia,pa),D.divisor=pa)}else if(D.buffer&&(m.disableVertexAttribArray(Ia),D.buffer=null),D.x!==qa||D.y!==ba||D.z!==x||D.w!==ha)m.vertexAttrib4f(Ia,qa,ba,x,ha),D.x=qa,D.y=ba,D.z=x,D.w=ha;pa=a.fill;m.uniform4f(ea.location,pa[0],pa[1],pa[2],pa[3]);pa=
a.scale;m.uniform2f(N.location,pa[0],pa[1]);pa=a.scaleFract;m.uniform2f(n.location,pa[0],pa[1]);pa=a.translate;m.uniform2f(H.location,pa[0],pa[1]);pa=a.translateFract;m.uniform2f(ca.location,pa[0],pa[1]);m.uniform1f(G.location,a.id);m.uniform1f(F.location,a.opacity);pa=O.call(this,e,a,0);(pa=(a=oa(pa))?z.createStream(pa):z.getElements(pa))&&m.bindBuffer(34963,pa.buffer.buffer);if(u=pa?pa.vertCount:-1)ka=d.instances,0<ka?pa?f.drawElementsInstancedANGLE(4,u,pa.type,0<<(pa.type-5121>>1),ka):f.drawArraysInstancedANGLE(4,
0,u,ka):0>ka&&(pa?m.drawElements(4,u,pa.type,0<<(pa.type-5121>>1)):m.drawArrays(4,0,u)),g.dirty=!0,h.setVAO(null),e.viewportWidth=b,e.viewportHeight=y,c&&(Z.cpuTime+=performance.now()-A),k&&R.destroyStream(v),X&&R.destroyStream(fa),a&&z.destroyStream(pa)},scope:function(h,k,m){var n,q,t,v,w,B,O,H,F,D,u,M,A,G,K,I,E,p,ba,x,J,N,l,Q,aa,r,P,S,U,Y,ea,W,da,ca,ma,pa,sa,ra,na,Fa,Oa,Na,jb,Wb,wd,$b,Sd,Td,ne,Xd,rd,id,vd,pd,dd,oc,sd,fd,Lc,qc,ab,Ic,Fb,pc,Ta,Jc,ac,rc,Cd,xd,Bc,Xb,Gc,Rc,La,vb,Wa,Aa,ld,gb,Sa,Hb,cb,
fc,Rb,ke,Zb,Sb,td,Tb,Ma,pb,wb,hb,Pa,uc,Jb,ad,db,lc,Yc,dc,kb,lb,va,qb,wa,Ua,bb,Ba,eb,Ja,Cb,Bb;n=h.viewport;q=n.x|0;t=n.y|0;v="width"in n?n.width|0:e.framebufferWidth-q;w="height"in n?n.height|0:e.framebufferHeight-t;B=e.viewportWidth;e.viewportWidth=v;O=e.viewportHeight;e.viewportHeight=w;H=Ia[0];Ia[0]=q;F=Ia[1];Ia[1]=t;D=Ia[2];Ia[2]=v;u=Ia[3];Ia[3]=w;M=X[0];X[0]=0;A=X[1];X[1]=0;G=X[2];X[2]=0;K=X[3];X[3]=0;I=L.blend_enable;L.blend_enable=!0;E=xa[0];xa[0]=32774;p=xa[1];xa[1]=32774;ba=ec[0];ec[0]=770;
x=ec[1];ec[1]=771;J=ec[2];ec[2]=773;N=ec[3];ec[3]=1;l=L.depth_enable;L.depth_enable=!1;Q=h.viewport;aa=Q.x|0;r=Q.y|0;P="width"in Q?Q.width|0:e.framebufferWidth-aa;S="height"in Q?Q.height|0:e.framebufferHeight-r;U=$a[0];$a[0]=aa;Y=$a[1];$a[1]=r;ea=$a[2];$a[2]=P;W=$a[3];$a[3]=S;da=L.scissor_enable;L.scissor_enable=!0;ca=L.stencil_enable;L.stencil_enable=!1;if(ma=g.profile)pa=performance.now(),Z.count++;sa=f.call(this,e,h,m);ra=null;ra=(na=oa(sa))?z.createStream(sa):z.getElements(sa);Fa=d.elements;d.elements=
ra;Oa=d.offset;d.offset=0;Na=ra?ra.vertCount:-1;jb=d.count;d.count=Na;Wb=d.primitive;d.primitive=4;wd=h.fill;$b=a[14];a[14]=wd;Sd=h.id;Td=a[31];a[31]=Sd;ne=h.opacity;Xd=a[10];a[10]=ne;rd=e.pixelRatio;id=a[34];a[34]=rd;vd=h.scale;pd=a[6];a[6]=vd;dd=h.scaleFract;oc=a[7];a[7]=dd;sd=h.translate;fd=a[8];a[8]=sd;Lc=h.translateFract;qc=a[9];a[9]=Lc;ab=c.call(this,e,h,m);Ic=a[3];a[3]=ab;ga.buffer=h.positionBuffer;Fb=!1;pc=null;Ta=0;Jc=!1;rc=ac=0;Cd=1;xd=0;Bc=5126;La=Rc=Gc=Xb=0;oa(ga)?(Fb=!0,pc=R.createStream(34962,
...
Ua=b.type;b.type=uc;bb=b.w;b.w=Jb;Ba=b.x;b.x=ad;eb=b.y;b.y=db;Ja=b.z;b.z=lc;Cb=fa.vert;fa.vert=42;Bb=fa.frag;fa.frag=41;g.dirty=!0;k(e,h,m);e.viewportWidth=B;e.viewportHeight=O;Ia[0]=H;Ia[1]=F;Ia[2]=D;Ia[3]=u;X[0]=M;X[1]=A;X[2]=G;X[3]=K;L.blend_enable=I;xa[0]=E;xa[1]=p;ec[0]=ba;ec[1]=x;ec[2]=J;ec[3]=N;L.depth_enable=l;$a[0]=U;$a[1]=Y;$a[2]=ea;$a[3]=W;L.scissor_enable=da;L.stencil_enable=ca;ma&&(Z.cpuTime+=performance.now()-pa);na&&z.destroyStream(ra);d.elements=Fa;d.offset=Oa;d.count=jb;d.primitive=
...
Z,q,O,f,c,y,b,v,A,ea,G,F,w,B,N,n,H,R,I,Ib,e,g,d,z,U,W,m,oa,L,fa,a,h,X,ra,xa,jb,ec,na,Na,Y,K,M,P,sa,J,Wb,$a,Q,t,ma,da,Fa,Oa,$b,Ia,S,ob,ga,ta,cc,nc,kc,ud,yc){var V,C,la,Da,ub,Qc,Uc,D,u,ka,ua,T,ha,qa,E,p,ba,x,ja,ia,l,tc,aa,r,Db,Ab,Ve,de,we,ee,Kd,se,od,he,ue,Gd,Bd,Zd,Wd;V=k.attributes;C=k.buffer;la=k.context;Da=k.current;ub=k.draw;Qc=k.elements;Uc=k.extensions;D=k.framebuffer;u=k.gl;ka=k.isBufferArgs;ua=k.next;T=k.shader;ha=k.uniforms;qa=k.vao;E=ua.blend_color;p=Da.blend_color;ba=ua.blend_equation;x=
Da.blend_equation;ja=ua.blend_func;ia=Da.blend_func;l=ua.colorMask;tc=Da.colorMask;aa=ua.depth_range;r=Da.depth_range;Db=ua.polygonOffset_offset;Ab=Da.polygonOffset_offset;Ve=ua.sample_coverage;de=Da.sample_coverage;we=ua.scissor_box;ee=Da.scissor_box;Kd=ua.stencil_func;se=Da.stencil_func;od=ua.stencil_opBack;he=Da.stencil_opBack;ue=ua.stencil_opFront;Gd=Da.stencil_opFront;Bd=ua.viewport;Zd=Da.viewport;Wd={int8:5120,int16:5122,int32:5124,uint8:5121,uint16:5123,uint32:5125,"float":5126,float32:5126};
return{batch:function(a,b){var c,d,e,g,h,f;c=D.next;c!==D.cur&&(c?u.bindFramebuffer(36160,c.framebuffer):u.bindFramebuffer(36160,null),D.cur=c);if(Da.dirty){var k,m,n,q,v,w,y,z,E,B,O,H,F,A,L,G,I,N,T,ha,U,ea,W,X,ja,R,ca,fa,pa,oa,gb,Sa,Hb,cb;k=ua.dither;k!==Da.dither&&(k?u.enable(3024):u.disable(3024),Da.dither=k);m=ba[0];n=ba[1];if(m!==x[0]||n!==x[1])u.blendEquationSeparate(m,n),x[0]=m,x[1]=n;q=ua.depth_func;q!==Da.depth_func&&(u.depthFunc(q),Da.depth_func=q);v=aa[0];w=aa[1];if(v!==r[0]||w!==r[1])u.depthRange(v,
w),r[0]=v,r[1]=w;y=ua.depth_mask;y!==Da.depth_mask&&(u.depthMask(y),Da.depth_mask=y);z=l[0];E=l[1];B=l[2];O=l[3];if(z!==tc[0]||E!==tc[1]||B!==tc[2]||O!==tc[3])u.colorMask(z,E,B,O),tc[0]=z,tc[1]=E,tc[2]=B,tc[3]=O;H=ua.cull_enable;H!==Da.cull_enable&&(H?u.enable(2884):u.disable(2884),Da.cull_enable=H);F=ua.cull_face;F!==Da.cull_face&&(u.cullFace(F),Da.cull_face=F);A=ua.frontFace;A!==Da.frontFace&&(u.frontFace(A),Da.frontFace=A);L=ua.lineWidth;L!==Da.lineWidth&&(u.lineWidth(L),Da.lineWidth=L);G=ua.polygonOffset_enable;
...
Da.stencil_mask=W);X=Kd[0];ja=Kd[1];R=Kd[2];if(X!==se[0]||ja!==se[1]||R!==se[2])u.stencilFunc(X,ja,R),se[0]=X,se[1]=ja,se[2]=R;ca=ue[0];fa=ue[1];pa=ue[2];oa=ue[3];if(ca!==Gd[0]||fa!==Gd[1]||pa!==Gd[2]||oa!==Gd[3])u.stencilOpSeparate(ca,fa,pa,oa),Gd[0]=ca,Gd[1]=fa,Gd[2]=pa,Gd[3]=oa;gb=od[0];Sa=od[1];Hb=od[2];cb=od[3];if(gb!==he[0]||Sa!==he[1]||Hb!==he[2]||cb!==he[3])u.stencilOpSeparate(gb,Sa,Hb,cb),he[0]=gb,he[1]=Sa,he[2]=Hb,he[3]=cb}u.blendColor(0,0,0,1);p[0]=0;p[1]=0;p[2]=0;p[3]=1;u.enable(3042);
...
Id),r[0]=Ee,r[1]=Id;Rd=ua.depth_mask;Rd!==Da.depth_mask&&(u.depthMask(Rd),Da.depth_mask=Rd);Yd=l[0];ae=l[1];Je=l[2];yd=l[3];if(Yd!==tc[0]||ae!==tc[1]||Je!==tc[2]||yd!==tc[3])u.colorMask(Yd,ae,Je,yd),tc[0]=Yd,tc[1]=ae,tc[2]=Je,tc[3]=yd;Pd=ua.cull_enable;Pd!==Da.cull_enable&&(Pd?u.enable(2884):u.disable(2884),Da.cull_enable=Pd);Ae=ua.cull_face;Ae!==Da.cull_face&&(u.cullFace(Ae),Da.cull_face=Ae);Ke=ua.frontFace;Ke!==Da.frontFace&&(u.frontFace(Ke),Da.frontFace=Ke);ff=ua.lineWidth;ff!==Da.lineWidth&&(u.lineWidth(ff),
...
pf}e=a.viewport;g=e.x|0;h=e.y|0;k="width"in e?e.width|0:la.framebufferWidth-g;m="height"in e?e.height|0:la.framebufferHeight-h;n=la.viewportWidth;la.viewportWidth=k;z=la.viewportHeight;la.viewportHeight=m;u.viewport(g,h,k,m);Zd[0]=g;Zd[1]=h;Zd[2]=k;Zd[3]=m;u.blendColor(0,0,0,1);p[0]=0;p[1]=0;p[2]=0;p[3]=1;u.enable(3042);Da.blend_enable=!0;u.blendFuncSeparate(770,771,773,1);ia[0]=770;ia[1]=771;ia[2]=773;ia[3]=1;u.disable(2929);Da.depth_enable=!1;E=a.viewport;B=E.x|0;H=E.y|0;M="width"in E?E.width|0:
la.framebufferWidth-B;L="height"in E?E.height|0:la.framebufferHeight-H;u.scissor(B,H,M,L);ee[0]=B;ee[1]=H;ee[2]=M;ee[3]=L;u.enable(3089);Da.scissor_enable=!0;u.disable(2960);Da.stencil_enable=!1;if(I=Da.profile)K=performance.now(),Z.count++;u.useProgram(q.program);N=Uc.angle_instanced_arrays;qa.setVAO(null);J=O.call(this,la,a,0);P=!1;T=null;ha=0;U=!1;X=W=0;Y=1;ja=0;R=5126;sa=oa=fa=ca=0;ka(J)?(P=!0,T=C.createStream(34962,J),R=T.dtype):(T=C.getBuffer(J))?R=T.dtype:"constant"in J?(Y=2,"number"===typeof J.constant?
...
p;u=la.viewportWidth;la.viewportWidth=r;t=la.viewportHeight;la.viewportHeight=q;v=Bd[0];Bd[0]=l;w=Bd[1];Bd[1]=p;y=Bd[2];Bd[2]=r;x=Bd[3];Bd[3]=q;D=E[0];E[0]=0;O=E[1];E[1]=0;J=E[2];E[2]=0;F=E[3];E[3]=1;M=ua.blend_enable;ua.blend_enable=!0;A=ja[0];ja[0]=770;G=ja[1];ja[1]=771;V=ja[2];ja[2]=773;K=ja[3];ja[3]=1;ba=ua.depth_enable;ua.depth_enable=!1;Q=b.viewport;P=Q.x|0;aa=Q.y|0;S="width"in Q?Q.width|0:la.framebufferWidth-P;ia="height"in Q?Q.height|0:la.framebufferHeight-aa;Y=we[0];we[0]=P;ea=we[1];we[1]=
...
Me=Pd.size|0,Qe=Pd.offset|0,Ue=Pd.stride|0,Ve=Pd.divisor|0);qf=m.buffer;m.buffer=Ke;nf=m.divisor;m.divisor=Ve;cf=m.normalized;m.normalized=Xe;gf=m.offset;m.offset=Qe;hf=m.size;m.size=Me;jf=m.state;m.state=We;of=m.stride;m.stride=Ue;kf=m.type;m.type=Re;pf=m.w;m.w=Se;Af=m.x;m.x=Qd;Bf=m.y;m.y=Vd;Ne=m.z;m.z=Te;Be=oa.call(this,la,b,f);lf=!1;mf=null;Cf=0;Ff=!1;Df=zf=0;Ef=1;uf=0;vf=5126;If=xf=wf=tf=0;ka(Be)?(lf=!0,mf=C.createStream(34962,Be),vf=mf.dtype):(mf=C.getBuffer(Be))?vf=mf.dtype:"constant"in Be?
...
re;U.divisor=De;U.normalized=Ge;U.offset=He;U.size=Ie;U.state=Ee;U.stride=Id;U.type=Rd;U.w=Yd;U.x=ae;U.y=Je;U.z=yd;Ae&&C.destroyStream(Ke);m.buffer=qf;m.divisor=nf;m.normalized=cf;m.offset=gf;m.size=hf;m.state=jf;m.stride=of;m.type=kf;m.w=pf;m.x=Af;m.y=Bf;m.z=Ne;lf&&C.destroyStream(mf);L.buffer=Jf;L.divisor=Kf;L.normalized=Lf;L.offset=rf;L.size=Qf;L.state=Gf;L.stride=sf;L.type=cg;L.w=Rf;L.x=Sf;L.y=pg;L.z=df;Mf&&C.destroyStream(Nf);a.buffer=qg;a.divisor=rg;a.normalized=sg;a.offset=tg;a.size=ug;a.state=
vg;a.stride=wg;a.type=xg;a.w=yg;a.x=zg;a.y=Ag;a.z=ef;Of&&C.destroyStream(Pf);X.buffer=Bg;X.divisor=Cg;X.normalized=Dg;X.offset=Eg;X.size=Fg;X.state=Gg;X.stride=Hg;X.type=Ig;X.w=Jg;X.x=Kg;X.y=Lg;X.z=Mg;T.vert=Ng;T.frag=Og;Da.dirty=!0}}},"$45,borderColorId,borderSize,colorId,constPointSize,isActive,opacity,paletteSize,paletteTexture,pixelRatio,scale,scaleFract,size,translate,translateFract,x,xFract,y,yFract":function(k,A,q,O,f,c,y,b,v,R,ea,G,F,w,B,N,n,H,ca,I,Ib,e,g,d,z,U,W,m,oa,L,fa,a,h,X,ra,xa,jb,
ec,na,Na,Y,K,M,P,sa,J,Wb,$a,Q,t,ma,da,Fa,Oa,$b,Ia,S,ob,ga,ta,cc,nc,kc,ud){var yc,V,C,la,Da,ub,Qc,Uc,D,u,ka,ua,T,ha,qa,E,p,ba,x,ja,ia,l,tc,aa,r,Db,Ab,Ve,de,we,ee,Kd,se,od,he,ue,Gd,Bd,Zd;yc=k.attributes;V=k.buffer;C=k.context;la=k.current;Da=k.draw;ub=k.elements;Qc=k.extensions;Uc=k.framebuffer;D=k.gl;u=k.isBufferArgs;ka=k.next;ua=k.shader;T=k.uniforms;ha=k.vao;qa=ka.blend_color;E=la.blend_color;p=ka.blend_equation;ba=la.blend_equation;x=ka.blend_func;ja=la.blend_func;ia=ka.colorMask;l=la.colorMask;
tc=ka.depth_range;aa=la.depth_range;r=ka.polygonOffset_offset;Db=la.polygonOffset_offset;Ab=ka.sample_coverage;Ve=la.sample_coverage;de=ka.scissor_box;we=la.scissor_box;ee=ka.stencil_func;Kd=la.stencil_func;se=ka.stencil_opBack;od=la.stencil_opBack;he=ka.stencil_opFront;ue=la.stencil_opFront;Gd=ka.viewport;Bd=la.viewport;Zd={int8:5120,int16:5122,int32:5124,uint8:5121,uint16:5123,uint32:5125,"float":5126,float32:5126};return{batch:function(a,b){var c,d,e,g,f,h;c=Uc.next;c!==Uc.cur&&(c?D.bindFramebuffer(36160,
c.framebuffer):D.bindFramebuffer(36160,null),Uc.cur=c);if(la.dirty){var k,m,n,q,v,w,y,x,z,B,O,H,F,L,G,N,I,T,U,W,ea,X,R,ca,fa,pa,ua,qa,oa,Aa,ld,gb,Sa,Hb;k=ka.dither;k!==la.dither&&(k?D.enable(3024):D.disable(3024),la.dither=k);m=p[0];n=p[1];if(m!==ba[0]||n!==ba[1])D.blendEquationSeparate(m,n),ba[0]=m,ba[1]=n;q=ka.depth_func;q!==la.depth_func&&(D.depthFunc(q),la.depth_func=q);v=tc[0];w=tc[1];if(v!==aa[0]||w!==aa[1])D.depthRange(v,w),aa[0]=v,aa[1]=w;y=ka.depth_mask;y!==la.depth_mask&&(D.depthMask(y),
...
yb&&V.destroyStream(Dd),jc&&V.destroyStream(de),kd&&V.destroyStream(qd),Ad&&V.destroyStream(te),Od&&V.destroyStream(je),ae&&V.destroyStream(Je),Qf&&ub.destroyStream(rf)}sa.unbind();la.dirty=!0;ha.setVAO(null);d&&(A.cpuTime+=performance.now()-e)},draw:function(a){var d,e,g,h,k,m,n,x,z,B,H,J,L,M,N,I,K,T,P,U,W,X,Y,ca,fa,ua,qa,na,oa,sa,ra,xa,Na,La,vb,Wa,Aa,jb,gb,Sa,Hb,cb,fc,Rb,ec,Zb,Sb,Ib,Tb,Ma,pb,wb,hb,Pa,uc,Jb,ad,db,lc,Yc,dc,kb,lb,va,qb,wa,Ua,bb,Ba,eb,Ja,Cb,Bb,Ra,Kc,Kb,Za,Ub,ya,Gd,Ka,Ob,fb,ib,za,gc,
...
Vd=he[0];Te=he[1];qf=he[2];nf=he[3];if(Vd!==ue[0]||Te!==ue[1]||qf!==ue[2]||nf!==ue[3])D.stencilOpSeparate(Vd,Te,qf,nf),ue[0]=Vd,ue[1]=Te,ue[2]=qf,ue[3]=nf;cf=se[0];gf=se[1];hf=se[2];jf=se[3];if(cf!==od[0]||gf!==od[1]||hf!==od[2]||jf!==od[3])D.stencilOpSeparate(cf,gf,hf,jf),od[0]=cf,od[1]=gf,od[2]=hf,od[3]=jf}e=a.viewport;g=e.x|0;h=e.y|0;k="width"in e?e.width|0:C.framebufferWidth-g;m="height"in e?e.height|0:C.framebufferHeight-h;n=C.viewportWidth;C.viewportWidth=k;x=C.viewportHeight;C.viewportHeight=
m;D.viewport(g,h,k,m);Bd[0]=g;Bd[1]=h;Bd[2]=k;Bd[3]=m;D.blendColor(0,0,0,1);E[0]=0;E[1]=0;E[2]=0;E[3]=1;D.enable(3042);la.blend_enable=!0;D.blendFuncSeparate(770,771,773,1);ja[0]=770;ja[1]=771;ja[2]=773;ja[3]=1;D.disable(2929);la.depth_enable=!1;z=a.viewport;B=z.x|0;H=z.y|0;J="width"in z?z.width|0:C.framebufferWidth-B;L="height"in z?z.height|0:C.framebufferHeight-H;D.scissor(B,H,J,L);we[0]=B;we[1]=H;we[2]=J;we[3]=L;D.enable(3089);la.scissor_enable=!0;D.disable(2960);la.stencil_enable=!1;if(M=la.profile)N=
performance.now(),A.count++;D.useProgram(q.program);I=Qc.angle_instanced_arrays;ha.setVAO(null);K=O.call(this,C,a,0);T=!1;P=null;U=0;W=!1;Y=X=0;ca=1;fa=0;ua=5126;sa=oa=na=qa=0;u(K)?(T=!0,P=V.createStream(34962,K),ua=P.dtype):(P=V.getBuffer(K))?ua=P.dtype:"constant"in K?(ca=2,"number"===typeof K.constant?(na=K.constant,oa=sa=qa=0):(na=0<K.constant.length?K.constant[0]:0,oa=1<K.constant.length?K.constant[1]:0,sa=2<K.constant.length?K.constant[2]:0,qa=3<K.constant.length?K.constant[3]:0)):(P=u(K.buffer)?
...
Ae.dtype,ff=!!yd.normalized,Qe=yd.size|0,Xe=yd.offset|0,We=yd.stride|0,Ke=yd.divisor|0);Te=m.buffer;m.buffer=Ae;qf=m.divisor;m.divisor=Ke;nf=m.normalized;m.normalized=ff;cf=m.offset;m.offset=Xe;gf=m.size;m.size=Qe;hf=m.state;m.state=Me;jf=m.stride;m.stride=We;of=m.type;m.type=Ue;kf=m.w;m.w=Re;pf=m.x;m.x=Se;Af=m.y;m.y=Qd;Bf=m.z;m.z=Vd;Ne=oa.call(this,C,b,f);Be=!1;lf=null;mf=0;Cf=!1;zf=Ff=0;Df=1;Ef=0;uf=5126;xf=wf=tf=vf=0;u(Ne)?(Be=!0,lf=V.createStream(34962,Ne),uf=lf.dtype):(lf=V.getBuffer(Ne))?uf=
...
U.buffer=Le;U.divisor=re;U.normalized=De;U.offset=Ge;U.size=He;U.state=Ie;U.stride=Ee;U.type=Id;U.w=Rd;U.x=Yd;U.y=ae;U.z=Je;Pd&&V.destroyStream(Ae);m.buffer=Te;m.divisor=qf;m.normalized=nf;m.offset=cf;m.size=gf;m.state=hf;m.stride=jf;m.type=of;m.w=kf;m.x=pf;m.y=Af;m.z=Bf;Be&&V.destroyStream(lf);L.buffer=If;L.divisor=Jf;L.normalized=Kf;L.offset=Lf;L.size=rf;L.state=Qf;L.stride=Gf;L.type=sf;L.w=cg;L.x=Rf;L.y=Sf;L.z=pg;$e&&V.destroyStream(Mf);a.buffer=ig;a.divisor=qg;a.normalized=rg;a.offset=sg;a.size=
...
rc);Cd=Da[0];xd=Da[1];Bc=Da[2];Xb=Da[3];if(Cd!==ub[0]||xd!==ub[1]||Bc!==ub[2]||Xb!==ub[3])Q.scissor(Cd,xd,Bc,Xb),ub[0]=Cd,ub[1]=xd,ub[2]=Bc,ub[3]=Xb}k=this.viewport;l=k.x|0;n=k.y|0;q="width"in k?k.width|0:M.framebufferWidth-l;r="height"in k?k.height|0:M.framebufferHeight-n;v=M.viewportWidth;M.viewportWidth=q;w=M.viewportHeight;M.viewportHeight=r;Q.viewport(l,n,q,r);ha[0]=l;ha[1]=n;ha[2]=q;ha[3]=r;Q.blendColor(0,0,0,1);Ia[0]=0;Ia[1]=0;Ia[2]=0;Ia[3]=1;Q.enable(3042);P.blend_enable=!0;Q.blendFuncSeparate(770,
771,773,1);ta[0]=770;ta[1]=771;ta[2]=773;ta[3]=1;Q.disable(2929);P.depth_enable=!1;Q.disable(2960);P.stencil_enable=!1;if(y=P.profile)B=performance.now(),A.count+=c;Q.useProgram(H.program);O=Wb.angle_instanced_arrays;var Gc,Rc,La,vb,Wa,Aa,ld,gb,Sa,Hb,cb,fc,Rb,ke,Zb,Sb,td,Tb,Ma,pb,wb,hb,Pa,uc,Jb,ad,db,lc,Yc,dc,kb,lb,va,qb,wa,Ua,bb,Ba,eb,Ja,Cb,Bb,Ra,Kc,Kb,Za,Ub,ya,ze,Ka,Ob,fb,ib,za,gc,Ea,rb,sb,Xa,Ya,mc,xc,vc,Va,Mb,Zc,Ga,zc,Qa,Ca,mb;Oa.setVAO(null);p.buffer=this.sizeBuffer;Gc=!1;Rc=null;La=0;vb=!1;Aa=
Wa=0;ld=1;gb=0;Sa=5126;Rb=fc=cb=Hb=0;t(p)?(Gc=!0,Rc=K.createStream(34962,p),Sa=Rc.dtype):(Rc=K.getBuffer(p))?Sa=Rc.dtype:"constant"in p?(ld=2,"number"===typeof p.constant?(cb=p.constant,fc=Rb=Hb=0):(cb=0<p.constant.length?p.constant[0]:0,fc=1<p.constant.length?p.constant[1]:0,Rb=2<p.constant.length?p.constant[2]:0,Hb=3<p.constant.length?p.constant[3]:0)):(Rc=t(p.buffer)?K.createStream(34962,p.buffer):K.getBuffer(p.buffer),Sa="type"in p?qa[p.type]:Rc.dtype,vb=!!p.normalized,Aa=p.size|0,Wa=p.offset|
0,gb=p.stride|0,La=p.divisor|0);ke=Na.location;Zb=Y[ke];if(1===ld){Zb.buffer||Q.enableVertexAttribArray(ke);Sb=Aa||1;if(Zb.type!==Sa||Zb.size!==Sb||Zb.buffer!==Rc||Zb.normalized!==vb||Zb.offset!==Wa||Zb.stride!==gb)Q.bindBuffer(34962,Rc.buffer),Q.vertexAttribPointer(ke,Sb,Sa,vb,gb,Wa),Zb.type=Sa,Zb.size=Sb,Zb.buffer=Rc,Zb.normalized=vb,Zb.offset=Wa,Zb.stride=gb;Zb.divisor!==La&&(O.vertexAttribDivisorANGLE(ke,La),Zb.divisor=La)}else if(Zb.buffer&&(Q.disableVertexAttribArray(ke),Zb.buffer=null),Zb.x!==
...
Qb,hc,jc,Hf,Cc,Dc,Ec,Nc,$c,Sc,Oc,Lb,Gb,Pc,Hc,Tc,ic,Wc,md;xb=ca.call(this,M,G,F);F&&Eb===xb||(Eb=xb,Q.uniform1f(fa.location,xb));tb=I.call(this,M,G,F);F&&wc===tb||(wc=tb,Q.uniform1f(h.location,tb));yb=G.align;F&&Dd===yb||(Dd=yb,Q.uniform1f(d.location,yb));sc=G.baseline;F&&Jd===sc||(Jd=sc,Q.uniform1f(m.location,sc));Mc=G.color;jd=Mc[0];Vb=Mc[1];Pb=Mc[2];Yb=Mc[3];F&&cd===jd&&bc===Vb&&Ha===Pb&&nb===Yb||(cd=jd,bc=Vb,Ha=Pb,nb=Yb,Q.uniform4f(a.location,jd,Vb,Pb,Yb));zb=Ib.call(this,M,G,F);Nb=zb[0];hc=zb[1];
...
l;r=M.viewportWidth;M.viewportWidth=v;B=M.viewportHeight;M.viewportHeight=w;Q.viewport(n,l,v,w);ha[0]=n;ha[1]=l;ha[2]=v;ha[3]=w;Q.blendColor(0,0,0,1);Ia[0]=0;Ia[1]=0;Ia[2]=0;Ia[3]=1;Q.enable(3042);P.blend_enable=!0;Q.blendFuncSeparate(770,771,773,1);ta[0]=770;ta[1]=771;ta[2]=773;ta[3]=1;Q.disable(2929);P.depth_enable=!1;Q.disable(2960);P.stencil_enable=!1;if(F=P.profile)H=performance.now(),A.count++;Q.useProgram(q.program);G=Wb.angle_instanced_arrays;Oa.setVAO(null);p.buffer=this.sizeBuffer;N=!1;
I=null;T=0;R=!1;ca=ea=0;da=1;ga=0;pa=5126;be=$b=Ib=Fa=0;t(p)?(N=!0,I=K.createStream(34962,p),pa=I.dtype):(I=K.getBuffer(p))?pa=I.dtype:"constant"in p?(da=2,"number"===typeof p.constant?(Ib=p.constant,$b=be=Fa=0):(Ib=0<p.constant.length?p.constant[0]:0,$b=1<p.constant.length?p.constant[1]:0,be=2<p.constant.length?p.constant[2]:0,Fa=3<p.constant.length?p.constant[3]:0)):(I=t(p.buffer)?K.createStream(34962,p.buffer):K.getBuffer(p.buffer),pa="type"in p?qa[p.type]:I.dtype,R=!!p.normalized,ca=p.size|0,
ea=p.offset|0,ga=p.stride|0,T=p.divisor|0);bf=Na.location;wd=Y[bf];if(1===da){wd.buffer||Q.enableVertexAttribArray(bf);Fe=ca||1;if(wd.type!==pa||wd.size!==Fe||wd.buffer!==I||wd.normalized!==R||wd.offset!==ea||wd.stride!==ga)Q.bindBuffer(34962,I.buffer),Q.vertexAttribPointer(bf,Fe,pa,R,ga,ea),wd.type=pa,wd.size=Fe,wd.buffer=I,wd.normalized=R,wd.offset=ea,wd.stride=ga;wd.divisor!==T&&(G.vertexAttribDivisorANGLE(bf,T),wd.divisor=T)}else if(wd.buffer&&(Q.disableVertexAttribArray(bf),wd.buffer=null),wd.x!==
...
zc;jd=N.z;N.z=Qa;p.buffer=this.sizeBuffer;cd=!1;Vb=null;bc=0;Pb=!1;Yb=Ha=0;nb=1;zb=0;Nb=5126;Hf=jc=hc=Qb=0;t(p)?(cd=!0,Vb=K.createStream(34962,p),Nb=Vb.dtype):(Vb=K.getBuffer(p))?Nb=Vb.dtype:"constant"in p?(nb=2,"number"===typeof p.constant?(hc=p.constant,jc=Hf=Qb=0):(hc=0<p.constant.length?p.constant[0]:0,jc=1<p.constant.length?p.constant[1]:0,Hf=2<p.constant.length?p.constant[2]:0,Qb=3<p.constant.length?p.constant[3]:0)):(Vb=t(p.buffer)?K.createStream(34962,p.buffer):K.getBuffer(p.buffer),Nb="type"in
p?qa[p.type]:Vb.dtype,Pb=!!p.normalized,Yb=p.size|0,Ha=p.offset|0,zb=p.stride|0,bc=p.divisor|0);Cc=n.buffer;n.buffer=Vb;Dc=n.divisor;n.divisor=bc;Ec=n.normalized;n.normalized=Pb;Nc=n.offset;n.offset=Ha;$c=n.size;n.size=Yb;Sc=n.state;n.state=nb;Oc=n.stride;n.stride=zb;Lb=n.type;n.type=Nb;Gb=n.w;n.w=Qb;Pc=n.x;n.x=hc;Hc=n.y;n.y=jc;Tc=n.z;n.z=Hf;ic=da.vert;da.vert=61;Wc=da.frag;da.frag=60;P.dirty=!0;b(M,a,c);M.viewportWidth=k;M.viewportHeight=m;T[0]=q;T[1]=u;T[2]=y;T[3]=z;$b[0]=C;$b[1]=O;$b[2]=D;$b[3]=
...
"function"===typeof b.getBoundingClientRect?v=b:"function"===typeof b.drawArrays||"function"===typeof b.drawElements?(G=b,R=G.canvas):(f.constructor(b),"gl"in b?G=b.gl:"canvas"in b?R=O(b.canvas):"container"in b&&(A=O(b.container)),"attributes"in b&&(c=b.attributes,f.type(c,"object","invalid context attributes")),"extensions"in b&&(F=q(b.extensions)),"optionalExtensions"in b&&(w=q(b.optionalExtensions)),"onDone"in b&&(f.type(b.onDone,"function","invalid or missing onDone callback"),n=b.onDone),"profile"in
...
function R(a){ra.getError();jb=!1;Ib.restore();ma.restore();$a.restore();da.restore();Fa.restore();Oa.restore();t.restore();K&&K.restore();$b.procs.refresh();d();ta.forEach(function(a){a()})}function m(a){function b(a,c){var d={},e={};Object.keys(a).forEach(function(b){var f=a[b];if(O.isDynamic(f))e[b]=O.unbox(f,b);else{if(c&&Array.isArray(f))for(var g=0;g<f.length;++g)if(O.isDynamic(f[g])){e[b]=O.unbox(f,b);return}d[b]=f}});return{dynamic:e,"static":d}}function c(a){for(;t.length<a;)t.push(null);
return t}Z(!!a,"invalid args to regl({...})");Z.type(a,"object","invalid args to regl({...})");var d=b(a.context||{},!0),e=b(a.uniforms||{},!0),f=b(a.attributes||{},!1);a=b(function(a){function b(a){if(a in c){var d=c[a];delete c[a];Object.keys(d).forEach(function(b){c[a+"."+b]=d[b]})}}var c=q({},a);delete c.uniforms;delete c.attributes;delete c.context;delete c.vao;"stencil"in c&&c.stencil.op&&(c.stencil.opBack=c.stencil.opFront=c.stencil.op,delete c.stencil.op);b("blend");b("depth");b("cull");b("stencil");
b("polygonOffset");b("scissor");b("sample");"vao"in a&&(c.vao=a.vao);return c}(a),!1);var g={gpuTime:0,cpuTime:0,count:0},h=$b.compile(a,f,e,d,g),k=h.draw,m=h.batch,n=h.scope,t=[];return q(function(a,b){var d;jb&&Z.raise("context lost");if("function"===typeof a)return n.call(this,null,a,0);if("function"===typeof b)if("number"===typeof a)for(d=0;d<a;++d)n.call(this,null,b,d);else if(Array.isArray(a))for(d=0;d<a.length;++d)n.call(this,a[d],b,d);else return n.call(this,a,b,0);else if("number"===typeof a){if(0<
a)return m.call(this,c(a|0),a|0)}else if(Array.isArray(a)){if(a.length)return m.call(this,a,a.length)}else return k.call(this,a)},{stats:g,destroy:function(){h.destroy()}})}function oa(a,b){var c=0;$b.procs.poll();var d=b.color;d&&(ra.clearColor(+d[0]||0,+d[1]||0,+d[2]||0,+d[3]||0),c|=16384);"depth"in b&&(ra.clearDepth(+b.depth),c|=256);"stencil"in b&&(ra.clearStencil(b.stencil|0),c|=1024);Z(!!c,"called regl.clear with no buffer specified");ra.clear(c)}function L(a){Z.type(a,"function","regl.frame() callback must be a function");
...
fa();$b.procs.refresh();K&&K.update()}function X(){return(c()-M)/1E3}console.log("REGL args are:",e);e=b(e);console.log("REGL configs are:",e);if(!e)return null;var ra=e.gl,xa=ra.getContextAttributes(),jb=ra.isContextLost(),Ib=v(ra,e);if(!Ib)return null;var na=y(),Na=I(),Y=Ib.extensions,K=be(ra,Y),M=c(),P=ra.drawingBufferWidth,sa=ra.drawingBufferHeight,J={tick:0,time:0,viewportWidth:P,viewportHeight:sa,framebufferWidth:P,framebufferHeight:sa,drawingBufferWidth:P,drawingBufferHeight:sa,pixelRatio:e.pixelRatio},
P={elements:null,primitive:4,count:-1,offset:0,instances:-1},Wb=pa(ra,Y),$a=ea(ra,Na,e,function(a){return t.destroyBuffer(a)}),Q=G(ra,Y,$a,Na),t=N(ra,Y,Wb,Na,$a,Q,P),ma=n(ra,na,Na,e),da=F(ra,Y,Wb,function(){$b.procs.poll()},J,Na,e),Fa=w(ra,Y,Wb,Na,e),Oa=B(ra,Y,Wb,da,Fa,Na),$b=ca(ra,na,Y,Wb,$a,Q,da,Oa,{},t,ma,P,J,K,e),na=H(ra,Oa,$b.procs.poll,J,xa,Y,Wb),Ia=$b.next,S=ra.canvas,ob=[],ga=[],ta=[],cc=[e.onDestroy],nc=null;S&&(S.addEventListener("webglcontextlost",A,!1),S.addEventListener("webglcontextrestored",
R,!1));var kc=Oa.setFBO=m({framebuffer:O.define.call(null,1,"framebuffer")});h();xa=q(m,{clear:function(a){Z("object"===typeof a&&a,"regl.clear() takes an object as input");if("framebuffer"in a)if(a.framebuffer&&"framebufferCube"===a.framebuffer_reglType)for(var b=0;6>b;++b)kc(q({framebuffer:a.framebuffer.faces[b]},a),oa);else kc(a,oa);else oa(null,a)},prop:O.define.bind(null,1),context:O.define.bind(null,2),"this":O.define.bind(null,3),draw:m({}),buffer:function(a){return $a.create(a,34962,!1,!1)},
elements:function(a){return Q.create(a,!1)},texture:da.create2D,cube:da.createCube,renderbuffer:Fa.create,framebuffer:Oa.create,framebufferCube:Oa.createCube,vao:t.createVAO,attributes:xa,frame:L,on:function(a,b){Z.type(b,"function","listener callback must be a function");var c;switch(a){case "frame":return L(b);case "lost":c=ga;break;case "restore":c=ta;break;case "destroy":c=cc;break;default:Z.raise("invalid event, must be one of frame,lost,restore,destroy")}c.push(b);return{cancel:function(){for(var a=
0;a<c.length;++a)if(c[a]===b){c[a]=c[c.length-1];c.pop();break}}}},limits:Wb,hasExtension:function(a){return 0<=Wb.extensions.indexOf(a.toLowerCase())},read:na,destroy:function(){ob.length=0;z();S&&(S.removeEventListener("webglcontextlost",A),S.removeEventListener("webglcontextrestored",R));ma.clear();Oa.clear();Fa.clear();t.clear();da.clear();Q.clear();$a.clear();K&&K.clear();cc.forEach(function(a){a()})},_gl:ra,_refresh:h,poll:function(){a();K&&K.update()},now:X,stats:Na});e.onDone(null,xa);return xa}},
