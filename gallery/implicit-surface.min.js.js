...
0;h.count=-1;h.instances=-1;h.primitive=4;h.elements&&(h.count=h.elements._elements.vertCount,h.primitive=h.elements._elements.primType);"offset"in g&&(h.offset=g.offset|0);"count"in g&&(h.count=g.count|0);"instances"in g&&(h.instances=g.instances|0);"primitive"in g&&(n(g.primitive in a,"bad primitive type: "+g.primitive),h.primitive=a[g.primitive]);n.optional(function(){for(var a=r(g),c=0;c<a.length;++c)n(0<=u.indexOf(a[c]),'invalid option for vao: "'+a[c]+'" valid options are '+u)});n(Array.isArray(X),
"attributes must be an array")}n(X.length<p,"too many attributes");n(0<X.length,"must specify at least one attribute");var c={},d=h.attributes;d.length=X.length;for(var ba=0;ba<X.length;++ba){var P=X[ba],l=d[ba]=new e,B=P.data||P;if(Array.isArray(B)||b(B)||t(B)){var z;h.buffers[ba]&&(z=h.buffers[ba],b(B)&&z._buffer.byteLength>=B.byteLength?z.subdata(B):(z.destroy(),h.buffers[ba]=null));h.buffers[ba]||(z=h.buffers[ba]=w.create(P,34962,!1,!0));l.buffer=w.getBuffer(z);l.size=l.buffer.dimension|0;l.normalized=
...
!0)):4===d.type&&(g=g||d.data.thisDep,f=f||d.data.contextDep,h=h||d.data.propDep)}return new n(g,f,h,b)}return new n(3===g,2===g,1===g,b)}var t=A("./util/sorted-object-keys"),a=A("./util/check"),u=A("./util/extend"),ma=A("./util/codegen"),Q=A("./util/loop"),G=A("./util/is-typed-array"),D=A("./util/is-ndarray"),w=A("./util/is-array-like"),C=A("./dynamic"),B=A("./constants/primitives.json"),z=A("./constants/dtypes.json"),J=["x","y","z","w"],P="blend.func blend.equation stencil.func stencil.opFront stencil.opBack sample.coverage viewport scissor.box polygonOffset.offset".split(" "),
...
if("string"===typeof c.frag&&"string"===typeof c.vert){if(0<t(m.dynamic).length)return null;var c=m["static"],g=t(c);if(0<g.length&&"number"===typeof c[g[0]]){for(var k=[],f=0;f<g.length;++f)a("number"===typeof c[g[f]],"must specify all vertex attribute locations when using vaos"),k.push([c[g[f]]|0,g[f]]);return k}}return null}function v(c,m,k){function E(c){if(c in d){var m=q.id(d[c]);a.optional(function(){xb.shader(g[c],m,a.guessCommand())});var k=f(function(){return m});k.id=m;return k}if(c in
h){var fa=h[c];return b(fa,function(b,m){var k=b.invoke(m,fa),f=m.def(b.shared.strings,".id(",k,")");a.optional(function(){m(b.shared.shader,".shader(",g[c],",",f,",",b.command,");")});return f})}return null}var d=c["static"],h=c.dynamic,e=E("frag"),t=E("vert"),xd=null;I(e)&&I(t)?(xd=xb.program(t.id,e.id,null,k),c=f(function(a,b){return a.link(xd)})):c=new n(e&&e.thisDep||t&&t.thisDep,e&&e.contextDep||t&&t.contextDep,e&&e.propDep||t&&t.propDep,function(b,m){var c=b.shared.shader,g;g=e?e.append(b,
m):m.def(c,".","frag");var k;k=t?t.append(b,m):m.def(c,".","vert");var f=c+".program("+k+","+g;a.optional(function(){f+=","+b.command});return m.def(f+")")});return{frag:e,vert:t,progVar:c,program:xd}}function ja(g,m){function k(c,g){if(c in E){var fa=E[c]|0;g?h.offset=fa:h.instances=fa;a.command(!g||0<=fa,"invalid "+c,m.commandStr);return f(function(a,c){g&&(a.OFFSET=fa);return fa})}if(c in d){var qd=d[c];return b(qd,function(b,m){var k=b.invoke(m,qd);g&&(b.OFFSET=k,a.optional(function(){b.assert(m,
...
"object",d,m.commandStr);var g=b.cmp||"keep",k=b.ref||0;b="mask"in b?b.mask:-1;a.commandParameter(g,p,c+".cmp",m.commandStr);a.commandType(k,"number",c+".ref",m.commandStr);a.commandType(b,"number",c+".mask",m.commandStr);return[p[g],k,b]},function(c,b,m){var g=c.constants.compareFuncs;a.optional(function(){function a(){c.assert(b,Array.prototype.join.call(arguments,""),"invalid stencil.func")}a(m+"&&typeof ",m,'==="object"');a('!("cmp" in ',m,")||(",m,".cmp in ",g,")")});var k=b.def('"cmp" in ',
...
typeof b[g]||"boolean"===typeof b[g],"invalid uniform "+c,m.commandStr);return b[g]}),"]")}):a.commandRaise('invalid or missing data for uniform "'+c+'"',m.commandStr);k.value=b;E[c]=k});t(k).forEach(function(a){var c=k[a];E[a]=b(c,function(a,b){return a.invoke(b,c)})});return E}function Oa(c,m){var g=c["static"],k=c.dynamic,E={};t(g).forEach(function(c){var b=g[c],k=q.id(c),fa=new ia;if(e(b))fa.state=1,fa.buffer=Y.getBuffer(Y.create(b,34962,!1,!0)),fa.type=0;else{var d=Y.getBuffer(b);if(d)fa.state=
...
0;a.command(0<=l,'invalid offset for attribute "'+c+'"',m.commandStr);var p=b.stride|0;a.command(0<=p&&256>p,'invalid stride for attribute "'+c+'", must be integer betweeen [0, 255]',m.commandStr);var r=b.size|0;a.command(!("size"in b)||0<r&&4>=r,'invalid size for attribute "'+c+'", must be 1,2,3,4',m.commandStr);var x=!!b.normalized,v=0;"type"in b&&(a.commandParameter(b.type,z,"invalid type for attribute "+c,m.commandStr),v=z[b.type]);var la=b.divisor|0;a.optional(function(){"divisor"in b&&(a.command(0===
la||R,'cannot specify divisor for attribute "'+c+'", instancing not supported',m.commandStr),a.command(0<=la,'invalid divisor for attribute "'+c+'"',m.commandStr));var g=m.commandStr,k="buffer offset divisor normalized type size stride".split(" ");t(b).forEach(function(b){a.command(0<=k.indexOf(b),'unknown parameter "'+b+'" for attribute pointer "'+c+'" (valid parameters are '+k+")",g)})});fa.buffer=d;fa.state=1;fa.size=r;fa.normalized=x;fa.type=v||d.dtype;fa.offset=l;fa.stride=p;fa.divisor=la}}E[c]=
f(function(a,c){var b=a.attribCache;if(k in b)return b[k];var m={isStream:!1};t(fa).forEach(function(a){m[a]=fa[a]});fa.buffer&&(m.buffer=a.link(fa.buffer),m.type=m.type||m.buffer+".dtype");return b[k]=m})});t(k).forEach(function(c){var m=k[c];E[c]=b(m,function(b,g){function k(a){g(e[a],"=",f,".",a,"|0;")}var f=b.invoke(g,m),fa=b.shared,E=b.constants,d=fa.isBufferArgs,h=fa.buffer;a.optional(function(){b.assert(g,f+"&&(typeof "+f+'==="object"||typeof '+f+'==="function")&&('+d+"("+f+")||"+h+".getBuffer("+
f+")||"+h+".getBuffer("+f+".buffer)||"+d+"("+f+'.buffer)||("constant" in '+f+"&&(typeof "+f+'.constant==="number"||'+fa.isArrayLike+"("+f+".constant))))",'invalid dynamic attribute "'+c+'"')});var e={isStream:g.def(!1)},q=new ia;q.state=1;t(q).forEach(function(a){e[a]=g.def(""+q[a])});var l=e.buffer,p=e.type;g("if(",d,"(",f,")){",e.isStream,"=true;",l,"=",h,".createStream(",34962,",",f,");",p,"=",l,".dtype;","}else{",l,"=",h,".getBuffer(",f,");","if(",l,"){",p,"=",l,".dtype;",'}else if("constant" in ',
...
k("offset");k("stride");k("divisor");g("}}");g.exit("if(",e.isStream,"){",h,".destroyStream(",l,");","}");return e})});return E}function S(a){var c=a["static"],g=a.dynamic,k={};t(c).forEach(function(a){var b=c[a];k[a]=f(function(a,c){return"number"===typeof b||"boolean"===typeof b?""+b:a.link(b)})});t(g).forEach(function(a){var c=g[a];k[a]=b(c,function(a,b){return a.invoke(b,c)})});return k}function Ha(c,b,g,k,f){function E(a){var c=q[a];c&&(r[a]=c)}var d=c["static"],h=c.dynamic;a.optional(function(){function c(m){t(m).forEach(function(c){a.command(0<=
b.indexOf(c),'unknown parameter "'+c+'"',f.commandStr)})}var b="framebuffer vert frag elements primitive offset count instances profile vao".split(" ").concat(da);c(d);c(h)});var e=T(c,b),l=$b(c,f),q=$a(c,l,f),p=ja(c,f),r=ea(c,f),x=v(c,f,e);E("viewport");E(K("scissor.box"));var la=0<t(r).length,l={framebuffer:l,draw:p,shader:x,state:r,dirty:la,scopeVAO:null,drawVAO:null,useVAO:!1,attributes:{}};l.profile=L(c,f);l.uniforms=Ea(g,f);l.drawVAO=l.scopeVAO=p.vao;if(!l.drawVAO&&x.program&&!e&&D.angle_instanced_arrays&&
p["static"].elements){var u=!0;c=x.program.attributes.map(function(a){a=b["static"][a];u=u&&!!a;return a});if(u&&0<c.length){var y=A.getVAO(A.createVAO({attributes:c,elements:p["static"].elements}));l.drawVAO=new n(null,null,null,function(a,c){return a.link(y)});l.useVAO=!0}}e?l.useVAO=!0:l.attributes=Oa(b,f);l.context=S(k,f);return l}function aa(a,c,b){var g=a.shared.context,k=a.scope();t(b).forEach(function(f){c.save(g,"."+f);var E=b[f].append(a,c);Array.isArray(E)?k(g,".",f,"=[",E.join(),"];"):
...
E[c],");")["else"](k,".disable(",E[c],");"),h,".",c,"=",m,";"):q(k,".",za[c],"(",m,");",h,".",c,"=",m,";")}});0===t(b.state).length&&l(h,".dirty=false;");c(l)}function qa(a,c,b,g){var k=a.shared,f=a.current,d=k.current,h=k.gl;r(t(b)).forEach(function(k){var e=b[k];if(!g||g(e)){var l=e.append(a,c);if(E[k]){var q=E[k];I(e)?l?c(h,".enable(",q,");"):c(h,".disable(",q,");"):c(a.cond(l).then(h,".enable(",q,");")["else"](h,".disable(",q,");"));c(d,".",k,"=",l,";")}else if(w(l)){var t=f[k];c(h,".",za[k],
"(",l,");",l.map(function(a,c){return t+"["+c+"]="+a}).join(";"),";")}else c(h,".",za[k],"(",l,");",d,".",k,"=",l,";")}})}function ec(a,c){R&&(a.instancing=c.def(a.shared.extensions,".angle_instanced_arrays"))}function pc(a,c,b,g,k){function f(){return"undefined"===typeof performance?"Date.now()":"performance.now()"}function E(a){p=c.def();a(p,"=",f(),";");"string"===typeof k?a(l,".count+=",k,";"):a(l,".count++;");Na&&(g?(r=c.def(),a(r,"=",t,".getNumPendingQueries();")):a(t,".beginQuery(",l,");"))}
function d(a){a(l,".cpuTime+=",f(),"-",p,";");Na&&(g?a(t,".pushScopeStats(",r,",",t,".getNumPendingQueries(),",l,");"):a(t,".endQuery();"))}function h(a){var b=c.def(q,".profile");c(q,".profile=",a,";");c.exit(q,".profile=",b,";")}var e=a.shared,l=a.stats,q=e.current,t=e.timer;b=b.profile;var p,r;if(b){if(I(b)){b.enable?(E(c),d(c.exit),h("true")):h("false");return}b=b.append(a,c);h(b)}else b=c.def(q,".profile");e=a.block();E(e);c("if(",b,"){",e,"}");a=a.block();d(a);c.exit("if(",b,"){",a,"}")}function lc(c,
b,g,k,f){function E(a){switch(a){case 35664:case 35667:case 35671:return 2;case 35665:case 35668:case 35672:return 3;case 35666:case 35669:case 35673:return 4;default:return 1}}function d(a,g,k){function f(){b("if(!",q,".buffer){",e,".enableVertexAttribArray(",l,");}");var a=k.type,E;E=k.size?b.def(k.size,"||",g):g;b("if(",q,".type!==",a,"||",q,".size!==",E,"||",r.map(function(a){return q+"."+a+"!=="+k[a]}).join("||"),"){",e,".bindBuffer(",34962,",",t,".buffer);",e,".vertexAttribPointer(",[l,E,a,
k.normalized,k.stride,k.offset],");",q,".type=",a,";",q,".size=",E,";",r.map(function(a){return q+"."+a+"="+k[a]+";"}).join(""),"}");R&&(a=k.divisor,b("if(",q,".divisor!==",a,"){",c.instancing,".vertexAttribDivisorANGLE(",[l,a],");",q,".divisor=",a,";}"))}function E(){b("if(",q,".buffer){",e,".disableVertexAttribArray(",l,");",q,".buffer=null;","}if(",J.map(function(a,c){return q+"."+a+"!=="+p[c]}).join("||"),"){",e,".vertexAttrib4f(",l,",",p,");",J.map(function(a,c){return q+"."+a+"="+p[c]+";"}).join(""),
"}")}var e=h.gl,l=b.def(a,".location"),q=b.def(h.attributes,"[",l,"]");a=k.state;var t=k.buffer,p=[k.x,k.y,k.z,k.w],r=["buffer","normalized","offset","stride"];1===a?f():2===a?E():(b("if(",a,"===",1,"){"),f(),b("}else{"),E(),b("}"))}var h=c.shared;k.forEach(function(k){var h=k.name,e=g.attributes[h],l;if(e){if(!f(e))return;l=e.append(c,b)}else{if(!f(V))return;var q=c.scopeAttrib(h);a.optional(function(){c.assert(b,q+".state","missing attribute "+h)});l={};t(new ia).forEach(function(a){l[a]=b.def(q,
".",a)})}d(c.link(k),E(k.info.type),l)})}function ud(c,b,g,k,f,E){for(var d=c.shared,h=d.gl,l,e=0;e<k.length;++e){var t=k[e],p=t.name,r=t.info.type,x=g.uniforms[p],t=c.link(t)+".location",v;if(x){if(!f(x))continue;if(I(x)){var la=x.value;a.command(null!==la&&"undefined"!==typeof la,'missing uniform "'+p+'"',c.commandStr);if(35678===r||35680===r)a.command("function"===typeof la&&(35678===r&&("texture2d"===la._reglType||"framebuffer"===la._reglType)||35680===r&&("textureCube"===la._reglType||"framebufferCube"===
la._reglType)),"invalid texture for uniform "+p,c.commandStr),x=c.link(la._texture||la.color[0]._texture),b(h,".uniform1i(",t,",",x+".bind());"),b.exit(x,".unbind();");else if(35674===r||35675===r||35676===r){a.optional(function(){a.command(w(la),"invalid matrix for uniform "+p,c.commandStr);a.command(35674===r&&4===la.length||35675===r&&9===la.length||35676===r&&16===la.length,"invalid length for matrix uniform "+p,c.commandStr)});var x=c.global.def("new Float32Array(["+Array.prototype.slice.call(la)+
"])"),u=2;35675===r?u=3:35676===r&&(u=4);b(h,".uniformMatrix",u,"fv(",t,",false,",x,");")}else{switch(r){case 5126:a.commandType(la,"number","uniform "+p,c.commandStr);l="1f";break;case 35664:a.command(w(la)&&2===la.length,"uniform "+p,c.commandStr);l="2f";break;case 35665:a.command(w(la)&&3===la.length,"uniform "+p,c.commandStr);l="3f";break;case 35666:a.command(w(la)&&4===la.length,"uniform "+p,c.commandStr);l="4f";break;case 35670:a.commandType(la,"boolean","uniform "+p,c.commandStr);l="1i";break;
...
4===la.length,"uniform "+p,c.commandStr),l="4i"}b(h,".uniform",l,"(",t,",",w(la)?Array.prototype.slice.call(la):la,");")}continue}else v=x.append(c,b)}else{if(!f(V))continue;v=b.def(d.uniforms,"[",q.id(p),"]")}35678===r?(a(!Array.isArray(v),"must specify a scalar prop for textures"),b("if(",v,"&&",v,'._reglType==="framebuffer"){',v,"=",v,".color[0];","}")):35680===r&&(a(!Array.isArray(v),"must specify a scalar prop for cube maps"),b("if(",v,"&&",v,'._reglType==="framebufferCube"){',v,"=",v,".color[0];",
...
v+'._reglType==="texture'+(3553===b?"2d":"Cube")+'"',"invalid texture type",c.commandStr)}switch(r){case 5124:k("number");break;case 35667:f(2,"number");break;case 35668:f(3,"number");break;case 35669:f(4,"number");break;case 5126:k("number");break;case 35664:f(2,"number");break;case 35665:f(3,"number");break;case 35666:f(4,"number");break;case 35670:k("boolean");break;case 35671:f(2,"boolean");break;case 35672:f(3,"boolean");break;case 35673:f(4,"boolean");break;case 35674:f(4,"number");break;case 35675:f(9,
"number");break;case 35676:f(16,"number");break;case 35678:E(3553);break;case 35680:E(34067)}});x=1;switch(r){case 35678:case 35680:x=b.def(v,"._texture");b(h,".uniform1i(",t,",",x,".bind());");b.exit(x,".unbind();");continue;case 5124:case 35670:l="1i";break;case 35667:case 35671:l="2i";x=2;break;case 35668:case 35672:l="3i";x=3;break;case 35669:case 35673:l="4i";x=4;break;case 5126:l="1f";break;case 35664:l="2f";x=2;break;case 35665:l="3f";x=3;break;case 35666:l="4f";x=4;break;case 35674:l="Matrix2fv";
break;case 35675:l="Matrix3fv";break;case 35676:l="Matrix4fv"}if("M"===l.charAt(0)){b(h,".uniform",l,"(",t,",");var t=Math.pow(r-35674+2,2),y=c.global.def("new Float32Array(",t,")");Array.isArray(v)?b("false,(",Q(t,function(a){return y+"["+a+"]="+v[a]}),",",y,")"):b("false,(Array.isArray(",v,")||",v," instanceof Float32Array)?",v,":(",Q(t,function(a){return y+"["+a+"]="+v+"["+a+"]"}),",",y,")");b(");")}else{if(1<x){for(var u=[],P=[],za=0;za<x;++za)Array.isArray(v)?P.push(v[za]):P.push(b.def(v+"["+
za+"]")),E&&u.push(b.def());E&&b("if(!",c.batchId,"||",u.map(function(a,c){return a+"!=="+P[c]}).join("||"),"){",u.map(function(a,c){return a+"="+P[c]+";"}).join(""));b(h,".uniform",l,"(",t,",",P.join(","),");")}else a(!Array.isArray(v),"uniform value must not be an array"),E&&(x=b.def(),b("if(!",c.batchId,"||",x,"!==",v,"){",x,"=",v,";")),b(h,".uniform",l,"(",t,",",v,");");E&&b("}")}}}function wc(c,b,g,k){function f(a){var E=q[a];return E?E.contextDep&&k.contextDynamic||E.propDep?E.append(c,g):E.append(c,
b):b.def(e,".",a)}function E(){function a(){g(x,".drawElementsInstancedANGLE(",[p,r,u,v+"<<(("+u+"-5121)>>1)",la],");")}function c(){g(x,".drawArraysInstancedANGLE(",[p,v,r,la],");")}t&&"null"!==t?y?a():(g("if(",t,"){"),a(),g("}else{"),c(),g("}")):c()}function d(){function a(){g(l+".drawElements("+[p,r,u,v+"<<(("+u+"-5121)>>1)"]+");")}function c(){g(l+".drawArrays("+[p,v,r]+");")}t&&"null"!==t?y?a():(g("if(",t,"){"),a(),g("}else{"),c(),g("}")):c()}var h=c.shared,l=h.gl,e=h.draw,q=k.draw,t=function(){var a=
q.elements,f=b;if(a){if(a.contextDep&&k.contextDynamic||a.propDep)f=g;a=a.append(c,f);q.elementsActive&&f("if("+a+")"+l+".bindBuffer(34963,"+a+".buffer.buffer);")}else a=f.def(),f(a,"=",e,".","elements",";","if(",a,"){",l,".bindBuffer(",34963,",",a,".buffer.buffer);}","else if(",h.vao,".currentVAO){",a,"=",c.shared.elements+".getElements("+h.vao,".currentVAO.elements);",ra?"":"if("+a+")"+l+".bindBuffer(34963,"+a+".buffer.buffer);","}");return a}(),p=f("primitive"),v=f("offset"),r=function(){var f=
q.count,E,d=b;if(f){if(f.contextDep&&k.contextDynamic||f.propDep)d=g;E=f.append(c,d);a.optional(function(){f.MISSING&&c.assert(b,"false","missing vertex count");f.DYNAMIC&&c.assert(d,E+">=0","missing vertex count")})}else E=d.def(e,".","count"),a.optional(function(){c.assert(d,E+">=0","missing vertex count")});return E}();if("number"===typeof r){if(0===r)return}else g("if(",r,"){"),g.exit("}");var la,x;R&&(la=f("instances"),x=c.instancing);var u=t+".type",y=q.elements&&I(q.elements)&&!q.vaoActive;
...
var k=!1,f=!0;t(c.context).forEach(function(a){k=k||c.context[a].propDep});k||(aa(a,g,c.context),f=!1);var E=c.framebuffer,d=!1;E?(E.propDep?k=d=!0:E.contextDep&&k&&(d=!0),d||ib(a,g,E)):ib(a,g,null);c.state.viewport&&c.state.viewport.propDep&&(k=!0);ga(a,g,c);qa(a,g,c.state,function(a){return!b(a)});c.profile&&b(c.profile)||pc(a,g,c,!1,"a1");c.contextDep=k;c.needsContext=f;c.needsFramebuffer=d;f=c.shader.progVar;if(f.contextDep&&k||f.propDep)Gb(a,g,c,null);else if(f=f.append(a,g),g(a.shared.gl,".useProgram(",
f,".program);"),c.shader.program)Gb(a,g,c,c.shader.program);else{g(a.shared.vao,".setVAO(null);");var E=a.global.def("{}"),d=g.def(f,".id"),h=g.def(E,"[",d,"]");g(a.cond(h).then(h,".call(this,a0,a1);")["else"](h,"=",E,"[",d,"]=",a.link(function(b){return ca(Gb,a,c,b,2)}),"(",f,");",h,".call(this,a0,a1);"))}0<t(c.state).length&&g(a.shared.current,".dirty=true;");a.shared.vao&&g(a.shared.vao,".setVAO(null);")}function Wc(a,c){function b(f){var E=c.shader[f];E&&g.set(k.shader,"."+f,E.append(a,g))}var g=
a.proc("scope",3);a.batchId="a2";var k=a.shared,f=k.current;aa(a,g,c.context);c.framebuffer&&c.framebuffer.append(a,g);r(t(c.state)).forEach(function(b){var f=c.state[b].append(a,g);w(f)?f.forEach(function(c,k){g.set(a.next[b],"["+k+"]",c)}):g.set(k.next,"."+b,f)});pc(a,g,c,!0,!0);["elements","offset","count","instances","primitive"].forEach(function(b){var f=c.draw[b];f&&g.set(k.draw,"."+b,""+f.append(a,g))});t(c.uniforms).forEach(function(b){var f=c.uniforms[b].append(a,g);Array.isArray(f)&&(f=
"["+f.join()+"]");g.set(k.uniforms,"["+q.id(b)+"]",f)});t(c.attributes).forEach(function(b){var k=c.attributes[b].append(a,g),f=a.scopeAttrib(b);t(new ia).forEach(function(a){g.set(f,"."+a,k[a])})});c.scopeVAO&&g.set(k.vao,".targetVAO",c.scopeVAO.append(a,g));b("vert");b("frag");0<t(c.state).length&&(g(f,".dirty=true;"),g.exit(f,".dirty=true;"));g("a1(",a.shared.context,",a0,",a.batchId,");")}function F(a){if("object"===typeof a&&!w(a)){for(var c=t(a),b=0;b<c.length;++b)if(C.isDynamic(a[c[b]]))return!0;
return!1}}function y(a,c,g){function k(a,c){d.forEach(function(b){var g=f[b];C.isDynamic(g)&&(g=a.invoke(c,g),c(q,".",b,"=",g,";"))})}var f=c["static"][g];if(f&&F(f)){var E=a.global,d=t(f),h=!1,l=!1,e=!1,q=a.global.def("{}");d.forEach(function(c){var g=f[c];if(C.isDynamic(g))"function"===typeof g&&(g=f[c]=C.unbox(g)),c=b(g,null),h=h||c.thisDep,e=e||c.propDep,l=l||c.contextDep;else{E(q,".",c,"=");switch(typeof g){case "number":E(g);break;case "string":E('"',g,'"');break;case "object":Array.isArray(g)&&
...
draw:Cb,elements:c,buffer:Y,shader:xb,attributes:A.state,vao:A,uniforms:oa,framebuffer:ba,extensions:D,timer:Na,isBufferArgs:e},k={primTypes:B,compareFuncs:p,blendFuncs:W,blendEquations:va,stencilOps:h,glTypes:z,orientationType:l};a.optional(function(){la.isArrayLike=w});ha&&(k.backBuffer=[1029],k.drawBuffer=Q(O.maxDrawbuffers,function(a){return 0===a?[0]:Q(a,function(a){return 36064+a})}));var kc=0;return{next:x,current:H,procs:function(){var a=sa(),c=a.proc("poll"),b=a.proc("refresh"),g=a.block();
...
".disableVertexAttribArray(",e,");",f,".vertexAttrib4f(",e,",",q,".x,",q,".y,",q,".z,",q,".w);",q,".buffer=null;");b(p);R&&b(l,".vertexAttribDivisorANGLE(",e,",",q,".divisor);")}b(a.shared.vao,".currentVAO=null;",a.shared.vao,".setVAO(",a.shared.vao,".targetVAO);");t(E).forEach(function(k){var l=E[k],e=g.def(d,".",k),q=a.block();q("if(",e,"){",f,".enable(",l,")}else{",f,".disable(",l,")}",h,".",k,"=",e,";");b(q);c("if(",e,"!==",h,".",k,"){",q,"}")});t(za).forEach(function(k){var E=za[k],l=H[k],e,
q,t=a.block();t(f,".",E,"(");w(l)?(E=l.length,e=a.global.def(d,".",k),q=a.global.def(h,".",k),t(Q(E,function(a){return e+"["+a+"]"}),");",Q(E,function(a){return q+"["+a+"]="+e+"["+a+"];"}).join("")),c("if(",Q(E,function(a){return e+"["+a+"]!=="+q+"["+a+"]"}).join("||"),"){",t,"}")):(e=g.def(d,".",k),q=g.def(h,".",k),t(e,");",h,".",k,"=",e,";"),c("if(",e,"!==",q,"){",t,"}"));b(t)});return a.compile()}(),compile:function(a,c,b,g,k){var f=sa();f.stats=f.link(k);t(c["static"]).forEach(function(a){y(f,
c,a)});P.forEach(function(c){y(f,a,c)});var E=Ha(a,c,b,g,f);ka(f,E);Wc(f,E);Jc(f,E);return u(f.compile(),{destroy:function(){E.shader.program.destroy()}})}}}},{"./constants/dtypes.json":6,"./constants/primitives.json":7,"./dynamic":10,"./util/check":22,"./util/codegen":24,"./util/extend":26,"./util/is-array-like":28,"./util/is-ndarray":29,"./util/is-typed-array":31,"./util/loop":32,"./util/sorted-object-keys":35}],10:[function(A,S,Ka){function e(f,a){this.id=b++;this.type=f;this.data=a}function r(b){if(0===
b.length)return[];var a=b.charAt(0),f=b.charAt(b.length-1);if(1<b.length&&a===f&&('"'===a||"'"===a))return['"'+b.substr(1,b.length-2).replace(/\\/g,"\\\\").replace(/"/g,'\\"')+'"'];if(a=/\[(false|true|null|\d+|'[^']*'|"[^"]*")\]/.exec(b))return r(b.substr(0,a.index)).concat(r(a[1])).concat(r(b.substr(a.index+a[0].length)));a=b.split(".");if(1===a.length)return['"'+b.replace(/\\/g,"\\\\").replace(/"/g,'\\"')+'"'];b=[];for(f=0;f<a.length;++f)b=b.concat(r(a[f]));return b}function n(b){return"["+r(b).join("][")+
...
11:[function(A,S,Ka){var e=A("./util/check"),r=A("./util/is-typed-array"),n=A("./util/is-ndarray"),I=A("./util/values"),f=A("./constants/primitives.json"),b=A("./constants/usage.json");S.exports=function(t,a,u,ma){function Q(a){this.id=C++;w[this.id]=this;this.buffer=a;this.primType=4;this.type=this.vertCount=0}function G(b,f,w,z,p,h,g){b.buffer.bind();var l;f?((l=g)||r(f)&&(!n(f)||r(f.data))||(l=a.oes_element_index_uint?5125:5123),u._initBuffer(b.buffer,f,w,l,3)):(t.bufferData(34963,h,w),b.buffer.dtype=
l||5121,b.buffer.usage=w,b.buffer.dimension=3,b.buffer.byteLength=h);l=g;if(!g){switch(b.buffer.dtype){case 5121:case 5120:l=5121;break;case 5123:case 5122:l=5123;break;case 5125:case 5124:l=5125;break;default:e.raise("unsupported type for element array")}b.buffer.dtype=l}b.type=l;e(5125!==l||!!a.oes_element_index_uint,"32 bit element buffers not supported, enable oes_element_index_uint first");f=p;0>f&&(f=b.buffer.byteLength,5123===l?f>>=1:5125===l&&(f>>=2));b.vertCount=f;f=z;0>z&&(f=4,z=b.buffer.dimension,
1===z&&(f=0),2===z&&(f=1),3===z&&(f=4));b.primType=f}function D(a){ma.elementsCount--;e(null!==a.buffer,"must not double destroy elements");delete w[a.id];a.buffer.destroy();a.buffer=null}var w={},C=0,B={uint8:5121,uint16:5123};a.oes_element_index_uint&&(B.uint32=5125);Q.prototype.bind=function(){this.buffer.bind()};var z=[];return{create:function(a,t){function w(a){if(a)if("number"===typeof a)z(a),p.primType=4,p.vertCount=a|0,p.type=5121;else{var g=null,l=35044,t=-1,u=-1,q=0,P=0;if(Array.isArray(a)||
r(a)||n(a))g=a;else if(e.type(a,"object","invalid arguments for elements"),"data"in a&&(g=a.data,e(Array.isArray(g)||r(g)||n(g),"invalid data for element buffer")),"usage"in a&&(e.parameter(a.usage,b,"invalid element buffer usage"),l=b[a.usage]),"primitive"in a&&(e.parameter(a.primitive,f,"invalid element buffer primitive"),t=f[a.primitive]),"count"in a&&(e("number"===typeof a.count&&0<=a.count,"invalid vertex count for elements"),u=a.count|0),"type"in a&&(e.parameter(a.type,B,"invalid buffer type"),
P=B[a.type]),"length"in a)q=a.length|0;else if(q=u,5123===P||5122===P)q*=2;else if(5125===P||5124===P)q*=4;G(p,g,l,t,u,q,P)}else z(),p.primType=4,p.vertCount=0,p.type=5121;return w}var z=u.create(null,34963,!0),p=new Q(z._buffer);ma.elementsCount++;w(a);w._reglType="elements";w._elements=p;w.subdata=function(a,b){z.subdata(a,b);return w};w.destroy=function(){D(p)};return w},createStream:function(a){var b=z.pop();b||(b=new Q(u.create(null,34963,!0,!1)._buffer));G(b,a,35040,-1,-1,0,0);return b},destroyStream:function(a){z.push(a)},
getElements:function(a){return"function"===typeof a&&a._elements instanceof Q?a._elements:null},clear:function(){I(w).forEach(D)}}}},{"./constants/primitives.json":7,"./constants/usage.json":8,"./util/check":22,"./util/is-ndarray":29,"./util/is-typed-array":31,"./util/values":37}],12:[function(A,S,Ka){var e=A("./util/sorted-object-keys"),r=A("./util/check");S.exports=function(n,I){function f(a){r.type(a,"string","extension name must be string");a=a.toLowerCase();var f;try{f=b[a]=n.getExtension(a)}catch(e){}return!!f}
for(var b={},t=0;t<I.extensions.length;++t){var a=I.extensions[t];if(!f(a))return I.onDestroy(),I.onDone('"'+a+'" extension is not supported by the current WebGL context, try upgrading your system or a different browser'),null}I.optionalExtensions.forEach(f);return{extensions:b,restore:function(){e(b).forEach(function(a){if(b[a]&&!f(a))throw Error("(regl): error restoring extension "+a);})}}}},{"./util/check":22,"./util/sorted-object-keys":35}],13:[function(A,S,Ka){var e=A("./util/check"),r=A("./util/values"),
n=A("./util/extend"),I=[6407,6408],f=[];f[6408]=4;f[6407]=3;var b=[];b[5121]=1;b[5126]=4;b[36193]=2;var t=[32854,32855,36194,35907,34842,34843,34836],a={36053:"complete",36054:"incomplete attachment",36057:"incomplete dimensions",36055:"incomplete, missing attachment",36061:"unsupported"};S.exports=function(u,ma,Q,G,D,w){function C(a,c,b){this.target=a;this.texture=c;this.renderbuffer=b;var g=a=0;c?(a=c.width,g=c.height):b&&(a=b.width,g=b.height);this.width=a;this.height=g}function B(a){a&&(a.texture&&
...
a._texture.refCount=0,new C(3553,a,null);a=D.create({width:a,height:c,format:g});a._renderbuffer.refCount=0;return new C(36161,null,a)}function A(a){return a&&(a.texture||a.renderbuffer)}function p(a,c,b){a&&(a.texture?a.texture.resize(c,b):a.renderbuffer&&a.renderbuffer.resize(c,b),a.width=c,a.height=b)}function h(){this.id=c++;d[this.id]=this;this.framebuffer=u.createFramebuffer();this.height=this.width=0;this.colorAttachments=[];this.depthStencilAttachment=this.stencilAttachment=this.depthAttachment=
...
33306,3553,null,0);u.framebufferTexture2D(36160,36096,3553,null,0);u.framebufferTexture2D(36160,36128,3553,null,0);J(36096,c.depthAttachment);J(36128,c.stencilAttachment);J(33306,c.depthStencilAttachment);c=u.checkFramebufferStatus(36160);u.isContextLost()||36053===c||e.raise("framebuffer configuration not supported, status = "+a[c]);u.bindFramebuffer(36160,q.next?q.next.framebuffer:null);q.cur=q.next;u.getError()}function X(a,c){function d(a,c){var l;e(q.next!==r,"can not update framebuffer which is currently in use");
var h=0,p=0,u=!0,w=!0;l=null;var n=!0,B="rgba",G="uint8",D=1,C=null,v=null,ba=null,J=!1;if("number"===typeof a)h=a|0,p=c|0||h;else if(a){e.type(a,"object","invalid arguments for framebuffer");"shape"in a?(p=a.shape,e(Array.isArray(p)&&2<=p.length,"invalid shape for framebuffer"),h=p[0],p=p[1]):("radius"in a&&(h=p=a.radius),"width"in a&&(h=a.width),"height"in a&&(p=a.height));if("color"in a||"colors"in a)l=a.color||a.colors,Array.isArray(l)&&e(1===l.length||ma.webgl_draw_buffers,"multiple render targets not supported");
...
var X=null,oa=null,S=null,Ha=null;if(Array.isArray(l))X=l.map(P);else if(l)X=[P(l)];else for(X=Array(D),l=0;l<D;++l)X[l]=W(h,p,n,B,G);e(ma.webgl_draw_buffers||1>=X.length,"you must enable the WEBGL_draw_buffers extension in order to use multiple color buffers.");e(X.length<=Q.maxColorAttachments,"too many color attachments, not supported");h=h||X[0].width;p=p||X[0].height;C?oa=P(C):u&&!w&&(oa=W(h,p,J,"depth","uint32"));v?S=P(v):w&&!u&&(S=W(h,p,!1,"stencil","uint8"));ba?Ha=P(ba):!C&&!v&&w&&u&&(Ha=
W(h,p,J,"depth stencil","depth stencil"));e(1>=!!C+!!v+!!ba,"invalid framebuffer configuration, can specify exactly one depth/stencil attachment");u=null;for(l=0;l<X.length;++l)z(X[l],h,p),e(!X[l]||X[l].texture&&0<=I.indexOf(X[l].texture._texture.format)||X[l].renderbuffer&&0<=t.indexOf(X[l].renderbuffer._renderbuffer.format),"framebuffer color attachment "+l+" is invalid"),X[l]&&X[l].texture&&(w=f[X[l].texture._texture.format]*b[X[l].texture._texture.type],null===u?u=w:e(u===w,"all color attachments much have the same number of bits per pixel."));
z(oa,h,p);e(!oa||oa.texture&&6402===oa.texture._texture.format||oa.renderbuffer&&33189===oa.renderbuffer._renderbuffer.format,"invalid depth attachment for framebuffer object");z(S,h,p);e(!S||S.renderbuffer&&36168===S.renderbuffer._renderbuffer.format,"invalid stencil attachment for framebuffer object");z(Ha,h,p);e(!Ha||Ha.texture&&34041===Ha.texture._texture.format||Ha.renderbuffer&&34041===Ha.renderbuffer._renderbuffer.format,"invalid depth-stencil attachment for framebuffer object");g(r);r.width=
h;r.height=p;r.colorAttachments=X;r.depthAttachment=oa;r.stencilAttachment=S;r.depthStencilAttachment=Ha;d.color=X.map(A);d.depth=A(oa);d.stencil=A(S);d.depthStencil=A(Ha);d.width=r.width;d.height=r.height;V(r);return d}var r=new h;w.framebufferCount++;d(a,c);return n(d,{resize:function(a,c){e(q.next!==r,"can not resize a framebuffer which is currently in use");var b=Math.max(a|0,1),g=Math.max(c|0||b,1);if(b===r.width&&g===r.height)return d;for(var f=r.colorAttachments,l=0;l<f.length;++l)p(f[l],b,
g);p(r.depthAttachment,b,g);p(r.stencilAttachment,b,g);p(r.depthStencilAttachment,b,g);r.width=d.width=b;r.height=d.height=g;V(r);return d},_reglType:"framebuffer",_framebuffer:r,destroy:function(){l(r);g(r)},use:function(a){q.setFBO({framebuffer:d},a)}})}var q={cur:null,next:null,dirty:!1,setFBO:null},pa=["rgba"],O=["rgba4","rgb565","rgb5 a1"];ma.ext_srgb&&O.push("srgba");ma.ext_color_buffer_half_float&&O.push("rgba16f","rgb16f");ma.webgl_color_buffer_float&&O.push("rgba32f");var Y=["uint8"];ma.oes_texture_half_float&&
...
if(g===c.width)return c;var f=c.color;for(a=0;a<f.length;++a)f[a].resize(g);for(a=0;6>a;++a)b[a].resize(g);c.width=c.height=g;return c},_reglType:"framebufferCube",destroy:function(){b.forEach(function(a){a.destroy()})}})},clear:function(){r(d).forEach(l)},restore:function(){q.cur=null;q.next=null;q.dirty=!0;r(d).forEach(function(a){a.framebuffer=u.createFramebuffer();V(a)})}})}},{"./util/check":22,"./util/extend":26,"./util/values":37}],14:[function(A,S,Ka){var e=A("./util/sorted-object-keys"),r=
A("./util/pool");S.exports=function(n,I){var f=1;I.ext_texture_filter_anisotropic&&(f=n.getParameter(34047));var b=1,t=1;I.webgl_draw_buffers&&(b=n.getParameter(34852),t=n.getParameter(36063));var a=!!I.oes_texture_float;if(a){a=n.createTexture();n.bindTexture(3553,a);n.texImage2D(3553,0,6408,1,1,0,6408,5126,null);var u=n.createFramebuffer();n.bindFramebuffer(36160,u);n.framebufferTexture2D(36160,36064,3553,a,0);n.bindTexture(3553,null);if(36053!==n.checkFramebufferStatus(36160))a=!1;else{n.viewport(0,
0,1,1);n.clearColor(1,0,0,1);n.clear(16384);var ma=r.allocType(5126,4);n.readPixels(0,0,1,1,6408,5126,ma);n.getError()?a=!1:(n.deleteFramebuffer(u),n.deleteTexture(a),a=1===ma[0]);r.freeType(ma)}}ma=!0;"undefined"!==typeof navigator&&(/MSIE/.test(navigator.userAgent)||/Trident\//.test(navigator.appVersion)||/Edge/.test(navigator.userAgent))||(ma=n.createTexture(),u=r.allocType(5121,36),n.activeTexture(33984),n.bindTexture(34067,ma),n.texImage2D(34069,0,6408,3,3,0,6408,5121,u),r.freeType(u),n.bindTexture(34067,
null),n.deleteTexture(ma),ma=!n.getError());return{colorBits:[n.getParameter(3410),n.getParameter(3411),n.getParameter(3412),n.getParameter(3413)],depthBits:n.getParameter(3414),stencilBits:n.getParameter(3415),subpixelBits:n.getParameter(3408),extensions:e(I).filter(function(a){return!!I[a]}),maxAnisotropic:f,maxDrawbuffers:b,maxColorAttachments:t,pointSizeDims:n.getParameter(33901),lineWidthDims:n.getParameter(33902),maxViewportDims:n.getParameter(3386),maxCombinedTextureUnits:n.getParameter(35661),
...
{"./util/pool":33,"./util/sorted-object-keys":35}],15:[function(A,S,Ka){var e=A("./util/check"),r=A("./util/is-typed-array");S.exports=function(n,I,f,b,t,a,u){function ma(G){var D;null===I.next?(e(t.preserveDrawingBuffer,'you must create a webgl context with "preserveDrawingBuffer":true in order to read pixels from the drawing buffer'),D=5121):(e(null!==I.next.colorAttachments[0].texture,"You cannot read from a renderbuffer"),D=I.next.colorAttachments[0].texture._texture.type,e.optional(function(){a.oes_texture_float?
(e(5121===D||5126===D,"Reading from a framebuffer is only allowed for the types 'uint8' and 'float'"),5126===D&&e(u.readFloat,"Reading 'float' values is not permitted in your browser. For a fallback, please see: https://www.npmjs.com/package/glsl-read-float")):e(5121===D,"Reading from a framebuffer is only allowed for the type 'uint8'")}));var w=0,C=0,B=b.framebufferWidth,z=b.framebufferHeight,Q=null;r(G)?Q=G:G&&(e.type(G,"object","invalid arguments to regl.read()"),w=G.x|0,C=G.y|0,e(0<=w&&w<b.framebufferWidth,
...
16:[function(A,S,Ka){var e=A("./util/sorted-object-keys"),r=A("./util/check"),n=A("./util/values"),I=[];I[32854]=2;I[32855]=2;I[36194]=2;I[33189]=2;I[36168]=1;I[34041]=4;I[35907]=4;I[34836]=16;I[34842]=8;I[34843]=6;S.exports=function(f,b,t,a,u){function ma(a){this.id=w++;this.refCount=1;this.renderbuffer=a;this.format=32854;this.height=this.width=0;u.profile&&(this.stats={size:0})}function Q(b){var e=b.renderbuffer;r(e,"must not double destroy renderbuffer");f.bindRenderbuffer(36161,null);f.deleteRenderbuffer(e);
...
C[b].stats.size});return a});return{create:function(b,e){function w(a,b){var e=0,h=0,g=32854;"object"===typeof a&&a?("shape"in a?(h=a.shape,r(Array.isArray(h)&&2<=h.length,"invalid renderbuffer shape"),e=h[0]|0,h=h[1]|0):("radius"in a&&(e=h=a.radius|0),"width"in a&&(e=a.width|0),"height"in a&&(h=a.height|0)),"format"in a&&(r.parameter(a.format,G,"invalid renderbuffer format"),g=G[a.format])):"number"===typeof a?(e=a|0,h="number"===typeof b?b|0:e):a?r.raise("invalid arguments to renderbuffer constructor"):
e=h=1;r(0<e&&0<h&&e<=t.maxRenderbufferSize&&h<=t.maxRenderbufferSize,"invalid renderbuffer size");if(e!==n.width||h!==n.height||g!==n.format)return w.width=n.width=e,w.height=n.height=h,n.format=g,f.bindRenderbuffer(36161,n.renderbuffer),f.renderbufferStorage(36161,g,e,h),r(0===f.getError(),"invalid render buffer format"),u.profile&&(n.stats.size=I[n.format]*n.width*n.height),w.format=D[n.format],w}var n=new ma(f.createRenderbuffer());C[n.id]=n;a.renderbufferCount++;w(b,e);w.resize=function(a,b){var e=
a|0,h=b|0||e;if(e===n.width&&h===n.height)return w;r(0<e&&0<h&&e<=t.maxRenderbufferSize&&h<=t.maxRenderbufferSize,"invalid renderbuffer size");w.width=n.width=e;w.height=n.height=h;f.bindRenderbuffer(36161,n.renderbuffer);f.renderbufferStorage(36161,n.format,e,h);r(0===f.getError(),"invalid render buffer format");u.profile&&(n.stats.size=I[n.format]*n.width*n.height);return w};w._reglType="renderbuffer";w._renderbuffer=n;u.profile&&(w.stats=n.stats);w.destroy=function(){n.decRef()};return w},clear:function(){n(C).forEach(Q)},
restore:function(){n(C).forEach(function(a){a.renderbuffer=f.createRenderbuffer();f.bindRenderbuffer(36161,a.renderbuffer);f.renderbufferStorage(36161,a.format,a.width,a.height)});f.bindRenderbuffer(36161,null)}}}},{"./util/check":22,"./util/sorted-object-keys":35,"./util/values":37}],17:[function(A,S,Ka){var e=A("./util/sorted-object-keys"),r=A("./util/check"),n=A("./util/extend"),I=A("./util/values");S.exports=function(f,b,t,a){function u(a,b,f,e){this.name=a;this.id=b;this.location=f;this.info=
e}function ma(a,b){for(var f=0;f<a.length;++f)if(a[f].id===b.id){a[f].location=b.location;return}a.push(b)}function Q(a,e,t){var p=35632===a?w:C,h=p[e];if(!h){var g=b.str(e),h=f.createShader(a);f.shaderSource(h,g);f.compileShader(h);r.shaderError(f,h,g,a,t);p[e]=h}return h}function G(b,f){this.id=J++;this.fragId=b;this.vertId=f;this.program=null;this.uniforms=[];this.attributes=[];this.refCount=1;a.profile&&(this.stats={uniformsCount:0,attributesCount:0})}function D(e,t,w){var p;p=Q(35632,e.fragId);
var h=Q(35633,e.vertId),g=e.program=f.createProgram();f.attachShader(g,p);f.attachShader(g,h);if(w)for(p=0;p<w.length;++p)h=w[p],f.bindAttribLocation(g,h[0],h[1]);f.linkProgram(g);r.linkError(f,g,b.str(e.fragId),b.str(e.vertId),t);w=f.getProgramParameter(g,35718);a.profile&&(e.stats.uniformsCount=w);h=e.uniforms;for(p=0;p<w;++p)if(t=f.getActiveUniform(g,p))if(1<t.size)for(var l=0;l<t.size;++l){var n=t.name.replace("[0]","["+l+"]");ma(h,new u(n,b.id(n),f.getUniformLocation(g,n),t))}else ma(h,new u(t.name,
b.id(t.name),f.getUniformLocation(g,t.name),t));w=f.getProgramParameter(g,35721);a.profile&&(e.stats.attributesCount=w);e=e.attributes;for(p=0;p<w;++p)(t=f.getActiveAttrib(g,p))&&ma(e,new u(t.name,b.id(t.name),f.getAttribLocation(g,t.name),t))}var w={},C={},B={},z=[],J=0;a.profile&&(t.getMaxUniformsCount=function(){var a=0;z.forEach(function(b){b.stats.uniformsCount>a&&(a=b.stats.uniformsCount)});return a},t.getMaxAttributesCount=function(){var a=0;z.forEach(function(b){b.stats.attributesCount>a&&
(a=b.stats.attributesCount)});return a});return{clear:function(){var a=f.deleteShader.bind(f);I(w).forEach(a);w={};I(C).forEach(a);C={};z.forEach(function(a){f.deleteProgram(a.program)});z.length=0;B={};t.shaderCount=0},program:function(a,b,u,p){r.command(0<=a,"missing vertex shader",u);r.command(0<=b,"missing fragment shader",u);var h=B[b];h||(h=B[b]={});var g=h[a];if(g&&(g.refCount++,!p))return g;var l=new G(b,a);t.shaderCount++;D(l,u,p);g||(h[a]=l);z.push(l);return n(l,{destroy:function(){l.refCount--;
if(0>=l.refCount){f.deleteProgram(l.program);var a=z.indexOf(l);z.splice(a,1);t.shaderCount--}0>=h[l.vertId].refCount&&(f.deleteShader(C[l.vertId]),delete C[l.vertId],delete B[l.fragId][l.vertId]);e(B[l.fragId]).length||(f.deleteShader(w[l.fragId]),delete w[l.fragId],delete B[l.fragId])}})},restore:function(){w={};C={};for(var a=0;a<z.length;++a)D(z[a],null,z[a].attributes.map(function(a){return[a.location,a.name]}))},shader:Q,frag:-1,vert:-1}}},{"./util/check":22,"./util/extend":26,"./util/sorted-object-keys":35,
"./util/values":37}],18:[function(A,S,Ka){S.exports=function(){return{vaoCount:0,bufferCount:0,elementsCount:0,framebufferCount:0,shaderCount:0,textureCount:0,cubeCount:0,renderbufferCount:0,maxTextureUnits:0}}},{}],19:[function(A,S,Ka){S.exports=function(){var e={"":0},r=[""];return{id:function(n){var I=e[n];if(I)return I;I=e[n]=r.length;r.push(n);return I},str:function(e){return r[e]}}}},{}],20:[function(A,S,Ka){function e(a){return"[object "+a+"]"}function r(a){return Array.isArray(a)&&(0===a.length||
"number"===typeof a[0])}function n(a){return Array.isArray(a)&&0!==a.length&&B(a[0])?!0:!1}function I(a){return Object.prototype.toString.call(a)}function f(a){if(!a)return!1;var b=I(a);return 0<=pa.indexOf(b)?!0:r(a)||n(a)||D(a)}function b(a,b){36193===a.type?(a.data=C(b),w.freeType(b)):a.data=b}function t(a,b,g,f,l,e){a="undefined"!==typeof Y[a]?Y[a]:p[a]*O[b];e&&(a*=6);if(l){for(f=0;1<=g;)f+=a*g*g,g/=2;return f}return a*g*f}var a=A("./util/sorted-object-keys"),u=A("./util/check"),ma=A("./util/extend"),
Q=A("./util/values"),G=A("./util/is-typed-array"),D=A("./util/is-ndarray"),w=A("./util/pool"),C=A("./util/to-half-float"),B=A("./util/is-array-like"),z=A("./util/flatten"),J=A("./util/is-pow2");Ka=A("./constants/arraytypes.json");var P=A("./constants/arraytypes.json"),W=[9984,9986,9985,9987],Qd=[0,6409,6410,6407,6408],p={};p[6409]=p[6406]=p[6402]=1;p[34041]=p[6410]=2;p[6407]=p[35904]=3;p[6408]=p[35906]=4;var h=e("HTMLCanvasElement"),g=e("OffscreenCanvas"),l=e("CanvasRenderingContext2D"),V=e("ImageBitmap"),
...
l|0;g=!1;"format"in b&&(g=b.format,u(d.webgl_depth_texture||!("depth"===g||"depth stencil"===g),"you must enable the WEBGL_depth_texture extension in order to use depth/stencil textures."),u.parameter(g,M,"invalid texture format"),f=a.internalformat=M[g],a.format=va[f],g in ca&&!("type"in b)&&(a.type=ca[g]),g in ka&&(a.compressed=!0),g=!0);!c&&g?a.channels=p[a.format]:c&&!g?a.channels!==Qd[a.format]&&(a.format=a.internalformat=Qd[a.channels]):g&&c&&u(a.channels===p[a.format],"number of channels inconsistent with specified format")}}
...
if(c.copy){u(!d,"can not specify copy and data field for the same texture");var k=A.viewportWidth,p=A.viewportHeight;a.width=a.width||k-a.xOffset;a.height=a.height||p-a.yOffset;a.needsCopy=!0;u(0<=a.xOffset&&a.xOffset<k&&0<=a.yOffset&&a.yOffset<p&&0<a.width&&a.width<=k&&0<a.height&&a.height<=p,"copy texture read out of bounds")}else if(!d)a.width=a.width||1,a.height=a.height||1,a.channels=a.channels||4;else if(G(d))a.channels=a.channels||4,a.data=d,"type"in c||5121!==a.type||(a.type=P[Object.prototype.toString.call(d)]|
0);else if(r(d)){a.channels=a.channels||4;k=d;p=k.length;switch(a.type){case 5121:case 5123:case 5125:case 5126:p=w.allocType(a.type,p);p.set(k);a.data=p;break;case 36193:a.data=C(k);break;default:u.raise("unsupported texture type, must specify a typed array")}a.alignment=1;a.needsFree=!0}else if(D(d)){k=d.data;Array.isArray(k)||5121!==a.type||(a.type=P[Object.prototype.toString.call(k)]|0);var p=d.shape,t=d.stride,m,v,x,y;3===p.length?(x=p[2],y=t[2]):(u(2===p.length,"invalid ndarray pixel data, must be 2 or 3D"),
y=x=1);m=p[0];v=p[1];p=t[0];t=t[1];a.alignment=1;a.width=m;a.height=v;a.channels=x;a.format=a.internalformat=Qd[x];a.needsFree=!0;m=y;d=d.offset;x=a.width;y=a.height;v=a.channels;for(var M=w.allocType(36193===a.type?5126:a.type,x*y*v),H=0,da=0;da<y;++da)for(var F=0;F<x;++F)for(var ca=0;ca<v;++ca)M[H++]=k[p*F+t*da+m*ca+d];b(a,M)}else if(I(d)===h||I(d)===g||I(d)===l)I(d)===h||I(d)===g?a.element=d:a.element=d.canvas,a.width=a.element.width,a.height=a.element.height,a.channels=4;else if(I(d)===V)a.element=
d,a.width=d.width,a.height=d.height,a.channels=4;else if(I(d)===X)a.element=d,a.width=d.naturalWidth,a.height=d.naturalHeight,a.channels=4;else if(I(d)===q)a.element=d,a.width=d.videoWidth,a.height=d.videoHeight,a.channels=4;else if(n(d)){k=a.width||d[0].length;p=a.height||d.length;t=a.channels;t=B(d[0][0])?t||d[0][0].length:t||1;m=z.shape(d);x=1;for(y=0;y<m.length;++y)x*=m[y];x=w.allocType(36193===a.type?5126:a.type,x);z.flatten(d,m,"",x);b(a,x);a.alignment=1;a.width=k;a.height=p;a.channels=t;a.format=
...
c+l.height<=f.height,"texture.subimage write out of bounds");u(f.mipmask&1<<d,"missing mipmap data");u(l.data||l.element||l.needsCopy,"missing image data");ib(f);sa(l,3553,b,c,d);ga();S(l);return g};g.resize=function(a,b){var d=a|0,l=b|0||d;if(d===f.width&&l===f.height)return g;g.width=f.width=d;g.height=f.height=l;ib(f);for(var e=0;f.mipmask>>e;++e){var h=d>>e,q=l>>e;if(!h||!q)break;c.texImage2D(3553,e,f.format,h,q,0,f.format,f.type,null)}ga();pa.profile&&(f.stats.size=t(f.internalformat,f.type,
...
ib(h);for(k=0;6>k;++k)ja(q[k],34069+k);Ha(l,34067);ga();pa.profile&&(h.stats.size=t(h.internalformat,h.type,m.width,m.height,l.genMipmaps,!0));m.format=Jc[h.internalformat];m.type=Wc[h.type];m.mag=F[l.magFilter];m.min=y[l.minFilter];m.wrapS=ia[l.wrapS];m.wrapT=ia[l.wrapT];for(k=0;6>k;++k)Ea(q[k]);return m}var h=new aa(34067);H[h.id]=h;Y.cubeCount++;var q=Array(6);m(a,b,g,f,d,l);m.subimage=function(a,b,c,g,f){u(!!b,"must specify image data");u("number"===typeof a&&a===(a|0)&&0<=a&&6>a,"invalid face");
...
0;if(a!==h.width){m.width=h.width=a;m.height=h.height=a;ib(h);for(var b=0;6>b;++b)for(var g=0;h.mipmask>>g;++g)c.texImage2D(34069+b,g,h.format,a>>g,a>>g,0,h.format,h.type,null);ga();pa.profile&&(h.stats.size=t(h.internalformat,h.type,m.width,m.height,!1,!0));return m}};m._reglType="textureCube";m._texture=h;pa.profile&&(m.stats=h.stats);m.destroy=function(){h.decRef()};return m},clear:function(){for(var a=0;a<x;++a)c.activeTexture(33984+a),c.bindTexture(3553,null),da[a]=null;Q(H).forEach(qa);Y.cubeCount=
...
S,Ka){S.exports=function(e,r){function n(){this.endQueryIndex=this.startQueryIndex=-1;this.sum=0;this.stats=null}function I(b,f,e){var r=t.pop()||new n;r.startQueryIndex=b;r.endQueryIndex=f;r.sum=0;r.stats=e;a.push(r)}if(!r.ext_disjoint_timer_query)return null;var f=[],b=[],t=[],a=[],u=[],ma=[];return{beginQuery:function(a){var e=f.pop()||r.ext_disjoint_timer_query.createQueryEXT();r.ext_disjoint_timer_query.beginQueryEXT(35007,e);b.push(e);I(b.length-1,b.length,a)},endQuery:function(){r.ext_disjoint_timer_query.endQueryEXT(35007)},
pushScopeStats:I,update:function(){var e,n;e=b.length;if(0!==e){ma.length=Math.max(ma.length,e+1);u.length=Math.max(u.length,e+1);u[0]=0;var D=ma[0]=0;for(n=e=0;n<b.length;++n){var w=b[n];r.ext_disjoint_timer_query.getQueryObjectEXT(w,34919)?(D+=r.ext_disjoint_timer_query.getQueryObjectEXT(w,34918),f.push(w)):b[e++]=w;u[n+1]=D;ma[n+1]=e}b.length=e;for(n=e=0;n<a.length;++n){var D=a[n],C=D.startQueryIndex,w=D.endQueryIndex;D.sum+=u[w]-u[C];C=ma[C];w=ma[w];w===C?(D.stats.gpuTime+=D.sum/1E6,t.push(D)):
(D.startQueryIndex=C,D.endQueryIndex=w,a[e++]=D)}a.length=e}},getNumPendingQueries:function(){return b.length},clear:function(){f.push.apply(f,b);for(var a=0;a<f.length;a++)r.ext_disjoint_timer_query.deleteQueryEXT(f[a]);b.length=0;f.length=0},restore:function(){b.length=0;f.length=0}}}},{}],22:[function(A,S,Ka){function e(a){return"undefined"!==typeof atob?atob(a):"base64:"+a}function r(a){a=Error("(regl) "+a);console.error(a);throw a;}function n(a,b){a||r(b)}function I(a){return a?": "+a:""}function f(a,
b){switch(b){case "number":return"number"===typeof a;case "object":return"object"===typeof a;case "string":return"string"===typeof a;case "boolean":return"boolean"===typeof a;case "function":return"function"===typeof a;case "undefined":return"undefined"===typeof a;case "symbol":return"symbol"===typeof a}}function b(a,b,f){0>b.indexOf(a)&&r("invalid value"+I(f)+". must be one of: "+b)}function t(a,b){for(a+="";a.length<b;)a=" "+a;return a}function a(){this.name="unknown";this.lines=[];this.index={};
...
a})});return r}function w(a){var b=[];a.split("\n").forEach(function(a){if(!(5>a.length)){var g=/^ERROR:\s+(\d+):(\d+):\s*(.*)$/.exec(a);g?b.push(new ma(g[1]|0,g[2]|0,g[3].trim())):0<a.length&&b.push(new ma("unknown",0,a))}});return b}function C(a,b){b.forEach(function(b){var f=a[b.file];if(f){var e=f.index[b.line];if(e){e.errors.push(b);f.hasErrors=!0;return}}a.unknown.hasErrors=!0;a.unknown.lines[0].errors.push(b)})}function B(a){a._commandRef=Q()}function z(a,b){var f=G();r(a+" in command "+(b||
Q())+("unknown"===f?"":" called from "+f))}function J(a,b,e,h){f(a,b)||z("invalid parameter type"+I(e)+". expected "+b+", got "+typeof a,h||Q())}function P(a,b){return 32820===a||32819===a||33635===a?2:34042===a?4:h[a]*b}var W=A("./sorted-object-keys"),Qd=A("./is-typed-array");A=A("./extend");var p="gl canvas container attributes pixelRatio extensions optionalExtensions profile onDone".split(" "),h={};h[5120]=h[5121]=1;h[5122]=h[5123]=h[36193]=h[33635]=h[32819]=h[32820]=2;h[5124]=h[5125]=h[5126]=
h[34042]=4;S.exports=A(n,{optional:function(a){a()},raise:r,commandRaise:z,command:function(a,b,f){a||z(b,f||Q())},parameter:function(a,b,f){a in b||r("unknown parameter ("+a+")"+I(f)+". possible values: "+W(b).join())},commandParameter:function(a,b,f,e){a in b||z("unknown parameter ("+a+")"+I(f)+". possible values: "+W(b).join(),e||Q())},constructor:function(a){W(a).forEach(function(a){0>p.indexOf(a)&&r('invalid regl constructor argument "'+a+'". must be one of '+p)})},type:function(a,b,e){f(a,b)||
r("invalid parameter type"+I(e)+". expected "+b+", got "+typeof a)},commandType:J,isTypedArray:function(a,b){Qd(a)||r("invalid parameter type"+I(b)+". must be a typed array")},nni:function(a,b){0<=a&&(a|0)===a||r("invalid parameter type, ("+a+")"+I(b)+". must be a nonnegative integer")},oneOf:b,shaderError:function(a,b,f,e,h){if(!a.getShaderParameter(b,a.COMPILE_STATUS)){b=a.getShaderInfoLog(b);a=e===a.FRAGMENT_SHADER?"fragment":"vertex";J(f,"string",a+" shader source must be a string",h);var p=D(f,
...
var r=A("./extend"),n=A("./compiled-fns");S.exports=function(){function I(){var a=[],b=[];return r(function(){a.push.apply(a,e(arguments))},{def:function(){var f="v"+t;t++;b.push(f);0<arguments.length&&(a.push(f,"="),a.push.apply(a,e(arguments)),a.push(";"));return f},toString:function(){return e([0<b.length?"var "+b.join(",")+";":"",e(a).join("")]).join("")}})}function f(){function a(e,r){f(e,r,"=",b.def(e,r),";")}var b=I(),f=I(),t=b.toString,w=f.toString;return r(function(){b.apply(b,e(arguments))},
{def:b.def,entry:b,exit:f,save:a,set:function(f,e,r){a(f,e);b(f,e,"=",r,";")},toString:function(){return t()+w()}})}var b=0,t=0,a={},u={};return{global:I(),link:function(f){var e="$"+b,r=!1;"object"===typeof f&&f.name&&(e=f.name.replace(/ /g,"_"),r=!0);if(e in a)return e;a[e]=f;r||b++;return e},block:I,proc:function(a,b){function t(){var a="a"+n.length;n.push(a);return a}var n=[];b=b||0;for(var w=0;w<b;++w)t();var w=f(),I=w.toString;return u[a]=r(w,{arg:t,toString:function(){return e(["function(",
n.join(),"){",I(),"}"]).join("")}})},scope:f,cond:function(){var a=e(arguments).join(""),b=f(),t=f(),u=b.toString,w=t.toString;return r(b,{then:function(){b.apply(b,e(arguments));return this},"else":function(){t.apply(t,e(arguments));return this},toString:function(){var b=w();b&&(b="else{"+b+"}");return e(["if(",a,"){",u(),"}",b]).join("")}})},compile:function(){var b=[],f=[];Object.keys(a).sort(function(a,b){var f="$"===a.charAt(0),e="$"===b.charAt(0);return f||e?f&&e?+a.slice(1)<+b.slice(1)?-1:
1:f&&!e?-1:1:a.localeCompare(b)}).forEach(function(e){var r=a[e];b.push(e);f.push(r)});for(var e=0,r=b.length-1;-1<r;r--)if("$"===b[r].charAt(0)){e=r;break}e=b.slice(e).join();r=n[e];if(!r)throw Error("missing precompiled function with key: "+e);return r.apply(null,f)}}}},{"./compiled-fns":25,"./extend":26}],25:[function(A,S,Ka){S.exports={$0:function(e){var r,n,I,f,b,t,a,u,ma,Q,G,D,w,C,B,z,J,P,W,A,p,h,g,l,V,X,q,pa,O,Y;r=e.attributes;n=e.current;I=e.framebuffer;f=e.gl;b=e.next;t=e.vao;a=b.blend_color;
u=n.blend_color;ma=b.blend_equation;Q=n.blend_equation;G=b.blend_func;D=n.blend_func;w=b.colorMask;C=n.colorMask;B=b.depth_range;z=n.depth_range;J=b.polygonOffset_offset;P=n.polygonOffset_offset;W=b.sample_coverage;A=n.sample_coverage;p=b.scissor_box;h=n.scissor_box;g=b.stencil_func;l=n.stencil_func;V=b.stencil_opBack;X=n.stencil_opBack;q=b.stencil_opFront;pa=n.stencil_opFront;O=b.viewport;Y=n.viewport;return{poll:function(){var c,d,e,r,t,S,Cb,na,Na,Z,K,N,U,sa,L,$b,$a,T,v,ja,ea,Ea;n.dirty=!1;d=b.blend_enable;
e=b.cull_enable;r=b.depth_enable;t=b.dither;S=b.polygonOffset_enable;Cb=b.sample_alpha;na=b.sample_enable;Na=b.scissor_enable;Z=b.stencil_enable;K=b.cull_face;N=n.cull_face;U=b.depth_func;sa=n.depth_func;L=b.depth_mask;$b=n.depth_mask;$a=b.frontFace;T=n.frontFace;v=b.lineWidth;ja=n.lineWidth;ea=b.stencil_mask;Ea=n.stencil_mask;c=I.next;c!==I.cur&&(c?f.bindFramebuffer(36160,c.framebuffer):f.bindFramebuffer(36160,null),I.cur=c);d!==n.blend_enable&&(d?f.enable(3042):f.disable(3042),n.blend_enable=d);
e!==n.cull_enable&&(e?f.enable(2884):f.disable(2884),n.cull_enable=e);r!==n.depth_enable&&(r?f.enable(2929):f.disable(2929),n.depth_enable=r);t!==n.dither&&(t?f.enable(3024):f.disable(3024),n.dither=t);S!==n.polygonOffset_enable&&(S?f.enable(32823):f.disable(32823),n.polygonOffset_enable=S);Cb!==n.sample_alpha&&(Cb?f.enable(32926):f.disable(32926),n.sample_alpha=Cb);na!==n.sample_enable&&(na?f.enable(32928):f.disable(32928),n.sample_enable=na);Na!==n.scissor_enable&&(Na?f.enable(3089):f.disable(3089),
...
w[1],w[2],w[3]),C[0]=w[0],C[1]=w[1],C[2]=w[2],C[3]=w[3];K!==N&&(f.cullFace(K),n.cull_face=K);U!==sa&&(f.depthFunc(U),n.depth_func=U);L!==$b&&(f.depthMask(L),n.depth_mask=L);if(B[0]!==z[0]||B[1]!==z[1])f.depthRange(B[0],B[1]),z[0]=B[0],z[1]=B[1];$a!==T&&(f.frontFace($a),n.frontFace=$a);v!==ja&&(f.lineWidth(v),n.lineWidth=v);if(J[0]!==P[0]||J[1]!==P[1])f.polygonOffset(J[0],J[1]),P[0]=J[0],P[1]=J[1];if(W[0]!==A[0]||W[1]!==A[1])f.sampleCoverage(W[0],W[1]),A[0]=W[0],A[1]=W[1];if(p[0]!==h[0]||p[1]!==h[1]||
p[2]!==h[2]||p[3]!==h[3])f.scissor(p[0],p[1],p[2],p[3]),h[0]=p[0],h[1]=p[1],h[2]=p[2],h[3]=p[3];if(g[0]!==l[0]||g[1]!==l[1]||g[2]!==l[2])f.stencilFunc(g[0],g[1],g[2]),l[0]=g[0],l[1]=g[1],l[2]=g[2];ea!==Ea&&(f.stencilMask(ea),n.stencil_mask=ea);if(V[0]!==X[0]||V[1]!==X[1]||V[2]!==X[2]||V[3]!==X[3])f.stencilOpSeparate(V[0],V[1],V[2],V[3]),X[0]=V[0],X[1]=V[1],X[2]=V[2],X[3]=V[3];if(q[0]!==pa[0]||q[1]!==pa[1]||q[2]!==pa[2]||q[3]!==pa[3])f.stencilOpSeparate(q[0],q[1],q[2],q[3]),pa[0]=q[0],pa[1]=q[1],pa[2]=
...
c.framebuffer):f.bindFramebuffer(36160,null);I.cur=c;c=r[0];c.buffer?(f.enableVertexAttribArray(0),f.bindBuffer(34962,c.buffer.buffer),f.vertexAttribPointer(0,c.size,c.type,c.normalized,c.stride,c.offset)):(f.disableVertexAttribArray(0),f.vertexAttrib4f(0,c.x,c.y,c.z,c.w),c.buffer=null);c=r[1];c.buffer?(f.enableVertexAttribArray(1),f.bindBuffer(34962,c.buffer.buffer),f.vertexAttribPointer(1,c.size,c.type,c.normalized,c.stride,c.offset)):(f.disableVertexAttribArray(1),f.vertexAttrib4f(1,c.x,c.y,c.z,
c.w),c.buffer=null);c=r[2];c.buffer?(f.enableVertexAttribArray(2),f.bindBuffer(34962,c.buffer.buffer),f.vertexAttribPointer(2,c.size,c.type,c.normalized,c.stride,c.offset)):(f.disableVertexAttribArray(2),f.vertexAttrib4f(2,c.x,c.y,c.z,c.w),c.buffer=null);c=r[3];c.buffer?(f.enableVertexAttribArray(3),f.bindBuffer(34962,c.buffer.buffer),f.vertexAttribPointer(3,c.size,c.type,c.normalized,c.stride,c.offset)):(f.disableVertexAttribArray(3),f.vertexAttrib4f(3,c.x,c.y,c.z,c.w),c.buffer=null);c=r[4];c.buffer?
(f.enableVertexAttribArray(4),f.bindBuffer(34962,c.buffer.buffer),f.vertexAttribPointer(4,c.size,c.type,c.normalized,c.stride,c.offset)):(f.disableVertexAttribArray(4),f.vertexAttrib4f(4,c.x,c.y,c.z,c.w),c.buffer=null);c=r[5];c.buffer?(f.enableVertexAttribArray(5),f.bindBuffer(34962,c.buffer.buffer),f.vertexAttribPointer(5,c.size,c.type,c.normalized,c.stride,c.offset)):(f.disableVertexAttribArray(5),f.vertexAttrib4f(5,c.x,c.y,c.z,c.w),c.buffer=null);c=r[6];c.buffer?(f.enableVertexAttribArray(6),f.bindBuffer(34962,
c.buffer.buffer),f.vertexAttribPointer(6,c.size,c.type,c.normalized,c.stride,c.offset)):(f.disableVertexAttribArray(6),f.vertexAttrib4f(6,c.x,c.y,c.z,c.w),c.buffer=null);c=r[7];c.buffer?(f.enableVertexAttribArray(7),f.bindBuffer(34962,c.buffer.buffer),f.vertexAttribPointer(7,c.size,c.type,c.normalized,c.stride,c.offset)):(f.disableVertexAttribArray(7),f.vertexAttrib4f(7,c.x,c.y,c.z,c.w),c.buffer=null);c=r[8];c.buffer?(f.enableVertexAttribArray(8),f.bindBuffer(34962,c.buffer.buffer),f.vertexAttribPointer(8,
c.size,c.type,c.normalized,c.stride,c.offset)):(f.disableVertexAttribArray(8),f.vertexAttrib4f(8,c.x,c.y,c.z,c.w),c.buffer=null);c=r[9];c.buffer?(f.enableVertexAttribArray(9),f.bindBuffer(34962,c.buffer.buffer),f.vertexAttribPointer(9,c.size,c.type,c.normalized,c.stride,c.offset)):(f.disableVertexAttribArray(9),f.vertexAttrib4f(9,c.x,c.y,c.z,c.w),c.buffer=null);c=r[10];c.buffer?(f.enableVertexAttribArray(10),f.bindBuffer(34962,c.buffer.buffer),f.vertexAttribPointer(10,c.size,c.type,c.normalized,c.stride,
c.offset)):(f.disableVertexAttribArray(10),f.vertexAttrib4f(10,c.x,c.y,c.z,c.w),c.buffer=null);c=r[11];c.buffer?(f.enableVertexAttribArray(11),f.bindBuffer(34962,c.buffer.buffer),f.vertexAttribPointer(11,c.size,c.type,c.normalized,c.stride,c.offset)):(f.disableVertexAttribArray(11),f.vertexAttrib4f(11,c.x,c.y,c.z,c.w),c.buffer=null);c=r[12];c.buffer?(f.enableVertexAttribArray(12),f.bindBuffer(34962,c.buffer.buffer),f.vertexAttribPointer(12,c.size,c.type,c.normalized,c.stride,c.offset)):(f.disableVertexAttribArray(12),
f.vertexAttrib4f(12,c.x,c.y,c.z,c.w),c.buffer=null);c=r[13];c.buffer?(f.enableVertexAttribArray(13),f.bindBuffer(34962,c.buffer.buffer),f.vertexAttribPointer(13,c.size,c.type,c.normalized,c.stride,c.offset)):(f.disableVertexAttribArray(13),f.vertexAttrib4f(13,c.x,c.y,c.z,c.w),c.buffer=null);c=r[14];c.buffer?(f.enableVertexAttribArray(14),f.bindBuffer(34962,c.buffer.buffer),f.vertexAttribPointer(14,c.size,c.type,c.normalized,c.stride,c.offset)):(f.disableVertexAttribArray(14),f.vertexAttrib4f(14,c.x,
c.y,c.z,c.w),c.buffer=null);c=r[15];c.buffer?(f.enableVertexAttribArray(15),f.bindBuffer(34962,c.buffer.buffer),f.vertexAttribPointer(15,c.size,c.type,c.normalized,c.stride,c.offset)):(f.disableVertexAttribArray(15),f.vertexAttrib4f(15,c.x,c.y,c.z,c.w),c.buffer=null);t.currentVAO=null;t.setVAO(t.targetVAO);d?f.enable(3042):f.disable(3042);n.blend_enable=d;e?f.enable(2884):f.disable(2884);n.cull_enable=e;oa?f.enable(2929):f.disable(2929);n.depth_enable=oa;S?f.enable(3024):f.disable(3024);n.dither=
...
(a.cullFace(n),b.cull_face=n);n=u.frontFace;n!==b.frontFace&&(a.frontFace(n),b.frontFace=n);n=u.lineWidth;n!==b.lineWidth&&(a.lineWidth(n),b.lineWidth=n);n=u.polygonOffset_enable;n!==b.polygonOffset_enable&&(n?a.enable(32823):a.disable(32823),b.polygonOffset_enable=n);n=p[0];K=p[1];if(n!==h[0]||K!==h[1])a.polygonOffset(n,K),h[0]=n,h[1]=K;n=u.sample_alpha;n!==b.sample_alpha&&(n?a.enable(32926):a.disable(32926),b.sample_alpha=n);n=u.sample_enable;n!==b.sample_enable&&(n?a.enable(32928):a.disable(32928),
...
r.count+=e;K=ma.program(ma.vert,ma.frag);a.useProgram(K.program);Q.setVAO(null);N=K.id;(U=xb[N])||(U=xb[N]=I(K));U.call(this,f,e);Q.setVAO(null);n&&(r.cpuTime+=performance.now()-Z)},draw:function(f){var e,I,Z,K,N;e=t.next;e!==t.cur&&(e?a.bindFramebuffer(36160,e.framebuffer):a.bindFramebuffer(36160,null),t.cur=e);if(b.dirty){e=u.dither;e!==b.dither&&(e?a.enable(3024):a.disable(3024),b.dither=e);e=u.blend_enable;e!==b.blend_enable&&(e?a.enable(3042):a.disable(3042),b.blend_enable=e);e=G[0];Z=G[1];K=
...
b.scissor_enable=e);e=V[0];Z=V[1];K=V[2];N=V[3];if(e!==X[0]||Z!==X[1]||K!==X[2]||N!==X[3])a.scissor(e,Z,K,N),X[0]=e,X[1]=Z,X[2]=K,X[3]=N;e=ba[0];Z=ba[1];K=ba[2];N=ba[3];if(e!==oa[0]||Z!==oa[1]||K!==oa[2]||N!==oa[3])a.viewport(e,Z,K,N),oa[0]=e,oa[1]=Z,oa[2]=K,oa[3]=N;b.dirty=!1}if(e=b.profile)I=performance.now(),r.count++;Z=ma.program(ma.vert,ma.frag);a.useProgram(Z.program);Q.setVAO(null);K=Z.id;(N=S[K])||(N=S[K]=n(Z));N.call(this,f);Q.setVAO(null);e&&(r.cpuTime+=performance.now()-I)},scope:function(a,
c,g){var e,d;if(e=b.profile)d=performance.now(),r.count++;c(f,a,g);e&&(r.cpuTime+=performance.now()-d)}}},"$38,colors,contextColor,dim0A,dim0B,dim0C,dim0D,dim1A,dim1B,dim1C,dim1D,drwLayer,hiA,hiB,hiC,hiD,loA,loB,loC,loD,maskHeight,maskTexture,p01_04,p05_08,p09_12,p13_16,p17_20,p21_24,p25_28,p29_32,p33_36,p37_40,p41_44,p45_48,p49_52,p53_56,p57_60,palette,resolution,viewBoxPos,viewBoxSize":function(e,r,n,I,f,b,t,a,u,A,Q,G,D,w,C,B,z,J,P,W,S,p,h,g,l,V,X,q,pa,O,Y,c,d,ba,oa,Tc,xb,Cb,na,Na,Z,K,N,U,sa,L,
...
vd=new Float32Array(16);Ab=new Float32Array(16);Sa=new Float32Array(16);Hb=new Float32Array(16);cb=new Float32Array(16);Wb=new Float32Array(16);Qb=new Float32Array(16);return{batch:function(c,g){var e,d,h,m;e=la.next;e!==la.cur&&(e?k.bindFramebuffer(36160,e.framebuffer):k.bindFramebuffer(36160,null),la.cur=e);if(da.dirty){var l,p,n,r,q,fa,O,W,V,X,ba,ab,Ta,ua,Y,wa,yb,Eb,Aa,ac,Ia,pa,Kc,Ra,gd;l=ze[0];p=ze[1];n=ze[2];r=ze[3];if(l!==qd[0]||p!==qd[1]||n!==qd[2]||r!==qd[3])k.colorMask(l,p,n,r),qd[0]=l,qd[1]=
p,qd[2]=n,qd[3]=r;q=kc.frontFace;q!==da.frontFace&&(k.frontFace(q),da.frontFace=q);fa=kc.polygonOffset_enable;fa!==da.polygonOffset_enable&&(fa?k.enable(32823):k.disable(32823),da.polygonOffset_enable=fa);O=Jd[0];W=Jd[1];if(O!==fd[0]||W!==fd[1])k.polygonOffset(O,W),fd[0]=O,fd[1]=W;V=kc.sample_alpha;V!==da.sample_alpha&&(V?k.enable(32926):k.disable(32926),da.sample_alpha=V);X=kc.sample_enable;X!==da.sample_enable&&(X?k.enable(32928):k.disable(32928),da.sample_enable=X);ba=Xd[0];ab=Xd[1];if(ba!==Kd[0]||
...
!1,h.offset=0,h.stride=0;d=lc.location;h=H[d];h.buffer||k.enableVertexAttribArray(d);if(h.type!==b.dtype||4!==h.size||h.buffer!==b||!1!==h.normalized||0!==h.offset||0!==h.stride)k.bindBuffer(34962,b.buffer),k.vertexAttribPointer(d,4,b.dtype,!1,0,0),h.type=b.dtype,h.size=4,h.buffer=b,h.normalized=!1,h.offset=0,h.stride=0;d=ud.location;h=H[d];h.buffer||k.enableVertexAttribArray(d);if(h.type!==t.dtype||4!==h.size||h.buffer!==t||!1!==h.normalized||0!==h.offset||0!==h.stride)k.bindBuffer(34962,t.buffer),
k.vertexAttribPointer(d,4,t.dtype,!1,0,0),h.type=t.dtype,h.size=4,h.buffer=t,h.normalized=!1,h.offset=0,h.stride=0;d=wc.location;h=H[d];h.buffer||k.enableVertexAttribArray(d);if(h.type!==a.dtype||4!==h.size||h.buffer!==a||!1!==h.normalized||0!==h.offset||0!==h.stride)k.bindBuffer(34962,a.buffer),k.vertexAttribPointer(d,4,a.dtype,!1,0,0),h.type=a.dtype,h.size=4,h.buffer=a,h.normalized=!1,h.offset=0,h.stride=0;d=ca.location;h=H[d];h.buffer||k.enableVertexAttribArray(d);if(h.type!==u.dtype||4!==h.size||
...
W.bind());(h=E.elements)?k.bindBuffer(34963,h.buffer.buffer):Ib.currentVAO&&(h=za.getElements(Ib.currentVAO.elements))&&k.bindBuffer(34963,h.buffer.buffer);m=c.offset;if(c=c.count)h?k.drawElements(1,c,h.type,m<<(h.type-5121>>1)):k.drawArrays(1,m,c),da.dirty=!0,Ib.setVAO(null),x.viewportWidth=g,x.viewportHeight=l,da.profile=e,d.unbind(),W.unbind()},scope:function(e,k,n){var r,v,y,M,H,F,ca,N,K,L,la,U,T,aa,W,R,ha,ka,Z,ia,ea,za,ga,ja,va,ta,pc,ab,ra,Ta,Ca,xa,La,Kd,Eb,Ib,Wa,ya,Ud,Da,ac,Fc,Kc,sa,gd,Vb,jc,
...
sg,tg,ug,vg,wg,xg,yg,zg,Ag,Bg,ef,af,Nf,Of,jg,kg,lg,mg,ng,Yf,Tf,Zf,$f,ag,og,Cg,Dg,Eg,Fg,Gg,Hg,Ig,Jg,Kg,Lg,Mg,Ng,Og,Pg,Qg,Rg,Sg,Tg,Ug,Vg,Wg,Xg,Yg,Zg,$g,ah,bh,ch,dh,eh,fh,gh,hh,ih,jh,kh,lh,mh,nh,oh,ph,qh,rh,sh,th,uh,vh;ld.height=e.viewportHeight;ld.width=e.viewportWidth;ld.x=e.viewportX;ld.y=e.viewportY;r=ld.x|0;v=ld.y|0;y="width"in ld?ld.width|0:x.framebufferWidth-r;M="height"in ld?ld.height|0:x.framebufferHeight-v;H=x.viewportWidth;x.viewportWidth=y;F=x.viewportHeight;x.viewportHeight=M;ca=le[0];le[0]=
r;N=le[1];le[1]=v;K=le[2];le[2]=y;L=le[3];le[3]=M;la=yb[0];yb[0]=0;U=yb[1];yb[1]=0;T=yb[2];yb[2]=0;aa=yb[3];yb[3]=0;W=kc.blend_enable;kc.blend_enable=!1;R=qe[0];qe[0]=32774;ha=qe[1];qe[1]=32774;ka=td[0];td[0]=770;Z=td[1];td[1]=771;ia=td[2];td[2]=1;ea=td[3];td[3]=1;za=kc.cull_enable;kc.cull_enable=!0;ga=kc.cull_face;kc.cull_face=1029;ja=kc.depth_enable;kc.depth_enable=!0;va=kc.depth_func;kc.depth_func=513;ta=kc.depth_mask;kc.depth_mask=!0;pc=Sd[0];Sd[0]=0;ab=Sd[1];Sd[1]=1;ra=kc.dither;kc.dither=!1;
...
Wb;md=e.maskTexture;Ue=m[25];m[25]=md;Kb=m[26];m[26]=S;Fb=e.resolution;re=m[19];m[19]=Fb;xd=e.viewBoxPos;Jd=m[20];m[20]=xd;yf=e.viewBoxSize;De=m[21];m[21]=yf;Dd=p.buffer;p.buffer=P;ec=p.divisor;p.divisor=0;bf=p.normalized;p.normalized=!1;$a=p.offset;p.offset=0;Na=p.size;p.size=0;lc=p.state;p.state=1;Xd=p.stride;p.stride=0;ze=p.type;p.type=P.dtype;Oa=p.w;p.w=0;ib=p.x;p.x=0;fd=p.y;p.y=0;se=p.z;p.z=0;Ec=h.buffer;h.buffer=I;$b=h.divisor;h.divisor=0;Ha=h.normalized;h.normalized=!1;Wc=h.offset;h.offset=
...
0;Ne=l.state;l.state=1;Ke=l.stride;l.stride=0;pe=l.type;l.type=b.dtype;Be=l.w;l.w=0;Fe=l.x;l.x=0;Ge=l.y;l.y=0;He=l.z;l.z=0;Ce=V.buffer;V.buffer=t;Hd=V.divisor;V.divisor=0;Rd=V.normalized;V.normalized=!1;Wd=V.offset;V.offset=0;Zd=V.size;V.size=0;Ie=V.state;V.state=1;zd=V.stride;V.stride=0;Od=V.type;V.type=t.dtype;xe=V.w;V.w=0;Je=V.x;V.x=0;of=V.y;V.y=0;We=V.z;V.z=0;Oe=X.buffer;X.buffer=a;Le=X.divisor;X.divisor=0;Ve=X.normalized;X.normalized=!1;Se=X.offset;X.offset=0;Pe=X.size;X.size=0;Qe=X.state;X.state=
...
xb.state;xb.state=1;oh=xb.stride;xb.stride=0;ph=xb.type;xb.type=J.dtype;qh=xb.w;xb.w=0;rh=xb.x;xb.x=0;sh=xb.y;xb.y=0;th=xb.z;xb.z=0;uh=fa.vert;fa.vert=2;vh=fa.frag;fa.frag=1;da.dirty=!0;k(x,e,n);x.viewportWidth=H;x.viewportHeight=F;le[0]=ca;le[1]=N;le[2]=K;le[3]=L;yb[0]=la;yb[1]=U;yb[2]=T;yb[3]=aa;kc.blend_enable=W;qe[0]=R;qe[1]=ha;td[0]=ka;td[1]=Z;td[2]=ia;td[3]=ea;kc.cull_enable=za;kc.cull_face=ga;kc.depth_enable=ja;kc.depth_func=va;kc.depth_mask=ta;Sd[0]=pc;Sd[1]=ab;kc.dither=ra;kc.lineWidth=Ta;
Ze[0]=Eb;Ze[1]=Ib;Ze[2]=Wa;Ze[3]=ya;kc.scissor_enable=Ud;da.profile=Da;E.offset=Fc;E.count=sa;E.primitive=gd;m[24]=jc;m[3]=sb;m[5]=Fa;m[7]=Qa;m[9]=ud;m[4]=qa;m[6]=Ab;m[8]=na;m[10]=rc;m[23]=Td;m[12]=Ac;m[14]=Hb;m[16]=Gb;m[18]=wb;m[11]=sd;m[13]=Jc;m[15]=pd;m[17]=vd;m[22]=Ea;m[25]=Ue;m[26]=Kb;m[19]=re;m[20]=Jd;m[21]=De;p.buffer=Dd;p.divisor=ec;p.normalized=bf;p.offset=$a;p.size=Na;p.state=lc;p.stride=Xd;p.type=ze;p.w=Oa;p.x=ib;p.y=fd;p.z=se;h.buffer=Ec;h.divisor=$b;h.normalized=Ha;h.offset=Wc;h.size=
...
Pg;oa.state=Qg;oa.stride=Rg;oa.type=Sg;oa.w=Tg;oa.x=Ug;oa.y=Vg;oa.z=Wg;Tc.buffer=Xg;Tc.divisor=Yg;Tc.normalized=Zg;Tc.offset=$g;Tc.size=ah;Tc.state=bh;Tc.stride=ch;Tc.type=dh;Tc.w=eh;Tc.x=fh;Tc.y=gh;Tc.z=hh;xb.buffer=ih;xb.divisor=jh;xb.normalized=kh;xb.offset=lh;xb.size=mh;xb.state=nh;xb.stride=oh;xb.type=ph;xb.w=qh;xb.x=rh;xb.y=sh;xb.z=th;fa.vert=uh;fa.frag=vh;da.dirty=!0}}},$1:function(e,r){var n,I,f,b,t,a,u,A,Q,G,D,w,C,B,z,J,P,W,S,p,h,g,l,V,X,q,pa,O,Y,c;n=e.attributes;I=e.current;f=e.framebuffer;
b=e.gl;t=e.next;a=e.vao;u=t.blend_color;A=I.blend_color;Q=t.blend_equation;G=I.blend_equation;D=t.blend_func;w=I.blend_func;C=t.colorMask;B=I.colorMask;z=t.depth_range;J=I.depth_range;P=t.polygonOffset_offset;W=I.polygonOffset_offset;S=t.sample_coverage;p=I.sample_coverage;h=t.scissor_box;g=I.scissor_box;l=t.stencil_func;V=I.stencil_func;X=t.stencil_opBack;q=I.stencil_opBack;pa=t.stencil_opFront;O=I.stencil_opFront;Y=t.viewport;c=I.viewport;return{poll:function(){var a,e,r,n,xb,Cb,na,Na,Z,K,N,U,sa,
L,$b,$a,T,v,ja,ea,Ea,Oa;I.dirty=!1;e=t.blend_enable;r=t.cull_enable;n=t.depth_enable;xb=t.dither;Cb=t.polygonOffset_enable;na=t.sample_alpha;Na=t.sample_enable;Z=t.scissor_enable;K=t.stencil_enable;N=t.cull_face;U=I.cull_face;sa=t.depth_func;L=I.depth_func;$b=t.depth_mask;$a=I.depth_mask;T=t.frontFace;v=I.frontFace;ja=t.lineWidth;ea=I.lineWidth;Ea=t.stencil_mask;Oa=I.stencil_mask;a=f.next;a!==f.cur&&(a?b.bindFramebuffer(36160,a.framebuffer):b.bindFramebuffer(36160,null),f.cur=a);e!==I.blend_enable&&
(e?b.enable(3042):b.disable(3042),I.blend_enable=e);r!==I.cull_enable&&(r?b.enable(2884):b.disable(2884),I.cull_enable=r);n!==I.depth_enable&&(n?b.enable(2929):b.disable(2929),I.depth_enable=n);xb!==I.dither&&(xb?b.enable(3024):b.disable(3024),I.dither=xb);Cb!==I.polygonOffset_enable&&(Cb?b.enable(32823):b.disable(32823),I.polygonOffset_enable=Cb);na!==I.sample_alpha&&(na?b.enable(32926):b.disable(32926),I.sample_alpha=na);Na!==I.sample_enable&&(Na?b.enable(32928):b.disable(32928),I.sample_enable=
...
if(C[0]!==B[0]||C[1]!==B[1]||C[2]!==B[2]||C[3]!==B[3])b.colorMask(C[0],C[1],C[2],C[3]),B[0]=C[0],B[1]=C[1],B[2]=C[2],B[3]=C[3];N!==U&&(b.cullFace(N),I.cull_face=N);sa!==L&&(b.depthFunc(sa),I.depth_func=sa);$b!==$a&&(b.depthMask($b),I.depth_mask=$b);if(z[0]!==J[0]||z[1]!==J[1])b.depthRange(z[0],z[1]),J[0]=z[0],J[1]=z[1];T!==v&&(b.frontFace(T),I.frontFace=T);ja!==ea&&(b.lineWidth(ja),I.lineWidth=ja);if(P[0]!==W[0]||P[1]!==W[1])b.polygonOffset(P[0],P[1]),W[0]=P[0],W[1]=P[1];if(S[0]!==p[0]||S[1]!==p[1])b.sampleCoverage(S[0],
S[1]),p[0]=S[0],p[1]=S[1];if(h[0]!==g[0]||h[1]!==g[1]||h[2]!==g[2]||h[3]!==g[3])b.scissor(h[0],h[1],h[2],h[3]),g[0]=h[0],g[1]=h[1],g[2]=h[2],g[3]=h[3];if(l[0]!==V[0]||l[1]!==V[1]||l[2]!==V[2])b.stencilFunc(l[0],l[1],l[2]),V[0]=l[0],V[1]=l[1],V[2]=l[2];Ea!==Oa&&(b.stencilMask(Ea),I.stencil_mask=Ea);if(X[0]!==q[0]||X[1]!==q[1]||X[2]!==q[2]||X[3]!==q[3])b.stencilOpSeparate(X[0],X[1],X[2],X[3]),q[0]=X[0],q[1]=X[1],q[2]=X[2],q[3]=X[3];if(pa[0]!==O[0]||pa[1]!==O[1]||pa[2]!==O[2]||pa[3]!==O[3])b.stencilOpSeparate(pa[0],
pa[1],pa[2],pa[3]),O[0]=pa[0],O[1]=pa[1],O[2]=pa[2],O[3]=pa[3];if(Y[0]!==c[0]||Y[1]!==c[1]||Y[2]!==c[2]||Y[3]!==c[3])b.viewport(Y[0],Y[1],Y[2],Y[3]),c[0]=Y[0],c[1]=Y[1],c[2]=Y[2],c[3]=Y[3]},refresh:function(){var d,e,oa,Tc,xb,Cb,na,Na,Z,K,N,U,sa,L,$b,$a;I.dirty=!1;e=t.blend_enable;oa=t.cull_enable;Tc=t.depth_enable;xb=t.dither;Cb=t.polygonOffset_enable;na=t.sample_alpha;Na=t.sample_enable;Z=t.scissor_enable;K=t.stencil_enable;N=t.cull_face;U=t.depth_func;sa=t.depth_mask;L=t.frontFace;$b=t.lineWidth;
$a=t.stencil_mask;(d=f.next)?b.bindFramebuffer(36160,d.framebuffer):b.bindFramebuffer(36160,null);f.cur=d;d=n[0];d.buffer?(b.enableVertexAttribArray(0),b.bindBuffer(34962,d.buffer.buffer),b.vertexAttribPointer(0,d.size,d.type,d.normalized,d.stride,d.offset)):(b.disableVertexAttribArray(0),b.vertexAttrib4f(0,d.x,d.y,d.z,d.w),d.buffer=null);r.vertexAttribDivisorANGLE(0,d.divisor);d=n[1];d.buffer?(b.enableVertexAttribArray(1),b.bindBuffer(34962,d.buffer.buffer),b.vertexAttribPointer(1,d.size,d.type,
d.normalized,d.stride,d.offset)):(b.disableVertexAttribArray(1),b.vertexAttrib4f(1,d.x,d.y,d.z,d.w),d.buffer=null);r.vertexAttribDivisorANGLE(1,d.divisor);d=n[2];d.buffer?(b.enableVertexAttribArray(2),b.bindBuffer(34962,d.buffer.buffer),b.vertexAttribPointer(2,d.size,d.type,d.normalized,d.stride,d.offset)):(b.disableVertexAttribArray(2),b.vertexAttrib4f(2,d.x,d.y,d.z,d.w),d.buffer=null);r.vertexAttribDivisorANGLE(2,d.divisor);d=n[3];d.buffer?(b.enableVertexAttribArray(3),b.bindBuffer(34962,d.buffer.buffer),
b.vertexAttribPointer(3,d.size,d.type,d.normalized,d.stride,d.offset)):(b.disableVertexAttribArray(3),b.vertexAttrib4f(3,d.x,d.y,d.z,d.w),d.buffer=null);r.vertexAttribDivisorANGLE(3,d.divisor);d=n[4];d.buffer?(b.enableVertexAttribArray(4),b.bindBuffer(34962,d.buffer.buffer),b.vertexAttribPointer(4,d.size,d.type,d.normalized,d.stride,d.offset)):(b.disableVertexAttribArray(4),b.vertexAttrib4f(4,d.x,d.y,d.z,d.w),d.buffer=null);r.vertexAttribDivisorANGLE(4,d.divisor);d=n[5];d.buffer?(b.enableVertexAttribArray(5),
b.bindBuffer(34962,d.buffer.buffer),b.vertexAttribPointer(5,d.size,d.type,d.normalized,d.stride,d.offset)):(b.disableVertexAttribArray(5),b.vertexAttrib4f(5,d.x,d.y,d.z,d.w),d.buffer=null);r.vertexAttribDivisorANGLE(5,d.divisor);d=n[6];d.buffer?(b.enableVertexAttribArray(6),b.bindBuffer(34962,d.buffer.buffer),b.vertexAttribPointer(6,d.size,d.type,d.normalized,d.stride,d.offset)):(b.disableVertexAttribArray(6),b.vertexAttrib4f(6,d.x,d.y,d.z,d.w),d.buffer=null);r.vertexAttribDivisorANGLE(6,d.divisor);
d=n[7];d.buffer?(b.enableVertexAttribArray(7),b.bindBuffer(34962,d.buffer.buffer),b.vertexAttribPointer(7,d.size,d.type,d.normalized,d.stride,d.offset)):(b.disableVertexAttribArray(7),b.vertexAttrib4f(7,d.x,d.y,d.z,d.w),d.buffer=null);r.vertexAttribDivisorANGLE(7,d.divisor);d=n[8];d.buffer?(b.enableVertexAttribArray(8),b.bindBuffer(34962,d.buffer.buffer),b.vertexAttribPointer(8,d.size,d.type,d.normalized,d.stride,d.offset)):(b.disableVertexAttribArray(8),b.vertexAttrib4f(8,d.x,d.y,d.z,d.w),d.buffer=
null);r.vertexAttribDivisorANGLE(8,d.divisor);d=n[9];d.buffer?(b.enableVertexAttribArray(9),b.bindBuffer(34962,d.buffer.buffer),b.vertexAttribPointer(9,d.size,d.type,d.normalized,d.stride,d.offset)):(b.disableVertexAttribArray(9),b.vertexAttrib4f(9,d.x,d.y,d.z,d.w),d.buffer=null);r.vertexAttribDivisorANGLE(9,d.divisor);d=n[10];d.buffer?(b.enableVertexAttribArray(10),b.bindBuffer(34962,d.buffer.buffer),b.vertexAttribPointer(10,d.size,d.type,d.normalized,d.stride,d.offset)):(b.disableVertexAttribArray(10),
b.vertexAttrib4f(10,d.x,d.y,d.z,d.w),d.buffer=null);r.vertexAttribDivisorANGLE(10,d.divisor);d=n[11];d.buffer?(b.enableVertexAttribArray(11),b.bindBuffer(34962,d.buffer.buffer),b.vertexAttribPointer(11,d.size,d.type,d.normalized,d.stride,d.offset)):(b.disableVertexAttribArray(11),b.vertexAttrib4f(11,d.x,d.y,d.z,d.w),d.buffer=null);r.vertexAttribDivisorANGLE(11,d.divisor);d=n[12];d.buffer?(b.enableVertexAttribArray(12),b.bindBuffer(34962,d.buffer.buffer),b.vertexAttribPointer(12,d.size,d.type,d.normalized,
d.stride,d.offset)):(b.disableVertexAttribArray(12),b.vertexAttrib4f(12,d.x,d.y,d.z,d.w),d.buffer=null);r.vertexAttribDivisorANGLE(12,d.divisor);d=n[13];d.buffer?(b.enableVertexAttribArray(13),b.bindBuffer(34962,d.buffer.buffer),b.vertexAttribPointer(13,d.size,d.type,d.normalized,d.stride,d.offset)):(b.disableVertexAttribArray(13),b.vertexAttrib4f(13,d.x,d.y,d.z,d.w),d.buffer=null);r.vertexAttribDivisorANGLE(13,d.divisor);d=n[14];d.buffer?(b.enableVertexAttribArray(14),b.bindBuffer(34962,d.buffer.buffer),
b.vertexAttribPointer(14,d.size,d.type,d.normalized,d.stride,d.offset)):(b.disableVertexAttribArray(14),b.vertexAttrib4f(14,d.x,d.y,d.z,d.w),d.buffer=null);r.vertexAttribDivisorANGLE(14,d.divisor);d=n[15];d.buffer?(b.enableVertexAttribArray(15),b.bindBuffer(34962,d.buffer.buffer),b.vertexAttribPointer(15,d.size,d.type,d.normalized,d.stride,d.offset)):(b.disableVertexAttribArray(15),b.vertexAttrib4f(15,d.x,d.y,d.z,d.w),d.buffer=null);r.vertexAttribDivisorANGLE(15,d.divisor);a.currentVAO=null;a.setVAO(a.targetVAO);
...
I;m.divisor=1;Ib={};Ib.buffer=f;Ib.divisor=1;yb={};yb.buffer=b;yb.divisor=1;return{batch:function(a,b){var f,g,e,h,l,n;f=Ha.next;f!==Ha.cur&&(f?aa.bindFramebuffer(36160,f.framebuffer):aa.bindFramebuffer(36160,null),Ha.cur=f);if(ea.dirty){var p,t,u,M,z,I,C,B,P,A,la,W,R,Q,V,X,J,ma,S,qa,sd,gd,Kc,sc,ab,jc,Eb,rc,Ta,Ic,ac,Zc,wc;p=ga.dither;p!==ea.dither&&(p?aa.enable(3024):aa.disable(3024),ea.dither=p);t=ga.depth_func;t!==ea.depth_func&&(aa.depthFunc(t),ea.depth_func=t);u=Jc[0];M=Jc[1];if(u!==Wc[0]||M!==
...
b.count;0<fc?hb?P.drawElementsInstancedANGLE(4,36,hb.type,ya<<(hb.type-5121>>1),fc):P.drawArraysInstancedANGLE(4,ya,36,fc):0>fc&&(hb?aa.drawElements(4,36,hb.type,ya<<(hb.type-5121>>1)):aa.drawArrays(4,ya,36));ea.dirty=!0;pc.setVAO(null);ja.viewportWidth=l;ja.viewportHeight=n;B&&(r.cpuTime+=performance.now()-O);W&&v.destroyStream(R);rc&&v.destroyStream(Ta);Sa&&v.destroyStream(Hb);Uc&&v.destroyStream(db)},scope:function(a,b,c){var d,f,e,k,n,q,t,x,u,y,E,H,F,I,da,ca,C,N,O,A,K,L,U,T,aa,Q,ha,ka,Z,ia,za,
...
vb="type"in m?kc[m.type]:Qa.dtype,lb=!!m.normalized,Db=m.size|0,ub=m.offset|0,vc=m.stride|0,Ba=m.divisor|0);xb=p.buffer;p.buffer=Qa;hd=p.divisor;p.divisor=Ba;Ub=p.normalized;p.normalized=lb;bc=p.offset;p.offset=ub;Ob=p.size;p.size=Db;Ga=p.state;p.state=rb;Yb=p.stride;p.stride=vc;mb=p.type;p.type=vb;wb=p.w;p.w=Ha;Mb=p.x;p.x=tc;Pb=p.y;p.y=Wc;gc=p.z;p.z=Lc;ic=h.buffer;h.buffer=D;Qc=h.divisor;h.divisor=0;Bc=h.normalized;h.normalized=!1;Cc=h.offset;h.offset=8;Dc=h.size;h.size=0;Mc=h.state;h.state=1;cd=
...
0,4,$c):0>$c&&(Eb?L.drawElements(5,4,Eb.type,0<<(Eb.type-5121>>1)):L.drawArrays(5,0,4));Na.viewportWidth=Dd;Na.viewportHeight=md;Wa&&na.destroyStream(ta);tb&&na.destroyStream(gb);bb&&na.destroyStream(Aa);hb&&na.destroyStream(ya);Qa&&na.destroyStream(Ba);jd.unbind()}Z.dirty=!0;ja.setVAO(null);t&&(r.cpuTime+=performance.now()-k)},draw:function(a){var e,v,u,k,w,y,m,z,ca,C,B,D,G,P,A,T,Q,W,J,ea,ma,Kd,Ze,Oa,Ha,yd,De,Td,Ud,ie,le,rd,ld,wd,pd,dd,zc,sd,gd,Kc,sc,ab,jc,Eb,rc,Ta,Ic,ac,Zc,Dd,md,Ac,Vb,Fc,Pc,La,
...
771,773,1);aa[0]=770;aa[1]=771;aa[2]=773;aa[3]=1;(ca=n.call(this,Na,a,0))?L.enable(2929):L.disable(2929);Z.depth_enable=ca;C=a.viewport;B=C.x|0;D=C.y|0;G="width"in C?C.width|0:Na.framebufferWidth-B;P="height"in C?C.height|0:Na.framebufferHeight-D;L.scissor(B,D,G,P);M[0]=B;M[1]=D;M[2]=G;M[3]=P;L.enable(3089);Z.scissor_enable=!0;L.disable(2960);Z.stencil_enable=!1;if(A=Z.profile)T=performance.now(),r.count++;L.useProgram(I.program);Q=U.angle_instanced_arrays;ja.setVAO(null);R.buffer=a.positionBuffer;
...
0);ae=a.scale;L.uniform2f(c.location,ae[0],ae[1]);Ja=a.scaleFract;L.uniform2f(d.location,Ja[0],Ja[1]);Nb=a.translate;L.uniform2f(oa.location,Nb[0],Nb[1]);fb=a.translateFract;L.uniform2f(Tc.location,fb[0],fb[1]);L.uniform1f(ba.location,a.thickness);L.uniform1f(q.location,a.depth);hb=t.call(this,Na,a,0);L.uniform4f(xb.location,hb[0],hb[1],hb[2],hb[3]);L.uniform1f(V.location,a.dashLength);L.uniform1f(Y.location,a.opacity);(ya=a.dashTexture)&&"framebuffer"===ya._reglType&&(ya=ya.color[0]);fc=ya._texture;
L.uniform1i(X.location,fc.bind());(Da=K.elements)?L.bindBuffer(34963,Da.buffer.buffer):ja.currentVAO&&(Da=N.getElements(ja.currentVAO.elements))&&L.bindBuffer(34963,Da.buffer.buffer);pb=a.count;0<pb?Da?Q.drawElementsInstancedANGLE(5,4,Da.type,0<<(Da.type-5121>>1),pb):Q.drawArraysInstancedANGLE(5,0,4,pb):0>pb&&(Da?L.drawElements(5,4,Da.type,0<<(Da.type-5121>>1)):L.drawArrays(5,0,4));Z.dirty=!0;ja.setVAO(null);Na.viewportWidth=m;Na.viewportHeight=z;A&&(r.cpuTime+=performance.now()-T);W&&na.destroyStream(J);
wd&&na.destroyStream(pd);Dd&&na.destroyStream(md);Qb&&na.destroyStream(ee);Gc&&na.destroyStream(cc);fc.unbind()},scope:function(c,d,g){var e,h,l,n,m,p,q,t,M,I,F,P,N,O,L,W,J,U,aa,V,X,ka,ia,ga,ja,ba,pc,Y,Ca,S,pa,qa,sa,ud,oa,wc,gd,Kc,sc,ab,jc,Eb,rc,Ta,Ic,ac,Gb,Jc,ec,Ac,Vb,Fc,Pc,La,sb,Wa,ta,Ea,Ab,Sa,Hb,cb,Wb,Qb,lc,Zb,Rb,ib,Sb,Ma,nb,tb,gb,Pa,qc,Xb,Uc,db,mc,Gc,cc,jb,kb,ua,ob,wa,Ua,bb,Aa,eb,Ia,Bb,zb,Ra,oc,Jb,Za,Tb,xa,Wc,Ja,Nb,fb,hb,ya,fc,Da,pb,qb,Xa,Ya,nc,ad,uc,Va,Lb,bd,Fa,xc,Qa,Ba,lb,ub,Db,rb,vc,vb,xb,
tc,Ka,Lc,nd,hd,Ub,bc,Ob,Ga,Yb,mb,wb,Mb,Pb,gc,ic,Qc,Bc,Cc,Dc,Mc,cd,Rc,Nc,Kb,Fb,Oc,Hc,Sc,hc,Xc,id,dc,me,Yc,Tc,Cb,Qd,ve,be,Gd,Ed,ed,Ec,od,jd,$c,kd,Ad,Cd,te,je,ue,de,ce,$d,ne,Yd,fe,yc,Vc,oe,he,Fd,Id,Md,Nd,ge,Ee,we,ke,Xe,Ne,Ke,pe,Be,Fe,Ge,He,Ce,Hd,Rd,Wd,Zd,Ie,zd,Od,xe,Je,of,We,Oe,Le;e=c.viewport;h=e.x|0;l=e.y|0;n="width"in e?e.width|0:Na.framebufferWidth-h;m="height"in e?e.height|0:Na.framebufferHeight-l;p=Na.viewportWidth;Na.viewportWidth=n;q=Na.viewportHeight;Na.viewportHeight=m;t=y[0];y[0]=h;M=y[1];
...
!1;ke=B.offset;B.offset=0;Xe=B.size;B.size=0;Ne=B.state;B.state=1;Ke=B.stride;B.stride=8;pe=B.type;B.type=5126;Be=B.w;B.w=0;Fe=B.x;B.x=0;Ge=B.y;B.y=0;He=B.z;B.z=0;Ce=z.buffer;z.buffer=b;Hd=z.divisor;z.divisor=0;Rd=z.normalized;z.normalized=!1;Wd=z.offset;z.offset=4;Zd=z.size;z.size=0;Ie=z.state;z.state=1;zd=z.stride;z.stride=8;Od=z.type;z.type=5126;xe=z.w;z.w=0;Je=z.x;z.x=0;of=z.y;z.y=0;We=z.z;z.z=0;Oe=T.vert;T.vert=20;Le=T.frag;T.frag=19;Z.dirty=!0;d(Na,c,g);Na.viewportWidth=p;Na.viewportHeight=
q;y[0]=t;y[1]=M;y[2]=I;y[3]=F;ea[0]=P;ea[1]=N;ea[2]=O;ea[3]=L;$a.blend_enable=W;Oa[0]=J;Oa[1]=U;Ha[0]=aa;Ha[1]=V;Ha[2]=X;Ha[3]=ka;$a.depth_enable=ga;ca[0]=S;ca[1]=pa;ca[2]=qa;ca[3]=sa;$a.scissor_enable=ud;$a.stencil_enable=oa;wc&&(r.cpuTime+=performance.now()-gd);K.offset=Kc;K.count=sc;K.instances=jc;K.primitive=Eb;v[23]=Ta;v[24]=ac;v[22]=Jc;v[31]=Ac;v[32]=Fc;v[33]=La;v[10]=Wa;v[34]=Ea;v[6]=Sa;v[7]=cb;v[21]=Qb;v[8]=Zb;v[9]=ib;v[3]=Ma;nb&&na.destroyStream(tb);Q.buffer=ua;Q.divisor=ob;Q.normalized=
...
stride:8};E={divisor:1,offset:4,stride:4};za={divisor:1,offset:16,stride:8};la={divisor:1,offset:24,stride:8};k={divisor:1,offset:0,stride:8};return{batch:function(a,e){var m,n,t,u,w,z;m=T.next;m!==T.cur&&(m?v.bindFramebuffer(36160,m.framebuffer):v.bindFramebuffer(36160,null),T.cur=m);if(sa.dirty){var I,C,B,D,P,G,A,Q,J,ha,ma,qa,Gb,Ea,Oa,Td,Ud,Ha,ib,rd,ld,wd,pd,dd,zc,sd,gd,Kc,sc,ab;I=ea.dither;I!==sa.dither&&(I?v.enable(3024):v.disable(3024),sa.dither=I);C=ea.depth_func;C!==sa.depth_func&&(v.depthFunc(C),
...
32774);ga[0]=32774;ga[1]=32774;v.blendFuncSeparate(770,771,773,1);ec[0]=770;ec[1]=771;ec[2]=773;ec[3]=1;v.enable(2884);sa.cull_enable=!0;v.cullFace(1029);sa.cull_face=1029;v.enable(3089);sa.scissor_enable=!0;v.disable(2960);sa.stencil_enable=!1;if(n=sa.profile)t=performance.now(),r.count+=e;v.useProgram(W.program);u=$a.angle_instanced_arrays;var jc,Eb,rc,Ta,Ic;dc.setVAO(null);jc=Y.location;Eb=K[jc];Eb.buffer||v.enableVertexAttribArray(jc);if(5126!==Eb.type||1!==Eb.size||Eb.buffer!==f||!1!==Eb.normalized||
...
Fb;Oc=y[0];Hc=y[1];Sc=y[2];hc=y[3];if(Oc!==ia[0]||Hc!==ia[1]||Sc!==ia[2]||hc!==ia[3])v.stencilOpSeparate(Oc,Hc,Sc,hc),ia[0]=Oc,ia[1]=Hc,ia[2]=Sc,ia[3]=hc}m=e.viewport;p=m.x|0;u=m.y|0;w="width"in m?m.width|0:U.framebufferWidth-p;z="height"in m?m.height|0:U.framebufferHeight-u;C=U.viewportWidth;U.viewportWidth=w;B=U.viewportHeight;U.viewportHeight=z;v.viewport(p,u,w,z);ra[0]=p;ra[1]=u;ra[2]=w;ra[3]=z;v.blendColor(0,0,0,0);aa[0]=0;aa[1]=0;aa[2]=0;aa[3]=0;v.enable(3042);sa.blend_enable=!0;v.blendEquationSeparate(32774,
...
h.depth_enable=!1;q.enable(3089);h.scissor_enable=!0;q.disable(2960);h.stencil_enable=!1;if(f=h.profile)e=performance.now(),r.count+=b;q.useProgram(u.program);n=V.angle_instanced_arrays;var Jd;d.setVAO(null);Jd=g.instances;for(t=0;t<b;++t){I=a[t];var fd,Xd,Kd,Ze,yf,bf,yd,De,Td,Ud,ie,le,rd,ld,wd,pd,dd,zc,sd,gd,Kc,sc,ab,jc,Eb,rc,Ta,Ic,ac,Zc,Dd,md,Ac,Vb,Fc,Pc,La,sb,Wa,ta,vd,Ab,Sa,Hb,cb,Wb,Qb,ee,Zb,Rb,Bd,Sb,Ma,nb,tb,gb,Pa,qc,Xb,Uc,db,mc,Gc,cc,jb,kb,ua,ob,wa,Ua,bb,Aa,eb,Ia,Bb,zb,Ra,oc,Jb,Za,Tb;fd=I.viewport;
Xd=fd.x|0;Kd=fd.y|0;Ze="width"in fd?fd.width|0:p.framebufferWidth-Xd;yf="height"in fd?fd.height|0:p.framebufferHeight-Kd;bf=p.viewportWidth;p.viewportWidth=Ze;yd=p.viewportHeight;p.viewportHeight=yf;q.viewport(Xd,Kd,Ze,yf);aa[0]=Xd;aa[1]=Kd;aa[2]=Ze;aa[3]=yf;De=I.viewport;Td=De.x|0;Ud=De.y|0;ie="width"in De?De.width|0:p.framebufferWidth-Td;le="height"in De?De.height|0:p.framebufferHeight-Ud;q.scissor(Td,Ud,ie,le);T[0]=Td;T[1]=Ud;T[2]=ie;T[3]=le;ga.buffer=I.positionBuffer;rd=!1;ld=null;wd=0;pd=!1;
...
Hb,Sa.buffer=Zc,Sa.normalized=md,Sa.offset=Ac,Sa.stride=Pc;Sa.divisor!==Dd&&(n.vertexAttribDivisorANGLE(Ab,Dd),Sa.divisor=Dd)}else if(Sa.buffer&&(q.disableVertexAttribArray(Ab),Sa.buffer=null),Sa.x!==Wa||Sa.y!==ta||Sa.z!==vd||Sa.w!==sb)q.vertexAttrib4f(Ab,Wa,ta,vd,sb),Sa.x=Wa,Sa.y=ta,Sa.z=vd,Sa.w=sb;cb=I.fill;Wb=cb[0];ee=cb[1];Rb=cb[2];Sb=cb[3];t&&Qb===Wb&&Zb===ee&&Bd===Rb&&Ma===Sb||(Qb=Wb,Zb=ee,Bd=Rb,Ma=Sb,q.uniform4f(Q.location,Wb,ee,Rb,Sb));nb=I.scale;tb=nb[0];Pa=nb[1];t&&gb===tb&&qc===Pa||(gb=
tb,qc=Pa,q.uniform2f(B.location,tb,Pa));Xb=I.scaleFract;Uc=Xb[0];mc=Xb[1];t&&db===Uc&&Gc===mc||(db=Uc,Gc=mc,q.uniform2f(z.location,Uc,mc));cc=I.translate;jb=cc[0];ua=cc[1];t&&kb===jb&&ob===ua||(kb=jb,ob=ua,q.uniform2f(J.location,jb,ua));wa=I.translateFract;Ua=wa[0];Aa=wa[1];t&&bb===Ua&&eb===Aa||(bb=Ua,eb=Aa,q.uniform2f(P.location,Ua,Aa));Ia=I.id;t&&Bb===Ia||(Bb=Ia,q.uniform1f(G.location,Ia));zb=I.opacity;t&&Ra===zb||(Ra=zb,q.uniform1f(D.location,zb));oc=A.call(this,p,I,t);Jb=null;(Jb=(Za=pa(oc))?
l.createStream(oc):l.getElements(oc))&&q.bindBuffer(34963,Jb.buffer.buffer);if(Tb=Jb?Jb.vertCount:-1)0<Jd?Jb?n.drawElementsInstancedANGLE(4,Tb,Jb.type,0<<(Jb.type-5121>>1),Jd):n.drawArraysInstancedANGLE(4,0,Tb,Jd):0>Jd&&(Jb?q.drawElements(4,Tb,Jb.type,0<<(Jb.type-5121>>1)):q.drawArrays(4,0,Tb)),p.viewportWidth=bf,p.viewportHeight=yd,rd&&S.destroyStream(ld),ac&&S.destroyStream(Zc),Za&&l.destroyStream(Jb)}h.dirty=!0;d.setVAO(null);f&&(r.cpuTime+=performance.now()-e)},draw:function(a){var b,c,f,e,t,
...
u,c,f),dc[0]=b,dc[1]=u,dc[2]=c,dc[3]=f;b=ea[0];u=ea[1];c=ea[2];f=ea[3];if(b!==Ea[0]||u!==Ea[1]||c!==Ea[2]||f!==Ea[3])q.stencilOpSeparate(b,u,c,f),Ea[0]=b,Ea[1]=u,Ea[2]=c,Ea[3]=f}b=a.viewport;c=b.x|0;f=b.y|0;e="width"in b?b.width|0:p.framebufferWidth-c;t="height"in b?b.height|0:p.framebufferHeight-f;b=p.viewportWidth;p.viewportWidth=e;u=p.viewportHeight;p.viewportHeight=t;q.viewport(c,f,e,t);aa[0]=c;aa[1]=f;aa[2]=e;aa[3]=t;q.blendColor(0,0,0,0);oa[0]=0;oa[1]=0;oa[2]=0;oa[3]=0;q.enable(3042);h.blend_enable=
!0;q.blendEquationSeparate(32774,32774);xb[0]=32774;xb[1]=32774;q.blendFuncSeparate(770,771,773,1);na[0]=770;na[1]=771;na[2]=773;na[3]=1;q.disable(2929);h.depth_enable=!1;t=a.viewport;c=t.x|0;f=t.y|0;e="width"in t?t.width|0:p.framebufferWidth-c;t="height"in t?t.height|0:p.framebufferHeight-f;q.scissor(c,f,e,t);T[0]=c;T[1]=f;T[2]=e;T[3]=t;q.enable(3089);h.scissor_enable=!0;q.disable(2960);h.stencil_enable=!1;if(c=h.profile)A=performance.now(),r.count++;q.useProgram(n.program);f=V.angle_instanced_arrays;
d.setVAO(null);ga.buffer=a.positionBuffer;e=!1;ma=0;ba=!1;Ha=Y=0;F=1;y=0;ia=5126;ra=ha=R=va=0;pa(ga)?(e=!0,t=S.createStream(34962,ga),ia=t.dtype):(t=S.getBuffer(ga))?ia=t.dtype:"constant"in ga?(F=2,"number"===typeof ga.constant?(R=ga.constant,ha=ra=va=0):(R=0<ga.constant.length?ga.constant[0]:0,ha=1<ga.constant.length?ga.constant[1]:0,ra=2<ga.constant.length?ga.constant[2]:0,va=3<ga.constant.length?ga.constant[3]:0)):(t=pa(ga.buffer)?S.createStream(34962,ga.buffer):S.getBuffer(ga.buffer),ia="type"in
ga?ib[ga.type]:t.dtype,ba=!!ga.normalized,Ha=ga.size|0,Y=ga.offset|0,y=ga.stride|0,ma=ga.divisor|0);H=w.location;x=W[H];if(1===F){x.buffer||q.enableVertexAttribArray(H);Ha=Ha||2;if(x.type!==ia||x.size!==Ha||x.buffer!==t||x.normalized!==ba||x.offset!==Y||x.stride!==y)q.bindBuffer(34962,t.buffer),q.vertexAttribPointer(H,Ha,ia,ba,y,Y),x.type=ia,x.size=Ha,x.buffer=t,x.normalized=ba,x.offset=Y,x.stride=y;x.divisor!==ma&&(f.vertexAttribDivisorANGLE(H,ma),x.divisor=ma)}else if(x.buffer&&(q.disableVertexAttribArray(H),
...
q.uniform1f(D.location,a.opacity);Y=I.call(this,p,a,0);(Y=(a=pa(Y))?l.createStream(Y):l.getElements(Y))&&q.bindBuffer(34963,Y.buffer.buffer);if(y=Y?Y.vertCount:-1)ia=g.instances,0<ia?Y?f.drawElementsInstancedANGLE(4,y,Y.type,0<<(Y.type-5121>>1),ia):f.drawArraysInstancedANGLE(4,0,y,ia):0>ia&&(Y?q.drawElements(4,y,Y.type,0<<(Y.type-5121>>1)):q.drawArrays(4,0,y)),h.dirty=!0,d.setVAO(null),p.viewportWidth=b,p.viewportHeight=u,c&&(r.cpuTime+=performance.now()-A),e&&S.destroyStream(t),ma&&S.destroyStream(ba),
a&&l.destroyStream(Y)},scope:function(d,e,n){var q,u,v,w,z,I,C,B,D,F,y,P,A,G,N,K,H,x,da,E,L,Q,k,T,J,m,W,aa,U,V,X,ma,Z,ea,ja,sa,oa,na,Ea,Oa,Kd,Na,xb,$b,yd,dc,Td,Ud,ie,le,rd,ld,wd,pd,dd,zc,sd,gd,Kc,sc,ab,jc,Eb,rc,Ta,Ic,ac,Zc,Dd,md,Ac,Vb,Fc,Pc,La,sb,Wa,ta,vd,Ab,Sa,Hb,cb,Wb,Qb,ee,Zb,Rb,Bd,Sb,Ma,nb,tb,gb,Pa,qc,Xb,Uc,db,mc,Gc,cc,jb,kb,ua,ob,wa,Ua,bb,Aa,eb,Ia,Bb,zb;q=d.viewport;u=q.x|0;v=q.y|0;w="width"in q?q.width|0:p.framebufferWidth-u;z="height"in q?q.height|0:p.framebufferHeight-v;I=p.viewportWidth;
p.viewportWidth=w;C=p.viewportHeight;p.viewportHeight=z;B=Ha[0];Ha[0]=u;D=Ha[1];Ha[1]=v;F=Ha[2];Ha[2]=w;y=Ha[3];Ha[3]=z;P=ba[0];ba[0]=0;A=ba[1];ba[1]=0;G=ba[2];ba[2]=0;N=ba[3];ba[3]=0;K=O.blend_enable;O.blend_enable=!0;H=Ka[0];Ka[0]=32774;x=Ka[1];Ka[1]=32774;da=Cb[0];Cb[0]=770;E=Cb[1];Cb[1]=771;L=Cb[2];Cb[2]=773;Q=Cb[3];Cb[3]=1;k=O.depth_enable;O.depth_enable=!1;T=d.viewport;J=T.x|0;m=T.y|0;W="width"in T?T.width|0:p.framebufferWidth-J;aa="height"in T?T.height|0:p.framebufferHeight-m;U=$a[0];$a[0]=
J;V=$a[1];$a[1]=m;X=$a[2];$a[2]=W;ma=$a[3];$a[3]=aa;Z=O.scissor_enable;O.scissor_enable=!0;ea=O.stencil_enable;O.stencil_enable=!1;if(ja=h.profile)sa=performance.now(),r.count++;oa=f.call(this,p,d,n);na=null;na=(Ea=pa(oa))?l.createStream(oa):l.getElements(oa);Oa=g.elements;g.elements=na;Kd=g.offset;g.offset=0;Na=na?na.vertCount:-1;xb=g.count;g.count=Na;$b=g.primitive;g.primitive=4;yd=d.fill;dc=c[14];c[14]=yd;Td=d.id;Ud=c[31];c[31]=Td;ie=d.opacity;le=c[10];c[10]=ie;rd=p.pixelRatio;ld=c[34];c[34]=rd;
wd=d.scale;pd=c[6];c[6]=wd;dd=d.scaleFract;zc=c[7];c[7]=dd;sd=d.translate;gd=c[8];c[8]=sd;Kc=d.translateFract;sc=c[9];c[9]=Kc;ab=b.call(this,p,d,n);jc=c[3];c[3]=ab;ga.buffer=d.positionBuffer;Eb=!1;rc=null;Ta=0;Ic=!1;Zc=ac=0;Dd=1;md=0;Ac=5126;La=Pc=Fc=Vb=0;pa(ga)?(Eb=!0,rc=S.createStream(34962,ga),Ac=rc.dtype):(rc=S.getBuffer(ga))?Ac=rc.dtype:"constant"in ga?(Dd=2,"number"===typeof ga.constant?(Fc=ga.constant,Pc=La=Vb=0):(Fc=0<ga.constant.length?ga.constant[0]:0,Pc=1<ga.constant.length?ga.constant[1]:
0,La=2<ga.constant.length?ga.constant[2]:0,Vb=3<ga.constant.length?ga.constant[3]:0)):(rc=pa(ga.buffer)?S.createStream(34962,ga.buffer):S.getBuffer(ga.buffer),Ac="type"in ga?ib[ga.type]:rc.dtype,Ic=!!ga.normalized,Zc=ga.size|0,ac=ga.offset|0,md=ga.stride|0,Ta=ga.divisor|0);sb=t.buffer;t.buffer=rc;Wa=t.divisor;t.divisor=Ta;ta=t.normalized;t.normalized=Ic;vd=t.offset;t.offset=ac;Ab=t.size;t.size=Zc;Sa=t.state;t.state=Dd;Hb=t.stride;t.stride=md;cb=t.type;t.type=Ac;Wb=t.w;t.w=Vb;Qb=t.x;t.x=Fc;ee=t.y;
t.y=Pc;Zb=t.z;t.z=La;qa.buffer=d.positionFractBuffer;Rb=!1;Bd=null;Sb=0;Ma=!1;tb=nb=0;gb=1;Pa=0;qc=5126;mc=db=Uc=Xb=0;pa(qa)?(Rb=!0,Bd=S.createStream(34962,qa),qc=Bd.dtype):(Bd=S.getBuffer(qa))?qc=Bd.dtype:"constant"in qa?(gb=2,"number"===typeof qa.constant?(Uc=qa.constant,db=mc=Xb=0):(Uc=0<qa.constant.length?qa.constant[0]:0,db=1<qa.constant.length?qa.constant[1]:0,mc=2<qa.constant.length?qa.constant[2]:0,Xb=3<qa.constant.length?qa.constant[3]:0)):(Bd=pa(qa.buffer)?S.createStream(34962,qa.buffer):
S.getBuffer(qa.buffer),qc="type"in qa?ib[qa.type]:Bd.dtype,Ma=!!qa.normalized,tb=qa.size|0,nb=qa.offset|0,Pa=qa.stride|0,Sb=qa.divisor|0);Gc=a.buffer;a.buffer=Bd;cc=a.divisor;a.divisor=Sb;jb=a.normalized;a.normalized=Ma;kb=a.offset;a.offset=nb;ua=a.size;a.size=tb;ob=a.state;a.state=gb;wa=a.stride;a.stride=Pa;Ua=a.type;a.type=qc;bb=a.w;a.w=Xb;Aa=a.x;a.x=Uc;eb=a.y;a.y=db;Ia=a.z;a.z=mc;Bb=Y.vert;Y.vert=42;zb=Y.frag;Y.frag=41;h.dirty=!0;e(p,d,n);p.viewportWidth=I;p.viewportHeight=C;Ha[0]=B;Ha[1]=D;Ha[2]=
F;Ha[3]=y;ba[0]=P;ba[1]=A;ba[2]=G;ba[3]=N;O.blend_enable=K;Ka[0]=H;Ka[1]=x;Cb[0]=da;Cb[1]=E;Cb[2]=L;Cb[3]=Q;O.depth_enable=k;$a[0]=U;$a[1]=V;$a[2]=X;$a[3]=ma;O.scissor_enable=Z;O.stencil_enable=ea;ja&&(r.cpuTime+=performance.now()-sa);Ea&&l.destroyStream(na);g.elements=Oa;g.offset=Kd;g.count=xb;g.primitive=$b;c[14]=dc;c[31]=Ud;c[10]=le;c[34]=ld;c[6]=pd;c[7]=zc;c[8]=gd;c[9]=sc;c[3]=jc;Eb&&S.destroyStream(rc);t.buffer=sb;t.divisor=Wa;t.normalized=ta;t.offset=vd;t.size=Ab;t.state=Sa;t.stride=Hb;t.type=
cb;t.w=Wb;t.x=Qb;t.y=ee;t.z=Zb;Rb&&S.destroyStream(Bd);a.buffer=Gc;a.divisor=cc;a.normalized=jb;a.offset=kb;a.size=ua;a.state=ob;a.stride=wa;a.type=Ua;a.w=bb;a.x=Aa;a.y=eb;a.z=Ia;Y.vert=Bb;Y.frag=zb;h.dirty=!0}}},"$45,borderColorId,borderSize,colorId,constPointSize,isActive,markerTexture,opacity,paletteSize,paletteTexture,pixelRatio,scale,scaleFract,size,translate,translateFract,x,xFract,y,yFract":function(e,r,n,I,f,b,t,a,u,A,Q,G,D,w,C,B,z,J,P,W,S,p,h,g,l,V,X,q,pa,O,Y,c,d,ba,oa,Ka,xb,Cb,na,Na,Z,K,
...
y.bindFramebuffer(36160,null),F.cur=c);if(Ca.dirty){var l,n,t,p,q,u,w,z,I,C,H,B,D,P,A,G,O,Q,J,W,R,V,X,Y,ha,ma,ba,S,ta,za,pa,Sa,Hb,cb;l=va.dither;l!==Ca.dither&&(l?y.enable(3024):y.disable(3024),Ca.dither=l);n=da[0];t=da[1];if(n!==E[0]||t!==E[1])y.blendEquationSeparate(n,t),E[0]=n,E[1]=t;p=va.depth_func;p!==Ca.depth_func&&(y.depthFunc(p),Ca.depth_func=p);q=fa[0];u=fa[1];if(q!==m[0]||u!==m[1])y.depthRange(q,u),m[0]=q,m[1]=u;w=va.depth_mask;w!==Ca.depth_mask&&(y.depthMask(w),Ca.depth_mask=w);z=k[0];
...
Ra&&M.destroyStream(oc),Ya&&M.destroyStream(nc),Ld&&M.destroyStream(tc),Qc&&M.destroyStream(Bc),me&&M.destroyStream(Yc),te&&M.destroyStream(je),ge&&M.destroyStream(Ee),Ie&&M.destroyStream(zd),Pf.unbind(),cg&&Jc.destroyStream(sf)}sa.unbind();Ca.dirty=!0;ra.setVAO(null);d&&(r.cpuTime+=performance.now()-f)},draw:function(c){var d,g,e,h,l,p,q,z,C,H,B,P,N,O,K,L,J,W,R,V,U,X,Y,ha,ba,Z,S,za,pa,sa,na,oa,La,sb,Wa,ta,Na,Ab,Sa,Hb,cb,Wb,Qb,Ka,Zb,Rb,xb,Sb,Ma,nb,tb,gb,Pa,qc,Xb,Uc,db,mc,Gc,cc,jb,kb,ua,ob,wa,Ua,bb,
...
ze[1]||ff!==ze[2])y.stencilFunc(Vd,Re,ff),ze[0]=Vd,ze[1]=Re,ze[2]=ff;kf=se[0];cf=se[1];gf=se[2];hf=se[3];if(kf!==Jd[0]||cf!==Jd[1]||gf!==Jd[2]||hf!==Jd[3])y.stencilOpSeparate(kf,cf,gf,hf),Jd[0]=kf,Jd[1]=cf,Jd[2]=gf,Jd[3]=hf;jf=qd[0];pf=qd[1];lf=qd[2];qf=qd[3];if(jf!==Sd[0]||pf!==Sd[1]||lf!==Sd[2]||qf!==Sd[3])y.stencilOpSeparate(jf,pf,lf,qf),Sd[0]=jf,Sd[1]=pf,Sd[2]=lf,Sd[3]=qf}g=c.viewport;e=g.x|0;h=g.y|0;l="width"in g?g.width|0:ka.framebufferWidth-e;p="height"in g?g.height|0:ka.framebufferHeight-
h;q=ka.viewportWidth;ka.viewportWidth=l;z=ka.viewportHeight;ka.viewportHeight=p;y.viewport(e,h,l,p);Xd[0]=e;Xd[1]=h;Xd[2]=l;Xd[3]=p;y.blendColor(0,0,0,1);x[0]=0;x[1]=0;x[2]=0;x[3]=1;y.enable(3042);Ca.blend_enable=!0;y.blendFuncSeparate(770,771,773,1);la[0]=770;la[1]=771;la[2]=773;la[3]=1;y.disable(2929);Ca.depth_enable=!1;C=c.viewport;H=C.x|0;B=C.y|0;P="width"in C?C.width|0:ka.framebufferWidth-H;N="height"in C?C.height|0:ka.framebufferHeight-B;y.scissor(H,B,P,N);td[0]=H;td[1]=B;td[2]=P;td[3]=N;y.enable(3089);
Ca.scissor_enable=!0;y.disable(2960);Ca.stencil_enable=!1;if(O=Ca.profile)K=performance.now(),r.count++;y.useProgram(n.program);L=Wc.angle_instanced_arrays;ra.setVAO(null);J=I.call(this,ka,c,0);W=!1;R=null;V=0;U=!1;Y=X=0;ha=1;ba=0;Z=5126;sa=pa=za=S=0;ia(J)?(W=!0,R=M.createStream(34962,J),Z=R.dtype):(R=M.getBuffer(J))?Z=R.dtype:"constant"in J?(ha=2,"number"===typeof J.constant?(za=J.constant,pa=sa=S=0):(za=0<J.constant.length?J.constant[0]:0,pa=1<J.constant.length?J.constant[1]:0,sa=2<J.constant.length?
...
ka.viewportWidth=q,ka.viewportHeight=z,O&&(r.cpuTime+=performance.now()-K),W&&M.destroyStream(R),Wa&&M.destroyStream(ta),gb&&M.destroyStream(Pa),eb&&M.destroyStream(Ia),Da&&M.destroyStream(pb),Db&&M.destroyStream(rb),Mb&&M.destroyStream(Pb),hc&&M.destroyStream(Xc),$c&&M.destroyStream(kd),w.unbind(),Ee.unbind(),Xe&&Jc.destroyStream(ke)},scope:function(a,b,f){var e,k,m,n,t,u,v,w,x,y,I,E,F,D,A,G,N,L,ca,K,Q,da,T,U,aa,Z,ma,fa,la,ea,ja,ga,oa,ta,ra,qa,sa,na,Ha,Ea,Oa,yb,Na,$a,wc,Ib,Ma,nb,tb,gb,Pa,Ka,ib,kc,
...
Ff,zf,Df,Ef,uf,vf,tf,wf,xf,Hf,If,Jf,Kf,rf,Pf,Gf,sf,cg,Qf,Rf,qg,df,$e,Lf,Mf,dg,eg,fg,gg,hg,Uf,Sf,Vf,Wf,Xf,ig,rg,sg,tg,ug,vg,wg,xg,yg,zg,Ag,Bg,ef,af,Nf,Of,jg,kg,lg,mg,ng,Yf,Tf,Zf,$f,ag,og,Cg,Dg,Eg,Fg,Gg,Hg,Ig,Jg,Kg,Lg,Mg,Ng,Og,Pg;e=a.viewport;k=e.x|0;m=e.y|0;n="width"in e?e.width|0:ka.framebufferWidth-k;t="height"in e?e.height|0:ka.framebufferHeight-m;u=ka.viewportWidth;ka.viewportWidth=n;v=ka.viewportHeight;ka.viewportHeight=t;w=fd[0];fd[0]=k;x=fd[1];fd[1]=m;y=fd[2];fd[2]=n;I=fd[3];fd[3]=t;E=H[0];
...
Cc=0):(Dc=0<Ga.constant.length?Ga.constant[0]:0,Mc=1<Ga.constant.length?Ga.constant[1]:0,cd=2<Ga.constant.length?Ga.constant[2]:0,Cc=3<Ga.constant.length?Ga.constant[3]:0)):(mb=ia(Ga.buffer)?M.createStream(34962,Ga.buffer):M.getBuffer(Ga.buffer),Bc="type"in Ga?Kd[Ga.type]:mb.dtype,Mb=!!Ga.normalized,gc=Ga.size|0,Pb=Ga.offset|0,Qc=Ga.stride|0,wb=Ga.divisor|0);Rc=p.buffer;p.buffer=mb;Nc=p.divisor;p.divisor=wb;Kb=p.normalized;p.normalized=Mb;Fb=p.offset;p.offset=Pb;Oc=p.size;p.size=gc;Hc=p.state;p.state=
ic;Sc=p.stride;p.stride=Qc;hc=p.type;p.type=Bc;Xc=p.w;p.w=Cc;id=p.x;p.x=Dc;qd=p.y;p.y=Mc;Tc=p.z;p.z=cd;Yc=h.call(this,ka,a,f);Wc=!1;xd=null;td=0;Xd=!1;Gd=Jd=0;Ed=1;ed=0;Ec=5126;kd=$c=jd=od=0;ia(Yc)?(Wc=!0,xd=M.createStream(34962,Yc),Ec=xd.dtype):(xd=M.getBuffer(Yc))?Ec=xd.dtype:"constant"in Yc?(Ed=2,"number"===typeof Yc.constant?(jd=Yc.constant,$c=kd=od=0):(jd=0<Yc.constant.length?Yc.constant[0]:0,$c=1<Yc.constant.length?Yc.constant[1]:0,kd=2<Yc.constant.length?Yc.constant[2]:0,od=3<Yc.constant.length?
...
ba.state=Hg;ba.stride=Ig;ba.type=Jg;ba.w=Kg;ba.x=Lg;ba.y=Mg;ba.z=Ng;R.vert=Og;R.frag=Pg;Ca.dirty=!0}}},"$45,borderColorId,borderSize,colorId,constPointSize,isActive,opacity,paletteSize,paletteTexture,pixelRatio,scale,scaleFract,size,translate,translateFract,x,xFract,y,yFract":function(e,r,n,I,f,b,t,a,u,A,Q,G,D,w,C,B,z,J,P,W,S,p,h,g,l,V,X,q,pa,O,Y,c,d,ba,oa,Ka,xb,Cb,na,Na,Z,K,N,U,sa,L,$b,$a,T,v,ja,ea,Ea,Oa,dc,Ha,aa,ib,ga,qa,ec,pc,lc,ud){var wc,ca,M,ka,Ca,Gb,Jc,Wc,F,y,ia,va,R,ha,ra,H,x,da,E,za,la,k,
...
qe=ia.scissor_box;re=ka.scissor_box;td=ia.stencil_func;xd=ka.stencil_func;ze=ia.stencil_opBack;qd=ka.stencil_opBack;Sd=ia.stencil_opFront;se=ka.stencil_opFront;Jd=ia.viewport;fd=ka.viewport;Xd={int8:5120,int16:5122,int32:5124,uint8:5121,uint16:5123,uint32:5125,"float":5126,float32:5126};return{batch:function(a,b){var c,d,f,g,e,h;c=Wc.next;c!==Wc.cur&&(c?F.bindFramebuffer(36160,c.framebuffer):F.bindFramebuffer(36160,null),Wc.cur=c);if(ka.dirty){var l,n,t,p,q,u,w,z,I,E,C,B,D,A,P,G,J,O,Q,W,R,V,X,Y,ba,
S,ma,va,ra,ta,pa,Ab,Sa,Hb;l=ia.dither;l!==ka.dither&&(l?F.enable(3024):F.disable(3024),ka.dither=l);n=x[0];t=x[1];if(n!==da[0]||t!==da[1])F.blendEquationSeparate(n,t),da[0]=n,da[1]=t;p=ia.depth_func;p!==ka.depth_func&&(F.depthFunc(p),ka.depth_func=p);q=kc[0];u=kc[1];if(q!==fa[0]||u!==fa[1])F.depthRange(q,u),fa[0]=q,fa[1]=u;w=ia.depth_mask;w!==ka.depth_mask&&(F.depthMask(w),ka.depth_mask=w);z=la[0];I=la[1];E=la[2];C=la[3];if(z!==k[0]||I!==k[1]||E!==k[2]||C!==k[3])F.colorMask(z,I,E,C),k[0]=z,k[1]=I,
...
Zd&&ca.destroyStream(Ie),Pf&&Gb.destroyStream(rf)}sa.unbind();ka.dirty=!0;ha.setVAO(null);d&&(r.cpuTime+=performance.now()-f)},draw:function(c){var d,e,g,h,l,p,q,z,E,C,B,P,J,N,O,L,K,W,R,V,X,U,Y,ba,S,Z,va,ra,oa,pa,sa,na,Na,La,sb,Wa,ta,Ka,Ab,Sa,Hb,cb,Wb,Qb,xb,Zb,Rb,Cb,Sb,Ma,nb,tb,gb,Pa,qc,Xb,Uc,db,mc,Gc,cc,jb,kb,ua,ob,wa,Ua,bb,Aa,eb,Ia,Bb,zb,Ra,oc,Jb,Za,Tb,xa,Tc,Ja,Nb,fb,hb,ya,fc,Da,pb,qb,Xa,Ya,nc,ad,uc,Va,Lb,bd,Fa,xc,Qa,Ba,lb,ub,Db,rb,vc,vb,Jd,tc,qe,Lc,nd,hd,Ub,bc,Ob,Ga,Yb,mb,wb,Mb,Pb,gc,ic,Qc,Bc,
...
ff,se[3]=kf;cf=ze[0];gf=ze[1];hf=ze[2];jf=ze[3];if(cf!==qd[0]||gf!==qd[1]||hf!==qd[2]||jf!==qd[3])F.stencilOpSeparate(cf,gf,hf,jf),qd[0]=cf,qd[1]=gf,qd[2]=hf,qd[3]=jf}e=c.viewport;g=e.x|0;h=e.y|0;l="width"in e?e.width|0:M.framebufferWidth-g;p="height"in e?e.height|0:M.framebufferHeight-h;q=M.viewportWidth;M.viewportWidth=l;z=M.viewportHeight;M.viewportHeight=p;F.viewport(g,h,l,p);fd[0]=g;fd[1]=h;fd[2]=l;fd[3]=p;F.blendColor(0,0,0,1);H[0]=0;H[1]=0;H[2]=0;H[3]=1;F.enable(3042);ka.blend_enable=!0;F.blendFuncSeparate(770,
771,773,1);za[0]=770;za[1]=771;za[2]=773;za[3]=1;F.disable(2929);ka.depth_enable=!1;E=c.viewport;C=E.x|0;B=E.y|0;P="width"in E?E.width|0:M.framebufferWidth-C;J="height"in E?E.height|0:M.framebufferHeight-B;F.scissor(C,B,P,J);re[0]=C;re[1]=B;re[2]=P;re[3]=J;F.enable(3089);ka.scissor_enable=!0;F.disable(2960);ka.stencil_enable=!1;if(N=ka.profile)O=performance.now(),r.count++;F.useProgram(n.program);L=Jc.angle_instanced_arrays;ha.setVAO(null);K=I.call(this,M,c,0);W=!1;R=null;V=0;X=!1;Y=U=0;ba=1;S=0;
...
we,ke,Xe):0>Xe&&(ge?F.drawElements(0,ke,ge.type,we<<(ge.type-5121>>1)):F.drawArrays(0,we,ke)),ka.dirty=!0,ha.setVAO(null),M.viewportWidth=q,M.viewportHeight=z,N&&(r.cpuTime+=performance.now()-O),W&&ca.destroyStream(R),sb&&ca.destroyStream(Wa),tb&&ca.destroyStream(gb),Aa&&ca.destroyStream(eb),fc&&ca.destroyStream(Da),ub&&ca.destroyStream(Db),wb&&ca.destroyStream(Mb),Sc&&ca.destroyStream(hc),jd&&ca.destroyStream($c),w.unbind(),Ee&&Gb.destroyStream(ge)},scope:function(a,b,f){var e,k,m,n,t,u,v,w,x,I,
...
Be,Fe,Ge,He,Ce,Hd,Rd,Wd,Zd,Ie,zd,Od,xe,Je,of,We,Oe,Le,Ve,Se,Pe,Qe,Pd,Vd,Re,ff,kf,cf,gf,hf,jf,pf,lf,qf,Af,Bf,Me,ye,mf,nf,Cf,Ff,zf,Df,Ef,uf,vf,tf,wf,xf,Hf,If,Jf,Kf,rf,Pf,Gf,sf,cg,Qf,Rf,qg,df,$e,Lf,Mf,dg,eg,fg,gg,hg,Uf,Sf,Vf,Wf,Xf,ig,rg,sg,tg,ug,vg,wg,xg,yg,zg,Ag,Bg,ef,af,Nf,Of,jg,kg,lg,mg,ng,Yf,Tf,Zf,$f,ag,og,Cg,Dg,Eg,Fg,Gg,Hg,Ig,Jg,Kg,Lg,Mg,Ng,Og;e=a.viewport;k=e.x|0;m=e.y|0;n="width"in e?e.width|0:M.framebufferWidth-k;t="height"in e?e.height|0:M.framebufferHeight-m;u=M.viewportWidth;M.viewportWidth=
n;v=M.viewportHeight;M.viewportHeight=t;w=Jd[0];Jd[0]=k;x=Jd[1];Jd[1]=m;I=Jd[2];Jd[2]=n;H=Jd[3];Jd[3]=t;F=ra[0];ra[0]=0;D=ra[1];ra[1]=0;A=ra[2];ra[2]=0;G=ra[3];ra[3]=1;K=ia.blend_enable;ia.blend_enable=!0;L=E[0];E[0]=770;N=E[1];E[1]=771;Q=E[2];E[2]=773;da=E[3];E[3]=1;T=ia.depth_enable;ia.depth_enable=!1;U=a.viewport;Z=U.x|0;aa=U.y|0;ha="width"in U?U.width|0:M.framebufferWidth-Z;ma="height"in U?U.height|0:M.framebufferHeight-aa;fa=qe[0];qe[0]=Z;la=qe[1];qe[1]=aa;ea=qe[2];qe[2]=ha;ja=qe[3];qe[3]=ma;
ga=ia.scissor_enable;ia.scissor_enable=!0;na=ia.stencil_enable;ia.stencil_enable=!1;if(oa=ka.profile)za=performance.now(),r.count++;ta=a.elements;qa=null;qa=(sa=y(ta))?Gb.createStream(ta):Gb.getElements(ta);Ha=Ca.elements;Ca.elements=qa;Ea=a.offset;Na=Ca.offset;Ca.offset=Ea;Oa=a.count;yb=Ca.count;Ca.count=Oa;Ka=Ca.primitive;Ca.primitive=0;$a=R[45];R[45]=!1;wc=a.markerTexture;Ib=R[48];R[48]=wc;ib=a.opacity;Ma=R[10];R[10]=ib;nb=C.call(this,M,a,f);tb=R[46];R[46]=nb;gb=R[47];R[47]=B;Pa=M.pixelRatio;xb=
...
N;E[2]=Q;E[3]=da;ia.depth_enable=T;qe[0]=fa;qe[1]=la;qe[2]=ea;qe[3]=ja;ia.scissor_enable=ga;ia.stencil_enable=na;oa&&(r.cpuTime+=performance.now()-za);sa&&Gb.destroyStream(qa);Ca.elements=Ha;Ca.offset=Na;Ca.count=yb;Ca.primitive=Ka;R[45]=$a;R[48]=Ib;R[10]=Ma;R[46]=tb;R[47]=gb;R[34]=xb;R[6]=kc;R[7]=ud;R[8]=cc;R[9]=kb;ob&&ca.destroyStream(wa);J.buffer=Tb;J.divisor=xa;J.normalized=ec;J.offset=Ja;J.size=Nb;J.state=fb;J.stride=hb;J.type=ya;J.w=fc;J.x=Da;J.y=pb;J.z=qb;Ya&&ca.destroyStream(nc);W.buffer=
Db;W.divisor=rb;W.normalized=vc;W.offset=vb;W.size=dc;W.state=tc;W.stride=lc;W.type=Lc;W.w=Tc;W.x=xd;W.y=Ub;W.z=bc;Ga&&ca.destroyStream(Yb);p.buffer=Jc;p.divisor=Rc;p.normalized=Nc;p.offset=Kb;p.size=Fb;p.state=Oc;p.stride=Hc;p.type=Sc;p.w=hc;p.x=Xc;p.y=qd;p.z=Wc;Yc&&ca.destroyStream(Sd);g.buffer=kd;g.divisor=Ad;g.normalized=Cd;g.offset=te;g.size=je;g.state=ue;g.stride=de;g.type=ce;g.w=$d;g.x=ne;g.y=Yd;g.z=fe;Vc&&ca.destroyStream(oe);V.buffer=Ke;V.divisor=pe;V.normalized=Be;V.offset=Fe;V.size=Ge;
...
Vb=Ca[3];if(Dd!==Gb[0]||md!==Gb[1]||Ac!==Gb[2]||Vb!==Gb[3])T.scissor(Dd,md,Ac,Vb),Gb[0]=Dd,Gb[1]=md,Gb[2]=Ac,Gb[3]=Vb}e=this.viewport;k=e.x|0;n=e.y|0;t="width"in e?e.width|0:N.framebufferWidth-k;m="height"in e?e.height|0:N.framebufferHeight-n;u=N.viewportWidth;N.viewportWidth=t;w=N.viewportHeight;N.viewportHeight=m;T.viewport(k,n,t,m);ha[0]=k;ha[1]=n;ha[2]=t;ha[3]=m;T.blendColor(0,0,0,1);Ha[0]=0;Ha[1]=0;Ha[2]=0;Ha[3]=1;T.enable(3042);U.blend_enable=!0;T.blendFuncSeparate(770,771,773,1);qa[0]=770;
qa[1]=771;qa[2]=773;qa[3]=1;T.disable(2929);U.depth_enable=!1;T.disable(2960);U.stencil_enable=!1;if(z=U.profile)I=performance.now(),r.count+=b;T.useProgram(J.program);C=$b.angle_instanced_arrays;var Fc,Pc,La,sb,Wa,ta,vd,Ab,Sa,Hb,cb,Wb,Qb,ee,Zb,Rb,Bd,Sb,Ma,nb,tb,gb,Pa,qc,Xb,Uc,db,mc,Gc,cc,jb,kb,ua,ob,wa,Ua,bb,Aa,eb,Ia,Bb,zb,Ra,oc,Jb,Za,Tb,xa,ae,Ja,Nb,fb,hb,ya,fc,Da,pb,qb,Xa,Ya,nc,ad,uc,Va,Lb,bd,Fa,xc,Qa,Ba,lb;Oa.setVAO(null);x.buffer=this.sizeBuffer;Fc=!1;Pc=null;La=0;sb=!1;ta=Wa=0;vd=1;Ab=0;Sa=5126;
...
Pa.w!==Sb)T.vertexAttrib4f(gb,Ma,nb,tb,Sb),Pa.x=Ma,Pa.y=nb,Pa.z=tb,Pa.w=Sb;Xb=I.call(this,N,e,0);T.uniform1f(Y.location,Xb);Uc=f.call(this,N,e,0);T.uniform1f(d.location,Uc);T.uniform1f(g.location,e.align);T.uniform1f(q.location,e.baseline);db=this.viewportArray;T.uniform4f(na.location,db[0],db[1],db[2],db[3]);mc=e.color;T.uniform4f(c.location,mc[0],mc[1],mc[2],mc[3]);Gc=b.call(this,N,e,0);T.uniform2f(X.location,Gc[0],Gc[1]);cc=t.call(this,N,e,0);T.uniform2f(V.location,cc[0],cc[1]);jb=this.scale;T.uniform2f(xb.location,
...
Aa,Ua.type,bb<<(Ua.type-5121>>1),eb):A.drawArraysInstancedANGLE(0,bb,Aa,eb):0>eb&&(Ua?T.drawElements(0,Aa,Ua.type,bb<<(Ua.type-5121>>1)):T.drawArrays(0,bb,Aa)),U.dirty=!0,Oa.setVAO(null),N.viewportWidth=m,N.viewportHeight=B,C&&(r.cpuTime+=performance.now()-D),P&&K.destroyStream(G),Td&&K.destroyStream(Ud),rc&&K.destroyStream(Ta),Sa&&K.destroyStream(Hb),wa.unbind()},scope:function(a,b,c){var d,f,e,g,h,l,n,p,t,q,y,I,F,P,M,J,L,O,W,ca,T,V,X,S,Y,Z,aa,ba,ha,ia,ka,va,na,oa,pa,qa,Ca,Ha,Na,Oa,Ka,$a,wc,Ta,ib,
...
g;n=N.viewportHeight;N.viewportHeight=h;p=R[0];R[0]=f;t=R[1];R[1]=e;q=R[2];R[2]=g;y=R[3];R[3]=h;I=dc[0];dc[0]=0;F=dc[1];dc[1]=0;P=dc[2];dc[2]=0;M=dc[3];dc[3]=1;J=ja.blend_enable;ja.blend_enable=!0;L=ga[0];ga[0]=770;O=ga[1];ga[1]=771;W=ga[2];ga[2]=773;ca=ga[3];ga[3]=1;T=ja.depth_enable;ja.depth_enable=!1;V=ja.stencil_enable;ja.stencil_enable=!1;if(X=U.profile)S=performance.now(),r.count++;Y=a.offset;Z=sa.offset;sa.offset=Y;aa=a.count;ba=sa.count;sa.count=aa;ha=sa.primitive;sa.primitive=0;ia=a.align;
...
Ob=!!x.normalized,Yb=x.size|0,Ga=x.offset|0,wb=x.stride|0,bc=x.divisor|0);Bc=z.buffer;z.buffer=Ub;Cc=z.divisor;z.divisor=bc;Dc=z.normalized;z.normalized=Ob;Mc=z.offset;z.offset=Ga;cd=z.size;z.size=Yb;Rc=z.state;z.state=mb;Nc=z.stride;z.stride=wb;Kb=z.type;z.type=Mb;Fb=z.w;z.w=Pb;Oc=z.x;z.x=gc;Hc=z.y;z.y=ic;Sc=z.z;z.z=Qc;hc=ea.vert;ea.vert=61;Xc=ea.frag;ea.frag=60;U.dirty=!0;b(N,a,c);N.viewportWidth=l;N.viewportHeight=n;R[0]=p;R[1]=t;R[2]=q;R[3]=y;dc[0]=I;dc[1]=F;dc[2]=P;dc[3]=M;ja.blend_enable=J;
ga[0]=L;ga[1]=O;ga[2]=W;ga[3]=ca;ja.depth_enable=T;ja.stencil_enable=V;X&&(r.cpuTime+=performance.now()-S);sa.offset=Z;sa.count=ba;sa.primitive=ha;Ea[64]=ka;Ea[69]=na;Ea[67]=pa;Ea[66]=Ca;Ea[65]=Na;Ea[62]=Ka;Ea[14]=wc;Ea[63]=ib;Ea[10]=Cb;Ea[68]=ud;Ea[6]=Vb;Ea[8]=pc;Ea[3]=sb;ta&&K.destroyStream(lc);w.buffer=Ma;w.divisor=nb;w.normalized=tb;w.offset=gb;w.size=Pa;w.state=qc;w.stride=Xb;w.type=Uc;w.w=db;w.x=mc;w.y=Gc;w.z=cc;jb&&K.destroyStream(kb);C.buffer=oc;C.divisor=Jb;C.normalized=Za;C.offset=Tb;C.size=
xa;C.state=Wc;C.stride=Ja;C.type=Nb;C.w=fb;C.x=hb;C.y=ya;C.z=fc;pb&&K.destroyStream(qb);B.buffer=Ba;B.divisor=lb;B.normalized=ub;B.offset=Db;B.size=rb;B.state=vc;B.stride=vb;B.type=Ld;B.w=tc;B.x=Qd;B.y=Lc;B.z=nd;hd&&K.destroyStream(Ub);z.buffer=Bc;z.divisor=Cc;z.normalized=Dc;z.offset=Mc;z.size=cd;z.state=Rc;z.stride=Nc;z.type=Kb;z.w=Fb;z.x=Oc;z.y=Hc;z.z=Sc;ea.vert=hc;ea.frag=Xc;U.dirty=!0}}}}},{}],26:[function(A,S,Ka){var e=A("./sorted-object-keys");S.exports=function(r,n){for(var I=e(n),f=0;f<I.length;++f)r[I[f]]=
n[I[f]];return r}},{"./sorted-object-keys":35}],27:[function(A,S,Ka){function e(e,f,b,n,a,r){for(var A=0;A<f;++A)for(var Q=e[A],G=0;G<b;++G)for(var D=Q[G],w=0;w<n;++w)a[r++]=D[w]}function r(n,f,b,t,a){for(var u=1,A=b+1;A<f.length;++A)u*=f[A];var Q=f[b];if(4===f.length-b){var G=f[b+1],D=f[b+2];f=f[b+3];for(A=0;A<Q;++A)e(n[A],G,D,f,t,a),a+=u}else for(A=0;A<Q;++A)r(n[A],f,b+1,t,a),a+=u}var n=A("./pool");S.exports={shape:function(e){for(var f=[];e.length;e=e[0])f.push(e.length);return f},flatten:function(I,
f,b,t){var a=1;if(f.length)for(var u=0;u<f.length;++u)a*=f[u];else a=0;b=t||n.allocType(b,a);switch(f.length){case 0:break;case 1:t=f[0];for(f=0;f<t;++f)b[f]=I[f];break;case 2:t=f[0];f=f[1];for(u=a=0;u<t;++u)for(var A=I[u],Q=0;Q<f;++Q)b[a++]=A[Q];break;case 3:e(I,f[0],f[1],f[2],b,0);break;default:r(I,f,0,b,0)}return b}}},{"./pool":33}],28:[function(A,S,Ka){var e=A("./is-typed-array");S.exports=function(r){return Array.isArray(r)||e(r)}},{"./is-typed-array":31}],29:[function(A,S,Ka){var e=A("./is-typed-array");
S.exports=function(r){return!!r&&"object"===typeof r&&Array.isArray(r.shape)&&Array.isArray(r.stride)&&"number"===typeof r.offset&&r.shape.length===r.stride.length&&(Array.isArray(r.data)||e(r.data))}},{"./is-typed-array":31}],30:[function(A,S,Ka){S.exports=function(e){return!(e&e-1)&&!!e}},{}],31:[function(A,S,Ka){S.exports=function(e){return e instanceof Uint8Array||e instanceof Uint16Array||e instanceof Uint32Array||e instanceof Int8Array||e instanceof Int16Array||e instanceof Int32Array||e instanceof
Float32Array||e instanceof Float64Array||e instanceof Uint8ClampedArray}},{}],32:[function(A,S,Ka){S.exports=function(e,r){for(var n=Array(e),I=0;I<e;++I)n[I]=r(I);return n}},{}],33:[function(A,S,Ka){function e(e){var f,b;f=(65535<e)<<4;e>>>=f;b=(255<e)<<3;e>>>=b;f|=b;b=(15<e)<<2;e>>>=b;f|=b;b=(3<e)<<1;return f|b|e>>>b>>1}function r(){function r(f){a:{for(var a=16;268435456>=a;a*=16)if(f<=a){f=a;break a}f=0}a=b[e(f)>>2];return 0<a.length?a.pop():new ArrayBuffer(f)}function f(f){b[e(f.byteLength)>>
2].push(f)}var b=n(8,function(){return[]});return{alloc:r,free:f,allocType:function(b,a){var f=null;switch(b){case 5120:f=new Int8Array(r(a),0,a);break;case 5121:f=new Uint8Array(r(a),0,a);break;case 5122:f=new Int16Array(r(2*a),0,a);break;case 5123:f=new Uint16Array(r(2*a),0,a);break;case 5124:f=new Int32Array(r(4*a),0,a);break;case 5125:f=new Uint32Array(r(4*a),0,a);break;case 5126:f=new Float32Array(r(4*a),0,a);break;default:return null}return f.length!==a?f.subarray(0,a):f},freeType:function(b){f(b.buffer)}}}
var n=A("./loop");A=r();A.zero=r();S.exports=A},{"./loop":32}],34:[function(A,S,Ka){S.exports={next:"function"===typeof requestAnimationFrame?function(e){return requestAnimationFrame(e)}:function(e){return setTimeout(e,16)},cancel:"function"===typeof cancelAnimationFrame?function(e){return cancelAnimationFrame(e)}:clearTimeout}},{}],35:[function(A,S,Ka){S.exports=function(e){return Object.keys(e).sort()}},{}],36:[function(A,S,Ka){var e=A("./pool"),r=new Float32Array(1),n=new Uint32Array(r.buffer);
S.exports=function(A){for(var f=e.allocType(5123,A.length),b=0;b<A.length;++b)if(isNaN(A[b]))f[b]=65535;else if(Infinity===A[b])f[b]=31744;else if(-Infinity===A[b])f[b]=64512;else{r[0]=A[b];var t=n[0],a=t>>>31<<15,u=(t<<1>>>24)-127,t=t>>13&1023;f[b]=-24>u?a:-14>u?a+(t+1024>>-14-u):15<u?a+31744:a+(u+15<<10)+t}return f}},{"./pool":33}],37:[function(A,S,Ka){var e=A("./sorted-object-keys");S.exports=function(r){return e(r).map(function(e){return r[e]})}},{"./sorted-object-keys":35}],38:[function(A,S,
Ka){function e(f,a,e){function n(){var a=window.innerWidth,b=window.innerHeight;f!==document.body&&(b=r.getBoundingClientRect(),a=b.right-b.left,b=b.bottom-b.top);r.width=e*a;r.height=e*b}var r=document.createElement("canvas");b(r.style,{border:0,margin:0,padding:0,top:0,left:0,width:"100%",height:"100%"});f.appendChild(r);f===document.body&&(r.style.position="absolute",b(f.style,{margin:0,padding:0}));var A;f!==document.body&&"function"===typeof ResizeObserver?(A=new ResizeObserver(function(){setTimeout(n)}),
A.observe(f)):window.addEventListener("resize",n,!1);n();return{canvas:r,onDestroy:function(){A?A.disconnect():window.removeEventListener("resize",n);f.removeChild(r)}}}function r(b,a){function f(e){try{return b.getContext(e,a)}catch(n){return null}}return f("webgl")||f("experimental-webgl")||f("webgl-experimental")}function n(b){if("string"===typeof b)return b.split();f(Array.isArray(b),"invalid extension array");return b}function I(b){return"string"===typeof b?(f("undefined"!==typeof document,"not supported outside of DOM"),
...
a&&(B=!!a.profile),"pixelRatio"in a&&(C=+a.pixelRatio,f(0<C,"invalid pixel ratio"))):f.raise("invalid arguments to regl");u&&("canvas"===u.nodeName.toLowerCase()?Q=u:A=u);if(!G){if(!Q){f("undefined"!==typeof document,"must manually specify webgl context outside of DOM environments");u=e(A||document.body,z,C);if(!u)return null;Q=u.canvas;J=u.onDestroy}void 0===b.premultipliedAlpha&&(b.premultipliedAlpha=!0);G=r(Q,b)}return G?{gl:G,canvas:Q,container:A,extensions:D,optionalExtensions:w,pixelRatio:C,
profile:B,onDone:z,onDestroy:J}:(J(),z("webgl not supported, try upgrading your browser or graphics drivers http://get.webgl.org"),null)}},{"./util/check":22,"./util/extend":26}],39:[function(A,S,Ka){S.exports=function(e){e[0]=1;e[1]=0;e[2]=0;e[3]=0;e[4]=0;e[5]=1;e[6]=0;e[7]=0;e[8]=0;e[9]=0;e[10]=1;e[11]=0;e[12]=0;e[13]=0;e[14]=0;e[15]=1;return e}},{}],40:[function(A,S,Ka){var e=A("./identity");S.exports=function(r,n,A,f){var b,t,a,u,S,Q,G,D,w=n[0],C=n[1];n=n[2];a=f[0];u=f[1];t=f[2];G=A[0];f=A[1];
b=A[2];if(1E-6>Math.abs(w-G)&&1E-6>Math.abs(C-f)&&1E-6>Math.abs(n-b))return e(r);A=w-G;f=C-f;G=n-b;D=1/Math.sqrt(A*A+f*f+G*G);A*=D;f*=D;G*=D;b=u*G-t*f;t=t*A-a*G;a=a*f-u*A;(D=Math.sqrt(b*b+t*t+a*a))?(D=1/D,b*=D,t*=D,a*=D):a=t=b=0;u=f*a-G*t;S=G*b-A*a;Q=A*t-f*b;(D=Math.sqrt(u*u+S*S+Q*Q))?(D=1/D,u*=D,S*=D,Q*=D):Q=S=u=0;r[0]=b;r[1]=u;r[2]=A;r[3]=0;r[4]=t;r[5]=S;r[6]=f;r[7]=0;r[8]=a;r[9]=Q;r[10]=G;r[11]=0;r[12]=-(b*w+t*C+a*n);r[13]=-(u*w+S*C+Q*n);r[14]=-(A*w+f*C+G*n);r[15]=1;return r}},{"./identity":39}],
41:[function(A,S,Ka){S.exports=function(e,r,n,A,f){r=1/Math.tan(r/2);var b=1/(A-f);e[0]=r/n;e[1]=0;e[2]=0;e[3]=0;e[4]=0;e[5]=r;e[6]=0;e[7]=0;e[8]=0;e[9]=0;e[10]=(f+A)*b;e[11]=-1;e[12]=0;e[13]=0;e[14]=2*f*A*b;e[15]=0;return e}},{}],42:[function(A,S,Ka){S.exports=function(r,n){function A(a){var b=!1;"altKey"in a&&(b=b||a.altKey!==B.alt,B.alt=!!a.altKey);"shiftKey"in a&&(b=b||a.shiftKey!==B.shift,B.shift=!!a.shiftKey);"ctrlKey"in a&&(b=b||a.ctrlKey!==B.control,B.control=!!a.ctrlKey);"metaKey"in a&&(b=
b||a.metaKey!==B.meta,B.meta=!!a.metaKey);return b}function f(a,b){var f=e.x(b),p=e.y(b);"buttons"in b&&(a=b.buttons|0);if(a!==D||f!==w||p!==C||A(b))D=a|0,w=f||0,C=p||0,n&&n(D,w,C,B)}function b(a){f(0,a)}function t(){if(D||w||C||B.shift||B.alt||B.meta||B.control)D=w=C=0,B.shift=B.alt=B.control=B.meta=!1,n&&n(0,0,0,B)}function a(a){A(a)&&n&&n(D,w,C,B)}function u(a){0===e.buttons(a)?f(0,a):f(D,a)}function S(a){f(D|e.buttons(a),a)}function Q(a){f(D&~e.buttons(a),a)}function G(){z||(z=!0,r.addEventListener("mousemove",
u),r.addEventListener("mousedown",S),r.addEventListener("mouseup",Q),r.addEventListener("mouseleave",b),r.addEventListener("mouseenter",b),r.addEventListener("mouseout",b),r.addEventListener("mouseover",b),r.addEventListener("blur",t),r.addEventListener("keyup",a),r.addEventListener("keydown",a),r.addEventListener("keypress",a),r!==window&&(window.addEventListener("blur",t),window.addEventListener("keyup",a),window.addEventListener("keydown",a),window.addEventListener("keypress",a)))}n||(n=r,r=window);
var D=0,w=0,C=0,B={shift:!1,alt:!1,control:!1,meta:!1},z=!1;G();var J={element:r};Object.defineProperties(J,{enabled:{get:function(){return z},set:function(f){f?G():z&&(z=!1,r.removeEventListener("mousemove",u),r.removeEventListener("mousedown",S),r.removeEventListener("mouseup",Q),r.removeEventListener("mouseleave",b),r.removeEventListener("mouseenter",b),r.removeEventListener("mouseout",b),r.removeEventListener("mouseover",b),r.removeEventListener("blur",t),r.removeEventListener("keyup",a),r.removeEventListener("keydown",
a),r.removeEventListener("keypress",a),r!==window&&(window.removeEventListener("blur",t),window.removeEventListener("keyup",a),window.removeEventListener("keydown",a),window.removeEventListener("keypress",a)))},enumerable:!0},buttons:{get:function(){return D},enumerable:!0},x:{get:function(){return w},enumerable:!0},y:{get:function(){return C},enumerable:!0},mods:{get:function(){return B},enumerable:!0}});return J};var e=A("mouse-event")},{"mouse-event":43}],43:[function(A,S,Ka){function e(e){return e.target||
e.srcElement||window}Ka.buttons=function(e){if("object"===typeof e){if("buttons"in e)return e.buttons;if("which"in e){e=e.which;if(2===e)return 4;if(3===e)return 2;if(0<e)return 1<<e-1}else if("button"in e){e=e.button;if(1===e)return 4;if(2===e)return 2;if(0<=e)return 1<<e}}return 0};Ka.element=e;Ka.x=function(r){if("object"===typeof r){if("offsetX"in r)return r.offsetX;var n=e(r).getBoundingClientRect();return r.clientX-n.left}return 0};Ka.y=function(r){if("object"===typeof r){if("offsetY"in r)return r.offsetY;
var n=e(r).getBoundingClientRect();return r.clientY-n.top}return 0}},{}],44:[function(A,S,Ka){var e=A("to-px");S.exports=function(r,n,A){"function"===typeof r&&(A=!!n,n=r,r=window);var f=e("ex",r),b=function(b){A&&b.preventDefault();var a=b.deltaX||0,e=b.deltaY||0,r=b.deltaZ||0,Q=1;switch(b.deltaMode){case 1:Q=f;break;case 2:Q=window.innerHeight}a*=Q;e*=Q;r*=Q;if(a||e||r)return n(a,e,r,b)};r.addEventListener("wheel",b);return b}},{"to-px":46}],45:[function(A,S,Ka){S.exports=function(e,r){r||(r=[0,
""]);e=String(e);var n=parseFloat(e,10);r[0]=n;r[1]=e.match(/[\d.\-\+]*\s*(.*)/)[1]||"";return r}},{}],46:[function(A,S,Ka){function e(b,e){var a=I(getComputedStyle(b).getPropertyValue(e));return a[0]*n(a[1],b)}function r(b,f){var a=document.createElement("div");a.style.height="128"+b;f.appendChild(a);var n=e(a,"height")/128;f.removeChild(a);return n}function n(b,t){if(!b)return null;t=t||document.body;b=(b+""||"px").trim().toLowerCase();if(t===window||t===document)t=document.body;switch(b){case "%":return t.clientHeight/
100;case "ch":case "ex":return r(b,t);case "em":return e(t,"font-size");case "rem":return e(document.body,"font-size");case "vw":return window.innerWidth/100;case "vh":return window.innerHeight/100;case "vmin":return Math.min(window.innerWidth,window.innerHeight)/100;case "vmax":return Math.max(window.innerWidth,window.innerHeight)/100;case "in":return f;case "cm":return f/2.54;case "mm":return f/25.4;case "pt":return f/72;case "pc":return f/6;case "px":return 1}var a=I(b);if(!isNaN(a[0])&&a[1]){var u=
n(a[1],t);return"number"===typeof u?a[0]*u:null}return null}var I=A("parse-unit");S.exports=n;var f=r("in",document.body)},{"parse-unit":45}],47:[function(A,S,Ka){function e(a,b){for(var e=0;e<a.length;++e)if(a[e]===b)return e;return-1}var r=A("./lib/util/check"),n=A("./lib/util/extend"),I=A("./lib/dynamic"),f=A("./lib/util/raf"),b=A("./lib/util/clock"),t=A("./lib/strings"),a=A("./lib/webgl"),u=A("./lib/extension"),ma=A("./lib/limits"),Q=A("./lib/buffer"),G=A("./lib/elements"),D=A("./lib/texture"),
w=A("./lib/renderbuffer"),C=A("./lib/framebuffer"),B=A("./lib/attribute"),z=A("./lib/shader"),J=A("./lib/read"),P=A("./lib/core"),W=A("./lib/stats"),Qd=A("./lib/timer");S.exports=function(p){function h(){if(0===ib.length)K&&K.update(),pc=null;else{pc=f.next(h);c();for(var a=ib.length-1;0<=a;--a){var b=ib[a];b&&b(L,null,0)}oa.flush();K&&K.update()}}function g(){!pc&&0<ib.length&&(pc=f.next(h))}function l(){pc&&(f.cancel(h),pc=null)}function A(a){a.preventDefault();xb=!0;l();ga.forEach(function(a){a()})}
...
Y();dc.procs.refresh();K&&K.update()}function ba(){return(b()-N)/1E3}console.log("REGL args are:",p);p=a(p);console.log("REGL configs are:",p);if(!p)return null;var oa=p.gl,Ka=oa.getContextAttributes(),xb=oa.isContextLost(),Cb=u(oa,p);if(!Cb)return null;var na=t(),Na=W(),Z=Cb.extensions,K=Qd(oa,Z),N=b(),U=oa.drawingBufferWidth,sa=oa.drawingBufferHeight,L={tick:0,time:0,viewportWidth:U,viewportHeight:sa,framebufferWidth:U,framebufferHeight:sa,drawingBufferWidth:U,drawingBufferHeight:sa,pixelRatio:p.pixelRatio},
U={elements:null,primitive:4,count:-1,offset:0,instances:-1},$b=ma(oa,Z),$a=Q(oa,Na,p,function(a){return v.destroyBuffer(a)}),T=G(oa,Z,$a,Na),v=B(oa,Z,$b,Na,$a,T,U),ja=z(oa,na,Na,p),ea=D(oa,Z,$b,function(){dc.procs.poll()},L,Na,p),Ea=w(oa,Z,$b,Na,p),Oa=C(oa,Z,$b,ea,Ea,Na),dc=P(oa,na,Z,$b,$a,T,ea,Oa,{},v,ja,U,L,K,p),na=J(oa,Oa,dc.procs.poll,L,Ka,Z,$b),Ha=dc.next,aa=oa.canvas,ib=[],ga=[],qa=[],ec=[p.onDestroy],pc=null;aa&&(aa.addEventListener("webglcontextlost",A,!1),aa.addEventListener("webglcontextrestored",
S,!1));var lc=Oa.setFBO=q({framebuffer:I.define.call(null,1,"framebuffer")});d();Ka=n(q,{clear:function(a){r("object"===typeof a&&a,"regl.clear() takes an object as input");if("framebuffer"in a)if(a.framebuffer&&"framebufferCube"===a.framebuffer_reglType)for(var b=0;6>b;++b)lc(n({framebuffer:a.framebuffer.faces[b]},a),pa);else lc(a,pa);else pa(null,a)},prop:I.define.bind(null,1),context:I.define.bind(null,2),"this":I.define.bind(null,3),draw:q({}),buffer:function(a){return $a.create(a,34962,!1,!1)},
elements:function(a){return T.create(a,!1)},texture:ea.create2D,cube:ea.createCube,renderbuffer:Ea.create,framebuffer:Oa.create,framebufferCube:Oa.createCube,vao:v.createVAO,attributes:Ka,frame:O,on:function(a,b){r.type(b,"function","listener callback must be a function");var c;switch(a){case "frame":return O(b);case "lost":c=ga;break;case "restore":c=qa;break;case "destroy":c=ec;break;default:r.raise("invalid event, must be one of frame,lost,restore,destroy")}c.push(b);return{cancel:function(){for(var a=
0;a<c.length;++a)if(c[a]===b){c[a]=c[c.length-1];c.pop();break}}}},limits:$b,hasExtension:function(a){return 0<=$b.extensions.indexOf(a.toLowerCase())},read:na,destroy:function(){ib.length=0;l();aa&&(aa.removeEventListener("webglcontextlost",A),aa.removeEventListener("webglcontextrestored",S));ja.clear();Oa.clear();Ea.clear();v.clear();ea.clear();T.clear();$a.clear();K&&K.clear();ec.forEach(function(a){a()})},_gl:oa,_refresh:d,poll:function(){c();K&&K.update()},now:ba,stats:Na});p.onDone(null,Ka);
return Ka}},{"./lib/attribute":3,"./lib/buffer":4,"./lib/core":9,"./lib/dynamic":10,"./lib/elements":11,"./lib/extension":12,"./lib/framebuffer":13,"./lib/limits":14,"./lib/read":15,"./lib/renderbuffer":16,"./lib/shader":17,"./lib/stats":18,"./lib/strings":19,"./lib/texture":20,"./lib/timer":21,"./lib/util/check":22,"./lib/util/clock":23,"./lib/util/extend":26,"./lib/util/raf":34,"./lib/webgl":38}]},{},[1]);
