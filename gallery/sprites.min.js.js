...
nb[c]=b}}}function fa(){var a=Ha.viewport,b=Ha.scissor_box;a[0]=a[1]=b[0]=b[1]=0;I.viewportWidth=I.framebufferWidth=I.drawingBufferWidth=a[2]=b[2]=la.drawingBufferWidth;I.viewportHeight=I.framebufferHeight=I.drawingBufferHeight=a[3]=b[3]=la.drawingBufferHeight}function a(){I.tick+=1;I.time=aa();fa();tb.procs.poll()}function p(){ea.refresh();fa();tb.procs.refresh();M&&M.update()}function aa(){return(c()-O)/1E3}console.log("REGL args are:",h);h=b(h);console.log("REGL configs are:",h);if(!h)return null;
var la=h.gl,La=la.getContextAttributes(),Ja=la.isContextLost(),Ld=v(la,h);if(!Ld)return null;var oa=x(),Oa=P(),ba=Ld.extensions,M=ge(la,ba),O=c(),U=la.drawingBufferWidth,ta=la.drawingBufferHeight,I={tick:0,time:0,viewportWidth:U,viewportHeight:ta,framebufferWidth:U,framebufferHeight:ta,drawingBufferWidth:U,drawingBufferHeight:ta,pixelRatio:h.pixelRatio},U={elements:null,primitive:4,count:-1,offset:0,instances:-1},Vb=na(la,ba),ab=T(la,Oa,h,function(a){return u.destroyBuffer(a)}),S=K(la,ba,ab,Oa),u=
B(la,ba,Vb,Oa,ab,S,U),ka=D(la,oa,Oa,h),ea=G(la,ba,Vb,function(){tb.procs.poll()},I,Oa,h),Ea=r(la,ba,Vb,Oa,h),Pa=E(la,ba,Vb,ea,Ea,Oa),tb=A(la,oa,ba,Vb,ab,S,ea,Pa,{},u,ka,U,I,M,h),oa=Q(la,Pa,tb.procs.poll,I,La,ba,Vb),Ha=tb.next,W=la.canvas,nb=[],ga=[],pa=[],ac=[h.onDestroy],pc=null;W&&(W.addEventListener("webglcontextlost",C,!1),W.addEventListener("webglcontextrestored",Z,!1));var ic=Pa.setFBO=m({framebuffer:N.define.call(null,1,"framebuffer")});p();La=n(m,{clear:function(a){y("object"===typeof a&&
a,"regl.clear() takes an object as input");if("framebuffer"in a)if(a.framebuffer&&"framebufferCube"===a.framebuffer_reglType)for(var b=0;6>b;++b)ic(n({framebuffer:a.framebuffer.faces[b]},a),ca);else ic(a,ca);else ca(null,a)},prop:N.define.bind(null,1),context:N.define.bind(null,2),"this":N.define.bind(null,3),draw:m({}),buffer:function(a){return ab.create(a,34962,!1,!1)},elements:function(a){return S.create(a,!1)},texture:ea.create2D,cube:ea.createCube,renderbuffer:Ea.create,framebuffer:Pa.create,
framebufferCube:Pa.createCube,vao:u.createVAO,attributes:La,frame:L,on:function(a,b){y.type(b,"function","listener callback must be a function");var c;switch(a){case "frame":return L(b);case "lost":c=ga;break;case "restore":c=pa;break;case "destroy":c=ac;break;default:y.raise("invalid event, must be one of frame,lost,restore,destroy")}c.push(b);return{cancel:function(){for(var a=0;a<c.length;++a)if(c[a]===b){c[a]=c[c.length-1];c.pop();break}}}},limits:Vb,hasExtension:function(a){return 0<=Vb.extensions.indexOf(a.toLowerCase())},
read:oa,destroy:function(){nb.length=0;l();W&&(W.removeEventListener("webglcontextlost",C),W.removeEventListener("webglcontextrestored",Z));ka.clear();Pa.clear();Ea.clear();u.clear();ea.clear();S.clear();ab.clear();M&&M.clear();ac.forEach(function(a){a()})},_gl:la,_refresh:p,poll:function(){a();M&&M.update()},now:aa,stats:Oa});h.onDone(null,La);return La}},{"./lib/attribute":2,"./lib/buffer":3,"./lib/core":8,"./lib/dynamic":9,"./lib/elements":10,"./lib/extension":11,"./lib/framebuffer":12,"./lib/limits":13,
