...
"}")}var k=e.gl,m=b.def(c,".location"),q=b.def(e.attributes,"[",m,"]");c=l.state;var w=l.buffer,x=[l.x,l.y,l.z,l.w],oa=["buffer","normalized","offset","stride"];1===c?f():2===c?h():(b("if(",c,"===",1,"){"),f(),b("}else{"),h(),b("}"))}var e=a.shared;l.forEach(function(l){var e=l.name,m=g.attributes[e],k;if(m){if(!f(m))return;k=m.append(a,b)}else{if(!f(Q))return;var q=a.scopeAttrib(e);c.optional(function(){a.assert(b,q+".state","missing attribute "+e)});k={};u(new ia).forEach(function(a){k[a]=b.def(q,
".",a)})}S(a.link(l),h(l.info.type),k)})}function td(a,b,g,l,f,h){for(var S=a.shared,e=S.gl,k,q=0;q<l.length;++q){var w=l[q],x=w.name,oa=w.info.type,u=g.uniforms[x],w=a.link(w)+".location",v;if(u){if(!f(u))continue;if(H(u)){var d=u.value;c.command(null!==d&&"undefined"!==typeof d,'missing uniform "'+x+'"',a.commandStr);if(35678===oa||35680===oa)c.command("function"===typeof d&&(35678===oa&&("texture2d"===d._reglType||"framebuffer"===d._reglType)||35680===oa&&("textureCube"===d._reglType||"framebufferCube"===
...
Jd,Ld,Md,he,Fe,we,me,Ye,Oe,Le,qe,Ce,Ge,He,Ie,De,Gd,Pd,Wd,Zd,Je,zd,Nd,Ae,Ke,ff,Ve,Pe,Me;g=b.viewport;h=g.x|0;k=g.y|0;m="width"in g?g.width|0:Pa.framebufferWidth-h;n="height"in g?g.height|0:Pa.framebufferHeight-k;q=Pa.viewportWidth;Pa.viewportWidth=m;p=Pa.viewportHeight;Pa.viewportHeight=n;u=v[0];v[0]=h;L=v[1];v[1]=k;C=v[2];v[2]=m;H=v[3];v[3]=n;J=ca[0];ca[0]=0;M=ca[1];ca[1]=0;E=ca[2];ca[2]=0;Q=ca[3];ca[3]=0;O=$a.blend_enable;$a.blend_enable=!0;R=Ma[0];Ma[0]=32774;G=Ma[1];Ma[1]=32774;T=Ha[0];Ha[0]=770;
...
De=y.buffer;y.buffer=a;Gd=y.divisor;y.divisor=0;Pd=y.normalized;y.normalized=!1;Wd=y.offset;y.offset=4;Zd=y.size;y.size=0;Je=y.state;y.state=1;zd=y.stride;y.stride=8;Nd=y.type;y.type=5126;Ae=y.w;y.w=0;Ke=y.x;y.x=0;ff=y.y;y.y=0;Ve=y.z;y.z=0;Pe=P.vert;P.vert=20;Me=P.frag;P.frag=19;Y.dirty=!0;e(Pa,b,d);Pa.viewportWidth=q;Pa.viewportHeight=p;v[0]=u;v[1]=L;v[2]=C;v[3]=H;ca[0]=J;ca[1]=M;ca[2]=E;ca[3]=Q;$a.blend_enable=O;Ma[0]=R;Ma[1]=G;Ha[0]=T;Ha[1]=W;Ha[2]=ja;Ha[3]=ia;$a.depth_enable=ba;aa[0]=N;aa[1]=
...
He,Ie,De,Gd,Pd,Wd,Zd,Je,zd,Nd,Ae,Ke,ff,Ve,Pe,Me,Ue,Te,Qe,Re,Od,Td,Se,gf,mf,cf,hf,jf,kf,qf,nf,rf,Af,Bf,Ne,Be,of,pf,Cf,Ff,zf,Df,Ef,vf,wf,uf,xf,yf;d=b.viewport;g=d.x|0;h=d.y|0;k="width"in d?d.width|0:T.framebufferWidth-g;m="height"in d?d.height|0:T.framebufferHeight-h;q=T.viewportWidth;T.viewportWidth=k;p=T.viewportHeight;T.viewportHeight=m;u=ha[0];ha[0]=g;v=ha[1];ha[1]=h;x=ha[2];ha[2]=k;L=ha[3];ha[3]=m;C=Ha[0];Ha[0]=0;H=Ha[1];Ha[1]=0;aa=Ha[2];Ha[2]=0;J=Ha[3];Ha[3]=0;Q=ca.blend_enable;ca.blend_enable=
...
Z.offset=cf;Cf=Z.size;Z.size=hf;Ff=Z.state;Z.state=jf;zf=Z.stride;Z.stride=kf;Df=Z.type;Z.type=qf;Ef=Z.w;Z.w=nf;vf=Z.x;Z.x=rf;wf=Z.y;Z.y=Af;uf=Z.z;Z.z=Bf;xf=Ea.vert;Ea.vert=36;yf=Ea.frag;Ea.frag=35;qa.dirty=!0;c(T,b,e);T.viewportWidth=q;T.viewportHeight=p;ha[0]=u;ha[1]=v;ha[2]=x;ha[3]=L;Ha[0]=C;Ha[1]=H;Ha[2]=aa;Ha[3]=J;ca.blend_enable=Q;ib[0]=K;ib[1]=P;sa[0]=R;sa[1]=G;sa[2]=U;sa[3]=W;ca.cull_enable=ja;ca.cull_face=Y;ca.depth_enable=ba;Gb[0]=pa;Gb[1]=ra;Gb[2]=Ba;Gb[3]=ab;ca.scissor_enable=pc;ca.stencil_enable=
...
M)/1E3}console.log("REGL args are:",k);k=c(k);if(!k)return null;var na=k.gl,Za=na.getContextAttributes(),yb=na.isContextLost(),Bb=r(na,k);if(!Bb)return null;var ma=u(),Pa=G(),Y=Bb.extensions,K=pc(na,Y),M=a(),T=na.drawingBufferWidth,qa=na.drawingBufferHeight,O={tick:0,time:0,viewportWidth:T,viewportHeight:qa,framebufferWidth:T,framebufferHeight:qa,drawingBufferWidth:T,drawingBufferHeight:qa,pixelRatio:k.pixelRatio},T={elements:null,primitive:4,count:-1,offset:0,instances:-1},Wb=ga(na,Y),$a=ka(na,Pa,
k,function(a){return x.destroyBuffer(a)}),P=F(na,Y,$a,Pa),x=I(na,Y,Wb,Pa,$a,P,T),la=y(na,ma,Pa,k),ca=B(na,Y,Wb,function(){bc.procs.poll()},O,Pa,k),Ea=t(na,Y,Wb,Pa,k),Ma=A(na,Y,Wb,ca,Ea,Pa),bc=Z(na,ma,Y,Wb,$a,P,ca,Ma,{},x,la,T,O,K,k),ma=E(na,Ma,bc.procs.poll,O,Za,Y,Wb),Ha=bc.next,W=na.canvas,ib=[],ea=[],sa=[],cc=[k.onDestroy],nc=null;W&&(W.addEventListener("webglcontextlost",z,!1),W.addEventListener("webglcontextrestored",N,!1));var kc=Ma.setFBO=m({framebuffer:H.define.call(null,1,"framebuffer")});
e();Za=p(m,{clear:function(a){V("object"===typeof a&&a,"regl.clear() takes an object as input");if("framebuffer"in a)if(a.framebuffer&&"framebufferCube"===a.framebuffer_reglType)for(var b=0;6>b;++b)kc(p({framebuffer:a.framebuffer.faces[b]},a),pa);else kc(a,pa);else pa(null,a)},prop:H.define.bind(null,1),context:H.define.bind(null,2),"this":H.define.bind(null,3),draw:m({}),buffer:function(a){return $a.create(a,34962,!1,!1)},elements:function(a){return P.create(a,!1)},texture:ca.create2D,cube:ca.createCube,
renderbuffer:Ea.create,framebuffer:Ma.create,framebufferCube:Ma.createCube,vao:x.createVAO,attributes:Za,frame:J,on:function(a,b){V.type(b,"function","listener callback must be a function");var c;switch(a){case "frame":return J(b);case "lost":c=ea;break;case "restore":c=sa;break;case "destroy":c=cc;break;default:V.raise("invalid event, must be one of frame,lost,restore,destroy")}c.push(b);return{cancel:function(){for(var a=0;a<c.length;++a)if(c[a]===b){c[a]=c[c.length-1];c.pop();break}}}},limits:Wb,
hasExtension:function(a){return 0<=Wb.extensions.indexOf(a.toLowerCase())},read:ma,destroy:function(){ib.length=0;q();W&&(W.removeEventListener("webglcontextlost",z),W.removeEventListener("webglcontextrestored",N));la.clear();Ma.clear();Ea.clear();x.clear();ca.clear();P.clear();$a.clear();K&&K.clear();cc.forEach(function(a){a()})},_gl:na,_refresh:e,poll:function(){b();K&&K.update()},now:ba,stats:Pa});k.onDone(null,Za);return Za}},{"./lib/attribute":2,"./lib/buffer":3,"./lib/core":8,"./lib/dynamic":9,
